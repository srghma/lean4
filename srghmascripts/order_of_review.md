...
- [ ] src/runtime/allocprof (`src/runtime/allocprof.h` and `src/runtime/allocprof.cpp`)
  - [~] src/runtime/io (`src/runtime/io.h` and `src/runtime/io.cpp`) — PARTIAL: lean_io_result_show_error, mk_embedded_nul_error, lean_decode_io_error, lean_decode_uv_error, lean_io_prim_handle_{is_tty,is_eof,flush,rewind,truncate,read,write,get_line,put_str,lock,try_lock,unlock}, lean_io_{create_dir,remove_dir,current_dir,app_path,rename,hard_link,remove_file,realpath,read_dir,metadata,symlink_metadata,create_tempdir,create_tempfile,get_random_bytes,check_canceled,cancel,get_task_state,wait,wait_any,as_task,map_task,bind_task}, lean_{get,set}_{stdin,stdout,stderr}, lean_option_get_or_block, lean_chmod, lean_st_{mk_ref,ref_get,ref_take,ref_set,ref_swap,ref_ptr_eq}, lean_io_{exit,force_exit}, lean_runtime_{mark_persistent,mark_multi_threaded,forget}, io_wrap_handle, initialize_io, finalize_io done; C++ bodies removed for Rust-owned FS functions; remaining: handle.mk and Windows timezone helpers
  - [~] src/runtime/io (`src/runtime/io.h` and `src/runtime/io.cpp`) — PARTIAL: lean_io_result_show_error, mk_embedded_nul_error, lean_decode_io_error, lean_decode_uv_error, lean_io_prim_handle_{is_tty,is_eof,flush,rewind,truncate,read,write,get_line,put_str,lock,try_lock,unlock}, lean_io_{create_dir,remove_dir,current_dir,app_path,rename,hard_link,remove_file,realpath,read_dir,metadata,symlink_metadata,create_tempdir,create_tempfile,get_random_bytes,check_canceled,cancel,get_task_state,wait,wait_any,as_task,map_task,bind_task}, lean_{get,set}_{stdin,stdout,stderr}, lean_option_get_or_block, lean_chmod, lean_st_{mk_ref,ref_get,ref_take,ref_set,ref_swap,ref_ptr_eq}, lean_io_{exit,force_exit}, lean_runtime_{mark_persistent,mark_multi_threaded,forget}, io_wrap_handle, initialize_io, finalize_io done; C++ bodies removed for Rust-owned FS functions; remaining: handle.mk and Windows timezone helpers
