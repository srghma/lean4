...
#[no_mangle] pub static l_main___lam__0___closed__0_value: lean_string_object<7> = lean_string_object { m_header: lean_object { m_rc: 0, m_cs_sz: (0) as u16, m_other: 0, m_tag: 249 }, m_size: 7, m_capacity: 7, m_length: 6, m_data: [104, 101, 108, 108, 111, 32, 0]};
...
#[no_mangle] pub static l_main___closed__1_value: lean_string_object<30> = lean_string_object { m_header: lean_object { m_rc: 0, m_cs_sz: (0) as u16, m_other: 0, m_tag: 249 }, m_size: 30, m_capacity: 30, m_length: 29, m_data: [46, 47, 95, 99, 111, 109, 112, 97, 99, 116, 95, 99, 108, 111, 115, 117, 114, 101, 95, 116, 101, 115, 116, 46, 111, 108, 101, 97, 110, 0]};
static mut l_main___closed__1: *mut lean_object = core::ptr::addr_of!(l_main___closed__1_value) as *mut lean_object;
#[no_mangle] pub static l_main___closed__2_value: lean_string_object<5> = lean_string_object { m_header: lean_object { m_rc: 0, m_cs_sz: (0) as u16, m_other: 0, m_tag: 249 }, m_size: 5, m_capacity: 5, m_length: 4, m_data: [116, 101, 115, 116, 0]};
static mut l_main___closed__2: *mut lean_object = core::ptr::addr_of!(l_main___closed__2_value) as *mut lean_object;
#[no_mangle] pub static l_main___closed__3_value: lean_ctor_object<3> = lean_ctor_object { m_header: lean_object { m_rc: 0, m_cs_sz: (core::mem::size_of::<lean_object>() + core::mem::size_of::<*mut lean_object>()*2 + 8) as u16, m_other: 2, m_tag: 1 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut lean_object,core::ptr::addr_of!(l_main___closed__2_value) as *mut lean_object,13563890123683549843 as *mut lean_object] };
static mut l_main___closed__3: *mut lean_object = core::ptr::addr_of!(l_main___closed__3_value) as *mut lean_object;
#[no_mangle] pub static l_main___closed__4_value: lean_array_object<0> = lean_array_object { m_header: lean_object { m_rc: 0, m_cs_sz: (core::mem::size_of::<lean_object>() + core::mem::size_of::<usize>()*2 + core::mem::size_of::<*mut lean_object>()*0) as u16, m_other: 0, m_tag: 246 }, m_size: 0, m_capacity: 0, m_data: [] };
static mut l_main___closed__4: *mut lean_object = core::ptr::addr_of!(l_main___closed__4_value) as *mut lean_object;
#[no_mangle] pub static l_main___closed__5_value: lean_array_object<3> = lean_array_object { m_header: lean_object { m_rc: 0, m_cs_sz: (core::mem::size_of::<lean_object>() + core::mem::size_of::<usize>()*2 + core::mem::size_of::<*mut lean_object>()*3) as u16, m_other: 0, m_tag: 246 }, m_size: 3, m_capacity: 3, m_data: [((( 10 as usize) << 1) | 1) as *mut lean_object,((( 20 as usize) << 1) | 1) as *mut lean_object,((( 30 as usize) << 1) | 1) as *mut lean_object] };
...
#[no_mangle] pub static l_main___closed__7_value: lean_string_object<6> = lean_string_object { m_header: lean_object { m_rc: 0, m_cs_sz: (0) as u16, m_other: 0, m_tag: 249 }, m_size: 6, m_capacity: 6, m_length: 5, m_data: [116, 101, 115, 116, 50, 0]};
...
if v___x_10_ == 0 {
let mut v___x_11_: *mut lean_object = core::ptr::null_mut(); let mut v___x_12_: *mut lean_object = core::ptr::null_mut(); let mut v___x_13_: usize = 0; let mut v___x_14_: usize = 0; 
...
let mut v___x_85_: *mut lean_object = core::ptr::null_mut(); 
lean_dec_ref_known(v___x_84_, 1);
v___x_85_ = lean_compacted_region_read(v_tmpFile_78_, v___x_81_);
if lean_obj_tag(v___x_85_) == 0 {
let mut v_a_86_: *mut lean_object = core::ptr::null_mut(); let mut v_fst_87_: *mut lean_object = core::ptr::null_mut(); let mut v___x_88_: *mut lean_object = core::ptr::null_mut(); let mut v___x_89_: *mut lean_object = core::ptr::null_mut(); let mut v___x_90_: *mut lean_object = core::ptr::null_mut(); 
...
let mut v___f_93_: *mut lean_object = core::ptr::null_mut(); let mut v___x_94_: *mut lean_object = core::ptr::null_mut(); let mut v___x_95_: *mut lean_object = core::ptr::null_mut(); 
...
let mut v___x_103_: *mut lean_object = core::ptr::null_mut(); let mut v___x_104_: *mut lean_object = core::ptr::null_mut(); let mut v___x_105_: *mut lean_object = core::ptr::null_mut(); let mut v___x_106_: *mut lean_object = core::ptr::null_mut(); 
...
let mut v_a_116_: *mut lean_object = core::ptr::null_mut(); let mut v___x_118_: *mut lean_object = core::ptr::null_mut(); let mut v_isShared_119_: u8 = 0; let mut v_isSharedCheck_123_: u8 = 0; 
...
let mut v_a_124_: *mut lean_object = core::ptr::null_mut(); let mut v___x_126_: *mut lean_object = core::ptr::null_mut(); let mut v_isShared_127_: u8 = 0; let mut v_isSharedCheck_131_: u8 = 0; 
...
let mut v_a_132_: *mut lean_object = core::ptr::null_mut(); let mut v___x_134_: *mut lean_object = core::ptr::null_mut(); let mut v_isShared_135_: u8 = 0; let mut v_isSharedCheck_139_: u8 = 0; 
...
let mut v_reuseFailAlloc_130_: *mut lean_object = core::ptr::null_mut(); 
...
let mut v_reuseFailAlloc_138_: *mut lean_object = core::ptr::null_mut(); 
