...
extern "C" {
    ...
    fn l_IO_sleep(_: u32) -> *mut lean_object;
    fn lean_string_push(_: *mut lean_object, _: u32) -> *mut lean_object;
    fn lean_io_as_task(_: *mut lean_object, _: *mut lean_object) -> *mut lean_object;
}
#[no_mangle] pub static l_stuff___closed__0_value: lean_string_object<9> = lean_string_object { m_header: lean_object { m_rc: 0, m_cs_sz: (0) as u16, m_other: 0, m_tag: 249 }, m_size: 9, m_capacity: 9, m_length: 8, m_data: [72, 105, 32, 116, 104, 101, 114, 101, 0]};
...
let mut v_a_27_: *mut lean_object = core::ptr::null_mut(); let mut v___x_29_: *mut lean_object = core::ptr::null_mut(); let mut v_isShared_30_: u8 = 0; let mut v_isSharedCheck_34_: u8 = 0; 
...
let mut v_a_35_: *mut lean_object = core::ptr::null_mut(); let mut v___x_37_: *mut lean_object = core::ptr::null_mut(); let mut v_isShared_38_: u8 = 0; let mut v_isSharedCheck_42_: u8 = 0; 
...
let mut v_reuseFailAlloc_33_: *mut lean_object = core::ptr::null_mut(); 
...
let mut v_reuseFailAlloc_41_: *mut lean_object = core::ptr::null_mut(); 
