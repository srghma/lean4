...
pub unsafe fn l_List_filterTR_loop___at___00Lean_Elab_Tactic_Omega_List_nonzeroMinimum_spec__0(
    ...
    let mut v_reuseFailAlloc_96_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_98_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_a_83_) == 0 {
                    v___x_85_ = l_List_reverse___redArg(v_a_84_);
                    return v___x_85_;
                } else {
                    v_head_86_ = leanh::lean_ctor_get(v_a_83_, 0);
                    v_tail_87_ = leanh::lean_ctor_get(v_a_83_, 1);
                    v_isSharedCheck_98_ = (!leanh::lean_is_exclusive(v_a_83_)) as u8;
            ...
            1 => {
                v___x_91_ = leanh::lean_unsigned_to_nat(0);
                v___x_92_ = lean_nat_dec_eq(v_head_86_, v___x_91_);
                if v___x_92_ == 0 {
                    if v_isShared_90_ == 0 {
                        leanh::lean_ctor_set(v___x_89_, 1, v_a_84_);
                        v___x_94_ = v___x_89_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_96_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_96_, 0, v_head_86_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_96_, 1, v_a_84_);
                        v___x_94_ = v_reuseFailAlloc_96_;
                        state = 2;
                        continue;
                    }
                } else {
                    leanh::lean_del_object(v___x_89_);
                    leanh::lean_dec(v_head_86_);
                    v_a_83_ = v_tail_87_;
                    state = 0;
                    continue;
                }
...
pub unsafe fn l_List_foldl___at___00List_min_x3f___at___00Lean_Elab_Tactic_Omega_List_nonzeroMinimum_spec__1_spec__1(
    ...
    let mut v_head_101_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_100_) == 0 {
                    leanh::lean_inc(v_x_99_);
                    return v_x_99_;
                } else {
                    v_head_101_ = leanh::lean_ctor_get(v_x_100_, 0);
                    v_tail_102_ = leanh::lean_ctor_get(v_x_100_, 1);
...
pub unsafe fn l_List_foldl___at___00List_min_x3f___at___00Lean_Elab_Tactic_Omega_List_nonzeroMinimum_spec__1_spec__1___boxed(
    ...
    leanh::lean_dec(v_x_107_);
    leanh::lean_dec(v_x_106_);
    return v_res_108_;
}
pub unsafe fn l_List_min_x3f___at___00Lean_Elab_Tactic_Omega_List_nonzeroMinimum_spec__1(
    ...
    if leanh::lean_obj_tag(v_x_109_) == 0 {
        let mut v___x_110_: *mut leanh::LeanObject = core::ptr::null_mut();
        v___x_110_ = leanh::lean_box(0);
        return v___x_110_;
    } else {
        let mut v_head_111_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_112_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_113_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_114_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_head_111_ = leanh::lean_ctor_get(v_x_109_, 0);
        v_tail_112_ = leanh::lean_ctor_get(v_x_109_, 1);
        ...
        v___x_114_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Elab_Tactic_Omega_List_nonzeroMinimum(
    mut v_xs_117_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    if leanh::lean_obj_tag(v___x_120_) == 0 {
        ...
        let mut v_val_122_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_val_122_ = leanh::lean_ctor_get(v___x_120_, 0);
        leanh::lean_inc(v_val_122_);
...
pub unsafe fn l_List_mapTR_loop___at___00Lean_Elab_Tactic_Omega_List_minNatAbs_spec__0(
    ...
    let mut v_head_126_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_127_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_135_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_136_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_a_123_) == 0 {
                    v___x_125_ = l_List_reverse___redArg(v_a_124_);
                    return v___x_125_;
                } else {
                    v_head_126_ = leanh::lean_ctor_get(v_a_123_, 0);
                    v_tail_127_ = leanh::lean_ctor_get(v_a_123_, 1);
                    v_isSharedCheck_136_ = (!leanh::lean_is_exclusive(v_a_123_)) as u8;
                    if v_isSharedCheck_136_ == 0 {
                        ...
                        leanh::lean_inc(v_tail_127_);
                        leanh::lean_inc(v_head_126_);
                        leanh::lean_dec(v_a_123_);
            ...
            1 => {
                ...
                leanh::lean_dec(v_head_126_);
                if v_isShared_130_ == 0 {
                    leanh::lean_ctor_set(v___x_129_, 1, v_a_124_);
                    leanh::lean_ctor_set(v___x_129_, 0, v___x_131_);
                    v___x_133_ = v___x_129_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_135_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_135_, 0, v___x_131_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_135_, 1, v_a_124_);
...
pub unsafe fn l_List_foldl___at___00List_max_x3f___at___00Lean_Elab_Tactic_Omega_List_maxNatAbs_spec__0_spec__0(
    ...
    let mut v_head_143_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_142_) == 0 {
                    leanh::lean_inc(v_x_141_);
                    return v_x_141_;
                } else {
                    v_head_143_ = leanh::lean_ctor_get(v_x_142_, 0);
                    v_tail_144_ = leanh::lean_ctor_get(v_x_142_, 1);
...
pub unsafe fn l_List_max_x3f___at___00Lean_Elab_Tactic_Omega_List_maxNatAbs_spec__0(
    ...
    if leanh::lean_obj_tag(v_x_151_) == 0 {
        let mut v___x_152_: *mut leanh::LeanObject = core::ptr::null_mut();
        v___x_152_ = leanh::lean_box(0);
        return v___x_152_;
    } else {
        let mut v_head_153_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_154_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_155_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_156_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_head_153_ = leanh::lean_ctor_get(v_x_151_, 0);
        v_tail_154_ = leanh::lean_ctor_get(v_x_151_, 1);
        ...
        v___x_156_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Elab_Tactic_Omega_List_maxNatAbs(
    ...
    if leanh::lean_obj_tag(v___x_162_) == 0 {
        let mut v___x_163_: *mut leanh::LeanObject = core::ptr::null_mut();
        v___x_163_ = leanh::lean_unsigned_to_nat(0);
        return v___x_163_;
    } else {
        let mut v_val_164_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_val_164_ = leanh::lean_ctor_get(v___x_162_, 0);
        leanh::lean_inc(v_val_164_);
        leanh::lean_dec_ref_known(v___x_162_, 1);
        return v_val_164_;
    }
}
