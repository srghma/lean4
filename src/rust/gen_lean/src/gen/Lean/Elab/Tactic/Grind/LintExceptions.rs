...
// Imports: Init Std Lean.Elab.Tactic.Grind.Lint
...
use crate::r#gen::Std::{initialize_Std, runtime_initialize_Std};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lean_Elab_Tactic_Grind_LintExceptions(
    builtin: u8,
...
pub unsafe fn meta_initialize_Lean_Elab_Tactic_Grind_LintExceptions(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Elab_Tactic_Grind_LintExceptions(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
