...
use crate::ffi::{
    ...
    lean_nat_dec_eq, lean_nat_dec_le, lean_nat_dec_lt, lean_string_dec_eq, lean_uint64_of_nat,
    lean_usize_dec_eq,
};
use crate::ffi::{
...
pub static mut l_Lean_Elab_Term_Quotation_quotPrecheck: *mut crate::leanh::LeanObject =
    core::ptr::null_mut();
...
pub static mut l_Lean_Elab_Term_Quotation_precheckAttribute: *mut crate::leanh::LeanObject =
    core::ptr::null_mut();
