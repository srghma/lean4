...
static mut l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__0_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__0_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value) as *mut leanh::LeanObject;
...
static mut l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__1_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__1_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value) as *mut leanh::LeanObject;
static l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__2_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value_aux_0: leanh::LeanCtorObject<3> = leanh::LeanCtorObject { m_header: leanh::LeanObject { rc: 0, cs_size: (core::mem::size_of::<leanh::LeanObject>() + core::mem::size_of::<*mut leanh::LeanObject>()*2 + 8) as u16, other: 2, tag: 1 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut leanh::LeanObject,core::ptr::addr_of!(l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__0_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value) as *mut leanh::LeanObject,17728754291599005030 as *mut leanh::LeanObject] };
pub static l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__2_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value: leanh::LeanCtorObject<3> = leanh::LeanCtorObject { m_header: leanh::LeanObject { rc: 0, cs_size: (core::mem::size_of::<leanh::LeanObject>() + core::mem::size_of::<*mut leanh::LeanObject>()*2 + 8) as u16, other: 2, tag: 1 }, m_objs: [core::ptr::addr_of!(l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__2_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value_aux_0) as *mut leanh::LeanObject,core::ptr::addr_of!(l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__1_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value) as *mut leanh::LeanObject,12195177637636718237 as *mut leanh::LeanObject] };
static mut l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__2_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn___closed__2_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2__value) as *mut leanh::LeanObject;
pub static mut l_Lean_Elab_ConfigEval_unsupportedExprExceptionId: *mut leanh::LeanObject =
    core::ptr::null_mut();
...
pub unsafe fn l___private_Lean_Elab_ConfigEval_Types_0__Lean_Elab_ConfigEval_initFn_00___x40_Lean_Elab_ConfigEval_Types_3111895740____hygCtx___hyg_2____boxed(
    mut v_a_30_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
-> *mut leanh::LeanObject {
    ...
    v___x_34_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_34_, 0, v___x_33_);
    leanh::lean_ctor_set(v___x_34_, 1, v___x_32_);
    return v___x_34_;
}
pub unsafe fn l_Lean_Elab_ConfigEval_throwUnsupportedExpr___redArg(
    mut v_inst_35_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_throw_36_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_37_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_38_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_throw_36_ = leanh::lean_ctor_get(v_inst_35_, 0);
    leanh::lean_inc(v_throw_36_);
    leanh::lean_dec_ref(v_inst_35_);
    v___x_37_ = leanh::lean_obj_once(
    ...
    v___x_38_ = leanh::lean_apply_2(v_throw_36_, leanh::lean_box(0), v___x_37_);
    return v___x_38_;
}
...
pub unsafe fn runtime_initialize_Lean_Elab_ConfigEval_Types(
    ...
    l_Lean_Elab_ConfigEval_unsupportedExprExceptionId = leanh::lean_io_result_get_value(res);
    leanh::lean_mark_persistent(l_Lean_Elab_ConfigEval_unsupportedExprExceptionId);
    leanh::lean_dec_ref(res);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
...
pub unsafe fn initialize_Lean_Elab_ConfigEval_Types(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
