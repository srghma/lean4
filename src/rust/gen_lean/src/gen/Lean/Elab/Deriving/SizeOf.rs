...
static mut l___private_Lean_Elab_Deriving_SizeOf_0__Lean_Elab_Deriving_SizeOf_initFn___closed__0_00___x40_Lean_Elab_Deriving_SizeOf_388027031____hygCtx___hyg_2_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Elab_Deriving_SizeOf_0__Lean_Elab_Deriving_SizeOf_initFn___closed__0_00___x40_Lean_Elab_Deriving_SizeOf_388027031____hygCtx___hyg_2__value) as *mut leanh::LeanObject;
pub static l___private_Lean_Elab_Deriving_SizeOf_0__Lean_Elab_Deriving_SizeOf_initFn___closed__1_00___x40_Lean_Elab_Deriving_SizeOf_388027031____hygCtx___hyg_2__value: leanh::LeanCtorObject<3> = leanh::LeanCtorObject { m_header: leanh::LeanObject { rc: 0, cs_size: (core::mem::size_of::<leanh::LeanObject>() + core::mem::size_of::<*mut leanh::LeanObject>()*2 + 8) as u16, other: 2, tag: 1 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut leanh::LeanObject,core::ptr::addr_of!(l___private_Lean_Elab_Deriving_SizeOf_0__Lean_Elab_Deriving_SizeOf_initFn___closed__0_00___x40_Lean_Elab_Deriving_SizeOf_388027031____hygCtx___hyg_2__value) as *mut leanh::LeanObject,14284789806808743489 as *mut leanh::LeanObject] };
static mut l___private_Lean_Elab_Deriving_SizeOf_0__Lean_Elab_Deriving_SizeOf_initFn___closed__1_00___x40_Lean_Elab_Deriving_SizeOf_388027031____hygCtx___hyg_2_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Elab_Deriving_SizeOf_0__Lean_Elab_Deriving_SizeOf_initFn___closed__1_00___x40_Lean_Elab_Deriving_SizeOf_388027031____hygCtx___hyg_2__value) as *mut leanh::LeanObject;
...
pub unsafe fn l_Lean_isInductive___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__1___redArg(
    ...
    v_env_185_ = leanh::lean_ctor_get(v___x_184_, 0);
    leanh::lean_inc_ref(v_env_185_);
    leanh::lean_dec(v___x_184_);
    v___x_186_ = l_Lean_isInductiveCore(v_env_185_, v_declName_181_);
    v___x_187_ = leanh::lean_box((v___x_186_) as usize);
    v___x_188_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_isInductive___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__1___redArg___boxed(
    mut v_declName_189_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_isInductive___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__1___boxed(
    mut v_declName_198_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Elab_Deriving_SizeOf_mkSizeOfHandler___lam__0(
    ...
    if v_____do__lift_203_ == 0 {
        ...
        v___x_207_ = 1;
        v___x_208_ = leanh::lean_box((v___x_207_) as usize);
        v___x_209_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
        ...
        v___x_210_ = 0;
        v___x_211_ = leanh::lean_box((v___x_210_) as usize);
...
pub unsafe fn l_Lean_Elab_Deriving_SizeOf_mkSizeOfHandler___lam__0___boxed(
    mut v_____do__lift_213_: *mut leanh::LeanObject,
    ...
    v_____do__lift_1887__boxed_217_ = (leanh::lean_unbox(v_____do__lift_213_) as u8);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_anyMUnsafe_any___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__2(
    mut v_as_219_: *mut leanh::LeanObject,
    mut v_i_220_: usize,
        ...
        match state {
            0 => {
                ...
                if v___x_225_ == 0 {
                    ...
                    if leanh::lean_obj_tag(v___x_235_) == 0 {
                        ...
                        v_isSharedCheck_245_ = (!leanh::lean_is_exclusive(v___x_235_)) as u8;
                        ...
                        if leanh::lean_obj_tag(v___x_235_) == 0 {
                            v_a_246_ = leanh::lean_ctor_get(v___x_235_, 0);
                            leanh::lean_inc(v_a_246_);
                            leanh::lean_dec_ref_known(v___x_235_, 1);
                            v___x_247_ = (leanh::lean_unbox(v_a_246_) as u8);
                    ...
                    v___x_248_ = 0;
                    v___x_249_ = leanh::lean_box((v___x_248_) as usize);
                    v___x_250_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
            ...
            1 => {
                if v_a_228_ == 0 {
                    ...
                    v___x_232_ = leanh::lean_box((v___x_226_) as usize);
            ...
            2 => {
                v___x_240_ = (leanh::lean_unbox(v_a_236_) as u8);
                leanh::lean_dec(v_a_236_);
                if v___x_240_ == 0 {
                    v___x_241_ = leanh::lean_box((v___x_226_) as usize);
                    if v_isShared_239_ == 0 {
                        leanh::lean_ctor_set(v___x_238_, 0, v___x_241_);
                        v___x_243_ = v___x_238_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_244_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_244_, 0, v___x_241_);
                        v___x_243_ = v_reuseFailAlloc_244_;
                        state = 3;
                        continue;
                    }
                } else {
                    leanh::lean_del_object(v___x_238_);
                    v_a_228_ = v___x_225_;
                    state = 1;
                    continue;
                }
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_anyMUnsafe_any___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__2___boxed(
    ...
    mut v_stop_253_: *mut leanh::LeanObject,
    ...
    v_i_boxed_257_ = leanh::lean_unbox_usize(v_i_252_);
    leanh::lean_dec(v_i_252_);
    v_stop_boxed_258_ = leanh::lean_unbox_usize(v_stop_253_);
    leanh::lean_dec(v_stop_253_);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__0(
    mut v_as_278_: *mut leanh::LeanObject,
    mut v_sz_279_: usize,
    mut v_i_280_: usize,
    mut v_b_281_: *mut leanh::LeanObject,
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_285_ == 0 {
                    v___x_286_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_286_, 0, v_b_281_);
                    return v___x_286_;
                } else {
                    v_a_287_ = lean_array_uget_borrowed(v_as_278_, v_i_280_);
                    leanh::lean_inc_n(v_a_287_, 2);
                    v___f_288_ = leanh::lean_alloc_closure(l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__0___lam__0___boxed as *mut core::ffi::c_void, 8, 1);
                    leanh::lean_closure_set(v___f_288_, 0, v_a_287_);
                    v___x_289_ = leanh::lean_alloc_closure(
                        l_Lean_Elab_Command_liftTermElabM___boxed as *mut core::ffi::c_void,
                        5,
                        2,
                    );
                    leanh::lean_closure_set(v___x_289_, 0, leanh::lean_box(0));
                    leanh::lean_closure_set(v___x_289_, 1, v___f_288_);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Elab_Deriving_SizeOf_mkSizeOfHandler_spec__0___boxed(
    ...
    mut v_sz_296_: *mut leanh::LeanObject,
    mut v_i_297_: *mut leanh::LeanObject,
    ...
    v_sz_boxed_302_ = leanh::lean_unbox_usize(v_sz_296_);
    leanh::lean_dec(v_sz_296_);
    v_i_boxed_303_ = leanh::lean_unbox_usize(v_i_297_);
    leanh::lean_dec(v_i_297_);
    ...
    leanh::lean_dec_ref(v_as_295_);
    return v_res_304_;
}
pub unsafe fn l_Lean_Elab_Deriving_SizeOf_mkSizeOfHandler(
    mut v_declNames_305_: *mut leanh::LeanObject,
    ...
    let mut v_unused_323_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v___y_333_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_343_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v___x_336_ = leanh::lean_unsigned_to_nat(0);
                ...
                if v___x_338_ == 0 {
                    ...
                    if v___x_338_ == 0 {
                        ...
                        if leanh::lean_obj_tag(v___x_342_) == 0 {
                            v_a_343_ = leanh::lean_ctor_get(v___x_342_, 0);
                            leanh::lean_inc(v_a_343_);
                            leanh::lean_dec_ref_known(v___x_342_, 1);
                            v___x_344_ = (leanh::lean_unbox(v_a_343_) as u8);
                            leanh::lean_dec(v_a_343_);
            ...
            1 => {
                ...
                if leanh::lean_obj_tag(v___x_313_) == 0 {
                    v_isSharedCheck_322_ = (!leanh::lean_is_exclusive(v___x_313_)) as u8;
                    if v_isSharedCheck_322_ == 0 {
                        v_unused_323_ = leanh::lean_ctor_get(v___x_313_, 0);
                        leanh::lean_dec(v_unused_323_);
                    ...
                    v_a_324_ = leanh::lean_ctor_get(v___x_313_, 0);
                    v_isSharedCheck_331_ = (!leanh::lean_is_exclusive(v___x_313_)) as u8;
            ...
            2 => {
                v___x_317_ = 1;
                v___x_318_ = leanh::lean_box((v___x_317_) as usize);
                if v_isShared_316_ == 0 {
                    leanh::lean_ctor_set(v___x_315_, 0, v___x_318_);
                    v___x_320_ = v___x_315_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_321_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_321_, 0, v___x_318_);
            ...
            6 => {
                if leanh::lean_obj_tag(v___y_333_) == 0 {
                    v_a_334_ = leanh::lean_ctor_get(v___y_333_, 0);
                    v___x_335_ = (leanh::lean_unbox(v_a_334_) as u8);
                    if v___x_335_ == 0 {
                        return v___y_333_;
                    } else {
                        leanh::lean_dec_ref_known(v___y_333_, 1);
                        state = 1;
                        continue;
                    }
                } else {
...
pub unsafe fn l_Lean_Elab_Deriving_SizeOf_mkSizeOfHandler___boxed(
    mut v_declNames_346_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_declNames_346_);
    return v_res_350_;
}
...
pub unsafe fn initialize_Lean_Elab_Deriving_SizeOf(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
