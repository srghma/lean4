...
pub static l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppKey___closed__1_value:
    ...
    m_objs: [
        ...
        core::ptr::addr_of!(l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppKey___closed__0_value)
            as *mut leanh::LeanObject,
        5349567883337469548 as *mut leanh::LeanObject,
    ],
};
static mut l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppKey___closed__1:
    *mut leanh::LeanObject =
    core::ptr::addr_of!(l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppKey___closed__1_value)
        as *mut leanh::LeanObject;
pub static mut l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppKey: *mut leanh::LeanObject =
    core::ptr::addr_of!(l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppKey___closed__1_value)
        as *mut leanh::LeanObject;
...
pub static l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppPosKey___closed__1_value:
    ...
    m_objs: [
        ...
        2302941783115023138 as *mut leanh::LeanObject,
    ],
};
...
pub unsafe fn l_Lean_mkRecAppWithSyntax(
    mut v_e_68_: *mut leanh::LeanObject,
    mut v_stx_69_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    let mut v_m_73_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_val_77_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                leanh::lean_inc(v_stx_69_);
                v___x_72_ = leanh::lean_alloc_ctor(5, 1, (0) as u32);
                leanh::lean_ctor_set(v___x_72_, 0, v_stx_69_);
                v_m_73_ = l_Lean_KVMap_insert(v___x_70_, v___x_71_, v___x_72_);
                v___x_74_ = 0;
                v___x_75_ = l_Lean_Syntax_getPos_x3f(v_stx_69_, v___x_74_);
                leanh::lean_dec(v_stx_69_);
                if leanh::lean_obj_tag(v___x_75_) == 0 {
                    v___x_76_ = l_Lean_mkMData(v_m_73_, v_e_68_);
                    return v___x_76_;
                } else {
                    v_val_77_ = leanh::lean_ctor_get(v___x_75_, 0);
                    v_isSharedCheck_87_ = (!leanh::lean_is_exclusive(v___x_75_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_80_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_79_, 3);
                    v___x_83_ = v___x_79_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_86_ = leanh::lean_alloc_ctor(3, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_86_, 0, v_val_77_);
...
pub unsafe fn l_Lean_getRecAppSyntax_x3f(
    mut v_e_88_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_data_89_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_v_96_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_e_88_) == 10 {
                    v_data_89_ = leanh::lean_ctor_get(v_e_88_, 0);
                    v___x_90_ = l___private_Lean_Elab_RecAppSyntax_0__Lean_recAppKey;
                    v___x_91_ = l_Lean_KVMap_find(v_data_89_, v___x_90_);
                    if leanh::lean_obj_tag(v___x_91_) == 1 {
                        v_val_92_ = leanh::lean_ctor_get(v___x_91_, 0);
                        v_isSharedCheck_101_ = (!leanh::lean_is_exclusive(v___x_91_)) as u8;
            ...
            1 => {
                if leanh::lean_obj_tag(v_val_92_) == 5 {
                    v_v_96_ = leanh::lean_ctor_get(v_val_92_, 0);
                    leanh::lean_inc(v_v_96_);
                    leanh::lean_dec_ref_known(v_val_92_, 1);
                    if v_isShared_95_ == 0 {
                        leanh::lean_ctor_set(v___x_94_, 0, v_v_96_);
                        v___x_98_ = v___x_94_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_99_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_99_, 0, v_v_96_);
                        v___x_98_ = v_reuseFailAlloc_99_;
                        state = 2;
                        continue;
                    }
                } else {
                    leanh::lean_del_object(v___x_94_);
                    leanh::lean_dec(v_val_92_);
...
pub unsafe fn l_Lean_getRecAppSyntax_x3f___boxed(
    mut v_e_104_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_105_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_105_ = l_Lean_getRecAppSyntax_x3f(v_e_104_);
    leanh::lean_dec_ref(v_e_104_);
    return v_res_105_;
}
pub unsafe fn l_Lean_MData_isRecApp(mut v_d_106_: *mut leanh::LeanObject) -> u8 {
...
pub unsafe fn l_Lean_MData_isRecApp___boxed(
    mut v_d_109_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_110_: u8 = 0;
    let mut v_r_111_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_110_ = l_Lean_MData_isRecApp(v_d_109_);
    leanh::lean_dec(v_d_109_);
    v_r_111_ = leanh::lean_box((v_res_110_) as usize);
    return v_r_111_;
}
pub unsafe fn l_Lean_hasRecAppSyntax(mut v_e_112_: *mut leanh::LeanObject) -> u8 {
    if leanh::lean_obj_tag(v_e_112_) == 10 {
        let mut v_data_113_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_114_: u8 = 0;
        v_data_113_ = leanh::lean_ctor_get(v_e_112_, 0);
...
pub unsafe fn meta_initialize_Lean_Elab_RecAppSyntax(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Elab_RecAppSyntax(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
