...
use crate::ffi::{
    ...
    lean_instantiate_level_mvars, lean_nat_add, lean_nat_dec_eq, lean_nat_dec_lt, lean_st_ref_get,
...
static mut l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7___redArg___closed__2: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub static l_Lean_Meta_Sym_Simp_Theorems_rewrite___closed__0_value: leanh::LeanCtorObject<
    2,
...
static mut l_Lean_Meta_Sym_Simp_Theorems_rewrite___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l___private_Lean_Meta_Sym_Simp_Rewrite_0__Lean_Meta_Sym_Simp_mkValue(
    mut v_expr_1235_: *mut leanh::LeanObject,
    mut v_pattern_1236_: *mut leanh::LeanObject,
    mut v_us_1237_: *mut leanh::LeanObject,
    mut v_args_1238_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_levelParams_1240_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1241_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1242_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_us_1243_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_declName_1244_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_expr_1235_) == 4 {
                    v_us_1243_ = leanh::lean_ctor_get(v_expr_1235_, 1);
                    if leanh::lean_obj_tag(v_us_1243_) == 0 {
                        leanh::lean_dec_ref(v_pattern_1236_);
                        v_declName_1244_ = leanh::lean_ctor_get(v_expr_1235_, 0);
                        leanh::lean_inc(v_declName_1244_);
                        leanh::lean_dec_ref_known(v_expr_1235_, 2);
            ...
            1 => {
                v_levelParams_1240_ = leanh::lean_ctor_get(v_pattern_1236_, 0);
                leanh::lean_inc(v_levelParams_1240_);
                leanh::lean_dec_ref(v_pattern_1236_);
                ...
                leanh::lean_dec_ref(v_expr_1235_);
...
pub unsafe fn l___private_Lean_Meta_Sym_Simp_Rewrite_0__Lean_Meta_Sym_Simp_mkValue___boxed(
    mut v_expr_1247_: *mut leanh::LeanObject,
    mut v_pattern_1248_: *mut leanh::LeanObject,
    mut v_us_1249_: *mut leanh::LeanObject,
    mut v_args_1250_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_args_1250_);
    return v_res_1251_;
}
pub unsafe fn l___private_Lean_Meta_Sym_Simp_Rewrite_0__Lean_Meta_Sym_Simp_Theorem_rewrite_checkPerm(
    mut v_perm_1252_: u8,
    mut v_e_1253_: *mut leanh::LeanObject,
    mut v_result_1254_: *mut leanh::LeanObject,
    ...
    if v_perm_1252_ == 0 {
        ...
        leanh::lean_dec_ref(v_result_1254_);
        leanh::lean_dec_ref(v_e_1253_);
        v___x_1260_ = 1;
        v___x_1261_ = leanh::lean_box((v___x_1260_) as usize);
        v___x_1262_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l___private_Lean_Meta_Sym_Simp_Rewrite_0__Lean_Meta_Sym_Simp_Theorem_rewrite_checkPerm___boxed(
    mut v_perm_1265_: *mut leanh::LeanObject,
    mut v_e_1266_: *mut leanh::LeanObject,
    mut v_result_1267_: *mut leanh::LeanObject,
    ...
    v_perm_boxed_1273_ = (leanh::lean_unbox(v_perm_1265_) as u8);
    v_res_1274_ =
...
pub unsafe fn l_Lean_instantiateLevelMVars___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__0___redArg(
    ...
    let mut v_cache_1284_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_1285_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_1286_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_1287_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_mctx_1279_ = leanh::lean_ctor_get(v___x_1278_, 0);
                leanh::lean_inc_ref(v_mctx_1279_);
                ...
                leanh::lean_dec_ref(v___x_1280_);
                v___x_1283_ = lean_st_ref_take(v___y_1276_);
                v_cache_1284_ = leanh::lean_ctor_get(v___x_1283_, 1);
                v_zetaDeltaFVarIds_1285_ = leanh::lean_ctor_get(v___x_1283_, 2);
                v_postponed_1286_ = leanh::lean_ctor_get(v___x_1283_, 3);
                v_diag_1287_ = leanh::lean_ctor_get(v___x_1283_, 4);
                v_isSharedCheck_1296_ = (!leanh::lean_is_exclusive(v___x_1283_)) as u8;
                if v_isSharedCheck_1296_ == 0 {
                    v_unused_1297_ = leanh::lean_ctor_get(v___x_1283_, 0);
                    ...
                    leanh::lean_inc(v_diag_1287_);
                    leanh::lean_inc(v_postponed_1286_);
                    leanh::lean_inc(v_zetaDeltaFVarIds_1285_);
                    leanh::lean_inc(v_cache_1284_);
            ...
            1 => {
                if v_isShared_1290_ == 0 {
                    leanh::lean_ctor_set(v___x_1289_, 0, v_fst_1281_);
                    v___x_1292_ = v___x_1289_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_1295_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1295_, 0, v_fst_1281_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1295_, 1, v_cache_1284_);
                    leanh::lean_ctor_set(
                        v_reuseFailAlloc_1295_,
                        2,
                        v_zetaDeltaFVarIds_1285_,
                    );
                    leanh::lean_ctor_set(v_reuseFailAlloc_1295_, 3, v_postponed_1286_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1295_, 4, v_diag_1287_);
            ...
            2 => {
                ...
                leanh::lean_ctor_set(v___x_1294_, 0, v_snd_1282_);
                return v___x_1294_;
            }
            _ => {}
        }
...
pub unsafe fn l_Lean_instantiateLevelMVars___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__0___redArg___boxed(
    mut v_l_1298_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_instantiateLevelMVars___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__0(
    mut v_l_1302_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_instantiateLevelMVars___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__0___boxed(
    mut v_l_1314_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_withNewMCtxDepth___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__5___redArg___lam__0(
    mut v_k_1326_: *mut leanh::LeanObject,
    ...
    leanh::lean_inc(v___y_1331_);
    leanh::lean_inc_ref(v___y_1330_);
    leanh::lean_inc(v___y_1329_);
    leanh::lean_inc_ref(v___y_1328_);
    leanh::lean_inc(v___y_1327_);
    v___x_1337_ = leanh::lean_apply_10(
        v_k_1326_,
        v___y_1327_,
        v___y_1328_,
        v___y_1329_,
...
pub unsafe fn l_Lean_Meta_withNewMCtxDepth___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__5___redArg(
    mut v_k_1350_: *mut leanh::LeanObject,
    ...
    loop {
        match state {
            0 => {
                leanh::lean_inc(v___y_1356_);
                leanh::lean_inc_ref(v___y_1355_);
                leanh::lean_inc(v___y_1354_);
                leanh::lean_inc_ref(v___y_1353_);
                leanh::lean_inc(v___y_1352_);
                v___f_1362_ = leanh::lean_alloc_closure(l_Lean_Meta_withNewMCtxDepth___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__5___redArg___lam__0___boxed as *mut core::ffi::c_void, 11, 6);
                leanh::lean_closure_set(v___f_1362_, 0, v_k_1350_);
                leanh::lean_closure_set(v___f_1362_, 1, v___y_1352_);
                leanh::lean_closure_set(v___f_1362_, 2, v___y_1353_);
                leanh::lean_closure_set(v___f_1362_, 3, v___y_1354_);
                leanh::lean_closure_set(v___f_1362_, 4, v___y_1355_);
                leanh::lean_closure_set(v___f_1362_, 5, v___y_1356_);
                ...
                if leanh::lean_obj_tag(v___x_1363_) == 0 {
                    ...
                    v_isSharedCheck_1371_ = (!leanh::lean_is_exclusive(v___x_1363_)) as u8;
...
pub unsafe fn l_Lean_Meta_withNewMCtxDepth___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__5___redArg___boxed(
    ...
    mut v_allowLevelAssignments_1373_: *mut leanh::LeanObject,
    ...
    v_allowLevelAssignments_boxed_1384_ =
        (leanh::lean_unbox(v_allowLevelAssignments_1373_) as u8);
    v_res_1385_ =
...
pub unsafe fn l_Lean_Meta_withNewMCtxDepth___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__5___boxed(
    ...
    mut v_allowLevelAssignments_1402_: *mut leanh::LeanObject,
    ...
    v_allowLevelAssignments_boxed_1413_ =
        (leanh::lean_unbox(v_allowLevelAssignments_1402_) as u8);
    ...
    leanh::lean_dec_ref(v___y_1410_);
...
pub unsafe fn l_List_mapM_loop___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__1(
    ...
    let mut v_head_1429_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_1430_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_1415_) == 0 {
                    ...
                    v___x_1428_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_1428_, 0, v___x_1427_);
                    return v___x_1428_;
                } else {
                    v_head_1429_ = leanh::lean_ctor_get(v_x_1415_, 0);
                    v_tail_1430_ = leanh::lean_ctor_get(v_x_1415_, 1);
                    v_isSharedCheck_1440_ = (!leanh::lean_is_exclusive(v_x_1415_)) as u8;
                    if v_isSharedCheck_1440_ == 0 {
                        ...
                        leanh::lean_inc(v_tail_1430_);
                        leanh::lean_inc(v_head_1429_);
                        leanh::lean_dec(v_x_1415_);
            ...
            1 => {
                ...
                if v_isShared_1433_ == 0 {
                    leanh::lean_ctor_set(v___x_1432_, 1, v_x_1416_);
                    leanh::lean_ctor_set(v___x_1432_, 0, v_a_1435_);
                    v___x_1437_ = v___x_1432_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_1439_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1439_, 0, v_a_1435_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1439_, 1, v_x_1416_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNodeAux___at___00Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7_spec__10_spec__11___redArg(
    ...
    let mut v_ks_1458_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_1459_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_k_x27_1470_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_ks_1458_ = leanh::lean_ctor_get(v_x_1454_, 0);
                v_vs_1459_ = leanh::lean_ctor_get(v_x_1454_, 1);
                v_isSharedCheck_1483_ = (!leanh::lean_is_exclusive(v_x_1454_)) as u8;
                if v_isSharedCheck_1483_ == 0 {
                    ...
                    leanh::lean_inc(v_vs_1459_);
                    leanh::lean_inc(v_ks_1458_);
            ...
            1 => {
                ...
                if v___x_1464_ == 0 {
                    ...
                    if v_isShared_1462_ == 0 {
                        leanh::lean_ctor_set(v___x_1461_, 1, v___x_1466_);
                        leanh::lean_ctor_set(v___x_1461_, 0, v___x_1465_);
                        v___x_1468_ = v___x_1461_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_1469_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    ...
                    if v___x_1471_ == 0 {
                        if v_isShared_1462_ == 0 {
                            ...
                            leanh::lean_ctor_set(v_reuseFailAlloc_1477_, 0, v_ks_1458_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_1477_, 1, v_vs_1459_);
                        ...
                        leanh::lean_dec(v_x_1455_);
                        if v_isShared_1462_ == 0 {
                            leanh::lean_ctor_set(v___x_1461_, 1, v___x_1479_);
                            leanh::lean_ctor_set(v___x_1461_, 0, v___x_1478_);
                            ...
                            v_reuseFailAlloc_1482_ =
                                leanh::lean_alloc_ctor(1, 2, (0) as u32);
                            leanh::lean_ctor_set(v_reuseFailAlloc_1482_, 0, v___x_1478_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_1482_, 1, v___x_1479_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7_spec__10___redArg(
    ...
    mut v_v_1486_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7___redArg(
    ...
    let mut v_v_1512_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1513_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_xs_x27_1514_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_key_1521_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_node_1533_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_ks_1547_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_1548_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1550_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_1551_: u8 = 0;
    let mut v___x_1553_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_newNode_1554_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___y_1556_: u8 = 0;
    let mut v_ks_1557_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_1558_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_1496_) == 0 {
                    v_es_1501_ = leanh::lean_ctor_get(v_x_1496_, 0);
                    v___x_1502_ = 5usize;
                    v___x_1503_ = 1usize;
                    ...
                    if v___x_1508_ == 0 {
                        ...
                        leanh::lean_inc_ref(v_es_1501_);
                        v_isSharedCheck_1545_ = (!leanh::lean_is_exclusive(v_x_1496_)) as u8;
                        if v_isSharedCheck_1545_ == 0 {
                            v_unused_1546_ = leanh::lean_ctor_get(v_x_1496_, 0);
                    ...
                    v_ks_1547_ = leanh::lean_ctor_get(v_x_1496_, 0);
                    v_vs_1548_ = leanh::lean_ctor_get(v_x_1496_, 1);
                    v_isSharedCheck_1568_ = (!leanh::lean_is_exclusive(v_x_1496_)) as u8;
                    if v_isSharedCheck_1568_ == 0 {
                        ...
                        leanh::lean_inc(v_vs_1548_);
                        leanh::lean_inc(v_ks_1547_);
                        leanh::lean_dec(v_x_1496_);
            ...
            1 => {
                ...
                match leanh::lean_obj_tag(v_v_1512_) {
                    0 => {
                        v_key_1521_ = leanh::lean_ctor_get(v_v_1512_, 0);
                        v_val_1522_ = leanh::lean_ctor_get(v_v_1512_, 1);
                        v_isSharedCheck_1532_ = (!leanh::lean_is_exclusive(v_v_1512_)) as u8;
                        if v_isSharedCheck_1532_ == 0 {
                            ...
                            leanh::lean_inc(v_key_1521_);
                            leanh::lean_dec(v_v_1512_);
                    ...
                    1 => {
                        v_node_1533_ = leanh::lean_ctor_get(v_v_1512_, 0);
                        v_isSharedCheck_1543_ = (!leanh::lean_is_exclusive(v_v_1512_)) as u8;
                    ...
                    _ => {
                        ...
                        leanh::lean_ctor_set(v___x_1544_, 0, v_x_1499_);
                        leanh::lean_ctor_set(v___x_1544_, 1, v_x_1500_);
            ...
            2 => {
                ...
                if v_isShared_1511_ == 0 {
                    leanh::lean_ctor_set(v___x_1510_, 0, v___x_1517_);
                    v___x_1519_ = v___x_1510_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_1520_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1520_, 0, v___x_1517_);
            ...
            4 => {
                ...
                if v___x_1526_ == 0 {
                    ...
                    v___x_1528_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    ...
                    leanh::lean_dec(v_key_1521_);
                    if v_isShared_1525_ == 0 {
                        leanh::lean_ctor_set(v___x_1524_, 1, v_x_1500_);
                        leanh::lean_ctor_set(v___x_1524_, 0, v_x_1499_);
                        v___x_1530_ = v___x_1524_;
                        state = 5;
                        continue;
                    } else {
                        v_reuseFailAlloc_1531_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_1531_, 0, v_x_1499_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_1531_, 1, v_x_1500_);
            ...
            6 => {
                ...
                if v_isShared_1536_ == 0 {
                    leanh::lean_ctor_set(v___x_1535_, 0, v___x_1539_);
            ...
            8 => {
                if v_isShared_1551_ == 0 {
                    ...
                    v_reuseFailAlloc_1567_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1567_, 0, v_ks_1547_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1567_, 1, v_vs_1548_);
            ...
            9 => {
                ...
                if v___x_1563_ == 0 {
                    ...
                    v___x_1565_ = leanh::lean_unsigned_to_nat(4);
            ...
            10 => {
                if v___y_1556_ == 0 {
                    v_ks_1557_ = leanh::lean_ctor_get(v_newNode_1554_, 0);
                    leanh::lean_inc_ref(v_ks_1557_);
                    v_vs_1558_ = leanh::lean_ctor_get(v_newNode_1554_, 1);
                    leanh::lean_inc_ref(v_vs_1558_);
                    leanh::lean_dec_ref(v_newNode_1554_);
                    v___x_1559_ = leanh::lean_unsigned_to_nat(0);
                    ...
                    leanh::lean_dec_ref(v_vs_1558_);
                    leanh::lean_dec_ref(v_ks_1557_);
                    return v___x_1561_;
                } else {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7_spec__11___redArg(
    ...
    mut v_keys_1570_: *mut leanh::LeanObject,
    mut v_vals_1571_: *mut leanh::LeanObject,
    mut v_i_1572_: *mut leanh::LeanObject,
    mut v_entries_1573_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_1574_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1575_: u8 = 0;
    let mut v_k_1576_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_v_1577_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_1575_ == 0 {
                    ...
                    leanh::lean_dec(v_i_1572_);
                    leanh::lean_inc(v_v_1577_);
                    leanh::lean_inc(v_k_1576_);
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7_spec__11___redArg___boxed(
    mut v_depth_1589_: *mut leanh::LeanObject,
    mut v_keys_1590_: *mut leanh::LeanObject,
    mut v_vals_1591_: *mut leanh::LeanObject,
    mut v_i_1592_: *mut leanh::LeanObject,
    mut v_entries_1593_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_1594_: usize = 0;
    let mut v_res_1595_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_1594_ = leanh::lean_unbox_usize(v_depth_1589_);
    leanh::lean_dec(v_depth_1589_);
    ...
    leanh::lean_dec_ref(v_vals_1591_);
    leanh::lean_dec_ref(v_keys_1590_);
    return v_res_1595_;
}
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7___redArg___boxed(
    ...
    v_x_34068__boxed_1601_ = leanh::lean_unbox_usize(v_x_1597_);
    leanh::lean_dec(v_x_1597_);
    v_x_34069__boxed_1602_ = leanh::lean_unbox_usize(v_x_1598_);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3___redArg(
    mut v_mvarId_1611_: *mut leanh::LeanObject,
    mut v_val_1612_: *mut leanh::LeanObject,
    mut v___y_1613_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_1615_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mctx_1616_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_1617_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_1618_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_1619_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_1620_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1622_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_1623_: u8 = 0;
    let mut v_depth_1624_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_levelAssignDepth_1625_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lmvarCounter_1626_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mvarCounter_1627_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lDecls_1628_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_decls_1629_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_userNames_1630_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lAssignment_1631_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_eAssignment_1632_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_dAssignment_1633_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_mctx_1616_ = leanh::lean_ctor_get(v___x_1615_, 0);
                v_cache_1617_ = leanh::lean_ctor_get(v___x_1615_, 1);
                v_zetaDeltaFVarIds_1618_ = leanh::lean_ctor_get(v___x_1615_, 2);
                v_postponed_1619_ = leanh::lean_ctor_get(v___x_1615_, 3);
                v_diag_1620_ = leanh::lean_ctor_get(v___x_1615_, 4);
                v_isSharedCheck_1648_ = (!leanh::lean_is_exclusive(v___x_1615_)) as u8;
                if v_isSharedCheck_1648_ == 0 {
                    ...
                    leanh::lean_inc(v_diag_1620_);
                    leanh::lean_inc(v_postponed_1619_);
                    leanh::lean_inc(v_zetaDeltaFVarIds_1618_);
                    leanh::lean_inc(v_cache_1617_);
                    leanh::lean_inc(v_mctx_1616_);
            ...
            1 => {
                v_depth_1624_ = leanh::lean_ctor_get(v_mctx_1616_, 0);
                v_levelAssignDepth_1625_ = leanh::lean_ctor_get(v_mctx_1616_, 1);
                v_lmvarCounter_1626_ = leanh::lean_ctor_get(v_mctx_1616_, 2);
                v_mvarCounter_1627_ = leanh::lean_ctor_get(v_mctx_1616_, 3);
                v_lDecls_1628_ = leanh::lean_ctor_get(v_mctx_1616_, 4);
                v_decls_1629_ = leanh::lean_ctor_get(v_mctx_1616_, 5);
                v_userNames_1630_ = leanh::lean_ctor_get(v_mctx_1616_, 6);
                v_lAssignment_1631_ = leanh::lean_ctor_get(v_mctx_1616_, 7);
                v_eAssignment_1632_ = leanh::lean_ctor_get(v_mctx_1616_, 8);
                v_dAssignment_1633_ = leanh::lean_ctor_get(v_mctx_1616_, 9);
                v_isSharedCheck_1647_ = (!leanh::lean_is_exclusive(v_mctx_1616_)) as u8;
                if v_isSharedCheck_1647_ == 0 {
                    ...
                    leanh::lean_inc(v_dAssignment_1633_);
                    leanh::lean_inc(v_eAssignment_1632_);
                    leanh::lean_inc(v_lAssignment_1631_);
                    leanh::lean_inc(v_userNames_1630_);
                    leanh::lean_inc(v_decls_1629_);
                    leanh::lean_inc(v_lDecls_1628_);
                    leanh::lean_inc(v_mvarCounter_1627_);
                    leanh::lean_inc(v_lmvarCounter_1626_);
                    leanh::lean_inc(v_levelAssignDepth_1625_);
                    leanh::lean_inc(v_depth_1624_);
                    leanh::lean_dec(v_mctx_1616_);
            ...
            2 => {
                ...
                if v_isShared_1636_ == 0 {
                    leanh::lean_ctor_set(v___x_1635_, 8, v___x_1637_);
                    v___x_1639_ = v___x_1635_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_1646_ = leanh::lean_alloc_ctor(0, 10, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 0, v_depth_1624_);
                    leanh::lean_ctor_set(
                        v_reuseFailAlloc_1646_,
                        1,
                        v_levelAssignDepth_1625_,
                    );
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 2, v_lmvarCounter_1626_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 3, v_mvarCounter_1627_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 4, v_lDecls_1628_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 5, v_decls_1629_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 6, v_userNames_1630_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 7, v_lAssignment_1631_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 8, v___x_1637_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1646_, 9, v_dAssignment_1633_);
            ...
            3 => {
                if v_isShared_1623_ == 0 {
                    leanh::lean_ctor_set(v___x_1622_, 0, v___x_1639_);
                    v___x_1641_ = v___x_1622_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_1645_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1645_, 0, v___x_1639_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1645_, 1, v_cache_1617_);
                    leanh::lean_ctor_set(
                        v_reuseFailAlloc_1645_,
                        2,
                        v_zetaDeltaFVarIds_1618_,
                    );
                    leanh::lean_ctor_set(v_reuseFailAlloc_1645_, 3, v_postponed_1619_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1645_, 4, v_diag_1620_);
            ...
            4 => {
                ...
                v___x_1644_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3___redArg___boxed(
    ...
    mut v_val_1650_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_containsAtAux___at___00Lean_PersistentHashMap_containsAux___at___00Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2_spec__4_spec__7___redArg___boxed(
    ...
    mut v_i_1665_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_k_1666_);
    leanh::lean_dec_ref(v_keys_1664_);
...
pub unsafe fn l_Lean_PersistentHashMap_containsAux___at___00Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2_spec__4___redArg(
    ...
    let mut v_es_1672_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1673_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1674_: usize = 0;
    let mut v___x_1675_: usize = 0;
    let mut v___x_1676_: usize = 0;
    let mut v_j_1677_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1678_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_key_1679_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1680_: u8 = 0;
    let mut v_node_1681_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_1669_) == 0 {
                    v_es_1672_ = leanh::lean_ctor_get(v_x_1669_, 0);
                    v___x_1673_ = leanh::lean_box(2);
                    v___x_1674_ = 5usize;
                    v___x_1675_ = leanh::lean_usize_once(core::ptr::addr_of_mut!(l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7___redArg___closed__1), core::ptr::addr_of_mut!(l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7___redArg___closed__1_once), _init_l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7___redArg___closed__1);
                    ...
                    leanh::lean_dec(v_j_1677_);
                    match leanh::lean_obj_tag(v___x_1678_) {
                        0 => {
                            v_key_1679_ = leanh::lean_ctor_get(v___x_1678_, 0);
                            v___x_1680_ = l_Lean_instBEqMVarId_beq(v_x_1671_, v_key_1679_);
                            return v___x_1680_;
                        }
                        1 => {
                            v_node_1681_ = leanh::lean_ctor_get(v___x_1678_, 0);
                    ...
                    v_ks_1685_ = leanh::lean_ctor_get(v_x_1669_, 0);
...
pub unsafe fn l_Lean_PersistentHashMap_containsAux___at___00Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2_spec__4___redArg___boxed(
    ...
    v_x_34306__boxed_1691_ = leanh::lean_unbox_usize(v_x_1689_);
...
pub unsafe fn l_Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2___redArg(
    ...
    leanh::lean_inc_ref(v_mctx_1707_);
    leanh::lean_dec(v___x_1706_);
    v_eAssignment_1708_ = leanh::lean_ctor_get(v_mctx_1707_, 8);
    leanh::lean_inc_ref(v_eAssignment_1708_);
    leanh::lean_dec_ref(v_mctx_1707_);
    ...
    leanh::lean_dec_ref(v_eAssignment_1708_);
    v___x_1710_ = leanh::lean_box((v___x_1709_) as usize);
...
pub unsafe fn l_WellFounded_opaqueFix_u2083___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__4___redArg(
    ...
    let mut v_snd_1737_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1739_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_1740_: u8 = 0;
    let mut v_fst_1741_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_1742_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1744_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_1745_: u8 = 0;
    let mut v___x_1746_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1747_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mvarId_1748_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_type_1754_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_proof_1776_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_1735_ == 0 {
                    ...
                    leanh::lean_dec_ref(v_d_1717_);
                    v___x_1736_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_1736_, 0, v_b_1719_);
                    return v___x_1736_;
                } else {
                    v_snd_1737_ = leanh::lean_ctor_get(v_b_1719_, 1);
                    v_isSharedCheck_1871_ = (!leanh::lean_is_exclusive(v_b_1719_)) as u8;
                    if v_isSharedCheck_1871_ == 0 {
                        v_unused_1872_ = leanh::lean_ctor_get(v_b_1719_, 0);
                        ...
                        leanh::lean_inc(v_snd_1737_);
                        leanh::lean_dec(v_b_1719_);
            ...
            2 => {
                v_fst_1741_ = leanh::lean_ctor_get(v_snd_1737_, 0);
                v_snd_1742_ = leanh::lean_ctor_get(v_snd_1737_, 1);
                v_isSharedCheck_1870_ = (!leanh::lean_is_exclusive(v_snd_1737_)) as u8;
                if v_isSharedCheck_1870_ == 0 {
                    ...
                    leanh::lean_inc(v_snd_1742_);
                    leanh::lean_inc(v_fst_1741_);
                    leanh::lean_dec(v_snd_1737_);
            ...
            3 => {
                ...
                if leanh::lean_obj_tag(v___x_1747_) == 2 {
                    v_mvarId_1748_ = leanh::lean_ctor_get(v___x_1747_, 0);
                    ...
                    if leanh::lean_obj_tag(v___x_1749_) == 0 {
                        ...
                        v___x_1751_ = (leanh::lean_unbox(v_a_1750_) as u8);
                        ...
                        if v___x_1751_ == 0 {
                            ...
                            if leanh::lean_obj_tag(v___x_1752_) == 0 {
                                ...
                                v_type_1754_ = leanh::lean_ctor_get(v_a_1753_, 2);
                                leanh::lean_inc_ref(v_type_1754_);
                                leanh::lean_dec(v_a_1753_);
                                leanh::lean_inc_ref(v_d_1717_);
                                leanh::lean_inc(v___y_1728_);
                                leanh::lean_inc_ref(v___y_1727_);
                                leanh::lean_inc(v___y_1726_);
                                leanh::lean_inc_ref(v___y_1725_);
                                ...
                                v___x_1755_ = leanh::lean_apply_11(
                                    v_d_1717_,
                                    v_type_1754_,
                                    v___y_1720_,
                                    v___y_1721_,
                                ...
                                if leanh::lean_obj_tag(v___x_1755_) == 0 {
                                    ...
                                    leanh::lean_dec(v_snd_1742_);
                                    leanh::lean_dec(v_fst_1741_);
                                    leanh::lean_del_object(v___x_1739_);
                                    leanh::lean_dec(v_a_1718_);
                                    leanh::lean_dec_ref(v_d_1717_);
                                    v_a_1805_ = leanh::lean_ctor_get(v___x_1755_, 0);
                                ...
                                leanh::lean_dec(v_a_1718_);
                                leanh::lean_dec_ref(v_d_1717_);
                                v_a_1813_ = leanh::lean_ctor_get(v___x_1752_, 0);
                            ...
                            leanh::lean_inc_ref(v___x_1747_);
                            ...
                            if leanh::lean_obj_tag(v___x_1821_) == 0 {
                                ...
                                if v_isShared_1745_ == 0 {
                                    leanh::lean_ctor_set(v___x_1744_, 0, v___x_1823_);
                                ...
                                leanh::lean_dec(v_a_1718_);
                                leanh::lean_dec_ref(v_d_1717_);
                                v_a_1830_ = leanh::lean_ctor_get(v___x_1821_, 0);
                                v_isSharedCheck_1837_ =
                                    (!leanh::lean_is_exclusive(v___x_1821_)) as u8;
                        ...
                        leanh::lean_dec(v_a_1718_);
                        leanh::lean_dec_ref(v_d_1717_);
                        v_a_1838_ = leanh::lean_ctor_get(v___x_1749_, 0);
                        v_isSharedCheck_1845_ =
                            (!leanh::lean_is_exclusive(v___x_1749_)) as u8;
                    ...
                    if v___x_1846_ == 0 {
                        if v_isShared_1745_ == 0 {
                            ...
                            v_reuseFailAlloc_1852_ =
                                leanh::lean_alloc_ctor(0, 2, (0) as u32);
                            leanh::lean_ctor_set(v_reuseFailAlloc_1852_, 0, v_fst_1741_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_1852_, 1, v_snd_1742_);
                        ...
                        if leanh::lean_obj_tag(v___x_1853_) == 0 {
                            ...
                            if v_isShared_1745_ == 0 {
                                leanh::lean_ctor_set(v___x_1744_, 0, v___x_1855_);
                                ...
                                v_reuseFailAlloc_1861_ =
                                    leanh::lean_alloc_ctor(0, 2, (0) as u32);
                                leanh::lean_ctor_set(v_reuseFailAlloc_1861_, 0, v___x_1855_);
                                leanh::lean_ctor_set(v_reuseFailAlloc_1861_, 1, v_snd_1742_);
                            ...
                            leanh::lean_dec(v_a_1718_);
                            leanh::lean_dec_ref(v_d_1717_);
                            v_a_1862_ = leanh::lean_ctor_get(v___x_1853_, 0);
            ...
            4 => {
                if leanh::lean_obj_tag(v_a_1756_) == 0 {
                    leanh::lean_dec(v_a_1718_);
                    leanh::lean_dec_ref(v_d_1717_);
                    v___x_1774_ = (leanh::lean_unbox(v_snd_1742_) as u8);
                    leanh::lean_dec(v_snd_1742_);
                    if v___x_1774_ == 0 {
                        v_contextDependent_1775_ =
                            leanh::lean_ctor_get_uint8(v_a_1756_, 0 as u32);
                        leanh::lean_dec_ref_known(v_a_1756_, 0);
                    ...
                    leanh::lean_del_object(v___x_1758_);
                    leanh::lean_del_object(v___x_1744_);
                    leanh::lean_del_object(v___x_1739_);
                    v_proof_1776_ = leanh::lean_ctor_get(v_a_1756_, 0);
                    leanh::lean_inc_ref(v_proof_1776_);
                    v_contextDependent_1777_ = leanh::lean_ctor_get_uint8(
                        v_a_1756_,
                        (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                    );
                    leanh::lean_dec_ref_known(v_a_1756_, 1);
                    v___x_1803_ = (leanh::lean_unbox(v_snd_1742_) as u8);
                    leanh::lean_dec(v_snd_1742_);
                    if v___x_1803_ == 0 {
            ...
            5 => {
                ...
                v___x_1764_ = leanh::lean_box((v___y_1761_) as usize);
                if v_isShared_1745_ == 0 {
                    leanh::lean_ctor_set(v___x_1744_, 1, v___x_1764_);
                    v___x_1766_ = v___x_1744_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_1773_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1773_, 0, v_fst_1741_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1773_, 1, v___x_1764_);
            ...
            6 => {
                if v_isShared_1740_ == 0 {
                    leanh::lean_ctor_set(v___x_1739_, 1, v___x_1766_);
                    leanh::lean_ctor_set(v___x_1739_, 0, v___x_1763_);
                    v___x_1768_ = v___x_1739_;
                    state = 7;
                    continue;
                } else {
                    v_reuseFailAlloc_1772_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1772_, 0, v___x_1763_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1772_, 1, v___x_1766_);
            ...
            7 => {
                if v_isShared_1759_ == 0 {
                    leanh::lean_ctor_set(v___x_1758_, 0, v___x_1768_);
            ...
            9 => {
                ...
                if leanh::lean_obj_tag(v___x_1780_) == 0 {
                    ...
                    if leanh::lean_obj_tag(v___x_1782_) == 0 {
                        leanh::lean_dec_ref_known(v___x_1782_, 1);
                        v___x_1783_ = lean_array_fset(v_fst_1741_, v_a_1718_, v_a_1781_);
                        v___x_1784_ = leanh::lean_box((v___y_1779_) as usize);
                        v___x_1785_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v___x_1785_, 0, v___x_1783_);
                        leanh::lean_ctor_set(v___x_1785_, 1, v___x_1784_);
                        v___x_1786_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v___x_1786_, 0, v___x_1746_);
                        ...
                        leanh::lean_dec(v_a_1718_);
                        leanh::lean_dec_ref(v_d_1717_);
                        v_a_1787_ = leanh::lean_ctor_get(v___x_1782_, 0);
                        v_isSharedCheck_1794_ =
                            (!leanh::lean_is_exclusive(v___x_1782_)) as u8;
                    ...
                    leanh::lean_dec(v_a_1718_);
                    leanh::lean_dec_ref(v_d_1717_);
                    v_a_1795_ = leanh::lean_ctor_get(v___x_1780_, 0);
                    v_isSharedCheck_1802_ = (!leanh::lean_is_exclusive(v___x_1780_)) as u8;
            ...
            10 => {
                if v_isShared_1790_ == 0 {
                    ...
                    v_reuseFailAlloc_1793_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1793_, 0, v_a_1787_);
            ...
            12 => {
                if v_isShared_1798_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_1801_, 0, v_a_1795_);
            ...
            18 => {
                if v_isShared_1740_ == 0 {
                    leanh::lean_ctor_set(v___x_1739_, 1, v___x_1825_);
                    leanh::lean_ctor_set(v___x_1739_, 0, v___x_1746_);
                    v___x_1827_ = v___x_1739_;
                    state = 19;
                    continue;
                } else {
                    v_reuseFailAlloc_1828_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1828_, 0, v___x_1746_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1828_, 1, v___x_1825_);
            ...
            24 => {
                if v_isShared_1740_ == 0 {
                    leanh::lean_ctor_set(v___x_1739_, 1, v___x_1848_);
                    leanh::lean_ctor_set(v___x_1739_, 0, v___x_1746_);
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_1851_, 0, v___x_1746_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1851_, 1, v___x_1848_);
            ...
            26 => {
                if v_isShared_1740_ == 0 {
                    leanh::lean_ctor_set(v___x_1739_, 1, v___x_1857_);
                    leanh::lean_ctor_set(v___x_1739_, 0, v___x_1746_);
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_1860_, 0, v___x_1746_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1860_, 1, v___x_1857_);
...
pub unsafe fn l_WellFounded_opaqueFix_u2083___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__4___redArg___boxed(
    mut v_upperBound_1873_: *mut leanh::LeanObject,
    mut v_d_1874_: *mut leanh::LeanObject,
    mut v_a_1875_: *mut leanh::LeanObject,
    mut v_b_1876_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_upperBound_1873_);
    return v_res_1887_;
}
pub unsafe fn l_Lean_Meta_Sym_Simp_Theorem_rewrite___lam__0(
    mut v_pattern_1890_: *mut leanh::LeanObject,
    mut v_e_1891_: *mut leanh::LeanObject,
    mut v___x_1892_: u8,
    mut v_d_1893_: *mut leanh::LeanObject,
    mut v_expr_1894_: *mut leanh::LeanObject,
    mut v_rhs_1895_: *mut leanh::LeanObject,
    mut v_perm_1896_: u8,
    ...
    let mut v_us_1913_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_args_1914_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_levelParams_1938_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                leanh::lean_inc_ref(v_e_1891_);
                leanh::lean_inc_ref(v_pattern_1890_);
                ...
                if leanh::lean_obj_tag(v___x_1907_) == 0 {
                    ...
                    v_isSharedCheck_2024_ = (!leanh::lean_is_exclusive(v___x_1907_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_expr_1894_);
                    leanh::lean_dec_ref(v_d_1893_);
                    leanh::lean_dec_ref(v_e_1891_);
                    leanh::lean_dec_ref(v_pattern_1890_);
                    v_a_2025_ = leanh::lean_ctor_get(v___x_1907_, 0);
                    v_isSharedCheck_2032_ = (!leanh::lean_is_exclusive(v___x_1907_)) as u8;
            ...
            1 => {
                if leanh::lean_obj_tag(v_a_1908_) == 1 {
                    leanh::lean_del_object(v___x_1910_);
                    v_val_1912_ = leanh::lean_ctor_get(v_a_1908_, 0);
                    leanh::lean_inc(v_val_1912_);
                    leanh::lean_dec_ref_known(v_a_1908_, 1);
                    v_us_1913_ = leanh::lean_ctor_get(v_val_1912_, 0);
                    v_args_1914_ = leanh::lean_ctor_get(v_val_1912_, 1);
                    v_isSharedCheck_2019_ = (!leanh::lean_is_exclusive(v_val_1912_)) as u8;
                    if v_isSharedCheck_2019_ == 0 {
                        ...
                        leanh::lean_inc(v_args_1914_);
                        leanh::lean_inc(v_us_1913_);
                        leanh::lean_dec(v_val_1912_);
                    ...
                    if v_isShared_1911_ == 0 {
                        leanh::lean_ctor_set(v___x_1910_, 0, v___x_2020_);
            ...
            2 => {
                ...
                if leanh::lean_obj_tag(v___x_1919_) == 0 {
                    ...
                    v___x_1925_ = leanh::lean_box((v___x_1923_) as usize);
                    if v_isShared_1917_ == 0 {
                        leanh::lean_ctor_set(v___x_1916_, 1, v___x_1925_);
                        leanh::lean_ctor_set(v___x_1916_, 0, v_args_1914_);
                        v___x_1927_ = v___x_1916_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_2010_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_2010_, 0, v_args_1914_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_2010_, 1, v___x_1925_);
                    ...
                    leanh::lean_dec_ref(v_args_1914_);
                    leanh::lean_dec_ref(v_expr_1894_);
                    leanh::lean_dec_ref(v_d_1893_);
                    leanh::lean_dec_ref(v_e_1891_);
                    leanh::lean_dec_ref(v_pattern_1890_);
                    v_a_2011_ = leanh::lean_ctor_get(v___x_1919_, 0);
                    v_isSharedCheck_2018_ = (!leanh::lean_is_exclusive(v___x_1919_)) as u8;
            ...
            3 => {
                ...
                leanh::lean_ctor_set(v___x_1928_, 0, v___x_1924_);
                ...
                if leanh::lean_obj_tag(v___x_1929_) == 0 {
                    ...
                    v_isSharedCheck_2001_ = (!leanh::lean_is_exclusive(v___x_1929_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_e_1891_);
                    leanh::lean_dec_ref(v_pattern_1890_);
                    v_a_2002_ = leanh::lean_ctor_get(v___x_1929_, 0);
                    v_isSharedCheck_2009_ = (!leanh::lean_is_exclusive(v___x_1929_)) as u8;
            ...
            4 => {
                v_fst_1934_ = leanh::lean_ctor_get(v_a_1930_, 0);
                if leanh::lean_obj_tag(v_fst_1934_) == 0 {
                    leanh::lean_del_object(v___x_1932_);
                    v_snd_1935_ = leanh::lean_ctor_get(v_a_1930_, 1);
                    leanh::lean_inc(v_snd_1935_);
                    leanh::lean_dec(v_a_1930_);
                    v_fst_1936_ = leanh::lean_ctor_get(v_snd_1935_, 0);
                    leanh::lean_inc(v_fst_1936_);
                    v_snd_1937_ = leanh::lean_ctor_get(v_snd_1935_, 1);
                    leanh::lean_inc(v_snd_1937_);
                    leanh::lean_dec(v_snd_1935_);
                    v_levelParams_1938_ = leanh::lean_ctor_get(v_pattern_1890_, 0);
                    leanh::lean_inc(v_levelParams_1938_);
                    leanh::lean_inc(v_a_1920_);
                    v___x_1939_ =
                    ...
                    if leanh::lean_obj_tag(v___x_1941_) == 0 {
                        ...
                        if leanh::lean_obj_tag(v___x_1943_) == 0 {
                            ...
                            leanh::lean_dec(v_snd_1937_);
                            leanh::lean_dec_ref(v_e_1891_);
                            v_a_1981_ = leanh::lean_ctor_get(v___x_1943_, 0);
                        ...
                        leanh::lean_dec(v_fst_1936_);
                        leanh::lean_dec_ref(v_e_1891_);
                        v_a_1989_ = leanh::lean_ctor_get(v___x_1941_, 0);
                    ...
                    leanh::lean_inc_ref(v_fst_1934_);
                    leanh::lean_dec(v_a_1930_);
                    leanh::lean_dec(v_a_1920_);
                    leanh::lean_dec_ref(v_expr_1894_);
                    leanh::lean_dec_ref(v_e_1891_);
                    leanh::lean_dec_ref(v_pattern_1890_);
                    v_val_1997_ = leanh::lean_ctor_get(v_fst_1934_, 0);
                    leanh::lean_inc(v_val_1997_);
                    leanh::lean_dec_ref_known(v_fst_1934_, 1);
                    if v_isShared_1933_ == 0 {
                        leanh::lean_ctor_set(v___x_1932_, 0, v_val_1997_);
            ...
            5 => {
                ...
                if v___x_1948_ == 0 {
                    ...
                    if leanh::lean_obj_tag(v___x_1949_) == 0 {
                        ...
                        leanh::lean_del_object(v___x_1946_);
                        leanh::lean_dec(v_a_1944_);
                        leanh::lean_dec_ref(v___x_1939_);
                        leanh::lean_dec(v_snd_1937_);
                        v_a_1967_ = leanh::lean_ctor_get(v___x_1949_, 0);
                    ...
                    leanh::lean_dec_ref(v___x_1939_);
                    leanh::lean_dec_ref(v_e_1891_);
                    v___x_1975_ = (leanh::lean_unbox(v_snd_1937_) as u8);
                    leanh::lean_dec(v_snd_1937_);
                    v___x_1976_ = l_Lean_Meta_Sym_Simp_mkRflResultCD(v___x_1975_);
                    if v_isShared_1947_ == 0 {
                        leanh::lean_ctor_set(v___x_1946_, 0, v___x_1976_);
            ...
            6 => {
                v___x_1960_ = (leanh::lean_unbox(v_a_1950_) as u8);
                ...
                if v___x_1960_ == 0 {
                    ...
                    if v___x_1948_ == 0 {
                        leanh::lean_del_object(v___x_1952_);
                        v___x_1961_ = leanh::lean_alloc_ctor(1, 2, (2) as u32);
                        leanh::lean_ctor_set(v___x_1961_, 0, v_a_1944_);
                        leanh::lean_ctor_set(v___x_1961_, 1, v___x_1939_);
                        leanh::lean_ctor_set_uint8(
                            v___x_1961_,
                            (core::mem::size_of::<*mut leanh::LeanObject>() * 2) as u32,
                            v___x_1923_,
                        );
                        v___x_1962_ = (leanh::lean_unbox(v_snd_1937_) as u8);
                        leanh::lean_dec(v_snd_1937_);
                        leanh::lean_ctor_set_uint8(
                            v___x_1961_,
                        ...
                        if v_isShared_1947_ == 0 {
                            leanh::lean_ctor_set(v___x_1946_, 0, v___x_1961_);
                            ...
                            leanh::lean_ctor_set(v_reuseFailAlloc_1965_, 0, v___x_1961_);
            ...
            7 => {
                v___x_1955_ = (leanh::lean_unbox(v_snd_1937_) as u8);
                leanh::lean_dec(v_snd_1937_);
                v___x_1956_ = l_Lean_Meta_Sym_Simp_mkRflResultCD(v___x_1955_);
                if v_isShared_1953_ == 0 {
                    leanh::lean_ctor_set(v___x_1952_, 0, v___x_1956_);
                    v___x_1958_ = v___x_1952_;
                    state = 8;
                    continue;
                } else {
                    v_reuseFailAlloc_1959_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_Meta_Sym_Simp_Theorem_rewrite___lam__0___boxed(
    ...
    let mut v_pattern_2033_: *mut leanh::LeanObject = *_args.add(0);
    let mut v_e_2034_: *mut leanh::LeanObject = *_args.add(1);
    let mut v___x_2035_: *mut leanh::LeanObject = *_args.add(2);
    let mut v_d_2036_: *mut leanh::LeanObject = *_args.add(3);
    let mut v_expr_2037_: *mut leanh::LeanObject = *_args.add(4);
    let mut v_rhs_2038_: *mut leanh::LeanObject = *_args.add(5);
    let mut v_perm_2039_: *mut leanh::LeanObject = *_args.add(6);
    let mut v___y_2040_: *mut leanh::LeanObject = *_args.add(7);
    let mut v___y_2041_: *mut leanh::LeanObject = *_args.add(8);
    let mut v___y_2042_: *mut leanh::LeanObject = *_args.add(9);
    let mut v___y_2043_: *mut leanh::LeanObject = *_args.add(10);
    let mut v___y_2044_: *mut leanh::LeanObject = *_args.add(11);
    let mut v___y_2045_: *mut leanh::LeanObject = *_args.add(12);
    let mut v___y_2046_: *mut leanh::LeanObject = *_args.add(13);
    let mut v___y_2047_: *mut leanh::LeanObject = *_args.add(14);
    let mut v___y_2048_: *mut leanh::LeanObject = *_args.add(15);
    let mut v___y_2049_: *mut leanh::LeanObject = *_args.add(16);
    ...
    v___x_34692__boxed_2050_ = (leanh::lean_unbox(v___x_2035_) as u8);
    v_perm_boxed_2051_ = (leanh::lean_unbox(v_perm_2039_) as u8);
    ...
    leanh::lean_dec_ref(v_rhs_2038_);
    return v_res_2052_;
}
pub unsafe fn l_Lean_Meta_Sym_Simp_Theorem_rewrite(
    mut v_thm_2053_: *mut leanh::LeanObject,
    mut v_e_2054_: *mut leanh::LeanObject,
    mut v_d_2055_: *mut leanh::LeanObject,
    ...
    let mut v_expr_2066_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_pattern_2067_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_2068_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_expr_2066_ = leanh::lean_ctor_get(v_thm_2053_, 0);
    leanh::lean_inc_ref(v_expr_2066_);
    v_pattern_2067_ = leanh::lean_ctor_get(v_thm_2053_, 1);
    leanh::lean_inc_ref(v_pattern_2067_);
    v_rhs_2068_ = leanh::lean_ctor_get(v_thm_2053_, 2);
    leanh::lean_inc_ref(v_rhs_2068_);
    v_perm_2069_ = leanh::lean_ctor_get_uint8(
        v_thm_2053_,
        (core::mem::size_of::<*mut leanh::LeanObject>() * 3) as u32,
    );
    leanh::lean_dec_ref(v_thm_2053_);
    v___x_2070_ = 1;
    v___x_2071_ = leanh::lean_box((v___x_2070_) as usize);
    v___x_2072_ = leanh::lean_box((v_perm_2069_) as usize);
    v___f_2073_ = leanh::lean_alloc_closure(
        l_Lean_Meta_Sym_Simp_Theorem_rewrite___lam__0___boxed as *mut core::ffi::c_void,
        17,
        7,
    );
    leanh::lean_closure_set(v___f_2073_, 0, v_pattern_2067_);
    leanh::lean_closure_set(v___f_2073_, 1, v_e_2054_);
    leanh::lean_closure_set(v___f_2073_, 2, v___x_2071_);
    leanh::lean_closure_set(v___f_2073_, 3, v_d_2055_);
    leanh::lean_closure_set(v___f_2073_, 4, v_expr_2066_);
    leanh::lean_closure_set(v___f_2073_, 5, v_rhs_2068_);
    leanh::lean_closure_set(v___f_2073_, 6, v___x_2072_);
    v___x_2074_ = 0;
    v___x_2075_ =
        l_Lean_Meta_withNewMCtxDepth___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__5___redArg(
            v___f_2073_,
...
pub unsafe fn l_Lean_Meta_Sym_Simp_Theorem_rewrite___boxed(
    mut v_thm_2076_: *mut leanh::LeanObject,
    mut v_e_2077_: *mut leanh::LeanObject,
    mut v_d_2078_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2(
    mut v_mvarId_2090_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2___boxed(
    mut v_mvarId_2102_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_mvarId_2102_);
    return v_res_2113_;
}
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3(
    mut v_mvarId_2114_: *mut leanh::LeanObject,
    mut v_val_2115_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3___boxed(
    mut v_mvarId_2127_: *mut leanh::LeanObject,
    mut v_val_2128_: *mut leanh::LeanObject,
...
pub unsafe fn l_WellFounded_opaqueFix_u2083___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__4(
    mut v_upperBound_2140_: *mut leanh::LeanObject,
    mut v_d_2141_: *mut leanh::LeanObject,
    mut v___x_2142_: *mut leanh::LeanObject,
    mut v_inst_2143_: *mut leanh::LeanObject,
    mut v_R_2144_: *mut leanh::LeanObject,
    mut v_a_2145_: *mut leanh::LeanObject,
    mut v_b_2146_: *mut leanh::LeanObject,
    mut v_c_2147_: *mut leanh::LeanObject,
...
pub unsafe fn l_WellFounded_opaqueFix_u2083___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__4___boxed(
    ...
    let mut v_upperBound_2159_: *mut leanh::LeanObject = *_args.add(0);
    let mut v_d_2160_: *mut leanh::LeanObject = *_args.add(1);
    let mut v___x_2161_: *mut leanh::LeanObject = *_args.add(2);
    let mut v_inst_2162_: *mut leanh::LeanObject = *_args.add(3);
    let mut v_R_2163_: *mut leanh::LeanObject = *_args.add(4);
    let mut v_a_2164_: *mut leanh::LeanObject = *_args.add(5);
    let mut v_b_2165_: *mut leanh::LeanObject = *_args.add(6);
    let mut v_c_2166_: *mut leanh::LeanObject = *_args.add(7);
    let mut v___y_2167_: *mut leanh::LeanObject = *_args.add(8);
    let mut v___y_2168_: *mut leanh::LeanObject = *_args.add(9);
    let mut v___y_2169_: *mut leanh::LeanObject = *_args.add(10);
    let mut v___y_2170_: *mut leanh::LeanObject = *_args.add(11);
    let mut v___y_2171_: *mut leanh::LeanObject = *_args.add(12);
    let mut v___y_2172_: *mut leanh::LeanObject = *_args.add(13);
    let mut v___y_2173_: *mut leanh::LeanObject = *_args.add(14);
    let mut v___y_2174_: *mut leanh::LeanObject = *_args.add(15);
    let mut v___y_2175_: *mut leanh::LeanObject = *_args.add(16);
    let mut v___y_2176_: *mut leanh::LeanObject = *_args.add(17);
    ...
    leanh::lean_dec(v_upperBound_2159_);
    return v_res_2177_;
}
pub unsafe fn l_Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2(
    mut v_00_u03b2_2178_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_containsAux___at___00Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2_spec__4(
    mut v_00_u03b2_2192_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_containsAux___at___00Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2_spec__4___boxed(
    ...
    let mut v_r_2203_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_35102__boxed_2201_ = leanh::lean_unbox_usize(v_x_2199_);
    leanh::lean_dec(v_x_2199_);
    ...
    leanh::lean_dec_ref(v_x_2198_);
    v_r_2203_ = leanh::lean_box((v_res_2202_) as usize);
    return v_r_2203_;
}
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7(
    mut v_00_u03b2_2204_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7___boxed(
    ...
    v_x_35113__boxed_2217_ = leanh::lean_unbox_usize(v_x_2213_);
    leanh::lean_dec(v_x_2213_);
    v_x_35114__boxed_2218_ = leanh::lean_unbox_usize(v_x_2214_);
...
pub unsafe fn l_Lean_PersistentHashMap_containsAtAux___at___00Lean_PersistentHashMap_containsAux___at___00Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2_spec__4_spec__7(
    ...
    mut v_keys_2221_: *mut leanh::LeanObject,
    mut v_vals_2222_: *mut leanh::LeanObject,
    mut v_heq_2223_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_containsAtAux___at___00Lean_PersistentHashMap_containsAux___at___00Lean_PersistentHashMap_contains___at___00Lean_MVarId_isAssigned___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__2_spec__2_spec__4_spec__7___boxed(
    mut v_00_u03b2_2227_: *mut leanh::LeanObject,
    mut v_keys_2228_: *mut leanh::LeanObject,
    mut v_vals_2229_: *mut leanh::LeanObject,
    mut v_heq_2230_: *mut leanh::LeanObject,
    mut v_i_2231_: *mut leanh::LeanObject,
    mut v_k_2232_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_k_2232_);
    leanh::lean_dec_ref(v_vals_2229_);
    leanh::lean_dec_ref(v_keys_2228_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7_spec__10(
    ...
    mut v_n_2236_: *mut leanh::LeanObject,
    mut v_k_2237_: *mut leanh::LeanObject,
    mut v_v_2238_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7_spec__11(
    mut v_00_u03b2_2240_: *mut leanh::LeanObject,
    mut v_depth_2241_: usize,
    mut v_keys_2242_: *mut leanh::LeanObject,
    mut v_vals_2243_: *mut leanh::LeanObject,
    mut v_heq_2244_: *mut leanh::LeanObject,
    mut v_i_2245_: *mut leanh::LeanObject,
    mut v_entries_2246_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Sym_Simp_Theorem_rewrite_spec__3_spec__4_spec__7_spec__11___boxed(
    mut v_00_u03b2_2248_: *mut leanh::LeanObject,
    mut v_depth_2249_: *mut leanh::LeanObject,
    mut v_keys_2250_: *mut leanh::LeanObject,
    mut v_vals_2251_: *mut leanh::LeanObject,
    mut v_heq_2252_: *mut leanh::LeanObject,
    mut v_i_2253_: *mut leanh::LeanObject,
    mut v_entries_2254_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_2255_: usize = 0;
    let mut v_res_2256_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_2255_ = leanh::lean_unbox_usize(v_depth_2249_);
    leanh::lean_dec(v_depth_2249_);
    ...
    leanh::lean_dec_ref(v_vals_2251_);
    leanh::lean_dec_ref(v_keys_2250_);
    return v_res_2256_;
}
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Meta_Sym_Simp_Theorems_rewrite_spec__0___lam__0(
    mut v_fst_2263_: *mut leanh::LeanObject,
    mut v_d_2264_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Meta_Sym_Simp_Theorems_rewrite_spec__0___lam__0___boxed(
    mut v_fst_2277_: *mut leanh::LeanObject,
    mut v_d_2278_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Meta_Sym_Simp_Theorems_rewrite_spec__0(
    mut v_d_2291_: *mut leanh::LeanObject,
    mut v_e_2292_: *mut leanh::LeanObject,
    mut v_as_2293_: *mut leanh::LeanObject,
    mut v_sz_2294_: usize,
    mut v_i_2295_: usize,
    mut v_b_2296_: *mut leanh::LeanObject,
    ...
    let mut v_snd_2339_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_result_2357_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_2389_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                ...
                if v___x_2334_ == 0 {
                    leanh::lean_dec_ref(v_e_2292_);
                    leanh::lean_dec_ref(v_d_2291_);
                    v___x_2335_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_2335_, 0, v_b_2296_);
                    return v___x_2335_;
                } else {
                    v_a_2336_ = lean_array_uget_borrowed(v_as_2293_, v_i_2295_);
                    v_fst_2337_ = leanh::lean_ctor_get(v_a_2336_, 0);
                    v_snd_2338_ = leanh::lean_ctor_get(v_a_2336_, 1);
                    v_snd_2339_ = leanh::lean_ctor_get(v_b_2296_, 1);
                    v_isSharedCheck_2388_ = (!leanh::lean_is_exclusive(v_b_2296_)) as u8;
                    if v_isSharedCheck_2388_ == 0 {
                        v_unused_2389_ = leanh::lean_ctor_get(v_b_2296_, 0);
                        leanh::lean_dec(v_unused_2389_);
                        v___x_2341_ = v_b_2296_;
                        v_isShared_2342_ = v_isSharedCheck_2388_;
                        state = 6;
                        continue;
                    } else {
                        leanh::lean_inc(v_snd_2339_);
                        leanh::lean_dec(v_b_2296_);
            ...
            1 => {
                ...
                leanh::lean_ctor_set(v___x_2310_, 0, v___y_2309_);
                v___x_2311_ = leanh::lean_box((v___y_2308_) as usize);
                ...
                if v___y_2326_ == 0 {
                    ...
                    if leanh::lean_obj_tag(v___y_2325_) == 0 {
                        v_contextDependent_2328_ =
                            leanh::lean_ctor_get_uint8(v___y_2325_, 1 as u32);
                        ...
                        v_contextDependent_2329_ = leanh::lean_ctor_get_uint8(
                            v___y_2325_,
                            (core::mem::size_of::<*mut leanh::LeanObject>() * 2 + 1) as u32,
                        );
                        v___y_2320_ = v___y_2325_;
            ...
            6 => {
                ...
                if v___x_2366_ == 0 {
                    leanh::lean_inc_ref(v_d_2291_);
                    leanh::lean_inc(v_fst_2337_);
                    v___f_2367_ = leanh::lean_alloc_closure(l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Meta_Sym_Simp_Theorems_rewrite_spec__0___lam__0___boxed as *mut core::ffi::c_void, 13, 2);
                    leanh::lean_closure_set(v___f_2367_, 0, v_fst_2337_);
                    leanh::lean_closure_set(v___f_2367_, 1, v_d_2291_);
                    leanh::lean_inc_ref(v_e_2292_);
                    ...
                    if leanh::lean_obj_tag(v___x_2368_) == 0 {
                        ...
                        leanh::lean_del_object(v___x_2341_);
                        leanh::lean_dec(v_snd_2339_);
                        leanh::lean_dec_ref(v_e_2292_);
                        leanh::lean_dec_ref(v_d_2291_);
                        v_a_2370_ = leanh::lean_ctor_get(v___x_2368_, 0);
                        v_isSharedCheck_2377_ =
                            (!leanh::lean_is_exclusive(v___x_2368_)) as u8;
                    ...
                    if leanh::lean_obj_tag(v___x_2378_) == 0 {
                        ...
                        leanh::lean_dec_ref(v_e_2292_);
                        leanh::lean_dec_ref(v_d_2291_);
                        v_a_2380_ = leanh::lean_ctor_get(v___x_2378_, 0);
            ...
            7 => {
                if v_done_2346_ == 0 {
                    ...
                    v___x_2348_ = leanh::lean_box((v___y_2347_) as usize);
                    if v_isShared_2342_ == 0 {
                        leanh::lean_ctor_set(v___x_2341_, 1, v___x_2348_);
                        leanh::lean_ctor_set(v___x_2341_, 0, v___x_2343_);
                        v___x_2350_ = v___x_2341_;
                        state = 8;
                        continue;
                    } else {
                        v_reuseFailAlloc_2354_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_2354_, 0, v___x_2343_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_2354_, 1, v___x_2348_);
            ...
            9 => {
                v___x_2358_ = (leanh::lean_unbox(v_snd_2339_) as u8);
                if v___x_2358_ == 0 {
                    leanh::lean_dec(v_snd_2339_);
                    if leanh::lean_obj_tag(v_result_2357_) == 0 {
                        v_done_2359_ = leanh::lean_ctor_get_uint8(v_result_2357_, 0 as u32);
                        v_contextDependent_2360_ =
                            leanh::lean_ctor_get_uint8(v_result_2357_, 1 as u32);
                    ...
                    if leanh::lean_obj_tag(v_result_2357_) == 0 {
                        v_done_2362_ = leanh::lean_ctor_get_uint8(v_result_2357_, 0 as u32);
                        v___x_2363_ = (leanh::lean_unbox(v_snd_2339_) as u8);
                        leanh::lean_dec(v_snd_2339_);
                        v___y_2345_ = v_result_2357_;
                        ...
                        leanh::lean_dec_ref(v_e_2292_);
                        leanh::lean_dec_ref(v_d_2291_);
                        v___x_2364_ = (leanh::lean_unbox(v_snd_2339_) as u8);
                        leanh::lean_dec(v_snd_2339_);
                        v___y_2331_ = v_result_2357_;
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Meta_Sym_Simp_Theorems_rewrite_spec__0___boxed(
    mut v_d_2390_: *mut leanh::LeanObject,
    mut v_e_2391_: *mut leanh::LeanObject,
    mut v_as_2392_: *mut leanh::LeanObject,
    mut v_sz_2393_: *mut leanh::LeanObject,
    ...
    v_sz_boxed_2406_ = leanh::lean_unbox_usize(v_sz_2393_);
    leanh::lean_dec(v_sz_2393_);
    v_i_boxed_2407_ = leanh::lean_unbox_usize(v_i_2394_);
    ...
    leanh::lean_dec_ref(v_as_2392_);
    return v_res_2408_;
}
pub unsafe fn l_Lean_Meta_Sym_Simp_Theorems_rewrite(
    mut v_thms_2413_: *mut leanh::LeanObject,
    mut v_d_2414_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_2430_) == 0 {
                    ...
                    v_isSharedCheck_2446_ = (!leanh::lean_is_exclusive(v___x_2430_)) as u8;
                    ...
                    v_a_2447_ = leanh::lean_ctor_get(v___x_2430_, 0);
                    v_isSharedCheck_2454_ = (!leanh::lean_is_exclusive(v___x_2430_)) as u8;
            ...
            1 => {
                v_fst_2435_ = leanh::lean_ctor_get(v_a_2431_, 0);
                if leanh::lean_obj_tag(v_fst_2435_) == 0 {
                    v_snd_2436_ = leanh::lean_ctor_get(v_a_2431_, 1);
                    leanh::lean_inc(v_snd_2436_);
                    leanh::lean_dec(v_a_2431_);
                    v___x_2437_ = (leanh::lean_unbox(v_snd_2436_) as u8);
                    leanh::lean_dec(v_snd_2436_);
                    v___x_2438_ = l_Lean_Meta_Sym_Simp_mkRflResultCD(v___x_2437_);
                    if v_isShared_2434_ == 0 {
                        leanh::lean_ctor_set(v___x_2433_, 0, v___x_2438_);
                    ...
                    leanh::lean_inc_ref(v_fst_2435_);
                    leanh::lean_dec(v_a_2431_);
                    v_val_2442_ = leanh::lean_ctor_get(v_fst_2435_, 0);
                    leanh::lean_inc(v_val_2442_);
                    leanh::lean_dec_ref_known(v_fst_2435_, 1);
                    if v_isShared_2434_ == 0 {
                        leanh::lean_ctor_set(v___x_2433_, 0, v_val_2442_);
                        v___x_2444_ = v___x_2433_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_2445_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_2445_, 0, v_val_2442_);
...
pub unsafe fn l_Lean_Meta_Sym_Simp_Theorems_rewrite___boxed(
    mut v_thms_2455_: *mut leanh::LeanObject,
    mut v_d_2456_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_a_2464_);
    leanh::lean_dec_ref(v_a_2463_);
    ...
    leanh::lean_dec_ref(v_thms_2455_);
    return v_res_2468_;
}
...
pub unsafe fn initialize_Lean_Meta_Sym_Simp_Rewrite(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
