...
static mut l_Lean_Meta_Sym_mkSimprocFor___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::null_mut();
static mut l_Lean_Meta_Sym_mkSimprocFor___closed__1_once: crate::leanh::LeanOnceCell =
    crate::leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Lean_Meta_Sym_mkSimprocFor___closed__1: *mut crate::leanh::LeanObject =
    core::ptr::null_mut();
pub static l_Lean_Meta_Sym_mkMethods___lam__0___closed__0_value: crate::leanh::LeanCtorObject<1> =
...
static mut l_Lean_Meta_Sym_mkMethods___lam__0___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_mkMethods___lam__0___closed__0_value)
        as *mut crate::leanh::LeanObject;
pub static l_Lean_Meta_Sym_mkMethods___closed__0_value: crate::leanh::LeanClosureObject<0> =
...
static mut l_Lean_Meta_Sym_mkMethods___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_mkMethods___closed__0_value)
        as *mut crate::leanh::LeanObject;
pub static l_Lean_Meta_Sym_mkMethods___closed__1_value: crate::leanh::LeanClosureObject<0> =
    crate::leanh::LeanClosureObject {
        m_header: crate::leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<crate::leanh::LeanObject>()
...
static mut l_Lean_Meta_Sym_mkMethods___closed__1: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_mkMethods___closed__1_value)
        as *mut crate::leanh::LeanObject;
pub static l_Lean_Meta_Sym_simpGoalUsing___lam__0___closed__0_value: crate::leanh::LeanCtorObject<
    2,
> = crate::leanh::LeanCtorObject {
    m_header: crate::leanh::LeanObject {
        rc: 0,
...
static mut l_Lean_Meta_Sym_simpGoalUsing___lam__0___closed__0: *mut crate::leanh::LeanObject =
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Meta_Sym_mkSimprocFor_spec__0(
    mut v_as_211_: *mut crate::leanh::LeanObject,
    mut v_sz_212_: usize,
    mut v_i_213_: usize,
    mut v_b_214_: *mut crate::leanh::LeanObject,
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_220_ == 0 {
                    v___x_221_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v___x_221_, 0, v_b_214_);
                    return v___x_221_;
                } else {
                    ...
                    if crate::leanh::lean_obj_tag(v___x_223_) == 0 {
                        v_a_224_ = crate::leanh::lean_ctor_get(v___x_223_, 0);
                        crate::leanh::lean_inc(v_a_224_);
                        crate::leanh::lean_dec_ref_known(v___x_223_, 1);
                        ...
                        crate::leanh::lean_dec_ref(v_b_214_);
                        v_a_229_ = crate::leanh::lean_ctor_get(v___x_223_, 0);
                        v_isSharedCheck_236_ = (!crate::leanh::lean_is_exclusive(v___x_223_)) as u8;
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Meta_Sym_mkSimprocFor_spec__0___boxed(
    mut v_as_237_: *mut crate::leanh::LeanObject,
    mut v_sz_238_: *mut crate::leanh::LeanObject,
    mut v_i_239_: *mut crate::leanh::LeanObject,
    mut v_b_240_: *mut crate::leanh::LeanObject,
    mut v___y_241_: *mut crate::leanh::LeanObject,
    mut v___y_242_: *mut crate::leanh::LeanObject,
    mut v___y_243_: *mut crate::leanh::LeanObject,
    mut v___y_244_: *mut crate::leanh::LeanObject,
    ...
    v_sz_boxed_246_ = crate::leanh::lean_unbox_usize(v_sz_238_);
    crate::leanh::lean_dec(v_sz_238_);
    v_i_boxed_247_ = crate::leanh::lean_unbox_usize(v_i_239_);
    crate::leanh::lean_dec(v_i_239_);
    ...
    crate::leanh::lean_dec(v___y_244_);
    crate::leanh::lean_dec_ref(v___y_243_);
    crate::leanh::lean_dec(v___y_242_);
    crate::leanh::lean_dec_ref(v___y_241_);
    crate::leanh::lean_dec_ref(v_as_237_);
    return v_res_248_;
}
pub unsafe fn _init_l_Lean_Meta_Sym_mkSimprocFor___closed__0() -> *mut crate::leanh::LeanObject {
    let mut v___x_249_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_249_ = l_Lean_PersistentHashMap_mkEmptyEntriesArray(
        crate::leanh::lean_box(0),
        crate::leanh::lean_box(0),
    );
    return v___x_249_;
}
pub unsafe fn _init_l_Lean_Meta_Sym_mkSimprocFor___closed__1() -> *mut crate::leanh::LeanObject {
    let mut v___x_250_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_thms_251_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    v_thms_251_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
    crate::leanh::lean_ctor_set(v_thms_251_, 0, v___x_250_);
    return v_thms_251_;
}
pub unsafe fn l_Lean_Meta_Sym_mkSimprocFor(
    mut v_declNames_252_: *mut crate::leanh::LeanObject,
    mut v_d_253_: *mut crate::leanh::LeanObject,
    ...
    let mut v_thms_259_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_272_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_thms_259_ = crate::leanh::lean_obj_once(
                ...
                if crate::leanh::lean_obj_tag(v___x_262_) == 0 {
                    ...
                    v_isSharedCheck_271_ = (!crate::leanh::lean_is_exclusive(v___x_262_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref(v_d_253_);
                    v_a_272_ = crate::leanh::lean_ctor_get(v___x_262_, 0);
                    v_isSharedCheck_279_ = (!crate::leanh::lean_is_exclusive(v___x_262_)) as u8;
            ...
            1 => {
                v___x_267_ = crate::leanh::lean_alloc_closure(
                    l_Lean_Meta_Sym_Simp_Theorems_rewrite___boxed as *mut core::ffi::c_void,
                    13,
                    2,
                );
                crate::leanh::lean_closure_set(v___x_267_, 0, v_a_263_);
                crate::leanh::lean_closure_set(v___x_267_, 1, v_d_253_);
                if v_isShared_266_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_265_, 0, v___x_267_);
                    v___x_269_ = v___x_265_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_270_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_270_, 0, v___x_267_);
            ...
            3 => {
                if v_isShared_275_ == 0 {
                    ...
                    v_reuseFailAlloc_278_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_278_, 0, v_a_272_);
...
pub unsafe fn l_Lean_Meta_Sym_mkSimprocFor___boxed(
    mut v_declNames_280_: *mut crate::leanh::LeanObject,
    mut v_d_281_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec_ref(v_a_284_);
    crate::leanh::lean_dec(v_a_283_);
    crate::leanh::lean_dec_ref(v_a_282_);
    crate::leanh::lean_dec_ref(v_declNames_280_);
    return v_res_287_;
}
...
pub unsafe fn l_Lean_Meta_Sym_mkMethods___lam__0___boxed(
    ...
    crate::leanh::lean_dec_ref(v___y_311_);
    crate::leanh::lean_dec(v___y_310_);
    crate::leanh::lean_dec_ref(v___y_309_);
    crate::leanh::lean_dec(v___y_308_);
    crate::leanh::lean_dec_ref(v___y_307_);
    crate::leanh::lean_dec(v___y_306_);
    crate::leanh::lean_dec_ref(v___y_305_);
    crate::leanh::lean_dec(v___y_304_);
    crate::leanh::lean_dec_ref(v_x_303_);
    return v_res_314_;
}
pub unsafe fn l_Lean_Meta_Sym_mkMethods(
    mut v_declNames_317_: *mut crate::leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if crate::leanh::lean_obj_tag(v___x_324_) == 0 {
                    v_a_325_ = crate::leanh::lean_ctor_get(v___x_324_, 0);
                    v_isSharedCheck_334_ = (!crate::leanh::lean_is_exclusive(v___x_324_)) as u8;
                    ...
                    v_a_335_ = crate::leanh::lean_ctor_get(v___x_324_, 0);
                    v_isSharedCheck_342_ = (!crate::leanh::lean_is_exclusive(v___x_324_)) as u8;
            ...
            1 => {
                ...
                crate::leanh::lean_ctor_set(v___x_330_, 0, v___f_329_);
                crate::leanh::lean_ctor_set(v___x_330_, 1, v_a_325_);
                if v_isShared_328_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_327_, 0, v___x_330_);
...
pub unsafe fn l_Lean_Meta_Sym_mkMethods___boxed(
    mut v_declNames_343_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec_ref(v_a_344_);
    crate::leanh::lean_dec_ref(v_declNames_343_);
    return v_res_349_;
}
pub unsafe fn l_Lean_Meta_Sym_simpGoalUsing___lam__0(
    mut v_declNames_353_: *mut crate::leanh::LeanObject,
    mut v_mvarId_354_: *mut crate::leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if crate::leanh::lean_obj_tag(v___x_362_) == 0 {
                    ...
                    if crate::leanh::lean_obj_tag(v___x_364_) == 0 {
                        v_a_365_ = crate::leanh::lean_ctor_get(v___x_364_, 0);
                        crate::leanh::lean_inc(v_a_365_);
                        crate::leanh::lean_dec_ref_known(v___x_364_, 1);
                        ...
                        if crate::leanh::lean_obj_tag(v___x_367_) == 0 {
                            v_a_368_ = crate::leanh::lean_ctor_get(v___x_367_, 0);
                            ...
                            v_a_370_ = crate::leanh::lean_ctor_get(v___x_367_, 0);
                            v_isSharedCheck_377_ =
                                (!crate::leanh::lean_is_exclusive(v___x_367_)) as u8;
                        ...
                        v_a_378_ = crate::leanh::lean_ctor_get(v___x_364_, 0);
                        v_isSharedCheck_385_ = (!crate::leanh::lean_is_exclusive(v___x_364_)) as u8;
                    ...
                    crate::leanh::lean_dec(v_mvarId_354_);
                    v_a_386_ = crate::leanh::lean_ctor_get(v___x_362_, 0);
                    v_isSharedCheck_393_ = (!crate::leanh::lean_is_exclusive(v___x_362_)) as u8;
            ...
            5 => {
                if v_isShared_389_ == 0 {
                    ...
                    v_reuseFailAlloc_392_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_392_, 0, v_a_386_);
...
pub unsafe fn l_Lean_Meta_Sym_simpGoalUsing___lam__0___boxed(
    mut v_declNames_394_: *mut crate::leanh::LeanObject,
    mut v_mvarId_395_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec(v___y_399_);
    crate::leanh::lean_dec_ref(v___y_398_);
    crate::leanh::lean_dec(v___y_397_);
    crate::leanh::lean_dec_ref(v___y_396_);
    crate::leanh::lean_dec_ref(v_declNames_394_);
    return v_res_403_;
}
pub unsafe fn l_Lean_Meta_Sym_simpGoalUsing(
    mut v_declNames_404_: *mut crate::leanh::LeanObject,
    mut v_mvarId_405_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_closure_set(v___f_411_, 0, v_declNames_404_);
    crate::leanh::lean_closure_set(v___f_411_, 1, v_mvarId_405_);
    v___x_412_ =
...
pub unsafe fn l_Lean_Meta_Sym_simpGoalUsing___boxed(
    mut v_declNames_413_: *mut crate::leanh::LeanObject,
    mut v_mvarId_414_: *mut crate::leanh::LeanObject,
...
pub unsafe fn runtime_initialize_Lean_Meta_Sym_Simp_Debug(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_Sym_Simp_Debug(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Sym_Simp_Debug(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
