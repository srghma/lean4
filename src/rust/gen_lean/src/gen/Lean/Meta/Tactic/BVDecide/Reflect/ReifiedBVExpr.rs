...
pub static l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkEvalExpr___closed__5_value:
    ...
    m_objs: [
        ...
        core::ptr::addr_of!(l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkEvalExpr___closed__4_value)
            as *mut leanh::LeanObject,
        4945347208705483836 as *mut leanh::LeanObject,
    ],
};
...
static mut l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkAtom___closed__3:
    *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkAtom___closed__3_value)
        as *mut leanh::LeanObject;
pub static l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_getNatOrBvValue_x3f___redArg___closed__0_value: leanh::LeanStringObject<4> = leanh::LeanStringObject { m_header: leanh::LeanObject { rc: 0, cs_size: (0) as u16, other: 0, tag: 249 }, m_size: 4, m_capacity: 4, m_length: 3, m_data: [78, 97, 116, 0]};
...
pub static l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_getNatOrBvValue_x3f___redArg___closed__1_value: leanh::LeanCtorObject<3> = leanh::LeanCtorObject { m_header: leanh::LeanObject { rc: 0, cs_size: (core::mem::size_of::<leanh::LeanObject>() + core::mem::size_of::<*mut leanh::LeanObject>()*2 + 8) as u16, other: 2, tag: 1 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut leanh::LeanObject,core::ptr::addr_of!(l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_getNatOrBvValue_x3f___redArg___closed__0_value) as *mut leanh::LeanObject,11442535297760353691 as *mut leanh::LeanObject] };
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkEvalExpr(
    mut v_w_438_: *mut leanh::LeanObject,
    mut v_expr_439_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_446_) == 0 {
                    ...
                    v_isSharedCheck_457_ = (!leanh::lean_is_exclusive(v___x_446_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_expr_439_);
                    leanh::lean_dec(v_w_438_);
                    return v___x_446_;
                }
            }
            1 => {
                ...
                if v_isShared_450_ == 0 {
                    leanh::lean_ctor_set(v___x_449_, 0, v___x_453_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkEvalExpr___boxed(
    mut v_w_458_: *mut leanh::LeanObject,
    mut v_expr_459_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_a_464_);
    leanh::lean_dec_ref(v_a_463_);
    leanh::lean_dec(v_a_462_);
    leanh::lean_dec_ref(v_a_461_);
    leanh::lean_dec(v_a_460_);
    return v_res_466_;
}
...
-> *mut leanh::LeanObject {
    ...
    v___x_472_ = leanh::lean_unsigned_to_nat(1);
...
-> *mut leanh::LeanObject {
    ...
    v___x_476_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkBVRefl(
    mut v_w_486_: *mut leanh::LeanObject,
    mut v_expr_487_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v___x_489_ = leanh::lean_obj_once(
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkAtom___lam__0(
    mut v___x_493_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkAtom(
    ...
    mut v_width_522_: *mut leanh::LeanObject,
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_530_) == 0 {
                    v_a_531_ = leanh::lean_ctor_get(v___x_530_, 0);
                    v_isSharedCheck_545_ = (!leanh::lean_is_exclusive(v___x_530_)) as u8;
                    ...
                    leanh::lean_dec(v_width_522_);
                    v_a_546_ = leanh::lean_ctor_get(v___x_530_, 0);
                    v_isSharedCheck_553_ = (!leanh::lean_is_exclusive(v___x_530_)) as u8;
            ...
            1 => {
                ...
                leanh::lean_inc_n(v_width_522_, 2);
                ...
                leanh::lean_inc_ref(v___x_538_);
                v___x_541_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                leanh::lean_ctor_set(v___x_541_, 0, v_width_522_);
                leanh::lean_ctor_set(v___x_541_, 1, v___x_540_);
                leanh::lean_ctor_set(v___x_541_, 2, v___x_538_);
                leanh::lean_ctor_set(v___x_541_, 3, v___f_539_);
                leanh::lean_ctor_set(v___x_541_, 4, v___x_538_);
                if v_isShared_534_ == 0 {
                    leanh::lean_ctor_set(v___x_533_, 0, v___x_541_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkAtom___boxed(
    mut v_e_554_: *mut leanh::LeanObject,
    mut v_width_555_: *mut leanh::LeanObject,
    mut v_synthetic_556_: *mut leanh::LeanObject,
    ...
    v_synthetic_boxed_563_ = (leanh::lean_unbox(v_synthetic_556_) as u8);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_getNatOrBvValue_x3f___redArg(
    mut v_ty_568_: *mut leanh::LeanObject,
    mut v_expr_569_: *mut leanh::LeanObject,
    ...
    let mut v_a_588_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
                ...
                if leanh::lean_obj_tag(v___x_578_) == 0 {
                    ...
                    if v___x_582_ == 0 {
                        ...
                        if v___x_583_ == 0 {
                            ...
                            leanh::lean_dec_ref(v_expr_569_);
                            state = 1;
                            continue;
                        } else {
                            ...
                            if v___x_586_ == 0 {
                                ...
                                if leanh::lean_obj_tag(v___x_587_) == 0 {
                                    v_a_588_ = leanh::lean_ctor_get(v___x_587_, 0);
                                    v_isSharedCheck_608_ =
                                        (!leanh::lean_is_exclusive(v___x_587_)) as u8;
                                    ...
                                    v_a_609_ = leanh::lean_ctor_get(v___x_587_, 0);
                    ...
                    leanh::lean_dec_ref(v_expr_569_);
                    v_a_618_ = leanh::lean_ctor_get(v___x_578_, 0);
                    v_isSharedCheck_625_ = (!leanh::lean_is_exclusive(v___x_578_)) as u8;
            ...
            1 => {
                ...
                v___x_577_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                leanh::lean_ctor_set(v___x_577_, 0, v___x_576_);
                return v___x_577_;
            }
            2 => {
                if leanh::lean_obj_tag(v_a_588_) == 1 {
                    v_val_592_ = leanh::lean_ctor_get(v_a_588_, 0);
                    v_isSharedCheck_603_ = (!leanh::lean_is_exclusive(v_a_588_)) as u8;
                    ...
                    if v_isShared_591_ == 0 {
                        leanh::lean_ctor_set(v___x_590_, 0, v___x_604_);
                        v___x_606_ = v___x_590_;
                        state = 6;
                        continue;
                    } else {
                        v_reuseFailAlloc_607_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
            ...
            3 => {
                v_snd_596_ = leanh::lean_ctor_get(v_val_592_, 1);
                leanh::lean_inc(v_snd_596_);
                leanh::lean_dec(v_val_592_);
                if v_isShared_595_ == 0 {
                    leanh::lean_ctor_set(v___x_594_, 0, v_snd_596_);
                    v___x_598_ = v___x_594_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_602_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_602_, 0, v_snd_596_);
            ...
            4 => {
                if v_isShared_591_ == 0 {
                    leanh::lean_ctor_set(v___x_590_, 0, v___x_598_);
                    v___x_600_ = v___x_590_;
                    state = 5;
                    continue;
                } else {
                    v_reuseFailAlloc_601_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_601_, 0, v___x_598_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_getNatOrBvValue_x3f___redArg___boxed(
    mut v_ty_626_: *mut leanh::LeanObject,
    mut v_expr_627_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_getNatOrBvValue_x3f(
    mut v_ty_634_: *mut leanh::LeanObject,
    mut v_expr_635_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_getNatOrBvValue_x3f___boxed(
    mut v_ty_643_: *mut leanh::LeanObject,
    mut v_expr_644_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_bitVecAtom_spec__0___redArg(
    ...
    let mut v_mctx_658_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_659_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fst_660_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_661_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_662_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_663_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_664_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_665_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_666_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_655_ == 0 {
                    ...
                    leanh::lean_ctor_set(v___x_656_, 0, v_e_652_);
                    return v___x_656_;
                } else {
                    v___x_657_ = lean_st_ref_get(v___y_653_);
                    v_mctx_658_ = leanh::lean_ctor_get(v___x_657_, 0);
                    leanh::lean_inc_ref(v_mctx_658_);
                    leanh::lean_dec(v___x_657_);
                    v___x_659_ = l_Lean_instantiateMVarsCore(v_mctx_658_, v_e_652_);
                    v_fst_660_ = leanh::lean_ctor_get(v___x_659_, 0);
                    leanh::lean_inc(v_fst_660_);
                    v_snd_661_ = leanh::lean_ctor_get(v___x_659_, 1);
                    leanh::lean_inc(v_snd_661_);
                    leanh::lean_dec_ref(v___x_659_);
                    v___x_662_ = lean_st_ref_take(v___y_653_);
                    v_cache_663_ = leanh::lean_ctor_get(v___x_662_, 1);
                    v_zetaDeltaFVarIds_664_ = leanh::lean_ctor_get(v___x_662_, 2);
                    v_postponed_665_ = leanh::lean_ctor_get(v___x_662_, 3);
                    v_diag_666_ = leanh::lean_ctor_get(v___x_662_, 4);
                    v_isSharedCheck_675_ = (!leanh::lean_is_exclusive(v___x_662_)) as u8;
                    if v_isSharedCheck_675_ == 0 {
                        v_unused_676_ = leanh::lean_ctor_get(v___x_662_, 0);
                        ...
                        leanh::lean_inc(v_diag_666_);
                        leanh::lean_inc(v_postponed_665_);
                        leanh::lean_inc(v_zetaDeltaFVarIds_664_);
                        leanh::lean_inc(v_cache_663_);
            ...
            1 => {
                if v_isShared_669_ == 0 {
                    leanh::lean_ctor_set(v___x_668_, 0, v_snd_661_);
                    v___x_671_ = v___x_668_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_674_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_674_, 0, v_snd_661_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_674_, 1, v_cache_663_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_674_, 2, v_zetaDeltaFVarIds_664_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_674_, 3, v_postponed_665_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_674_, 4, v_diag_666_);
            ...
            2 => {
                ...
                leanh::lean_ctor_set(v___x_673_, 0, v_fst_660_);
                return v___x_673_;
            }
            _ => {}
        }
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_bitVecAtom(
    ...
    let mut v_arg_721_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                leanh::lean_inc(v_a_703_);
                leanh::lean_inc_ref(v_a_702_);
                leanh::lean_inc(v_a_701_);
                leanh::lean_inc_ref(v_a_700_);
                leanh::lean_inc_ref(v_x_697_);
                ...
                if leanh::lean_obj_tag(v___x_705_) == 0 {
                    ...
                    if leanh::lean_obj_tag(v___x_707_) == 0 {
                        ...
                        v_isSharedCheck_768_ = (!leanh::lean_is_exclusive(v___x_709_)) as u8;
                        ...
                        v_a_769_ = leanh::lean_ctor_get(v___x_707_, 0);
                        v_isSharedCheck_776_ = (!leanh::lean_is_exclusive(v___x_707_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_x_697_);
                    v_a_777_ = leanh::lean_ctor_get(v___x_705_, 0);
                    v_isSharedCheck_784_ = (!leanh::lean_is_exclusive(v___x_705_)) as u8;
            ...
            1 => {
                ...
                if v___x_720_ == 0 {
                    ...
                    v_arg_721_ = leanh::lean_ctor_get(v___x_719_, 1);
                    leanh::lean_inc_ref(v_arg_721_);
                    ...
                    if v___x_724_ == 0 {
                        leanh::lean_dec_ref(v_arg_721_);
                        leanh::lean_dec_ref(v_x_697_);
                        state = 2;
                        continue;
                    } else {
                        leanh::lean_del_object(v___x_712_);
                        ...
                        if leanh::lean_obj_tag(v___x_725_) == 0 {
                            ...
                            leanh::lean_dec_ref(v_x_697_);
                            v_a_760_ = leanh::lean_ctor_get(v___x_725_, 0);
            ...
            4 => {
                if leanh::lean_obj_tag(v_a_726_) == 1 {
                    leanh::lean_del_object(v___x_728_);
                    v_val_730_ = leanh::lean_ctor_get(v_a_726_, 0);
                    v_isSharedCheck_754_ = (!leanh::lean_is_exclusive(v_a_726_)) as u8;
                    ...
                    if v_isShared_729_ == 0 {
                        leanh::lean_ctor_set(v___x_728_, 0, v___x_755_);
                        v___x_757_ = v___x_728_;
                        state = 11;
                        continue;
                    } else {
                        v_reuseFailAlloc_758_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_758_, 0, v___x_755_);
            ...
            5 => {
                ...
                if leanh::lean_obj_tag(v___x_734_) == 0 {
                    ...
                    leanh::lean_del_object(v___x_732_);
                    v_a_746_ = leanh::lean_ctor_get(v___x_734_, 0);
                    v_isSharedCheck_753_ = (!leanh::lean_is_exclusive(v___x_734_)) as u8;
            ...
            6 => {
                if v_isShared_733_ == 0 {
                    leanh::lean_ctor_set(v___x_732_, 0, v_a_735_);
                    v___x_740_ = v___x_732_;
                    state = 7;
                    continue;
                } else {
                    v_reuseFailAlloc_744_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_744_, 0, v_a_735_);
            ...
            7 => {
                if v_isShared_738_ == 0 {
                    leanh::lean_ctor_set(v___x_737_, 0, v___x_740_);
                    v___x_742_ = v___x_737_;
                    state = 8;
                    continue;
                } else {
                    v_reuseFailAlloc_743_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_743_, 0, v___x_740_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_bitVecAtom___boxed(
    ...
    mut v_synthetic_786_: *mut leanh::LeanObject,
    ...
    v_synthetic_boxed_793_ = (leanh::lean_unbox(v_synthetic_786_) as u8);
    ...
    leanh::lean_dec(v_a_791_);
    leanh::lean_dec_ref(v_a_790_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkBVConst___redArg(
    mut v_w_812_: *mut leanh::LeanObject,
    mut v_val_813_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_bvExpr_815_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_expr_821_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_proof_822_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    leanh::lean_inc_ref(v___x_817_);
    v___x_820_ = l_Lean_mkAppB(v___x_818_, v___x_817_, v___x_819_);
    leanh::lean_inc_ref(v___x_820_);
    ...
    v___x_823_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
    leanh::lean_ctor_set(v___x_823_, 0, v_w_812_);
    leanh::lean_ctor_set(v___x_823_, 1, v_bvExpr_815_);
    leanh::lean_ctor_set(v___x_823_, 2, v___x_820_);
    leanh::lean_ctor_set(v___x_823_, 3, v_proof_822_);
    leanh::lean_ctor_set(v___x_823_, 4, v_expr_821_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkBVConst___redArg___boxed(
    ...
    mut v_val_826_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkBVConst(
    mut v_w_829_: *mut leanh::LeanObject,
    mut v_val_830_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVExpr_mkBVConst___boxed(
    mut v_w_838_: *mut leanh::LeanObject,
    mut v_val_839_: *mut leanh::LeanObject,
