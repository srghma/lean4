...
// Imports: Lean.Meta.Tactic.Grind.Arith.Cutsat.Model
...
pub unsafe fn runtime_initialize_Lean_Meta_Tactic_Grind_Arith_Model(
    builtin: u8,
...
pub unsafe fn meta_initialize_Lean_Meta_Tactic_Grind_Arith_Model(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Tactic_Grind_Arith_Model(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
    ...
    leanh::lean_dec_ref(res);
    res = meta_initialize_Lean_Meta_Tactic_Grind_Arith_Model(builtin);
    if leanh::lean_io_result_is_error(res) {
        return res;
    }
    leanh::lean_dec_ref(res);
    return initialize_Lean_Meta_Tactic_Grind_Arith_Model(builtin);
}