...
static mut l_Lean_Grind_Linarith_Expr_renameVars___closed__0: *mut crate::leanh::LeanObject =
...
pub unsafe fn l_Lean_Grind_Linarith_Expr_renameVars(
    ...
    let mut v_k_290_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => match crate::leanh::lean_obj_tag(v_e_236_) {
                ...
                _ => {
                    v_k_290_ = crate::leanh::lean_ctor_get(v_e_236_, 0);
                    v_a_291_ = crate::leanh::lean_ctor_get(v_e_236_, 1);
            ...
            11 => {
                ...
                if v_isShared_294_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_293_, 1, v___x_295_);
                    v___x_297_ = v___x_293_;
                    state = 12;
                    continue;
                } else {
                    v_reuseFailAlloc_298_ = crate::leanh::lean_alloc_ctor(6, 2, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_298_, 0, v_k_290_);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_298_, 1, v___x_295_);
    ...
    loop {
        match state {
            0 => match crate::leanh::lean_obj_tag(v_e_309_) {
                ...
                6 => {
                    v_a_323_ = crate::leanh::lean_ctor_get(v_e_309_, 1);
                ...
                _ => {
                    ...
                    crate::leanh::lean_inc(v_b_326_);
                    crate::leanh::lean_dec(v_e_309_);
                    v_a_312_ = v_a_325_;
                    v_b_313_ = v_b_326_;
                    v___y_314_ = v_a_310_;
                    state = 1;
