...
pub unsafe fn runtime_initialize_Lean_Meta_Tactic_BVDecide_Reflect(
    builtin: u8,
...
pub unsafe fn meta_initialize_Lean_Meta_Tactic_BVDecide_Reflect(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Tactic_BVDecide_Reflect(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
