...
use crate::ffi::{
    ...
    lean_array_push, lean_nat_add, lean_nat_dec_eq, lean_nat_dec_lt, lean_nat_sub, lean_st_ref_set,
...
static mut l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2___redArg___closed__2: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_Lean_MVarId_assumptionCore___closed__0_value: leanh::LeanStringObject<11> =
...
static mut l_Lean_MVarId_assumptionCore___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_MVarId_assumptionCore___closed__0_value)
        as *mut leanh::LeanObject;
pub static l_Lean_MVarId_assumptionCore___closed__1_value: leanh::LeanCtorObject<3> =
    leanh::LeanCtorObject {
        ...
        m_objs: [
            ...
            core::ptr::addr_of!(l_Lean_MVarId_assumptionCore___closed__0_value)
                as *mut leanh::LeanObject,
            11851244492489364017 as *mut leanh::LeanObject,
        ],
    };
static mut l_Lean_MVarId_assumptionCore___closed__1: *mut leanh::LeanObject =
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__1___redArg(
    mut v_type_633_: *mut leanh::LeanObject,
    mut v_as_634_: *mut leanh::LeanObject,
    mut v_i_635_: *mut leanh::LeanObject,
    ...
    let mut v_zero_641_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_one_645_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_646_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_641_ = leanh::lean_unsigned_to_nat(0);
                v_isZero_642_ = lean_nat_dec_eq(v_i_635_, v_zero_641_);
                if v_isZero_642_ == 1 {
                    leanh::lean_dec(v_i_635_);
                    leanh::lean_dec_ref(v_type_633_);
                    v___x_643_ = leanh::lean_box(0);
                    v___x_644_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_644_, 0, v___x_643_);
                    return v___x_644_;
                } else {
                    v_one_645_ = leanh::lean_unsigned_to_nat(1);
                    ...
                    if leanh::lean_obj_tag(v___x_647_) == 0 {
                        ...
                        v_isSharedCheck_679_ = (!leanh::lean_is_exclusive(v___x_647_)) as u8;
            ...
            1 => {
                ...
                if v___x_653_ == 0 {
                    ...
                    leanh::lean_inc_ref(v_type_633_);
                    ...
                    if leanh::lean_obj_tag(v___x_655_) == 0 {
                        v_a_656_ = leanh::lean_ctor_get(v___x_655_, 0);
                        v_isSharedCheck_669_ = (!leanh::lean_is_exclusive(v___x_655_)) as u8;
                        ...
                        leanh::lean_del_object(v___x_651_);
                        leanh::lean_dec(v_val_649_);
                        leanh::lean_dec(v_n_646_);
                        leanh::lean_dec_ref(v_type_633_);
                        v_a_670_ = leanh::lean_ctor_get(v___x_655_, 0);
                        v_isSharedCheck_677_ = (!leanh::lean_is_exclusive(v___x_655_)) as u8;
            ...
            2 => {
                v___x_660_ = (leanh::lean_unbox(v_a_656_) as u8);
                leanh::lean_dec(v_a_656_);
                if v___x_660_ == 0 {
                    leanh::lean_del_object(v___x_658_);
                    leanh::lean_del_object(v___x_651_);
                    leanh::lean_dec(v_val_649_);
                    v_i_635_ = v_n_646_;
                    state = 0;
                    ...
                    if v_isShared_652_ == 0 {
                        leanh::lean_ctor_set(v___x_651_, 0, v___x_662_);
                        v___x_664_ = v___x_651_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_668_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_668_, 0, v___x_662_);
            ...
            3 => {
                if v_isShared_659_ == 0 {
                    leanh::lean_ctor_set(v___x_658_, 0, v___x_664_);
                    v___x_666_ = v___x_658_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_667_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
            ...
            5 => {
                if v_isShared_673_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_676_, 0, v_a_670_);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__1___redArg___boxed(
    mut v_type_680_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevMAux___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__2_spec__3___redArg(
    mut v_type_689_: *mut leanh::LeanObject,
    mut v_as_690_: *mut leanh::LeanObject,
    mut v_i_691_: *mut leanh::LeanObject,
    ...
    let mut v_zero_697_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_n_702_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_697_ = leanh::lean_unsigned_to_nat(0);
                v_isZero_698_ = lean_nat_dec_eq(v_i_691_, v_zero_697_);
                if v_isZero_698_ == 1 {
                    leanh::lean_dec(v_i_691_);
                    leanh::lean_dec_ref(v_type_689_);
                    v___x_699_ = leanh::lean_box(0);
                    v___x_700_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    ...
                    leanh::lean_inc_ref(v_type_689_);
                    ...
                    if leanh::lean_obj_tag(v___x_704_) == 0 {
                        ...
                        if leanh::lean_obj_tag(v_a_705_) == 0 {
                            leanh::lean_dec_ref_known(v___x_704_, 1);
                            v_i_691_ = v_n_702_;
                            state = 0;
                            continue;
                        } else {
                            leanh::lean_dec_ref_known(v_a_705_, 1);
                            leanh::lean_dec(v_n_702_);
                            leanh::lean_dec_ref(v_type_689_);
                            return v___x_704_;
                        }
                    } else {
...
pub unsafe fn l_Lean_PersistentArray_findSomeRevMAux___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__2(
    mut v_type_707_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentArray_findSomeRevMAux___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__2___boxed(
    mut v_type_720_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevMAux___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__2_spec__3___redArg___boxed(
    mut v_type_728_: *mut leanh::LeanObject,
    mut v_as_729_: *mut leanh::LeanObject,
    mut v_i_730_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0(
    mut v_type_737_: *mut leanh::LeanObject,
    ...
    let mut v_root_744_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_root_744_ = leanh::lean_ctor_get(v_t_738_, 0);
    v_tail_745_ = leanh::lean_ctor_get(v_t_738_, 1);
    v___x_746_ = lean_array_get_size(v_tail_745_);
    leanh::lean_inc_ref(v_type_737_);
    ...
    if leanh::lean_obj_tag(v___x_747_) == 0 {
        ...
        if leanh::lean_obj_tag(v_a_748_) == 0 {
            ...
            leanh::lean_dec_ref_known(v_a_748_, 1);
            leanh::lean_dec_ref(v_type_737_);
            return v___x_747_;
        }
    } else {
        leanh::lean_dec_ref(v_type_737_);
...
pub unsafe fn l_Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0___boxed(
    ...
    leanh::lean_dec_ref(v___y_752_);
    leanh::lean_dec_ref(v_t_751_);
    return v_res_757_;
}
pub unsafe fn l_Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0(
    mut v_type_758_: *mut leanh::LeanObject,
    mut v_lctx_759_: *mut leanh::LeanObject,
    ...
    let mut v_decls_765_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_766_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_decls_765_ = leanh::lean_ctor_get(v_lctx_759_, 1);
...
pub unsafe fn l_Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0___boxed(
    mut v_type_767_: *mut leanh::LeanObject,
    mut v_lctx_768_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_lctx_768_);
    return v_res_774_;
}
pub unsafe fn l_Lean_Meta_findLocalDeclWithType_x3f(
    mut v_type_775_: *mut leanh::LeanObject,
    ...
    let mut v_lctx_781_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_782_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_lctx_781_ = leanh::lean_ctor_get(v_a_776_, 2);
    v___x_782_ =
        l_Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0(
            v_type_775_,
            v_lctx_781_,
...
pub unsafe fn l_Lean_Meta_findLocalDeclWithType_x3f___boxed(
    mut v_type_783_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__1(
    mut v_type_790_: *mut leanh::LeanObject,
    mut v_as_791_: *mut leanh::LeanObject,
    mut v_i_792_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__1___boxed(
    mut v_type_800_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevMAux___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__2_spec__3(
    mut v_type_810_: *mut leanh::LeanObject,
    mut v_as_811_: *mut leanh::LeanObject,
    mut v_i_812_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevMAux___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_LocalContext_findDeclRevM_x3f___at___00Lean_Meta_findLocalDeclWithType_x3f_spec__0_spec__0_spec__2_spec__3___boxed(
    mut v_type_820_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_837_) == 0 {
                    ...
                    v_isSharedCheck_853_ = (!leanh::lean_is_exclusive(v___x_837_)) as u8;
            ...
            3 => {
                if v_isShared_849_ == 0 {
                    ...
                    v_reuseFailAlloc_852_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_852_, 0, v_a_846_);
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_assumptionCore_spec__1___redArg___boxed(
    mut v_mvarId_854_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_assumptionCore_spec__1(
    ...
    mut v_mvarId_863_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNodeAux___at___00Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2_spec__3_spec__4___redArg(
    ...
    let mut v_k_x27_896_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_ks_884_ = leanh::lean_ctor_get(v_x_880_, 0);
                v_vs_885_ = leanh::lean_ctor_get(v_x_880_, 1);
                v_isSharedCheck_909_ = (!leanh::lean_is_exclusive(v_x_880_)) as u8;
            ...
            1 => {
                ...
                if v___x_890_ == 0 {
                    ...
                    if v_isShared_888_ == 0 {
                        leanh::lean_ctor_set(v___x_887_, 1, v___x_892_);
                        leanh::lean_ctor_set(v___x_887_, 0, v___x_891_);
                        v___x_894_ = v___x_887_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_895_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_895_, 0, v___x_891_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_895_, 1, v___x_892_);
                    ...
                    if v___x_897_ == 0 {
                        if v_isShared_888_ == 0 {
                            ...
                            v_reuseFailAlloc_903_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                            leanh::lean_ctor_set(v_reuseFailAlloc_903_, 0, v_ks_884_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_903_, 1, v_vs_885_);
                        ...
                        leanh::lean_dec(v_x_881_);
                        if v_isShared_888_ == 0 {
                            leanh::lean_ctor_set(v___x_887_, 1, v___x_905_);
                            leanh::lean_ctor_set(v___x_887_, 0, v___x_904_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2_spec__3___redArg(
    ...
    mut v_v_912_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_913_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_914_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_913_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2___redArg(
    ...
    let mut v_es_927_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_928_: usize = 0;
    let mut v___x_929_: usize = 0;
    let mut v___x_930_: usize = 0;
    let mut v___x_931_: usize = 0;
    let mut v_j_932_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_v_938_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_939_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_xs_x27_940_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_key_947_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_node_959_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_ks_973_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_974_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_976_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_977_: u8 = 0;
    let mut v___x_979_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_newNode_980_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___y_982_: u8 = 0;
    let mut v_ks_983_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_984_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_922_) == 0 {
                    ...
                    if v___x_934_ == 0 {
                        leanh::lean_dec(v_j_932_);
                        leanh::lean_dec(v_x_926_);
                        leanh::lean_dec(v_x_925_);
                        return v_x_922_;
                    } else {
                        leanh::lean_inc_ref(v_es_927_);
                        v_isSharedCheck_971_ = (!leanh::lean_is_exclusive(v_x_922_)) as u8;
                        if v_isSharedCheck_971_ == 0 {
                            v_unused_972_ = leanh::lean_ctor_get(v_x_922_, 0);
                    ...
                    v_ks_973_ = leanh::lean_ctor_get(v_x_922_, 0);
                    v_vs_974_ = leanh::lean_ctor_get(v_x_922_, 1);
                    v_isSharedCheck_994_ = (!leanh::lean_is_exclusive(v_x_922_)) as u8;
                    if v_isSharedCheck_994_ == 0 {
                        ...
                        leanh::lean_inc(v_vs_974_);
                        leanh::lean_inc(v_ks_973_);
                        leanh::lean_dec(v_x_922_);
            ...
            1 => {
                ...
                match leanh::lean_obj_tag(v_v_938_) {
                    0 => {
                        v_key_947_ = leanh::lean_ctor_get(v_v_938_, 0);
                        v_val_948_ = leanh::lean_ctor_get(v_v_938_, 1);
                        v_isSharedCheck_958_ = (!leanh::lean_is_exclusive(v_v_938_)) as u8;
                        if v_isSharedCheck_958_ == 0 {
                            ...
                            leanh::lean_inc(v_key_947_);
                            leanh::lean_dec(v_v_938_);
                    ...
                    1 => {
                        v_node_959_ = leanh::lean_ctor_get(v_v_938_, 0);
                        v_isSharedCheck_969_ = (!leanh::lean_is_exclusive(v_v_938_)) as u8;
                    ...
                    _ => {
                        ...
                        leanh::lean_ctor_set(v___x_970_, 0, v_x_925_);
                        leanh::lean_ctor_set(v___x_970_, 1, v_x_926_);
            ...
            2 => {
                ...
                if v_isShared_937_ == 0 {
                    leanh::lean_ctor_set(v___x_936_, 0, v___x_943_);
            ...
            4 => {
                ...
                if v___x_952_ == 0 {
                    ...
                    leanh::lean_dec(v_val_948_);
                    leanh::lean_dec(v_key_947_);
                    if v_isShared_951_ == 0 {
                        leanh::lean_ctor_set(v___x_950_, 1, v_x_926_);
                        leanh::lean_ctor_set(v___x_950_, 0, v_x_925_);
                        v___x_956_ = v___x_950_;
                        state = 5;
                        continue;
                    } else {
                        v_reuseFailAlloc_957_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_957_, 0, v_x_925_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_957_, 1, v_x_926_);
            ...
            8 => {
                if v_isShared_977_ == 0 {
                    ...
                    v_reuseFailAlloc_993_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_993_, 0, v_ks_973_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_993_, 1, v_vs_974_);
            ...
            9 => {
                ...
                if v___x_989_ == 0 {
                    ...
                    v___x_991_ = leanh::lean_unsigned_to_nat(4);
            ...
            10 => {
                if v___y_982_ == 0 {
                    v_ks_983_ = leanh::lean_ctor_get(v_newNode_980_, 0);
                    leanh::lean_inc_ref(v_ks_983_);
                    v_vs_984_ = leanh::lean_ctor_get(v_newNode_980_, 1);
                    leanh::lean_inc_ref(v_vs_984_);
                    leanh::lean_dec_ref(v_newNode_980_);
                    ...
                    leanh::lean_dec_ref(v_vs_984_);
                    leanh::lean_dec_ref(v_ks_983_);
                    return v___x_987_;
                } else {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2_spec__4___redArg(
    ...
    mut v_keys_996_: *mut leanh::LeanObject,
    mut v_vals_997_: *mut leanh::LeanObject,
    mut v_i_998_: *mut leanh::LeanObject,
    mut v_entries_999_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2_spec__4___redArg___boxed(
    mut v_depth_1015_: *mut leanh::LeanObject,
    mut v_keys_1016_: *mut leanh::LeanObject,
    mut v_vals_1017_: *mut leanh::LeanObject,
    mut v_i_1018_: *mut leanh::LeanObject,
    mut v_entries_1019_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_1020_: usize = 0;
    let mut v_res_1021_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_1020_ = leanh::lean_unbox_usize(v_depth_1015_);
    leanh::lean_dec(v_depth_1015_);
    ...
    leanh::lean_dec_ref(v_vals_1017_);
    leanh::lean_dec_ref(v_keys_1016_);
    return v_res_1021_;
}
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2___redArg___boxed(
    ...
    v_x_1415__boxed_1027_ = leanh::lean_unbox_usize(v_x_1023_);
    leanh::lean_dec(v_x_1023_);
    v_x_1416__boxed_1028_ = leanh::lean_unbox_usize(v_x_1024_);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0___redArg(
    mut v_mvarId_1037_: *mut leanh::LeanObject,
    mut v_val_1038_: *mut leanh::LeanObject,
    ...
    let mut v_cache_1043_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_1044_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_1045_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_1046_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1048_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_1049_: u8 = 0;
    let mut v_depth_1050_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_levelAssignDepth_1051_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lmvarCounter_1052_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mvarCounter_1053_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lDecls_1054_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_decls_1055_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_userNames_1056_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lAssignment_1057_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_eAssignment_1058_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_dAssignment_1059_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_cache_1043_ = leanh::lean_ctor_get(v___x_1041_, 1);
                v_zetaDeltaFVarIds_1044_ = leanh::lean_ctor_get(v___x_1041_, 2);
                v_postponed_1045_ = leanh::lean_ctor_get(v___x_1041_, 3);
                v_diag_1046_ = leanh::lean_ctor_get(v___x_1041_, 4);
                v_isSharedCheck_1074_ = (!leanh::lean_is_exclusive(v___x_1041_)) as u8;
                if v_isSharedCheck_1074_ == 0 {
                    ...
                    leanh::lean_inc(v_diag_1046_);
                    leanh::lean_inc(v_postponed_1045_);
                    leanh::lean_inc(v_zetaDeltaFVarIds_1044_);
                    leanh::lean_inc(v_cache_1043_);
                    leanh::lean_inc(v_mctx_1042_);
            ...
            1 => {
                v_depth_1050_ = leanh::lean_ctor_get(v_mctx_1042_, 0);
                v_levelAssignDepth_1051_ = leanh::lean_ctor_get(v_mctx_1042_, 1);
                v_lmvarCounter_1052_ = leanh::lean_ctor_get(v_mctx_1042_, 2);
                v_mvarCounter_1053_ = leanh::lean_ctor_get(v_mctx_1042_, 3);
                v_lDecls_1054_ = leanh::lean_ctor_get(v_mctx_1042_, 4);
                v_decls_1055_ = leanh::lean_ctor_get(v_mctx_1042_, 5);
                v_userNames_1056_ = leanh::lean_ctor_get(v_mctx_1042_, 6);
                v_lAssignment_1057_ = leanh::lean_ctor_get(v_mctx_1042_, 7);
                v_eAssignment_1058_ = leanh::lean_ctor_get(v_mctx_1042_, 8);
                v_dAssignment_1059_ = leanh::lean_ctor_get(v_mctx_1042_, 9);
                v_isSharedCheck_1073_ = (!leanh::lean_is_exclusive(v_mctx_1042_)) as u8;
                if v_isSharedCheck_1073_ == 0 {
                    ...
                    leanh::lean_inc(v_dAssignment_1059_);
                    leanh::lean_inc(v_eAssignment_1058_);
                    leanh::lean_inc(v_lAssignment_1057_);
                    leanh::lean_inc(v_userNames_1056_);
                    leanh::lean_inc(v_decls_1055_);
                    leanh::lean_inc(v_lDecls_1054_);
                    leanh::lean_inc(v_mvarCounter_1053_);
                    leanh::lean_inc(v_lmvarCounter_1052_);
                    leanh::lean_inc(v_levelAssignDepth_1051_);
                    leanh::lean_inc(v_depth_1050_);
                    leanh::lean_dec(v_mctx_1042_);
            ...
            2 => {
                ...
                if v_isShared_1062_ == 0 {
                    leanh::lean_ctor_set(v___x_1061_, 8, v___x_1063_);
                    v___x_1065_ = v___x_1061_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_1072_ = leanh::lean_alloc_ctor(0, 10, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 0, v_depth_1050_);
                    leanh::lean_ctor_set(
                        v_reuseFailAlloc_1072_,
                        1,
                        v_levelAssignDepth_1051_,
                    );
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 2, v_lmvarCounter_1052_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 3, v_mvarCounter_1053_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 4, v_lDecls_1054_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 5, v_decls_1055_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 6, v_userNames_1056_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 7, v_lAssignment_1057_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 8, v___x_1063_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1072_, 9, v_dAssignment_1059_);
            ...
            3 => {
                if v_isShared_1049_ == 0 {
                    leanh::lean_ctor_set(v___x_1048_, 0, v___x_1065_);
                    v___x_1067_ = v___x_1048_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_1071_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1071_, 0, v___x_1065_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1071_, 1, v_cache_1043_);
                    leanh::lean_ctor_set(
                        v_reuseFailAlloc_1071_,
                        2,
                        v_zetaDeltaFVarIds_1044_,
                    );
                    leanh::lean_ctor_set(v_reuseFailAlloc_1071_, 3, v_postponed_1045_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1071_, 4, v_diag_1046_);
            ...
            4 => {
                ...
                v___x_1070_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0___redArg___boxed(
    mut v_mvarId_1075_: *mut leanh::LeanObject,
    mut v_val_1076_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assumptionCore___lam__0(
    ...
    loop {
        match state {
                ...
                if leanh::lean_obj_tag(v___x_1087_) == 0 {
                    ...
                    if leanh::lean_obj_tag(v___x_1088_) == 0 {
                        ...
                        if leanh::lean_obj_tag(v___x_1090_) == 0 {
                            ...
                            leanh::lean_dec(v_mvarId_1080_);
                            v_a_1114_ = leanh::lean_ctor_get(v___x_1090_, 0);
                        ...
                        leanh::lean_dec(v_mvarId_1080_);
                        v_a_1122_ = leanh::lean_ctor_get(v___x_1088_, 0);
                        v_isSharedCheck_1129_ =
                            (!leanh::lean_is_exclusive(v___x_1088_)) as u8;
                    ...
                    leanh::lean_dec(v_mvarId_1080_);
                    v_a_1130_ = leanh::lean_ctor_get(v___x_1087_, 0);
                    v_isSharedCheck_1137_ = (!leanh::lean_is_exclusive(v___x_1087_)) as u8;
            ...
            1 => {
                if leanh::lean_obj_tag(v_a_1091_) == 0 {
                    leanh::lean_dec(v_mvarId_1080_);
                    v___x_1095_ = 0;
                    v___x_1096_ = leanh::lean_box((v___x_1095_) as usize);
                    if v_isShared_1094_ == 0 {
                        leanh::lean_ctor_set(v___x_1093_, 0, v___x_1096_);
                        v___x_1098_ = v___x_1093_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_1099_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    ...
                    v_val_1100_ = leanh::lean_ctor_get(v_a_1091_, 0);
                    leanh::lean_inc(v_val_1100_);
                    leanh::lean_dec_ref_known(v_a_1091_, 1);
                    ...
                    if v_isSharedCheck_1111_ == 0 {
                        v_unused_1112_ = leanh::lean_ctor_get(v___x_1102_, 0);
            ...
            3 => {
                v___x_1106_ = 1;
                v___x_1107_ = leanh::lean_box((v___x_1106_) as usize);
            ...
            7 => {
                if v_isShared_1125_ == 0 {
                    ...
                    v_reuseFailAlloc_1128_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_1128_, 0, v_a_1122_);
...
pub unsafe fn l_Lean_MVarId_assumptionCore___lam__0___boxed(
    mut v_mvarId_1138_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assumptionCore(
    mut v_mvarId_1149_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assumptionCore___boxed(
    mut v_mvarId_1158_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0(
    ...
    mut v_val_1166_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0___boxed(
    mut v_mvarId_1173_: *mut leanh::LeanObject,
    mut v_val_1174_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0(
    mut v_00_u03b2_1181_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2(
    mut v_00_u03b2_1186_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2___boxed(
    ...
    v_x_1801__boxed_1199_ = leanh::lean_unbox_usize(v_x_1195_);
    leanh::lean_dec(v_x_1195_);
    v_x_1802__boxed_1200_ = leanh::lean_unbox_usize(v_x_1196_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2_spec__3(
    ...
    mut v_n_1203_: *mut leanh::LeanObject,
    mut v_k_1204_: *mut leanh::LeanObject,
    mut v_v_1205_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2_spec__4(
    ...
    mut v_keys_1209_: *mut leanh::LeanObject,
    mut v_vals_1210_: *mut leanh::LeanObject,
    mut v_heq_1211_: *mut leanh::LeanObject,
    mut v_i_1212_: *mut leanh::LeanObject,
    mut v_entries_1213_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_assumptionCore_spec__0_spec__0_spec__2_spec__4___boxed(
    ...
    mut v_depth_1216_: *mut leanh::LeanObject,
    mut v_keys_1217_: *mut leanh::LeanObject,
    mut v_vals_1218_: *mut leanh::LeanObject,
    mut v_heq_1219_: *mut leanh::LeanObject,
    mut v_i_1220_: *mut leanh::LeanObject,
    mut v_entries_1221_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_1222_: usize = 0;
    let mut v_res_1223_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_1222_ = leanh::lean_unbox_usize(v_depth_1216_);
    leanh::lean_dec(v_depth_1216_);
    ...
    leanh::lean_dec_ref(v_vals_1218_);
    leanh::lean_dec_ref(v_keys_1217_);
    return v_res_1223_;
}
...
pub unsafe fn l_Lean_MVarId_assumption(
    mut v_mvarId_1230_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_1236_) == 0 {
                    ...
                    leanh::lean_dec(v_mvarId_1230_);
                    v_a_1250_ = leanh::lean_ctor_get(v___x_1236_, 0);
                    v_isSharedCheck_1257_ = (!leanh::lean_is_exclusive(v___x_1236_)) as u8;
            ...
            1 => {
                v___x_1241_ = (leanh::lean_unbox(v_a_1237_) as u8);
                ...
                if v___x_1241_ == 0 {
                    ...
                    if v_isShared_1240_ == 0 {
                        leanh::lean_ctor_set(v___x_1239_, 0, v___x_1245_);
...
pub unsafe fn l_Lean_MVarId_assumption___boxed(
    mut v_mvarId_1258_: *mut leanh::LeanObject,
...
pub unsafe fn initialize_Lean_Meta_Tactic_Assumption(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
