...
static mut l_Lean_Meta_Tactic_BVDecide_bvDecide_x27___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l___private_Lean_Meta_Tactic_BVDecide_Main_0__Lean_Meta_Tactic_BVDecide_bvUnsat___lam__0(
    mut v_g_292_: *mut leanh::LeanObject,
    mut v___x_293_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Lean_Meta_Tactic_BVDecide_Main_0__Lean_Meta_Tactic_BVDecide_bvUnsat___lam__0___boxed(
    ...
    mut v___x_302_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Lean_Meta_Tactic_BVDecide_Main_0__Lean_Meta_Tactic_BVDecide_bvUnsat(
    ...
    v___x_317_ = leanh::lean_alloc_closure(
        l_Lean_Meta_Tactic_BVDecide_lratBitblaster___boxed as *mut core::ffi::c_void,
        9,
        1,
    );
    leanh::lean_closure_set(v___x_317_, 0, v_ctx_311_);
    v___f_318_ = leanh::lean_alloc_closure(l___private_Lean_Meta_Tactic_BVDecide_Main_0__Lean_Meta_Tactic_BVDecide_bvUnsat___lam__0___boxed as *mut core::ffi::c_void, 8, 2);
    leanh::lean_closure_set(v___f_318_, 0, v_g_310_);
    leanh::lean_closure_set(v___f_318_, 1, v___x_317_);
...
pub unsafe fn l___private_Lean_Meta_Tactic_BVDecide_Main_0__Lean_Meta_Tactic_BVDecide_bvUnsat___boxed(
    mut v_g_320_: *mut leanh::LeanObject,
    mut v_ctx_321_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_a_323_);
    leanh::lean_dec_ref(v_a_322_);
    return v_res_327_;
}
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_bvDecide_x27(
    mut v_g_330_: *mut leanh::LeanObject,
    mut v_ctx_331_: *mut leanh::LeanObject,
    ...
    let mut v_config_337_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_374_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_config_337_ = leanh::lean_ctor_get(v_ctx_331_, 5);
                ...
                if leanh::lean_obj_tag(v___x_338_) == 0 {
                    ...
                    v_isSharedCheck_391_ = (!leanh::lean_is_exclusive(v___x_338_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_ctx_331_);
                    v_a_392_ = leanh::lean_ctor_get(v___x_338_, 0);
                    v_isSharedCheck_399_ = (!leanh::lean_is_exclusive(v___x_338_)) as u8;
            ...
            1 => {
                if leanh::lean_obj_tag(v_a_339_) == 1 {
                    leanh::lean_del_object(v___x_341_);
                    v_val_343_ = leanh::lean_ctor_get(v_a_339_, 0);
                    v_isSharedCheck_386_ = (!leanh::lean_is_exclusive(v_a_339_)) as u8;
                    ...
                    if v_isShared_342_ == 0 {
                        leanh::lean_ctor_set(v___x_341_, 0, v___x_387_);
            ...
            2 => {
                ...
                if leanh::lean_obj_tag(v___x_347_) == 0 {
                    v_a_348_ = leanh::lean_ctor_get(v___x_347_, 0);
                    v_isSharedCheck_377_ = (!leanh::lean_is_exclusive(v___x_347_)) as u8;
                    ...
                    leanh::lean_del_object(v___x_345_);
                    v_a_378_ = leanh::lean_ctor_get(v___x_347_, 0);
                    v_isSharedCheck_385_ = (!leanh::lean_is_exclusive(v___x_347_)) as u8;
            ...
            3 => {
                if leanh::lean_obj_tag(v_a_348_) == 0 {
                    leanh::lean_del_object(v___x_345_);
                    v_a_352_ = leanh::lean_ctor_get(v_a_348_, 0);
                    v_isSharedCheck_362_ = (!leanh::lean_is_exclusive(v_a_348_)) as u8;
                    ...
                    v_a_363_ = leanh::lean_ctor_get(v_a_348_, 0);
                    v_isSharedCheck_376_ = (!leanh::lean_is_exclusive(v_a_348_)) as u8;
            ...
            4 => {
                if v_isShared_355_ == 0 {
                    ...
                    v_reuseFailAlloc_361_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_361_, 0, v_a_352_);
            ...
            5 => {
                if v_isShared_351_ == 0 {
                    leanh::lean_ctor_set(v___x_350_, 0, v___x_357_);
                    v___x_359_ = v___x_350_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_360_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_360_, 0, v___x_357_);
            ...
            7 => {
                if v_isShared_346_ == 0 {
                    leanh::lean_ctor_set(v___x_345_, 0, v_a_363_);
                    v___x_368_ = v___x_345_;
                    state = 8;
                    continue;
                } else {
                    v_reuseFailAlloc_375_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_375_, 0, v_a_363_);
            ...
            8 => {
                if v_isShared_366_ == 0 {
                    leanh::lean_ctor_set(v___x_365_, 0, v___x_368_);
                    v___x_370_ = v___x_365_;
                    state = 9;
                    continue;
                } else {
                    v_reuseFailAlloc_374_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_374_, 0, v___x_368_);
            ...
            9 => {
                if v_isShared_351_ == 0 {
                    leanh::lean_ctor_set(v___x_350_, 0, v___x_370_);
                    v___x_372_ = v___x_350_;
                    state = 10;
                    continue;
                } else {
                    v_reuseFailAlloc_373_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_373_, 0, v___x_370_);
            ...
            11 => {
                if v_isShared_381_ == 0 {
                    ...
                    v_reuseFailAlloc_384_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_384_, 0, v_a_378_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_bvDecide_x27___boxed(
    mut v_g_400_: *mut leanh::LeanObject,
    mut v_ctx_401_: *mut leanh::LeanObject,
    ...
    let mut v_res_407_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Lean_addMessageContextFull___at___00Lean_Meta_Tactic_BVDecide_bvDecide_spec__0(
    ...
    let mut v_env_415_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_416_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mctx_417_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lctx_418_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_options_419_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_env_415_ = leanh::lean_ctor_get(v___x_414_, 0);
    leanh::lean_inc_ref(v_env_415_);
    leanh::lean_dec(v___x_414_);
    v___x_416_ = lean_st_ref_get(v___y_410_);
    v_mctx_417_ = leanh::lean_ctor_get(v___x_416_, 0);
    leanh::lean_inc_ref(v_mctx_417_);
    leanh::lean_dec(v___x_416_);
    v_lctx_418_ = leanh::lean_ctor_get(v___y_409_, 2);
    v_options_419_ = leanh::lean_ctor_get(v___y_411_, 2);
    leanh::lean_inc_ref(v_options_419_);
    leanh::lean_inc_ref(v_lctx_418_);
    v___x_420_ = leanh::lean_alloc_ctor(0, 4, (0) as u32);
    leanh::lean_ctor_set(v___x_420_, 0, v_env_415_);
    leanh::lean_ctor_set(v___x_420_, 1, v_mctx_417_);
    leanh::lean_ctor_set(v___x_420_, 2, v_lctx_418_);
    leanh::lean_ctor_set(v___x_420_, 3, v_options_419_);
    v___x_421_ = leanh::lean_alloc_ctor(3, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_421_, 0, v___x_420_);
    leanh::lean_ctor_set(v___x_421_, 1, v_msgData_408_);
...
pub unsafe fn l_Lean_addMessageContextFull___at___00Lean_Meta_Tactic_BVDecide_bvDecide_spec__0___boxed(
    mut v_msgData_423_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_Meta_Tactic_BVDecide_bvDecide_spec__2___redArg(
    mut v_mvarId_430_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_437_) == 0 {
                    ...
                    v_isSharedCheck_445_ = (!leanh::lean_is_exclusive(v___x_437_)) as u8;
                    ...
                    v_a_446_ = leanh::lean_ctor_get(v___x_437_, 0);
                    v_isSharedCheck_453_ = (!leanh::lean_is_exclusive(v___x_437_)) as u8;
            ...
            1 => {
                if v_isShared_441_ == 0 {
                    ...
                    v_reuseFailAlloc_444_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_Meta_Tactic_BVDecide_bvDecide_spec__2(
    mut v_00_u03b1_462_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_Meta_Tactic_BVDecide_bvDecide_spec__2___boxed(
    ...
    mut v_mvarId_472_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_throwError___at___00Lean_Meta_Tactic_BVDecide_bvDecide_spec__1___redArg(
    ...
    let mut v_ref_486_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_ref_486_ = leanh::lean_ctor_get(v___y_483_, 5);
                ...
                v_isSharedCheck_496_ = (!leanh::lean_is_exclusive(v___x_487_)) as u8;
            ...
            1 => {
                leanh::lean_inc(v_ref_486_);
                v___x_492_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_492_, 0, v_ref_486_);
                leanh::lean_ctor_set(v___x_492_, 1, v_a_488_);
                if v_isShared_491_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_490_, 1);
                    leanh::lean_ctor_set(v___x_490_, 0, v___x_492_);
                    v___x_494_ = v___x_490_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_495_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_495_, 0, v___x_492_);
...
pub unsafe fn l_Lean_throwError___at___00Lean_Meta_Tactic_BVDecide_bvDecide_spec__1___redArg___boxed(
    mut v_msg_497_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_510_) == 0 {
                    ...
                    leanh::lean_dec_ref_known(v___x_510_, 1);
                    ...
                    v_a_515_ = leanh::lean_ctor_get(v___x_510_, 0);
                    v_isSharedCheck_522_ = (!leanh::lean_is_exclusive(v___x_510_)) as u8;
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_bvDecide(
    ...
    let mut v_goal_543_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_537_) == 0 {
                    v_a_538_ = leanh::lean_ctor_get(v___x_537_, 0);
                    v_isSharedCheck_550_ = (!leanh::lean_is_exclusive(v___x_537_)) as u8;
                    ...
                    v_a_551_ = leanh::lean_ctor_get(v___x_537_, 0);
                    v_isSharedCheck_558_ = (!leanh::lean_is_exclusive(v___x_537_)) as u8;
            ...
            1 => {
                if leanh::lean_obj_tag(v_a_538_) == 0 {
                    leanh::lean_del_object(v___x_540_);
                    v_a_542_ = leanh::lean_ctor_get(v_a_538_, 0);
                    leanh::lean_inc(v_a_542_);
                    leanh::lean_dec_ref_known(v_a_538_, 1);
                    v_goal_543_ = leanh::lean_ctor_get(v_a_542_, 0);
                    leanh::lean_inc(v_goal_543_);
                    ...
                    leanh::lean_closure_set(v___f_544_, 0, v_a_542_);
                    ...
                    v_a_546_ = leanh::lean_ctor_get(v_a_538_, 0);
                    leanh::lean_inc(v_a_546_);
                    leanh::lean_dec_ref_known(v_a_538_, 1);
                    if v_isShared_541_ == 0 {
                        leanh::lean_ctor_set(v___x_540_, 0, v_a_546_);
                        v___x_548_ = v___x_540_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_549_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_549_, 0, v_a_546_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_bvDecide___boxed(
    mut v_g_559_: *mut leanh::LeanObject,
    mut v_ctx_560_: *mut leanh::LeanObject,
