...
use crate::ffi::{
    lean_array_get, lean_array_get_size, lean_array_set, lean_mk_array, lean_nat_add,
...
static mut l_reduceCtorIdx___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_reduceCtorIdx___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
...
static mut l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__0_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__0_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9__value) as *mut leanh::LeanObject;
pub static l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__1_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9__value: leanh::LeanCtorObject<3> = leanh::LeanCtorObject { m_header: leanh::LeanObject { rc: 0, cs_size: (core::mem::size_of::<leanh::LeanObject>() + core::mem::size_of::<*mut leanh::LeanObject>()*2 + 8) as u16, other: 2, tag: 1 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut leanh::LeanObject,core::ptr::addr_of!(l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__0_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9__value) as *mut leanh::LeanObject,11681431521506135087 as *mut leanh::LeanObject] };
static mut l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__1_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__1_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9__value) as *mut leanh::LeanObject;
...
static mut l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__2_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9_: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_0____regBuiltin_reduceCtorIdx_declare__5___closed__2_00___x40_Lean_Meta_Tactic_Simp_BuiltinSimprocs_CtorIdx_4044519369____hygCtx___hyg_9__value) as *mut leanh::LeanObject;
pub unsafe fn l_Lean_Expr_withAppAux___at___00reduceCtorIdx_spec__0___redArg(
    ...
    let mut v_fn_169_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_arg_170_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_178_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_numParams_183_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_numIndices_184_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_193_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_cidx_206_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_212_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_reuseFailAlloc_213_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_233_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_239_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_161_) == 5 {
                    v_fn_169_ = leanh::lean_ctor_get(v_x_161_, 0);
                    leanh::lean_inc_ref(v_fn_169_);
                    v_arg_170_ = leanh::lean_ctor_get(v_x_161_, 1);
                    leanh::lean_inc_ref(v_arg_170_);
                    leanh::lean_dec_ref_known(v_x_161_, 2);
                    v___x_171_ = lean_array_set(v_x_162_, v_x_163_, v_arg_170_);
                    v___x_172_ = leanh::lean_unsigned_to_nat(1);
                    v___x_173_ = lean_nat_sub(v_x_163_, v___x_172_);
                    leanh::lean_dec(v_x_163_);
                    v_x_161_ = v_fn_169_;
                    v_x_162_ = v___x_171_;
                    v_x_163_ = v___x_173_;
                    state = 0;
                    ...
                    if leanh::lean_obj_tag(v___x_175_) == 1 {
                        v_val_176_ = leanh::lean_ctor_get(v___x_175_, 0);
                        leanh::lean_inc(v_val_176_);
                        leanh::lean_dec_ref_known(v___x_175_, 1);
                        v___x_177_ = l_isCtorIdx_x3f___redArg(v_val_176_, v___y_167_);
                        if leanh::lean_obj_tag(v___x_177_) == 0 {
                            v_a_178_ = leanh::lean_ctor_get(v___x_177_, 0);
                            v_isSharedCheck_232_ =
                                (!leanh::lean_is_exclusive(v___x_177_)) as u8;
                            ...
                            leanh::lean_dec_ref(v_x_162_);
                            v_a_233_ = leanh::lean_ctor_get(v___x_177_, 0);
                        ...
                        v___x_242_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        leanh::lean_ctor_set(v___x_242_, 0, v___x_241_);
                        return v___x_242_;
                    }
                }
            }
            1 => {
                if leanh::lean_obj_tag(v_a_178_) == 1 {
                    v_val_182_ = leanh::lean_ctor_get(v_a_178_, 0);
                    leanh::lean_inc(v_val_182_);
                    leanh::lean_dec_ref_known(v_a_178_, 1);
                    v_numParams_183_ = leanh::lean_ctor_get(v_val_182_, 1);
                    leanh::lean_inc(v_numParams_183_);
                    v_numIndices_184_ = leanh::lean_ctor_get(v_val_182_, 2);
                    leanh::lean_inc(v_numIndices_184_);
                    leanh::lean_dec(v_val_182_);
                    v___x_185_ = lean_array_get_size(v_x_162_);
                    v___x_186_ = lean_nat_add(v_numParams_183_, v_numIndices_184_);
                    leanh::lean_dec(v_numIndices_184_);
                    leanh::lean_dec(v_numParams_183_);
                    ...
                    if v___x_189_ == 0 {
                        ...
                        if v_isShared_181_ == 0 {
                            leanh::lean_ctor_set(v___x_180_, 0, v___x_190_);
                            v___x_192_ = v___x_180_;
                            state = 2;
                            continue;
                        } else {
                            v_reuseFailAlloc_193_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                            leanh::lean_ctor_set(v_reuseFailAlloc_193_, 0, v___x_190_);
                            v___x_192_ = v_reuseFailAlloc_193_;
                            state = 2;
                            continue;
                        }
                    } else {
                        leanh::lean_del_object(v___x_180_);
                        ...
                        if leanh::lean_obj_tag(v___x_197_) == 0 {
                            ...
                            v_isSharedCheck_219_ =
                                (!leanh::lean_is_exclusive(v___x_197_)) as u8;
                            ...
                            v_a_220_ = leanh::lean_ctor_get(v___x_197_, 0);
            ...
            3 => {
                if leanh::lean_obj_tag(v_a_198_) == 1 {
                    v_val_202_ = leanh::lean_ctor_get(v_a_198_, 0);
                    v_isSharedCheck_214_ = (!leanh::lean_is_exclusive(v_a_198_)) as u8;
                    ...
                    if v_isShared_201_ == 0 {
                        leanh::lean_ctor_set(v___x_200_, 0, v___x_215_);
                        v___x_217_ = v___x_200_;
                        state = 7;
                        continue;
                    } else {
                        v_reuseFailAlloc_218_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_218_, 0, v___x_215_);
            ...
            4 => {
                v_cidx_206_ = leanh::lean_ctor_get(v_val_202_, 2);
                leanh::lean_inc(v_cidx_206_);
                leanh::lean_dec(v_val_202_);
                v___x_207_ = l_Lean_mkNatLit(v_cidx_206_);
                if v_isShared_205_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_204_, 0);
                    leanh::lean_ctor_set(v___x_204_, 0, v___x_207_);
                    v___x_209_ = v___x_204_;
                    state = 5;
                    continue;
                } else {
                    v_reuseFailAlloc_213_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_213_, 0, v___x_207_);
            ...
            5 => {
                if v_isShared_201_ == 0 {
                    leanh::lean_ctor_set(v___x_200_, 0, v___x_209_);
                    v___x_211_ = v___x_200_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_212_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_212_, 0, v___x_209_);
            ...
            8 => {
                if v_isShared_223_ == 0 {
                    ...
                    v_reuseFailAlloc_226_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_226_, 0, v_a_220_);
            ...
            11 => {
                if v_isShared_236_ == 0 {
                    ...
                    v_reuseFailAlloc_239_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_239_, 0, v_a_233_);
...
pub unsafe fn l_Lean_Expr_withAppAux___at___00reduceCtorIdx_spec__0___redArg___boxed(
    ...
    leanh::lean_dec(v___y_247_);
    leanh::lean_dec_ref(v___y_246_);
    return v_res_251_;
}
pub unsafe fn _init_l_reduceCtorIdx___closed__0() -> *mut leanh::LeanObject {
    let mut v___x_252_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_dummy_253_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_252_ = leanh::lean_box(0);
    v_dummy_253_ = l_Lean_Expr_sort___override(v___x_252_);
    return v_dummy_253_;
}
pub unsafe fn l_reduceCtorIdx(
    mut v_e_254_: *mut leanh::LeanObject,
    ...
    let mut v_dummy_263_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_nargs_264_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_dummy_263_ = leanh::lean_obj_once(
...
pub unsafe fn l_reduceCtorIdx___boxed(
    ...
    leanh::lean_dec(v_a_272_);
    leanh::lean_dec_ref(v_a_271_);
    leanh::lean_dec(v_a_270_);
    return v_res_278_;
}
...
pub unsafe fn l_Lean_Expr_withAppAux___at___00reduceCtorIdx_spec__0___boxed(
    ...
    leanh::lean_dec(v___y_300_);
    leanh::lean_dec_ref(v___y_299_);
    leanh::lean_dec(v___y_298_);
    leanh::lean_dec_ref(v___y_297_);
    leanh::lean_dec(v___y_296_);
    leanh::lean_dec_ref(v___y_295_);
...
-> *mut leanh::LeanObject {
    ...
    v___x_313_ =
        leanh::lean_alloc_closure(l_reduceCtorIdx___boxed as *mut core::ffi::c_void, 9, 0);
