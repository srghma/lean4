...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Meta_isMatchValue_spec__0___redArg(
    ...
    let mut v_mctx_239_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_cache_244_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_245_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_246_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_247_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_257_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                ...
                if v___x_236_ == 0 {
                    v___x_237_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v___x_237_, 0, v_e_233_);
                    return v___x_237_;
                } else {
                    v___x_238_ = lean_st_ref_get(v___y_234_);
                    v_mctx_239_ = crate::leanh::lean_ctor_get(v___x_238_, 0);
                    crate::leanh::lean_inc_ref(v_mctx_239_);
                    crate::leanh::lean_dec(v___x_238_);
                    v___x_240_ = l_Lean_instantiateMVarsCore(v_mctx_239_, v_e_233_);
                    v_fst_241_ = crate::leanh::lean_ctor_get(v___x_240_, 0);
                    crate::leanh::lean_inc(v_fst_241_);
                    v_snd_242_ = crate::leanh::lean_ctor_get(v___x_240_, 1);
                    crate::leanh::lean_inc(v_snd_242_);
                    crate::leanh::lean_dec_ref(v___x_240_);
                    v___x_243_ = lean_st_ref_take(v___y_234_);
                    v_cache_244_ = crate::leanh::lean_ctor_get(v___x_243_, 1);
                    v_zetaDeltaFVarIds_245_ = crate::leanh::lean_ctor_get(v___x_243_, 2);
                    v_postponed_246_ = crate::leanh::lean_ctor_get(v___x_243_, 3);
                    v_diag_247_ = crate::leanh::lean_ctor_get(v___x_243_, 4);
                    v_isSharedCheck_256_ = (!crate::leanh::lean_is_exclusive(v___x_243_)) as u8;
                    if v_isSharedCheck_256_ == 0 {
                        v_unused_257_ = crate::leanh::lean_ctor_get(v___x_243_, 0);
                        crate::leanh::lean_dec(v_unused_257_);
                        v___x_249_ = v___x_243_;
                        v_isShared_250_ = v_isSharedCheck_256_;
                        state = 1;
                        continue;
                    } else {
                        crate::leanh::lean_inc(v_diag_247_);
                        crate::leanh::lean_inc(v_postponed_246_);
                        crate::leanh::lean_inc(v_zetaDeltaFVarIds_245_);
                        crate::leanh::lean_inc(v_cache_244_);
            ...
            1 => {
                if v_isShared_250_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_249_, 0, v_snd_242_);
                    v___x_252_ = v___x_249_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_255_ = crate::leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_255_, 0, v_snd_242_);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_255_, 1, v_cache_244_);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_255_, 2, v_zetaDeltaFVarIds_245_);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_255_, 3, v_postponed_246_);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_255_, 4, v_diag_247_);
            ...
            2 => {
                ...
                v___x_254_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                crate::leanh::lean_ctor_set(v___x_254_, 0, v_fst_241_);
                return v___x_254_;
            }
            _ => {}
        }
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Meta_isMatchValue_spec__0___redArg___boxed(
    mut v_e_258_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Meta_isMatchValue_spec__0(
    mut v_e_262_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_isMatchValue(
    ...
    let mut v_a_307_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_317_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_380_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_386_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_a_283_ = crate::leanh::lean_ctor_get(v___x_282_, 0);
                ...
                if crate::leanh::lean_obj_tag(v___x_284_) == 0 {
                    v_a_285_ = crate::leanh::lean_ctor_get(v___x_284_, 0);
                    v_isSharedCheck_449_ = (!crate::leanh::lean_is_exclusive(v___x_284_)) as u8;
                    ...
                    v_a_450_ = crate::leanh::lean_ctor_get(v___x_284_, 0);
                    v_isSharedCheck_457_ = (!crate::leanh::lean_is_exclusive(v___x_284_)) as u8;
            ...
            1 => {
                if crate::leanh::lean_obj_tag(v_a_285_) == 0 {
                    crate::leanh::lean_del_object(v___x_287_);
                    crate::leanh::lean_inc(v_a_283_);
                    ...
                    if crate::leanh::lean_obj_tag(v___x_289_) == 0 {
                        ...
                        v_isSharedCheck_435_ = (!crate::leanh::lean_is_exclusive(v___x_289_)) as u8;
                        ...
                        crate::leanh::lean_dec(v_a_283_);
                        v_a_436_ = crate::leanh::lean_ctor_get(v___x_289_, 0);
                        v_isSharedCheck_443_ = (!crate::leanh::lean_is_exclusive(v___x_289_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_285_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_444_ = 1;
                    v___x_445_ = crate::leanh::lean_box((v___x_444_) as usize);
                    if v_isShared_288_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_287_, 0, v___x_445_);
                        v___x_447_ = v___x_287_;
                        state = 36;
                        continue;
                    } else {
                        v_reuseFailAlloc_448_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_448_, 0, v___x_445_);
            ...
            2 => {
                v___x_294_ = 1;
                if crate::leanh::lean_obj_tag(v_a_290_) == 0 {
                    crate::leanh::lean_del_object(v___x_292_);
                    crate::leanh::lean_inc(v_a_283_);
                    ...
                    if crate::leanh::lean_obj_tag(v___x_295_) == 0 {
                        ...
                        v_isSharedCheck_422_ = (!crate::leanh::lean_is_exclusive(v___x_295_)) as u8;
                        ...
                        crate::leanh::lean_dec(v_a_283_);
                        v_a_423_ = crate::leanh::lean_ctor_get(v___x_295_, 0);
                        v_isSharedCheck_430_ = (!crate::leanh::lean_is_exclusive(v___x_295_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_290_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_431_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_293_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_292_, 0, v___x_431_);
                        v___x_433_ = v___x_292_;
                        state = 33;
                        continue;
                    } else {
                        v_reuseFailAlloc_434_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_434_, 0, v___x_431_);
            ...
            3 => {
                if crate::leanh::lean_obj_tag(v_a_296_) == 0 {
                    crate::leanh::lean_del_object(v___x_298_);
                    crate::leanh::lean_inc(v_a_283_);
                    v___x_300_ = l_Lean_Meta_getBitVecValue_x3f(
                        v_a_283_, v_a_277_, v_a_278_, v_a_279_, v_a_280_,
                    );
                    if crate::leanh::lean_obj_tag(v___x_300_) == 0 {
                        v_a_301_ = crate::leanh::lean_ctor_get(v___x_300_, 0);
                        v_isSharedCheck_409_ = (!crate::leanh::lean_is_exclusive(v___x_300_)) as u8;
                        ...
                        crate::leanh::lean_dec(v_a_283_);
                        v_a_410_ = crate::leanh::lean_ctor_get(v___x_300_, 0);
                        v_isSharedCheck_417_ = (!crate::leanh::lean_is_exclusive(v___x_300_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_296_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_418_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_299_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_298_, 0, v___x_418_);
            ...
            4 => {
                if crate::leanh::lean_obj_tag(v_a_301_) == 0 {
                    ...
                    if crate::leanh::lean_obj_tag(v___x_305_) == 0 {
                        crate::leanh::lean_del_object(v___x_303_);
                        crate::leanh::lean_inc(v_a_283_);
                        v___x_306_ = l_Lean_Meta_getCharValue_x3f(
                            v_a_283_, v_a_277_, v_a_278_, v_a_279_, v_a_280_,
                        );
                        if crate::leanh::lean_obj_tag(v___x_306_) == 0 {
                            v_a_307_ = crate::leanh::lean_ctor_get(v___x_306_, 0);
                            v_isSharedCheck_392_ =
                                (!crate::leanh::lean_is_exclusive(v___x_306_)) as u8;
                            ...
                            crate::leanh::lean_dec(v_a_283_);
                            v_a_393_ = crate::leanh::lean_ctor_get(v___x_306_, 0);
                        ...
                        crate::leanh::lean_dec_ref_known(v___x_305_, 1);
                        crate::leanh::lean_dec(v_a_283_);
                        v___x_401_ = crate::leanh::lean_box((v___x_294_) as usize);
                        if v_isShared_304_ == 0 {
                            crate::leanh::lean_ctor_set(v___x_303_, 0, v___x_401_);
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_301_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_405_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_304_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_303_, 0, v___x_405_);
            ...
            5 => {
                if crate::leanh::lean_obj_tag(v_a_307_) == 0 {
                    crate::leanh::lean_del_object(v___x_309_);
                    crate::leanh::lean_inc(v_a_283_);
                    v___x_311_ = l_Lean_Meta_getUInt8Value_x3f(
                        v_a_283_, v_a_277_, v_a_278_, v_a_279_, v_a_280_,
                    );
                    if crate::leanh::lean_obj_tag(v___x_311_) == 0 {
                        v_a_312_ = crate::leanh::lean_ctor_get(v___x_311_, 0);
                        v_isSharedCheck_379_ = (!crate::leanh::lean_is_exclusive(v___x_311_)) as u8;
                        if v_isSharedCheck_379_ == 0 {
                            ...
                            crate::leanh::lean_dec(v___x_311_);
                        ...
                        crate::leanh::lean_dec(v_a_283_);
                        v_a_380_ = crate::leanh::lean_ctor_get(v___x_311_, 0);
                        v_isSharedCheck_387_ = (!crate::leanh::lean_is_exclusive(v___x_311_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_307_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_388_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_310_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_309_, 0, v___x_388_);
            ...
            6 => {
                if crate::leanh::lean_obj_tag(v_a_312_) == 0 {
                    crate::leanh::lean_del_object(v___x_314_);
                    crate::leanh::lean_inc(v_a_283_);
                    v___x_316_ = l_Lean_Meta_getUInt16Value_x3f(
                        v_a_283_, v_a_277_, v_a_278_, v_a_279_, v_a_280_,
                    );
                    if crate::leanh::lean_obj_tag(v___x_316_) == 0 {
                        v_a_317_ = crate::leanh::lean_ctor_get(v___x_316_, 0);
                        v_isSharedCheck_366_ = (!crate::leanh::lean_is_exclusive(v___x_316_)) as u8;
                        ...
                        crate::leanh::lean_dec(v_a_283_);
                        v_a_367_ = crate::leanh::lean_ctor_get(v___x_316_, 0);
                        v_isSharedCheck_374_ = (!crate::leanh::lean_is_exclusive(v___x_316_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_312_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_375_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_315_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_314_, 0, v___x_375_);
                        v___x_377_ = v___x_314_;
                        state = 20;
                        continue;
                    } else {
                        v_reuseFailAlloc_378_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
            ...
            7 => {
                if crate::leanh::lean_obj_tag(v_a_317_) == 0 {
                    crate::leanh::lean_del_object(v___x_319_);
                    crate::leanh::lean_inc(v_a_283_);
                    v___x_321_ = l_Lean_Meta_getUInt32Value_x3f(
                        v_a_283_, v_a_277_, v_a_278_, v_a_279_, v_a_280_,
                    );
                    if crate::leanh::lean_obj_tag(v___x_321_) == 0 {
                        v_a_322_ = crate::leanh::lean_ctor_get(v___x_321_, 0);
                        v_isSharedCheck_353_ = (!crate::leanh::lean_is_exclusive(v___x_321_)) as u8;
                        ...
                        crate::leanh::lean_dec(v_a_283_);
                        v_a_354_ = crate::leanh::lean_ctor_get(v___x_321_, 0);
                        v_isSharedCheck_361_ = (!crate::leanh::lean_is_exclusive(v___x_321_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_317_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_362_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_320_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_319_, 0, v___x_362_);
                        v___x_364_ = v___x_319_;
                        state = 17;
                        continue;
                    } else {
                        v_reuseFailAlloc_365_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_365_, 0, v___x_362_);
            ...
            8 => {
                if crate::leanh::lean_obj_tag(v_a_322_) == 0 {
                    crate::leanh::lean_del_object(v___x_324_);
                    ...
                    if crate::leanh::lean_obj_tag(v___x_326_) == 0 {
                        ...
                        v_isSharedCheck_340_ = (!crate::leanh::lean_is_exclusive(v___x_326_)) as u8;
                        ...
                        v_a_341_ = crate::leanh::lean_ctor_get(v___x_326_, 0);
                        v_isSharedCheck_348_ = (!crate::leanh::lean_is_exclusive(v___x_326_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref_known(v_a_322_, 1);
                    crate::leanh::lean_dec(v_a_283_);
                    v___x_349_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_325_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_324_, 0, v___x_349_);
                        v___x_351_ = v___x_324_;
                        state = 14;
                        continue;
                    } else {
                        v_reuseFailAlloc_352_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_352_, 0, v___x_349_);
            ...
            9 => {
                if crate::leanh::lean_obj_tag(v_a_327_) == 0 {
                    v___x_331_ = 0;
                    v___x_332_ = crate::leanh::lean_box((v___x_331_) as usize);
                    if v_isShared_330_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_329_, 0, v___x_332_);
                        v___x_334_ = v___x_329_;
                        state = 10;
                        continue;
                    } else {
                        v_reuseFailAlloc_335_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_335_, 0, v___x_332_);
                        v___x_334_ = v_reuseFailAlloc_335_;
                        state = 10;
                        continue;
                    }
                } else {
                    crate::leanh::lean_dec_ref_known(v_a_327_, 1);
                    v___x_336_ = crate::leanh::lean_box((v___x_294_) as usize);
                    if v_isShared_330_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_329_, 0, v___x_336_);
                        v___x_338_ = v___x_329_;
                        state = 11;
                        continue;
                    } else {
                        v_reuseFailAlloc_339_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_339_, 0, v___x_336_);
            ...
            12 => {
                if v_isShared_344_ == 0 {
                    ...
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_347_, 0, v_a_341_);
            ...
            15 => {
                if v_isShared_357_ == 0 {
                    ...
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_360_, 0, v_a_354_);
            ...
            18 => {
                if v_isShared_370_ == 0 {
                    ...
                    v_reuseFailAlloc_373_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_373_, 0, v_a_367_);
            ...
            21 => {
                if v_isShared_383_ == 0 {
                    ...
                    v_reuseFailAlloc_386_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_386_, 0, v_a_380_);
            ...
            28 => {
                if v_isShared_413_ == 0 {
                    ...
                    v_reuseFailAlloc_416_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
            ...
            31 => {
                if v_isShared_426_ == 0 {
                    ...
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_429_, 0, v_a_423_);
            ...
            34 => {
                if v_isShared_439_ == 0 {
                    ...
                    v_reuseFailAlloc_442_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_442_, 0, v_a_436_);
...
pub unsafe fn l_Lean_Meta_isMatchValue___boxed(
    ...
    crate::leanh::lean_dec_ref(v_a_459_);
    return v_res_464_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lean_Meta_Match_Value(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_Match_Value(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Match_Value(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
