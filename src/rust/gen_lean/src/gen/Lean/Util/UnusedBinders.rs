...
pub unsafe fn l_Lean_Expr_hasUnusedForallBindersWhere(
    ...
    mut v_e_23_: *mut leanh::LeanObject,
) -> u8 {
    let mut v___x_24_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderType_25_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_26_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_body_36_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                match leanh::lean_obj_tag(v___x_24_) {
                    7 => {
                        v_binderType_25_ = leanh::lean_ctor_get(v___x_24_, 1);
                        leanh::lean_inc_ref(v_binderType_25_);
                        v_body_26_ = leanh::lean_ctor_get(v___x_24_, 2);
                        leanh::lean_inc_ref(v_body_26_);
                        v_binderInfo_27_ = leanh::lean_ctor_get_uint8(
                            v___x_24_,
                            (core::mem::size_of::<*mut leanh::LeanObject>() * 3 + 8) as u32,
                        );
                        leanh::lean_dec_ref_known(v___x_24_, 3);
                        v___x_28_ = leanh::lean_box((v_binderInfo_27_) as usize);
                        leanh::lean_inc_ref(v_p_22_);
                        v___x_29_ =
                            leanh::lean_apply_2(v_p_22_, v___x_28_, v_binderType_25_);
                        v___x_30_ = (leanh::lean_unbox(v___x_29_) as u8);
                        if v___x_30_ == 0 {
                            v_e_23_ = v_body_26_;
                            state = 0;
                            continue;
                            ...
                            if v___x_33_ == 0 {
                                leanh::lean_dec_ref(v_body_26_);
                                leanh::lean_dec_ref(v_p_22_);
                                v___x_34_ = (leanh::lean_unbox(v___x_29_) as u8);
                                return v___x_34_;
                            } else {
                                v_e_23_ = v_body_26_;
                                state = 0;
                    ...
                    8 => {
                        v_body_36_ = leanh::lean_ctor_get(v___x_24_, 3);
                        leanh::lean_inc_ref(v_body_36_);
                        leanh::lean_dec_ref_known(v___x_24_, 4);
                        v_e_23_ = v_body_36_;
                        state = 0;
                        continue;
                    }
                    _ => {
                        leanh::lean_dec_ref(v___x_24_);
                        leanh::lean_dec_ref(v_p_22_);
                        v___x_38_ = 0;
                        return v___x_38_;
                    }
...
pub unsafe fn l_Lean_Expr_hasUnusedForallBindersWhere___boxed(
    mut v_p_39_: *mut leanh::LeanObject,
    mut v_e_40_: *mut leanh::LeanObject,
...
pub unsafe fn initialize_Lean_Util_UnusedBinders(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
