...
pub static l_Lean_determineLakePath___closed__0_value: leanh::LeanStringObject<5> =
...
static mut l_Lean_determineLakePath___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__0_value)
        as *mut leanh::LeanObject;
pub static l_Lean_determineLakePath___closed__1_value: leanh::LeanStringObject<13> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_determineLakePath___closed__1: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__1_value)
        as *mut leanh::LeanObject;
pub static l_Lean_determineLakePath___closed__2_value: leanh::LeanStringObject<5> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_determineLakePath___closed__2: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__2_value)
        as *mut leanh::LeanObject;
pub static l_Lean_determineLakePath___closed__3_value: leanh::LeanStringObject<4> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_determineLakePath___closed__3: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__3_value)
        as *mut leanh::LeanObject;
pub unsafe fn l_Lean_determineLakePath() -> *mut leanh::LeanObject {
    ...
    let mut v_reuseFailAlloc_69_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_81_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_49_) == 1 {
                    v_val_50_ = leanh::lean_ctor_get(v___x_49_, 0);
                    v_isSharedCheck_57_ = (!leanh::lean_is_exclusive(v___x_49_)) as u8;
                    ...
                    if leanh::lean_obj_tag(v___x_59_) == 0 {
                        ...
                        v_val_71_ = leanh::lean_ctor_get(v___x_59_, 0);
                        v_isSharedCheck_82_ = (!leanh::lean_is_exclusive(v___x_59_)) as u8;
            ...
            1 => {
                if v_isShared_53_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_52_, 0);
                    v___x_55_ = v___x_52_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_56_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_56_, 0, v_val_50_);
            ...
            3 => {
                ...
                if v_isShared_64_ == 0 {
                    leanh::lean_ctor_set(v___x_63_, 0, v___x_66_);
                    v___x_68_ = v___x_63_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_69_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_69_, 0, v___x_66_);
            ...
            5 => {
                ...
                if v_isShared_74_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_73_, 0);
                    leanh::lean_ctor_set(v___x_73_, 0, v___x_78_);
                    v___x_80_ = v___x_73_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_81_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_81_, 0, v___x_78_);
...
pub unsafe fn runtime_initialize_Lean_Util_LakePath(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_Util_LakePath(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Util_LakePath(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
