...
pub unsafe fn l_Lean_Expr_replaceImpl___boxed(
    mut v_f_x3f_101_: *mut leanh::LeanObject,
    mut v_e_102_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_103_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_103_ = lean_replace_expr(v_f_x3f_101_, v_e_102_);
    leanh::lean_dec_ref(v_e_102_);
    leanh::lean_dec_ref(v_f_x3f_101_);
    return v_res_103_;
}
pub unsafe fn l_Lean_Expr_replace(
    mut v_f_x3f_104_: *mut leanh::LeanObject,
    mut v_e_105_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_Expr_replace___boxed(
    mut v_f_x3f_107_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_e_108_);
    leanh::lean_dec_ref(v_f_x3f_107_);
    return v_res_109_;
}
pub unsafe fn l_Lean_Expr_replaceNoCache(
    mut v_f_x3f_110_: *mut leanh::LeanObject,
    mut v_e_111_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_112_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderName_113_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderType_114_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_115_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderInfo_116_: u8 = 0;
    let mut v_d_117_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_118_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_binderName_130_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderType_131_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_132_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderInfo_133_: u8 = 0;
    let mut v_d_134_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_135_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_data_147_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_148_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_149_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_declName_154_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_type_155_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_value_156_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_157_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_nondep_158_: u8 = 0;
    let mut v_t_159_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_v_160_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_161_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_fn_175_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_arg_176_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_f_177_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_typeName_188_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_idx_189_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_struct_190_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_191_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                leanh::lean_inc_ref(v_f_x3f_110_);
                leanh::lean_inc_ref(v_e_111_);
                v___x_112_ = leanh::lean_apply_1(v_f_x3f_110_, v_e_111_);
                if leanh::lean_obj_tag(v___x_112_) == 0 {
                    match leanh::lean_obj_tag(v_e_111_) {
                        7 => {
                            v_binderName_113_ = leanh::lean_ctor_get(v_e_111_, 0);
                            v_binderType_114_ = leanh::lean_ctor_get(v_e_111_, 1);
                            v_body_115_ = leanh::lean_ctor_get(v_e_111_, 2);
                            v_binderInfo_116_ = leanh::lean_ctor_get_uint8(
                                v_e_111_,
                                (core::mem::size_of::<*mut leanh::LeanObject>() * 3 + 8)
                                    as u32,
                            );
                            leanh::lean_inc_ref(v_binderType_114_);
                            leanh::lean_inc_ref(v_f_x3f_110_);
                            v_d_117_ = l_Lean_Expr_replaceNoCache(v_f_x3f_110_, v_binderType_114_);
                            leanh::lean_inc_ref(v_body_115_);
                        ...
                        6 => {
                            v_binderName_130_ = leanh::lean_ctor_get(v_e_111_, 0);
                            v_binderType_131_ = leanh::lean_ctor_get(v_e_111_, 1);
                            v_body_132_ = leanh::lean_ctor_get(v_e_111_, 2);
                            v_binderInfo_133_ = leanh::lean_ctor_get_uint8(
                                v_e_111_,
                                (core::mem::size_of::<*mut leanh::LeanObject>() * 3 + 8)
                                    as u32,
                            );
                            leanh::lean_inc_ref(v_binderType_131_);
                            leanh::lean_inc_ref(v_f_x3f_110_);
                            v_d_134_ = l_Lean_Expr_replaceNoCache(v_f_x3f_110_, v_binderType_131_);
                            leanh::lean_inc_ref(v_body_132_);
                        ...
                        10 => {
                            v_data_147_ = leanh::lean_ctor_get(v_e_111_, 0);
                            v_expr_148_ = leanh::lean_ctor_get(v_e_111_, 1);
                            leanh::lean_inc_ref(v_expr_148_);
                            ...
                            if v___x_152_ == 0 {
                                leanh::lean_inc(v_data_147_);
                                leanh::lean_dec_ref_known(v_e_111_, 2);
                                v___x_153_ = l_Lean_Expr_mdata___override(v_data_147_, v_b_149_);
                                return v___x_153_;
                            } else {
                                leanh::lean_dec_ref(v_b_149_);
                                return v_e_111_;
                            }
                        }
                        8 => {
                            v_declName_154_ = leanh::lean_ctor_get(v_e_111_, 0);
                            v_type_155_ = leanh::lean_ctor_get(v_e_111_, 1);
                            v_value_156_ = leanh::lean_ctor_get(v_e_111_, 2);
                            v_body_157_ = leanh::lean_ctor_get(v_e_111_, 3);
                            v_nondep_158_ = leanh::lean_ctor_get_uint8(
                                v_e_111_,
                                (core::mem::size_of::<*mut leanh::LeanObject>() * 4 + 8)
                                    as u32,
                            );
                            leanh::lean_inc_ref(v_type_155_);
                            leanh::lean_inc_ref_n(v_f_x3f_110_, 2);
                            v_t_159_ = l_Lean_Expr_replaceNoCache(v_f_x3f_110_, v_type_155_);
                            leanh::lean_inc_ref(v_value_156_);
                            v_v_160_ = l_Lean_Expr_replaceNoCache(v_f_x3f_110_, v_value_156_);
                            leanh::lean_inc_ref(v_body_157_);
                        ...
                        5 => {
                            v_fn_175_ = leanh::lean_ctor_get(v_e_111_, 0);
                            v_arg_176_ = leanh::lean_ctor_get(v_e_111_, 1);
                            leanh::lean_inc_ref(v_fn_175_);
                            leanh::lean_inc_ref(v_f_x3f_110_);
                            v_f_177_ = l_Lean_Expr_replaceNoCache(v_f_x3f_110_, v_fn_175_);
                            leanh::lean_inc_ref(v_arg_176_);
                        ...
                        11 => {
                            v_typeName_188_ = leanh::lean_ctor_get(v_e_111_, 0);
                            v_idx_189_ = leanh::lean_ctor_get(v_e_111_, 1);
                            v_struct_190_ = leanh::lean_ctor_get(v_e_111_, 2);
                            leanh::lean_inc_ref(v_struct_190_);
                            ...
                            if v___x_194_ == 0 {
                                leanh::lean_inc(v_idx_189_);
                                leanh::lean_inc(v_typeName_188_);
                                leanh::lean_dec_ref_known(v_e_111_, 3);
                                ...
                                leanh::lean_dec_ref(v_b_191_);
                                return v_e_111_;
                            }
                        }
                        _ => {
                            leanh::lean_dec_ref(v_f_x3f_110_);
                            return v_e_111_;
                        }
                    }
                } else {
                    leanh::lean_dec_ref(v_e_111_);
                    leanh::lean_dec_ref(v_f_x3f_110_);
                    v_val_196_ = leanh::lean_ctor_get(v___x_112_, 0);
                    leanh::lean_inc(v_val_196_);
                    leanh::lean_dec_ref_known(v___x_112_, 1);
                    return v_val_196_;
                }
            }
            1 => {
                if v___y_120_ == 0 {
                    leanh::lean_inc(v_binderName_113_);
                    leanh::lean_dec_ref_known(v_e_111_, 3);
                    ...
                    if v___x_122_ == 0 {
                        ...
                        leanh::lean_dec_ref(v_b_118_);
                        leanh::lean_dec_ref(v_d_117_);
                        return v_e_111_;
                    }
                }
            }
            2 => {
                if v___y_137_ == 0 {
                    leanh::lean_inc(v_binderName_130_);
                    leanh::lean_dec_ref_known(v_e_111_, 3);
                    ...
                    if v___x_139_ == 0 {
                        ...
                        leanh::lean_dec_ref(v_b_135_);
                        leanh::lean_dec_ref(v_d_134_);
                        return v_e_111_;
                    }
                }
            }
            3 => {
                if v___y_163_ == 0 {
                    leanh::lean_inc(v_declName_154_);
                    leanh::lean_dec_ref_known(v_e_111_, 4);
                    ...
                    if v___x_167_ == 0 {
                        ...
                        leanh::lean_dec_ref(v_b_161_);
                        leanh::lean_dec_ref(v_v_160_);
                        leanh::lean_dec_ref(v_t_159_);
                        return v_e_111_;
                    }
                }
            }
            4 => {
                if v___y_180_ == 0 {
                    ...
                    leanh::lean_dec_ref(v_a_178_);
                    leanh::lean_dec_ref(v_f_177_);
                    return v_e_111_;
                }
            }
            _ => {}
...
pub unsafe fn meta_initialize_Lean_Util_ReplaceExpr(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Util_ReplaceExpr(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
