...
// Module: Lean.Data.PPContext
// Imports: Lean.Data.OpenDecl Lean.Environment Lean.MetavarContext
...
pub unsafe fn runtime_initialize_Lean_Data_PPContext(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_Data_PPContext(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Data_PPContext(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
    ...
    leanh::lean_dec_ref(res);
    res = meta_initialize_Lean_Data_PPContext(builtin);
    if leanh::lean_io_result_is_error(res) {
        return res;
    }
    leanh::lean_dec_ref(res);
    return initialize_Lean_Data_PPContext(builtin);
}