...
// Imports: Init.Grind.Ring.Basic Init.Grind.Ring.Field Init.Grind.Ring.OfScientific Init.Grind.Ring.Envelope Init.Grind.Ring.CommSolver Init.Grind.Ring.CommSemiringAdapter Init.Grind.Ring.ToInt
...
pub unsafe fn runtime_initialize_Init_Grind_Ring(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Grind_Ring(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Grind_Ring(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
