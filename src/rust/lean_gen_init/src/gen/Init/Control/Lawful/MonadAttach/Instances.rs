...
pub unsafe fn l___private_Init_Control_Lawful_MonadAttach_Instances_0__instMonadAttachExceptTOfMonad_match__1_splitter___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_a_68_) == 0 {
        ...
        v_a_71_ = crate::leanh::lean_ctor_get(v_a_68_, 0);
        crate::leanh::lean_inc(v_a_71_);
        crate::leanh::lean_dec_ref_known(v_a_68_, 1);
        v___x_72_ = crate::leanh::lean_apply_2(v_h__2_70_, v_a_71_, crate::leanh::lean_box(0));
        return v___x_72_;
    } else {
        let mut v_a_73_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_74_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        crate::leanh::lean_dec(v_h__2_70_);
        v_a_73_ = crate::leanh::lean_ctor_get(v_a_68_, 0);
        crate::leanh::lean_inc(v_a_73_);
        crate::leanh::lean_dec_ref_known(v_a_68_, 1);
        v___x_74_ = crate::leanh::lean_apply_2(v_h__1_69_, v_a_73_, crate::leanh::lean_box(0));
        return v___x_74_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_MonadAttach_Instances_0__instMonadAttachExceptTOfMonad_match__1_splitter(
    ...
    mut v_00_u03b5_76_: *mut crate::leanh::LeanObject,
    ...
    mut v_h_82_: *mut crate::leanh::LeanObject,
    mut v_h__1_83_: *mut crate::leanh::LeanObject,
    mut v_h__2_84_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    if crate::leanh::lean_obj_tag(v_a_81_) == 0 {
        let mut v_a_85_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_86_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        crate::leanh::lean_dec(v_h__1_83_);
        v_a_85_ = crate::leanh::lean_ctor_get(v_a_81_, 0);
        crate::leanh::lean_inc(v_a_85_);
        crate::leanh::lean_dec_ref_known(v_a_81_, 1);
        v___x_86_ = crate::leanh::lean_apply_2(v_h__2_84_, v_a_85_, crate::leanh::lean_box(0));
        return v___x_86_;
    } else {
        ...
        v_a_87_ = crate::leanh::lean_ctor_get(v_a_81_, 0);
        crate::leanh::lean_inc(v_a_87_);
        crate::leanh::lean_dec_ref_known(v_a_81_, 1);
        v___x_88_ = crate::leanh::lean_apply_2(v_h__1_83_, v_a_87_, crate::leanh::lean_box(0));
        return v___x_88_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_MonadAttach_Instances_0__instMonadAttachExceptTOfMonad_match__1_splitter___boxed(
    ...
    mut v_00_u03b5_90_: *mut crate::leanh::LeanObject,
    ...
    mut v_h_96_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec(v_x_93_);
    crate::leanh::lean_dec(v_inst_91_);
    return v_res_99_;
}
pub unsafe fn l___private_Init_Control_Lawful_MonadAttach_Instances_0__ExceptT_bindCont_match__1_splitter___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_x_100_) == 0 {
        ...
        v_a_103_ = crate::leanh::lean_ctor_get(v_x_100_, 0);
        crate::leanh::lean_inc(v_a_103_);
        crate::leanh::lean_dec_ref_known(v_x_100_, 1);
        v___x_104_ = crate::leanh::lean_apply_1(v_h__2_102_, v_a_103_);
        return v___x_104_;
    } else {
        ...
        v_a_105_ = crate::leanh::lean_ctor_get(v_x_100_, 0);
        crate::leanh::lean_inc(v_a_105_);
        crate::leanh::lean_dec_ref_known(v_x_100_, 1);
        v___x_106_ = crate::leanh::lean_apply_1(v_h__1_101_, v_a_105_);
        return v___x_106_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_MonadAttach_Instances_0__ExceptT_bindCont_match__1_splitter(
    mut v_00_u03b5_107_: *mut crate::leanh::LeanObject,
    mut v_00_u03b1_108_: *mut crate::leanh::LeanObject,
    mut v_motive_109_: *mut crate::leanh::LeanObject,
    ...
    if crate::leanh::lean_obj_tag(v_x_110_) == 0 {
        let mut v_a_113_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_114_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        crate::leanh::lean_dec(v_h__1_111_);
        v_a_113_ = crate::leanh::lean_ctor_get(v_x_110_, 0);
        crate::leanh::lean_inc(v_a_113_);
        crate::leanh::lean_dec_ref_known(v_x_110_, 1);
        v___x_114_ = crate::leanh::lean_apply_1(v_h__2_112_, v_a_113_);
        return v___x_114_;
    } else {
        let mut v_a_115_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_116_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        crate::leanh::lean_dec(v_h__2_112_);
        v_a_115_ = crate::leanh::lean_ctor_get(v_x_110_, 0);
        crate::leanh::lean_inc(v_a_115_);
        crate::leanh::lean_dec_ref_known(v_x_110_, 1);
        v___x_116_ = crate::leanh::lean_apply_1(v_h__1_111_, v_a_115_);
        return v___x_116_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_MonadAttach_Instances_0__instLawfulMonadAttachExceptTOfLawfulMonad_match__2_splitter___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_a_117_) == 0 {
        let mut v_a_120_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_121_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        crate::leanh::lean_dec(v_h__1_118_);
        v_a_120_ = crate::leanh::lean_ctor_get(v_a_117_, 0);
        crate::leanh::lean_inc(v_a_120_);
        crate::leanh::lean_dec_ref_known(v_a_117_, 1);
        v___x_121_ = crate::leanh::lean_apply_1(v_h__2_119_, v_a_120_);
        return v___x_121_;
    } else {
        ...
        v_a_122_ = crate::leanh::lean_ctor_get(v_a_117_, 0);
        crate::leanh::lean_inc(v_a_122_);
        crate::leanh::lean_dec_ref_known(v_a_117_, 1);
        v___x_123_ = crate::leanh::lean_apply_1(v_h__1_118_, v_a_122_);
        return v___x_123_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_MonadAttach_Instances_0__instLawfulMonadAttachExceptTOfLawfulMonad_match__2_splitter(
    mut v_00_u03b5_124_: *mut crate::leanh::LeanObject,
    mut v_00_u03b1_125_: *mut crate::leanh::LeanObject,
    mut v_P_126_: *mut crate::leanh::LeanObject,
    ...
    if crate::leanh::lean_obj_tag(v_a_128_) == 0 {
        ...
        v_a_131_ = crate::leanh::lean_ctor_get(v_a_128_, 0);
        crate::leanh::lean_inc(v_a_131_);
        crate::leanh::lean_dec_ref_known(v_a_128_, 1);
        ...
        v_a_133_ = crate::leanh::lean_ctor_get(v_a_128_, 0);
