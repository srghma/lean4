...
// Module: Init.Data.String.Lemmas.Pattern.Memcmp
// Imports: Init.Data.String.Pattern.Basic Init.Data.String.Pattern.Basic Init.Data.ByteArray.Lemmas Init.ByCases Init.Data.Nat.MinMax
...
pub unsafe fn runtime_initialize_Init_Data_String_Lemmas_Pattern_Memcmp(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_String_Lemmas_Pattern_Memcmp(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String_Lemmas_Pattern_Memcmp(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
    ...
    crate::leanh::lean_dec_ref(res);
    res = meta_initialize_Init_Data_String_Lemmas_Pattern_Memcmp(builtin);
    if crate::leanh::lean_io_result_is_error(res) {
        return res;
    }
    crate::leanh::lean_dec_ref(res);
    return initialize_Init_Data_String_Lemmas_Pattern_Memcmp(builtin);
}
