...
// Imports: Init.Data.Order.Ord Init.Data.Order.Classes Init.Data.Order.ClassesExtra Init.Data.Order.Lemmas Init.Data.Order.LemmasExtra Init.Data.Order.Factories Init.Data.Order.FactoriesExtra Init.Data.Order.MinMaxOn Init.Data.Order.Opposite Init.Data.Order.PackageFactories
...
use crate::r#gen::Init::Data::Order::MinMaxOn::{
    initialize_Init_Data_Order_MinMaxOn, runtime_initialize_Init_Data_Order_MinMaxOn,
};
...
pub unsafe fn runtime_initialize_Init_Data_Order(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Order(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Order(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
