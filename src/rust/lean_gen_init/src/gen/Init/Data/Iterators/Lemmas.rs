...
// Imports: Init.Data.Iterators.Lemmas.Consumers Init.Data.Iterators.Lemmas.Combinators Init.Data.Iterators.Lemmas.Producers
...
use crate::r#gen::Init::Data::Iterators::Lemmas::Producers::{
    initialize_Init_Data_Iterators_Lemmas_Producers,
    runtime_initialize_Init_Data_Iterators_Lemmas_Producers,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Iterators_Lemmas(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_Iterators_Lemmas(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Iterators_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
    ...
    crate::leanh::lean_dec_ref(res);
    res = meta_initialize_Init_Data_Iterators_Lemmas(builtin);
    if crate::leanh::lean_io_result_is_error(res) {
        return res;
    }
    crate::leanh::lean_dec_ref(res);
    return initialize_Init_Data_Iterators_Lemmas(builtin);
}
