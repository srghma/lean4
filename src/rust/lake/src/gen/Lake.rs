...
use crate::r#gen::Lake::Build::{initialize_Lake_Build, runtime_initialize_Lake_Build};
use crate::r#gen::Lake::CLI::Actions::{
    initialize_Lake_CLI_Actions, runtime_initialize_Lake_CLI_Actions,
};
use crate::r#gen::Lake::Config::{initialize_Lake_Config, runtime_initialize_Lake_Config};
use crate::r#gen::Lake::DSL::{initialize_Lake_DSL, runtime_initialize_Lake_DSL};
use crate::r#gen::Lake::Toml::{initialize_Lake_Toml, runtime_initialize_Lake_Toml};
use crate::r#gen::Lake::Util::{initialize_Lake_Util, runtime_initialize_Lake_Util};
use crate::r#gen::Lake::Version::{initialize_Lake_Version, runtime_initialize_Lake_Version};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lake(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lake(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
