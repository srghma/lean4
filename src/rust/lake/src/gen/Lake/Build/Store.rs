...
pub static mut l_Lake_BuildStore_empty: *mut leanh::LeanObject = core::ptr::null_mut();
...
static l_Lake_BuildStore_collectSharedExternLibs___redArg___closed__2_value_aux_0:
    ...
    m_objs: [
        ...
        core::ptr::addr_of!(l_Lake_BuildStore_collectSharedExternLibs___redArg___closed__0_value)
            as *mut leanh::LeanObject,
        3925673521345038251 as *mut leanh::LeanObject,
    ],
};
pub static l_Lake_BuildStore_collectSharedExternLibs___redArg___closed__2_value:
    ...
    m_objs: [
        ...
        core::ptr::addr_of!(l_Lake_BuildStore_collectSharedExternLibs___redArg___closed__1_value)
            as *mut leanh::LeanObject,
        13440204898709017026 as *mut leanh::LeanObject,
    ],
};
static mut l_Lake_BuildStore_collectSharedExternLibs___redArg___closed__2:
    *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_BuildStore_collectSharedExternLibs___redArg___closed__2_value)
        as *mut leanh::LeanObject;
pub unsafe fn _init_l_Lake_BuildStore_empty() -> *mut leanh::LeanObject {
    let mut v___x_279_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_279_ = leanh::lean_box(1);
    return v___x_279_;
}
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getModuleFacetJob_x3f___redArg(
    mut v_facet_280_: *mut leanh::LeanObject,
    mut v_k_281_: *mut leanh::LeanObject,
    mut v_v_282_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_target_283_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_facet_284_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_286_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_287_: u8 = 0;
    let mut v_module_288_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_302_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_facet_303_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_module_304_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_315_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_k_281_) == 4 {
                    v_target_283_ = leanh::lean_ctor_get(v_k_281_, 0);
                    leanh::lean_inc_ref(v_target_283_);
                    match leanh::lean_obj_tag(v_target_283_) {
                        0 => {
                            v_facet_284_ = leanh::lean_ctor_get(v_k_281_, 1);
                            v_isSharedCheck_301_ =
                                (!leanh::lean_is_exclusive(v_k_281_)) as u8;
                            if v_isSharedCheck_301_ == 0 {
                                v_unused_302_ = leanh::lean_ctor_get(v_k_281_, 0);
                                leanh::lean_dec(v_unused_302_);
                                v___x_286_ = v_k_281_;
                                v_isShared_287_ = v_isSharedCheck_301_;
                                state = 1;
                                continue;
                            } else {
                                leanh::lean_inc(v_facet_284_);
                                leanh::lean_dec(v_k_281_);
                        ...
                        2 => {
                            v_facet_303_ = leanh::lean_ctor_get(v_k_281_, 1);
                            leanh::lean_inc(v_facet_303_);
                            leanh::lean_dec_ref_known(v_k_281_, 2);
                            v_module_304_ = leanh::lean_ctor_get(v_target_283_, 1);
                            v_isSharedCheck_314_ =
                                (!leanh::lean_is_exclusive(v_target_283_)) as u8;
                            if v_isSharedCheck_314_ == 0 {
                                v_unused_315_ = leanh::lean_ctor_get(v_target_283_, 0);
                                leanh::lean_dec(v_unused_315_);
                                v___x_306_ = v_target_283_;
                                v_isShared_307_ = v_isSharedCheck_314_;
                                state = 5;
                                continue;
                            } else {
                                leanh::lean_inc(v_module_304_);
                                leanh::lean_dec(v_target_283_);
                        ...
                        _ => {
                            leanh::lean_dec_ref_known(v_k_281_, 2);
                            leanh::lean_dec_ref(v_target_283_);
                            leanh::lean_dec_ref(v_v_282_);
                    ...
                    leanh::lean_dec_ref(v_v_282_);
                    leanh::lean_dec_ref(v_k_281_);
                    v___x_317_ = leanh::lean_box(0);
                    return v___x_317_;
                }
            }
            1 => {
                v_module_288_ = leanh::lean_ctor_get(v_target_283_, 0);
                v_isSharedCheck_300_ = (!leanh::lean_is_exclusive(v_target_283_)) as u8;
            ...
            2 => {
                ...
                leanh::lean_dec(v_facet_284_);
                if v___x_292_ == 0 {
                    leanh::lean_del_object(v___x_290_);
                    leanh::lean_dec(v_module_288_);
                    leanh::lean_del_object(v___x_286_);
                    leanh::lean_dec_ref(v_v_282_);
                    v___x_293_ = leanh::lean_box(0);
                    return v___x_293_;
                } else {
                    if v_isShared_287_ == 0 {
                        leanh::lean_ctor_set_tag(v___x_286_, 0);
                        leanh::lean_ctor_set(v___x_286_, 1, v_v_282_);
                        leanh::lean_ctor_set(v___x_286_, 0, v_module_288_);
                        v___x_295_ = v___x_286_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_299_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_299_, 0, v_module_288_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_299_, 1, v_v_282_);
            ...
            3 => {
                if v_isShared_291_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_290_, 1);
                    leanh::lean_ctor_set(v___x_290_, 0, v___x_295_);
                    v___x_297_ = v___x_290_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_298_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_298_, 0, v___x_295_);
            ...
            5 => {
                ...
                leanh::lean_dec(v_facet_303_);
                if v___x_308_ == 0 {
                    leanh::lean_del_object(v___x_306_);
                    leanh::lean_dec(v_module_304_);
                    leanh::lean_dec_ref(v_v_282_);
                    v___x_309_ = leanh::lean_box(0);
                    return v___x_309_;
                } else {
                    if v_isShared_307_ == 0 {
                        leanh::lean_ctor_set_tag(v___x_306_, 0);
                        leanh::lean_ctor_set(v___x_306_, 1, v_v_282_);
                        leanh::lean_ctor_set(v___x_306_, 0, v_module_304_);
                        v___x_311_ = v___x_306_;
                        state = 6;
                        continue;
                    } else {
                        v_reuseFailAlloc_313_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_313_, 0, v_module_304_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_313_, 1, v_v_282_);
            ...
            6 => {
                v___x_312_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getModuleFacetJob_x3f___redArg___boxed(
    mut v_facet_318_: *mut leanh::LeanObject,
    mut v_k_319_: *mut leanh::LeanObject,
    mut v_v_320_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getModuleFacetJob_x3f(
    ...
    mut v_facet_323_: *mut leanh::LeanObject,
    mut v_inst_324_: *mut leanh::LeanObject,
    mut v_k_325_: *mut leanh::LeanObject,
    mut v_v_326_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getModuleFacetJob_x3f___boxed(
    ...
    mut v_facet_329_: *mut leanh::LeanObject,
    mut v_inst_330_: *mut leanh::LeanObject,
    mut v_k_331_: *mut leanh::LeanObject,
    mut v_v_332_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_facet_329_);
    return v_res_333_;
}
pub unsafe fn l_Lake_BuildStore_collectModuleFacetArray___redArg___lam__0(
    mut v_facet_334_: *mut leanh::LeanObject,
    mut v_a_335_: *mut leanh::LeanObject,
    mut v_b_336_: *mut leanh::LeanObject,
    mut v_acc_337_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_338_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_val_339_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_338_) == 1 {
                    v_val_339_ = leanh::lean_ctor_get(v___x_338_, 0);
                    v_isSharedCheck_348_ = (!leanh::lean_is_exclusive(v___x_338_)) as u8;
                    ...
                    leanh::lean_dec(v___x_338_);
                    v___x_349_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_349_, 0, v_acc_337_);
                    return v___x_349_;
                }
            }
            1 => {
                v_snd_343_ = leanh::lean_ctor_get(v_val_339_, 1);
                leanh::lean_inc(v_snd_343_);
                leanh::lean_dec(v_val_339_);
                v___x_344_ = lean_array_push(v_acc_337_, v_snd_343_);
                if v_isShared_342_ == 0 {
                    leanh::lean_ctor_set(v___x_341_, 0, v___x_344_);
                    v___x_346_ = v___x_341_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_347_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_347_, 0, v___x_344_);
...
pub unsafe fn l_Lake_BuildStore_collectModuleFacetArray___redArg___lam__0___boxed(
    mut v_facet_350_: *mut leanh::LeanObject,
    mut v_a_351_: *mut leanh::LeanObject,
    mut v_b_352_: *mut leanh::LeanObject,
    mut v_acc_353_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_facet_350_);
    return v_res_354_;
}
pub unsafe fn l_Lake_BuildStore_collectModuleFacetArray___redArg(
    mut v_self_376_: *mut leanh::LeanObject,
    mut v_facet_377_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_closure_set(v___f_378_, 0, v_facet_377_);
...
pub unsafe fn l_Lake_BuildStore_collectModuleFacetArray(
    ...
    mut v_self_384_: *mut leanh::LeanObject,
    mut v_facet_385_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lake_BuildStore_collectModuleFacetMap___redArg___lam__0(
    mut v_facet_388_: *mut leanh::LeanObject,
    mut v_a_389_: *mut leanh::LeanObject,
    mut v_b_390_: *mut leanh::LeanObject,
    mut v_acc_391_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_392_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_val_393_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_392_) == 1 {
                    v_val_393_ = leanh::lean_ctor_get(v___x_392_, 0);
                    v_isSharedCheck_403_ = (!leanh::lean_is_exclusive(v___x_392_)) as u8;
                    ...
                    leanh::lean_dec(v___x_392_);
                    v___x_404_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_404_, 0, v_acc_391_);
                    return v___x_404_;
                }
            }
            1 => {
                v_fst_397_ = leanh::lean_ctor_get(v_val_393_, 0);
                leanh::lean_inc(v_fst_397_);
                v_snd_398_ = leanh::lean_ctor_get(v_val_393_, 1);
                leanh::lean_inc(v_snd_398_);
                leanh::lean_dec(v_val_393_);
                ...
                if v_isShared_396_ == 0 {
                    leanh::lean_ctor_set(v___x_395_, 0, v___x_399_);
                    v___x_401_ = v___x_395_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_402_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_402_, 0, v___x_399_);
...
pub unsafe fn l_Lake_BuildStore_collectModuleFacetMap___redArg___lam__0___boxed(
    ...
    mut v_b_407_: *mut leanh::LeanObject,
    mut v_acc_408_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_facet_405_);
    return v_res_409_;
}
pub unsafe fn l_Lake_BuildStore_collectModuleFacetMap___redArg(
    mut v_self_410_: *mut leanh::LeanObject,
    mut v_facet_411_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_closure_set(v___f_412_, 0, v_facet_411_);
    v___x_413_ = l_Lake_BuildStore_collectModuleFacetArray___redArg___closed__9;
    v_res_414_ = leanh::lean_box(1);
...
pub unsafe fn l_Lake_BuildStore_collectModuleFacetMap(
    ...
    mut v_self_418_: *mut leanh::LeanObject,
    mut v_facet_419_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getPackageFacetJob_x3f___redArg(
    mut v_facet_422_: *mut leanh::LeanObject,
    mut v_k_423_: *mut leanh::LeanObject,
    mut v_v_424_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_target_425_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_facet_426_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_k_423_) == 4 {
                    v_target_425_ = leanh::lean_ctor_get(v_k_423_, 0);
                    leanh::lean_inc_ref(v_target_425_);
                    if leanh::lean_obj_tag(v_target_425_) == 1 {
                        v_facet_426_ = leanh::lean_ctor_get(v_k_423_, 1);
                        leanh::lean_inc(v_facet_426_);
                        leanh::lean_dec_ref_known(v_k_423_, 2);
                        v_isSharedCheck_435_ =
                            (!leanh::lean_is_exclusive(v_target_425_)) as u8;
                        if v_isSharedCheck_435_ == 0 {
                            v_unused_436_ = leanh::lean_ctor_get(v_target_425_, 0);
                        ...
                        leanh::lean_dec_ref(v_target_425_);
                        leanh::lean_dec_ref_known(v_k_423_, 2);
                        leanh::lean_dec_ref(v_v_424_);
                        v___x_437_ = leanh::lean_box(0);
                        return v___x_437_;
                    }
                } else {
                    leanh::lean_dec_ref(v_v_424_);
                    leanh::lean_dec_ref(v_k_423_);
            ...
            1 => {
                ...
                leanh::lean_dec(v_facet_426_);
                if v___x_430_ == 0 {
                    leanh::lean_del_object(v___x_428_);
                    leanh::lean_dec_ref(v_v_424_);
                    v___x_431_ = leanh::lean_box(0);
                    return v___x_431_;
                } else {
                    if v_isShared_429_ == 0 {
                        leanh::lean_ctor_set(v___x_428_, 0, v_v_424_);
                        v___x_433_ = v___x_428_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_434_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_434_, 0, v_v_424_);
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getPackageFacetJob_x3f___redArg___boxed(
    mut v_facet_439_: *mut leanh::LeanObject,
    mut v_k_440_: *mut leanh::LeanObject,
    mut v_v_441_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getPackageFacetJob_x3f(
    ...
    mut v_facet_444_: *mut leanh::LeanObject,
    mut v_inst_445_: *mut leanh::LeanObject,
    mut v_k_446_: *mut leanh::LeanObject,
    mut v_v_447_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getPackageFacetJob_x3f___boxed(
    ...
    mut v_facet_450_: *mut leanh::LeanObject,
    mut v_inst_451_: *mut leanh::LeanObject,
    mut v_k_452_: *mut leanh::LeanObject,
    mut v_v_453_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_459_) == 1 {
                    v_val_460_ = leanh::lean_ctor_get(v___x_459_, 0);
                    v_isSharedCheck_468_ = (!leanh::lean_is_exclusive(v___x_459_)) as u8;
                    ...
                    leanh::lean_dec(v___x_459_);
                    v___x_469_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_469_, 0, v_acc_458_);
                    return v___x_469_;
                }
            }
            1 => {
...
pub unsafe fn l_Lake_BuildStore_collectPackageFacetArray___redArg___lam__0___boxed(
    mut v_facet_470_: *mut leanh::LeanObject,
    mut v_a_471_: *mut leanh::LeanObject,
    mut v_b_472_: *mut leanh::LeanObject,
    mut v_acc_473_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_facet_470_);
    return v_res_474_;
}
pub unsafe fn l_Lake_BuildStore_collectPackageFacetArray___redArg(
    mut v_self_475_: *mut leanh::LeanObject,
    mut v_facet_476_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_closure_set(v___f_477_, 0, v_facet_476_);
    ...
    v_a_481_ = leanh::lean_ctor_get(v___x_480_, 0);
...
pub unsafe fn l_Lake_BuildStore_collectPackageFacetArray(
    ...
    mut v_self_483_: *mut leanh::LeanObject,
    mut v_facet_484_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getTargetFacetJob_x3f___redArg(
    mut v_facet_487_: *mut leanh::LeanObject,
    mut v_k_488_: *mut leanh::LeanObject,
    mut v_v_489_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_k_488_) == 4 {
        let mut v_target_490_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_target_490_ = leanh::lean_ctor_get(v_k_488_, 0);
        if leanh::lean_obj_tag(v_target_490_) == 3 {
            let mut v_facet_491_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_492_: u8 = 0;
            v_facet_491_ = leanh::lean_ctor_get(v_k_488_, 1);
            v___x_492_ = lean_name_eq(v_facet_491_, v_facet_487_);
            if v___x_492_ == 0 {
                let mut v___x_493_: *mut leanh::LeanObject = core::ptr::null_mut();
                leanh::lean_dec_ref(v_v_489_);
                ...
                leanh::lean_ctor_set(v___x_494_, 0, v_v_489_);
                return v___x_494_;
            }
        } else {
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getTargetFacetJob_x3f___redArg___boxed(
    mut v_facet_497_: *mut leanh::LeanObject,
    mut v_k_498_: *mut leanh::LeanObject,
    mut v_v_499_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_k_498_);
    leanh::lean_dec(v_facet_497_);
    return v_res_500_;
}
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getTargetFacetJob_x3f(
    ...
    mut v_facet_502_: *mut leanh::LeanObject,
    mut v_inst_503_: *mut leanh::LeanObject,
    mut v_k_504_: *mut leanh::LeanObject,
    mut v_v_505_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lake_Build_Store_0__Lake_BuildStore_getTargetFacetJob_x3f___boxed(
    ...
    mut v_facet_508_: *mut leanh::LeanObject,
    mut v_inst_509_: *mut leanh::LeanObject,
    mut v_k_510_: *mut leanh::LeanObject,
    mut v_v_511_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_517_) == 1 {
                    ...
                    leanh::lean_dec(v___x_517_);
                    v___x_527_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_527_, 0, v_acc_516_);
                    return v___x_527_;
                }
            }
            1 => {
...
pub unsafe fn l_Lake_BuildStore_collectTargetFacetArray___redArg___lam__0___boxed(
    mut v_facet_528_: *mut leanh::LeanObject,
    mut v_a_529_: *mut leanh::LeanObject,
    mut v_b_530_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lake_BuildStore_collectTargetFacetArray___redArg(
    ...
    leanh::lean_closure_set(v___f_535_, 0, v_facet_534_);
    ...
    v_a_539_ = leanh::lean_ctor_get(v___x_538_, 0);
    leanh::lean_inc(v_a_539_);
    leanh::lean_dec(v___x_538_);
    return v_a_539_;
}
pub unsafe fn l_Lake_BuildStore_collectTargetFacetArray(
    ...
    mut v_facet_542_: *mut leanh::LeanObject,
...
pub unsafe fn runtime_initialize_Lake_Build_Store(builtin: u8) -> *mut leanh::LeanObject {
    ...
    leanh::lean_mark_persistent(l_Lake_BuildStore_empty);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
static mut _G_meta_initialized: bool = false;
pub unsafe fn meta_initialize_Lake_Build_Store(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Build_Store(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
