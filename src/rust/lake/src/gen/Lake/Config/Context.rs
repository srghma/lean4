...
pub unsafe fn l_Lake_LakeT_run___redArg(
    mut v_ctx_16_: *mut leanh::LeanObject,
    mut v_self_17_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_18_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_18_ = leanh::lean_apply_1(v_self_17_, v_ctx_16_);
    return v___x_18_;
}
pub unsafe fn l_Lake_LakeT_run(
    mut v_m_19_: *mut leanh::LeanObject,
    mut v_00_u03b1_20_: *mut leanh::LeanObject,
    mut v_ctx_21_: *mut leanh::LeanObject,
    mut v_self_22_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_23_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_23_ = leanh::lean_apply_1(v_self_22_, v_ctx_21_);
    return v___x_23_;
}
pub unsafe fn l_Lake_LakeM_run___redArg(
    mut v_ctx_24_: *mut leanh::LeanObject,
    mut v_self_25_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_26_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_26_ = leanh::lean_apply_1(v_self_25_, v_ctx_24_);
    return v___x_26_;
}
pub unsafe fn l_Lake_LakeM_run(
    mut v_00_u03b1_27_: *mut leanh::LeanObject,
    mut v_ctx_28_: *mut leanh::LeanObject,
    mut v_self_29_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_30_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_30_ = leanh::lean_apply_1(v_self_29_, v_ctx_28_);
    return v___x_30_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lake_Config_Context(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lake_Config_Context(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Config_Context(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
