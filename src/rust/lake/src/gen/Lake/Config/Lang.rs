...
pub static l_Lake_instReprConfigLang_repr___closed__0_value: leanh::LeanStringObject<21> =
...
static mut l_Lake_instReprConfigLang_repr___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__0_value)
        as *mut leanh::LeanObject;
pub static l_Lake_instReprConfigLang_repr___closed__1_value: leanh::LeanCtorObject<1> =
...
static mut l_Lake_instReprConfigLang_repr___closed__1: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__1_value)
        as *mut leanh::LeanObject;
pub static l_Lake_instReprConfigLang_repr___closed__2_value: leanh::LeanStringObject<21> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lake_instReprConfigLang_repr___closed__2: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__2_value)
        as *mut leanh::LeanObject;
pub static l_Lake_instReprConfigLang_repr___closed__3_value: leanh::LeanCtorObject<1> =
    leanh::LeanCtorObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Lake_instReprConfigLang_repr___closed__3: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__3_value)
        as *mut leanh::LeanObject;
static mut l_Lake_instReprConfigLang_repr___closed__4_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Lake_instReprConfigLang_repr___closed__4: *mut leanh::LeanObject =
    core::ptr::null_mut();
static mut l_Lake_instReprConfigLang_repr___closed__5_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Lake_instReprConfigLang_repr___closed__5: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static l_Lake_instReprConfigLang___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_Lake_instReprConfigLang___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang___closed__0_value)
        as *mut leanh::LeanObject;
pub static mut l_Lake_instReprConfigLang: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang___closed__0_value)
        as *mut leanh::LeanObject;
pub static mut l_Lake_ConfigLang_default: u8 = 0;
pub static mut l_Lake_instInhabitedConfigLang: u8 = 0;
pub static l_Lake_ConfigLang_ofString_x3f___closed__0_value: leanh::LeanStringObject<5> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__0_value)
        as *mut leanh::LeanObject;
pub static l_Lake_ConfigLang_ofString_x3f___closed__1_value: leanh::LeanStringObject<5> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__1: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__1_value)
        as *mut leanh::LeanObject;
pub static l_Lake_ConfigLang_ofString_x3f___closed__2_value: leanh::LeanCtorObject<1> =
    leanh::LeanCtorObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__2: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__2_value)
        as *mut leanh::LeanObject;
pub static l_Lake_ConfigLang_ofString_x3f___closed__3_value: leanh::LeanCtorObject<1> =
    leanh::LeanCtorObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__3: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__3_value)
        as *mut leanh::LeanObject;
pub static l_Lake_instToStringConfigLang___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Lake_instToStringConfigLang___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instToStringConfigLang___closed__0_value)
        as *mut leanh::LeanObject;
pub static mut l_Lake_instToStringConfigLang: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_instToStringConfigLang___closed__0_value)
        as *mut leanh::LeanObject;
pub unsafe fn l_Lake_ConfigLang_ctorIdx(mut v_x_140_: u8) -> *mut leanh::LeanObject {
    if v_x_140_ == 0 {
...
pub unsafe fn l_Lake_ConfigLang_ctorIdx___boxed(
    ...
    v_x_boxed_144_ = (leanh::lean_unbox(v_x_143_) as u8);
    v_res_145_ = l_Lake_ConfigLang_ctorIdx(v_x_boxed_144_);
    return v_res_145_;
}
pub unsafe fn l_Lake_ConfigLang_toCtorIdx(mut v_x_146_: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lake_ConfigLang_toCtorIdx___boxed(
    ...
    v_x_4__boxed_149_ = (leanh::lean_unbox(v_x_148_) as u8);
    v_res_150_ = l_Lake_ConfigLang_toCtorIdx(v_x_4__boxed_149_);
    return v_res_150_;
}
pub unsafe fn l_Lake_ConfigLang_ctorElim___redArg(
    mut v_k_151_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_k_151_);
    return v_k_151_;
}
...
pub unsafe fn l_Lake_ConfigLang_ctorElim(
    ...
    leanh::lean_inc(v_k_158_);
    return v_k_158_;
}
pub unsafe fn l_Lake_ConfigLang_ctorElim___boxed(
    mut v_motive_159_: *mut leanh::LeanObject,
    mut v_ctorIdx_160_: *mut leanh::LeanObject,
    mut v_t_161_: *mut leanh::LeanObject,
    mut v_h_162_: *mut leanh::LeanObject,
    mut v_k_163_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_164_: u8 = 0;
    let mut v_res_165_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_164_ = (leanh::lean_unbox(v_t_161_) as u8);
...
pub unsafe fn l_Lake_instReprConfigLang_repr(
    ...
    let mut v___y_205_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v___y_212_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if v_x_202_ == 0 {
                    v___x_218_ = leanh::lean_unsigned_to_nat(1024);
                    ...
                    v___x_222_ = leanh::lean_unsigned_to_nat(1024);
            ...
            1 => {
                ...
                leanh::lean_inc(v___y_205_);
                v___x_207_ = leanh::lean_alloc_ctor(4, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_207_, 0, v___y_205_);
                leanh::lean_ctor_set(v___x_207_, 1, v___x_206_);
                v___x_208_ = 0;
                v___x_209_ = leanh::lean_alloc_ctor(6, 1, (1) as u32);
                leanh::lean_ctor_set(v___x_209_, 0, v___x_207_);
            ...
            2 => {
                ...
                leanh::lean_inc(v___y_212_);
                v___x_214_ = leanh::lean_alloc_ctor(4, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_214_, 0, v___y_212_);
                leanh::lean_ctor_set(v___x_214_, 1, v___x_213_);
                v___x_215_ = 0;
                v___x_216_ = leanh::lean_alloc_ctor(6, 1, (1) as u32);
                leanh::lean_ctor_set(v___x_216_, 0, v___x_214_);
                leanh::lean_ctor_set_uint8(
                    v___x_216_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                    v___x_215_,
...
pub unsafe fn l_Lake_instReprConfigLang_repr___boxed(
    ...
    mut v_prec_227_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_x_121__boxed_228_: u8 = 0;
    let mut v_res_229_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_121__boxed_228_ = (leanh::lean_unbox(v_x_226_) as u8);
    v_res_229_ = l_Lake_instReprConfigLang_repr(v_x_121__boxed_228_, v_prec_227_);
    leanh::lean_dec(v_prec_227_);
    return v_res_229_;
}
pub unsafe fn l_Lake_ConfigLang_ofNat(mut v_n_232_: *mut leanh::LeanObject) -> u8 {
...
pub unsafe fn l_Lake_instDecidableEqConfigLang___boxed(
    ...
    mut v_y_246_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_x_13__boxed_247_ = (leanh::lean_unbox(v_x_245_) as u8);
    v_y_14__boxed_248_ = (leanh::lean_unbox(v_y_246_) as u8);
    v_res_249_ = l_Lake_instDecidableEqConfigLang(v_x_13__boxed_247_, v_y_14__boxed_248_);
    v_r_250_ = leanh::lean_box((v_res_249_) as usize);
    return v_r_250_;
}
...
pub unsafe fn l_Lake_ConfigLang_ofString_x3f___boxed(
    ...
    leanh::lean_dec_ref(v_x_269_);
    return v_res_270_;
}
pub unsafe fn l_Lake_ConfigLang_fileExtension(mut v_x_271_: u8) -> *mut leanh::LeanObject {
    if v_x_271_ == 0 {
...
pub unsafe fn l_Lake_ConfigLang_fileExtension___boxed(
    ...
    v_x_20__boxed_275_ = (leanh::lean_unbox(v_x_274_) as u8);
    v_res_276_ = l_Lake_ConfigLang_fileExtension(v_x_20__boxed_275_);
    return v_res_276_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lake_Config_Lang(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lake_Config_Lang(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Config_Lang(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
