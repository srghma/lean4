...
use crate::r#gen::Lake::DSL::Config::{
    initialize_Lake_DSL_Config, runtime_initialize_Lake_DSL_Config,
};
use crate::r#gen::Lake::DSL::DeclUtil::{
    initialize_Lake_DSL_DeclUtil, runtime_initialize_Lake_DSL_DeclUtil,
};
use crate::r#gen::Lake::DSL::Extensions::{
    initialize_Lake_DSL_Extensions, runtime_initialize_Lake_DSL_Extensions,
};
use crate::r#gen::Lake::DSL::Key::{initialize_Lake_DSL_Key, runtime_initialize_Lake_DSL_Key};
use crate::r#gen::Lake::DSL::Meta::{initialize_Lake_DSL_Meta, runtime_initialize_Lake_DSL_Meta};
use crate::r#gen::Lake::DSL::Package::{
    initialize_Lake_DSL_Package, runtime_initialize_Lake_DSL_Package,
};
use crate::r#gen::Lake::DSL::Require::{
    initialize_Lake_DSL_Require, runtime_initialize_Lake_DSL_Require,
};
use crate::r#gen::Lake::DSL::Script::{
    initialize_Lake_DSL_Script, runtime_initialize_Lake_DSL_Script,
};
use crate::r#gen::Lake::DSL::Targets::{
    initialize_Lake_DSL_Targets, runtime_initialize_Lake_DSL_Targets,
};
use crate::r#gen::Lake::DSL::VerLit::{
    initialize_Lake_DSL_VerLit, runtime_initialize_Lake_DSL_VerLit,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lake_DSL(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lake_DSL(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_DSL(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
    ...
    leanh::lean_dec_ref(res);
    res = meta_initialize_Lake_DSL(builtin);
    if leanh::lean_io_result_is_error(res) {
        return res;
    }
    leanh::lean_dec_ref(res);
    return initialize_Lake_DSL(builtin);
}