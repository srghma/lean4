...
pub static l_Lake_LoadConfig_configDir___closed__0_value: leanh::LeanStringObject<7> =
...
static mut l_Lake_LoadConfig_configDir___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lake_LoadConfig_configDir___closed__0_value)
        as *mut leanh::LeanObject;
pub unsafe fn l_Lake_LoadConfig_lakeDir(
    mut v_cfg_15_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_pkgDir_16_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_17_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_18_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_pkgDir_16_ = leanh::lean_ctor_get(v_cfg_15_, 6);
    leanh::lean_inc_ref(v_pkgDir_16_);
    leanh::lean_dec_ref(v_cfg_15_);
...
pub unsafe fn l_Lake_LoadConfig_configDir(
    mut v_cfg_20_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_wsDir_21_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_pkgIdx_22_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_wsDir_21_ = leanh::lean_ctor_get(v_cfg_20_, 2);
    leanh::lean_inc_ref(v_wsDir_21_);
    v_pkgIdx_22_ = leanh::lean_ctor_get(v_cfg_20_, 3);
    leanh::lean_inc(v_pkgIdx_22_);
    leanh::lean_dec_ref(v_cfg_20_);
...
pub unsafe fn runtime_initialize_Lake_Load_Config(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lake_Load_Config(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Load_Config(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
