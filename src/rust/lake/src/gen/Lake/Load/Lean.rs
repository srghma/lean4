...
pub unsafe fn l_Lake_loadLeanConfig(
    mut v_cfg_22_: *mut leanh::LeanObject,
    mut v_a_23_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_25_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_a_26_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_a_27_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_leanOpts_28_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_29_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_a_30_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                leanh::lean_inc_ref(v_cfg_22_);
                v___x_25_ = l_Lake_importConfigFile(v_cfg_22_, v_a_23_);
                if leanh::lean_obj_tag(v___x_25_) == 0 {
                    v_a_26_ = leanh::lean_ctor_get(v___x_25_, 0);
                    leanh::lean_inc(v_a_26_);
                    v_a_27_ = leanh::lean_ctor_get(v___x_25_, 1);
                    leanh::lean_inc(v_a_27_);
                    leanh::lean_dec_ref_known(v___x_25_, 2);
                    v_leanOpts_28_ = leanh::lean_ctor_get(v_cfg_22_, 13);
                    leanh::lean_inc_ref(v_leanOpts_28_);
                    leanh::lean_dec_ref(v_cfg_22_);
                    v___x_29_ = l_Lake_LakefileConfig_loadFromEnv(v_a_26_, v_leanOpts_28_, v_a_27_);
                    return v___x_29_;
                } else {
                    leanh::lean_dec_ref(v_cfg_22_);
                    v_a_30_ = leanh::lean_ctor_get(v___x_25_, 0);
                    v_a_31_ = leanh::lean_ctor_get(v___x_25_, 1);
                    v_isSharedCheck_38_ = (!leanh::lean_is_exclusive(v___x_25_)) as u8;
                    if v_isSharedCheck_38_ == 0 {
                        ...
                        leanh::lean_inc(v_a_30_);
                        leanh::lean_dec(v___x_25_);
            ...
            1 => {
                if v_isShared_34_ == 0 {
                    ...
                    v_reuseFailAlloc_37_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_37_, 0, v_a_30_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_37_, 1, v_a_31_);
...
pub unsafe fn l_Lake_loadLeanConfig___boxed(
    mut v_cfg_39_: *mut leanh::LeanObject,
...
pub unsafe fn runtime_initialize_Lake_Load_Lean(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lake_Load_Lean(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Load_Lean(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
