...
pub unsafe fn l_Std_Internal_UV_DNS_getAddrInfo___boxed(
    mut v_host_20_: *mut leanh::LeanObject,
    mut v_service_21_: *mut leanh::LeanObject,
    mut v_family_22_: *mut leanh::LeanObject,
    ...
    v_family_boxed_24_ = (leanh::lean_unbox(v_family_22_) as u8);
    v_res_25_ = lean_uv_dns_get_info(v_host_20_, v_service_21_, v_family_boxed_24_);
    leanh::lean_dec_ref(v_service_21_);
    leanh::lean_dec_ref(v_host_20_);
    return v_res_25_;
}
pub unsafe fn l_Std_Internal_UV_DNS_getNameInfo___boxed(
    mut v_host_28_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_host_28_);
    return v_res_30_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Internal_UV_DNS(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Internal_UV_DNS(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Internal_UV_DNS(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
