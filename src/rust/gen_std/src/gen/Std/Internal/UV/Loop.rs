...
pub unsafe fn l_Std_Internal_UV_Loop_configure___boxed(
    ...
    mut v_a_00___x40___internal___hyg_13_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_Internal_UV_Loop_alive___boxed(
    mut v_a_00___x40___internal___hyg_16_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Internal_UV_Loop(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Internal_UV_Loop(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
