...
pub unsafe fn l_Std_Internal_UV_UDP_Socket_new___boxed(
    mut v_a_00___x40___internal___hyg_109_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Internal_UV_UDP_Socket_bind___boxed(
    mut v_socket_114_: *mut leanh::LeanObject,
    mut v_addr_115_: *mut leanh::LeanObject,
    mut v_a_00___x40___internal___hyg_116_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_117_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_117_ = lean_uv_udp_bind(v_socket_114_, v_addr_115_);
    leanh::lean_dec_ref(v_addr_115_);
    leanh::lean_dec(v_socket_114_);
    return v_res_117_;
}
pub unsafe fn l_Std_Internal_UV_UDP_Socket_connect___boxed(
    mut v_socket_121_: *mut leanh::LeanObject,
    mut v_addr_122_: *mut leanh::LeanObject,
    mut v_a_00___x40___internal___hyg_123_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_124_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_124_ = lean_uv_udp_connect(v_socket_121_, v_addr_122_);
    leanh::lean_dec_ref(v_addr_122_);
    leanh::lean_dec(v_socket_121_);
    return v_res_124_;
}
pub unsafe fn l_Std_Internal_UV_UDP_Socket_send___boxed(
    mut v_socket_129_: *mut leanh::LeanObject,
    mut v_data_130_: *mut leanh::LeanObject,
    mut v_addr_131_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Internal_UV_UDP_Socket_recv___boxed(
    ...
    v_size_boxed_140_ = leanh::lean_unbox_uint64(v_size_138_);
    leanh::lean_dec_ref(v_size_138_);
...
pub unsafe fn l_Std_Internal_UV_UDP_Socket_waitReadable___boxed(
    ...
    mut v_a_00___x40___internal___hyg_145_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Internal_UV_UDP_Socket_setBroadcast___boxed(
    ...
    v_on_boxed_168_ = (leanh::lean_unbox(v_on_166_) as u8);
    v_res_169_ = lean_uv_udp_set_broadcast(v_socket_165_, v_on_boxed_168_);
    leanh::lean_dec(v_socket_165_);
    return v_res_169_;
}
pub unsafe fn l_Std_Internal_UV_UDP_Socket_setMulticastLoop___boxed(
    mut v_socket_173_: *mut leanh::LeanObject,
    mut v_on_174_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Internal_UV_UDP_Socket_setMembership___boxed(
    mut v_socket_191_: *mut leanh::LeanObject,
    mut v_multicastAddr_192_: *mut leanh::LeanObject,
    mut v_interfaceAddr_193_: *mut leanh::LeanObject,
    mut v_membership_194_: *mut leanh::LeanObject,
    mut v_a_00___x40___internal___hyg_195_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_membership_boxed_196_: u8 = 0;
    let mut v_res_197_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_membership_boxed_196_ = (leanh::lean_unbox(v_membership_194_) as u8);
    ...
    leanh::lean_dec(v_interfaceAddr_193_);
    leanh::lean_dec_ref(v_multicastAddr_192_);
    leanh::lean_dec(v_socket_191_);
    return v_res_197_;
}
pub unsafe fn l_Std_Internal_UV_UDP_Socket_setMulticastInterface___boxed(
    mut v_socket_201_: *mut leanh::LeanObject,
    mut v_interfaceAddr_202_: *mut leanh::LeanObject,
    mut v_a_00___x40___internal___hyg_203_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_interfaceAddr_202_);
    leanh::lean_dec(v_socket_201_);
    return v_res_204_;
}
pub unsafe fn l_Std_Internal_UV_UDP_Socket_setTTL___boxed(
    mut v_socket_208_: *mut leanh::LeanObject,
    mut v_ttl_209_: *mut leanh::LeanObject,
    mut v_a_00___x40___internal___hyg_210_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_ttl_boxed_211_: u32 = 0;
    let mut v_res_212_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_ttl_boxed_211_ = leanh::lean_unbox_uint32(v_ttl_209_);
    leanh::lean_dec(v_ttl_209_);
    v_res_212_ = lean_uv_udp_set_ttl(v_socket_208_, v_ttl_boxed_211_);
    leanh::lean_dec(v_socket_208_);
    return v_res_212_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Internal_UV_UDP(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Internal_UV_UDP(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Internal_UV_UDP(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
