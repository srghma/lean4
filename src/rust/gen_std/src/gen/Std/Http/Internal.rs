...
// Imports: Std.Http.Internal.Char Std.Http.Internal.ChunkedBuffer Std.Http.Internal.LowerCase Std.Http.Internal.IndexMultiMap Std.Http.Internal.Encode Std.Http.Internal.String Std.Http.Internal.Char
...
use crate::r#gen::Std::Http::Internal::Encode::{
    initialize_Std_Http_Internal_Encode, runtime_initialize_Std_Http_Internal_Encode,
};
use crate::r#gen::Std::Http::Internal::IndexMultiMap::{
    initialize_Std_Http_Internal_IndexMultiMap, runtime_initialize_Std_Http_Internal_IndexMultiMap,
};
use crate::r#gen::Std::Http::Internal::LowerCase::{
    initialize_Std_Http_Internal_LowerCase, runtime_initialize_Std_Http_Internal_LowerCase,
};
use crate::r#gen::Std::Http::Internal::String::{
    initialize_Std_Http_Internal_String, runtime_initialize_Std_Http_Internal_String,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Http_Internal(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Http_Internal(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Http_Internal(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
