...
pub static mut l_Std_Http_instInhabitedExtensions_default: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static mut l_Std_Http_instInhabitedExtensions: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static mut l_Std_Http_Extensions_empty: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_Std_Http_Extensions_get___redArg___closed__0_value: leanh::LeanClosureObject<
    0,
...
static mut l_Std_Http_Extensions_get___redArg___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l_Std_Http_Extensions_compareName(
    ...
    match leanh::lean_obj_tag(v_x_91_) {
        0 => {
        ...
        1 => match leanh::lean_obj_tag(v_x_92_) {
            0 => {
            ...
            1 => {
                let mut v_pre_96_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v_str_97_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v_pre_98_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v_str_99_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v___x_100_: u8 = 0;
                v_pre_96_ = leanh::lean_ctor_get(v_x_91_, 0);
                v_str_97_ = leanh::lean_ctor_get(v_x_91_, 1);
                v_pre_98_ = leanh::lean_ctor_get(v_x_92_, 0);
                v_str_99_ = leanh::lean_ctor_get(v_x_92_, 1);
        ...
        _ => {
            if leanh::lean_obj_tag(v_x_92_) == 2 {
                let mut v_pre_106_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v_i_107_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v_pre_108_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v_i_109_: *mut leanh::LeanObject = core::ptr::null_mut();
                let mut v___x_110_: u8 = 0;
                v_pre_106_ = leanh::lean_ctor_get(v_x_91_, 0);
                v_i_107_ = leanh::lean_ctor_get(v_x_91_, 1);
                v_pre_108_ = leanh::lean_ctor_get(v_x_92_, 0);
                v_i_109_ = leanh::lean_ctor_get(v_x_92_, 1);
...
pub unsafe fn l_Std_Http_Extensions_compareName___boxed(
    ...
    let mut v_r_119_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_118_ = l_Std_Http_Extensions_compareName(v_x_116_, v_x_117_);
    leanh::lean_dec(v_x_117_);
    leanh::lean_dec(v_x_116_);
    v_r_119_ = leanh::lean_box((v_res_118_) as usize);
    return v_r_119_;
}
pub unsafe fn _init_l_Std_Http_instInhabitedExtensions_default() -> *mut leanh::LeanObject {
    let mut v___x_120_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_120_ = leanh::lean_box(1);
    return v___x_120_;
}
pub unsafe fn _init_l_Std_Http_instInhabitedExtensions() -> *mut leanh::LeanObject {
    let mut v___x_121_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_121_ = leanh::lean_box(1);
    return v___x_121_;
}
pub unsafe fn _init_l_Std_Http_Extensions_empty() -> *mut leanh::LeanObject {
    let mut v___x_122_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_122_ = leanh::lean_box(1);
    return v___x_122_;
}
...
pub unsafe fn l_Std_Http_Extensions_get(
    ...
    if leanh::lean_obj_tag(v___x_135_) == 0 {
        ...
        v_val_137_ = leanh::lean_ctor_get(v___x_135_, 0);
        leanh::lean_inc(v_val_137_);
        leanh::lean_dec_ref_known(v___x_135_, 1);
        v___x_138_ =
            l___private_Init_Dynamic_0__Dynamic_get_x3fImpl___redArg(v_val_137_, v_inst_133_);
        leanh::lean_dec(v_inst_133_);
        leanh::lean_dec(v_val_137_);
        return v___x_138_;
    }
}
pub unsafe fn l_Std_Http_Extensions_insert___redArg(
    ...
    mut v_data_141_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_dyn_142_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_dyn_142_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v_dyn_142_, 0, v_inst_140_);
    leanh::lean_ctor_set(v_dyn_142_, 1, v_data_141_);
...
pub unsafe fn l_Std_Http_Extensions_insert(
    ...
    mut v_data_149_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_dyn_150_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_dyn_150_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v_dyn_150_, 0, v_inst_148_);
    leanh::lean_ctor_set(v_dyn_150_, 1, v_data_149_);
...
pub unsafe fn l_Std_Http_Extensions_contains___redArg___boxed(
    ...
    let mut v_r_170_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_169_ = l_Std_Http_Extensions_contains___redArg(v_x_167_, v_inst_168_);
    v_r_170_ = leanh::lean_box((v_res_169_) as usize);
    return v_r_170_;
}
...
pub unsafe fn l_Std_Http_Extensions_contains___boxed(
    ...
    let mut v_r_180_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_179_ = l_Std_Http_Extensions_contains(v_x_176_, v_00_u03b1_177_, v_inst_178_);
    v_r_180_ = leanh::lean_box((v_res_179_) as usize);
    return v_r_180_;
}
...
pub unsafe fn runtime_initialize_Std_Http_Data_Extensions(
    ...
    leanh::lean_mark_persistent(l_Std_Http_instInhabitedExtensions_default);
    l_Std_Http_instInhabitedExtensions = _init_l_Std_Http_instInhabitedExtensions();
    leanh::lean_mark_persistent(l_Std_Http_instInhabitedExtensions);
    l_Std_Http_Extensions_empty = _init_l_Std_Http_Extensions_empty();
    leanh::lean_mark_persistent(l_Std_Http_Extensions_empty);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
...
pub unsafe fn initialize_Std_Http_Data_Extensions(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
