...
static mut l_Std_Http_Internal_instDecidableIsLowerCase___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l_Std_Http_Internal_instDecidableIsLowerCase(
    mut v_s_12_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_Http_Internal_instDecidableIsLowerCase___boxed(
    mut v_s_18_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_19_: u8 = 0;
    let mut v_r_20_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_19_ = l_Std_Http_Internal_instDecidableIsLowerCase(v_s_18_);
    v_r_20_ = leanh::lean_box((v_res_19_) as usize);
    return v_r_20_;
}
...
pub unsafe fn initialize_Std_Http_Internal_LowerCase(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
