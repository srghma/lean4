...
static mut l_Std_Http_Internal_instEncodeV11Version___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Std_Http_Internal_instEncodeV11Version___closed__0_value)
        as *mut leanh::LeanObject;
pub static mut l_Std_Http_Internal_instEncodeV11Version: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Std_Http_Internal_instEncodeV11Version___closed__0_value)
        as *mut leanh::LeanObject;
pub unsafe fn l_Std_Http_Internal_instEncodeV11Version___lam__0(
    mut v_buffer_36_: *mut leanh::LeanObject,
    mut v___y_37_: u8,
) -> *mut leanh::LeanObject {
    let mut v___y_39_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_data_40_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_size_41_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_51_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            ...
            1 => {
                v_data_40_ = leanh::lean_ctor_get(v_buffer_36_, 0);
                v_size_41_ = leanh::lean_ctor_get(v_buffer_36_, 1);
                v_isSharedCheck_52_ = (!leanh::lean_is_exclusive(v_buffer_36_)) as u8;
                if v_isSharedCheck_52_ == 0 {
                    ...
                    leanh::lean_inc(v_size_41_);
                    leanh::lean_inc(v_data_40_);
                    leanh::lean_dec(v_buffer_36_);
            ...
            2 => {
                ...
                leanh::lean_dec(v_size_41_);
                if v_isShared_44_ == 0 {
                    leanh::lean_ctor_set(v___x_43_, 1, v___x_48_);
                    leanh::lean_ctor_set(v___x_43_, 0, v___x_46_);
                    v___x_50_ = v___x_43_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_51_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_51_, 0, v___x_46_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_51_, 1, v___x_48_);
...
pub unsafe fn l_Std_Http_Internal_instEncodeV11Version___lam__0___boxed(
    mut v_buffer_57_: *mut leanh::LeanObject,
    ...
    v___y_52__boxed_59_ = (leanh::lean_unbox(v___y_58_) as u8);
    v_res_60_ =
...
pub unsafe fn initialize_Std_Http_Internal_Encode(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
