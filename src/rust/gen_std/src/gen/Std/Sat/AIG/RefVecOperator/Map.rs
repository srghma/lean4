...
pub unsafe fn l_Std_Sat_AIG_RefVec_map_go___redArg(
    ...
    mut v_idx_94_: *mut crate::leanh::LeanObject,
    mut v_s_95_: *mut crate::leanh::LeanObject,
    mut v_input_96_: *mut crate::leanh::LeanObject,
    mut v_f_97_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v___y_99_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_102_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_gate_103_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_111_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_113_: u8 = 0;
    let mut v___x_114_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_ref_115_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_113_ == 0 {
                    crate::leanh::lean_dec_ref(v_f_97_);
                    crate::leanh::lean_dec(v_idx_94_);
                    v___x_114_ = crate::leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    crate::leanh::lean_ctor_set(v___x_114_, 0, v_aig_93_);
                    crate::leanh::lean_ctor_set(v___x_114_, 1, v_s_95_);
                    return v___x_114_;
                } else {
                    ...
                    v___x_119_ = crate::leanh::lean_unsigned_to_nat(0);
                    v___x_120_ = lean_nat_dec_eq(v___x_118_, v___x_119_);
                    crate::leanh::lean_dec(v___x_118_);
                    if v___x_120_ == 0 {
                        v___x_121_ = crate::leanh::lean_alloc_ctor(0, 1, (1) as u32);
                        crate::leanh::lean_ctor_set(v___x_121_, 0, v___x_117_);
                        ...
                        v___x_122_ = 0;
                        v___x_123_ = crate::leanh::lean_alloc_ctor(0, 1, (1) as u32);
                        crate::leanh::lean_ctor_set(v___x_123_, 0, v___x_117_);
                        crate::leanh::lean_ctor_set_uint8(
                            v___x_123_,
                            (core::mem::size_of::<*mut crate::leanh::LeanObject>() * 1) as u32,
                            v___x_122_,
            ...
            1 => {
                crate::leanh::lean_inc_ref(v_f_97_);
                v_res_100_ = crate::leanh::lean_apply_2(v_f_97_, v_aig_93_, v___y_99_);
                v_ref_101_ = crate::leanh::lean_ctor_get(v_res_100_, 1);
                crate::leanh::lean_inc_ref(v_ref_101_);
                v_aig_102_ = crate::leanh::lean_ctor_get(v_res_100_, 0);
                crate::leanh::lean_inc_ref(v_aig_102_);
                crate::leanh::lean_dec_ref(v_res_100_);
                v_gate_103_ = crate::leanh::lean_ctor_get(v_ref_101_, 0);
                crate::leanh::lean_inc(v_gate_103_);
                v_invert_104_ = crate::leanh::lean_ctor_get_uint8(
                    v_ref_101_,
                    (core::mem::size_of::<*mut crate::leanh::LeanObject>() * 1) as u32,
                );
                crate::leanh::lean_dec_ref(v_ref_101_);
                v___x_105_ = crate::leanh::lean_unsigned_to_nat(1);
                v___x_106_ = lean_nat_add(v_idx_94_, v___x_105_);
                crate::leanh::lean_dec(v_idx_94_);
                v___x_107_ = crate::leanh::lean_unsigned_to_nat(2);
                v___x_108_ = lean_nat_mul(v_gate_103_, v___x_107_);
                crate::leanh::lean_dec(v_gate_103_);
...
pub unsafe fn l_Std_Sat_AIG_RefVec_map_go___redArg___boxed(
    mut v_len_124_: *mut crate::leanh::LeanObject,
    mut v_aig_125_: *mut crate::leanh::LeanObject,
    mut v_idx_126_: *mut crate::leanh::LeanObject,
    mut v_s_127_: *mut crate::leanh::LeanObject,
    mut v_input_128_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec_ref(v_input_128_);
    crate::leanh::lean_dec(v_len_124_);
    return v_res_130_;
}
pub unsafe fn l_Std_Sat_AIG_RefVec_map_go(
    ...
    mut v_len_134_: *mut crate::leanh::LeanObject,
    mut v_aig_135_: *mut crate::leanh::LeanObject,
    mut v_idx_136_: *mut crate::leanh::LeanObject,
    mut v_hidx_137_: *mut crate::leanh::LeanObject,
    mut v_s_138_: *mut crate::leanh::LeanObject,
    mut v_input_139_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_AIG_RefVec_map_go___boxed(
    ...
    mut v_idx_149_: *mut crate::leanh::LeanObject,
    mut v_hidx_150_: *mut crate::leanh::LeanObject,
    mut v_s_151_: *mut crate::leanh::LeanObject,
    mut v_input_152_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec_ref(v_input_152_);
    crate::leanh::lean_dec(v_len_147_);
    crate::leanh::lean_dec_ref(v_inst_146_);
    crate::leanh::lean_dec_ref(v_inst_145_);
    return v_res_156_;
}
pub unsafe fn l_Std_Sat_AIG_RefVec_map___redArg(
    mut v_len_157_: *mut crate::leanh::LeanObject,
    ...
    let mut v_func_161_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    v_vec_160_ = crate::leanh::lean_ctor_get(v_target_159_, 0);
    crate::leanh::lean_inc_ref(v_vec_160_);
    v_func_161_ = crate::leanh::lean_ctor_get(v_target_159_, 1);
    crate::leanh::lean_inc_ref(v_func_161_);
...
pub unsafe fn l_Std_Sat_AIG_RefVec_map___redArg___boxed(
    mut v_len_165_: *mut crate::leanh::LeanObject,
    mut v_aig_166_: *mut crate::leanh::LeanObject,
    mut v_target_167_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_dec(v_len_165_);
    return v_res_168_;
}
pub unsafe fn l_Std_Sat_AIG_RefVec_map(
    ...
    mut v_len_172_: *mut crate::leanh::LeanObject,
    mut v_aig_173_: *mut crate::leanh::LeanObject,
    mut v_target_174_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_RefVec_map___boxed(
    ...
    mut v_len_179_: *mut crate::leanh::LeanObject,
    mut v_aig_180_: *mut crate::leanh::LeanObject,
    mut v_target_181_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_dec(v_len_179_);
    crate::leanh::lean_dec_ref(v_inst_178_);
