...
static mut l_Std_Sat_AIG_RelabelNat_State_empty___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Std_Sat_AIG_RelabelNat_State_empty___closed__0: *mut leanh::LeanObject =
    core::ptr::null_mut();
static mut l_Std_Sat_AIG_RelabelNat_State_empty___closed__1_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Std_Sat_AIG_RelabelNat_State_empty___closed__1: *mut leanh::LeanObject =
    core::ptr::null_mut();
static mut l_Std_Sat_AIG_RelabelNat_State_empty___closed__2_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Std_Sat_AIG_RelabelNat_State_empty___closed__2: *mut leanh::LeanObject =
    core::ptr::null_mut();
...
-> *mut leanh::LeanObject {
    ...
    v___x_338_ = leanh::lean_unsigned_to_nat(16);
...
-> *mut leanh::LeanObject {
    ...
    v___x_341_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_empty(
    ...
    mut v_decls_349_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_empty___boxed(
    ...
    mut v_decls_354_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_decls_354_);
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addAtom___redArg(
    ...
    mut v_state_358_: *mut leanh::LeanObject,
    mut v_a_359_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_max_360_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_max_360_ = leanh::lean_ctor_get(v_state_358_, 0);
                v_map_361_ = leanh::lean_ctor_get(v_state_358_, 1);
                v_isSharedCheck_376_ = (!leanh::lean_is_exclusive(v_state_358_)) as u8;
                if v_isSharedCheck_376_ == 0 {
                    ...
                    leanh::lean_inc(v_max_360_);
                    leanh::lean_dec(v_state_358_);
            ...
            1 => {
                ...
                leanh::lean_closure_set(v___f_365_, 0, v_inst_356_);
                leanh::lean_inc(v_a_359_);
                leanh::lean_inc_ref(v_inst_357_);
                leanh::lean_inc_ref(v___f_365_);
                ...
                if leanh::lean_obj_tag(v___x_366_) == 0 {
                    ...
                    if v_isShared_364_ == 0 {
                        leanh::lean_ctor_set(v___x_363_, 1, v___x_369_);
                        leanh::lean_ctor_set(v___x_363_, 0, v___x_368_);
                        v___x_371_ = v___x_363_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_372_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_372_, 0, v___x_368_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_372_, 1, v___x_369_);
                        v___x_371_ = v_reuseFailAlloc_372_;
                        state = 2;
                        continue;
                    }
                } else {
                    leanh::lean_dec_ref_known(v___x_366_, 1);
                    leanh::lean_dec_ref(v___f_365_);
                    ...
                    if v_isShared_364_ == 0 {
                        ...
                        v_reuseFailAlloc_375_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_375_, 0, v_max_360_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_375_, 1, v_map_361_);
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addAtom(
    ...
    mut v_idx_380_: *mut leanh::LeanObject,
    mut v_decls_381_: *mut leanh::LeanObject,
    mut v_hidx_382_: *mut leanh::LeanObject,
    mut v_state_383_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addAtom___boxed(
    ...
    mut v_idx_390_: *mut leanh::LeanObject,
    mut v_decls_391_: *mut leanh::LeanObject,
    mut v_hidx_392_: *mut leanh::LeanObject,
    mut v_state_393_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_decls_391_);
    leanh::lean_dec(v_idx_390_);
    return v_res_396_;
}
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addFalse___redArg(
    mut v_state_397_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_max_398_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_map_399_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_max_398_ = leanh::lean_ctor_get(v_state_397_, 0);
                v_map_399_ = leanh::lean_ctor_get(v_state_397_, 1);
                v_isSharedCheck_406_ = (!leanh::lean_is_exclusive(v_state_397_)) as u8;
                if v_isSharedCheck_406_ == 0 {
                    ...
                    leanh::lean_inc(v_map_399_);
                    leanh::lean_inc(v_max_398_);
                    leanh::lean_dec(v_state_397_);
            ...
            1 => {
                if v_isShared_402_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_405_, 0, v_max_398_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_405_, 1, v_map_399_);
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addFalse(
    ...
    mut v_idx_410_: *mut leanh::LeanObject,
    mut v_decls_411_: *mut leanh::LeanObject,
    mut v_hidx_412_: *mut leanh::LeanObject,
    mut v_state_413_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addFalse___boxed(
    ...
    mut v_idx_419_: *mut leanh::LeanObject,
    mut v_decls_420_: *mut leanh::LeanObject,
    mut v_hidx_421_: *mut leanh::LeanObject,
    mut v_state_422_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_decls_420_);
    leanh::lean_dec(v_idx_419_);
    leanh::lean_dec_ref(v_inst_418_);
    leanh::lean_dec_ref(v_inst_417_);
    return v_res_424_;
}
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addGate___redArg(
    mut v_state_425_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_max_426_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_map_427_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_max_426_ = leanh::lean_ctor_get(v_state_425_, 0);
                v_map_427_ = leanh::lean_ctor_get(v_state_425_, 1);
                v_isSharedCheck_434_ = (!leanh::lean_is_exclusive(v_state_425_)) as u8;
                if v_isSharedCheck_434_ == 0 {
                    ...
                    leanh::lean_inc(v_map_427_);
                    leanh::lean_inc(v_max_426_);
                    leanh::lean_dec(v_state_425_);
            ...
            1 => {
                if v_isShared_430_ == 0 {
                    ...
                    v_reuseFailAlloc_433_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_433_, 0, v_max_426_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_433_, 1, v_map_427_);
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addGate(
    ...
    mut v_idx_438_: *mut leanh::LeanObject,
    mut v_decls_439_: *mut leanh::LeanObject,
    mut v_hidx_440_: *mut leanh::LeanObject,
    mut v_state_441_: *mut leanh::LeanObject,
    mut v_lhs_442_: *mut leanh::LeanObject,
    mut v_rhs_443_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_addGate___boxed(
    ...
    mut v_idx_449_: *mut leanh::LeanObject,
    mut v_decls_450_: *mut leanh::LeanObject,
    mut v_hidx_451_: *mut leanh::LeanObject,
    mut v_state_452_: *mut leanh::LeanObject,
    mut v_lhs_453_: *mut leanh::LeanObject,
    mut v_rhs_454_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_rhs_454_);
    leanh::lean_dec(v_lhs_453_);
    leanh::lean_dec_ref(v_decls_450_);
    leanh::lean_dec(v_idx_449_);
    leanh::lean_dec_ref(v_inst_448_);
    leanh::lean_dec_ref(v_inst_447_);
    return v_res_456_;
}
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIGAux_go___redArg(
    ...
    mut v_decls_459_: *mut leanh::LeanObject,
    mut v_idx_460_: *mut leanh::LeanObject,
    mut v_state_461_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_462_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_463_: u8 = 0;
    let mut v_decl_464_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_idx_469_: *mut leanh::LeanObject = core::ptr::null_mut();
            ...
            0 => {
                ...
                if v___x_463_ == 0 {
                    ...
                    match leanh::lean_obj_tag(v_decl_464_) {
                        ...
                        1 => {
                            v_idx_469_ = leanh::lean_ctor_get(v_decl_464_, 0);
                            v___x_470_ = leanh::lean_unsigned_to_nat(1);
                            v___x_471_ = lean_nat_add(v_idx_460_, v___x_470_);
                            leanh::lean_dec(v_idx_460_);
                            leanh::lean_inc(v_idx_469_);
                            leanh::lean_inc_ref(v_inst_458_);
                            leanh::lean_inc_ref(v_inst_457_);
                        ...
                        _ => {
                            v___x_474_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIGAux_go___redArg___boxed(
    ...
    mut v_decls_480_: *mut leanh::LeanObject,
    mut v_idx_481_: *mut leanh::LeanObject,
    mut v_state_482_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_decls_480_);
    return v_res_483_;
}
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIGAux_go(
    ...
    mut v_decls_487_: *mut leanh::LeanObject,
    mut v_idx_488_: *mut leanh::LeanObject,
    mut v_state_489_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIGAux_go___boxed(
    ...
    mut v_decls_494_: *mut leanh::LeanObject,
    mut v_idx_495_: *mut leanh::LeanObject,
    mut v_state_496_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_decls_494_);
    return v_res_497_;
}
pub unsafe fn l___private_Std_Sat_AIG_RelabelNat_0__Std_Sat_AIG_RelabelNat_State_ofAIGAux_go_match__1_splitter___redArg(
    mut v_decl_498_: *mut leanh::LeanObject,
    mut v_h__1_499_: *mut leanh::LeanObject,
    mut v_h__2_500_: *mut leanh::LeanObject,
    mut v_h__3_501_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match leanh::lean_obj_tag(v_decl_498_) {
        0 => {
            let mut v___x_502_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_501_);
            leanh::lean_dec(v_h__1_499_);
            v___x_502_ = leanh::lean_apply_1(v_h__2_500_, leanh::lean_box(0));
            return v___x_502_;
        }
        1 => {
            let mut v_idx_503_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_504_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_501_);
            leanh::lean_dec(v_h__2_500_);
            v_idx_503_ = leanh::lean_ctor_get(v_decl_498_, 0);
            leanh::lean_inc(v_idx_503_);
            leanh::lean_dec_ref_known(v_decl_498_, 1);
            v___x_504_ =
                leanh::lean_apply_2(v_h__1_499_, v_idx_503_, leanh::lean_box(0));
            return v___x_504_;
        }
        _ => {
            let mut v_l_505_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v_r_506_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_507_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__2_500_);
            leanh::lean_dec(v_h__1_499_);
            v_l_505_ = leanh::lean_ctor_get(v_decl_498_, 0);
            leanh::lean_inc(v_l_505_);
            v_r_506_ = leanh::lean_ctor_get(v_decl_498_, 1);
            leanh::lean_inc(v_r_506_);
            leanh::lean_dec_ref_known(v_decl_498_, 2);
            v___x_507_ = leanh::lean_apply_3(
                v_h__3_501_,
                v_l_505_,
                v_r_506_,
                leanh::lean_box(0),
...
pub unsafe fn l___private_Std_Sat_AIG_RelabelNat_0__Std_Sat_AIG_RelabelNat_State_ofAIGAux_go_match__1_splitter(
    ...
    mut v_h__3_513_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match leanh::lean_obj_tag(v_decl_510_) {
        0 => {
            let mut v___x_514_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_513_);
            leanh::lean_dec(v_h__1_511_);
            v___x_514_ = leanh::lean_apply_1(v_h__2_512_, leanh::lean_box(0));
            return v___x_514_;
        }
        1 => {
            let mut v_idx_515_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_516_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_513_);
            leanh::lean_dec(v_h__2_512_);
            v_idx_515_ = leanh::lean_ctor_get(v_decl_510_, 0);
            leanh::lean_inc(v_idx_515_);
            leanh::lean_dec_ref_known(v_decl_510_, 1);
            v___x_516_ =
                leanh::lean_apply_2(v_h__1_511_, v_idx_515_, leanh::lean_box(0));
            return v___x_516_;
        }
        _ => {
            let mut v_l_517_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v_r_518_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_519_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__2_512_);
            leanh::lean_dec(v_h__1_511_);
            v_l_517_ = leanh::lean_ctor_get(v_decl_510_, 0);
            leanh::lean_inc(v_l_517_);
            v_r_518_ = leanh::lean_ctor_get(v_decl_510_, 1);
            leanh::lean_inc(v_r_518_);
            leanh::lean_dec_ref_known(v_decl_510_, 2);
            v___x_519_ = leanh::lean_apply_3(
                v_h__3_513_,
                v_l_517_,
                v_r_518_,
                leanh::lean_box(0),
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIGAux___redArg(
    ...
    mut v_aig_522_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_decls_523_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_decls_523_ = leanh::lean_ctor_get(v_aig_522_, 0);
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIGAux___boxed(
    ...
    mut v_aig_539_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIG___redArg(
    ...
    mut v_aig_543_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_544_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_map_545_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_544_ =
        l_Std_Sat_AIG_RelabelNat_State_ofAIGAux___redArg(v_inst_541_, v_inst_542_, v_aig_543_);
    v_map_545_ = leanh::lean_ctor_get(v___x_544_, 1);
    leanh::lean_inc_ref(v_map_545_);
    leanh::lean_dec_ref(v___x_544_);
    return v_map_545_;
}
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIG(
    ...
    mut v_aig_553_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_RelabelNat_State_ofAIG___boxed(
    ...
    mut v_aig_558_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_aig_558_);
    return v_res_559_;
}
pub unsafe fn l_Std_Sat_AIG_relabelNat_x27___redArg___lam__0(
    mut v___f_560_: *mut leanh::LeanObject,
    mut v_inst_561_: *mut leanh::LeanObject,
    mut v_map_562_: *mut leanh::LeanObject,
    ...
    if leanh::lean_obj_tag(v___x_564_) == 0 {
        ...
        v_val_566_ = leanh::lean_ctor_get(v___x_564_, 0);
...
pub unsafe fn l_Std_Sat_AIG_relabelNat_x27___redArg___lam__0___boxed(
    mut v___f_567_: *mut leanh::LeanObject,
    mut v_inst_568_: *mut leanh::LeanObject,
    mut v_map_569_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_AIG_relabelNat_x27___redArg(
    ...
    mut v_aig_574_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_map_575_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___f_576_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___f_577_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_578_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_579_: *mut leanh::LeanObject = core::ptr::null_mut();
    leanh::lean_inc_ref(v_inst_573_);
    ...
    leanh::lean_closure_set(v___f_576_, 0, v_inst_572_);
    leanh::lean_inc_ref(v_map_575_);
    v___f_577_ = leanh::lean_alloc_closure(
        l_Std_Sat_AIG_relabelNat_x27___redArg___lam__0___boxed as *mut core::ffi::c_void,
        4,
        3,
    );
    leanh::lean_closure_set(v___f_577_, 0, v___f_576_);
    leanh::lean_closure_set(v___f_577_, 1, v_inst_573_);
    leanh::lean_closure_set(v___f_577_, 2, v_map_575_);
    v_aig_578_ = l_Std_Sat_AIG_relabel___redArg(v___f_577_, v_aig_574_);
    v___x_579_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_579_, 0, v_aig_578_);
    leanh::lean_ctor_set(v___x_579_, 1, v_map_575_);
    return v___x_579_;
}
pub unsafe fn l_Std_Sat_AIG_relabelNat_x27(
    ...
    mut v_aig_583_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_relabelNat___redArg(
    ...
    mut v_aig_587_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_fst_589_ = leanh::lean_ctor_get(v___x_588_, 0);
...
pub unsafe fn l_Std_Sat_AIG_relabelNat(
    ...
    mut v_aig_593_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Std_Sat_AIG_RelabelNat_0__Std_Sat_AIG_relabelNat_x27_match__1_splitter___redArg(
    ...
    mut v_h__1_596_: *mut leanh::LeanObject,
    mut v_h__2_597_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_x_595_) == 0 {
        let mut v___x_598_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_599_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_596_);
        v___x_598_ = leanh::lean_box(0);
        v___x_599_ = leanh::lean_apply_1(v_h__2_597_, v___x_598_);
        return v___x_599_;
    } else {
        let mut v_val_600_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_601_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_597_);
        v_val_600_ = leanh::lean_ctor_get(v_x_595_, 0);
        leanh::lean_inc(v_val_600_);
        leanh::lean_dec_ref_known(v_x_595_, 1);
        v___x_601_ = leanh::lean_apply_1(v_h__1_596_, v_val_600_);
        return v___x_601_;
    }
}
pub unsafe fn l___private_Std_Sat_AIG_RelabelNat_0__Std_Sat_AIG_relabelNat_x27_match__1_splitter(
    ...
    mut v_h__1_604_: *mut leanh::LeanObject,
    mut v_h__2_605_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_x_603_) == 0 {
        ...
        leanh::lean_dec(v_h__1_604_);
        v___x_606_ = leanh::lean_box(0);
        v___x_607_ = leanh::lean_apply_1(v_h__2_605_, v___x_606_);
        return v___x_607_;
    } else {
        let mut v_val_608_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_609_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_605_);
        v_val_608_ = leanh::lean_ctor_get(v_x_603_, 0);
        leanh::lean_inc(v_val_608_);
        leanh::lean_dec_ref_known(v_x_603_, 1);
        v___x_609_ = leanh::lean_apply_1(v_h__1_604_, v_val_608_);
        return v___x_609_;
    }
}
pub unsafe fn l_Std_Sat_AIG_Entrypoint_relabelNat_x27___redArg(
    ...
    mut v_entry_612_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_aig_613_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_fst_619_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_gate_624_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_entry_632_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_aig_613_ = leanh::lean_ctor_get(v_entry_612_, 0);
                v_ref_614_ = leanh::lean_ctor_get(v_entry_612_, 1);
                v_isSharedCheck_640_ = (!leanh::lean_is_exclusive(v_entry_612_)) as u8;
                if v_isSharedCheck_640_ == 0 {
                    ...
                    leanh::lean_inc(v_aig_613_);
                    leanh::lean_dec(v_entry_612_);
            ...
            1 => {
                ...
                v_fst_619_ = leanh::lean_ctor_get(v_res_618_, 0);
                v_snd_620_ = leanh::lean_ctor_get(v_res_618_, 1);
                v_isSharedCheck_639_ = (!leanh::lean_is_exclusive(v_res_618_)) as u8;
                if v_isSharedCheck_639_ == 0 {
                    ...
                    leanh::lean_inc(v_snd_620_);
                    leanh::lean_inc(v_fst_619_);
                    leanh::lean_dec(v_res_618_);
            ...
            2 => {
                v_gate_624_ = leanh::lean_ctor_get(v_ref_614_, 0);
                v_invert_625_ = leanh::lean_ctor_get_uint8(
                    v_ref_614_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                v_isSharedCheck_638_ = (!leanh::lean_is_exclusive(v_ref_614_)) as u8;
            ...
            3 => {
                if v_isShared_628_ == 0 {
                    ...
                    v_reuseFailAlloc_637_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_637_, 0, v_gate_624_);
            ...
            4 => {
                if v_isShared_617_ == 0 {
                    leanh::lean_ctor_set(v___x_616_, 1, v___x_630_);
                    leanh::lean_ctor_set(v___x_616_, 0, v_fst_619_);
                    v_entry_632_ = v___x_616_;
                    state = 5;
                    continue;
                } else {
                    v_reuseFailAlloc_636_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_636_, 0, v_fst_619_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_636_, 1, v___x_630_);
            ...
            5 => {
                if v_isShared_623_ == 0 {
                    leanh::lean_ctor_set(v___x_622_, 0, v_entry_632_);
                    v___x_634_ = v___x_622_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_635_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_635_, 0, v_entry_632_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_635_, 1, v_snd_620_);
...
pub unsafe fn l_Std_Sat_AIG_Entrypoint_relabelNat_x27(
    ...
    mut v_entry_644_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_Entrypoint_relabelNat___redArg(
    ...
    mut v_entry_648_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_ref_649_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_650_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_652_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_653_: u8 = 0;
    let mut v_gate_654_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_ref_649_ = leanh::lean_ctor_get(v_entry_648_, 1);
                v_aig_650_ = leanh::lean_ctor_get(v_entry_648_, 0);
                v_isSharedCheck_667_ = (!leanh::lean_is_exclusive(v_entry_648_)) as u8;
                if v_isSharedCheck_667_ == 0 {
                    ...
                    leanh::lean_inc(v_ref_649_);
                    leanh::lean_inc(v_aig_650_);
                    leanh::lean_dec(v_entry_648_);
            ...
            1 => {
                v_gate_654_ = leanh::lean_ctor_get(v_ref_649_, 0);
                v_invert_655_ = leanh::lean_ctor_get_uint8(
                    v_ref_649_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                v_isSharedCheck_666_ = (!leanh::lean_is_exclusive(v_ref_649_)) as u8;
                if v_isSharedCheck_666_ == 0 {
                    ...
                    leanh::lean_inc(v_gate_654_);
                    leanh::lean_dec(v_ref_649_);
            ...
            2 => {
                ...
                if v_isShared_658_ == 0 {
                    ...
                    v_reuseFailAlloc_665_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_665_, 0, v_gate_654_);
                    leanh::lean_ctor_set_uint8(
            ...
            3 => {
                if v_isShared_653_ == 0 {
                    leanh::lean_ctor_set(v___x_652_, 1, v___x_661_);
                    leanh::lean_ctor_set(v___x_652_, 0, v___x_659_);
                    v___x_663_ = v___x_652_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_664_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_664_, 0, v___x_659_);
...
pub unsafe fn l_Std_Sat_AIG_Entrypoint_relabelNat(
    ...
    mut v_entry_671_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Sat_AIG_RelabelNat(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sat_AIG_RelabelNat(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
