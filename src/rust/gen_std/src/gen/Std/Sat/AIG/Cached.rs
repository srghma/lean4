...
pub static l_Std_Sat_AIG_mkGateCached_go___redArg___closed__0_value: leanh::LeanCtorObject<
    2,
...
static mut l_Std_Sat_AIG_mkGateCached_go___redArg___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l_Std_Sat_AIG_mkAtomCached___redArg___lam__0(
    ...
    mut v_b_197_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_Sat_AIG_mkAtomCached___redArg___lam__0___boxed(
    ...
    v_r_203_ = leanh::lean_box((v_res_202_) as usize);
    return v_r_203_;
}
pub unsafe fn l_Std_Sat_AIG_mkAtomCached___redArg(
    ...
    mut v_aig_206_: *mut leanh::LeanObject,
    mut v_n_207_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_decls_208_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_209_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_211_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_212_: u8 = 0;
    let mut v___f_213_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_decl_214_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_g_218_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_219_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_decls_220_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_226_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_val_227_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_decls_208_ = leanh::lean_ctor_get(v_aig_206_, 0);
                v_cache_209_ = leanh::lean_ctor_get(v_aig_206_, 1);
                v_isSharedCheck_234_ = (!leanh::lean_is_exclusive(v_aig_206_)) as u8;
                if v_isSharedCheck_234_ == 0 {
                    ...
                    leanh::lean_inc(v_cache_209_);
                    leanh::lean_inc(v_decls_208_);
                    leanh::lean_dec(v_aig_206_);
            ...
            1 => {
                v___f_213_ = leanh::lean_alloc_closure(
                    l_Std_Sat_AIG_mkAtomCached___redArg___lam__0___boxed as *mut core::ffi::c_void,
                    3,
                    1,
                );
                leanh::lean_closure_set(v___f_213_, 0, v_inst_205_);
                v_decl_214_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                leanh::lean_ctor_set(v_decl_214_, 0, v_n_207_);
                v___x_215_ = leanh::lean_alloc_closure(
                    l_Std_Sat_AIG_instHashableDecl_hash___boxed as *mut core::ffi::c_void,
                    3,
                    2,
                );
                leanh::lean_closure_set(v___x_215_, 0, leanh::lean_box(0));
                leanh::lean_closure_set(v___x_215_, 1, v_inst_204_);
                v___f_216_ = leanh::lean_alloc_closure(
                    l_instBEqOfDecidableEq___redArg___lam__0___boxed as *mut core::ffi::c_void,
                    3,
                    1,
                );
                leanh::lean_closure_set(v___f_216_, 0, v___f_213_);
                leanh::lean_inc_ref(v_decl_214_);
                leanh::lean_inc_ref(v___x_215_);
                leanh::lean_inc_ref(v___f_216_);
                ...
                if leanh::lean_obj_tag(v___x_217_) == 0 {
                    ...
                    if v_isShared_212_ == 0 {
                        leanh::lean_ctor_set(v___x_211_, 1, v_cache_219_);
                        leanh::lean_ctor_set(v___x_211_, 0, v_decls_220_);
                        v___x_222_ = v___x_211_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_226_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_226_, 0, v_decls_220_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_226_, 1, v_cache_219_);
                    ...
                    leanh::lean_dec_ref(v___x_215_);
                    leanh::lean_dec_ref_known(v_decl_214_, 1);
                    v_val_227_ = leanh::lean_ctor_get(v___x_217_, 0);
                    leanh::lean_inc(v_val_227_);
                    leanh::lean_dec_ref_known(v___x_217_, 1);
                    if v_isShared_212_ == 0 {
                        ...
                        leanh::lean_ctor_set(v_reuseFailAlloc_233_, 0, v_decls_208_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_233_, 1, v_cache_209_);
            ...
            2 => {
                v___x_223_ = 0;
                v___x_224_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                leanh::lean_ctor_set(v___x_224_, 0, v_g_218_);
                ...
                leanh::lean_ctor_set(v___x_225_, 0, v___x_222_);
                leanh::lean_ctor_set(v___x_225_, 1, v___x_224_);
                return v___x_225_;
            }
            3 => {
                v___x_230_ = 0;
                v___x_231_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                leanh::lean_ctor_set(v___x_231_, 0, v_val_227_);
                leanh::lean_ctor_set_uint8(
                    v___x_231_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                    v___x_230_,
                );
                v___x_232_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_232_, 0, v___x_229_);
                leanh::lean_ctor_set(v___x_232_, 1, v___x_231_);
                return v___x_232_;
            }
            _ => {}
        }
...
pub unsafe fn l_Std_Sat_AIG_mkAtomCached(
    ...
    mut v_aig_238_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_AIG_mkConstCached___redArg(
    ...
    v___x_242_ = leanh::lean_unsigned_to_nat(0);
    v___x_243_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
...
pub unsafe fn l_Std_Sat_AIG_mkConstCached(
    ...
    mut v_aig_250_: *mut leanh::LeanObject,
    mut v_val_251_: u8,
) -> *mut leanh::LeanObject {
    let mut v___x_252_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_253_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_252_ = leanh::lean_unsigned_to_nat(0);
    v___x_253_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
    leanh::lean_ctor_set(v___x_253_, 0, v___x_252_);
    leanh::lean_ctor_set_uint8(
        v___x_253_,
        (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
        v_val_251_,
...
pub unsafe fn l_Std_Sat_AIG_mkConstCached___boxed(
    ...
    mut v_aig_257_: *mut leanh::LeanObject,
    mut v_val_258_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_val_boxed_259_: u8 = 0;
    let mut v_res_260_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_val_boxed_259_ = (leanh::lean_unbox(v_val_258_) as u8);
...
pub unsafe fn l_Std_Sat_AIG_mkGateCached_go___redArg(
    ...
    mut v_input_267_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lhs_268_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_269_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_271_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_272_: u8 = 0;
    let mut v_decls_273_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_274_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_276_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_277_: u8 = 0;
    let mut v_gate_278_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_invert_279_: u8 = 0;
    let mut v_gate_280_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_decl_291_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_300_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_310_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_311_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lhsVal_312_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhsVal_313_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_326_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_327_: u8 = 0;
    let mut v_g_328_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_329_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_decls_330_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_lhs_268_ = leanh::lean_ctor_get(v_input_267_, 0);
                v_rhs_269_ = leanh::lean_ctor_get(v_input_267_, 1);
                v_isSharedCheck_355_ = (!leanh::lean_is_exclusive(v_input_267_)) as u8;
                if v_isSharedCheck_355_ == 0 {
                    ...
                    leanh::lean_inc(v_rhs_269_);
                    leanh::lean_inc(v_lhs_268_);
                    leanh::lean_dec(v_input_267_);
            ...
            1 => {
                v_decls_273_ = leanh::lean_ctor_get(v_aig_266_, 0);
                v_cache_274_ = leanh::lean_ctor_get(v_aig_266_, 1);
                v_isSharedCheck_354_ = (!leanh::lean_is_exclusive(v_aig_266_)) as u8;
                if v_isSharedCheck_354_ == 0 {
                    ...
                    leanh::lean_inc(v_cache_274_);
                    leanh::lean_inc(v_decls_273_);
                    leanh::lean_dec(v_aig_266_);
            ...
            2 => {
                v_gate_278_ = leanh::lean_ctor_get(v_lhs_268_, 0);
                leanh::lean_inc(v_gate_278_);
                v_invert_279_ = leanh::lean_ctor_get_uint8(
                    v_lhs_268_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                v_gate_280_ = leanh::lean_ctor_get(v_rhs_269_, 0);
                v_invert_281_ = leanh::lean_ctor_get_uint8(
                    v_rhs_269_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                ...
                leanh::lean_closure_set(v___f_282_, 0, v_inst_265_);
                v___x_283_ = leanh::lean_unsigned_to_nat(2);
                ...
                leanh::lean_dec(v___x_288_);
                leanh::lean_dec(v___x_287_);
                if v_isShared_272_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_271_, 2);
                    leanh::lean_ctor_set(v___x_271_, 1, v___x_289_);
                    leanh::lean_ctor_set(v___x_271_, 0, v___x_286_);
                    v_decl_291_ = v___x_271_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_353_ = leanh::lean_alloc_ctor(2, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_353_, 0, v___x_286_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_353_, 1, v___x_289_);
            ...
            3 => {
                v___x_292_ = leanh::lean_alloc_closure(
                    l_Std_Sat_AIG_instHashableDecl_hash___boxed as *mut core::ffi::c_void,
                    3,
                    2,
                );
                leanh::lean_closure_set(v___x_292_, 0, leanh::lean_box(0));
                leanh::lean_closure_set(v___x_292_, 1, v_inst_264_);
                v___f_293_ = leanh::lean_alloc_closure(
                    l_instBEqOfDecidableEq___redArg___lam__0___boxed as *mut core::ffi::c_void,
                    3,
                    1,
                );
                leanh::lean_closure_set(v___f_293_, 0, v___f_282_);
                leanh::lean_inc_ref(v_decl_291_);
                leanh::lean_inc_ref(v___x_292_);
                leanh::lean_inc_ref(v___f_293_);
                ...
                if leanh::lean_obj_tag(v___x_294_) == 0 {
                    leanh::lean_inc(v_gate_280_);
                    leanh::lean_inc_ref(v_cache_274_);
                    leanh::lean_inc_ref(v_decls_273_);
                    if v_isShared_277_ == 0 {
                        v___x_296_ = v___x_276_;
                        state = 4;
                        continue;
                    } else {
                        v_reuseFailAlloc_338_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_338_, 0, v_decls_273_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_338_, 1, v_cache_274_);
                        v___x_296_ = v_reuseFailAlloc_338_;
                        state = 4;
                        continue;
                    }
                } else {
                    leanh::lean_dec_ref(v___f_293_);
                    leanh::lean_dec_ref(v___x_292_);
                    leanh::lean_dec_ref(v_decl_291_);
                    leanh::lean_dec(v_gate_278_);
                    leanh::lean_dec_ref(v_lhs_268_);
                    v_isSharedCheck_351_ = (!leanh::lean_is_exclusive(v_rhs_269_)) as u8;
                    if v_isSharedCheck_351_ == 0 {
                        v_unused_352_ = leanh::lean_ctor_get(v_rhs_269_, 0);
            ...
            4 => {
                ...
                v_isSharedCheck_336_ = (!leanh::lean_is_exclusive(v_rhs_269_)) as u8;
                if v_isSharedCheck_336_ == 0 {
                    v_unused_337_ = leanh::lean_ctor_get(v_rhs_269_, 0);
            ...
            5 => {
                ...
                v_ref_300_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                leanh::lean_ctor_set(v_ref_300_, 0, v___x_299_);
                leanh::lean_ctor_set_uint8(
                    v_ref_300_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                    v___y_298_,
                ...
                leanh::lean_ctor_set(v___x_301_, 0, v___x_296_);
                leanh::lean_ctor_set(v___x_301_, 1, v_ref_300_);
                return v___x_301_;
            }
            6 => {
                if v___y_303_ == 0 {
                    ...
                    v___x_304_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                    leanh::lean_ctor_set(v___x_304_, 0, v_gate_278_);
                    leanh::lean_ctor_set_uint8(
                        v___x_304_,
                        (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                        v_invert_279_,
                    ...
                    leanh::lean_ctor_set(v___x_305_, 0, v___x_296_);
                    leanh::lean_ctor_set(v___x_305_, 1, v___x_304_);
                    return v___x_305_;
                }
            }
            7 => {
                v___x_307_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                leanh::lean_ctor_set(v___x_307_, 0, v_gate_280_);
                leanh::lean_ctor_set_uint8(
                    v___x_307_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                    v_invert_281_,
                );
                v___x_308_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_308_, 0, v___x_296_);
                leanh::lean_ctor_set(v___x_308_, 1, v___x_307_);
                return v___x_308_;
            }
            8 => {
                v_ref_310_ = l_Std_Sat_AIG_mkGateCached_go___redArg___closed__0;
                v___x_311_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_311_, 0, v___x_296_);
                leanh::lean_ctor_set(v___x_311_, 1, v_ref_310_);
                return v___x_311_;
            }
            9 => {
                if leanh::lean_obj_tag(v_lhsVal_312_) == 1 {
                    leanh::lean_del_object(v___x_315_);
                    leanh::lean_dec_ref(v___f_293_);
                    leanh::lean_dec_ref(v___x_292_);
                    leanh::lean_dec_ref(v_decl_291_);
                    leanh::lean_dec(v_gate_278_);
                    leanh::lean_dec_ref(v_cache_274_);
                    leanh::lean_dec_ref(v_decls_273_);
                    v_val_317_ = leanh::lean_ctor_get(v_lhsVal_312_, 0);
                    leanh::lean_inc(v_val_317_);
                    leanh::lean_dec_ref_known(v_lhsVal_312_, 1);
                    v___x_318_ = (leanh::lean_unbox(v_val_317_) as u8);
                    leanh::lean_dec(v_val_317_);
                    if v___x_318_ == 0 {
                        leanh::lean_dec(v_rhsVal_313_);
                        leanh::lean_dec(v_gate_280_);
                        state = 8;
                        continue;
                    } else {
                        if leanh::lean_obj_tag(v_rhsVal_313_) == 1 {
                            v_val_319_ = leanh::lean_ctor_get(v_rhsVal_313_, 0);
                            leanh::lean_inc(v_val_319_);
                            leanh::lean_dec_ref_known(v_rhsVal_313_, 1);
                            v___x_320_ = (leanh::lean_unbox(v_val_319_) as u8);
                            leanh::lean_dec(v_val_319_);
                            if v___x_320_ == 0 {
                                leanh::lean_dec(v_gate_280_);
                                state = 8;
                                continue;
                    ...
                    if leanh::lean_obj_tag(v_rhsVal_313_) == 1 {
                        ...
                        leanh::lean_dec_ref(v_cache_274_);
                        leanh::lean_dec_ref(v_decls_273_);
                        v_val_321_ = leanh::lean_ctor_get(v_rhsVal_313_, 0);
                        leanh::lean_inc(v_val_321_);
                        leanh::lean_dec_ref_known(v_rhsVal_313_, 1);
                        v___x_322_ = (leanh::lean_unbox(v_val_321_) as u8);
                        leanh::lean_dec(v_val_321_);
                        if v___x_322_ == 0 {
                            leanh::lean_del_object(v___x_315_);
                            leanh::lean_dec(v_gate_278_);
                            state = 8;
                            ...
                            if v_isShared_316_ == 0 {
                                leanh::lean_ctor_set(v___x_315_, 0, v_gate_278_);
                                ...
                                leanh::lean_ctor_set(v_reuseFailAlloc_326_, 0, v_gate_278_);
                        ...
                        if v___x_327_ == 0 {
                            ...
                            v___x_331_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                            leanh::lean_ctor_set(v___x_331_, 0, v_decls_330_);
                            leanh::lean_ctor_set(v___x_331_, 1, v_cache_329_);
                            if v_isShared_316_ == 0 {
                                leanh::lean_ctor_set(v___x_315_, 0, v_g_328_);
                                ...
                                v_reuseFailAlloc_335_ =
                                    leanh::lean_alloc_ctor(0, 1, (1) as u32);
                                leanh::lean_ctor_set(v_reuseFailAlloc_335_, 0, v_g_328_);
            ...
            10 => {
                ...
                v___x_325_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_325_, 0, v___x_296_);
            ...
            11 => {
                ...
                leanh::lean_ctor_set(v___x_334_, 0, v___x_331_);
                leanh::lean_ctor_set(v___x_334_, 1, v___x_333_);
                return v___x_334_;
            }
            12 => {
                v_val_342_ = leanh::lean_ctor_get(v___x_294_, 0);
                ...
                if v_isShared_277_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_350_, 0, v_decls_273_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_350_, 1, v_cache_274_);
            ...
            13 => {
                ...
                if v_isShared_341_ == 0 {
                    leanh::lean_ctor_set(v___x_340_, 0, v_val_342_);
                    v___x_347_ = v___x_340_;
                    state = 14;
                    continue;
                } else {
                    v_reuseFailAlloc_349_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_349_, 0, v_val_342_);
...
pub unsafe fn l_Std_Sat_AIG_mkGateCached_go(
    ...
    mut v_aig_359_: *mut leanh::LeanObject,
    mut v_input_360_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_AIG_mkGateCached___redArg(
    ...
    mut v_aig_364_: *mut leanh::LeanObject,
    mut v_input_365_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lhs_366_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_367_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_369_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_370_: u8 = 0;
    let mut v_gate_371_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_gate_372_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_377_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_lhs_366_ = leanh::lean_ctor_get(v_input_365_, 0);
                v_rhs_367_ = leanh::lean_ctor_get(v_input_365_, 1);
                v_isSharedCheck_382_ = (!leanh::lean_is_exclusive(v_input_365_)) as u8;
                if v_isSharedCheck_382_ == 0 {
                    ...
                    leanh::lean_inc(v_rhs_367_);
                    leanh::lean_inc(v_lhs_366_);
                    leanh::lean_dec(v_input_365_);
            ...
            1 => {
                v_gate_371_ = leanh::lean_ctor_get(v_lhs_366_, 0);
                v_gate_372_ = leanh::lean_ctor_get(v_rhs_367_, 0);
                v___x_373_ = lean_nat_dec_lt(v_gate_371_, v_gate_372_);
                if v___x_373_ == 0 {
                    if v_isShared_370_ == 0 {
                        leanh::lean_ctor_set(v___x_369_, 1, v_lhs_366_);
                        leanh::lean_ctor_set(v___x_369_, 0, v_rhs_367_);
                        v___x_375_ = v___x_369_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_377_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_377_, 0, v_rhs_367_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_377_, 1, v_lhs_366_);
                    ...
                    if v_isShared_370_ == 0 {
                        ...
                        leanh::lean_ctor_set(v_reuseFailAlloc_381_, 0, v_lhs_366_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_381_, 1, v_rhs_367_);
...
pub unsafe fn l_Std_Sat_AIG_mkGateCached(
    ...
    mut v_aig_386_: *mut leanh::LeanObject,
    mut v_input_387_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn runtime_initialize_Std_Sat_AIG_Cached(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Sat_AIG_Cached(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sat_AIG_Cached(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
