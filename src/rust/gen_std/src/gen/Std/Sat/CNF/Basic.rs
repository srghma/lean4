...
pub static l_Std_Sat_CNF_empty___closed__0_value: leanh::LeanArrayObject<0> =
...
static mut l_Std_Sat_CNF_empty___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Std_Sat_CNF_empty___closed__0_value) as *mut leanh::LeanObject;
pub static l_Std_Sat_CNF_instAppend___closed__0_value: leanh::LeanClosureObject<1> =
...
static mut l_Std_Sat_CNF_instAppend___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l_List_any___at___00Std_Sat_CNF_Clause_eval_spec__0___redArg(
    ...
    let mut v_head_343_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_344_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fst_345_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_346_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_341_) == 0 {
                    leanh::lean_dec_ref(v_a_340_);
                    v___x_342_ = 0;
                    return v___x_342_;
                } else {
                    v_head_343_ = leanh::lean_ctor_get(v_x_341_, 0);
                    leanh::lean_inc(v_head_343_);
                    v_tail_344_ = leanh::lean_ctor_get(v_x_341_, 1);
                    leanh::lean_inc(v_tail_344_);
                    leanh::lean_dec_ref_known(v_x_341_, 2);
                    v_fst_345_ = leanh::lean_ctor_get(v_head_343_, 0);
                    leanh::lean_inc(v_fst_345_);
                    v_snd_346_ = leanh::lean_ctor_get(v_head_343_, 1);
                    leanh::lean_inc(v_snd_346_);
                    leanh::lean_dec(v_head_343_);
                    leanh::lean_inc_ref(v_a_340_);
                    v___x_347_ = leanh::lean_apply_1(v_a_340_, v_fst_345_);
                    v___x_348_ = (leanh::lean_unbox(v___x_347_) as u8);
                    if v___x_348_ == 0 {
                        v___x_349_ = (leanh::lean_unbox(v_snd_346_) as u8);
                        leanh::lean_dec(v_snd_346_);
                        if v___x_349_ == 0 {
                            leanh::lean_dec(v_tail_344_);
                            leanh::lean_dec_ref(v_a_340_);
                            v___x_350_ = 1;
                            return v___x_350_;
                        } else {
                        ...
                        v___x_352_ = (leanh::lean_unbox(v_snd_346_) as u8);
                        if v___x_352_ == 0 {
                            leanh::lean_dec(v_snd_346_);
                            v_x_341_ = v_tail_344_;
                            state = 0;
                            ...
                            leanh::lean_dec(v_tail_344_);
                            leanh::lean_dec_ref(v_a_340_);
                            v___x_354_ = (leanh::lean_unbox(v_snd_346_) as u8);
                            leanh::lean_dec(v_snd_346_);
                            return v___x_354_;
                        }
                    }
...
pub unsafe fn l_Std_Sat_CNF_Clause_eval___redArg(
    ...
    mut v_c_360_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_Sat_CNF_Clause_eval___redArg___boxed(
    ...
    mut v_c_363_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_CNF_Clause_eval(
    ...
    mut v_c_368_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_Sat_CNF_Clause_eval___boxed(
    ...
    mut v_c_372_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_373_: u8 = 0;
    let mut v_r_374_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_373_ = l_Std_Sat_CNF_Clause_eval(v_00_u03b1_370_, v_a_371_, v_c_372_);
    v_r_374_ = leanh::lean_box((v_res_373_) as usize);
    return v_r_374_;
}
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_anyMUnsafe_any___at___00Std_Sat_CNF_eval_spec__0___redArg(
    ...
    mut v_as_385_: *mut leanh::LeanObject,
    mut v_i_386_: usize,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_anyMUnsafe_any___at___00Std_Sat_CNF_eval_spec__0___redArg___boxed(
    ...
    mut v_as_397_: *mut leanh::LeanObject,
    mut v_i_398_: *mut leanh::LeanObject,
    mut v_stop_399_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_i_boxed_400_: usize = 0;
    let mut v_stop_boxed_401_: usize = 0;
    let mut v_res_402_: u8 = 0;
    let mut v_r_403_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_i_boxed_400_ = leanh::lean_unbox_usize(v_i_398_);
    leanh::lean_dec(v_i_398_);
    v_stop_boxed_401_ = leanh::lean_unbox_usize(v_stop_399_);
    leanh::lean_dec(v_stop_399_);
    ...
    leanh::lean_dec_ref(v_as_397_);
    v_r_403_ = leanh::lean_box((v_res_402_) as usize);
    return v_r_403_;
}
...
pub unsafe fn l_Std_Sat_CNF_eval(
    ...
    mut v_f_420_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_anyMUnsafe_any___at___00Std_Sat_CNF_eval_spec__0___boxed(
    ...
    mut v_as_435_: *mut leanh::LeanObject,
    mut v_i_436_: *mut leanh::LeanObject,
    mut v_stop_437_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_i_boxed_438_ = leanh::lean_unbox_usize(v_i_436_);
    leanh::lean_dec(v_i_436_);
    v_stop_boxed_439_ = leanh::lean_unbox_usize(v_stop_437_);
    leanh::lean_dec(v_stop_437_);
    v_res_440_ =
    ...
    leanh::lean_dec_ref(v_as_435_);
    v_r_441_ = leanh::lean_box((v_res_440_) as usize);
    return v_r_441_;
}
...
pub unsafe fn l_Std_Sat_CNF_emptyWithCapacity___redArg(
    mut v_n_446_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_CNF_add(
    ...
    mut v_c_460_: *mut leanh::LeanObject,
    mut v_f_461_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_CNF_append___redArg(
    mut v_f1_463_: *mut leanh::LeanObject,
    mut v_f2_464_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_CNF_append___boxed(
    ...
    mut v_f1_474_: *mut leanh::LeanObject,
    mut v_f2_475_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_f2_475_);
    return v_res_476_;
}
pub unsafe fn l_Std_Sat_CNF_instAppend(
    mut v_00_u03b1_478_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
-> *mut leanh::LeanObject {
    ...
    leanh::lean_closure_set(v___f_481_, 0, v___x_480_);
    return v___f_481_;
}
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___aux__1___redArg(
    mut v_v_482_: *mut leanh::LeanObject,
    mut v_c_483_: *mut leanh::LeanObject,
    ...
    v___f_485_ = leanh::lean_alloc_closure(
        l_instBEqOfDecidableEq___redArg___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_485_, 0, v_inst_484_);
    v___f_486_ = leanh::lean_obj_once(
    ...
    leanh::lean_closure_set(v___f_487_, 0, v___f_485_);
    leanh::lean_closure_set(v___f_487_, 1, v___f_486_);
    v___x_488_ = 0;
    v___x_489_ = leanh::lean_box((v___x_488_) as usize);
    leanh::lean_inc(v_v_482_);
    v___x_490_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_490_, 0, v_v_482_);
    leanh::lean_ctor_set(v___x_490_, 1, v___x_489_);
    leanh::lean_inc(v_c_483_);
    leanh::lean_inc_ref(v___f_487_);
    ...
    if v___x_491_ == 0 {
        ...
        v___x_492_ = 1;
        v___x_493_ = leanh::lean_box((v___x_492_) as usize);
        v___x_494_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
        leanh::lean_ctor_set(v___x_494_, 0, v_v_482_);
        leanh::lean_ctor_set(v___x_494_, 1, v___x_493_);
        v___x_495_ = l_List_elem___redArg(v___f_487_, v___x_494_, v_c_483_);
        return v___x_495_;
    } else {
        leanh::lean_dec_ref(v___f_487_);
        leanh::lean_dec(v_c_483_);
        leanh::lean_dec(v_v_482_);
        return v___x_491_;
    }
}
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___aux__1___redArg___boxed(
    mut v_v_496_: *mut leanh::LeanObject,
    mut v_c_497_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___aux__1(
    ...
    mut v_v_502_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___aux__1___boxed(
    ...
    mut v_v_507_: *mut leanh::LeanObject,
    mut v_c_508_: *mut leanh::LeanObject,
    mut v_inst_509_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_510_: u8 = 0;
    let mut v_r_511_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_r_511_ = leanh::lean_box((v_res_510_) as usize);
    return v_r_511_;
}
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___redArg(
    mut v_v_512_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___redArg___boxed(
    mut v_v_516_: *mut leanh::LeanObject,
    mut v_c_517_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq(
    ...
    mut v_v_522_: *mut leanh::LeanObject,
    mut v_c_523_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___boxed(
    ...
    mut v_v_527_: *mut leanh::LeanObject,
    mut v_c_528_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableMemClauseOfDecidableEq___aux__1___redArg(
    mut v_c_534_: *mut leanh::LeanObject,
    mut v_f_535_: *mut leanh::LeanObject,
    ...
    v___f_538_ = leanh::lean_obj_once(
        core::ptr::addr_of_mut!(
            l_Std_Sat_CNF_Clause_instDecidableMemOfDecidableEq___aux__1___redArg___closed__0
        ),
        core::ptr::addr_of_mut!(
    ...
    leanh::lean_closure_set(v___f_539_, 0, v___f_537_);
    leanh::lean_closure_set(v___f_539_, 1, v___f_538_);
    v___x_540_ =
        leanh::lean_alloc_closure(l_List_beq___boxed as *mut core::ffi::c_void, 4, 2);
    leanh::lean_closure_set(v___x_540_, 0, leanh::lean_box(0));
    leanh::lean_closure_set(v___x_540_, 1, v___f_539_);
...
pub unsafe fn l_Std_Sat_CNF_instDecidableMemClauseOfDecidableEq___aux__1(
    ...
    mut v_c_548_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableMemClauseOfDecidableEq___aux__1___boxed(
    ...
    mut v_c_553_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableMemClauseOfDecidableEq___redArg(
    mut v_c_558_: *mut leanh::LeanObject,
    mut v_f_559_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq___aux__1___redArg___lam__0___boxed(
    mut v_v_582_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq___aux__1___redArg(
    ...
    leanh::lean_closure_set(v___f_590_, 0, v_v_587_);
    leanh::lean_closure_set(v___f_590_, 1, v_inst_589_);
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq___aux__1___redArg___boxed(
    mut v_v_592_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq___aux__1(
    mut v_00_u03b1_597_: *mut leanh::LeanObject,
    mut v_v_598_: *mut leanh::LeanObject,
    mut v_f_599_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq___aux__1___boxed(
    ...
    mut v_v_603_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq___redArg___boxed(
    mut v_v_612_: *mut leanh::LeanObject,
    mut v_f_613_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq(
    ...
    mut v_v_618_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_instDecidableVarMemOfDecidableEq___boxed(
    ...
    mut v_v_623_: *mut leanh::LeanObject,
    ...
    v_r_627_ = leanh::lean_box((v_res_626_) as usize);
    return v_r_627_;
}
...
pub unsafe fn l_Std_Sat_CNF_instDecidableExistsVarMemOfDecidableEq___redArg___lam__0___boxed(
    mut v___x_632_: *mut leanh::LeanObject,
    ...
    v___x_86__boxed_634_ = (leanh::lean_unbox(v___x_632_) as u8);
...
pub unsafe fn l_Std_Sat_CNF_instDecidableExistsVarMemOfDecidableEq___redArg(
    mut v_f_656_: *mut leanh::LeanObject,
) -> u8 {
    ...
    if v___x_660_ == 0 {
        ...
        if v___x_660_ == 0 {
            ...
            v___x_661_ = leanh::lean_box((v___x_660_) as usize);
            ...
            leanh::lean_closure_set(v___f_662_, 0, v___x_661_);
            v___x_663_ = 0usize;
...
pub unsafe fn l_Std_Sat_CNF_instDecidableExistsVarMemOfDecidableEq___boxed(
    ...
    mut v_f_675_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_inst_676_);
    v_r_678_ = leanh::lean_box((v_res_677_) as usize);
    return v_r_678_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Sat_CNF_Basic(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Sat_CNF_Basic(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sat_CNF_Basic(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
