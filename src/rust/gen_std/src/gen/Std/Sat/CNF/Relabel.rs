...
pub unsafe fn l_List_mapTR_loop___at___00Std_Sat_CNF_Clause_relabel_spec__0___redArg(
    mut v_r_86_: *mut leanh::LeanObject,
    mut v_a_87_: *mut leanh::LeanObject,
    mut v_a_88_: *mut leanh::LeanObject,
    ...
    let mut v_fst_95_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_96_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_107_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_a_87_) == 0 {
                    leanh::lean_dec(v_r_86_);
                    v___x_89_ = l_List_reverse___redArg(v_a_88_);
                    return v___x_89_;
                } else {
                    v_head_90_ = leanh::lean_ctor_get(v_a_87_, 0);
                    v_tail_91_ = leanh::lean_ctor_get(v_a_87_, 1);
                    v_isSharedCheck_109_ = (!leanh::lean_is_exclusive(v_a_87_)) as u8;
            ...
            1 => {
                v_fst_95_ = leanh::lean_ctor_get(v_head_90_, 0);
                v_snd_96_ = leanh::lean_ctor_get(v_head_90_, 1);
                v_isSharedCheck_108_ = (!leanh::lean_is_exclusive(v_head_90_)) as u8;
                if v_isSharedCheck_108_ == 0 {
                    ...
                    leanh::lean_inc(v_snd_96_);
                    leanh::lean_inc(v_fst_95_);
                    leanh::lean_dec(v_head_90_);
            ...
            2 => {
                leanh::lean_inc(v_r_86_);
                v___x_100_ = leanh::lean_apply_1(v_r_86_, v_fst_95_);
                if v_isShared_99_ == 0 {
                    leanh::lean_ctor_set(v___x_98_, 0, v___x_100_);
                    v___x_102_ = v___x_98_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_107_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_107_, 0, v___x_100_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_107_, 1, v_snd_96_);
            ...
            3 => {
                if v_isShared_94_ == 0 {
                    leanh::lean_ctor_set(v___x_93_, 1, v_a_88_);
                    leanh::lean_ctor_set(v___x_93_, 0, v___x_102_);
                    v___x_104_ = v___x_93_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_106_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_106_, 0, v___x_102_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_106_, 1, v_a_88_);
...
pub unsafe fn l_Std_Sat_CNF_Clause_relabel___redArg(
    mut v_r_110_: *mut leanh::LeanObject,
    mut v_c_111_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Sat_CNF_Clause_relabel(
    ...
    mut v_00_u03b2_115_: *mut leanh::LeanObject,
    mut v_r_116_: *mut leanh::LeanObject,
    mut v_c_117_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_List_mapTR_loop___at___00Std_Sat_CNF_Clause_relabel_spec__0(
    ...
    mut v_r_121_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Std_Sat_CNF_relabel_spec__0___redArg(
    mut v_r_125_: *mut leanh::LeanObject,
    mut v_sz_126_: usize,
    mut v_i_127_: usize,
    mut v_bs_128_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_129_: u8 = 0;
    let mut v_v_130_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_131_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_bs_x27_132_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Std_Sat_CNF_relabel_spec__0___redArg___boxed(
    mut v_r_138_: *mut leanh::LeanObject,
    mut v_sz_139_: *mut leanh::LeanObject,
    mut v_i_140_: *mut leanh::LeanObject,
    mut v_bs_141_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_sz_boxed_142_: usize = 0;
    let mut v_i_boxed_143_: usize = 0;
    let mut v_res_144_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_sz_boxed_142_ = leanh::lean_unbox_usize(v_sz_139_);
    leanh::lean_dec(v_sz_139_);
    v_i_boxed_143_ = leanh::lean_unbox_usize(v_i_140_);
...
pub unsafe fn l_Std_Sat_CNF_relabel___redArg(
    ...
    mut v_f_146_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Std_Sat_CNF_relabel_spec__0(
    ...
    mut v_r_157_: *mut leanh::LeanObject,
    mut v_sz_158_: usize,
    mut v_i_159_: usize,
    mut v_bs_160_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Std_Sat_CNF_relabel_spec__0___boxed(
    ...
    mut v_r_164_: *mut leanh::LeanObject,
    mut v_sz_165_: *mut leanh::LeanObject,
    mut v_i_166_: *mut leanh::LeanObject,
    mut v_bs_167_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_sz_boxed_168_: usize = 0;
    let mut v_i_boxed_169_: usize = 0;
    let mut v_res_170_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_sz_boxed_168_ = leanh::lean_unbox_usize(v_sz_165_);
    leanh::lean_dec(v_sz_165_);
    v_i_boxed_169_ = leanh::lean_unbox_usize(v_i_166_);
    leanh::lean_dec(v_i_166_);
...
pub unsafe fn runtime_initialize_Std_Sat_CNF_Relabel(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Sat_CNF_Relabel(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sat_CNF_Relabel(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
