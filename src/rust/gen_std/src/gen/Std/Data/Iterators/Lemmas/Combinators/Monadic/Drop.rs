...
pub unsafe fn l___private_Std_Data_Iterators_Lemmas_Combinators_Monadic_Drop_0__Std_IterM_step__drop_match__3_splitter(
    ...
    mut v_00_u03b2_208_: *mut crate::leanh::LeanObject,
    mut v_inst_209_: *mut crate::leanh::LeanObject,
    mut v_it_210_: *mut crate::leanh::LeanObject,
    ...
    mut v_h__3_215_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    match crate::leanh::lean_obj_tag(v_x_212_) {
        0 => {
            ...
            crate::leanh::lean_dec(v_h__3_215_);
            crate::leanh::lean_dec(v_h__2_214_);
            v_it_216_ = crate::leanh::lean_ctor_get(v_x_212_, 0);
            crate::leanh::lean_inc(v_it_216_);
            v_out_217_ = crate::leanh::lean_ctor_get(v_x_212_, 1);
            crate::leanh::lean_inc(v_out_217_);
            crate::leanh::lean_dec_ref_known(v_x_212_, 2);
        ...
        1 => {
            ...
            v_it_219_ = crate::leanh::lean_ctor_get(v_x_212_, 0);
            crate::leanh::lean_inc(v_it_219_);
            crate::leanh::lean_dec_ref_known(v_x_212_, 1);
            v___x_220_ =
                crate::leanh::lean_apply_2(v_h__2_214_, v_it_219_, crate::leanh::lean_box(0));
            return v___x_220_;
        }
        _ => {
            ...
            crate::leanh::lean_dec(v_h__2_214_);
            crate::leanh::lean_dec(v_h__1_213_);
            v___x_221_ = crate::leanh::lean_apply_1(v_h__3_215_, crate::leanh::lean_box(0));
            return v___x_221_;
        }
    }
}
pub unsafe fn l___private_Std_Data_Iterators_Lemmas_Combinators_Monadic_Drop_0__Std_IterM_step__drop_match__3_splitter___boxed(
    ...
    mut v_it_226_: *mut crate::leanh::LeanObject,
    ...
    mut v_h__3_231_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_dec(v_it_226_);
...
pub unsafe fn l___private_Std_Data_Iterators_Lemmas_Combinators_Monadic_Drop_0__Std_IterM_step__drop_match__1_splitter(
    ...
    let mut v_zero_250_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_251_: u8 = 0;
    v_zero_250_ = crate::leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_251_ == 1 {
        ...
        v___x_252_ = crate::leanh::lean_apply_1(v_h__1_248_, crate::leanh::lean_box(0));
        return v___x_252_;
    } else {
        ...
        v___x_255_ = crate::leanh::lean_apply_2(v_h__2_249_, v_n_254_, crate::leanh::lean_box(0));
        return v___x_255_;
    }
}
