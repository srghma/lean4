...
pub unsafe fn l_Array_iterFromIdx___redArg(
    ...
    mut v_pos_16_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_17_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_17_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_17_, 0, v_l_15_);
    leanh::lean_ctor_set(v___x_17_, 1, v_pos_16_);
    return v___x_17_;
}
pub unsafe fn l_Array_iterFromIdx(
    mut v_00_u03b1_18_: *mut leanh::LeanObject,
    mut v_l_19_: *mut leanh::LeanObject,
    mut v_pos_20_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_21_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_21_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_21_, 0, v_l_19_);
    leanh::lean_ctor_set(v___x_21_, 1, v_pos_20_);
    return v___x_21_;
}
pub unsafe fn l_Array_iter___redArg(
    mut v_l_22_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_23_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_24_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_23_ = leanh::lean_unsigned_to_nat(0);
    v___x_24_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_24_, 0, v_l_22_);
    leanh::lean_ctor_set(v___x_24_, 1, v___x_23_);
    return v___x_24_;
}
pub unsafe fn l_Array_iter(
    mut v_00_u03b1_25_: *mut leanh::LeanObject,
    mut v_l_26_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_ctor_set(v___x_28_, 0, v_l_26_);
    leanh::lean_ctor_set(v___x_28_, 1, v___x_27_);
    return v___x_28_;
}
