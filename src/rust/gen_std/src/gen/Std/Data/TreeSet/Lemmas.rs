...
pub unsafe fn l_Std_TreeSet_Equiv_instTrans(
    mut v_00_u03b1_7_: *mut leanh::LeanObject,
    mut v_cmp_8_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_9_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_9_ = leanh::lean_box(0);
    return v___x_9_;
}
pub unsafe fn l_Std_TreeSet_Equiv_instTrans___boxed(
    mut v_00_u03b1_10_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_cmp_11_);
    return v_res_12_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Data_TreeSet_Lemmas(
    builtin: u8,
) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_TreeSet_Lemmas(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_TreeSet_Lemmas(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
