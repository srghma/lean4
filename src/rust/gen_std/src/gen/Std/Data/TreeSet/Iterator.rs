...
pub unsafe fn l_Std_TreeSet_iter___redArg(
    mut v_m_13_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_TreeSet_iter___redArg___boxed(
...
pub unsafe fn l_Std_TreeSet_iter(
    ...
    mut v_cmp_18_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_TreeSet_iter___boxed(
    ...
    mut v_cmp_22_: *mut leanh::LeanObject,
    mut v_m_23_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_24_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_24_ = l_Std_TreeSet_iter(v_00_u03b1_21_, v_cmp_22_, v_m_23_);
    leanh::lean_dec(v_m_23_);
    leanh::lean_dec_ref(v_cmp_22_);
    return v_res_24_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Data_TreeSet_Iterator(
    builtin: u8,
) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_TreeSet_Iterator(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_TreeSet_Iterator(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
