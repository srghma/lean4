...
pub unsafe fn l___private_Std_Data_String_ToNat_0__Break_runK_match__1_splitter(
    mut v_00_u03b1_24_: *mut leanh::LeanObject,
...
pub unsafe fn meta_initialize_Std_Data_String_ToNat(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_String_ToNat(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
