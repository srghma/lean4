...
// Imports: Std.Data.String.ToNat Std.Data.String.ToInt
use crate::r#gen::Std::Data::String::ToInt::{
    initialize_Std_Data_String_ToInt, runtime_initialize_Std_Data_String_ToInt,
};
use crate::r#gen::Std::Data::String::ToNat::{
    initialize_Std_Data_String_ToNat, runtime_initialize_Std_Data_String_ToNat,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Data_String(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_String(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_String(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
