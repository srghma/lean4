...
pub unsafe fn l_Std_DTreeMap_Raw_filterMap(
    ...
    mut v_f_46_: *mut leanh::LeanObject,
    mut v_t_47_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Raw_filterMap___boxed(
    ...
    mut v_00_u03b3_51_: *mut leanh::LeanObject,
    mut v_cmp_52_: *mut leanh::LeanObject,
    mut v_f_53_: *mut leanh::LeanObject,
    mut v_t_54_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_cmp_52_);
    return v_res_55_;
}
pub unsafe fn l_Std_DTreeMap_Raw_map___redArg(
    mut v_f_56_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_DTreeMap_Raw_map(
    mut v_00_u03b1_59_: *mut leanh::LeanObject,
    mut v_00_u03b2_60_: *mut leanh::LeanObject,
    mut v_00_u03b3_61_: *mut leanh::LeanObject,
    mut v_cmp_62_: *mut leanh::LeanObject,
    mut v_f_63_: *mut leanh::LeanObject,
    mut v_t_64_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Raw_map___boxed(
    ...
    mut v_00_u03b3_68_: *mut leanh::LeanObject,
    mut v_cmp_69_: *mut leanh::LeanObject,
    mut v_f_70_: *mut leanh::LeanObject,
