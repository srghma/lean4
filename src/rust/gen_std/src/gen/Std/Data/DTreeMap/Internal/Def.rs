...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_ctorIdx___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_x_120_) == 0 {
        ...
        v___x_122_ = crate::leanh::lean_unsigned_to_nat(1);
        return v___x_122_;
    }
}
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_ctorElim___redArg(
    ...
    mut v_k_134_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    if crate::leanh::lean_obj_tag(v_t_133_) == 0 {
        let mut v_size_135_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_k_136_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_v_137_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_l_138_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_r_139_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_140_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        v_size_135_ = crate::leanh::lean_ctor_get(v_t_133_, 0);
        crate::leanh::lean_inc(v_size_135_);
        v_k_136_ = crate::leanh::lean_ctor_get(v_t_133_, 1);
        crate::leanh::lean_inc(v_k_136_);
        v_v_137_ = crate::leanh::lean_ctor_get(v_t_133_, 2);
        crate::leanh::lean_inc(v_v_137_);
        v_l_138_ = crate::leanh::lean_ctor_get(v_t_133_, 3);
        crate::leanh::lean_inc(v_l_138_);
        v_r_139_ = crate::leanh::lean_ctor_get(v_t_133_, 4);
        crate::leanh::lean_inc(v_r_139_);
        crate::leanh::lean_dec_ref_known(v_t_133_, 5);
        v___x_140_ = crate::leanh::lean_apply_5(
            v_k_134_,
            v_size_135_,
            v_k_136_,
            v_v_137_,
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_ctorElim(
    ...
    mut v_motive_143_: *mut crate::leanh::LeanObject,
    mut v_ctorIdx_144_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_ctorElim___boxed(
    ...
    mut v_ctorIdx_152_: *mut crate::leanh::LeanObject,
    mut v_t_153_: *mut crate::leanh::LeanObject,
    mut v_h_154_: *mut crate::leanh::LeanObject,
    mut v_k_155_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_dec(v_ctorIdx_152_);
    return v_res_156_;
}
pub unsafe fn l_Std_DTreeMap_Internal_Impl_inner_elim___redArg(
    mut v_t_157_: *mut crate::leanh::LeanObject,
    mut v_inner_158_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_inner_elim(
    ...
    mut v_inner_165_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_leaf_elim___redArg(
    ...
    mut v_leaf_168_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_leaf_elim(
    ...
    mut v_motive_172_: *mut crate::leanh::LeanObject,
    mut v_t_173_: *mut crate::leanh::LeanObject,
    mut v_h_174_: *mut crate::leanh::LeanObject,
    mut v_leaf_175_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Internal_instInhabitedImpl_default(
    ...
    mut v_00_u03b2_178_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v___x_179_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_179_ = crate::leanh::lean_box(1);
    return v___x_179_;
}
...
pub unsafe fn _init_l_Std_DTreeMap_Internal_delta() -> *mut crate::leanh::LeanObject {
    let mut v___x_183_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_183_ = crate::leanh::lean_unsigned_to_nat(3);
    return v___x_183_;
}
pub unsafe fn _init_l_Std_DTreeMap_Internal_ratio() -> *mut crate::leanh::LeanObject {
    let mut v___x_184_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_184_ = crate::leanh::lean_unsigned_to_nat(2);
    return v___x_184_;
}
pub unsafe fn l_Std_DTreeMap_Internal_Impl_size___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_x_185_) == 0 {
        let mut v_size_186_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        v_size_186_ = crate::leanh::lean_ctor_get(v_x_185_, 0);
        crate::leanh::lean_inc(v_size_186_);
        return v_size_186_;
    } else {
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_size(
    ...
    if crate::leanh::lean_obj_tag(v_x_192_) == 0 {
        let mut v_size_193_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        v_size_193_ = crate::leanh::lean_ctor_get(v_x_192_, 0);
        crate::leanh::lean_inc(v_size_193_);
        return v_size_193_;
    } else {
        let mut v___x_194_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        v___x_194_ = crate::leanh::lean_unsigned_to_nat(0);
        return v___x_194_;
    }
}
pub unsafe fn l_Std_DTreeMap_Internal_Impl_size___boxed(
    mut v_00_u03b1_195_: *mut crate::leanh::LeanObject,
    mut v_00_u03b2_196_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_toListModel___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_x_199_) == 0 {
        let mut v_k_200_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_v_201_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_l_202_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        ...
        v_k_200_ = crate::leanh::lean_ctor_get(v_x_199_, 1);
        v_v_201_ = crate::leanh::lean_ctor_get(v_x_199_, 2);
        v_l_202_ = crate::leanh::lean_ctor_get(v_x_199_, 3);
        v_r_203_ = crate::leanh::lean_ctor_get(v_x_199_, 4);
        v___x_204_ = l_Std_DTreeMap_Internal_Impl_toListModel___redArg(v_l_202_);
        crate::leanh::lean_inc(v_v_201_);
        crate::leanh::lean_inc(v_k_200_);
        v___x_205_ = crate::leanh::lean_alloc_ctor(0, 2, (0) as u32);
        crate::leanh::lean_ctor_set(v___x_205_, 0, v_k_200_);
        crate::leanh::lean_ctor_set(v___x_205_, 1, v_v_201_);
        v___x_206_ = l_Std_DTreeMap_Internal_Impl_toListModel___redArg(v_r_203_);
        v___x_207_ = crate::leanh::lean_alloc_ctor(1, 2, (0) as u32);
        crate::leanh::lean_ctor_set(v___x_207_, 0, v___x_205_);
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_treeSize___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_x_220_) == 0 {
        let mut v_l_221_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        ...
        v_l_221_ = crate::leanh::lean_ctor_get(v_x_220_, 3);
        v_r_222_ = crate::leanh::lean_ctor_get(v_x_220_, 4);
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_treeSize___boxed(
    ...
    mut v_00_u03b2_236_: *mut crate::leanh::LeanObject,
...
pub unsafe fn runtime_initialize_Std_Data_DTreeMap_Internal_Def(
    ...
    crate::leanh::lean_mark_persistent(l_Std_DTreeMap_Internal_delta);
    l_Std_DTreeMap_Internal_ratio = _init_l_Std_DTreeMap_Internal_ratio();
    crate::leanh::lean_mark_persistent(l_Std_DTreeMap_Internal_ratio);
    return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
}
