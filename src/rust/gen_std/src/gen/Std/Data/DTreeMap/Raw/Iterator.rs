...
// Imports: Std.Data.DTreeMap.Internal.Zipper Std.Data.DTreeMap.Raw.Basic Init.Data.Iterators.Lemmas.Combinators.FilterMap
...
use crate::r#gen::Std::Data::DTreeMap::Internal::Zipper::{
    ...
    l_Std_DTreeMap_Internal_Zipper_iterOfTree___redArg,
...
pub unsafe fn l_Std_DTreeMap_Raw_iter___redArg(
    mut v_m_43_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_DTreeMap_Raw_iter___redArg___boxed(
    mut v_m_45_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_46_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_46_ = l_Std_DTreeMap_Raw_iter___redArg(v_m_45_);
    crate::leanh::lean_dec(v_m_45_);
    return v_res_46_;
}
pub unsafe fn l_Std_DTreeMap_Raw_iter(
    mut v_00_u03b1_47_: *mut crate::leanh::LeanObject,
    mut v_00_u03b2_48_: *mut crate::leanh::LeanObject,
    mut v_cmp_49_: *mut crate::leanh::LeanObject,
    mut v_m_50_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Raw_iter___boxed(
    ...
    v_res_56_ = l_Std_DTreeMap_Raw_iter(v_00_u03b1_52_, v_00_u03b2_53_, v_cmp_54_, v_m_55_);
    crate::leanh::lean_dec(v_m_55_);
    crate::leanh::lean_dec_ref(v_cmp_54_);
    return v_res_56_;
}
pub unsafe fn l_Std_DTreeMap_Raw_keysIter___redArg(
...
pub unsafe fn l_Std_DTreeMap_Raw_keysIter___redArg___boxed(
    mut v_m_59_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_60_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_60_ = l_Std_DTreeMap_Raw_keysIter___redArg(v_m_59_);
    crate::leanh::lean_dec(v_m_59_);
    return v_res_60_;
}
pub unsafe fn l_Std_DTreeMap_Raw_keysIter(
    mut v_00_u03b1_61_: *mut crate::leanh::LeanObject,
    mut v_00_u03b2_62_: *mut crate::leanh::LeanObject,
    mut v_cmp_63_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_DTreeMap_Raw_keysIter___boxed(
    ...
    v_res_70_ = l_Std_DTreeMap_Raw_keysIter(v_00_u03b1_66_, v_00_u03b2_67_, v_cmp_68_, v_m_69_);
    crate::leanh::lean_dec(v_m_69_);
    crate::leanh::lean_dec_ref(v_cmp_68_);
    return v_res_70_;
}
pub unsafe fn l_Std_DTreeMap_Raw_valuesIter___redArg(
    mut v_m_71_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Raw_valuesIter___redArg___boxed(
    mut v_m_73_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_74_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_74_ = l_Std_DTreeMap_Raw_valuesIter___redArg(v_m_73_);
    crate::leanh::lean_dec(v_m_73_);
    return v_res_74_;
}
pub unsafe fn l_Std_DTreeMap_Raw_valuesIter(
    mut v_00_u03b1_75_: *mut crate::leanh::LeanObject,
    mut v_00_u03b2_76_: *mut crate::leanh::LeanObject,
    mut v_cmp_77_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_DTreeMap_Raw_valuesIter___boxed(
    mut v_00_u03b1_80_: *mut crate::leanh::LeanObject,
    mut v_00_u03b2_81_: *mut crate::leanh::LeanObject,
    mut v_cmp_82_: *mut crate::leanh::LeanObject,
    mut v_m_83_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_84_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_84_ = l_Std_DTreeMap_Raw_valuesIter(v_00_u03b1_80_, v_00_u03b2_81_, v_cmp_82_, v_m_83_);
    crate::leanh::lean_dec(v_m_83_);
    crate::leanh::lean_dec_ref(v_cmp_82_);
    return v_res_84_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Data_DTreeMap_Raw_Iterator(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_DTreeMap_Raw_Iterator(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_DTreeMap_Raw_Iterator(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
