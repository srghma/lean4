...
// Imports: Init.Data.AC Std.Data.DTreeMap.Internal.Def Init.Omega Init.RCases
use crate::r#gen::Init::Data::AC::{initialize_Init_Data_AC, runtime_initialize_Init_Data_AC};
use crate::r#gen::Init::Omega::{initialize_Init_Omega, runtime_initialize_Init_Omega};
use crate::r#gen::Init::RCases::{initialize_Init_RCases, runtime_initialize_Init_RCases};
use crate::r#gen::Std::Data::DTreeMap::Internal::Def::{
    initialize_Std_Data_DTreeMap_Internal_Def, runtime_initialize_Std_Data_DTreeMap_Internal_Def,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Data_DTreeMap_Internal_Balanced(
    builtin: u8,
...
pub unsafe fn meta_initialize_Std_Data_DTreeMap_Internal_Balanced(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_DTreeMap_Internal_Balanced(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
