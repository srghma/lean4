...
// Imports: Std.Data.Iterators Std.Data.DHashMap.Iterator Std.Data.DHashMap.Basic Std.Data.DHashMap.Raw Std.Data.DHashMap.Iterator Init.Data.Iterators.Lemmas.Combinators Std.Data.DHashMap.Internal.Defs Std.Data.DHashMap.RawLemmas Std.Data.DHashMap.Lemmas
...
pub unsafe fn runtime_initialize_Std_Data_DHashMap_IteratorLemmas(
    builtin: u8,
...
pub unsafe fn meta_initialize_Std_Data_DHashMap_IteratorLemmas(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_DHashMap_IteratorLemmas(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
