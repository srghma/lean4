...
pub unsafe fn l_Std_HashMap_instDecidableEquivOfLawfulBEq___redArg___lam__0(
    ...
    mut v_k_49_: *mut leanh::LeanObject,
    mut v___y_50_: *mut leanh::LeanObject,
    mut v___y_51_: *mut leanh::LeanObject,
) -> u8 {
    let mut v___x_52_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_53_: u8 = 0;
    v___x_52_ = leanh::lean_apply_2(v_inst_48_, v___y_50_, v___y_51_);
    v___x_53_ = (leanh::lean_unbox(v___x_52_) as u8);
    return v___x_53_;
}
pub unsafe fn l_Std_HashMap_instDecidableEquivOfLawfulBEq___redArg___lam__0___boxed(
    ...
    mut v___y_57_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_HashMap_instDecidableEquivOfLawfulBEq___redArg(
    ...
    mut v_m_u2081_63_: *mut leanh::LeanObject,
    mut v_m_u2082_64_: *mut leanh::LeanObject,
) -> u8 {
    let mut v___f_65_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_this_66_: u8 = 0;
    v___f_65_ = leanh::lean_alloc_closure(
        l_Std_HashMap_instDecidableEquivOfLawfulBEq___redArg___lam__0___boxed
            as *mut core::ffi::c_void,
        4,
        1,
    );
    leanh::lean_closure_set(v___f_65_, 0, v_inst_62_);
...
pub unsafe fn l_Std_HashMap_instDecidableEquivOfLawfulBEq___redArg___boxed(
    ...
    mut v_m_u2081_70_: *mut leanh::LeanObject,
    mut v_m_u2082_71_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_HashMap_instDecidableEquivOfLawfulBEq(
    ...
    mut v_m_u2081_81_: *mut leanh::LeanObject,
    mut v_m_u2082_82_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_HashMap_instDecidableEquivOfLawfulBEq___boxed(
    ...
    mut v_m_u2081_91_: *mut leanh::LeanObject,
    mut v_m_u2082_92_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_93_: u8 = 0;
    let mut v_r_94_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_r_94_ = leanh::lean_box((v_res_93_) as usize);
    return v_r_94_;
}
