...
pub unsafe fn l_Std_Time_Database_defaultGetZoneRules(
    mut v_name_32_: *mut leanh::LeanObject,
...
pub unsafe fn _init_l_Std_Time_Database_defaultGetLocalZoneRules___closed__0() -> u64 {
    ...
    v___x_41_ = leanh::lean_unsigned_to_nat(2147483648);
...
pub unsafe fn _init_l_Std_Time_Database_defaultGetLocalZoneRules___closed__1() -> u64 {
    ...
    v___x_43_ = leanh::lean_uint64_once(
...
pub unsafe fn l_Std_Time_Database_defaultGetLocalZoneRules() -> *mut leanh::LeanObject {
        ...
        match state {
            0 => {
                ...
                if v___x_46_ == 0 {
                    ...
                    v___x_49_ = leanh::lean_uint64_once(
                    ...
                    if leanh::lean_obj_tag(v___x_50_) == 0 {
                        v_a_51_ = leanh::lean_ctor_get(v___x_50_, 0);
                        leanh::lean_inc(v_a_51_);
                        leanh::lean_dec_ref_known(v___x_50_, 1);
                        v___x_52_ = l_Std_Time_Database_Windows_getZoneRules(v_a_51_);
                        leanh::lean_dec(v_a_51_);
                        return v___x_52_;
                    } else {
                        v_a_53_ = leanh::lean_ctor_get(v___x_50_, 0);
                        v_isSharedCheck_60_ = (!leanh::lean_is_exclusive(v___x_50_)) as u8;
            ...
            1 => {
                if v_isShared_56_ == 0 {
                    ...
                    v_reuseFailAlloc_59_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_59_, 0, v_a_53_);
...
pub unsafe fn initialize_Std_Time_Zoned_Database(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
