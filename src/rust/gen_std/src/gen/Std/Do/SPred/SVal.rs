...
pub static mut l_Std_Do_SVal_instInhabitedStateTupleNil: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub unsafe fn _init_l_Std_Do_SVal_instInhabitedStateTupleNil() -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Do_SVal_instInhabitedStateTupleCons___redArg(
    ...
    v___x_160_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_160_, 0, v_inst_158_);
    leanh::lean_ctor_set(v___x_160_, 1, v_inst_159_);
    return v___x_160_;
}
pub unsafe fn l_Std_Do_SVal_instInhabitedStateTupleCons(
    mut v_00_u03c3_161_: *mut leanh::LeanObject,
    mut v_00_u03c3s_162_: *mut leanh::LeanObject,
    ...
    leanh::lean_ctor_set(v___x_165_, 0, v_inst_163_);
    leanh::lean_ctor_set(v___x_165_, 1, v_inst_164_);
    return v___x_165_;
}
pub unsafe fn l_Std_Do_SVal_instInhabitedStateTupleCons___boxed(
    mut v_00_u03c3_166_: *mut leanh::LeanObject,
    mut v_00_u03c3s_167_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_00_u03c3s_167_);
    return v_res_170_;
}
pub unsafe fn l_Std_Do_SVal_curry___redArg___lam__0(
    mut v___y_171_: *mut leanh::LeanObject,
    mut v_f_172_: *mut leanh::LeanObject,
    mut v_s_x27_173_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_174_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_175_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_174_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_174_, 0, v___y_171_);
    leanh::lean_ctor_set(v___x_174_, 1, v_s_x27_173_);
    v___x_175_ = leanh::lean_apply_1(v_f_172_, v___x_174_);
    return v___x_175_;
}
pub unsafe fn l_Std_Do_SVal_curry___redArg(
    mut v_00_u03c3s_176_: *mut leanh::LeanObject,
    mut v_f_177_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_00_u03c3s_176_) == 0 {
        ...
        v___x_179_ = leanh::lean_apply_1(v_f_177_, v___x_178_);
        return v___x_179_;
    } else {
        let mut v_tail_180_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___f_181_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_tail_180_ = leanh::lean_ctor_get(v_00_u03c3s_176_, 1);
        leanh::lean_inc(v_tail_180_);
        leanh::lean_dec_ref_known(v_00_u03c3s_176_, 2);
        v___f_181_ = leanh::lean_alloc_closure(
            l_Std_Do_SVal_curry___redArg___lam__1 as *mut core::ffi::c_void,
            3,
            2,
        );
        leanh::lean_closure_set(v___f_181_, 0, v_f_177_);
        leanh::lean_closure_set(v___f_181_, 1, v_tail_180_);
        return v___f_181_;
    }
}
pub unsafe fn l_Std_Do_SVal_curry___redArg___lam__1(
    mut v_f_182_: *mut leanh::LeanObject,
    mut v_tail_183_: *mut leanh::LeanObject,
    ...
    leanh::lean_closure_set(v___f_185_, 0, v___y_184_);
    leanh::lean_closure_set(v___f_185_, 1, v_f_182_);
...
pub unsafe fn l_Std_Do_SVal_curry(
    ...
    mut v_f_189_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Do_SVal_uncurry___redArg(
    mut v_00_u03c3s_191_: *mut leanh::LeanObject,
    ...
    let mut v_snd_196_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_197_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_00_u03c3s_191_) == 0 {
                    leanh::lean_dec(v_a_193_);
                    return v_f_192_;
                } else {
                    v_tail_194_ = leanh::lean_ctor_get(v_00_u03c3s_191_, 1);
                    v_fst_195_ = leanh::lean_ctor_get(v_a_193_, 0);
                    leanh::lean_inc(v_fst_195_);
                    v_snd_196_ = leanh::lean_ctor_get(v_a_193_, 1);
                    leanh::lean_inc(v_snd_196_);
                    leanh::lean_dec(v_a_193_);
                    v___x_197_ = leanh::lean_apply_1(v_f_192_, v_fst_195_);
...
pub unsafe fn l_Std_Do_SVal_uncurry___redArg___boxed(
    mut v_00_u03c3s_199_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Do_SVal_uncurry___boxed(
    ...
    mut v_00_u03c3s_209_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Std_Do_SPred_SVal_0__Std_Do_SVal_uncurry_match__3_splitter(
    ...
    mut v_00_u03c3s_222_: *mut leanh::LeanObject,
    mut v_f_223_: *mut leanh::LeanObject,
    mut v_h__1_224_: *mut leanh::LeanObject,
    mut v_h__2_225_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_00_u03c3s_222_) == 0 {
        let mut v___x_226_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_225_);
        v___x_226_ = leanh::lean_apply_1(v_h__1_224_, v_f_223_);
        return v___x_226_;
    } else {
        ...
        v_tail_227_ = leanh::lean_ctor_get(v_00_u03c3s_222_, 1);
        leanh::lean_inc(v_tail_227_);
        leanh::lean_dec_ref_known(v_00_u03c3s_222_, 2);
        v___x_228_ = leanh::lean_apply_3(
            v_h__2_225_,
            leanh::lean_box(0),
            v_tail_227_,
            v_f_223_,
...
pub unsafe fn l___private_Std_Do_SPred_SVal_0__Std_Do_SVal_uncurry_match__1_splitter___redArg(
    ...
    let mut v_snd_232_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_233_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_fst_231_ = leanh::lean_ctor_get(v_x_229_, 0);
    leanh::lean_inc(v_fst_231_);
    v_snd_232_ = leanh::lean_ctor_get(v_x_229_, 1);
    leanh::lean_inc(v_snd_232_);
    leanh::lean_dec_ref(v_x_229_);
    v___x_233_ = leanh::lean_apply_2(v_h__1_230_, v_fst_231_, v_snd_232_);
    return v___x_233_;
}
pub unsafe fn l___private_Std_Do_SPred_SVal_0__Std_Do_SVal_uncurry_match__1_splitter(
    mut v_head_234_: *mut leanh::LeanObject,
    mut v_tail_235_: *mut leanh::LeanObject,
    mut v_motive_236_: *mut leanh::LeanObject,
    mut v_x_237_: *mut leanh::LeanObject,
    mut v_h__1_238_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_fst_239_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_240_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_241_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_fst_239_ = leanh::lean_ctor_get(v_x_237_, 0);
    leanh::lean_inc(v_fst_239_);
    v_snd_240_ = leanh::lean_ctor_get(v_x_237_, 1);
    leanh::lean_inc(v_snd_240_);
    leanh::lean_dec_ref(v_x_237_);
    v___x_241_ = leanh::lean_apply_2(v_h__1_238_, v_fst_239_, v_snd_240_);
    return v___x_241_;
}
pub unsafe fn l___private_Std_Do_SPred_SVal_0__Std_Do_SVal_uncurry_match__1_splitter___boxed(
    mut v_head_242_: *mut leanh::LeanObject,
    mut v_tail_243_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Std_Do_SPred_SVal_0__Std_Do_SVal_curry_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_00_u03c3s_248_) == 0 {
        ...
        v_tail_253_ = leanh::lean_ctor_get(v_00_u03c3s_248_, 1);
        leanh::lean_inc(v_tail_253_);
        leanh::lean_dec_ref_known(v_00_u03c3s_248_, 2);
...
pub unsafe fn l___private_Std_Do_SPred_SVal_0__Std_Do_SVal_curry_match__1_splitter(
    ...
    mut v_00_u03c3s_257_: *mut leanh::LeanObject,
    mut v_f_258_: *mut leanh::LeanObject,
    mut v_h__1_259_: *mut leanh::LeanObject,
    mut v_h__2_260_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_00_u03c3s_257_) == 0 {
        let mut v___x_261_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_260_);
        v___x_261_ = leanh::lean_apply_1(v_h__1_259_, v_f_258_);
        return v___x_261_;
    } else {
        let mut v_tail_262_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_263_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_259_);
        v_tail_262_ = leanh::lean_ctor_get(v_00_u03c3s_257_, 1);
        leanh::lean_inc(v_tail_262_);
        leanh::lean_dec_ref_known(v_00_u03c3s_257_, 2);
        v___x_263_ = leanh::lean_apply_3(
            v_h__2_260_,
            leanh::lean_box(0),
            v_tail_262_,
            v_f_258_,
...
pub unsafe fn l_Std_Do_SVal_instInhabited___redArg(
    mut v_00_u03c3s_269_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Do_SVal_instInhabited(
    ...
    mut v_00_u03c3s_274_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Do_SVal_instGetTyCons___redArg___lam__0___boxed(
    ...
    leanh::lean_dec(v_s_279_);
    return v_res_281_;
}
pub unsafe fn l_Std_Do_SVal_instGetTyCons___redArg___lam__1(
    mut v_00_u03c3s_282_: *mut leanh::LeanObject,
    mut v_s_283_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_284_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_285_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_284_ = leanh::lean_alloc_closure(
        l_Std_Do_SVal_instGetTyCons___redArg___lam__0___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    leanh::lean_closure_set(v___f_284_, 0, v_s_283_);
    v___x_285_ = l_Std_Do_SVal_curry___redArg(v_00_u03c3s_282_, v___f_284_);
    return v___x_285_;
}
pub unsafe fn l_Std_Do_SVal_instGetTyCons___redArg(
    mut v_00_u03c3s_286_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_287_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_287_ = leanh::lean_alloc_closure(
        l_Std_Do_SVal_instGetTyCons___redArg___lam__1 as *mut core::ffi::c_void,
        2,
        1,
    );
    leanh::lean_closure_set(v___f_287_, 0, v_00_u03c3s_286_);
    return v___f_287_;
}
pub unsafe fn l_Std_Do_SVal_instGetTyCons(
    mut v_00_u03c3_288_: *mut leanh::LeanObject,
    mut v_00_u03c3s_289_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_closure_set(v___f_290_, 0, v_00_u03c3s_289_);
    return v___f_290_;
}
pub unsafe fn l_Std_Do_SVal_instGetTyCons__1___redArg(
    ...
    leanh::lean_closure_set(v___f_292_, 0, v_inst_291_);
    return v___f_292_;
}
pub unsafe fn l_Std_Do_SVal_instGetTyCons__1(
    mut v_00_u03c3_u2081_293_: *mut leanh::LeanObject,
    mut v_00_u03c3s_294_: *mut leanh::LeanObject,
    mut v_00_u03c3_u2082_295_: *mut leanh::LeanObject,
    mut v_inst_296_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_297_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_297_ = leanh::lean_alloc_closure(
        l_Std_Do_SVal_instInhabited___redArg___lam__0___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    leanh::lean_closure_set(v___f_297_, 0, v_inst_296_);
    return v___f_297_;
}
pub unsafe fn l_Std_Do_SVal_instGetTyCons__1___boxed(
    mut v_00_u03c3_u2081_298_: *mut leanh::LeanObject,
    mut v_00_u03c3s_299_: *mut leanh::LeanObject,
    mut v_00_u03c3_u2082_300_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Do_SVal_getThe___redArg___boxed(
    ...
    leanh::lean_dec(v_inst_304_);
    return v_res_305_;
}
pub unsafe fn l_Std_Do_SVal_getThe(
    mut v_00_u03c3s_306_: *mut leanh::LeanObject,
    mut v_00_u03c3_307_: *mut leanh::LeanObject,
    mut v_inst_308_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_inst_308_);
    return v_inst_308_;
}
pub unsafe fn l_Std_Do_SVal_getThe___boxed(
    mut v_00_u03c3s_309_: *mut leanh::LeanObject,
    mut v_00_u03c3_310_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_00_u03c3s_309_);
    return v_res_312_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Do_SPred_SVal(builtin: u8) -> *mut leanh::LeanObject {
    ...
    leanh::lean_mark_persistent(l_Std_Do_SVal_instInhabitedStateTupleNil);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
static mut _G_meta_initialized: bool = false;
pub unsafe fn meta_initialize_Std_Do_SPred_SVal(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Do_SPred_SVal(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
