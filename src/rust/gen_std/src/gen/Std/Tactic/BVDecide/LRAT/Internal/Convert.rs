...
static mut l_Std_Tactic_BVDecide_LRAT_Internal_CNF_lift___closed__0: *mut leanh::LeanObject =
...
static mut l_Array_filterMapM___at___00Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_spec__0___closed__0: *mut leanh::LeanObject = core::ptr::addr_of!(l_Array_filterMapM___at___00Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_spec__0___closed__0_value) as *mut leanh::LeanObject;
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_CNF_lift___lam__0___boxed(
    ...
    leanh::lean_dec(v_lit_130_);
    return v_res_131_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_CNF_lift(
    mut v_cnf_133_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_134_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cnf_135_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_CNF_Clause_convertLRAT_x27(
    ...
    mut v_clause_138_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Array_filterMapM___at___00Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_spec__0_spec__0(
    ...
    mut v_as_145_: *mut leanh::LeanObject,
    mut v_i_146_: usize,
    mut v_stop_147_: usize,
    mut v_b_148_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___y_150_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Array_filterMapM___at___00Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_spec__0_spec__0___boxed(
    ...
    mut v_as_159_: *mut leanh::LeanObject,
    mut v_i_160_: *mut leanh::LeanObject,
    mut v_stop_161_: *mut leanh::LeanObject,
    mut v_b_162_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_stop_boxed_164_ = leanh::lean_unbox_usize(v_stop_161_);
    leanh::lean_dec(v_stop_161_);
...
pub unsafe fn l_Array_filterMapM___at___00Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_spec__0(
    ...
    mut v_as_169_: *mut leanh::LeanObject,
    mut v_start_170_: *mut leanh::LeanObject,
    mut v_stop_171_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Array_filterMapM___at___00Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_spec__0___boxed(
    ...
    mut v_as_184_: *mut leanh::LeanObject,
    mut v_start_185_: *mut leanh::LeanObject,
    mut v_stop_186_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_187_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_187_ =
    ...
    leanh::lean_dec(v_stop_186_);
    leanh::lean_dec(v_start_185_);
    leanh::lean_dec_ref(v_as_184_);
    leanh::lean_dec(v_n_183_);
    return v_res_187_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27(
    mut v_n_188_: *mut leanh::LeanObject,
    mut v_clauses_189_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27___boxed(
    ...
    mut v_clauses_194_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_clauses_194_);
...
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Convert_0__Std_Tactic_BVDecide_LRAT_Internal_DefaultClause_ofArray_folder_match__6_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_acc_196_) == 0 {
        ...
        v_val_201_ = leanh::lean_ctor_get(v_acc_196_, 0);
        leanh::lean_inc(v_val_201_);
        leanh::lean_dec_ref_known(v_acc_196_, 1);
...
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Convert_0__Std_Tactic_BVDecide_LRAT_Internal_DefaultClause_ofArray_folder_match__6_splitter(
    ...
    if leanh::lean_obj_tag(v_acc_205_) == 0 {
        ...
        v___x_209_ = leanh::lean_apply_1(v_h__1_206_, v___x_208_);
        return v___x_209_;
    } else {
        ...
        v_val_210_ = leanh::lean_ctor_get(v_acc_205_, 0);
        leanh::lean_inc(v_val_210_);
        leanh::lean_dec_ref_known(v_acc_205_, 1);
        v___x_211_ = leanh::lean_apply_1(v_h__2_207_, v_val_210_);
        return v___x_211_;
    }
}
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Convert_0__Std_Tactic_BVDecide_LRAT_Internal_DefaultClause_ofArray_folder_match__6_splitter___boxed(
    mut v_n_212_: *mut leanh::LeanObject,
    mut v_motive_213_: *mut leanh::LeanObject,
    mut v_acc_214_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_n_212_);
    return v_res_217_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT(
    mut v_cnf_222_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lifted_223_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_lratCnf_227_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    leanh::lean_dec_ref(v_lifted_223_);
    ...
    leanh::lean_dec_ref(v_lratCnf_227_);
...
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Convert_0__Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_231_) == 0 {
        ...
        v___x_235_ = leanh::lean_apply_1(v_h__2_233_, v___x_234_);
        return v___x_235_;
    } else {
        ...
        v_val_236_ = leanh::lean_ctor_get(v_x_231_, 0);
        leanh::lean_inc(v_val_236_);
        leanh::lean_dec_ref_known(v_x_231_, 1);
        v___x_237_ = leanh::lean_apply_1(v_h__1_232_, v_val_236_);
        return v___x_237_;
    }
}
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Convert_0__Std_Tactic_BVDecide_LRAT_Internal_CNF_convertLRAT_x27_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_240_) == 0 {
        ...
        v___x_244_ = leanh::lean_apply_1(v_h__2_242_, v___x_243_);
        return v___x_244_;
    } else {
        ...
        v_val_245_ = leanh::lean_ctor_get(v_x_240_, 0);
        leanh::lean_inc(v_val_245_);
        leanh::lean_dec_ref_known(v_x_240_, 1);
        v___x_246_ = leanh::lean_apply_1(v_h__1_241_, v_val_245_);
        return v___x_246_;
    }
}
