...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate_go___redArg(
    ...
    let mut v_s_96_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate_go___redArg___boxed(
    ...
    mut v_input_101_: *mut leanh::LeanObject,
    mut v_curr_102_: *mut leanh::LeanObject,
    mut v_s_103_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_input_101_);
    leanh::lean_dec(v_n_100_);
    return v_res_104_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate_go(
    mut v_00_u03b1_105_: *mut leanh::LeanObject,
    mut v_inst_106_: *mut leanh::LeanObject,
    mut v_inst_107_: *mut leanh::LeanObject,
    mut v_aig_108_: *mut leanh::LeanObject,
    mut v_w_109_: *mut leanh::LeanObject,
    mut v_n_110_: *mut leanh::LeanObject,
    mut v_input_111_: *mut leanh::LeanObject,
    mut v_curr_112_: *mut leanh::LeanObject,
    mut v_hcurr_113_: *mut leanh::LeanObject,
    mut v_s_114_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate_go___boxed(
    ...
    mut v_aig_119_: *mut leanh::LeanObject,
    mut v_w_120_: *mut leanh::LeanObject,
    mut v_n_121_: *mut leanh::LeanObject,
    mut v_input_122_: *mut leanh::LeanObject,
    mut v_curr_123_: *mut leanh::LeanObject,
    mut v_hcurr_124_: *mut leanh::LeanObject,
    mut v_s_125_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_input_122_);
    leanh::lean_dec(v_n_121_);
    leanh::lean_dec(v_w_120_);
    leanh::lean_dec_ref(v_aig_119_);
    leanh::lean_dec_ref(v_inst_118_);
    leanh::lean_dec_ref(v_inst_117_);
    return v_res_126_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate___redArg(
    mut v_newWidth_127_: *mut leanh::LeanObject,
    mut v_aig_128_: *mut leanh::LeanObject,
    mut v_target_129_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_n_130_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_inner_131_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_132_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_133_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ref_134_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_135_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_n_130_ = leanh::lean_ctor_get(v_target_129_, 1);
    v_inner_131_ = leanh::lean_ctor_get(v_target_129_, 2);
    v___x_132_ = leanh::lean_unsigned_to_nat(0);
    ...
    v___x_135_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_135_, 0, v_aig_128_);
    leanh::lean_ctor_set(v___x_135_, 1, v_ref_134_);
    return v___x_135_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate___redArg___boxed(
    mut v_newWidth_136_: *mut leanh::LeanObject,
    mut v_aig_137_: *mut leanh::LeanObject,
    mut v_target_138_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_target_138_);
    leanh::lean_dec(v_newWidth_136_);
    return v_res_139_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate(
    ...
    mut v_newWidth_143_: *mut leanh::LeanObject,
    mut v_aig_144_: *mut leanh::LeanObject,
    mut v_target_145_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate___boxed(
    ...
    mut v_newWidth_150_: *mut leanh::LeanObject,
    mut v_aig_151_: *mut leanh::LeanObject,
    mut v_target_152_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_target_152_);
    leanh::lean_dec(v_newWidth_150_);
    leanh::lean_dec_ref(v_inst_149_);
    leanh::lean_dec_ref(v_inst_148_);
    return v_res_153_;
}
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Replicate_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate_match__1_splitter___redArg(
    mut v_target_154_: *mut leanh::LeanObject,
    mut v_h__1_155_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_w_156_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_157_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_inner_158_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_159_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_w_156_ = leanh::lean_ctor_get(v_target_154_, 0);
    leanh::lean_inc(v_w_156_);
    v_n_157_ = leanh::lean_ctor_get(v_target_154_, 1);
    leanh::lean_inc(v_n_157_);
    v_inner_158_ = leanh::lean_ctor_get(v_target_154_, 2);
    leanh::lean_inc_ref(v_inner_158_);
    leanh::lean_dec_ref(v_target_154_);
    v___x_159_ = leanh::lean_apply_4(
        v_h__1_155_,
        v_w_156_,
        v_n_157_,
        v_inner_158_,
...
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Replicate_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate_match__1_splitter(
    ...
    mut v_newWidth_163_: *mut leanh::LeanObject,
    ...
    let mut v_w_168_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_169_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_inner_170_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_171_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_w_168_ = leanh::lean_ctor_get(v_target_166_, 0);
    leanh::lean_inc(v_w_168_);
    v_n_169_ = leanh::lean_ctor_get(v_target_166_, 1);
    leanh::lean_inc(v_n_169_);
    v_inner_170_ = leanh::lean_ctor_get(v_target_166_, 2);
    leanh::lean_inc_ref(v_inner_170_);
    leanh::lean_dec_ref(v_target_166_);
    v___x_171_ = leanh::lean_apply_4(
        v_h__1_167_,
        v_w_168_,
        v_n_169_,
        v_inner_170_,
...
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Replicate_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastReplicate_match__1_splitter___boxed(
    ...
    mut v_target_178_: *mut leanh::LeanObject,
