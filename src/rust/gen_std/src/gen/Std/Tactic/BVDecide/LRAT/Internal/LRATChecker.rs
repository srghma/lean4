...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_ctorIdx(
    ...
    match v_x_171_ {
        ...
        1 => {
            ...
            v___x_173_ = leanh::lean_unsigned_to_nat(1);
            return v___x_173_;
        }
        _ => {
            let mut v___x_174_: *mut leanh::LeanObject = core::ptr::null_mut();
            v___x_174_ = leanh::lean_unsigned_to_nat(2);
            return v___x_174_;
        }
    }
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_ctorIdx___boxed(
    ...
    v_x_boxed_176_ = (leanh::lean_unbox(v_x_175_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_toCtorIdx___boxed(
    ...
    v_x_4__boxed_181_ = (leanh::lean_unbox(v_x_180_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_success_elim___redArg___boxed(
    ...
    leanh::lean_dec(v_success_199_);
    return v_res_200_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_success_elim(
    mut v_motive_201_: *mut leanh::LeanObject,
    mut v_t_202_: u8,
    mut v_h_203_: *mut leanh::LeanObject,
    mut v_success_204_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_success_204_);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_success_elim___boxed(
    ...
    mut v_t_206_: *mut leanh::LeanObject,
    mut v_h_207_: *mut leanh::LeanObject,
    mut v_success_208_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_209_: u8 = 0;
    let mut v_res_210_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_209_ = (leanh::lean_unbox(v_t_206_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_outOfProof_elim___redArg___boxed(
    ...
    leanh::lean_dec(v_outOfProof_212_);
    return v_res_213_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_outOfProof_elim(
    mut v_motive_214_: *mut leanh::LeanObject,
    mut v_t_215_: u8,
    mut v_h_216_: *mut leanh::LeanObject,
    mut v_outOfProof_217_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_outOfProof_217_);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_outOfProof_elim___boxed(
    ...
    mut v_t_219_: *mut leanh::LeanObject,
    mut v_h_220_: *mut leanh::LeanObject,
    mut v_outOfProof_221_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_222_: u8 = 0;
    let mut v_res_223_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_222_ = (leanh::lean_unbox(v_t_219_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_rupFailure_elim___redArg___boxed(
    ...
    leanh::lean_dec(v_rupFailure_225_);
    return v_res_226_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_rupFailure_elim(
    ...
    mut v_rupFailure_230_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_rupFailure_230_);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_rupFailure_elim___boxed(
    ...
    mut v_t_232_: *mut leanh::LeanObject,
    mut v_h_233_: *mut leanh::LeanObject,
    mut v_rupFailure_234_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_235_: u8 = 0;
    let mut v_res_236_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_235_ = (leanh::lean_unbox(v_t_232_) as u8);
    ...
    leanh::lean_dec(v_rupFailure_234_);
    return v_res_236_;
}
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_ofNat(
    ...
    if v___x_241_ == 0 {
        ...
        v___x_242_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Result_ofNat___boxed(
    ...
    let mut v_r_249_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_248_ = l_Std_Tactic_BVDecide_LRAT_Internal_Result_ofNat(v_n_247_);
    leanh::lean_dec(v_n_247_);
    v_r_249_ = leanh::lean_box((v_res_248_) as usize);
    return v_r_249_;
}
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_instDecidableEqResult___boxed(
    ...
    mut v_y_256_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_x_13__boxed_257_ = (leanh::lean_unbox(v_x_255_) as u8);
    v_y_14__boxed_258_ = (leanh::lean_unbox(v_y_256_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_instToStringResult___lam__0___boxed(
    ...
    v_x_36__boxed_269_ = (leanh::lean_unbox(v_x_268_) as u8);
    v_res_270_ =
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_lratChecker___redArg(
    ...
    mut v_f_275_: *mut leanh::LeanObject,
    mut v_prf_276_: *mut leanh::LeanObject,
) -> u8 {
    let mut v___x_277_: u8 = 0;
    let mut v_head_278_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rupHints_279_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_performRupAdd_280_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_empty_281_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_282_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_283_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_c_288_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rupHints_289_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_performRupAdd_290_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_291_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_292_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_293_: u8 = 0;
    let mut v___x_294_: u8 = 0;
    let mut v_fst_295_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_297_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_c_298_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_pivot_299_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rupHints_300_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ratHints_301_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_performRatAdd_302_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_fst_307_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_309_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ids_310_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_delete_311_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_312_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_prf_276_) == 0 {
                    leanh::lean_dec(v_f_275_);
                    leanh::lean_dec_ref(v_inst_274_);
                    leanh::lean_dec_ref(v_inst_273_);
                    v___x_277_ = 1;
                    return v___x_277_;
                } else {
                    v_head_278_ = leanh::lean_ctor_get(v_prf_276_, 0);
                    leanh::lean_inc(v_head_278_);
                    match leanh::lean_obj_tag(v_head_278_) {
                        0 => {
                            leanh::lean_dec_ref_known(v_prf_276_, 2);
                            v_rupHints_279_ = leanh::lean_ctor_get(v_head_278_, 1);
                            leanh::lean_inc_ref(v_rupHints_279_);
                            leanh::lean_dec_ref_known(v_head_278_, 2);
                            v_performRupAdd_280_ = leanh::lean_ctor_get(v_inst_274_, 4);
                            leanh::lean_inc_ref(v_performRupAdd_280_);
                            leanh::lean_dec_ref(v_inst_274_);
                            v_empty_281_ = leanh::lean_ctor_get(v_inst_273_, 2);
                            leanh::lean_inc(v_empty_281_);
                            leanh::lean_dec_ref(v_inst_273_);
                            ...
                            v_snd_283_ = leanh::lean_ctor_get(v___x_282_, 1);
                            leanh::lean_inc(v_snd_283_);
                            leanh::lean_dec_ref(v___x_282_);
                            v___x_284_ = (leanh::lean_unbox(v_snd_283_) as u8);
                            leanh::lean_dec(v_snd_283_);
                            if v___x_284_ == 0 {
                                v___x_285_ = 2;
                                return v___x_285_;
                            } else {
                        ...
                        1 => {
                            v_tail_287_ = leanh::lean_ctor_get(v_prf_276_, 1);
                            leanh::lean_inc(v_tail_287_);
                            leanh::lean_dec_ref_known(v_prf_276_, 2);
                            v_c_288_ = leanh::lean_ctor_get(v_head_278_, 1);
                            leanh::lean_inc(v_c_288_);
                            v_rupHints_289_ = leanh::lean_ctor_get(v_head_278_, 2);
                            leanh::lean_inc_ref(v_rupHints_289_);
                            leanh::lean_dec_ref_known(v_head_278_, 3);
                            v_performRupAdd_290_ = leanh::lean_ctor_get(v_inst_274_, 4);
                            leanh::lean_inc_ref(v_performRupAdd_290_);
                            ...
                            v_snd_292_ = leanh::lean_ctor_get(v___x_291_, 1);
                            leanh::lean_inc(v_snd_292_);
                            v___x_293_ = (leanh::lean_unbox(v_snd_292_) as u8);
                            leanh::lean_dec(v_snd_292_);
                            if v___x_293_ == 0 {
                                leanh::lean_dec_ref(v___x_291_);
                                leanh::lean_dec(v_tail_287_);
                                leanh::lean_dec_ref(v_inst_274_);
                                leanh::lean_dec_ref(v_inst_273_);
                                v___x_294_ = 2;
                                return v___x_294_;
                            } else {
                                v_fst_295_ = leanh::lean_ctor_get(v___x_291_, 0);
                                leanh::lean_inc(v_fst_295_);
                                leanh::lean_dec_ref(v___x_291_);
                                v_f_275_ = v_fst_295_;
                        ...
                        2 => {
                            v_tail_297_ = leanh::lean_ctor_get(v_prf_276_, 1);
                            leanh::lean_inc(v_tail_297_);
                            leanh::lean_dec_ref_known(v_prf_276_, 2);
                            v_c_298_ = leanh::lean_ctor_get(v_head_278_, 1);
                            leanh::lean_inc(v_c_298_);
                            v_pivot_299_ = leanh::lean_ctor_get(v_head_278_, 2);
                            leanh::lean_inc_ref(v_pivot_299_);
                            v_rupHints_300_ = leanh::lean_ctor_get(v_head_278_, 3);
                            leanh::lean_inc_ref(v_rupHints_300_);
                            v_ratHints_301_ = leanh::lean_ctor_get(v_head_278_, 4);
                            leanh::lean_inc_ref(v_ratHints_301_);
                            leanh::lean_dec_ref_known(v_head_278_, 5);
                            v_performRatAdd_302_ = leanh::lean_ctor_get(v_inst_274_, 5);
                            leanh::lean_inc_ref(v_performRatAdd_302_);
                            v___x_303_ = leanh::lean_apply_5(
                            ...
                            v_snd_304_ = leanh::lean_ctor_get(v___x_303_, 1);
                            leanh::lean_inc(v_snd_304_);
                            v___x_305_ = (leanh::lean_unbox(v_snd_304_) as u8);
                            leanh::lean_dec(v_snd_304_);
                            if v___x_305_ == 0 {
                                leanh::lean_dec_ref(v___x_303_);
                                leanh::lean_dec(v_tail_297_);
                                leanh::lean_dec_ref(v_inst_274_);
                                leanh::lean_dec_ref(v_inst_273_);
                                v___x_306_ = 2;
                                return v___x_306_;
                            } else {
                                v_fst_307_ = leanh::lean_ctor_get(v___x_303_, 0);
                                leanh::lean_inc(v_fst_307_);
                                leanh::lean_dec_ref(v___x_303_);
                                v_f_275_ = v_fst_307_;
                        ...
                        _ => {
                            v_tail_309_ = leanh::lean_ctor_get(v_prf_276_, 1);
                            leanh::lean_inc(v_tail_309_);
                            leanh::lean_dec_ref_known(v_prf_276_, 2);
                            v_ids_310_ = leanh::lean_ctor_get(v_head_278_, 0);
                            leanh::lean_inc_ref(v_ids_310_);
                            leanh::lean_dec_ref_known(v_head_278_, 1);
                            v_delete_311_ = leanh::lean_ctor_get(v_inst_274_, 3);
                            leanh::lean_inc(v_delete_311_);
                            v___x_312_ =
                                leanh::lean_apply_2(v_delete_311_, v_f_275_, v_ids_310_);
                            v_f_275_ = v___x_312_;
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_lratChecker___redArg___boxed(
    ...
    mut v_prf_317_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_lratChecker(
    ...
    mut v_prf_328_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_lratChecker___boxed(
    ...
    mut v_00_u03c3_332_: *mut leanh::LeanObject,
    ...
    mut v_prf_338_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
