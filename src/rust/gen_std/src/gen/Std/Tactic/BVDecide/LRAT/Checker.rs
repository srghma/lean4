...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_check(
    mut v_lratProof_14_: *mut leanh::LeanObject,
    mut v_cnf_15_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_internalFormula_16_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    leanh::lean_dec_ref(v_cnf_15_);
    v___x_18_ = leanh::lean_unsigned_to_nat(1);
    v___x_19_ = lean_nat_add(v___x_17_, v___x_18_);
    leanh::lean_dec(v___x_17_);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_check___boxed(
    mut v_lratProof_23_: *mut leanh::LeanObject,
    mut v_cnf_24_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_lratProof_23_);
