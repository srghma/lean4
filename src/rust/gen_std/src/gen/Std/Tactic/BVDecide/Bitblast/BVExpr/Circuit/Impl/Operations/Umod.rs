...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUmod___redArg(
    ...
    mut v_aig_52_: *mut leanh::LeanObject,
    mut v_input_53_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lhs_54_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_55_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_zero_61_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_63_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_64_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_65_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ref_66_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_67_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_68_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_gate_73_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_invert_74_: u8 = 0;
    let mut v___x_76_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_77_: u8 = 0;
    let mut v_discr_79_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_81_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_82_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_reuseFailAlloc_83_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_reuseFailAlloc_84_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_85_: u8 = 0;
    let mut v_isSharedCheck_86_: u8 = 0;
    let mut v_unused_87_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_lhs_54_ = leanh::lean_ctor_get(v_input_53_, 0);
                v_rhs_55_ = leanh::lean_ctor_get(v_input_53_, 1);
                v_isSharedCheck_89_ = (!leanh::lean_is_exclusive(v_input_53_)) as u8;
                if v_isSharedCheck_89_ == 0 {
                    ...
                    leanh::lean_inc(v_rhs_55_);
                    leanh::lean_inc(v_lhs_54_);
                    leanh::lean_dec(v_input_53_);
            ...
            1 => {
                ...
                leanh::lean_inc_ref(v_zero_61_);
                leanh::lean_inc_ref(v_rhs_55_);
                if v_isShared_58_ == 0 {
                    leanh::lean_ctor_set(v___x_57_, 1, v_zero_61_);
                    leanh::lean_ctor_set(v___x_57_, 0, v_rhs_55_);
                    v___x_63_ = v___x_57_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_88_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_88_, 0, v_rhs_55_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_88_, 1, v_zero_61_);
            ...
            2 => {
                leanh::lean_inc_ref_n(v_inst_50_, 2);
                leanh::lean_inc_ref_n(v_inst_49_, 2);
                v_res_64_ = l_Std_Tactic_BVDecide_BVPred_mkEq___redArg(
                    v_inst_49_, v_inst_50_, v_w_51_, v_aig_52_, v___x_63_,
                );
                leanh::lean_dec_ref(v___x_63_);
                v_aig_65_ = leanh::lean_ctor_get(v_res_64_, 0);
                leanh::lean_inc_ref(v_aig_65_);
                v_ref_66_ = leanh::lean_ctor_get(v_res_64_, 1);
                leanh::lean_inc_ref(v_ref_66_);
                leanh::lean_dec_ref(v_res_64_);
                leanh::lean_inc_ref(v_zero_61_);
                leanh::lean_inc(v_w_51_);
                ...
                v_aig_68_ = leanh::lean_ctor_get(v_res_67_, 0);
                v_r_69_ = leanh::lean_ctor_get(v_res_67_, 2);
                v_isSharedCheck_86_ = (!leanh::lean_is_exclusive(v_res_67_)) as u8;
                if v_isSharedCheck_86_ == 0 {
                    v_unused_87_ = leanh::lean_ctor_get(v_res_67_, 1);
                    leanh::lean_dec(v_unused_87_);
                    v___x_71_ = v_res_67_;
                    v_isShared_72_ = v_isSharedCheck_86_;
                    state = 3;
                    continue;
                } else {
                    leanh::lean_inc(v_r_69_);
                    leanh::lean_inc(v_aig_68_);
                    leanh::lean_dec(v_res_67_);
            ...
            3 => {
                v_gate_73_ = leanh::lean_ctor_get(v_ref_66_, 0);
                v_invert_74_ = leanh::lean_ctor_get_uint8(
                    v_ref_66_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                v_isSharedCheck_85_ = (!leanh::lean_is_exclusive(v_ref_66_)) as u8;
                if v_isSharedCheck_85_ == 0 {
                    ...
                    leanh::lean_inc(v_gate_73_);
                    leanh::lean_dec(v_ref_66_);
            ...
            4 => {
                if v_isShared_77_ == 0 {
                    ...
                    v_reuseFailAlloc_84_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_84_, 0, v_gate_73_);
            ...
            5 => {
                if v_isShared_72_ == 0 {
                    leanh::lean_ctor_set(v___x_71_, 1, v_lhs_54_);
                    leanh::lean_ctor_set(v___x_71_, 0, v_discr_79_);
                    v___x_81_ = v___x_71_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_83_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_83_, 0, v_discr_79_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_83_, 1, v_lhs_54_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_83_, 2, v_r_69_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUmod(
    ...
    mut v_w_93_: *mut leanh::LeanObject,
    mut v_aig_94_: *mut leanh::LeanObject,
    mut v_input_95_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
