...
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___closed__0_once: leanh::LeanOnceCell = leanh::LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___closed__0:
    *mut leanh::LeanObject = core::ptr::null_mut();
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___closed__1_once: leanh::LeanOnceCell = leanh::LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg(
    mut v_w_231_: *mut leanh::LeanObject,
    mut v_aig_232_: *mut leanh::LeanObject,
    mut v_input_233_: *mut leanh::LeanObject,
    mut v_distance_234_: *mut leanh::LeanObject,
    mut v_curr_235_: *mut leanh::LeanObject,
    mut v_s_236_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_gate_238_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_246_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_252_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_261_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                ...
                if v___x_248_ == 0 {
                    leanh::lean_dec(v_curr_235_);
                    v___x_249_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v___x_249_, 0, v_aig_232_);
                    leanh::lean_ctor_set(v___x_249_, 1, v_s_236_);
                    return v___x_249_;
                } else {
                    ...
                    if v___x_250_ == 0 {
                        ...
                        v___x_258_ = leanh::lean_unsigned_to_nat(1);
            ...
            1 => {
                v___x_240_ = leanh::lean_unsigned_to_nat(1);
                v___x_241_ = lean_nat_add(v_curr_235_, v___x_240_);
                leanh::lean_dec(v_curr_235_);
                v___x_242_ = leanh::lean_unsigned_to_nat(2);
                v___x_243_ = lean_nat_mul(v_gate_238_, v___x_242_);
                leanh::lean_dec(v_gate_238_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___boxed(
    ...
    mut v_input_265_: *mut leanh::LeanObject,
    mut v_distance_266_: *mut leanh::LeanObject,
    mut v_curr_267_: *mut leanh::LeanObject,
    mut v_s_268_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_distance_266_);
    leanh::lean_dec_ref(v_input_265_);
    leanh::lean_dec(v_w_263_);
    return v_res_269_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go(
    ...
    mut v_w_273_: *mut leanh::LeanObject,
    mut v_aig_274_: *mut leanh::LeanObject,
    mut v_input_275_: *mut leanh::LeanObject,
    mut v_distance_276_: *mut leanh::LeanObject,
    mut v_curr_277_: *mut leanh::LeanObject,
    mut v_hcurr_278_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___boxed(
    ...
    mut v_w_284_: *mut leanh::LeanObject,
    mut v_aig_285_: *mut leanh::LeanObject,
    mut v_input_286_: *mut leanh::LeanObject,
    mut v_distance_287_: *mut leanh::LeanObject,
    mut v_curr_288_: *mut leanh::LeanObject,
    mut v_hcurr_289_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_distance_287_);
    leanh::lean_dec_ref(v_input_286_);
    leanh::lean_dec(v_w_284_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst___redArg(
    ...
    mut v_aig_293_: *mut leanh::LeanObject,
    mut v_target_294_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_vec_295_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_distance_296_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_vec_295_ = leanh::lean_ctor_get(v_target_294_, 0);
    v_distance_296_ = leanh::lean_ctor_get(v_target_294_, 1);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst___redArg___boxed(
    mut v_w_300_: *mut leanh::LeanObject,
    mut v_aig_301_: *mut leanh::LeanObject,
    mut v_target_302_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_target_302_);
    leanh::lean_dec(v_w_300_);
    return v_res_303_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst(
    ...
    mut v_w_307_: *mut leanh::LeanObject,
    mut v_aig_308_: *mut leanh::LeanObject,
    mut v_target_309_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift___redArg(
    ...
    mut v_w_320_: *mut leanh::LeanObject,
    mut v_aig_321_: *mut leanh::LeanObject,
    mut v_target_322_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_n_323_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lhs_324_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_325_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_pow_326_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_333_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vec_334_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_339_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_n_323_ = leanh::lean_ctor_get(v_target_322_, 0);
                v_lhs_324_ = leanh::lean_ctor_get(v_target_322_, 1);
                v_rhs_325_ = leanh::lean_ctor_get(v_target_322_, 2);
                v_pow_326_ = leanh::lean_ctor_get(v_target_322_, 3);
                v___x_327_ = lean_nat_dec_lt(v_pow_326_, v_n_323_);
                if v___x_327_ == 0 {
                    leanh::lean_dec_ref(v_inst_319_);
                    leanh::lean_dec_ref(v_inst_318_);
                    leanh::lean_inc_ref(v_lhs_324_);
                    v___x_328_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v___x_328_, 0, v_aig_321_);
                    leanh::lean_ctor_set(v___x_328_, 1, v_lhs_324_);
                    return v___x_328_;
                } else {
                    ...
                    leanh::lean_ctor_set(v___x_331_, 0, v_lhs_324_);
                    ...
                    leanh::lean_dec_ref_known(v___x_331_, 2);
                    v_aig_333_ = leanh::lean_ctor_get(v_res_332_, 0);
                    leanh::lean_inc_ref(v_aig_333_);
                    v_vec_334_ = leanh::lean_ctor_get(v_res_332_, 1);
                    leanh::lean_inc_ref(v_vec_334_);
                    leanh::lean_dec_ref(v_res_332_);
                    v_ref_339_ = lean_array_fget_borrowed(v_rhs_325_, v_pow_326_);
                    v___x_340_ = leanh::lean_unsigned_to_nat(1);
                    v___x_341_ = lean_nat_shiftr(v_ref_339_, v___x_340_);
                    v___x_342_ = lean_nat_land(v___x_340_, v_ref_339_);
                    v___x_343_ = leanh::lean_unsigned_to_nat(0);
                    v___x_344_ = lean_nat_dec_eq(v___x_342_, v___x_343_);
                    leanh::lean_dec(v___x_342_);
                    if v___x_344_ == 0 {
                        v___x_345_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                        leanh::lean_ctor_set(v___x_345_, 0, v___x_341_);
                        ...
                        v___x_346_ = 0;
                        v___x_347_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                        leanh::lean_ctor_set(v___x_347_, 0, v___x_341_);
                        leanh::lean_ctor_set_uint8(
                            v___x_347_,
                            (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                            v___x_346_,
            ...
            1 => {
                leanh::lean_inc_ref(v_lhs_324_);
                v___x_337_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                leanh::lean_ctor_set(v___x_337_, 0, v___y_336_);
                leanh::lean_ctor_set(v___x_337_, 1, v_vec_334_);
                leanh::lean_ctor_set(v___x_337_, 2, v_lhs_324_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift___redArg___boxed(
    ...
    mut v_w_350_: *mut leanh::LeanObject,
    mut v_aig_351_: *mut leanh::LeanObject,
    mut v_target_352_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_target_352_);
    leanh::lean_dec(v_w_350_);
    return v_res_353_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift(
    ...
    mut v_w_357_: *mut leanh::LeanObject,
    mut v_aig_358_: *mut leanh::LeanObject,
    mut v_target_359_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift___boxed(
    ...
    mut v_aig_365_: *mut leanh::LeanObject,
    mut v_target_366_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_target_366_);
    leanh::lean_dec(v_w_364_);
    return v_res_367_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go___redArg(
    ...
    mut v_w_370_: *mut leanh::LeanObject,
    mut v_n_371_: *mut leanh::LeanObject,
    mut v_aig_372_: *mut leanh::LeanObject,
    mut v_distance_373_: *mut leanh::LeanObject,
    mut v_curr_374_: *mut leanh::LeanObject,
    mut v_acc_375_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_378_ == 0 {
                    leanh::lean_dec(v_curr_374_);
                    leanh::lean_dec_ref(v_distance_373_);
                    leanh::lean_dec(v_n_371_);
                    leanh::lean_dec_ref(v_inst_369_);
                    leanh::lean_dec_ref(v_inst_368_);
                    v___x_379_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v___x_379_, 0, v_aig_372_);
                    leanh::lean_ctor_set(v___x_379_, 1, v_acc_375_);
                    return v___x_379_;
                } else {
                    v___x_380_ = lean_nat_add(v_curr_374_, v___x_376_);
                    leanh::lean_dec(v_curr_374_);
                    leanh::lean_inc(v___x_380_);
                    leanh::lean_inc_ref(v_distance_373_);
                    leanh::lean_inc(v_n_371_);
                    v___x_381_ = leanh::lean_alloc_ctor(0, 4, (0) as u32);
                    leanh::lean_ctor_set(v___x_381_, 0, v_n_371_);
                    leanh::lean_ctor_set(v___x_381_, 1, v_acc_375_);
                    leanh::lean_ctor_set(v___x_381_, 2, v_distance_373_);
                    leanh::lean_ctor_set(v___x_381_, 3, v___x_380_);
                    leanh::lean_inc_ref(v_inst_369_);
                    leanh::lean_inc_ref(v_inst_368_);
                    v_res_382_ =
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go___redArg___boxed(
    ...
    mut v_w_388_: *mut leanh::LeanObject,
    mut v_n_389_: *mut leanh::LeanObject,
    mut v_aig_390_: *mut leanh::LeanObject,
    mut v_distance_391_: *mut leanh::LeanObject,
    mut v_curr_392_: *mut leanh::LeanObject,
    mut v_acc_393_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go(
    ...
    mut v_w_398_: *mut leanh::LeanObject,
    mut v_n_399_: *mut leanh::LeanObject,
    mut v_aig_400_: *mut leanh::LeanObject,
    mut v_distance_401_: *mut leanh::LeanObject,
    mut v_curr_402_: *mut leanh::LeanObject,
    mut v_acc_403_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go___boxed(
    ...
    mut v_w_408_: *mut leanh::LeanObject,
    mut v_n_409_: *mut leanh::LeanObject,
    mut v_aig_410_: *mut leanh::LeanObject,
    mut v_distance_411_: *mut leanh::LeanObject,
    mut v_curr_412_: *mut leanh::LeanObject,
    mut v_acc_413_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft___redArg(
    ...
    mut v_w_417_: *mut leanh::LeanObject,
    mut v_aig_418_: *mut leanh::LeanObject,
    mut v_target_419_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_n_420_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_target_421_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_distance_422_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_423_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_424_: u8 = 0;
    v_n_420_ = leanh::lean_ctor_get(v_target_419_, 0);
    leanh::lean_inc(v_n_420_);
    v_target_421_ = leanh::lean_ctor_get(v_target_419_, 1);
    leanh::lean_inc_ref(v_target_421_);
    v_distance_422_ = leanh::lean_ctor_get(v_target_419_, 2);
    leanh::lean_inc_ref(v_distance_422_);
    leanh::lean_dec_ref(v_target_419_);
    v___x_423_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v___x_424_ == 0 {
        ...
        leanh::lean_ctor_set(v___x_425_, 0, v_n_420_);
        leanh::lean_ctor_set(v___x_425_, 1, v_target_421_);
        leanh::lean_ctor_set(v___x_425_, 2, v_distance_422_);
        leanh::lean_ctor_set(v___x_425_, 3, v___x_423_);
        leanh::lean_inc_ref(v_inst_416_);
        leanh::lean_inc_ref(v_inst_415_);
        ...
        leanh::lean_dec_ref_known(v___x_425_, 4);
        ...
        leanh::lean_dec_ref(v_distance_422_);
        leanh::lean_dec(v_n_420_);
        leanh::lean_dec_ref(v_inst_416_);
        leanh::lean_dec_ref(v_inst_415_);
        v___x_430_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
        leanh::lean_ctor_set(v___x_430_, 0, v_aig_418_);
        leanh::lean_ctor_set(v___x_430_, 1, v_target_421_);
        return v___x_430_;
    }
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft___redArg___boxed(
    ...
    mut v_w_433_: *mut leanh::LeanObject,
    mut v_aig_434_: *mut leanh::LeanObject,
    mut v_target_435_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft(
    ...
    mut v_w_440_: *mut leanh::LeanObject,
    mut v_aig_441_: *mut leanh::LeanObject,
    mut v_target_442_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft___boxed(
    ...
    mut v_w_447_: *mut leanh::LeanObject,
    mut v_aig_448_: *mut leanh::LeanObject,
    mut v_target_449_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
