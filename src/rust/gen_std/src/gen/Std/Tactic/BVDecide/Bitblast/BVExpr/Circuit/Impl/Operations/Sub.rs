...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastSub___redArg(
    ...
    mut v_w_41_: *mut leanh::LeanObject,
    mut v_aig_42_: *mut leanh::LeanObject,
    mut v_input_43_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lhs_44_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_45_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_50_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vec_51_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_53_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_54_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_reuseFailAlloc_55_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_56_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_lhs_44_ = leanh::lean_ctor_get(v_input_43_, 0);
                v_rhs_45_ = leanh::lean_ctor_get(v_input_43_, 1);
                v_isSharedCheck_56_ = (!leanh::lean_is_exclusive(v_input_43_)) as u8;
                if v_isSharedCheck_56_ == 0 {
                    ...
                    leanh::lean_inc(v_rhs_45_);
                    leanh::lean_inc(v_lhs_44_);
                    leanh::lean_dec(v_input_43_);
            ...
            1 => {
                ...
                leanh::lean_inc_ref(v_inst_39_);
                v_res_49_ = l_Std_Tactic_BVDecide_BVExpr_bitblast_blastNeg___redArg(
                    v_inst_39_, v_inst_40_, v_w_41_, v_aig_42_, v_rhs_45_,
                );
                v_aig_50_ = leanh::lean_ctor_get(v_res_49_, 0);
                leanh::lean_inc_ref(v_aig_50_);
                v_vec_51_ = leanh::lean_ctor_get(v_res_49_, 1);
                leanh::lean_inc_ref(v_vec_51_);
                leanh::lean_dec_ref(v_res_49_);
                if v_isShared_48_ == 0 {
                    leanh::lean_ctor_set(v___x_47_, 1, v_vec_51_);
                    v___x_53_ = v___x_47_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_55_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_55_, 0, v_lhs_44_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_55_, 1, v_vec_51_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastSub___redArg___boxed(
    ...
    mut v_input_61_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastSub(
    ...
    mut v_w_66_: *mut leanh::LeanObject,
    mut v_aig_67_: *mut leanh::LeanObject,
    mut v_input_68_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastSub___boxed(
    ...
    mut v_input_75_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
