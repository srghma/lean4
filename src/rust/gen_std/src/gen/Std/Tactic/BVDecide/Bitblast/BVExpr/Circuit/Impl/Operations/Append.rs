...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastAppend___redArg(
    mut v_aig_50_: *mut leanh::LeanObject,
    mut v_target_51_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lhs_52_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_53_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_combined_54_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_55_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_lhs_52_ = leanh::lean_ctor_get(v_target_51_, 2);
    leanh::lean_inc_ref(v_lhs_52_);
    v_rhs_53_ = leanh::lean_ctor_get(v_target_51_, 3);
    leanh::lean_inc_ref(v_rhs_53_);
    leanh::lean_dec_ref(v_target_51_);
    v_combined_54_ = l_Array_append___redArg(v_rhs_53_, v_lhs_52_);
    leanh::lean_dec_ref(v_lhs_52_);
    v___x_55_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_55_, 0, v_aig_50_);
    leanh::lean_ctor_set(v___x_55_, 1, v_combined_54_);
    return v___x_55_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastAppend(
    ...
    mut v_newWidth_59_: *mut leanh::LeanObject,
    mut v_aig_60_: *mut leanh::LeanObject,
    mut v_target_61_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastAppend___boxed(
    ...
    mut v_newWidth_66_: *mut leanh::LeanObject,
    mut v_aig_67_: *mut leanh::LeanObject,
    mut v_target_68_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_newWidth_66_);
    leanh::lean_dec_ref(v_inst_65_);
    leanh::lean_dec_ref(v_inst_64_);
    return v_res_69_;
}
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Append_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastAppend_match__1_splitter___redArg(
    mut v_target_70_: *mut leanh::LeanObject,
    mut v_h__1_71_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lw_72_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rw_73_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lhs_74_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_75_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_76_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_lw_72_ = leanh::lean_ctor_get(v_target_70_, 0);
    leanh::lean_inc(v_lw_72_);
    v_rw_73_ = leanh::lean_ctor_get(v_target_70_, 1);
    leanh::lean_inc(v_rw_73_);
    v_lhs_74_ = leanh::lean_ctor_get(v_target_70_, 2);
    leanh::lean_inc_ref(v_lhs_74_);
    v_rhs_75_ = leanh::lean_ctor_get(v_target_70_, 3);
    leanh::lean_inc_ref(v_rhs_75_);
    leanh::lean_dec_ref(v_target_70_);
    v___x_76_ = leanh::lean_apply_5(
        v_h__1_71_,
        v_lw_72_,
        v_rw_73_,
        v_lhs_74_,
...
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Append_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastAppend_match__1_splitter(
    ...
    mut v_newWidth_80_: *mut leanh::LeanObject,
    mut v_aig_81_: *mut leanh::LeanObject,
    mut v_motive_82_: *mut leanh::LeanObject,
    mut v_target_83_: *mut leanh::LeanObject,
    mut v_h__1_84_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lw_85_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rw_86_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lhs_87_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_88_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_89_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_lw_85_ = leanh::lean_ctor_get(v_target_83_, 0);
    leanh::lean_inc(v_lw_85_);
    v_rw_86_ = leanh::lean_ctor_get(v_target_83_, 1);
    leanh::lean_inc(v_rw_86_);
    v_lhs_87_ = leanh::lean_ctor_get(v_target_83_, 2);
    leanh::lean_inc_ref(v_lhs_87_);
    v_rhs_88_ = leanh::lean_ctor_get(v_target_83_, 3);
    leanh::lean_inc_ref(v_rhs_88_);
    leanh::lean_dec_ref(v_target_83_);
    v___x_89_ = leanh::lean_apply_5(
        v_h__1_84_,
        v_lw_85_,
        v_rw_86_,
        v_lhs_87_,
...
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Append_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastAppend_match__1_splitter___boxed(
    ...
    mut v_target_96_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_aig_94_);
    leanh::lean_dec(v_newWidth_93_);
    leanh::lean_dec_ref(v_inst_92_);
