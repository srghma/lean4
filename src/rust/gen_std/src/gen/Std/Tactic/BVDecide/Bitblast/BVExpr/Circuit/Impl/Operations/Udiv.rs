...
use crate::ffi::{lean_array_fget_borrowed, lean_array_push, lean_mk_empty_array_with_capacity, lean_nat_add, lean_nat_dec_eq, lean_nat_dec_lt, lean_nat_land, lean_nat_lor, lean_nat_mul, lean_nat_shiftr, lean_nat_sub};
pub static l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___redArg___closed__0_value: leanh::LeanCtorObject<2> = leanh::LeanCtorObject { m_header: leanh::LeanObject { rc: 0, cs_size: (core::mem::size_of::<leanh::LeanObject>() + core::mem::size_of::<*mut leanh::LeanObject>()*1 + 8) as u16, other: 1, tag: 0 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut leanh::LeanObject,0 as *mut leanh::LeanObject] };
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___redArg___closed__0: *mut leanh::LeanObject = core::ptr::addr_of!(l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___redArg___closed__0_value) as *mut leanh::LeanObject;
...
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___redArg___closed__1: *mut leanh::LeanObject = core::ptr::addr_of!(l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___redArg___closed__1_value) as *mut leanh::LeanObject;
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastShiftConcat___redArg(
    mut v_w_316_: *mut leanh::LeanObject,
    mut v_aig_317_: *mut leanh::LeanObject,
    mut v_input_318_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_bit_319_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lhs_320_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_322_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_323_: u8 = 0;
    let mut v_gate_324_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_refs_328_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_new_335_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_337_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_338_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_reuseFailAlloc_339_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_340_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_bit_319_ = leanh::lean_ctor_get(v_input_318_, 1);
                v_lhs_320_ = leanh::lean_ctor_get(v_input_318_, 0);
                v_isSharedCheck_340_ = (!leanh::lean_is_exclusive(v_input_318_)) as u8;
                if v_isSharedCheck_340_ == 0 {
                    ...
                    leanh::lean_inc(v_bit_319_);
                    leanh::lean_inc(v_lhs_320_);
                    leanh::lean_dec(v_input_318_);
            ...
            1 => {
                v_gate_324_ = leanh::lean_ctor_get(v_bit_319_, 0);
                leanh::lean_inc(v_gate_324_);
                v_invert_325_ = leanh::lean_ctor_get_uint8(
                    v_bit_319_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                leanh::lean_dec_ref(v_bit_319_);
                v___x_326_ = leanh::lean_unsigned_to_nat(1);
                v___x_327_ = lean_nat_add(v_w_316_, v___x_326_);
                v_refs_328_ = lean_mk_empty_array_with_capacity(v___x_327_);
                leanh::lean_dec(v___x_327_);
                v___x_329_ = leanh::lean_unsigned_to_nat(2);
                v___x_330_ = lean_nat_mul(v_gate_324_, v___x_329_);
                leanh::lean_dec(v_gate_324_);
                ...
                leanh::lean_dec_ref(v_lhs_320_);
                if v_isShared_323_ == 0 {
                    leanh::lean_ctor_set(v___x_322_, 1, v_new_335_);
                    leanh::lean_ctor_set(v___x_322_, 0, v___x_334_);
                    v___x_337_ = v___x_322_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_339_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_339_, 0, v___x_334_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_339_, 1, v_new_335_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastShiftConcat___redArg___boxed(
    mut v_w_341_: *mut leanh::LeanObject,
    mut v_aig_342_: *mut leanh::LeanObject,
    mut v_input_343_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastShiftConcat(
    ...
    mut v_w_348_: *mut leanh::LeanObject,
    mut v_aig_349_: *mut leanh::LeanObject,
    mut v_input_350_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastShiftConcat___boxed(
    ...
    mut v_w_355_: *mut leanh::LeanObject,
    mut v_aig_356_: *mut leanh::LeanObject,
    mut v_input_357_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___redArg(
    ...
    mut v_d_370_: *mut leanh::LeanObject,
    mut v_wn_371_: *mut leanh::LeanObject,
    mut v_wr_372_: *mut leanh::LeanObject,
    mut v_q_373_: *mut leanh::LeanObject,
    mut v_r_374_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_375_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_wn_376_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_wr_377_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_383_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vec_384_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_386_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_387_: u8 = 0;
    let mut v_falseRef_388_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_390_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_391_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_392_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vec_393_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_395_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_396_: u8 = 0;
    let mut v_trueRef_397_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_399_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_400_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_401_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vec_402_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_409_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vec_410_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_411_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_412_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ref_413_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_gate_418_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_invert_419_: u8 = 0;
    let mut v___x_421_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_422_: u8 = 0;
    let mut v_discr_424_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_425_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_426_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_427_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vec_428_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_falseRef_439_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ref_440_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_438_ == 0 {
                    ...
                    v___x_443_ = leanh::lean_unsigned_to_nat(0);
                    v___x_444_ = lean_nat_dec_eq(v___x_442_, v___x_443_);
                    leanh::lean_dec(v___x_442_);
                    if v___x_444_ == 0 {
                        v___x_445_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                        leanh::lean_ctor_set(v___x_445_, 0, v___x_441_);
                        ...
                        leanh::lean_ctor_set(v___x_446_, 0, v___x_441_);
                        leanh::lean_ctor_set_uint8(
                            v___x_446_,
                            (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                            v___x_378_,
            ...
            1 => {
                v___x_381_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_381_, 0, v_r_374_);
                leanh::lean_ctor_set(v___x_381_, 1, v___y_380_);
                v_res_382_ =
                    l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastShiftConcat___redArg(
                        v_w_367_, v_aig_368_, v___x_381_,
                    );
                v_aig_383_ = leanh::lean_ctor_get(v_res_382_, 0);
                v_vec_384_ = leanh::lean_ctor_get(v_res_382_, 1);
                v_isSharedCheck_437_ = (!leanh::lean_is_exclusive(v_res_382_)) as u8;
                if v_isSharedCheck_437_ == 0 {
                    ...
                    leanh::lean_inc(v_vec_384_);
                    leanh::lean_inc(v_aig_383_);
                    leanh::lean_dec(v_res_382_);
            ...
            2 => {
                ...
                leanh::lean_inc_ref(v_q_373_);
                if v_isShared_387_ == 0 {
                    leanh::lean_ctor_set(v___x_386_, 1, v_falseRef_388_);
                    leanh::lean_ctor_set(v___x_386_, 0, v_q_373_);
                    v___x_390_ = v___x_386_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_436_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_436_, 0, v_q_373_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_436_, 1, v_falseRef_388_);
            ...
            3 => {
                ...
                v_aig_392_ = leanh::lean_ctor_get(v_res_391_, 0);
                v_vec_393_ = leanh::lean_ctor_get(v_res_391_, 1);
                v_isSharedCheck_435_ = (!leanh::lean_is_exclusive(v_res_391_)) as u8;
                if v_isSharedCheck_435_ == 0 {
                    ...
                    leanh::lean_inc(v_vec_393_);
                    leanh::lean_inc(v_aig_392_);
                    leanh::lean_dec(v_res_391_);
            ...
            4 => {
                ...
                if v_isShared_396_ == 0 {
                    leanh::lean_ctor_set(v___x_395_, 1, v_trueRef_397_);
                    leanh::lean_ctor_set(v___x_395_, 0, v_q_373_);
                    v___x_399_ = v___x_395_;
                    state = 5;
                    continue;
                } else {
                    v_reuseFailAlloc_434_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_434_, 0, v_q_373_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_434_, 1, v_trueRef_397_);
            ...
            5 => {
                ...
                v_aig_401_ = leanh::lean_ctor_get(v_res_400_, 0);
                v_vec_402_ = leanh::lean_ctor_get(v_res_400_, 1);
                v_isSharedCheck_433_ = (!leanh::lean_is_exclusive(v_res_400_)) as u8;
                if v_isSharedCheck_433_ == 0 {
                    ...
                    leanh::lean_inc(v_vec_402_);
                    leanh::lean_inc(v_aig_401_);
                    leanh::lean_dec(v_res_400_);
            ...
            6 => {
                leanh::lean_inc_ref(v_vec_384_);
                if v_isShared_405_ == 0 {
                    leanh::lean_ctor_set(v___x_404_, 1, v_d_370_);
                    leanh::lean_ctor_set(v___x_404_, 0, v_vec_384_);
                    v___x_407_ = v___x_404_;
                    state = 7;
                    continue;
                } else {
                    v_reuseFailAlloc_432_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_432_, 0, v_vec_384_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_432_, 1, v_d_370_);
            ...
            7 => {
                leanh::lean_inc_ref(v___x_407_);
                leanh::lean_inc_ref_n(v_inst_366_, 3);
                leanh::lean_inc_ref_n(v_inst_365_, 3);
                ...
                v_aig_409_ = leanh::lean_ctor_get(v_res_408_, 0);
                leanh::lean_inc_ref(v_aig_409_);
                v_vec_410_ = leanh::lean_ctor_get(v_res_408_, 1);
                leanh::lean_inc_ref(v_vec_410_);
                leanh::lean_dec_ref(v_res_408_);
                leanh::lean_inc(v_w_367_);
                ...
                v_aig_412_ = leanh::lean_ctor_get(v_res_411_, 0);
                leanh::lean_inc_ref(v_aig_412_);
                v_ref_413_ = leanh::lean_ctor_get(v_res_411_, 1);
                leanh::lean_inc_ref_n(v_ref_413_, 2);
                leanh::lean_dec_ref(v_res_411_);
                v___x_414_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                leanh::lean_ctor_set(v___x_414_, 0, v_ref_413_);
                leanh::lean_ctor_set(v___x_414_, 1, v_vec_393_);
                leanh::lean_ctor_set(v___x_414_, 2, v_vec_402_);
                ...
                v_gate_418_ = leanh::lean_ctor_get(v_ref_413_, 0);
                v_invert_419_ = leanh::lean_ctor_get_uint8(
                    v_ref_413_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                v_isSharedCheck_431_ = (!leanh::lean_is_exclusive(v_ref_413_)) as u8;
                if v_isSharedCheck_431_ == 0 {
                    ...
                    leanh::lean_inc(v_gate_418_);
                    leanh::lean_dec(v_ref_413_);
            ...
            8 => {
                if v_isShared_422_ == 0 {
                    ...
                    v_reuseFailAlloc_430_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_430_, 0, v_gate_418_);
                    leanh::lean_ctor_set_uint8(
            ...
            9 => {
                ...
                leanh::lean_ctor_set(v___x_425_, 0, v_discr_424_);
                leanh::lean_ctor_set(v___x_425_, 1, v_vec_384_);
                leanh::lean_ctor_set(v___x_425_, 2, v_vec_410_);
                ...
                v_aig_427_ = leanh::lean_ctor_get(v_res_426_, 0);
                leanh::lean_inc_ref(v_aig_427_);
                v_vec_428_ = leanh::lean_ctor_get(v_res_426_, 1);
                leanh::lean_inc_ref(v_vec_428_);
                leanh::lean_dec_ref(v_res_426_);
                v___x_429_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                leanh::lean_ctor_set(v___x_429_, 0, v_aig_427_);
                leanh::lean_ctor_set(v___x_429_, 1, v_wn_376_);
                leanh::lean_ctor_set(v___x_429_, 2, v_wr_377_);
                leanh::lean_ctor_set(v___x_429_, 3, v_vec_417_);
                leanh::lean_ctor_set(v___x_429_, 4, v_vec_428_);
                return v___x_429_;
            }
            _ => {}
        }
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___redArg___boxed(
    ...
    mut v_w_449_: *mut leanh::LeanObject,
    mut v_aig_450_: *mut leanh::LeanObject,
    mut v_n_451_: *mut leanh::LeanObject,
    mut v_d_452_: *mut leanh::LeanObject,
    mut v_wn_453_: *mut leanh::LeanObject,
    mut v_wr_454_: *mut leanh::LeanObject,
    mut v_q_455_: *mut leanh::LeanObject,
    mut v_r_456_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_wr_454_);
    leanh::lean_dec(v_wn_453_);
    leanh::lean_dec_ref(v_n_451_);
    return v_res_457_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift(
    ...
    mut v_d_464_: *mut leanh::LeanObject,
    mut v_wn_465_: *mut leanh::LeanObject,
    mut v_wr_466_: *mut leanh::LeanObject,
    mut v_q_467_: *mut leanh::LeanObject,
    mut v_r_468_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_blastDivSubtractShift___boxed(
    mut v_00_u03b1_470_: *mut leanh::LeanObject,
    mut v_inst_471_: *mut leanh::LeanObject,
    mut v_inst_472_: *mut leanh::LeanObject,
    mut v_w_473_: *mut leanh::LeanObject,
    mut v_aig_474_: *mut leanh::LeanObject,
    mut v_n_475_: *mut leanh::LeanObject,
    mut v_d_476_: *mut leanh::LeanObject,
    mut v_wn_477_: *mut leanh::LeanObject,
    mut v_wr_478_: *mut leanh::LeanObject,
    mut v_q_479_: *mut leanh::LeanObject,
    mut v_r_480_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_wr_478_);
    leanh::lean_dec(v_wn_477_);
    leanh::lean_dec_ref(v_n_475_);
    return v_res_481_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go___redArg(
    ...
    mut v_w_484_: *mut leanh::LeanObject,
    mut v_aig_485_: *mut leanh::LeanObject,
    mut v_curr_486_: *mut leanh::LeanObject,
    mut v_n_487_: *mut leanh::LeanObject,
    mut v_d_488_: *mut leanh::LeanObject,
    mut v_wn_489_: *mut leanh::LeanObject,
    mut v_wr_490_: *mut leanh::LeanObject,
    mut v_q_491_: *mut leanh::LeanObject,
    mut v_r_492_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_493_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_497_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_wn_498_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_wr_499_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_q_500_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_r_501_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_one_502_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_503_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_504_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_505_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_q_506_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_493_ = leanh::lean_unsigned_to_nat(0);
                v_isZero_494_ = lean_nat_dec_eq(v_curr_486_, v_zero_493_);
                if v_isZero_494_ == 1 {
                    leanh::lean_dec_ref(v_d_488_);
                    leanh::lean_dec(v_w_484_);
                    leanh::lean_dec_ref(v_inst_483_);
                    leanh::lean_dec_ref(v_inst_482_);
                    v___x_495_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                    leanh::lean_ctor_set(v___x_495_, 0, v_aig_485_);
                    leanh::lean_ctor_set(v___x_495_, 1, v_q_491_);
                    leanh::lean_ctor_set(v___x_495_, 2, v_r_492_);
                    return v___x_495_;
                } else {
                    leanh::lean_inc_ref(v_d_488_);
                    leanh::lean_inc(v_w_484_);
                    leanh::lean_inc_ref(v_inst_483_);
                    leanh::lean_inc_ref(v_inst_482_);
                    ...
                    v_aig_497_ = leanh::lean_ctor_get(v_res_496_, 0);
                    leanh::lean_inc_ref(v_aig_497_);
                    v_wn_498_ = leanh::lean_ctor_get(v_res_496_, 1);
                    leanh::lean_inc(v_wn_498_);
                    v_wr_499_ = leanh::lean_ctor_get(v_res_496_, 2);
                    leanh::lean_inc(v_wr_499_);
                    v_q_500_ = leanh::lean_ctor_get(v_res_496_, 3);
                    leanh::lean_inc_ref(v_q_500_);
                    v_r_501_ = leanh::lean_ctor_get(v_res_496_, 4);
                    leanh::lean_inc_ref(v_r_501_);
                    leanh::lean_dec_ref(v_res_496_);
                    v_one_502_ = leanh::lean_unsigned_to_nat(1);
                    ...
                    leanh::lean_dec(v_wr_499_);
                    leanh::lean_dec(v_wn_498_);
                    leanh::lean_dec(v_n_503_);
                    v_aig_505_ = leanh::lean_ctor_get(v_res_504_, 0);
                    v_q_506_ = leanh::lean_ctor_get(v_res_504_, 1);
                    v_r_507_ = leanh::lean_ctor_get(v_res_504_, 2);
                    v_isSharedCheck_514_ = (!leanh::lean_is_exclusive(v_res_504_)) as u8;
                    if v_isSharedCheck_514_ == 0 {
                        ...
                        leanh::lean_inc(v_r_507_);
                        leanh::lean_inc(v_q_506_);
                        leanh::lean_inc(v_aig_505_);
                        leanh::lean_dec(v_res_504_);
            ...
            1 => {
                if v_isShared_510_ == 0 {
                    ...
                    v_reuseFailAlloc_513_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_513_, 0, v_aig_505_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_513_, 1, v_q_506_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_513_, 2, v_r_507_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go___redArg___boxed(
    ...
    mut v_curr_519_: *mut leanh::LeanObject,
    mut v_n_520_: *mut leanh::LeanObject,
    mut v_d_521_: *mut leanh::LeanObject,
    mut v_wn_522_: *mut leanh::LeanObject,
    mut v_wr_523_: *mut leanh::LeanObject,
    mut v_q_524_: *mut leanh::LeanObject,
    mut v_r_525_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_wr_523_);
    leanh::lean_dec(v_wn_522_);
    leanh::lean_dec_ref(v_n_520_);
    leanh::lean_dec(v_curr_519_);
    return v_res_526_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go(
    ...
    mut v_w_530_: *mut leanh::LeanObject,
    mut v_aig_531_: *mut leanh::LeanObject,
    mut v_curr_532_: *mut leanh::LeanObject,
    mut v_n_533_: *mut leanh::LeanObject,
    mut v_d_534_: *mut leanh::LeanObject,
    mut v_wn_535_: *mut leanh::LeanObject,
    mut v_wr_536_: *mut leanh::LeanObject,
    mut v_q_537_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go___boxed(
    mut v_00_u03b1_540_: *mut leanh::LeanObject,
    ...
    mut v_curr_545_: *mut leanh::LeanObject,
    mut v_n_546_: *mut leanh::LeanObject,
    mut v_d_547_: *mut leanh::LeanObject,
    mut v_wn_548_: *mut leanh::LeanObject,
    mut v_wr_549_: *mut leanh::LeanObject,
    mut v_q_550_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_wr_549_);
    leanh::lean_dec(v_wn_548_);
    leanh::lean_dec_ref(v_n_546_);
    leanh::lean_dec(v_curr_545_);
    return v_res_552_;
}
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Udiv_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go_match__1_splitter___redArg(
    mut v_curr_553_: *mut leanh::LeanObject,
    mut v_h__1_554_: *mut leanh::LeanObject,
    mut v_h__2_555_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_556_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_557_: u8 = 0;
    v_zero_556_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_557_ == 1 {
        ...
        leanh::lean_dec(v_h__2_555_);
        v___x_558_ = leanh::lean_box(0);
        v___x_559_ = leanh::lean_apply_1(v_h__1_554_, v___x_558_);
        return v___x_559_;
    } else {
        let mut v_one_560_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_561_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_562_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_554_);
        v_one_560_ = leanh::lean_unsigned_to_nat(1);
        v_n_561_ = lean_nat_sub(v_curr_553_, v_one_560_);
        v___x_562_ = leanh::lean_apply_1(v_h__2_555_, v_n_561_);
        return v___x_562_;
    }
}
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Udiv_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go_match__1_splitter___redArg___boxed(
    mut v_curr_563_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Udiv_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go_match__1_splitter(
    ...
    mut v_curr_568_: *mut leanh::LeanObject,
    mut v_h__1_569_: *mut leanh::LeanObject,
    mut v_h__2_570_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_571_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_572_: u8 = 0;
    v_zero_571_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_572_ == 1 {
        ...
        leanh::lean_dec(v_h__2_570_);
        v___x_573_ = leanh::lean_box(0);
        v___x_574_ = leanh::lean_apply_1(v_h__1_569_, v___x_573_);
        return v___x_574_;
    } else {
        let mut v_one_575_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_576_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_577_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_569_);
        v_one_575_ = leanh::lean_unsigned_to_nat(1);
        v_n_576_ = lean_nat_sub(v_curr_568_, v_one_575_);
        v___x_577_ = leanh::lean_apply_1(v_h__2_570_, v_n_576_);
        return v___x_577_;
    }
}
pub unsafe fn l___private_Std_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Operations_Udiv_0__Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv_go_match__1_splitter___boxed(
    ...
    mut v_curr_579_: *mut leanh::LeanObject,
    mut v_h__1_580_: *mut leanh::LeanObject,
    mut v_h__2_581_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv___redArg(
    ...
    mut v_w_585_: *mut leanh::LeanObject,
    mut v_aig_586_: *mut leanh::LeanObject,
    mut v_input_587_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lhs_588_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_rhs_589_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_599_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ref_600_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_res_601_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_aig_602_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_q_603_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_605_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_606_: u8 = 0;
    let mut v_gate_607_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_invert_608_: u8 = 0;
    let mut v___x_610_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_611_: u8 = 0;
    let mut v_discr_613_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_lhs_588_ = leanh::lean_ctor_get(v_input_587_, 0);
                v_rhs_589_ = leanh::lean_ctor_get(v_input_587_, 1);
                v_isSharedCheck_623_ = (!leanh::lean_is_exclusive(v_input_587_)) as u8;
                if v_isSharedCheck_623_ == 0 {
                    ...
                    leanh::lean_inc(v_rhs_589_);
                    leanh::lean_inc(v_lhs_588_);
                    leanh::lean_dec(v_input_587_);
            ...
            1 => {
                ...
                leanh::lean_inc_ref(v_zero_595_);
                leanh::lean_inc_ref(v_rhs_589_);
                if v_isShared_592_ == 0 {
                    leanh::lean_ctor_set(v___x_591_, 1, v_zero_595_);
                    leanh::lean_ctor_set(v___x_591_, 0, v_rhs_589_);
                    v___x_597_ = v___x_591_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_622_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_622_, 0, v_rhs_589_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_622_, 1, v_zero_595_);
            ...
            2 => {
                leanh::lean_inc_ref_n(v_inst_584_, 2);
                leanh::lean_inc_ref_n(v_inst_583_, 2);
                ...
                v_aig_599_ = leanh::lean_ctor_get(v_res_598_, 0);
                leanh::lean_inc_ref(v_aig_599_);
                v_ref_600_ = leanh::lean_ctor_get(v_res_598_, 1);
                leanh::lean_inc_ref(v_ref_600_);
                leanh::lean_dec_ref(v_res_598_);
                leanh::lean_inc_ref_n(v_zero_595_, 2);
                leanh::lean_inc(v_w_585_);
                ...
                leanh::lean_dec_ref(v_lhs_588_);
                v_aig_602_ = leanh::lean_ctor_get(v_res_601_, 0);
                v_q_603_ = leanh::lean_ctor_get(v_res_601_, 1);
                v_isSharedCheck_620_ = (!leanh::lean_is_exclusive(v_res_601_)) as u8;
                if v_isSharedCheck_620_ == 0 {
                    v_unused_621_ = leanh::lean_ctor_get(v_res_601_, 2);
                    ...
                    leanh::lean_inc(v_q_603_);
                    leanh::lean_inc(v_aig_602_);
                    leanh::lean_dec(v_res_601_);
            ...
            3 => {
                v_gate_607_ = leanh::lean_ctor_get(v_ref_600_, 0);
                v_invert_608_ = leanh::lean_ctor_get_uint8(
                    v_ref_600_,
                    (core::mem::size_of::<*mut leanh::LeanObject>() * 1) as u32,
                );
                v_isSharedCheck_619_ = (!leanh::lean_is_exclusive(v_ref_600_)) as u8;
                if v_isSharedCheck_619_ == 0 {
                    ...
                    leanh::lean_inc(v_gate_607_);
                    leanh::lean_dec(v_ref_600_);
            ...
            4 => {
                if v_isShared_611_ == 0 {
                    ...
                    v_reuseFailAlloc_618_ = leanh::lean_alloc_ctor(0, 1, (1) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_618_, 0, v_gate_607_);
                    leanh::lean_ctor_set_uint8(
            ...
            5 => {
                if v_isShared_606_ == 0 {
                    leanh::lean_ctor_set(v___x_605_, 2, v_q_603_);
                    leanh::lean_ctor_set(v___x_605_, 1, v_zero_595_);
                    leanh::lean_ctor_set(v___x_605_, 0, v_discr_613_);
                    v___x_615_ = v___x_605_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_617_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_617_, 0, v_discr_613_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_617_, 1, v_zero_595_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_617_, 2, v_q_603_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUdiv(
    ...
    mut v_w_627_: *mut leanh::LeanObject,
    mut v_aig_628_: *mut leanh::LeanObject,
    mut v_input_629_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
