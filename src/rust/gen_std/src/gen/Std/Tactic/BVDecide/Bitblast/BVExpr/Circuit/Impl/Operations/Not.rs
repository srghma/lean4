...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastNot___redArg(
    mut v_inst_29_: *mut leanh::LeanObject,
    mut v_inst_30_: *mut leanh::LeanObject,
    mut v_w_31_: *mut leanh::LeanObject,
    mut v_aig_32_: *mut leanh::LeanObject,
    mut v_s_33_: *mut leanh::LeanObject,
    ...
    leanh::lean_closure_set(v___x_34_, 0, leanh::lean_box(0));
    leanh::lean_closure_set(v___x_34_, 1, v_inst_29_);
    leanh::lean_closure_set(v___x_34_, 2, v_inst_30_);
    v___x_35_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_35_, 0, v_s_33_);
    leanh::lean_ctor_set(v___x_35_, 1, v___x_34_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastNot___redArg___boxed(
    ...
    mut v_w_39_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastNot(
    ...
    mut v_w_46_: *mut leanh::LeanObject,
    mut v_aig_47_: *mut leanh::LeanObject,
    mut v_s_48_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastNot___boxed(
    ...
    mut v_w_53_: *mut leanh::LeanObject,
    mut v_aig_54_: *mut leanh::LeanObject,
    mut v_s_55_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
