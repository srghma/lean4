...
static mut l_Std_Semaphore_new___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Std_Semaphore_new___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_Std_Semaphore_acquire___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_Std_Semaphore_acquire___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Std_Semaphore_acquire___closed__0_value) as *mut leanh::LeanObject;
pub static l_Std_Semaphore_tryAcquire___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Std_Semaphore_tryAcquire___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Std_Semaphore_tryAcquire___closed__0_value)
        as *mut leanh::LeanObject;
pub static l_Std_Semaphore_release___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Std_Semaphore_release___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Std_Semaphore_release___closed__0_value) as *mut leanh::LeanObject;
pub static l_Std_Semaphore_availablePermits___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Std_Semaphore_availablePermits___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn _init_l_Std_Semaphore_new___closed__0() -> *mut leanh::LeanObject {
    let mut v___x_196_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_196_ = l_Std_Queue_empty(leanh::lean_box(0));
    return v___x_196_;
}
pub unsafe fn l_Std_Semaphore_new(
    mut v_permits_197_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_ctor_set(v___x_200_, 0, v_permits_197_);
    leanh::lean_ctor_set(v___x_200_, 1, v___x_199_);
    v___x_201_ = l_Std_Mutex_new___redArg(v___x_200_);
    return v___x_201_;
}
pub unsafe fn l_Std_Semaphore_new___boxed(
    mut v_permits_202_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Semaphore_acquire_spec__0___redArg(
    mut v_mutex_205_: *mut leanh::LeanObject,
    mut v_k_206_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_ref_208_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mutex_209_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_ref_208_ = leanh::lean_ctor_get(v_mutex_205_, 0);
    leanh::lean_inc(v_ref_208_);
    v_mutex_209_ = leanh::lean_ctor_get(v_mutex_205_, 1);
    leanh::lean_inc(v_mutex_209_);
    leanh::lean_dec_ref(v_mutex_205_);
    v___x_210_ = lean_io_basemutex_lock(v_mutex_209_);
    v___x_211_ = leanh::lean_apply_2(v_k_206_, v_ref_208_, leanh::lean_box(0));
    v___x_212_ = lean_io_basemutex_unlock(v_mutex_209_);
    leanh::lean_dec(v_mutex_209_);
    return v___x_211_;
}
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Semaphore_acquire_spec__0___redArg___boxed(
    mut v_mutex_213_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Semaphore_acquire_spec__0(
    ...
    mut v_mutex_219_: *mut leanh::LeanObject,
    mut v_k_220_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Semaphore_acquire___lam__0(
    ...
    let mut v_permits_232_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_waiters_233_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_permits_232_ = leanh::lean_ctor_get(v___x_231_, 0);
                v_waiters_233_ = leanh::lean_ctor_get(v___x_231_, 1);
                v_isSharedCheck_253_ = (!leanh::lean_is_exclusive(v___x_231_)) as u8;
                if v_isSharedCheck_253_ == 0 {
                    ...
                    leanh::lean_inc(v_waiters_233_);
                    leanh::lean_inc(v_permits_232_);
            ...
            1 => {
                ...
                if v___x_238_ == 0 {
                    ...
                    leanh::lean_dec(v_permits_232_);
                    if v_isShared_236_ == 0 {
                        leanh::lean_ctor_set(v___x_235_, 0, v___x_246_);
                        v___x_248_ = v___x_235_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_252_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_252_, 0, v___x_246_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_252_, 1, v_waiters_233_);
...
pub unsafe fn l_Std_Semaphore_acquire___lam__0___boxed(
    ...
    leanh::lean_dec(v___y_254_);
    return v_res_256_;
}
pub unsafe fn l_Std_Semaphore_acquire(
    mut v_sem_258_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Semaphore_acquire___boxed(
    mut v_sem_262_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Semaphore_tryAcquire___lam__0(
    ...
    let mut v_permits_268_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_waiters_269_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_permits_268_ = leanh::lean_ctor_get(v___x_267_, 0);
                v_waiters_269_ = leanh::lean_ctor_get(v___x_267_, 1);
                v_isSharedCheck_281_ = (!leanh::lean_is_exclusive(v___x_267_)) as u8;
                if v_isSharedCheck_281_ == 0 {
                    ...
                    leanh::lean_inc(v_waiters_269_);
                    leanh::lean_inc(v_permits_268_);
            ...
            1 => {
                v___x_273_ = leanh::lean_unsigned_to_nat(0);
                v___x_274_ = lean_nat_dec_lt(v___x_273_, v_permits_268_);
                if v___x_274_ == 0 {
                    leanh::lean_del_object(v___x_271_);
                    leanh::lean_dec_ref(v_waiters_269_);
                    leanh::lean_dec(v_permits_268_);
                    return v___x_274_;
                } else {
                    ...
                    if v_isShared_272_ == 0 {
                        leanh::lean_ctor_set(v___x_271_, 0, v___x_276_);
                        v___x_278_ = v___x_271_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_280_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_280_, 0, v___x_276_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_280_, 1, v_waiters_269_);
...
pub unsafe fn l_Std_Semaphore_tryAcquire___lam__0___boxed(
    ...
    leanh::lean_dec(v___y_282_);
    v_r_285_ = leanh::lean_box((v_res_284_) as usize);
    return v_r_285_;
}
pub unsafe fn l_Std_Semaphore_tryAcquire(mut v_sem_287_: *mut leanh::LeanObject) -> u8 {
    ...
    v___x_291_ = (leanh::lean_unbox(v___x_290_) as u8);
    leanh::lean_dec(v___x_290_);
    return v___x_291_;
}
pub unsafe fn l_Std_Semaphore_tryAcquire___boxed(
    mut v_sem_292_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Semaphore_release___lam__0(
    ...
    let mut v_permits_299_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_waiters_300_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_val_312_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_snd_317_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_permits_299_ = leanh::lean_ctor_get(v___x_298_, 0);
                v_waiters_300_ = leanh::lean_ctor_get(v___x_298_, 1);
                v_isSharedCheck_326_ = (!leanh::lean_is_exclusive(v___x_298_)) as u8;
                if v_isSharedCheck_326_ == 0 {
                    ...
                    leanh::lean_inc(v_waiters_300_);
                    leanh::lean_inc(v_permits_299_);
            ...
            1 => {
                leanh::lean_inc_ref(v_waiters_300_);
                v___x_304_ = l_Std_Queue_dequeue_x3f___redArg(v_waiters_300_);
                if leanh::lean_obj_tag(v___x_304_) == 0 {
                    v___x_305_ = leanh::lean_unsigned_to_nat(1);
                    v___x_306_ = lean_nat_add(v_permits_299_, v___x_305_);
                    leanh::lean_dec(v_permits_299_);
                    if v_isShared_303_ == 0 {
                        leanh::lean_ctor_set(v___x_302_, 0, v___x_306_);
                        v___x_308_ = v___x_302_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_311_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_311_, 0, v___x_306_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_311_, 1, v_waiters_300_);
                        v___x_308_ = v_reuseFailAlloc_311_;
                        state = 2;
                        continue;
                    }
                } else {
                    leanh::lean_dec_ref(v_waiters_300_);
                    v_val_312_ = leanh::lean_ctor_get(v___x_304_, 0);
                    v_isSharedCheck_325_ = (!leanh::lean_is_exclusive(v___x_304_)) as u8;
            ...
            3 => {
                v_fst_316_ = leanh::lean_ctor_get(v_val_312_, 0);
                leanh::lean_inc(v_fst_316_);
                v_snd_317_ = leanh::lean_ctor_get(v_val_312_, 1);
                leanh::lean_inc(v_snd_317_);
                leanh::lean_dec(v_val_312_);
                if v_isShared_303_ == 0 {
                    leanh::lean_ctor_set(v___x_302_, 1, v_snd_317_);
                    v___x_319_ = v___x_302_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_324_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_324_, 0, v_permits_299_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_324_, 1, v_snd_317_);
            ...
            4 => {
                ...
                if v_isShared_315_ == 0 {
                    leanh::lean_ctor_set(v___x_314_, 0, v_fst_316_);
                    v___x_322_ = v___x_314_;
                    state = 5;
                    continue;
                } else {
                    v_reuseFailAlloc_323_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_323_, 0, v_fst_316_);
...
pub unsafe fn l_Std_Semaphore_release___lam__0___boxed(
    ...
    leanh::lean_dec(v___y_327_);
    return v_res_329_;
}
pub unsafe fn l_Std_Semaphore_release(
    mut v_sem_331_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    if leanh::lean_obj_tag(v___x_334_) == 1 {
...
pub unsafe fn l_Std_Semaphore_release___boxed(
    mut v_sem_339_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_Semaphore_availablePermits___lam__0(
    ...
    let mut v_permits_345_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_344_ = lean_st_ref_get(v___y_342_);
    v_permits_345_ = leanh::lean_ctor_get(v___x_344_, 0);
    leanh::lean_inc(v_permits_345_);
...
pub unsafe fn l_Std_Semaphore_availablePermits(
    mut v_sem_350_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_Semaphore_availablePermits___boxed(
    mut v_sem_354_: *mut leanh::LeanObject,
...
pub unsafe fn runtime_initialize_Std_Sync_Semaphore(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Sync_Semaphore(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sync_Semaphore(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
