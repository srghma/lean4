...
pub unsafe fn l_binderNameHint___redArg(
    mut v_e_17_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_e_17_);
    return v_e_17_;
}
pub unsafe fn l_binderNameHint___redArg___boxed(
    ...
    leanh::lean_dec(v_e_18_);
    return v_res_19_;
}
pub unsafe fn l_binderNameHint(
    mut v_00_u03b1_20_: *mut leanh::LeanObject,
    mut v_00_u03b2_21_: *mut leanh::LeanObject,
    mut v_00_u03b3_22_: *mut leanh::LeanObject,
    mut v_v_23_: *mut leanh::LeanObject,
    mut v_binder_24_: *mut leanh::LeanObject,
    mut v_e_25_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_e_25_);
    return v_e_25_;
}
pub unsafe fn l_binderNameHint___boxed(
    mut v_00_u03b1_26_: *mut leanh::LeanObject,
    mut v_00_u03b2_27_: *mut leanh::LeanObject,
    mut v_00_u03b3_28_: *mut leanh::LeanObject,
    mut v_v_29_: *mut leanh::LeanObject,
    mut v_binder_30_: *mut leanh::LeanObject,
    mut v_e_31_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_32_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    leanh::lean_dec(v_e_31_);
    leanh::lean_dec(v_binder_30_);
    leanh::lean_dec(v_v_29_);
    return v_res_32_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_BinderNameHint(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_BinderNameHint(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_BinderNameHint(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
