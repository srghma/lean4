...
static mut l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg___closed__0:
    *mut leanh::LeanObject = core::ptr::null_mut();
pub unsafe fn _init_l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg___closed__0()
...
pub unsafe fn l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg(
    mut v_n_37_: *mut leanh::LeanObject,
    ...
    v_intZero_40_ = leanh::lean_obj_once(
        core::ptr::addr_of_mut!(
            l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg___closed__0
        ),
        core::ptr::addr_of_mut!(
            l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg___closed__0_once
        ),
        _init_l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg___closed__0,
    );
    v_isNeg_41_ = lean_int_dec_lt(v_n_37_, v_intZero_40_);
    if v_isNeg_41_ == 0 {
        ...
        v_abs_44_ = lean_nat_abs(v_n_37_);
...
pub unsafe fn l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg___boxed(
    ...
    v_res_51_ = l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg(
        v_n_48_, v_h__1_49_, v_h__2_50_,
    );
    leanh::lean_dec(v_n_48_);
    return v_res_51_;
}
pub unsafe fn l___private_Init_Omega_Int_0__Int_neg_match__1_splitter(
    mut v_motive_52_: *mut leanh::LeanObject,
    mut v_n_53_: *mut leanh::LeanObject,
    ...
    v_intZero_56_ = leanh::lean_obj_once(
        core::ptr::addr_of_mut!(
            l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg___closed__0
        ),
        core::ptr::addr_of_mut!(
    ...
    v_isNeg_57_ = lean_int_dec_lt(v_n_53_, v_intZero_56_);
    if v_isNeg_57_ == 0 {
        ...
        v_abs_60_ = lean_nat_abs(v_n_53_);
...
pub unsafe fn l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___boxed(
    ...
    v_res_68_ = l___private_Init_Omega_Int_0__Int_neg_match__1_splitter(
        v_motive_64_,
        v_n_65_,
        v_h__1_66_,
        v_h__2_67_,
    );
    leanh::lean_dec(v_n_65_);
    return v_res_68_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Omega_Int(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Omega_Int(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Omega_Int(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
