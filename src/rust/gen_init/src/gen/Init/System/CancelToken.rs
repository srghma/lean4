...
pub unsafe fn l_IO_CancelToken_new() -> *mut crate::leanh::LeanObject {
    ...
    v___x_60_ = 0;
    v___x_61_ = crate::leanh::lean_box((v___x_60_) as usize);
    v___x_62_ = lean_st_mk_ref(v___x_61_);
    v___x_63_ = crate::leanh::lean_alloc_ctor(0, 2, (0) as u32);
    crate::leanh::lean_ctor_set(v___x_63_, 0, v___x_59_);
    crate::leanh::lean_ctor_set(v___x_63_, 1, v___x_62_);
    return v___x_63_;
}
pub unsafe fn l_IO_CancelToken_new___boxed(
...
pub unsafe fn l_IO_CancelToken_set(
    mut v_tk_66_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_promise_68_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_setRef_69_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    v_promise_68_ = crate::leanh::lean_ctor_get(v_tk_66_, 0);
    v_setRef_69_ = crate::leanh::lean_ctor_get(v_tk_66_, 1);
    v___x_70_ = crate::leanh::lean_box(0);
    v___x_71_ = lean_io_promise_resolve(v___x_70_, v_promise_68_);
    v___x_72_ = 1;
    v___x_73_ = crate::leanh::lean_box((v___x_72_) as usize);
    v___x_74_ = lean_st_ref_set(v_setRef_69_, v___x_73_);
    return v___x_74_;
}
pub unsafe fn l_IO_CancelToken_set___boxed(
    mut v_tk_75_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec_ref(v_tk_75_);
    return v_res_77_;
}
pub unsafe fn l_IO_CancelToken_isSet(mut v_tk_78_: *mut crate::leanh::LeanObject) -> u8 {
    let mut v_setRef_80_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_81_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_82_: u8 = 0;
    v_setRef_80_ = crate::leanh::lean_ctor_get(v_tk_78_, 1);
    v___x_81_ = lean_st_ref_get(v_setRef_80_);
    v___x_82_ = (crate::leanh::lean_unbox(v___x_81_) as u8);
    crate::leanh::lean_dec(v___x_81_);
    return v___x_82_;
}
pub unsafe fn l_IO_CancelToken_isSet___boxed(
    mut v_tk_83_: *mut crate::leanh::LeanObject,
    mut v_a_84_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_85_: u8 = 0;
    let mut v_r_86_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_85_ = l_IO_CancelToken_isSet(v_tk_83_);
    crate::leanh::lean_dec_ref(v_tk_83_);
    v_r_86_ = crate::leanh::lean_box((v_res_85_) as usize);
    return v_r_86_;
}
pub unsafe fn l_IO_CancelToken_onSet___lam__0(
    mut v_action_87_: *mut crate::leanh::LeanObject,
    mut v_x_88_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v___x_90_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_90_ = crate::leanh::lean_apply_1(v_action_87_, crate::leanh::lean_box(0));
    return v___x_90_;
}
pub unsafe fn l_IO_CancelToken_onSet___lam__0___boxed(
    mut v_action_91_: *mut crate::leanh::LeanObject,
    mut v_x_92_: *mut crate::leanh::LeanObject,
    mut v___y_93_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_IO_CancelToken_onSet(
    mut v_tk_95_: *mut crate::leanh::LeanObject,
    mut v_action_96_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_promise_98_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    v_promise_98_ = crate::leanh::lean_ctor_get(v_tk_95_, 0);
    v___f_99_ = crate::leanh::lean_alloc_closure(
        l_IO_CancelToken_onSet___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    crate::leanh::lean_closure_set(v___f_99_, 0, v_action_96_);
...
pub unsafe fn l_IO_CancelToken_onSet___boxed(
    mut v_tk_104_: *mut crate::leanh::LeanObject,
    mut v_action_105_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec_ref(v_tk_104_);
    return v_res_107_;
}
pub unsafe fn lean_io_cancel_token_is_set(mut v_tk_108_: *mut crate::leanh::LeanObject) -> u8 {
    let mut v___x_110_: u8 = 0;
    v___x_110_ = l_IO_CancelToken_isSet(v_tk_108_);
    crate::leanh::lean_dec_ref(v_tk_108_);
    return v___x_110_;
}
pub unsafe fn l___private_Init_System_CancelToken_0__IO_CancelToken_isSetExport___boxed(
    mut v_tk_111_: *mut crate::leanh::LeanObject,
    mut v_a_112_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_113_: u8 = 0;
    let mut v_r_114_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_113_ = lean_io_cancel_token_is_set(v_tk_111_);
    v_r_114_ = crate::leanh::lean_box((v_res_113_) as usize);
    return v_r_114_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_System_CancelToken(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_System_CancelToken(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_System_CancelToken(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
