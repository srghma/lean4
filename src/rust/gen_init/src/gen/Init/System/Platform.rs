...
static mut l_System_Platform_isWindows___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
...
static mut l_System_Platform_isOSX___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
...
static mut l_System_Platform_isEmscripten___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
...
static mut l_System_Platform_target___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_System_Platform_target___closed__0: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static mut l_System_Platform_target: *mut leanh::LeanObject = core::ptr::null_mut();
pub unsafe fn l_System_Platform_getIsWindows___boxed(
    mut v_a_00___x40___internal___hyg_29_: *mut leanh::LeanObject,
    ...
    v_r_31_ = leanh::lean_box((v_res_30_) as usize);
    return v_r_31_;
}
pub unsafe fn l_System_Platform_getIsOSX___boxed(
    mut v_a_00___x40___internal___hyg_33_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_r_35_ = leanh::lean_box((v_res_34_) as usize);
    return v_r_35_;
}
...
pub unsafe fn _init_l_System_Platform_isWindows() -> u8 {
    ...
    v___x_42_ = leanh::lean_uint8_once(
...
pub unsafe fn _init_l_System_Platform_isOSX() -> u8 {
    ...
    v___x_45_ = leanh::lean_uint8_once(
...
pub unsafe fn _init_l_System_Platform_isEmscripten() -> u8 {
    ...
    v___x_48_ = leanh::lean_uint8_once(
...
pub unsafe fn l_System_Platform_getTarget___boxed(
    mut v_a_00___x40___internal___hyg_50_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_System_Platform_target___closed__0() -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_System_Platform_target() -> *mut leanh::LeanObject {
    let mut v___x_54_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_54_ = leanh::lean_obj_once(
...
pub unsafe fn runtime_initialize_Init_System_Platform(
    builtin: u8,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_mark_persistent(l_System_Platform_target);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
static mut _G_meta_initialized: bool = false;
pub unsafe fn meta_initialize_Init_System_Platform(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_System_Platform(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
