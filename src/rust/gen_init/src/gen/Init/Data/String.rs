...
use crate::r#gen::Init::Data::String::Decode::{
    initialize_Init_Data_String_Decode, runtime_initialize_Init_Data_String_Decode,
};
...
use crate::r#gen::Init::Data::String::Extra::{
    initialize_Init_Data_String_Extra, runtime_initialize_Init_Data_String_Extra,
};
...
use crate::r#gen::Init::Data::String::Hashable::{
    initialize_Init_Data_String_Hashable, runtime_initialize_Init_Data_String_Hashable,
};
...
use crate::r#gen::Init::Data::String::Iterator::{
    initialize_Init_Data_String_Iterator, runtime_initialize_Init_Data_String_Iterator,
};
use crate::r#gen::Init::Data::String::Legacy::{
    initialize_Init_Data_String_Legacy, runtime_initialize_Init_Data_String_Legacy,
};
use crate::r#gen::Init::Data::String::Lemmas::{
    initialize_Init_Data_String_Lemmas, runtime_initialize_Init_Data_String_Lemmas,
};
...
use crate::r#gen::Init::Data::String::Stream::{
    initialize_Init_Data_String_Stream, runtime_initialize_Init_Data_String_Stream,
};
use crate::r#gen::Init::Data::String::Subslice::{
    initialize_Init_Data_String_Subslice, runtime_initialize_Init_Data_String_Subslice,
};
use crate::r#gen::Init::Data::String::Substring::{
    initialize_Init_Data_String_Substring, runtime_initialize_Init_Data_String_Substring,
};
...
pub unsafe fn runtime_initialize_Init_Data_String(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_String(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
