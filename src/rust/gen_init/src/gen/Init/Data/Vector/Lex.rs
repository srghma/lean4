...
pub unsafe fn l___private_Init_Data_Vector_Lex_0__Break_runK_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_117_) == 0 {
        ...
        v___x_121_ = leanh::lean_apply_1(v_h__2_119_, v___x_120_);
        return v___x_121_;
    } else {
...
pub unsafe fn l___private_Init_Data_Vector_Lex_0__Break_runK_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_126_) == 0 {
        ...
        v___x_130_ = leanh::lean_apply_1(v_h__2_128_, v___x_129_);
        return v___x_130_;
    } else {
        let mut v_val_131_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_132_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_128_);
        v_val_131_ = leanh::lean_ctor_get(v_x_126_, 0);
        leanh::lean_inc(v_val_131_);
        leanh::lean_dec_ref_known(v_x_126_, 1);
        v___x_132_ = leanh::lean_apply_1(v_h__1_127_, v_val_131_);
        return v___x_132_;
    }
}
...
pub unsafe fn l_Vector_instTransLeOfLawfulOrderLTOfIsLinearOrder___boxed(
    ...
    mut v_n_151_: *mut leanh::LeanObject,
...
pub unsafe fn l_Vector_instDecidableLTOfDecidableEq___redArg(
    ...
    leanh::lean_closure_set(v___f_172_, 0, v_inst_169_);
    v___f_173_ = leanh::lean_alloc_closure(
        l_instBEqOfDecidableEq___redArg___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_173_, 0, v_inst_168_);
...
pub unsafe fn l_Vector_instDecidableLTOfDecidableEq___boxed(
    ...
    mut v_xs_195_: *mut leanh::LeanObject,
    mut v_ys_196_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Vector_instDecidableLEOfDecidableEqOfDecidableLT___redArg(
    ...
    leanh::lean_closure_set(v___f_204_, 0, v_inst_201_);
    v___f_205_ = leanh::lean_alloc_closure(
        l_instBEqOfDecidableEq___redArg___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_205_, 0, v_inst_200_);
...
pub unsafe fn l_Vector_instDecidableLEOfDecidableEqOfDecidableLT___redArg___boxed(
    ...
    mut v_ys_213_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Vector_instDecidableLEOfDecidableEqOfDecidableLT(
    ...
    mut v_ys_222_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Vector_instDecidableLEOfDecidableEqOfDecidableLT___boxed(
    ...
    mut v_n_225_: *mut leanh::LeanObject,
    mut v_inst_226_: *mut leanh::LeanObject,
    mut v_inst_227_: *mut leanh::LeanObject,
    mut v_inst_228_: *mut leanh::LeanObject,
    mut v_xs_229_: *mut leanh::LeanObject,
    mut v_ys_230_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_231_: u8 = 0;
    let mut v_r_232_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_r_232_ = leanh::lean_box((v_res_231_) as usize);
    return v_r_232_;
}
...
pub unsafe fn meta_initialize_Init_Data_Vector_Lex(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Vector_Lex(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
