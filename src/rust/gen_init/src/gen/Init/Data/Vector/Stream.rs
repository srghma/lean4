...
static mut l_Vector_instToStreamSubarray___closed__0: *mut crate::leanh::LeanObject =
...
pub unsafe fn l_Vector_instToStreamSubarray___lam__0(
    mut v_xs_12_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Vector_instToStreamSubarray(
    ...
    mut v_n_18_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Vector_instToStreamSubarray___boxed(
    ...
    mut v_n_21_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn initialize_Init_Data_Vector_Stream(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
