...
pub unsafe fn l_Std_Iter_attachWith(
    ...
    mut v_P_24_: *mut leanh::LeanObject,
    mut v_h_25_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_it_23_);
    return v_it_23_;
}
pub unsafe fn l_Std_Iter_attachWith___boxed(
    ...
    mut v_it_29_: *mut leanh::LeanObject,
    mut v_P_30_: *mut leanh::LeanObject,
    mut v_h_31_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_it_29_);
    leanh::lean_dec(v_inst_28_);
    return v_res_32_;
}
