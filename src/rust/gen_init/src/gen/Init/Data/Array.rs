...
// Imports: Init.Data.Array.Basic Init.Data.Array.QSort Init.Data.Array.BinSearch Init.Data.Array.InsertionSort Init.Data.Array.DecidableEq Init.Data.Array.Mem Init.Data.Array.Attach Init.Data.Array.BasicAux Init.Data.Array.Lemmas Init.Data.Array.TakeDrop Init.Data.Array.Bootstrap Init.Data.Array.GetLit Init.Data.Array.MapIdx Init.Data.Array.Set Init.Data.Array.Monadic Init.Data.Array.FinRange Init.Data.Array.Perm Init.Data.Array.Find Init.Data.Array.Lex Init.Data.Array.Range Init.Data.Array.Erase Init.Data.Array.Zip Init.Data.Array.InsertIdx Init.Data.Array.Extract Init.Data.Array.MinMax Init.Data.Array.Nat Init.Data.Array.Int Init.Data.Array.Count Init.Data.Array.Sort
...
use crate::r#gen::Init::Data::Array::BasicAux::{
    initialize_Init_Data_Array_BasicAux, runtime_initialize_Init_Data_Array_BasicAux,
};
use crate::r#gen::Init::Data::Array::BinSearch::{
    initialize_Init_Data_Array_BinSearch, runtime_initialize_Init_Data_Array_BinSearch,
};
...
use crate::r#gen::Init::Data::Array::Erase::{
    initialize_Init_Data_Array_Erase, runtime_initialize_Init_Data_Array_Erase,
};
use crate::r#gen::Init::Data::Array::Extract::{
    initialize_Init_Data_Array_Extract, runtime_initialize_Init_Data_Array_Extract,
};
use crate::r#gen::Init::Data::Array::FinRange::{
    initialize_Init_Data_Array_FinRange, runtime_initialize_Init_Data_Array_FinRange,
};
...
use crate::r#gen::Init::Data::Array::InsertionSort::{
    initialize_Init_Data_Array_InsertionSort, runtime_initialize_Init_Data_Array_InsertionSort,
};
use crate::r#gen::Init::Data::Array::Int::{
    initialize_Init_Data_Array_Int, runtime_initialize_Init_Data_Array_Int,
};
use crate::r#gen::Init::Data::Array::Lemmas::{
    initialize_Init_Data_Array_Lemmas, runtime_initialize_Init_Data_Array_Lemmas,
};
use crate::r#gen::Init::Data::Array::Lex::{
    initialize_Init_Data_Array_Lex, runtime_initialize_Init_Data_Array_Lex,
};
...
use crate::r#gen::Init::Data::Array::Sort::{
    initialize_Init_Data_Array_Sort, runtime_initialize_Init_Data_Array_Sort,
};
...
pub unsafe fn runtime_initialize_Init_Data_Array(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Array(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
