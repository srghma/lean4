...
// Imports: Init.Data.String.Search Init.Data.String.Search Init.Data.String.Lemmas.Slice Init.Data.String.Lemmas.FindPos
...
pub unsafe fn runtime_initialize_Init_Data_String_Lemmas_Search(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_String_Lemmas_Search(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String_Lemmas_Search(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
