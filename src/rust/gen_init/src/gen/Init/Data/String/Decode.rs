...
pub unsafe fn l_String_utf8EncodeCharFast(mut v_c_1180_: u32) -> *mut leanh::LeanObject {
    ...
    if v___x_1182_ == 0 {
        ...
        if v___x_1184_ == 0 {
            ...
            if v___x_1186_ == 0 {
                ...
                v___x_1210_ = leanh::lean_box((v___x_1208_) as usize);
                v___x_1211_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_1211_, 0, v___x_1210_);
                leanh::lean_ctor_set(v___x_1211_, 1, v___x_1209_);
                v___x_1212_ = leanh::lean_box((v___x_1205_) as usize);
                v___x_1213_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_1213_, 0, v___x_1212_);
                leanh::lean_ctor_set(v___x_1213_, 1, v___x_1211_);
                v___x_1214_ = leanh::lean_box((v___x_1200_) as usize);
                ...
                v___x_1216_ = leanh::lean_box((v___x_1193_) as usize);
                v___x_1217_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_1217_, 0, v___x_1216_);
                leanh::lean_ctor_set(v___x_1217_, 1, v___x_1215_);
                return v___x_1217_;
            } else {
                ...
                v___x_1236_ = leanh::lean_box((v___x_1234_) as usize);
                ...
                v___x_1238_ = leanh::lean_box((v___x_1231_) as usize);
                v___x_1239_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_1239_, 0, v___x_1238_);
                leanh::lean_ctor_set(v___x_1239_, 1, v___x_1237_);
                v___x_1240_ = leanh::lean_box((v___x_1224_) as usize);
                v___x_1241_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_1241_, 0, v___x_1240_);
                leanh::lean_ctor_set(v___x_1241_, 1, v___x_1239_);
                return v___x_1241_;
            }
        } else {
            ...
            v___x_1255_ = leanh::lean_box((v___x_1253_) as usize);
            v___x_1256_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
            leanh::lean_ctor_set(v___x_1256_, 0, v___x_1255_);
            leanh::lean_ctor_set(v___x_1256_, 1, v___x_1254_);
            v___x_1257_ = leanh::lean_box((v___x_1248_) as usize);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_ctorIdx(
    ...
    match v_x_1266_ {
        ...
        1 => {
            ...
            v___x_1268_ = leanh::lean_unsigned_to_nat(1);
            return v___x_1268_;
        }
        2 => {
        ...
        3 => {
            ...
            v___x_1270_ = leanh::lean_unsigned_to_nat(3);
            return v___x_1270_;
        }
        _ => {
            let mut v___x_1271_: *mut leanh::LeanObject = core::ptr::null_mut();
            v___x_1271_ = leanh::lean_unsigned_to_nat(4);
            return v___x_1271_;
        }
    }
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_ctorIdx___boxed(
    ...
    v_x_boxed_1273_ = (leanh::lean_unbox(v_x_1272_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_toCtorIdx___boxed(
    ...
    v_x_4__boxed_1278_ = (leanh::lean_unbox(v_x_1277_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_ctorElim(
    ...
    leanh::lean_inc(v_k_1287_);
    return v_k_1287_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_ctorElim___boxed(
    mut v_motive_1288_: *mut leanh::LeanObject,
    mut v_ctorIdx_1289_: *mut leanh::LeanObject,
    mut v_t_1290_: *mut leanh::LeanObject,
    mut v_h_1291_: *mut leanh::LeanObject,
    mut v_k_1292_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_1293_: u8 = 0;
    let mut v_res_1294_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_1293_ = (leanh::lean_unbox(v_t_1290_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_invalid_elim___redArg___boxed(
    ...
    leanh::lean_dec(v_invalid_1296_);
    return v_res_1297_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_invalid_elim(
    ...
    mut v_invalid_1301_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_invalid_1301_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_invalid_elim___boxed(
    ...
    mut v_invalid_1305_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_1306_: u8 = 0;
    let mut v_res_1307_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_1306_ = (leanh::lean_unbox(v_t_1303_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_done_elim(
    ...
    mut v_done_1314_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_done_1314_);
    return v_done_1314_;
}
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_oneMore_elim___redArg___boxed(
    ...
    leanh::lean_dec(v_oneMore_1322_);
    return v_res_1323_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_oneMore_elim(
    mut v_motive_1324_: *mut leanh::LeanObject,
    mut v_t_1325_: u8,
    mut v_h_1326_: *mut leanh::LeanObject,
    mut v_oneMore_1327_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_oneMore_1327_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_oneMore_elim___boxed(
    ...
    mut v_t_1329_: *mut leanh::LeanObject,
    mut v_h_1330_: *mut leanh::LeanObject,
    mut v_oneMore_1331_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_1332_: u8 = 0;
    let mut v_res_1333_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_1332_ = (leanh::lean_unbox(v_t_1329_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_twoMore_elim___redArg___boxed(
    ...
    leanh::lean_dec(v_twoMore_1335_);
    return v_res_1336_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_twoMore_elim(
    mut v_motive_1337_: *mut leanh::LeanObject,
    mut v_t_1338_: u8,
    mut v_h_1339_: *mut leanh::LeanObject,
    mut v_twoMore_1340_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_twoMore_1340_);
    return v_twoMore_1340_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_twoMore_elim___boxed(
    mut v_motive_1341_: *mut leanh::LeanObject,
    mut v_t_1342_: *mut leanh::LeanObject,
    mut v_h_1343_: *mut leanh::LeanObject,
    mut v_twoMore_1344_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_1345_: u8 = 0;
    let mut v_res_1346_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_1345_ = (leanh::lean_unbox(v_t_1342_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_threeMore_elim___redArg___boxed(
    ...
    leanh::lean_dec(v_threeMore_1348_);
    return v_res_1349_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_threeMore_elim(
    ...
    mut v_threeMore_1353_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_threeMore_1353_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_threeMore_elim___boxed(
    ...
    mut v_t_1355_: *mut leanh::LeanObject,
    mut v_h_1356_: *mut leanh::LeanObject,
    mut v_threeMore_1357_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_t_boxed_1358_: u8 = 0;
    let mut v_res_1359_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_1358_ = (leanh::lean_unbox(v_t_1355_) as u8);
    ...
    leanh::lean_dec(v_threeMore_1357_);
    return v_res_1359_;
}
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_parseFirstByte___boxed(
    ...
    v_b_boxed_1381_ = (leanh::lean_unbox(v_b_1380_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_isInvalidContinuationByte___boxed(
    ...
    v_b_boxed_1392_ = (leanh::lean_unbox(v_b_1391_) as u8);
    v_res_1393_ = l_ByteArray_utf8DecodeChar_x3f_isInvalidContinuationByte(v_b_boxed_1392_);
    v_r_1394_ = leanh::lean_box((v_res_1393_) as usize);
    return v_r_1394_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2081___redArg(
    ...
    v___x_1397_ = leanh::lean_box_uint32(v___x_1396_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2081___boxed(
    mut v_w_1407_: *mut leanh::LeanObject,
    mut v_h_1408_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_w_boxed_1409_: u8 = 0;
    let mut v_res_1410_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_w_boxed_1409_ = (leanh::lean_unbox(v_w_1407_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2081(
    mut v_w_1411_: u8,
    mut v___w_1412_: u8,
    mut v___h_1413_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2081___boxed(
    mut v_w_1415_: *mut leanh::LeanObject,
    mut v___w_1416_: *mut leanh::LeanObject,
    mut v___h_1417_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_w_boxed_1418_ = (leanh::lean_unbox(v_w_1415_) as u8);
    v___w_boxed_1419_ = (leanh::lean_unbox(v___w_1416_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2082Unchecked___boxed(
    mut v_w_1433_: *mut leanh::LeanObject,
    ...
    v_w_boxed_1435_ = (leanh::lean_unbox(v_w_1433_) as u8);
    v_x_boxed_1436_ = (leanh::lean_unbox(v_x_1434_) as u8);
    v_res_1437_ =
        l_ByteArray_utf8DecodeChar_x3f_assemble_u2082Unchecked(v_w_boxed_1435_, v_x_boxed_1436_);
    v_r_1438_ = leanh::lean_box_uint32(v_res_1437_);
    return v_r_1438_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2082(
    ...
    if v___x_1444_ == 0 {
        ...
        if v___x_1456_ == 0 {
            ...
            v___x_1457_ = leanh::lean_box_uint32(v_r_1454_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2082___boxed(
    mut v_w_1460_: *mut leanh::LeanObject,
    ...
    v_w_boxed_1462_ = (leanh::lean_unbox(v_w_1460_) as u8);
    v_x_boxed_1463_ = (leanh::lean_unbox(v_x_1461_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2082___boxed(
    mut v_w_1482_: *mut leanh::LeanObject,
    ...
    v_w_boxed_1484_ = (leanh::lean_unbox(v_w_1482_) as u8);
    v_x_boxed_1485_ = (leanh::lean_unbox(v_x_1483_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2083Unchecked___boxed(
    ...
    mut v_y_1507_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_w_boxed_1508_ = (leanh::lean_unbox(v_w_1505_) as u8);
    v_x_boxed_1509_ = (leanh::lean_unbox(v_x_1506_) as u8);
    v_y_boxed_1510_ = (leanh::lean_unbox(v_y_1507_) as u8);
    v_res_1511_ = l_ByteArray_utf8DecodeChar_x3f_assemble_u2083Unchecked(
        v_w_boxed_1508_,
        v_x_boxed_1509_,
        v_y_boxed_1510_,
    );
    v_r_1512_ = leanh::lean_box_uint32(v_res_1511_);
    return v_r_1512_;
}
        ...
        if v___x_1522_ == 0 {
            ...
            if v___x_1539_ == 0 {
                ...
                if v___x_1541_ == 0 {
                    ...
                    v___x_1542_ = leanh::lean_box_uint32(v_r_1537_);
                    v___x_1543_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    ...
                    if v___x_1545_ == 0 {
                        ...
                        v___x_1546_ = leanh::lean_box_uint32(v_r_1537_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2083___boxed(
    mut v_w_1550_: *mut leanh::LeanObject,
    mut v_x_1551_: *mut leanh::LeanObject,
    mut v_y_1552_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_w_boxed_1553_ = (leanh::lean_unbox(v_w_1550_) as u8);
    v_x_boxed_1554_ = (leanh::lean_unbox(v_x_1551_) as u8);
    v_y_boxed_1555_ = (leanh::lean_unbox(v_y_1552_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2083___boxed(
    mut v_w_1587_: *mut leanh::LeanObject,
    mut v_x_1588_: *mut leanh::LeanObject,
    mut v_y_1589_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_w_boxed_1590_: u8 = 0;
    let mut v_x_boxed_1591_: u8 = 0;
    let mut v_y_boxed_1592_: u8 = 0;
    let mut v_res_1593_: u8 = 0;
    let mut v_r_1594_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_w_boxed_1590_ = (leanh::lean_unbox(v_w_1587_) as u8);
    v_x_boxed_1591_ = (leanh::lean_unbox(v_x_1588_) as u8);
    v_y_boxed_1592_ = (leanh::lean_unbox(v_y_1589_) as u8);
    v_res_1593_ = l_ByteArray_utf8DecodeChar_x3f_verify_u2083(
        v_w_boxed_1590_,
        v_x_boxed_1591_,
        v_y_boxed_1592_,
    );
    v_r_1594_ = leanh::lean_box((v_res_1593_) as usize);
    return v_r_1594_;
}
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2084Unchecked___boxed(
    mut v_w_1618_: *mut leanh::LeanObject,
    mut v_x_1619_: *mut leanh::LeanObject,
    mut v_y_1620_: *mut leanh::LeanObject,
    mut v_z_1621_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    let mut v_r_1627_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_w_boxed_1622_ = (leanh::lean_unbox(v_w_1618_) as u8);
    v_x_boxed_1623_ = (leanh::lean_unbox(v_x_1619_) as u8);
    v_y_boxed_1624_ = (leanh::lean_unbox(v_y_1620_) as u8);
    v_z_boxed_1625_ = (leanh::lean_unbox(v_z_1621_) as u8);
    ...
    v_r_1627_ = leanh::lean_box_uint32(v_res_1626_);
    return v_r_1627_;
}
            ...
            if v___x_1641_ == 0 {
                ...
                if v___x_1663_ == 0 {
                    ...
                    if v___x_1665_ == 0 {
                        ...
                        v___x_1666_ = leanh::lean_box_uint32(v_r_1661_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2084___boxed(
    mut v_w_1670_: *mut leanh::LeanObject,
    mut v_x_1671_: *mut leanh::LeanObject,
    mut v_y_1672_: *mut leanh::LeanObject,
    mut v_z_1673_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_w_boxed_1674_ = (leanh::lean_unbox(v_w_1670_) as u8);
    v_x_boxed_1675_ = (leanh::lean_unbox(v_x_1671_) as u8);
    v_y_boxed_1676_ = (leanh::lean_unbox(v_y_1672_) as u8);
    v_z_boxed_1677_ = (leanh::lean_unbox(v_z_1673_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2084___boxed(
    mut v_w_1715_: *mut leanh::LeanObject,
    mut v_x_1716_: *mut leanh::LeanObject,
    mut v_y_1717_: *mut leanh::LeanObject,
    mut v_z_1718_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_w_boxed_1719_ = (leanh::lean_unbox(v_w_1715_) as u8);
    v_x_boxed_1720_ = (leanh::lean_unbox(v_x_1716_) as u8);
    v_y_boxed_1721_ = (leanh::lean_unbox(v_y_1717_) as u8);
    v_z_boxed_1722_ = (leanh::lean_unbox(v_z_1718_) as u8);
    ...
    v_r_1724_ = leanh::lean_box((v_res_1723_) as usize);
    return v_r_1724_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f(
    mut v_bytes_1725_: *mut leanh::LeanObject,
    mut v_i_1726_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    if v___x_1728_ == 0 {
        ...
        if v___x_1734_ == 0 {
            ...
            if v___x_1738_ == 0 {
                ...
                if v___x_1741_ == 0 {
                    ...
                    if v___x_1744_ == 0 {
                        ...
                        v___x_1746_ = leanh::lean_unsigned_to_nat(3);
                        v___x_1747_ = lean_nat_add(v_i_1726_, v___x_1746_);
                        v___x_1748_ = lean_nat_dec_lt(v___x_1747_, v___x_1727_);
                        if v___x_1748_ == 0 {
                            let mut v___x_1749_: *mut leanh::LeanObject =
                                core::ptr::null_mut();
                            leanh::lean_dec(v___x_1747_);
                            v___x_1749_ = leanh::lean_box(0);
                            return v___x_1749_;
                        } else {
                            let mut v___x_1750_: *mut leanh::LeanObject =
                                core::ptr::null_mut();
                            let mut v___x_1751_: *mut leanh::LeanObject =
                                core::ptr::null_mut();
                            ...
                            if v___x_1754_ == 0 {
                                let mut v___x_1755_: *mut leanh::LeanObject =
                                    core::ptr::null_mut();
                                leanh::lean_dec(v___x_1747_);
                                v___x_1755_ = leanh::lean_box(0);
                                return v___x_1755_;
                            } else {
                                let mut v___x_1756_: *mut leanh::LeanObject =
                                    core::ptr::null_mut();
                                let mut v___x_1757_: *mut leanh::LeanObject =
                                    core::ptr::null_mut();
                                let mut v___x_1758_: u8 = 0;
                                let mut v___x_1759_: u8 = 0;
                                let mut v___x_1760_: u8 = 0;
                                v___x_1756_ = leanh::lean_unsigned_to_nat(2);
                                ...
                                if v___x_1760_ == 0 {
                                    let mut v___x_1761_: *mut leanh::LeanObject =
                                        core::ptr::null_mut();
                                    leanh::lean_dec(v___x_1747_);
                                    ...
                                    if v___x_1764_ == 0 {
                                        let mut v___x_1765_: *mut leanh::LeanObject =
                                            core::ptr::null_mut();
                                        ...
                                        if v___x_1786_ == 0 {
                                            ...
                                            if v___x_1788_ == 0 {
                                                let mut v___x_1789_: *mut leanh::LeanObject =
                                                    core::ptr::null_mut();
                                                let mut v___x_1790_: *mut leanh::LeanObject =
                                                    core::ptr::null_mut();
                                                v___x_1789_ =
                                                    leanh::lean_box_uint32(v_r_1784_);
                                                v___x_1790_ =
                                                ...
                                                let mut v___x_1791_: *mut leanh::LeanObject =
                                                    core::ptr::null_mut();
                                                v___x_1791_ = leanh::lean_box(0);
                                                return v___x_1791_;
                                            }
                                        } else {
                                            let mut v___x_1792_: *mut leanh::LeanObject =
                                                core::ptr::null_mut();
                    ...
                    if v___x_1795_ == 0 {
                        ...
                        if v___x_1801_ == 0 {
                            let mut v___x_1802_: *mut leanh::LeanObject =
                                core::ptr::null_mut();
                            leanh::lean_dec(v___x_1794_);
                            ...
                            if v___x_1805_ == 0 {
                                let mut v___x_1806_: *mut leanh::LeanObject =
                                    core::ptr::null_mut();
                                ...
                                if v___x_1822_ == 0 {
                                    ...
                                    if v___x_1824_ == 0 {
                                        let mut v___x_1825_: *mut leanh::LeanObject =
                                            core::ptr::null_mut();
                                        let mut v___x_1826_: *mut leanh::LeanObject =
                                            core::ptr::null_mut();
                                        v___x_1825_ = leanh::lean_box_uint32(v_r_1820_);
                                        v___x_1826_ =
                                            leanh::lean_alloc_ctor(1, 1, (0) as u32);
                                        ...
                                        if v___x_1828_ == 0 {
                                            let mut v___x_1829_: *mut leanh::LeanObject =
                                                core::ptr::null_mut();
                                            let mut v___x_1830_: *mut leanh::LeanObject =
                                                core::ptr::null_mut();
                                            v___x_1829_ = leanh::lean_box_uint32(v_r_1820_);
                                            v___x_1830_ =
                                                leanh::lean_alloc_ctor(1, 1, (0) as u32);
                                            leanh::lean_ctor_set(
                                                v___x_1830_,
                                            ...
                                            let mut v___x_1831_: *mut leanh::LeanObject =
                                                core::ptr::null_mut();
                ...
                if v___x_1835_ == 0 {
                    ...
                    if v___x_1839_ == 0 {
                        ...
                        if v___x_1851_ == 0 {
                            let mut v___x_1852_: *mut leanh::LeanObject =
                                core::ptr::null_mut();
                            let mut v___x_1853_: *mut leanh::LeanObject =
                                core::ptr::null_mut();
                            v___x_1852_ = leanh::lean_box_uint32(v_r_1849_);
                            v___x_1853_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                            leanh::lean_ctor_set(v___x_1853_, 0, v___x_1852_);
                            return v___x_1853_;
                        } else {
                            let mut v___x_1854_: *mut leanh::LeanObject =
                                core::ptr::null_mut();
            ...
            v___x_1856_ = leanh::lean_box_uint32(v___x_1855_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f___boxed(
    mut v_bytes_1858_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_i_1859_);
    leanh::lean_dec_ref(v_bytes_1858_);
    return v_res_1860_;
}
pub unsafe fn l_ByteArray_validateUTF8At(
    mut v_bytes_1861_: *mut leanh::LeanObject,
            ...
            if v___x_1873_ == 0 {
                ...
                if v___x_1876_ == 0 {
                    ...
                    if v___x_1879_ == 0 {
                        ...
                        v___x_1880_ = leanh::lean_unsigned_to_nat(3);
                        ...
                        if v___x_1882_ == 0 {
                            ...
                            if v___x_1887_ == 0 {
                                ...
                                let mut v___x_1888_: *mut leanh::LeanObject =
                                    core::ptr::null_mut();
                                let mut v___x_1889_: *mut leanh::LeanObject =
                                    core::ptr::null_mut();
                    ...
                    v___x_1919_ = leanh::lean_unsigned_to_nat(2);
                ...
                v___x_1950_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_ByteArray_validateUTF8At___boxed(
    mut v_bytes_1967_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_bytes_1967_);
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter___redArg(
    mut v_x_1971_: u8,
    mut v_h__1_1972_: *mut leanh::LeanObject,
    mut v_h__2_1973_: *mut leanh::LeanObject,
    mut v_h__3_1974_: *mut leanh::LeanObject,
    mut v_h__4_1975_: *mut leanh::LeanObject,
    mut v_h__5_1976_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match v_x_1971_ {
        0 => {
            let mut v___x_1977_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__5_1976_);
            leanh::lean_dec(v_h__4_1975_);
            leanh::lean_dec(v_h__3_1974_);
            leanh::lean_dec(v_h__2_1973_);
            v___x_1977_ = leanh::lean_apply_1(v_h__1_1972_, leanh::lean_box(0));
            return v___x_1977_;
        }
        1 => {
            ...
            leanh::lean_dec(v_h__4_1975_);
            leanh::lean_dec(v_h__3_1974_);
            leanh::lean_dec(v_h__1_1972_);
            v___x_1978_ = leanh::lean_apply_1(v_h__2_1973_, leanh::lean_box(0));
            return v___x_1978_;
        }
        2 => {
            ...
            leanh::lean_dec(v_h__2_1973_);
            leanh::lean_dec(v_h__1_1972_);
            v___x_1979_ = leanh::lean_apply_1(v_h__3_1974_, leanh::lean_box(0));
            return v___x_1979_;
        }
        3 => {
            ...
            leanh::lean_dec(v_h__2_1973_);
            leanh::lean_dec(v_h__1_1972_);
            v___x_1980_ = leanh::lean_apply_1(v_h__4_1975_, leanh::lean_box(0));
            return v___x_1980_;
        }
        _ => {
            ...
            leanh::lean_dec(v_h__2_1973_);
            leanh::lean_dec(v_h__1_1972_);
            v___x_1981_ = leanh::lean_apply_1(v_h__5_1976_, leanh::lean_box(0));
            return v___x_1981_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter___redArg___boxed(
    ...
    mut v_h__1_1983_: *mut leanh::LeanObject,
    mut v_h__2_1984_: *mut leanh::LeanObject,
    mut v_h__3_1985_: *mut leanh::LeanObject,
    mut v_h__4_1986_: *mut leanh::LeanObject,
    mut v_h__5_1987_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_x_47__boxed_1988_: u8 = 0;
    let mut v_res_1989_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_47__boxed_1988_ = (leanh::lean_unbox(v_x_1982_) as u8);
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter(
    mut v_motive_1990_: *mut leanh::LeanObject,
    mut v_x_1991_: u8,
    mut v_h__1_1992_: *mut leanh::LeanObject,
    mut v_h__2_1993_: *mut leanh::LeanObject,
    mut v_h__3_1994_: *mut leanh::LeanObject,
    mut v_h__4_1995_: *mut leanh::LeanObject,
    mut v_h__5_1996_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match v_x_1991_ {
        0 => {
            let mut v___x_1997_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__5_1996_);
            leanh::lean_dec(v_h__4_1995_);
            leanh::lean_dec(v_h__3_1994_);
            leanh::lean_dec(v_h__2_1993_);
            v___x_1997_ = leanh::lean_apply_1(v_h__1_1992_, leanh::lean_box(0));
            return v___x_1997_;
        }
        1 => {
            ...
            leanh::lean_dec(v_h__4_1995_);
            leanh::lean_dec(v_h__3_1994_);
            leanh::lean_dec(v_h__1_1992_);
            v___x_1998_ = leanh::lean_apply_1(v_h__2_1993_, leanh::lean_box(0));
            return v___x_1998_;
        }
        2 => {
            ...
            leanh::lean_dec(v_h__2_1993_);
            leanh::lean_dec(v_h__1_1992_);
            v___x_1999_ = leanh::lean_apply_1(v_h__3_1994_, leanh::lean_box(0));
            return v___x_1999_;
        }
        3 => {
            ...
            leanh::lean_dec(v_h__2_1993_);
            leanh::lean_dec(v_h__1_1992_);
            v___x_2000_ = leanh::lean_apply_1(v_h__4_1995_, leanh::lean_box(0));
            return v___x_2000_;
        }
        _ => {
            ...
            leanh::lean_dec(v_h__2_1993_);
            leanh::lean_dec(v_h__1_1992_);
            v___x_2001_ = leanh::lean_apply_1(v_h__5_1996_, leanh::lean_box(0));
            return v___x_2001_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter___boxed(
    ...
    mut v_h__1_2004_: *mut leanh::LeanObject,
    mut v_h__2_2005_: *mut leanh::LeanObject,
    mut v_h__3_2006_: *mut leanh::LeanObject,
    mut v_h__4_2007_: *mut leanh::LeanObject,
    mut v_h__5_2008_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_x_60__boxed_2009_: u8 = 0;
    let mut v_res_2010_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_60__boxed_2009_ = (leanh::lean_unbox(v_x_2003_) as u8);
    v_res_2010_ =
...
pub unsafe fn l_ByteArray_utf8DecodeChar___redArg(
    mut v_bytes_2011_: *mut leanh::LeanObject,
    ...
    if v___x_2019_ == 0 {
        ...
        if v___x_2023_ == 0 {
            ...
            if v___x_2026_ == 0 {
                ...
                v___x_2030_ = leanh::lean_unsigned_to_nat(3);
                ...
                v___x_2038_ = leanh::lean_unsigned_to_nat(2);
            ...
            v___x_2100_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_ByteArray_utf8DecodeChar___redArg___boxed(
    mut v_bytes_2118_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_bytes_2118_);
    v_r_2121_ = leanh::lean_box_uint32(v_res_2120_);
    return v_r_2121_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar(
    mut v_bytes_2122_: *mut leanh::LeanObject,
    mut v_i_2123_: *mut leanh::LeanObject,
    mut v_h_2124_: *mut leanh::LeanObject,
) -> u32 {
    ...
    if v___x_2131_ == 0 {
        ...
        if v___x_2135_ == 0 {
            ...
            if v___x_2138_ == 0 {
                ...
                v___x_2142_ = leanh::lean_unsigned_to_nat(3);
                ...
                v___x_2150_ = leanh::lean_unsigned_to_nat(2);
                ...
                v___x_2181_ = leanh::lean_unsigned_to_nat(2);
            ...
            v___x_2212_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_ByteArray_utf8DecodeChar___boxed(
    mut v_bytes_2230_: *mut leanh::LeanObject,
    mut v_i_2231_: *mut leanh::LeanObject,
    mut v_h_2232_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_i_2231_);
    leanh::lean_dec_ref(v_bytes_2230_);
    v_r_2234_ = leanh::lean_box_uint32(v_res_2233_);
    return v_r_2234_;
}
...
pub unsafe fn l_UInt8_instDecidableIsUTF8FirstByte___boxed(
    ...
    let mut v_r_2259_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___y_4__boxed_2257_ = (leanh::lean_unbox(v___y_2256_) as u8);
    v_res_2258_ = l_UInt8_instDecidableIsUTF8FirstByte(v___y_4__boxed_2257_);
    v_r_2259_ = leanh::lean_box((v_res_2258_) as usize);
    return v_r_2259_;
}
pub unsafe fn l_UInt8_utf8ByteSize___redArg(mut v_c_2260_: u8) -> *mut leanh::LeanObject {
    ...
    if v___x_2264_ == 0 {
        ...
        if v___x_2268_ == 0 {
            ...
            if v___x_2271_ == 0 {
                ...
                v___x_2272_ = leanh::lean_unsigned_to_nat(4);
                return v___x_2272_;
            } else {
                let mut v___x_2273_: *mut leanh::LeanObject = core::ptr::null_mut();
                v___x_2273_ = leanh::lean_unsigned_to_nat(3);
                return v___x_2273_;
            }
        } else {
            let mut v___x_2274_: *mut leanh::LeanObject = core::ptr::null_mut();
            v___x_2274_ = leanh::lean_unsigned_to_nat(2);
            return v___x_2274_;
        }
    } else {
    ...
    if v___x_2284_ == 0 {
        ...
        if v___x_2288_ == 0 {
            ...
            if v___x_2291_ == 0 {
                ...
                v___x_2292_ = leanh::lean_unsigned_to_nat(4);
                return v___x_2292_;
            } else {
                let mut v___x_2293_: *mut leanh::LeanObject = core::ptr::null_mut();
                v___x_2293_ = leanh::lean_unsigned_to_nat(3);
                return v___x_2293_;
            }
        } else {
            let mut v___x_2294_: *mut leanh::LeanObject = core::ptr::null_mut();
            v___x_2294_ = leanh::lean_unsigned_to_nat(2);
            return v___x_2294_;
        }
    } else {
...
pub unsafe fn l_UInt8_utf8ByteSize___boxed(
    mut v_c_2296_: *mut leanh::LeanObject,
    mut v___h_2297_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_2298_: u8 = 0;
    let mut v_res_2299_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_2298_ = (leanh::lean_unbox(v_c_2296_) as u8);
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize(
    ...
    match v_x_2300_ {
        ...
        2 => {
            ...
            v___x_2303_ = leanh::lean_unsigned_to_nat(2);
            return v___x_2303_;
        }
        3 => {
        ...
        _ => {
            ...
            v___x_2305_ = leanh::lean_unsigned_to_nat(4);
            return v___x_2305_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize___boxed(
    ...
    v_x_54__boxed_2307_ = (leanh::lean_unbox(v_x_2306_) as u8);
    v_res_2308_ =
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter___redArg(
    ...
    mut v_h__3_2312_: *mut leanh::LeanObject,
    mut v_h__4_2313_: *mut leanh::LeanObject,
    mut v_h__5_2314_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match v_x_2309_ {
        0 => {
            let mut v___x_2315_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_2316_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__5_2314_);
            leanh::lean_dec(v_h__4_2313_);
            leanh::lean_dec(v_h__3_2312_);
            leanh::lean_dec(v_h__2_2311_);
            v___x_2315_ = leanh::lean_box(0);
            v___x_2316_ = leanh::lean_apply_1(v_h__1_2310_, v___x_2315_);
            return v___x_2316_;
        }
        1 => {
            ...
            v___x_2318_ = leanh::lean_apply_1(v_h__2_2311_, v___x_2317_);
            return v___x_2318_;
        }
        2 => {
            ...
            v___x_2320_ = leanh::lean_apply_1(v_h__3_2312_, v___x_2319_);
            return v___x_2320_;
        }
        3 => {
            ...
            v___x_2322_ = leanh::lean_apply_1(v_h__4_2313_, v___x_2321_);
            return v___x_2322_;
        }
        _ => {
            ...
            v___x_2324_ = leanh::lean_apply_1(v_h__5_2314_, v___x_2323_);
            return v___x_2324_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter___redArg___boxed(
    ...
    mut v_h__1_2326_: *mut leanh::LeanObject,
    mut v_h__2_2327_: *mut leanh::LeanObject,
    mut v_h__3_2328_: *mut leanh::LeanObject,
    mut v_h__4_2329_: *mut leanh::LeanObject,
    mut v_h__5_2330_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_x_56__boxed_2331_: u8 = 0;
    let mut v_res_2332_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_56__boxed_2331_ = (leanh::lean_unbox(v_x_2325_) as u8);
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter(
    ...
    mut v_x_2334_: u8,
    mut v_h__1_2335_: *mut leanh::LeanObject,
    mut v_h__2_2336_: *mut leanh::LeanObject,
    mut v_h__3_2337_: *mut leanh::LeanObject,
    mut v_h__4_2338_: *mut leanh::LeanObject,
    mut v_h__5_2339_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match v_x_2334_ {
        0 => {
            let mut v___x_2340_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_2341_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__5_2339_);
            leanh::lean_dec(v_h__4_2338_);
            leanh::lean_dec(v_h__3_2337_);
            leanh::lean_dec(v_h__2_2336_);
            v___x_2340_ = leanh::lean_box(0);
            v___x_2341_ = leanh::lean_apply_1(v_h__1_2335_, v___x_2340_);
            return v___x_2341_;
        }
        1 => {
            ...
            leanh::lean_dec(v_h__4_2338_);
            leanh::lean_dec(v_h__3_2337_);
            leanh::lean_dec(v_h__1_2335_);
            v___x_2342_ = leanh::lean_box(0);
            v___x_2343_ = leanh::lean_apply_1(v_h__2_2336_, v___x_2342_);
            return v___x_2343_;
        }
        2 => {
            ...
            v___x_2345_ = leanh::lean_apply_1(v_h__3_2337_, v___x_2344_);
            return v___x_2345_;
        }
        3 => {
            ...
            v___x_2347_ = leanh::lean_apply_1(v_h__4_2338_, v___x_2346_);
            return v___x_2347_;
        }
        _ => {
            ...
            v___x_2349_ = leanh::lean_apply_1(v_h__5_2339_, v___x_2348_);
            return v___x_2349_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter___boxed(
    ...
    mut v_h__1_2352_: *mut leanh::LeanObject,
    mut v_h__2_2353_: *mut leanh::LeanObject,
    mut v_h__3_2354_: *mut leanh::LeanObject,
    mut v_h__4_2355_: *mut leanh::LeanObject,
    mut v_h__5_2356_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_x_79__boxed_2357_: u8 = 0;
    let mut v_res_2358_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_79__boxed_2357_ = (leanh::lean_unbox(v_x_2351_) as u8);
...
pub unsafe fn initialize_Init_Data_String_Decode(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
