...
// Imports: Init.GetElem Init.Data.List.Erase Init.Data.List.Lemmas Init.Data.List.Nat.Modify Init.Data.Nat.Lemmas Init.Data.Option.Lemmas Init.Omega
...
pub unsafe fn runtime_initialize_Init_Data_List_Nat_InsertIdx(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_List_Nat_InsertIdx(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Nat_InsertIdx(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
