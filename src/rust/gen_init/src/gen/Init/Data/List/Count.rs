...
pub unsafe fn l___private_Init_Data_List_Count_0__List_findIdx_go_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_35_) == 0 {
        ...
        v___x_39_ = leanh::lean_apply_1(v_h__1_37_, v_x_36_);
        return v___x_39_;
    } else {
        ...
        v_head_40_ = leanh::lean_ctor_get(v_x_35_, 0);
        leanh::lean_inc(v_head_40_);
        v_tail_41_ = leanh::lean_ctor_get(v_x_35_, 1);
        leanh::lean_inc(v_tail_41_);
        leanh::lean_dec_ref_known(v_x_35_, 2);
        v___x_42_ = leanh::lean_apply_3(v_h__2_38_, v_head_40_, v_tail_41_, v_x_36_);
        return v___x_42_;
    }
}
...
pub unsafe fn l___private_Init_Data_List_Count_0__List_filterMap_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_53_) == 0 {
        ...
        v___x_56_ = leanh::lean_box(0);
        v___x_57_ = leanh::lean_apply_1(v_h__1_54_, v___x_56_);
        return v___x_57_;
    } else {
        ...
        v_val_58_ = leanh::lean_ctor_get(v_x_53_, 0);
        leanh::lean_inc(v_val_58_);
        leanh::lean_dec_ref_known(v_x_53_, 1);
        v___x_59_ = leanh::lean_apply_1(v_h__2_55_, v_val_58_);
        return v___x_59_;
    }
}
pub unsafe fn l___private_Init_Data_List_Count_0__List_filterMap_match__1_splitter(
    mut v_00_u03b2_60_: *mut leanh::LeanObject,
    mut v_motive_61_: *mut leanh::LeanObject,
    mut v_x_62_: *mut leanh::LeanObject,
    mut v_h__1_63_: *mut leanh::LeanObject,
    mut v_h__2_64_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_x_62_) == 0 {
        let mut v___x_65_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_66_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_64_);
        v___x_65_ = leanh::lean_box(0);
        v___x_66_ = leanh::lean_apply_1(v_h__1_63_, v___x_65_);
        return v___x_66_;
    } else {
        let mut v_val_67_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_68_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_63_);
        v_val_67_ = leanh::lean_ctor_get(v_x_62_, 0);
        leanh::lean_inc(v_val_67_);
        leanh::lean_dec_ref_known(v_x_62_, 1);
        v___x_68_ = leanh::lean_apply_1(v_h__2_64_, v_val_67_);
        return v___x_68_;
    }
}
...
pub unsafe fn meta_initialize_Init_Data_List_Count(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Count(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
