...
static mut l_List_ofFnM___redArg___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_List_ofFnM___redArg___closed__0_value) as *mut crate::leanh::LeanObject;
pub unsafe fn l_Fin_foldr_loop___at___00List_ofFn_spec__0___redArg(
    mut v_f_62_: *mut crate::leanh::LeanObject,
    mut v_i_63_: *mut crate::leanh::LeanObject,
    mut v_a_64_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_zero_65_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_66_: u8 = 0;
    let mut v_one_67_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_68_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_65_ = crate::leanh::lean_unsigned_to_nat(0);
                v_isZero_66_ = lean_nat_dec_eq(v_i_63_, v_zero_65_);
                if v_isZero_66_ == 1 {
                    crate::leanh::lean_dec(v_i_63_);
                    crate::leanh::lean_dec(v_f_62_);
                    return v_a_64_;
                } else {
                    v_one_67_ = crate::leanh::lean_unsigned_to_nat(1);
                    v_n_68_ = lean_nat_sub(v_i_63_, v_one_67_);
                    crate::leanh::lean_dec(v_i_63_);
                    crate::leanh::lean_inc(v_f_62_);
                    crate::leanh::lean_inc(v_n_68_);
                    v___x_69_ = crate::leanh::lean_apply_1(v_f_62_, v_n_68_);
                    v___x_70_ = crate::leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    crate::leanh::lean_ctor_set(v___x_70_, 0, v___x_69_);
                    crate::leanh::lean_ctor_set(v___x_70_, 1, v_a_64_);
                    v_i_63_ = v_n_68_;
                    v_a_64_ = v___x_70_;
                    state = 0;
                    continue;
...
pub unsafe fn l_Fin_foldr_loop___at___00List_ofFn_spec__0___boxed(
    ...
    mut v_i_90_: *mut crate::leanh::LeanObject,
    mut v_a_91_: *mut crate::leanh::LeanObject,
    mut v_a_92_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_List_ofFnM___redArg___lam__0(
    mut v_xs_94_: *mut crate::leanh::LeanObject,
    mut v_x_95_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v___x_96_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_96_ = crate::leanh::lean_alloc_ctor(1, 2, (0) as u32);
    crate::leanh::lean_ctor_set(v___x_96_, 0, v_x_95_);
    crate::leanh::lean_ctor_set(v___x_96_, 1, v_xs_94_);
    return v___x_96_;
}
pub unsafe fn l_List_ofFnM___redArg___lam__1(
    mut v_f_97_: *mut crate::leanh::LeanObject,
    mut v_map_98_: *mut crate::leanh::LeanObject,
    mut v_xs_99_: *mut crate::leanh::LeanObject,
    mut v_i_100_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_closure_set(v___f_101_, 0, v_xs_99_);
    v___x_102_ = crate::leanh::lean_apply_1(v_f_97_, v_i_100_);
...
pub unsafe fn l_List_ofFnM___redArg(
    mut v_n_105_: *mut crate::leanh::LeanObject,
    mut v_inst_106_: *mut crate::leanh::LeanObject,
    mut v_f_107_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_toApplicative_108_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_109_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_map_110_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___f_111_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    v_toApplicative_108_ = crate::leanh::lean_ctor_get(v_inst_106_, 0);
    v_toFunctor_109_ = crate::leanh::lean_ctor_get(v_toApplicative_108_, 0);
    v_map_110_ = crate::leanh::lean_ctor_get(v_toFunctor_109_, 0);
    crate::leanh::lean_inc_n(v_map_110_, 2);
    v___f_111_ = crate::leanh::lean_alloc_closure(
        l_List_ofFnM___redArg___lam__1 as *mut core::ffi::c_void,
        4,
        2,
    );
    crate::leanh::lean_closure_set(v___f_111_, 0, v_f_107_);
    crate::leanh::lean_closure_set(v___f_111_, 1, v_map_110_);
    v___x_112_ = l_List_ofFnM___redArg___closed__0;
    v___x_113_ = crate::leanh::lean_box(0);
    v___x_114_ = crate::leanh::lean_unsigned_to_nat(0);
    ...
    v___x_116_ = crate::leanh::lean_apply_4(
        v_map_110_,
        crate::leanh::lean_box(0),
        crate::leanh::lean_box(0),
        v___x_112_,
...
pub unsafe fn l_List_ofFnM(
    ...
    mut v_f_121_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn runtime_initialize_Init_Data_List_OfFn(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List_OfFn(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_OfFn(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
