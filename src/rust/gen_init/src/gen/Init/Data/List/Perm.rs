...
pub unsafe fn l___private_Init_Data_List_Perm_0__List_foldl_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_86_) == 0 {
        ...
        v___x_89_ = leanh::lean_apply_1(v_h__1_87_, v_x_85_);
        return v___x_89_;
    } else {
        let mut v_head_90_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_91_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_92_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_87_);
        v_head_90_ = leanh::lean_ctor_get(v_x_86_, 0);
        leanh::lean_inc(v_head_90_);
        v_tail_91_ = leanh::lean_ctor_get(v_x_86_, 1);
        leanh::lean_inc(v_tail_91_);
        leanh::lean_dec_ref_known(v_x_86_, 2);
        v___x_92_ = leanh::lean_apply_3(v_h__2_88_, v_x_85_, v_head_90_, v_tail_91_);
        return v___x_92_;
    }
}
pub unsafe fn l___private_Init_Data_List_Perm_0__List_foldl_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_97_) == 0 {
        ...
        v___x_100_ = leanh::lean_apply_1(v_h__1_98_, v_x_96_);
        return v___x_100_;
    } else {
        ...
        v_head_101_ = leanh::lean_ctor_get(v_x_97_, 0);
        leanh::lean_inc(v_head_101_);
        v_tail_102_ = leanh::lean_ctor_get(v_x_97_, 1);
        leanh::lean_inc(v_tail_102_);
        leanh::lean_dec_ref_known(v_x_97_, 2);
        v___x_103_ = leanh::lean_apply_3(v_h__2_99_, v_x_96_, v_head_101_, v_tail_102_);
        return v___x_103_;
    }
}
pub unsafe fn l___private_Init_Data_List_Perm_0__List_reverseAux_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_104_) == 0 {
        ...
        leanh::lean_dec(v_h__2_107_);
        v___x_108_ = leanh::lean_apply_1(v_h__1_106_, v_x_105_);
        return v___x_108_;
    } else {
        ...
        leanh::lean_dec(v_h__1_106_);
        v_head_109_ = leanh::lean_ctor_get(v_x_104_, 0);
        leanh::lean_inc(v_head_109_);
        v_tail_110_ = leanh::lean_ctor_get(v_x_104_, 1);
        leanh::lean_inc(v_tail_110_);
        leanh::lean_dec_ref_known(v_x_104_, 2);
        v___x_111_ = leanh::lean_apply_3(v_h__2_107_, v_head_109_, v_tail_110_, v_x_105_);
        return v___x_111_;
    }
}
pub unsafe fn l___private_Init_Data_List_Perm_0__List_reverseAux_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_114_) == 0 {
        ...
        v___x_118_ = leanh::lean_apply_1(v_h__1_116_, v_x_115_);
        return v___x_118_;
    } else {
        let mut v_head_119_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v_head_119_ = leanh::lean_ctor_get(v_x_114_, 0);
        leanh::lean_inc(v_head_119_);
        v_tail_120_ = leanh::lean_ctor_get(v_x_114_, 1);
        leanh::lean_inc(v_tail_120_);
        leanh::lean_dec_ref_known(v_x_114_, 2);
        v___x_121_ = leanh::lean_apply_3(v_h__2_117_, v_head_119_, v_tail_120_, v_x_115_);
        return v___x_121_;
    }
}
pub unsafe fn l___private_Init_Data_List_Perm_0__List_getLast_x3f_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_122_) == 0 {
        ...
        v___x_126_ = leanh::lean_apply_1(v_h__1_123_, v___x_125_);
        return v___x_126_;
    } else {
        let mut v_head_127_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_128_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_129_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_123_);
        v_head_127_ = leanh::lean_ctor_get(v_x_122_, 0);
        leanh::lean_inc(v_head_127_);
        v_tail_128_ = leanh::lean_ctor_get(v_x_122_, 1);
        leanh::lean_inc(v_tail_128_);
        leanh::lean_dec_ref_known(v_x_122_, 2);
        v___x_129_ = leanh::lean_apply_2(v_h__2_124_, v_head_127_, v_tail_128_);
        return v___x_129_;
    }
}
pub unsafe fn l___private_Init_Data_List_Perm_0__List_getLast_x3f_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_132_) == 0 {
        ...
        v___x_136_ = leanh::lean_apply_1(v_h__1_133_, v___x_135_);
        return v___x_136_;
    } else {
        let mut v_head_137_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_138_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_139_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_133_);
        v_head_137_ = leanh::lean_ctor_get(v_x_132_, 0);
        leanh::lean_inc(v_head_137_);
        v_tail_138_ = leanh::lean_ctor_get(v_x_132_, 1);
        leanh::lean_inc(v_tail_138_);
        leanh::lean_dec_ref_known(v_x_132_, 2);
        v___x_139_ = leanh::lean_apply_2(v_h__2_134_, v_head_137_, v_tail_138_);
        return v___x_139_;
    }
}
pub unsafe fn l_List_decidablePerm___redArg(
    mut v_inst_140_: *mut leanh::LeanObject,
    mut v_l_u2081_141_: *mut leanh::LeanObject,
    mut v_l_u2082_142_: *mut leanh::LeanObject,
) -> u8 {
    ...
    leanh::lean_closure_set(v___f_143_, 0, v_inst_140_);
...
pub unsafe fn l_List_decidablePerm___redArg___boxed(
    ...
    mut v_l_u2081_146_: *mut leanh::LeanObject,
    mut v_l_u2082_147_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_List_decidablePerm(
    ...
    mut v_l_u2081_152_: *mut leanh::LeanObject,
    mut v_l_u2082_153_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_List_decidablePerm___boxed(
    ...
    mut v_l_u2081_157_: *mut leanh::LeanObject,
    mut v_l_u2082_158_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_159_: u8 = 0;
    let mut v_r_160_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_159_ = l_List_decidablePerm(v_00_u03b1_155_, v_inst_156_, v_l_u2081_157_, v_l_u2082_158_);
    v_r_160_ = leanh::lean_box((v_res_159_) as usize);
    return v_r_160_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_List_Perm(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List_Perm(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Perm(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
