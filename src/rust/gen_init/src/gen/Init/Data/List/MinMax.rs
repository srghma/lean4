...
pub unsafe fn l___private_Init_Data_List_MinMax_0__List_getLast_x3f_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_32_) == 0 {
        ...
        v___x_36_ = leanh::lean_apply_1(v_h__1_33_, v___x_35_);
        return v___x_36_;
    } else {
        ...
        v_head_37_ = leanh::lean_ctor_get(v_x_32_, 0);
        leanh::lean_inc(v_head_37_);
        v_tail_38_ = leanh::lean_ctor_get(v_x_32_, 1);
        leanh::lean_inc(v_tail_38_);
        leanh::lean_dec_ref_known(v_x_32_, 2);
        v___x_39_ = leanh::lean_apply_2(v_h__2_34_, v_head_37_, v_tail_38_);
        return v___x_39_;
    }
}
pub unsafe fn l___private_Init_Data_List_MinMax_0__List_getLast_x3f_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_42_) == 0 {
        ...
        let mut v_head_47_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_48_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_49_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_43_);
        v_head_47_ = leanh::lean_ctor_get(v_x_42_, 0);
        leanh::lean_inc(v_head_47_);
        v_tail_48_ = leanh::lean_ctor_get(v_x_42_, 1);
        leanh::lean_inc(v_tail_48_);
        leanh::lean_dec_ref_known(v_x_42_, 2);
        v___x_49_ = leanh::lean_apply_2(v_h__2_44_, v_head_47_, v_tail_48_);
        return v___x_49_;
    }
}
pub unsafe fn l___private_Init_Data_List_MinMax_0__List_head_match__1_splitter___redArg(
    ...
    let mut v_head_52_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_53_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_54_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_head_52_ = leanh::lean_ctor_get(v_x_50_, 0);
    leanh::lean_inc(v_head_52_);
    v_tail_53_ = leanh::lean_ctor_get(v_x_50_, 1);
    leanh::lean_inc(v_tail_53_);
    leanh::lean_dec(v_x_50_);
    v___x_54_ = leanh::lean_apply_3(
        v_h__1_51_,
        v_head_52_,
        v_tail_53_,
        leanh::lean_box(0),
...
pub unsafe fn l___private_Init_Data_List_MinMax_0__List_head_match__1_splitter(
    ...
    let mut v_head_60_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_61_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_62_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_head_60_ = leanh::lean_ctor_get(v_x_57_, 0);
    leanh::lean_inc(v_head_60_);
    v_tail_61_ = leanh::lean_ctor_get(v_x_57_, 1);
    leanh::lean_inc(v_tail_61_);
    leanh::lean_dec(v_x_57_);
    v___x_62_ = leanh::lean_apply_3(
        v_h__1_59_,
        v_head_60_,
        v_tail_61_,
        leanh::lean_box(0),
...
pub unsafe fn meta_initialize_Init_Data_List_MinMax(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_MinMax(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
