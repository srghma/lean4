...
pub unsafe fn l___private_Init_Data_List_Erase_0__List_filterMap_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_78_) == 0 {
        ...
        let mut v_val_83_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_84_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_79_);
        v_val_83_ = leanh::lean_ctor_get(v_x_78_, 0);
        leanh::lean_inc(v_val_83_);
        leanh::lean_dec_ref_known(v_x_78_, 1);
        v___x_84_ = leanh::lean_apply_1(v_h__2_80_, v_val_83_);
        return v___x_84_;
    }
}
pub unsafe fn l___private_Init_Data_List_Erase_0__List_filterMap_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_87_) == 0 {
        ...
        v___x_91_ = leanh::lean_apply_1(v_h__1_88_, v___x_90_);
        return v___x_91_;
    } else {
        let mut v_val_92_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_93_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_88_);
        v_val_92_ = leanh::lean_ctor_get(v_x_87_, 0);
        leanh::lean_inc(v_val_92_);
        leanh::lean_dec_ref_known(v_x_87_, 1);
        v___x_93_ = leanh::lean_apply_1(v_h__2_89_, v_val_92_);
        return v___x_93_;
    }
}
pub unsafe fn l___private_Init_Data_List_Erase_0__List_eraseP__filterMap_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_94_) == 0 {
        ...
        v___x_98_ = leanh::lean_apply_1(v_h__2_96_, v___x_97_);
        return v___x_98_;
    } else {
        let mut v_val_99_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_100_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_96_);
        v_val_99_ = leanh::lean_ctor_get(v_x_94_, 0);
        leanh::lean_inc(v_val_99_);
        leanh::lean_dec_ref_known(v_x_94_, 1);
        v___x_100_ = leanh::lean_apply_1(v_h__1_95_, v_val_99_);
        return v___x_100_;
    }
}
pub unsafe fn l___private_Init_Data_List_Erase_0__List_eraseP__filterMap_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_103_) == 0 {
        ...
        let mut v_val_108_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_109_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_105_);
        v_val_108_ = leanh::lean_ctor_get(v_x_103_, 0);
        leanh::lean_inc(v_val_108_);
        leanh::lean_dec_ref_known(v_x_103_, 1);
        v___x_109_ = leanh::lean_apply_1(v_h__1_104_, v_val_108_);
        return v___x_109_;
    }
}
pub unsafe fn l___private_Init_Data_List_Erase_0__List_eraseP__eq__eraseIdx_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_110_) == 0 {
        ...
        v___x_114_ = leanh::lean_apply_1(v_h__1_111_, v___x_113_);
        return v___x_114_;
    } else {
        let mut v_val_115_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_116_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_111_);
        v_val_115_ = leanh::lean_ctor_get(v_x_110_, 0);
        leanh::lean_inc(v_val_115_);
        leanh::lean_dec_ref_known(v_x_110_, 1);
        v___x_116_ = leanh::lean_apply_1(v_h__2_112_, v_val_115_);
        return v___x_116_;
    }
}
pub unsafe fn l___private_Init_Data_List_Erase_0__List_eraseP__eq__eraseIdx_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_118_) == 0 {
        ...
        v___x_122_ = leanh::lean_apply_1(v_h__1_119_, v___x_121_);
        return v___x_122_;
    } else {
        let mut v_val_123_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_124_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_119_);
        v_val_123_ = leanh::lean_ctor_get(v_x_118_, 0);
        leanh::lean_inc(v_val_123_);
        leanh::lean_dec_ref_known(v_x_118_, 1);
        v___x_124_ = leanh::lean_apply_1(v_h__2_120_, v_val_123_);
        return v___x_124_;
    }
}
pub unsafe fn l___private_Init_Data_List_Erase_0__List_eraseIdx_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_125_) == 0 {
        let mut v___x_130_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__3_129_);
        leanh::lean_dec(v_h__2_128_);
        v___x_130_ = leanh::lean_apply_1(v_h__1_127_, v_x_126_);
        return v___x_130_;
    } else {
        let mut v_head_131_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_132_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_zero_133_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_isZero_134_: u8 = 0;
        leanh::lean_dec(v_h__1_127_);
        v_head_131_ = leanh::lean_ctor_get(v_x_125_, 0);
        leanh::lean_inc(v_head_131_);
        v_tail_132_ = leanh::lean_ctor_get(v_x_125_, 1);
        leanh::lean_inc(v_tail_132_);
        leanh::lean_dec_ref_known(v_x_125_, 2);
        v_zero_133_ = leanh::lean_unsigned_to_nat(0);
        ...
        if v_isZero_134_ == 1 {
            ...
            v___x_135_ = leanh::lean_apply_2(v_h__2_128_, v_head_131_, v_tail_132_);
            return v___x_135_;
        } else {
            let mut v_one_136_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v_n_137_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_138_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__2_128_);
            v_one_136_ = leanh::lean_unsigned_to_nat(1);
            v_n_137_ = lean_nat_sub(v_x_126_, v_one_136_);
            leanh::lean_dec(v_x_126_);
            v___x_138_ =
                leanh::lean_apply_3(v_h__3_129_, v_head_131_, v_tail_132_, v_n_137_);
            return v___x_138_;
        }
    }
}
pub unsafe fn l___private_Init_Data_List_Erase_0__List_eraseIdx_match__1_splitter(
    ...
    mut v_h__1_143_: *mut leanh::LeanObject,
    mut v_h__2_144_: *mut leanh::LeanObject,
    mut v_h__3_145_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_x_141_) == 0 {
        let mut v___x_146_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__3_145_);
        leanh::lean_dec(v_h__2_144_);
        v___x_146_ = leanh::lean_apply_1(v_h__1_143_, v_x_142_);
        return v___x_146_;
    } else {
        let mut v_head_147_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_148_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_zero_149_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_isZero_150_: u8 = 0;
        leanh::lean_dec(v_h__1_143_);
        v_head_147_ = leanh::lean_ctor_get(v_x_141_, 0);
        leanh::lean_inc(v_head_147_);
        v_tail_148_ = leanh::lean_ctor_get(v_x_141_, 1);
        leanh::lean_inc(v_tail_148_);
        leanh::lean_dec_ref_known(v_x_141_, 2);
        v_zero_149_ = leanh::lean_unsigned_to_nat(0);
        ...
        if v_isZero_150_ == 1 {
            ...
            v___x_151_ = leanh::lean_apply_2(v_h__2_144_, v_head_147_, v_tail_148_);
            return v___x_151_;
        } else {
            ...
            leanh::lean_dec(v_x_142_);
            v___x_154_ =
                leanh::lean_apply_3(v_h__3_145_, v_head_147_, v_tail_148_, v_n_153_);
            return v___x_154_;
        }
    }
}
...
pub unsafe fn meta_initialize_Init_Data_List_Erase(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Erase(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
