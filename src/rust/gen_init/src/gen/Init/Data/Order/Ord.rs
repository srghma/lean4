...
// Imports: Init.Data.List.Lemmas Init.Data.Array.DecidableEq Init.Data.Ord.Array Init.Data.BEq Init.Data.Array.Basic Init.ByCases Init.Data.Bool Init.Data.Int.Order Init.Data.List.Nat.BEq Init.Data.Option.Lemmas
...
pub unsafe fn runtime_initialize_Init_Data_Order_Ord(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Order_Ord(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Order_Ord(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
