...
pub unsafe fn l___private_Init_Data_ByteArray_Lemmas_0__ByteArray_set_match__1_splitter___redArg(
    ...
    let mut v_data_44_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v___x_45_ = leanh::lean_box((v_x_42_) as usize);
    v___x_46_ = leanh::lean_apply_4(
        v_h__1_43_,
        v_data_44_,
        v_x_41_,
        v___x_45_,
...
pub unsafe fn l___private_Init_Data_ByteArray_Lemmas_0__ByteArray_set_match__1_splitter___redArg___boxed(
    ...
    v_x_33__boxed_51_ = (leanh::lean_unbox(v_x_49_) as u8);
...
pub unsafe fn l___private_Init_Data_ByteArray_Lemmas_0__ByteArray_set_match__1_splitter(
    ...
    let mut v_data_59_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v___x_60_ = leanh::lean_box((v_x_56_) as usize);
    v___x_61_ = leanh::lean_apply_4(
        v_h__1_58_,
        v_data_59_,
        v_x_55_,
        v___x_60_,
...
pub unsafe fn l___private_Init_Data_ByteArray_Lemmas_0__ByteArray_set_match__1_splitter___boxed(
    mut v_motive_62_: *mut leanh::LeanObject,
    ...
    v_x_48__boxed_68_ = (leanh::lean_unbox(v_x_65_) as u8);
...
pub unsafe fn l___private_Init_Data_ByteArray_Lemmas_0__ByteArray_size_match__1_splitter___redArg(
    ...
    let mut v_data_72_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_73_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_data_72_ = lean_byte_array_data(v_x_70_);
    v___x_73_ = leanh::lean_apply_1(v_h__1_71_, v_data_72_);
    return v___x_73_;
}
pub unsafe fn l___private_Init_Data_ByteArray_Lemmas_0__ByteArray_size_match__1_splitter(
    ...
    let mut v_data_77_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_78_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_data_77_ = lean_byte_array_data(v_x_75_);
    v___x_78_ = leanh::lean_apply_1(v_h__1_76_, v_data_77_);
    return v___x_78_;
}
...
pub unsafe fn initialize_Init_Data_ByteArray_Lemmas(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
