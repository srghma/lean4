...
pub unsafe fn l___private_Init_Data_Array_Find_0__Array_of__findIdx_x3f__eq__some_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_59_) == 0 {
        ...
        v___x_63_ = leanh::lean_apply_1(v_h__2_61_, v___x_62_);
        return v___x_63_;
    } else {
        let mut v_val_64_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_65_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_61_);
        v_val_64_ = leanh::lean_ctor_get(v_x_59_, 0);
        leanh::lean_inc(v_val_64_);
        leanh::lean_dec_ref_known(v_x_59_, 1);
        v___x_65_ = leanh::lean_apply_1(v_h__1_60_, v_val_64_);
        return v___x_65_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Find_0__Array_of__findIdx_x3f__eq__some_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_68_) == 0 {
        ...
        v___x_72_ = leanh::lean_apply_1(v_h__2_70_, v___x_71_);
        return v___x_72_;
    } else {
        let mut v_val_73_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_74_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_70_);
        v_val_73_ = leanh::lean_ctor_get(v_x_68_, 0);
        leanh::lean_inc(v_val_73_);
        leanh::lean_dec_ref_known(v_x_68_, 1);
        v___x_74_ = leanh::lean_apply_1(v_h__1_69_, v_val_73_);
        return v___x_74_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Find_0__List_of__findIdx_x3f__eq__some_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_75_) == 0 {
        ...
        leanh::lean_dec(v_h__1_76_);
        v___x_78_ = leanh::lean_box(0);
        v___x_79_ = leanh::lean_apply_1(v_h__2_77_, v___x_78_);
        return v___x_79_;
    } else {
        let mut v_val_80_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_81_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_77_);
        v_val_80_ = leanh::lean_ctor_get(v_x_75_, 0);
        leanh::lean_inc(v_val_80_);
        leanh::lean_dec_ref_known(v_x_75_, 1);
        v___x_81_ = leanh::lean_apply_1(v_h__1_76_, v_val_80_);
        return v___x_81_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Find_0__List_of__findIdx_x3f__eq__some_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_84_) == 0 {
        ...
        v___x_88_ = leanh::lean_apply_1(v_h__2_86_, v___x_87_);
        return v___x_88_;
    } else {
        ...
        v___x_90_ = leanh::lean_apply_1(v_h__1_85_, v_val_89_);
        return v___x_90_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Find_0__Option_pmap__or_match__1_splitter___redArg(
    mut v_o_91_: *mut leanh::LeanObject,
    mut v_h__1_92_: *mut leanh::LeanObject,
    mut v_h__2_93_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_o_91_) == 0 {
        let mut v___x_94_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_93_);
        v___x_94_ = leanh::lean_apply_1(v_h__1_92_, leanh::lean_box(0));
        return v___x_94_;
    } else {
        let mut v_val_95_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_96_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_92_);
        v_val_95_ = leanh::lean_ctor_get(v_o_91_, 0);
        leanh::lean_inc(v_val_95_);
        leanh::lean_dec_ref_known(v_o_91_, 1);
        v___x_96_ = leanh::lean_apply_2(v_h__2_93_, v_val_95_, leanh::lean_box(0));
        return v___x_96_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Find_0__Option_pmap__or_match__1_splitter(
    ...
    mut v_p_98_: *mut leanh::LeanObject,
    mut v_o_x27_99_: *mut leanh::LeanObject,
    mut v_motive_100_: *mut leanh::LeanObject,
    mut v_o_101_: *mut leanh::LeanObject,
    mut v_h_102_: *mut leanh::LeanObject,
    mut v_h__1_103_: *mut leanh::LeanObject,
    mut v_h__2_104_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_o_101_) == 0 {
        let mut v___x_105_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_104_);
        v___x_105_ = leanh::lean_apply_1(v_h__1_103_, leanh::lean_box(0));
        return v___x_105_;
    } else {
        ...
        v_val_106_ = leanh::lean_ctor_get(v_o_101_, 0);
        leanh::lean_inc(v_val_106_);
        leanh::lean_dec_ref_known(v_o_101_, 1);
        v___x_107_ = leanh::lean_apply_2(v_h__2_104_, v_val_106_, leanh::lean_box(0));
        return v___x_107_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Find_0__Option_pmap__or_match__1_splitter___boxed(
    ...
    mut v_o_x27_110_: *mut leanh::LeanObject,
    mut v_motive_111_: *mut leanh::LeanObject,
    mut v_o_112_: *mut leanh::LeanObject,
    mut v_h_113_: *mut leanh::LeanObject,
...
pub unsafe fn meta_initialize_Init_Data_Array_Find(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array_Find(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
