...
pub unsafe fn l___private_Init_Data_Array_DecidableEq_0__Array_isEqvAux_match__1_splitter___redArg(
    ...
    let mut v_zero_158_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_159_: u8 = 0;
    v_zero_158_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_159_ == 1 {
        ...
        v___x_160_ = leanh::lean_apply_1(v_h__1_156_, leanh::lean_box(0));
        return v___x_160_;
    } else {
        let mut v_one_161_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_162_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_163_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_156_);
        v_one_161_ = leanh::lean_unsigned_to_nat(1);
        v_n_162_ = lean_nat_sub(v_x_155_, v_one_161_);
        v___x_163_ = leanh::lean_apply_2(v_h__2_157_, v_n_162_, leanh::lean_box(0));
        return v___x_163_;
    }
}
...
pub unsafe fn l___private_Init_Data_Array_DecidableEq_0__Array_isEqvAux_match__1_splitter(
    ...
    mut v_xs_169_: *mut leanh::LeanObject,
    ...
    let mut v_zero_175_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_176_: u8 = 0;
    v_zero_175_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_176_ == 1 {
        ...
        v___x_177_ = leanh::lean_apply_1(v_h__1_173_, leanh::lean_box(0));
        return v___x_177_;
    } else {
        let mut v_one_178_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v_one_178_ = leanh::lean_unsigned_to_nat(1);
        v_n_179_ = lean_nat_sub(v_x_171_, v_one_178_);
        v___x_180_ = leanh::lean_apply_2(v_h__2_174_, v_n_179_, leanh::lean_box(0));
        return v___x_180_;
    }
}
...
pub unsafe fn l_Array_instDecidableEqImpl___redArg___lam__0(
    ...
    mut v_b_191_: *mut leanh::LeanObject,
) -> u8 {
    let mut v___x_192_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_193_: u8 = 0;
    v___x_192_ = leanh::lean_apply_2(v_inst_189_, v_a_190_, v_b_191_);
    v___x_193_ = (leanh::lean_unbox(v___x_192_) as u8);
    return v___x_193_;
}
pub unsafe fn l_Array_instDecidableEqImpl___redArg___lam__0___boxed(
    ...
    mut v_b_196_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_197_: u8 = 0;
    let mut v_r_198_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_197_ = l_Array_instDecidableEqImpl___redArg___lam__0(v_inst_194_, v_a_195_, v_b_196_);
    v_r_198_ = leanh::lean_box((v_res_197_) as usize);
    return v_r_198_;
}
pub unsafe fn l_Array_instDecidableEqImpl___redArg(
    mut v_inst_199_: *mut leanh::LeanObject,
    mut v_xs_200_: *mut leanh::LeanObject,
    mut v_ys_201_: *mut leanh::LeanObject,
) -> u8 {
    ...
    if v___x_204_ == 0 {
        ...
        leanh::lean_closure_set(v___f_205_, 0, v_inst_199_);
...
pub unsafe fn l_Array_instDecidableEqImpl___redArg___boxed(
    ...
    mut v_xs_208_: *mut leanh::LeanObject,
    mut v_ys_209_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_ys_209_);
    leanh::lean_dec_ref(v_xs_208_);
...
pub unsafe fn l_Array_instDecidableEqImpl(
    ...
    mut v_xs_214_: *mut leanh::LeanObject,
    mut v_ys_215_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Array_instDecidableEqImpl___boxed(
    ...
    mut v_ys_220_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_ys_220_);
    leanh::lean_dec_ref(v_xs_219_);
...
pub unsafe fn l_Array_instDecidableEq___redArg(
    ...
    mut v_ys_225_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_toList_226_: *mut leanh::LeanObject = core::ptr::null_mut();
    leanh::lean_inc_ref(v_xs_224_);
    v_toList_226_ = lean_array_to_list(v_xs_224_);
    if leanh::lean_obj_tag(v_toList_226_) == 0 {
        let mut v_toList_227_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec_ref(v_xs_224_);
        leanh::lean_dec_ref(v_inst_223_);
        v_toList_227_ = lean_array_to_list(v_ys_225_);
        if leanh::lean_obj_tag(v_toList_227_) == 0 {
            let mut v___x_228_: u8 = 0;
            v___x_228_ = 1;
            return v___x_228_;
        } else {
            let mut v___x_229_: u8 = 0;
            leanh::lean_dec_ref_known(v_toList_227_, 2);
            v___x_229_ = 0;
            return v___x_229_;
        }
    } else {
        let mut v_toList_230_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec_ref_known(v_toList_226_, 2);
        leanh::lean_inc_ref(v_ys_225_);
        v_toList_230_ = lean_array_to_list(v_ys_225_);
        if leanh::lean_obj_tag(v_toList_230_) == 0 {
            let mut v___x_231_: u8 = 0;
            leanh::lean_dec_ref(v_ys_225_);
            leanh::lean_dec_ref(v_xs_224_);
            leanh::lean_dec_ref(v_inst_223_);
            v___x_231_ = 0;
            return v___x_231_;
            ...
            leanh::lean_dec_ref_known(v_toList_230_, 2);
...
pub unsafe fn l_Array_instDecidableEq___redArg___boxed(
    ...
    mut v_xs_234_: *mut leanh::LeanObject,
    mut v_ys_235_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Array_instDecidableEq(
    ...
    mut v_xs_240_: *mut leanh::LeanObject,
    mut v_ys_241_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Array_instDecidableEq___boxed(
    ...
    mut v_xs_245_: *mut leanh::LeanObject,
    mut v_ys_246_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Array_instDecidableEqEmp___redArg(
    ...
    let mut v_toList_250_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_toList_250_ = lean_array_to_list(v_xs_249_);
    if leanh::lean_obj_tag(v_toList_250_) == 0 {
        let mut v___x_251_: u8 = 0;
        v___x_251_ = 1;
        return v___x_251_;
    } else {
        let mut v___x_252_: u8 = 0;
        leanh::lean_dec_ref_known(v_toList_250_, 2);
        v___x_252_ = 0;
        return v___x_252_;
    }
}
pub unsafe fn l_Array_instDecidableEqEmp___redArg___boxed(
    mut v_xs_253_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Array_instDecidableEmpEq___redArg(
    mut v_ys_263_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_toList_264_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_toList_264_ = lean_array_to_list(v_ys_263_);
    if leanh::lean_obj_tag(v_toList_264_) == 0 {
        let mut v___x_265_: u8 = 0;
        v___x_265_ = 1;
        return v___x_265_;
    } else {
        let mut v___x_266_: u8 = 0;
        leanh::lean_dec_ref_known(v_toList_264_, 2);
        v___x_266_ = 0;
        return v___x_266_;
    }
}
pub unsafe fn l_Array_instDecidableEmpEq___redArg___boxed(
    mut v_ys_267_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Array_instDecidableEmpEq(
    ...
    mut v_ys_271_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Array_instDecidableEmpEq___boxed(
    ...
    mut v_ys_274_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Array_instDecidableEqEmpImpl___redArg(
    mut v_xs_277_: *mut leanh::LeanObject,
) -> u8 {
    ...
    v___x_279_ = leanh::lean_unsigned_to_nat(0);
    v___x_280_ = lean_nat_dec_eq(v___x_278_, v___x_279_);
    return v___x_280_;
}
pub unsafe fn l_Array_instDecidableEqEmpImpl___redArg___boxed(
    mut v_xs_281_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_282_: u8 = 0;
    let mut v_r_283_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_282_ = l_Array_instDecidableEqEmpImpl___redArg(v_xs_281_);
    leanh::lean_dec_ref(v_xs_281_);
    v_r_283_ = leanh::lean_box((v_res_282_) as usize);
    return v_r_283_;
}
...
pub unsafe fn l_Array_instDecidableEqEmpImpl___boxed(
    ...
    mut v_xs_290_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Array_instDecidableEmpEqImpl(
    ...
    mut v_xs_301_: *mut leanh::LeanObject,
) -> u8 {
    ...
    v___x_303_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l_Array_instDecidableEmpEqImpl___boxed(
    ...
    mut v_xs_306_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_307_: u8 = 0;
    let mut v_r_308_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_307_ = l_Array_instDecidableEmpEqImpl(v_00_u03b1_305_, v_xs_306_);
    leanh::lean_dec_ref(v_xs_306_);
    v_r_308_ = leanh::lean_box((v_res_307_) as usize);
    return v_r_308_;
}
...
pub unsafe fn initialize_Init_Data_Array_DecidableEq(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
