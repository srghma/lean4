...
pub unsafe fn l___private_Init_Data_Array_Lex_Lemmas_0__Break_runK_match__1_splitter___redArg(
    ...
    mut v_h__1_112_: *mut crate::leanh::LeanObject,
    mut v_h__2_113_: *mut crate::leanh::LeanObject,
    ...
    if crate::leanh::lean_obj_tag(v_x_111_) == 0 {
        ...
        crate::leanh::lean_dec(v_h__1_112_);
        v___x_114_ = crate::leanh::lean_box(0);
        v___x_115_ = crate::leanh::lean_apply_1(v_h__2_113_, v___x_114_);
        return v___x_115_;
    } else {
        ...
        crate::leanh::lean_dec(v_h__2_113_);
        v_val_116_ = crate::leanh::lean_ctor_get(v_x_111_, 0);
        crate::leanh::lean_inc(v_val_116_);
        crate::leanh::lean_dec_ref_known(v_x_111_, 1);
        v___x_117_ = crate::leanh::lean_apply_1(v_h__1_112_, v_val_116_);
        return v___x_117_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Lex_Lemmas_0__Break_runK_match__1_splitter(
    ...
    mut v_motive_119_: *mut crate::leanh::LeanObject,
    ...
    if crate::leanh::lean_obj_tag(v_x_120_) == 0 {
        ...
        v___x_124_ = crate::leanh::lean_apply_1(v_h__2_122_, v___x_123_);
        return v___x_124_;
    } else {
        ...
        v_val_125_ = crate::leanh::lean_ctor_get(v_x_120_, 0);
        crate::leanh::lean_inc(v_val_125_);
        crate::leanh::lean_dec_ref_known(v_x_120_, 1);
        v___x_126_ = crate::leanh::lean_apply_1(v_h__1_121_, v_val_125_);
        return v___x_126_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Lex_Lemmas_0__List_forIn_x27__cons_match__1_splitter___redArg(
    ...
    if crate::leanh::lean_obj_tag(v_x_127_) == 0 {
        ...
        v_a_130_ = crate::leanh::lean_ctor_get(v_x_127_, 0);
        crate::leanh::lean_inc(v_a_130_);
        crate::leanh::lean_dec_ref_known(v_x_127_, 1);
        v___x_131_ = crate::leanh::lean_apply_1(v_h__1_128_, v_a_130_);
        return v___x_131_;
    } else {
        ...
        v_a_132_ = crate::leanh::lean_ctor_get(v_x_127_, 0);
        crate::leanh::lean_inc(v_a_132_);
        crate::leanh::lean_dec_ref_known(v_x_127_, 1);
        v___x_133_ = crate::leanh::lean_apply_1(v_h__2_129_, v_a_132_);
        return v___x_133_;
    }
}
pub unsafe fn l___private_Init_Data_Array_Lex_Lemmas_0__List_forIn_x27__cons_match__1_splitter(
    mut v_00_u03b2_134_: *mut crate::leanh::LeanObject,
    ...
    if crate::leanh::lean_obj_tag(v_x_136_) == 0 {
        let mut v_a_139_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_140_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        crate::leanh::lean_dec(v_h__2_138_);
        v_a_139_ = crate::leanh::lean_ctor_get(v_x_136_, 0);
        crate::leanh::lean_inc(v_a_139_);
        crate::leanh::lean_dec_ref_known(v_x_136_, 1);
        v___x_140_ = crate::leanh::lean_apply_1(v_h__1_137_, v_a_139_);
        return v___x_140_;
    } else {
        ...
        v_a_141_ = crate::leanh::lean_ctor_get(v_x_136_, 0);
        crate::leanh::lean_inc(v_a_141_);
        crate::leanh::lean_dec_ref_known(v_x_136_, 1);
        v___x_142_ = crate::leanh::lean_apply_1(v_h__2_138_, v_a_141_);
        return v___x_142_;
    }
}
...
pub unsafe fn l_Array_instDecidableLTOfDecidableEq___redArg___lam__0(
    ...
    mut v_x1_154_: *mut crate::leanh::LeanObject,
    mut v_x2_155_: *mut crate::leanh::LeanObject,
) -> u8 {
    let mut v___x_156_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_157_: u8 = 0;
    v___x_156_ = crate::leanh::lean_apply_2(v_inst_153_, v_x1_154_, v_x2_155_);
    v___x_157_ = (crate::leanh::lean_unbox(v___x_156_) as u8);
    return v___x_157_;
}
pub unsafe fn l_Array_instDecidableLTOfDecidableEq___redArg___lam__0___boxed(
    mut v_inst_158_: *mut crate::leanh::LeanObject,
    mut v_x1_159_: *mut crate::leanh::LeanObject,
    mut v_x2_160_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_161_: u8 = 0;
    let mut v_r_162_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_161_ =
        l_Array_instDecidableLTOfDecidableEq___redArg___lam__0(v_inst_158_, v_x1_159_, v_x2_160_);
    v_r_162_ = crate::leanh::lean_box((v_res_161_) as usize);
    return v_r_162_;
}
pub unsafe fn l_Array_instDecidableLTOfDecidableEq___redArg(
    ...
    mut v_xs_165_: *mut crate::leanh::LeanObject,
    mut v_ys_166_: *mut crate::leanh::LeanObject,
) -> u8 {
    ...
    crate::leanh::lean_closure_set(v___f_168_, 0, v_inst_163_);
...
pub unsafe fn l_Array_instDecidableLTOfDecidableEq___redArg___boxed(
    ...
    mut v_xs_172_: *mut crate::leanh::LeanObject,
    mut v_ys_173_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_174_: u8 = 0;
    let mut v_r_175_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    v_r_175_ = crate::leanh::lean_box((v_res_174_) as usize);
    return v_r_175_;
}
pub unsafe fn l_Array_instDecidableLTOfDecidableEq(
    ...
    mut v_xs_180_: *mut crate::leanh::LeanObject,
    mut v_ys_181_: *mut crate::leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Array_instDecidableLTOfDecidableEq___boxed(
    ...
    let mut v_r_190_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    v_r_190_ = crate::leanh::lean_box((v_res_189_) as usize);
    return v_r_190_;
}
pub unsafe fn l_Array_instDecidableLEOfDecidableEqOfDecidableLT___redArg(
    ...
    mut v_xs_193_: *mut crate::leanh::LeanObject,
    mut v_ys_194_: *mut crate::leanh::LeanObject,
) -> u8 {
    ...
    crate::leanh::lean_closure_set(v___f_196_, 0, v_inst_191_);
...
pub unsafe fn l_Array_instDecidableLEOfDecidableEqOfDecidableLT___redArg___boxed(
    ...
    v_r_205_ = crate::leanh::lean_box((v_res_204_) as usize);
    return v_r_205_;
}
pub unsafe fn l_Array_instDecidableLEOfDecidableEqOfDecidableLT(
    ...
    mut v_ys_211_: *mut crate::leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Array_instDecidableLEOfDecidableEqOfDecidableLT___boxed(
    ...
    mut v_ys_218_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn initialize_Init_Data_Array_Lex_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
