...
pub static l_Array_finRange___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_Array_finRange___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Array_finRange___closed__0_value) as *mut leanh::LeanObject;
...
pub unsafe fn initialize_Init_Data_Array_FinRange(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
