...
pub unsafe fn l___private_Init_Data_Array_OfFn_0__Array_ofFn_go_match__1_splitter___redArg(
    ...
    let mut v_zero_59_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_60_: u8 = 0;
    v_zero_59_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_60_ == 1 {
        ...
        v___x_61_ = leanh::lean_apply_1(v_h__2_58_, leanh::lean_box(0));
        return v___x_61_;
    } else {
        let mut v_one_62_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_63_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_64_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_58_);
        v_one_62_ = leanh::lean_unsigned_to_nat(1);
        v_n_63_ = lean_nat_sub(v_x_56_, v_one_62_);
        v___x_64_ = leanh::lean_apply_2(v_h__1_57_, v_n_63_, leanh::lean_box(0));
        return v___x_64_;
    }
}
...
pub unsafe fn l___private_Init_Data_Array_OfFn_0__Array_ofFn_go_match__1_splitter(
    ...
    mut v_motive_70_: *mut leanh::LeanObject,
    mut v_x_71_: *mut leanh::LeanObject,
    mut v_x_72_: *mut leanh::LeanObject,
    mut v_h__1_73_: *mut leanh::LeanObject,
    mut v_h__2_74_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_75_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_76_: u8 = 0;
    v_zero_75_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_76_ = lean_nat_dec_eq(v_x_71_, v_zero_75_);
    if v_isZero_76_ == 1 {
        let mut v___x_77_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_73_);
        v___x_77_ = leanh::lean_apply_1(v_h__2_74_, leanh::lean_box(0));
        return v___x_77_;
    } else {
        let mut v_one_78_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_79_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_80_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_74_);
        v_one_78_ = leanh::lean_unsigned_to_nat(1);
        v_n_79_ = lean_nat_sub(v_x_71_, v_one_78_);
        v___x_80_ = leanh::lean_apply_2(v_h__1_73_, v_n_79_, leanh::lean_box(0));
        return v___x_80_;
    }
}
pub unsafe fn l___private_Init_Data_Array_OfFn_0__Array_ofFn_go_match__1_splitter___boxed(
    ...
    leanh::lean_dec(v_x_83_);
    leanh::lean_dec(v_n_81_);
    return v_res_87_;
}
pub unsafe fn l_Array_ofFnM___redArg___lam__0(
    mut v_toFunctor_88_: *mut leanh::LeanObject,
    mut v_f_89_: *mut leanh::LeanObject,
    mut v_xs_90_: *mut leanh::LeanObject,
    mut v_i_91_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_map_92_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_map_92_ = leanh::lean_ctor_get(v_toFunctor_88_, 0);
    leanh::lean_inc(v_map_92_);
    leanh::lean_dec_ref(v_toFunctor_88_);
    v___x_93_ =
        leanh::lean_alloc_closure(l_Array_push___boxed as *mut core::ffi::c_void, 3, 2);
    leanh::lean_closure_set(v___x_93_, 0, leanh::lean_box(0));
    leanh::lean_closure_set(v___x_93_, 1, v_xs_90_);
    v___x_94_ = leanh::lean_apply_1(v_f_89_, v_i_91_);
    v___x_95_ = leanh::lean_apply_4(
        v_map_92_,
        leanh::lean_box(0),
        leanh::lean_box(0),
        v___x_93_,
...
pub unsafe fn l_Array_ofFnM___redArg(
    ...
    let mut v_toApplicative_99_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_100_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_toApplicative_99_ = leanh::lean_ctor_get(v_inst_97_, 0);
    v_toFunctor_100_ = leanh::lean_ctor_get(v_toApplicative_99_, 0);
    leanh::lean_inc_ref(v_toFunctor_100_);
    v___f_101_ = leanh::lean_alloc_closure(
        l_Array_ofFnM___redArg___lam__0 as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___f_101_, 0, v_toFunctor_100_);
    leanh::lean_closure_set(v___f_101_, 1, v_f_98_);
    v___x_102_ = lean_mk_empty_array_with_capacity(v_n_96_);
    v___x_103_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn meta_initialize_Init_Data_Array_OfFn(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array_OfFn(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
