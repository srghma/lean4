...
pub unsafe fn l___private_Init_Data_Array_MapIdx_0__Array_mapFinIdxM_map_match__1_splitter___redArg(
    mut v_i_87_: *mut leanh::LeanObject,
    mut v_h__1_88_: *mut leanh::LeanObject,
    mut v_h__2_89_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_90_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_91_: u8 = 0;
    v_zero_90_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_91_ == 1 {
        ...
        v___x_92_ = leanh::lean_apply_1(v_h__1_88_, leanh::lean_box(0));
        return v___x_92_;
    } else {
        let mut v_one_93_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_94_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_95_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_88_);
        v_one_93_ = leanh::lean_unsigned_to_nat(1);
        v_n_94_ = lean_nat_sub(v_i_87_, v_one_93_);
        v___x_95_ = leanh::lean_apply_2(v_h__2_89_, v_n_94_, leanh::lean_box(0));
        return v___x_95_;
    }
}
pub unsafe fn l___private_Init_Data_Array_MapIdx_0__Array_mapFinIdxM_map_match__1_splitter___redArg___boxed(
    mut v_i_96_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_MapIdx_0__Array_mapFinIdxM_map_match__1_splitter(
    ...
    mut v_as_101_: *mut leanh::LeanObject,
    mut v_j_102_: *mut leanh::LeanObject,
    mut v_motive_103_: *mut leanh::LeanObject,
    mut v_i_104_: *mut leanh::LeanObject,
    mut v_inv_105_: *mut leanh::LeanObject,
    mut v_h__1_106_: *mut leanh::LeanObject,
    mut v_h__2_107_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_108_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_109_: u8 = 0;
    v_zero_108_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_109_ == 1 {
        ...
        v___x_110_ = leanh::lean_apply_1(v_h__1_106_, leanh::lean_box(0));
        return v___x_110_;
    } else {
        let mut v_one_111_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_112_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_113_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_106_);
        v_one_111_ = leanh::lean_unsigned_to_nat(1);
        v_n_112_ = lean_nat_sub(v_i_104_, v_one_111_);
        v___x_113_ = leanh::lean_apply_2(v_h__2_107_, v_n_112_, leanh::lean_box(0));
        return v___x_113_;
    }
}
pub unsafe fn l___private_Init_Data_Array_MapIdx_0__Array_mapFinIdxM_map_match__1_splitter___boxed(
    ...
    mut v_as_115_: *mut leanh::LeanObject,
    mut v_j_116_: *mut leanh::LeanObject,
    mut v_motive_117_: *mut leanh::LeanObject,
    mut v_i_118_: *mut leanh::LeanObject,
    mut v_inv_119_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_i_118_);
    leanh::lean_dec(v_j_116_);
    leanh::lean_dec_ref(v_as_115_);
    return v_res_122_;
}
pub unsafe fn l___private_Init_Data_Array_MapIdx_0__List_mapFinIdx_go_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_123_) == 0 {
        ...
        v___x_127_ = leanh::lean_apply_2(v_h__1_125_, v_x_124_, leanh::lean_box(0));
        return v___x_127_;
    } else {
        let mut v_head_128_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_129_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_130_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_125_);
        v_head_128_ = leanh::lean_ctor_get(v_x_123_, 0);
        leanh::lean_inc(v_head_128_);
        v_tail_129_ = leanh::lean_ctor_get(v_x_123_, 1);
        leanh::lean_inc(v_tail_129_);
        leanh::lean_dec_ref_known(v_x_123_, 2);
        v___x_130_ = leanh::lean_apply_4(
            v_h__2_126_,
            v_head_128_,
            v_tail_129_,
            v_x_124_,
...
pub unsafe fn l___private_Init_Data_Array_MapIdx_0__List_mapFinIdx_go_match__1_splitter(
    ...
    mut v_as_133_: *mut leanh::LeanObject,
    mut v_motive_134_: *mut leanh::LeanObject,
    mut v_x_135_: *mut leanh::LeanObject,
    mut v_x_136_: *mut leanh::LeanObject,
    mut v_x_137_: *mut leanh::LeanObject,
    mut v_h__1_138_: *mut leanh::LeanObject,
    mut v_h__2_139_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_x_135_) == 0 {
        let mut v___x_140_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_139_);
        v___x_140_ = leanh::lean_apply_2(v_h__1_138_, v_x_136_, leanh::lean_box(0));
        return v___x_140_;
    } else {
        let mut v_head_141_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_tail_142_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_143_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_138_);
        v_head_141_ = leanh::lean_ctor_get(v_x_135_, 0);
        leanh::lean_inc(v_head_141_);
        v_tail_142_ = leanh::lean_ctor_get(v_x_135_, 1);
        leanh::lean_inc(v_tail_142_);
...
pub unsafe fn l___private_Init_Data_Array_MapIdx_0__List_mapFinIdx_go_match__1_splitter___boxed(
    ...
    mut v_00_u03b2_145_: *mut leanh::LeanObject,
    mut v_as_146_: *mut leanh::LeanObject,
...
pub unsafe fn meta_initialize_Init_Data_Array_MapIdx(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array_MapIdx(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
