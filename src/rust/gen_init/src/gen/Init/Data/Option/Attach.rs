...
pub static l_Option_instMonadAttach___closed__0_value: leanh::LeanClosureObject<0> =
...
pub unsafe fn l___private_Init_Data_Option_Attach_0__Option_attachWithImpl___boxed(
    ...
    mut v_o_108_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Option_Attach_0__Option_instDecidableEq_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_b_120_) == 0 {
        ...
        v_val_125_ = leanh::lean_ctor_get(v_b_120_, 0);
        leanh::lean_inc(v_val_125_);
        leanh::lean_dec_ref_known(v_b_120_, 1);
        v___x_126_ = leanh::lean_apply_1(v_h__2_122_, v_val_125_);
        return v___x_126_;
    }
}
pub unsafe fn l___private_Init_Data_Option_Attach_0__Option_instDecidableEq_match__1_splitter(
    mut v_00_u03b1_127_: *mut leanh::LeanObject,
    ...
    if leanh::lean_obj_tag(v_b_129_) == 0 {
        ...
        let mut v_val_134_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_135_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_130_);
        v_val_134_ = leanh::lean_ctor_get(v_b_129_, 0);
        leanh::lean_inc(v_val_134_);
        leanh::lean_dec_ref_known(v_b_129_, 1);
        v___x_135_ = leanh::lean_apply_1(v_h__2_131_, v_val_134_);
        return v___x_135_;
    }
}
pub unsafe fn l_Option_unattach___redArg(
    mut v_o_136_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_o_136_) == 0 {
                    v___x_137_ = leanh::lean_box(0);
                    return v___x_137_;
                } else {
                    v_val_138_ = leanh::lean_ctor_get(v_o_136_, 0);
                    v_isSharedCheck_145_ = (!leanh::lean_is_exclusive(v_o_136_)) as u8;
                    if v_isSharedCheck_145_ == 0 {
                        ...
                        leanh::lean_dec(v_o_136_);
                        v___x_140_ = leanh::lean_box(0);
                        v_isShared_141_ = v_isSharedCheck_145_;
                        state = 1;
                        continue;
                    }
            ...
            1 => {
                if v_isShared_141_ == 0 {
                    ...
                    v_reuseFailAlloc_144_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_144_, 0, v_val_138_);
...
pub unsafe fn l_Option_unattach(
    ...
    mut v_p_147_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Option_Attach_0__OptionT_instMonadAttach_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_157_) == 0 {
        ...
        v___x_160_ = leanh::lean_apply_1(v_h__2_159_, leanh::lean_box(0));
        return v___x_160_;
    } else {
        let mut v_val_161_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_162_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_159_);
        v_val_161_ = leanh::lean_ctor_get(v_x_157_, 0);
        leanh::lean_inc(v_val_161_);
        leanh::lean_dec_ref_known(v_x_157_, 1);
        v___x_162_ = leanh::lean_apply_2(v_h__1_158_, v_val_161_, leanh::lean_box(0));
        return v___x_162_;
    }
}
pub unsafe fn l___private_Init_Data_Option_Attach_0__OptionT_instMonadAttach_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_168_) == 0 {
        let mut v___x_171_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_169_);
        v___x_171_ = leanh::lean_apply_1(v_h__2_170_, leanh::lean_box(0));
        return v___x_171_;
    } else {
        let mut v_val_172_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_173_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_170_);
        v_val_172_ = leanh::lean_ctor_get(v_x_168_, 0);
        leanh::lean_inc(v_val_172_);
        leanh::lean_dec_ref_known(v_x_168_, 1);
        v___x_173_ = leanh::lean_apply_2(v_h__1_169_, v_val_172_, leanh::lean_box(0));
        return v___x_173_;
    }
}
...
pub unsafe fn l___private_Init_Data_Option_Attach_0__OptionT_bind_match__1_splitter___redArg(
    mut v_____do__lift_183_: *mut leanh::LeanObject,
    mut v_h__1_184_: *mut leanh::LeanObject,
    mut v_h__2_185_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_____do__lift_183_) == 0 {
        ...
        v_val_188_ = leanh::lean_ctor_get(v_____do__lift_183_, 0);
        leanh::lean_inc(v_val_188_);
        leanh::lean_dec_ref_known(v_____do__lift_183_, 1);
...
pub unsafe fn l___private_Init_Data_Option_Attach_0__OptionT_bind_match__1_splitter(
    ...
    mut v_____do__lift_192_: *mut leanh::LeanObject,
    mut v_h__1_193_: *mut leanh::LeanObject,
    mut v_h__2_194_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_____do__lift_192_) == 0 {
        ...
        v___x_196_ = leanh::lean_apply_1(v_h__2_194_, v___x_195_);
        return v___x_196_;
    } else {
        ...
        v_val_197_ = leanh::lean_ctor_get(v_____do__lift_192_, 0);
        leanh::lean_inc(v_val_197_);
        leanh::lean_dec_ref_known(v_____do__lift_192_, 1);
        v___x_198_ = leanh::lean_apply_1(v_h__1_193_, v_val_197_);
        return v___x_198_;
    }
}
...
pub unsafe fn initialize_Init_Data_Option_Attach(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
