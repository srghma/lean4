...
static mut l_String_instOrd___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_String_instOrd___closed__0_value) as *mut crate::leanh::LeanObject;
pub static mut l_String_instOrd: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_String_instOrd___closed__0_value) as *mut crate::leanh::LeanObject;
pub unsafe fn l_String_compare___boxed(
    mut v_s_u2081_11_: *mut crate::leanh::LeanObject,
    mut v_s_u2082_12_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_13_: u8 = 0;
    let mut v_r_14_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_13_ = lean_string_compare(v_s_u2081_11_, v_s_u2082_12_);
    crate::leanh::lean_dec_ref(v_s_u2082_12_);
    crate::leanh::lean_dec_ref(v_s_u2081_11_);
    v_r_14_ = crate::leanh::lean_box((v_res_13_) as usize);
    return v_r_14_;
}
...
pub unsafe fn meta_initialize_Init_Data_Ord_String(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Ord_String(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
