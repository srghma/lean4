...
// Imports: Init.Data.Char.Basic Init.Data.Char.Lemmas Init.Data.Char.Order Init.Data.Char.Ordinal
...
use crate::r#gen::Init::Data::Char::Ordinal::{
    initialize_Init_Data_Char_Ordinal, runtime_initialize_Init_Data_Char_Ordinal,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Char(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Char(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Char(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
    ...
    leanh::lean_dec_ref(res);
    res = meta_initialize_Init_Data_Char(builtin);
    if leanh::lean_io_result_is_error(res) {
        return res;
    }
    leanh::lean_dec_ref(res);
    return initialize_Init_Data_Char(builtin);
}