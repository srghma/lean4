...
pub unsafe fn l_UInt64_log2___boxed(
    ...
    v_a_boxed_43_ = leanh::lean_unbox_uint64(v_a_42_);
    leanh::lean_dec_ref(v_a_42_);
    v_res_44_ = lean_uint64_log2(v_a_boxed_43_);
    v_r_45_ = leanh::lean_box_uint64(v_res_44_);
    return v_r_45_;
}
pub unsafe fn l_USize_log2___boxed(
    ...
    v_a_boxed_48_ = leanh::lean_unbox_usize(v_a_47_);
    leanh::lean_dec(v_a_47_);
    v_res_49_ = lean_usize_log2(v_a_boxed_48_);
    v_r_50_ = leanh::lean_box_usize(v_res_49_);
    return v_r_50_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_UInt_Log2(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_UInt_Log2(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_UInt_Log2(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
