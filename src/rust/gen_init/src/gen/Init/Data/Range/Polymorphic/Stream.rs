...
pub unsafe fn l_Std_PRange_instToStreamRccIterIteratorOfUpwardEnumerable___lam__0(
    mut v_r_137_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lower_138_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_upper_139_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_lower_138_ = leanh::lean_ctor_get(v_r_137_, 0);
                v_upper_139_ = leanh::lean_ctor_get(v_r_137_, 1);
                v_isSharedCheck_147_ = (!leanh::lean_is_exclusive(v_r_137_)) as u8;
                if v_isSharedCheck_147_ == 0 {
                    ...
                    leanh::lean_inc(v_upper_139_);
                    leanh::lean_inc(v_lower_138_);
                    leanh::lean_dec(v_r_137_);
            ...
            1 => {
                v___x_143_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                leanh::lean_ctor_set(v___x_143_, 0, v_lower_138_);
                if v_isShared_142_ == 0 {
                    leanh::lean_ctor_set(v___x_141_, 0, v___x_143_);
                    v___x_145_ = v___x_141_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_146_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_146_, 0, v___x_143_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_146_, 1, v_upper_139_);
...
pub unsafe fn l_Std_PRange_instToStreamRccIterIteratorOfUpwardEnumerable___boxed(
    mut v_00_u03b1_152_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_inst_153_);
    return v_res_154_;
}
pub unsafe fn l_Std_PRange_instToStreamRcoIterIteratorOfUpwardEnumerable___lam__0(
    mut v_r_155_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_lower_156_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_upper_157_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_164_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_165_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_lower_156_ = leanh::lean_ctor_get(v_r_155_, 0);
                v_upper_157_ = leanh::lean_ctor_get(v_r_155_, 1);
                v_isSharedCheck_165_ = (!leanh::lean_is_exclusive(v_r_155_)) as u8;
                if v_isSharedCheck_165_ == 0 {
                    ...
                    leanh::lean_inc(v_upper_157_);
                    leanh::lean_inc(v_lower_156_);
                    leanh::lean_dec(v_r_155_);
            ...
            1 => {
                v___x_161_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                leanh::lean_ctor_set(v___x_161_, 0, v_lower_156_);
                if v_isShared_160_ == 0 {
                    leanh::lean_ctor_set(v___x_159_, 0, v___x_161_);
                    v___x_163_ = v___x_159_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_164_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_164_, 0, v___x_161_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_164_, 1, v_upper_157_);
...
pub unsafe fn l_Std_PRange_instToStreamRcoIterIteratorOfUpwardEnumerable___boxed(
    ...
    leanh::lean_dec_ref(v_inst_171_);
    return v_res_172_;
}
pub unsafe fn l_Std_PRange_instToStreamRciIterIteratorOfUpwardEnumerable___lam__0(
    mut v_r_173_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_174_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_174_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
    leanh::lean_ctor_set(v___x_174_, 0, v_r_173_);
    return v___x_174_;
}
pub unsafe fn l_Std_PRange_instToStreamRciIterIteratorOfUpwardEnumerable(
    ...
    let mut v___f_178_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Std_PRange_instToStreamRciIterIteratorOfUpwardEnumerable___boxed(
    mut v_00_u03b1_179_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_PRange_instToStreamRocIterIteratorOfUpwardEnumerable___redArg___lam__0(
    ...
    mut v_r_183_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_succ_x3f_184_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lower_185_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_upper_186_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_succ_x3f_184_ = leanh::lean_ctor_get(v_inst_182_, 0);
                leanh::lean_inc_ref(v_succ_x3f_184_);
                leanh::lean_dec_ref(v_inst_182_);
                v_lower_185_ = leanh::lean_ctor_get(v_r_183_, 0);
                v_upper_186_ = leanh::lean_ctor_get(v_r_183_, 1);
                v_isSharedCheck_194_ = (!leanh::lean_is_exclusive(v_r_183_)) as u8;
                if v_isSharedCheck_194_ == 0 {
                    ...
                    leanh::lean_inc(v_upper_186_);
                    leanh::lean_inc(v_lower_185_);
                    leanh::lean_dec(v_r_183_);
            ...
            1 => {
                v___x_190_ = leanh::lean_apply_1(v_succ_x3f_184_, v_lower_185_);
                if v_isShared_189_ == 0 {
                    leanh::lean_ctor_set(v___x_188_, 0, v___x_190_);
                    v___x_192_ = v___x_188_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_193_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_193_, 0, v___x_190_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_193_, 1, v_upper_186_);
...
pub unsafe fn l_Std_PRange_instToStreamRocIterIteratorOfUpwardEnumerable(
    ...
    leanh::lean_closure_set(v___f_199_, 0, v_inst_198_);
    return v___f_199_;
}
pub unsafe fn l_Std_PRange_instToStreamRooIterIteratorOfUpwardEnumerable___redArg___lam__0(
    ...
    mut v_r_201_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_succ_x3f_202_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lower_203_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_upper_204_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_succ_x3f_202_ = leanh::lean_ctor_get(v_inst_200_, 0);
                leanh::lean_inc_ref(v_succ_x3f_202_);
                leanh::lean_dec_ref(v_inst_200_);
                v_lower_203_ = leanh::lean_ctor_get(v_r_201_, 0);
                v_upper_204_ = leanh::lean_ctor_get(v_r_201_, 1);
                v_isSharedCheck_212_ = (!leanh::lean_is_exclusive(v_r_201_)) as u8;
                if v_isSharedCheck_212_ == 0 {
                    ...
                    leanh::lean_inc(v_upper_204_);
                    leanh::lean_inc(v_lower_203_);
                    leanh::lean_dec(v_r_201_);
            ...
            1 => {
                v___x_208_ = leanh::lean_apply_1(v_succ_x3f_202_, v_lower_203_);
                if v_isShared_207_ == 0 {
                    leanh::lean_ctor_set(v___x_206_, 0, v___x_208_);
                    v___x_210_ = v___x_206_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_211_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_211_, 0, v___x_208_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_211_, 1, v_upper_204_);
...
pub unsafe fn l_Std_PRange_instToStreamRooIterIteratorOfUpwardEnumerable___redArg(
    ...
    leanh::lean_closure_set(v___f_214_, 0, v_inst_213_);
    return v___f_214_;
}
pub unsafe fn l_Std_PRange_instToStreamRooIterIteratorOfUpwardEnumerable(
    ...
    leanh::lean_closure_set(v___f_217_, 0, v_inst_216_);
    return v___f_217_;
}
pub unsafe fn l_Std_PRange_instToStreamRoiIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg___lam__0(
    ...
    let mut v_succ_x3f_220_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_221_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_succ_x3f_220_ = leanh::lean_ctor_get(v_inst_218_, 0);
    leanh::lean_inc_ref(v_succ_x3f_220_);
    leanh::lean_dec_ref(v_inst_218_);
    v___x_221_ = leanh::lean_apply_1(v_succ_x3f_220_, v_r_219_);
    return v___x_221_;
}
pub unsafe fn l_Std_PRange_instToStreamRoiIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg(
    ...
    leanh::lean_closure_set(v___f_223_, 0, v_inst_222_);
    return v___f_223_;
}
pub unsafe fn l_Std_PRange_instToStreamRoiIterIteratorOfUpwardEnumerableOfLeast_x3f(
    ...
    leanh::lean_closure_set(v___f_227_, 0, v_inst_225_);
    return v___f_227_;
}
...
pub unsafe fn l_Std_PRange_instToStreamRicIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg___lam__0(
    ...
    mut v_r_233_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_234_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_234_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_234_, 0, v_inst_232_);
    leanh::lean_ctor_set(v___x_234_, 1, v_r_233_);
    return v___x_234_;
}
pub unsafe fn l_Std_PRange_instToStreamRicIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg(
    ...
    leanh::lean_closure_set(v___f_236_, 0, v_inst_235_);
    return v___f_236_;
}
pub unsafe fn l_Std_PRange_instToStreamRicIterIteratorOfUpwardEnumerableOfLeast_x3f(
    ...
    leanh::lean_closure_set(v___f_240_, 0, v_inst_239_);
    return v___f_240_;
}
...
pub unsafe fn l_Std_PRange_instToStreamRioIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg___lam__0(
    ...
    mut v_r_246_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_247_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_247_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_247_, 0, v_inst_245_);
    leanh::lean_ctor_set(v___x_247_, 1, v_r_246_);
    return v___x_247_;
}
...
pub unsafe fn l_Std_PRange_instToStreamRiiIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg___lam__0(
    ...
    mut v_r_259_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_inst_258_);
    return v_inst_258_;
}
...
pub unsafe fn l_Std_PRange_instToStreamRiiIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg(
    ...
    let mut v___f_264_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_264_ = leanh::lean_alloc_closure(l_Std_PRange_instToStreamRiiIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg___lam__0___boxed as *mut core::ffi::c_void, 2, 1);
    leanh::lean_closure_set(v___f_264_, 0, v_inst_263_);
    return v___f_264_;
}
pub unsafe fn l_Std_PRange_instToStreamRiiIterIteratorOfUpwardEnumerableOfLeast_x3f(
    ...
    v___f_268_ = leanh::lean_alloc_closure(l_Std_PRange_instToStreamRiiIterIteratorOfUpwardEnumerableOfLeast_x3f___redArg___lam__0___boxed as *mut core::ffi::c_void, 2, 1);
