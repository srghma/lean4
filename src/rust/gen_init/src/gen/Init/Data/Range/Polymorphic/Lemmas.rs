...
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Rxc_Iterator_toList__eq__match_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_171_) == 0 {
        ...
        v___x_175_ = leanh::lean_apply_1(v_h__1_172_, v___x_174_);
        return v___x_175_;
    } else {
        ...
        v___x_177_ = leanh::lean_apply_1(v_h__2_173_, v_val_176_);
        return v___x_177_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Rxc_Iterator_toList__eq__match_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_180_) == 0 {
        ...
        v___x_184_ = leanh::lean_apply_1(v_h__1_181_, v___x_183_);
        return v___x_184_;
    } else {
        ...
        v___x_186_ = leanh::lean_apply_1(v_h__2_182_, v_val_185_);
        return v___x_186_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Rxc_Iterator_Monadic_step_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_187_) == 0 {
        ...
        v___x_191_ = leanh::lean_apply_1(v_h__1_188_, v___x_190_);
        return v___x_191_;
    } else {
        ...
        v_val_192_ = leanh::lean_ctor_get(v_x_187_, 0);
        leanh::lean_inc(v_val_192_);
        leanh::lean_dec_ref_known(v_x_187_, 1);
        v___x_193_ = leanh::lean_apply_1(v_h__2_189_, v_val_192_);
        return v___x_193_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Rxc_Iterator_Monadic_step_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_196_) == 0 {
        ...
        v___x_200_ = leanh::lean_apply_1(v_h__1_197_, v___x_199_);
        return v___x_200_;
    } else {
        ...
        v_val_201_ = leanh::lean_ctor_get(v_x_196_, 0);
        leanh::lean_inc(v_val_201_);
        leanh::lean_dec_ref_known(v_x_196_, 1);
        v___x_202_ = leanh::lean_apply_1(v_h__2_198_, v_val_201_);
        return v___x_202_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Iter_toArray__eq__match__step_match__1_splitter___redArg(
    ...
    mut v_h__3_206_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match leanh::lean_obj_tag(v_x_203_) {
        0 => {
            let mut v_it_207_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v_out_208_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_209_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_206_);
            leanh::lean_dec(v_h__2_205_);
            v_it_207_ = leanh::lean_ctor_get(v_x_203_, 0);
            leanh::lean_inc(v_it_207_);
            v_out_208_ = leanh::lean_ctor_get(v_x_203_, 1);
            leanh::lean_inc(v_out_208_);
            leanh::lean_dec_ref_known(v_x_203_, 2);
            v___x_209_ = leanh::lean_apply_2(v_h__1_204_, v_it_207_, v_out_208_);
            return v___x_209_;
        }
        1 => {
            let mut v_it_210_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_211_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_206_);
            leanh::lean_dec(v_h__1_204_);
            v_it_210_ = leanh::lean_ctor_get(v_x_203_, 0);
            leanh::lean_inc(v_it_210_);
            leanh::lean_dec_ref_known(v_x_203_, 1);
            v___x_211_ = leanh::lean_apply_1(v_h__2_205_, v_it_210_);
            return v___x_211_;
        }
        _ => {
            ...
            v___x_213_ = leanh::lean_apply_1(v_h__3_206_, v___x_212_);
            return v___x_213_;
        }
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Iter_toArray__eq__match__step_match__1_splitter(
    ...
    mut v_00_u03b2_215_: *mut leanh::LeanObject,
    ...
    match leanh::lean_obj_tag(v_x_217_) {
        0 => {
            let mut v_it_221_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v_out_222_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_223_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_220_);
            leanh::lean_dec(v_h__2_219_);
            v_it_221_ = leanh::lean_ctor_get(v_x_217_, 0);
            leanh::lean_inc(v_it_221_);
            v_out_222_ = leanh::lean_ctor_get(v_x_217_, 1);
            leanh::lean_inc(v_out_222_);
            leanh::lean_dec_ref_known(v_x_217_, 2);
            v___x_223_ = leanh::lean_apply_2(v_h__1_218_, v_it_221_, v_out_222_);
            return v___x_223_;
        }
        1 => {
            ...
            v_it_224_ = leanh::lean_ctor_get(v_x_217_, 0);
            leanh::lean_inc(v_it_224_);
            leanh::lean_dec_ref_known(v_x_217_, 1);
            v___x_225_ = leanh::lean_apply_1(v_h__2_219_, v_it_224_);
            return v___x_225_;
        }
        _ => {
            ...
            v___x_227_ = leanh::lean_apply_1(v_h__3_220_, v___x_226_);
            return v___x_227_;
        }
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Rcc_forIn_x27__eq__if_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_____do__lift_228_) == 0 {
        ...
        v_a_231_ = leanh::lean_ctor_get(v_____do__lift_228_, 0);
        leanh::lean_inc(v_a_231_);
        leanh::lean_dec_ref_known(v_____do__lift_228_, 1);
        v___x_232_ = leanh::lean_apply_1(v_h__2_230_, v_a_231_);
        return v___x_232_;
    } else {
        ...
        v_a_233_ = leanh::lean_ctor_get(v_____do__lift_228_, 0);
        leanh::lean_inc(v_a_233_);
        leanh::lean_dec_ref_known(v_____do__lift_228_, 1);
        v___x_234_ = leanh::lean_apply_1(v_h__1_229_, v_a_233_);
        return v___x_234_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Rcc_forIn_x27__eq__if_match__1_splitter(
    mut v_00_u03b3_235_: *mut leanh::LeanObject,
    ...
    if leanh::lean_obj_tag(v_____do__lift_237_) == 0 {
        ...
        v_a_240_ = leanh::lean_ctor_get(v_____do__lift_237_, 0);
        leanh::lean_inc(v_a_240_);
        leanh::lean_dec_ref_known(v_____do__lift_237_, 1);
        v___x_241_ = leanh::lean_apply_1(v_h__2_239_, v_a_240_);
        return v___x_241_;
    } else {
        let mut v_a_242_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_243_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_239_);
        v_a_242_ = leanh::lean_ctor_get(v_____do__lift_237_, 0);
        leanh::lean_inc(v_a_242_);
        leanh::lean_dec_ref_known(v_____do__lift_237_, 1);
        v___x_243_ = leanh::lean_apply_1(v_h__1_238_, v_a_242_);
        return v___x_243_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Iter_forIn_x27__eq__match__step_match__3_splitter___redArg(
    ...
    mut v_h__3_247_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    match leanh::lean_obj_tag(v_x_244_) {
        0 => {
            let mut v_it_248_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v_out_249_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_250_: *mut leanh::LeanObject = core::ptr::null_mut();
            leanh::lean_dec(v_h__3_247_);
            leanh::lean_dec(v_h__2_246_);
            v_it_248_ = leanh::lean_ctor_get(v_x_244_, 0);
            leanh::lean_inc(v_it_248_);
            v_out_249_ = leanh::lean_ctor_get(v_x_244_, 1);
            leanh::lean_inc(v_out_249_);
            leanh::lean_dec_ref_known(v_x_244_, 2);
            v___x_250_ = leanh::lean_apply_3(
                v_h__1_245_,
                v_it_248_,
                v_out_249_,
                leanh::lean_box(0),
        ...
        1 => {
            ...
            v_it_251_ = leanh::lean_ctor_get(v_x_244_, 0);
            leanh::lean_inc(v_it_251_);
            leanh::lean_dec_ref_known(v_x_244_, 1);
            v___x_252_ =
                leanh::lean_apply_2(v_h__2_246_, v_it_251_, leanh::lean_box(0));
            return v___x_252_;
        }
        _ => {
            ...
            leanh::lean_dec(v_h__2_246_);
            leanh::lean_dec(v_h__1_245_);
            v___x_253_ = leanh::lean_apply_1(v_h__3_247_, leanh::lean_box(0));
            return v___x_253_;
        }
    }
}
...
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Iter_forIn_x27__eq__match__step_match__1_splitter___redArg(
    mut v_____do__lift_279_: *mut leanh::LeanObject,
    mut v_h__1_280_: *mut leanh::LeanObject,
    mut v_h__2_281_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_____do__lift_279_) == 0 {
        ...
        v_a_282_ = leanh::lean_ctor_get(v_____do__lift_279_, 0);
        leanh::lean_inc(v_a_282_);
        leanh::lean_dec_ref_known(v_____do__lift_279_, 1);
        v___x_283_ = leanh::lean_apply_1(v_h__2_281_, v_a_282_);
        return v___x_283_;
    } else {
        ...
        v_a_284_ = leanh::lean_ctor_get(v_____do__lift_279_, 0);
        leanh::lean_inc(v_a_284_);
        leanh::lean_dec_ref_known(v_____do__lift_279_, 1);
        v___x_285_ = leanh::lean_apply_1(v_h__1_280_, v_a_284_);
        return v___x_285_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Iter_forIn_x27__eq__match__step_match__1_splitter(
    ...
    mut v_motive_287_: *mut leanh::LeanObject,
    mut v_____do__lift_288_: *mut leanh::LeanObject,
    mut v_h__1_289_: *mut leanh::LeanObject,
    mut v_h__2_290_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_____do__lift_288_) == 0 {
        ...
        v_a_291_ = leanh::lean_ctor_get(v_____do__lift_288_, 0);
        leanh::lean_inc(v_a_291_);
        leanh::lean_dec_ref_known(v_____do__lift_288_, 1);
        v___x_292_ = leanh::lean_apply_1(v_h__2_290_, v_a_291_);
        return v___x_292_;
    } else {
        ...
        v_a_293_ = leanh::lean_ctor_get(v_____do__lift_288_, 0);
        leanh::lean_inc(v_a_293_);
        leanh::lean_dec_ref_known(v_____do__lift_288_, 1);
        v___x_294_ = leanh::lean_apply_1(v_h__1_289_, v_a_293_);
        return v___x_294_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Roc_forIn_x27__eq__match_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_295_) == 0 {
        let mut v___x_298_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_297_);
        v___x_298_ = leanh::lean_apply_1(v_h__1_296_, leanh::lean_box(0));
        return v___x_298_;
    } else {
        ...
        v_val_299_ = leanh::lean_ctor_get(v_x_295_, 0);
        leanh::lean_inc(v_val_299_);
        leanh::lean_dec_ref_known(v_x_295_, 1);
        v___x_300_ = leanh::lean_apply_2(v_h__2_297_, v_val_299_, leanh::lean_box(0));
        return v___x_300_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Roc_forIn_x27__eq__match_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_303_) == 0 {
        ...
        v___x_306_ = leanh::lean_apply_1(v_h__1_304_, leanh::lean_box(0));
        return v___x_306_;
    } else {
        ...
        v___x_308_ = leanh::lean_apply_2(v_h__2_305_, v_val_307_, leanh::lean_box(0));
        return v___x_308_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__List_forIn_x27__cons_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_309_) == 0 {
        ...
        v_a_312_ = leanh::lean_ctor_get(v_x_309_, 0);
        leanh::lean_inc(v_a_312_);
        leanh::lean_dec_ref_known(v_x_309_, 1);
        v___x_313_ = leanh::lean_apply_1(v_h__1_310_, v_a_312_);
        return v___x_313_;
    } else {
        ...
        v_a_314_ = leanh::lean_ctor_get(v_x_309_, 0);
        leanh::lean_inc(v_a_314_);
        leanh::lean_dec_ref_known(v_x_309_, 1);
        v___x_315_ = leanh::lean_apply_1(v_h__2_311_, v_a_314_);
        return v___x_315_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__List_forIn_x27__cons_match__1_splitter(
    ...
    mut v_motive_317_: *mut leanh::LeanObject,
    mut v_x_318_: *mut leanh::LeanObject,
    mut v_h__1_319_: *mut leanh::LeanObject,
    mut v_h__2_320_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_x_318_) == 0 {
        ...
        leanh::lean_dec(v_h__2_320_);
        v_a_321_ = leanh::lean_ctor_get(v_x_318_, 0);
        leanh::lean_inc(v_a_321_);
        leanh::lean_dec_ref_known(v_x_318_, 1);
        v___x_322_ = leanh::lean_apply_1(v_h__1_319_, v_a_321_);
        return v___x_322_;
    } else {
        let mut v_a_323_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_324_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_319_);
        v_a_323_ = leanh::lean_ctor_get(v_x_318_, 0);
        leanh::lean_inc(v_a_323_);
        leanh::lean_dec_ref_known(v_x_318_, 1);
        v___x_324_ = leanh::lean_apply_1(v_h__2_320_, v_a_323_);
        return v___x_324_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Roc_size_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_325_) == 0 {
        ...
        v___x_329_ = leanh::lean_apply_1(v_h__1_326_, v___x_328_);
        return v___x_329_;
    } else {
        ...
        v_val_330_ = leanh::lean_ctor_get(v_x_325_, 0);
        leanh::lean_inc(v_val_330_);
        leanh::lean_dec_ref_known(v_x_325_, 1);
        v___x_331_ = leanh::lean_apply_1(v_h__2_327_, v_val_330_);
        return v___x_331_;
    }
}
pub unsafe fn l___private_Init_Data_Range_Polymorphic_Lemmas_0__Std_Roc_size_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_334_) == 0 {
        ...
        v___x_338_ = leanh::lean_apply_1(v_h__1_335_, v___x_337_);
        return v___x_338_;
    } else {
        ...
        v_val_339_ = leanh::lean_ctor_get(v_x_334_, 0);
        leanh::lean_inc(v_val_339_);
        leanh::lean_dec_ref_known(v_x_334_, 1);
        v___x_340_ = leanh::lean_apply_1(v_h__2_336_, v_val_339_);
        return v___x_340_;
    }
}
