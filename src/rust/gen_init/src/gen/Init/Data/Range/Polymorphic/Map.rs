...
// Imports: Init.Data.Function Init.Data.Order.Lemmas Init.Data.Option.Function Init.Data.Range.Polymorphic.Basic Init.Data.Option.Lemmas
...
pub unsafe fn runtime_initialize_Init_Data_Range_Polymorphic_Map(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_Range_Polymorphic_Map(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Range_Polymorphic_Map(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
