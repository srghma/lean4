...
pub static l_BitVec_instRxcHasSize___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_BitVec_instRxcHasSize___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_BitVec_instRxcHasSize___closed__0_value) as *mut leanh::LeanObject;
pub static l_BitVec_instRxoHasSize___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_BitVec_instRxoHasSize___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_BitVec_instRxoHasSize___closed__0_value) as *mut leanh::LeanObject;
pub unsafe fn l_BitVec_instUpwardEnumerable___lam__0(
    mut v_n_68_: *mut leanh::LeanObject,
    mut v_i_69_: *mut leanh::LeanObject,
    ...
    if v___x_75_ == 0 {
        ...
        v___x_76_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
        leanh::lean_ctor_set(v___x_76_, 0, v___x_72_);
        return v___x_76_;
    } else {
...
pub unsafe fn l_BitVec_instUpwardEnumerable___lam__1(
    ...
    v___x_85_ = leanh::lean_unsigned_to_nat(2);
    ...
    if v___x_87_ == 0 {
        ...
        v___x_89_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
        leanh::lean_ctor_set(v___x_89_, 0, v___x_84_);
        return v___x_89_;
    }
}
pub unsafe fn l_BitVec_instUpwardEnumerable___lam__1___boxed(
    ...
    mut v_i_92_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_BitVec_instRxcHasSize___lam__0(
    ...
    v___x_100_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_BitVec_instRxoHasSize___lam__0(
    mut v_lo_111_: *mut leanh::LeanObject,
    mut v_hi_112_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_BitVec_instRxiHasSize___lam__0(
    ...
    mut v_lo_126_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v___x_127_ = leanh::lean_unsigned_to_nat(2);
...
pub unsafe fn l_BitVec_instRxiHasSize___lam__0___boxed(
    mut v_n_130_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_n_130_);
    return v_res_132_;
}
pub unsafe fn l_BitVec_instRxiHasSize(
    mut v_n_133_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_closure_set(v___f_134_, 0, v_n_133_);
    return v___f_134_;
}
