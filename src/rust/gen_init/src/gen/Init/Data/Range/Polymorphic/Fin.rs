...
pub static mut l_Fin_instLeast_x3fOfNatNat: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_Fin_instHasSize___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_Fin_instHasSize___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Fin_instHasSize___closed__0_value) as *mut leanh::LeanObject;
pub static l_Fin_instHasSize__1___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Fin_instHasSize__1___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Fin_instHasSize__1___closed__0_value) as *mut leanh::LeanObject;
...
pub unsafe fn l_Fin_instUpwardEnumerable___lam__1(
    ...
    if v___x_88_ == 0 {
        ...
        leanh::lean_dec(v___x_87_);
        v___x_89_ = leanh::lean_box(0);
        return v___x_89_;
    } else {
        let mut v___x_90_: *mut leanh::LeanObject = core::ptr::null_mut();
        v___x_90_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
        leanh::lean_ctor_set(v___x_90_, 0, v___x_87_);
        return v___x_90_;
    }
}
pub unsafe fn l_Fin_instUpwardEnumerable___lam__1___boxed(
    mut v_n_91_: *mut leanh::LeanObject,
    mut v_m_92_: *mut leanh::LeanObject,
    mut v_i_93_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_i_93_);
    leanh::lean_dec(v_m_92_);
...
pub unsafe fn l_Fin_instUpwardEnumerable(
    ...
    let mut v___f_96_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___f_97_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_98_: *mut leanh::LeanObject = core::ptr::null_mut();
    leanh::lean_inc(v_n_95_);
    v___f_96_ = leanh::lean_alloc_closure(
        l_Fin_instUpwardEnumerable___lam__0___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    leanh::lean_closure_set(v___f_96_, 0, v_n_95_);
    v___f_97_ = leanh::lean_alloc_closure(
        l_Fin_instUpwardEnumerable___lam__1___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_97_, 0, v_n_95_);
    v___x_98_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_98_, 0, v___f_96_);
    leanh::lean_ctor_set(v___x_98_, 1, v___f_97_);
    return v___x_98_;
}
pub unsafe fn _init_l_Fin_instLeast_x3fOfNatNat() -> *mut leanh::LeanObject {
...
pub unsafe fn l_Fin_instLeast_x3fOfNeZeroNat___redArg(
    ...
    v___x_103_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Fin_instLeast_x3fOfNeZeroNat___boxed(
    ...
    leanh::lean_dec(v_n_109_);
    return v_res_111_;
}
pub unsafe fn l_Fin_instHasSize___lam__0(
    mut v_lo_112_: *mut leanh::LeanObject,
    mut v_hi_113_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Fin_instHasSize__1___lam__0(
    mut v_lo_125_: *mut leanh::LeanObject,
    mut v_hi_126_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Fin_instHasSize__2___lam__0(
    mut v_n_139_: *mut leanh::LeanObject,
    mut v_lo_140_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn runtime_initialize_Init_Data_Range_Polymorphic_Fin(
    ...
    leanh::lean_mark_persistent(l_Fin_instLeast_x3fOfNatNat);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
