...
pub unsafe fn l_Std_Rxo_HasSize_ofClosed___redArg___lam__0(
    mut v_inst_12_: *mut leanh::LeanObject,
    mut v_lo_13_: *mut leanh::LeanObject,
    mut v_hi_14_: *mut leanh::LeanObject,
    ...
    v___x_15_ = leanh::lean_apply_2(v_inst_12_, v_lo_13_, v_hi_14_);
    v___x_16_ = leanh::lean_unsigned_to_nat(1);
    v___x_17_ = lean_nat_sub(v___x_15_, v___x_16_);
    leanh::lean_dec(v___x_15_);
    return v___x_17_;
}
pub unsafe fn l_Std_Rxo_HasSize_ofClosed___redArg(
    mut v_inst_18_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_19_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_19_ = leanh::lean_alloc_closure(
        l_Std_Rxo_HasSize_ofClosed___redArg___lam__0 as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_19_, 0, v_inst_18_);
    return v___f_19_;
}
pub unsafe fn l_Std_Rxo_HasSize_ofClosed(
    mut v_00_u03b1_20_: *mut leanh::LeanObject,
    mut v_inst_21_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_22_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_22_ = leanh::lean_alloc_closure(
        l_Std_Rxo_HasSize_ofClosed___redArg___lam__0 as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_22_, 0, v_inst_21_);
    return v___f_22_;
}
