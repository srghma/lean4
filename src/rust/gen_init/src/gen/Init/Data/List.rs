...
// Imports: Init.Data.List.Attach Init.Data.List.Basic Init.Data.List.BasicAux Init.Data.List.Control Init.Data.List.Count Init.Data.List.Erase Init.Data.List.Find Init.Data.List.Impl Init.Data.List.Lemmas Init.Data.List.MinMax Init.Data.List.MinMaxIdx Init.Data.List.MinMaxOn Init.Data.List.Monadic Init.Data.List.Nat Init.Data.List.Int Init.Data.List.Notation Init.Data.List.Pairwise Init.Data.List.Sublist Init.Data.List.TakeDrop Init.Data.List.Zip Init.Data.List.Perm Init.Data.List.Sort Init.Data.List.ToArray Init.Data.List.ToArrayImpl Init.Data.List.MapIdx Init.Data.List.OfFn Init.Data.List.FinRange Init.Data.List.Lex Init.Data.List.Range Init.Data.List.Scan Init.Data.List.ControlImpl Init.Data.List.SplitOn
...
use crate::r#gen::Init::Data::List::ControlImpl::{
    initialize_Init_Data_List_ControlImpl, runtime_initialize_Init_Data_List_ControlImpl,
};
...
use crate::r#gen::Init::Data::List::Int::{
    initialize_Init_Data_List_Int, runtime_initialize_Init_Data_List_Int,
};
...
use crate::r#gen::Init::Data::List::MinMaxIdx::{
    initialize_Init_Data_List_MinMaxIdx, runtime_initialize_Init_Data_List_MinMaxIdx,
};
...
use crate::r#gen::Init::Data::List::Nat::{
    initialize_Init_Data_List_Nat, runtime_initialize_Init_Data_List_Nat,
};
...
use crate::r#gen::Init::Data::List::Scan::{
    initialize_Init_Data_List_Scan, runtime_initialize_Init_Data_List_Scan,
};
use crate::r#gen::Init::Data::List::Sort::{
    initialize_Init_Data_List_Sort, runtime_initialize_Init_Data_List_Sort,
};
use crate::r#gen::Init::Data::List::SplitOn::{
    initialize_Init_Data_List_SplitOn, runtime_initialize_Init_Data_List_SplitOn,
};
...
pub unsafe fn runtime_initialize_Init_Data_List(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
