...
static mut l_Float_ofScientific___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Float_ofScientific___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
static mut l_Float_ofScientific___closed__1_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Float_ofScientific___closed__1: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_instOfScientificFloat___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_instOfScientificFloat___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat___closed__0_value) as *mut leanh::LeanObject;
pub static mut l_instOfScientificFloat: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat___closed__0_value) as *mut leanh::LeanObject;
static mut l_Float_ofInt___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Float_ofInt___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_instOfScientificFloat32___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_instOfScientificFloat32___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat32___closed__0_value)
        as *mut leanh::LeanObject;
pub static mut l_instOfScientificFloat32: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat32___closed__0_value)
        as *mut leanh::LeanObject;
...
pub unsafe fn l_Float_ofBinaryScientific___boxed(
    ...
    leanh::lean_dec(v_e_179_);
    leanh::lean_dec(v_m_178_);
    v_r_181_ = leanh::lean_box_float(v_res_180_);
    return v_r_181_;
}
pub unsafe fn _init_l_Float_ofScientific___closed__0() -> *mut leanh::LeanObject {
    let mut v___x_182_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_183_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_182_ = leanh::lean_unsigned_to_nat(4);
    v___x_183_ = lean_nat_to_int(v___x_182_);
    return v___x_183_;
}
pub unsafe fn _init_l_Float_ofScientific___closed__1() -> *mut leanh::LeanObject {
...
pub unsafe fn l_Float_ofScientific(
    mut v_m_186_: *mut leanh::LeanObject,
    mut v_s_187_: u8,
    mut v_e_188_: *mut leanh::LeanObject,
) -> f64 {
    if v_s_187_ == 0 {
        ...
        v___x_189_ = leanh::lean_unsigned_to_nat(5);
        ...
        let mut v_m_203_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v___x_194_ = leanh::lean_unsigned_to_nat(64);
        v___x_195_ = lean_nat_log2(v_m_186_);
        v_s_196_ = lean_nat_sub(v___x_194_, v___x_195_);
        leanh::lean_dec(v___x_195_);
        v___x_197_ = leanh::lean_unsigned_to_nat(3);
        ...
        leanh::lean_dec(v_m_203_);
        return v___x_209_;
    }
}
pub unsafe fn l_Float_ofScientific___boxed(
    mut v_m_210_: *mut leanh::LeanObject,
    mut v_s_211_: *mut leanh::LeanObject,
    mut v_e_212_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_s_boxed_213_: u8 = 0;
    let mut v_res_214_: f64 = 0.0;
    let mut v_r_215_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_s_boxed_213_ = (leanh::lean_unbox(v_s_211_) as u8);
    v_res_214_ = l_Float_ofScientific(v_m_210_, v_s_boxed_213_, v_e_212_);
    leanh::lean_dec(v_m_210_);
    v_r_215_ = leanh::lean_box_float(v_res_214_);
    return v_r_215_;
}
pub unsafe fn lean_float_of_nat(mut v_n_218_: *mut leanh::LeanObject) -> f64 {
...
pub unsafe fn l_Float_ofNat___boxed(
    ...
    v_r_224_ = leanh::lean_box_float(v_res_223_);
    return v_r_224_;
}
pub unsafe fn _init_l_Float_ofInt___closed__0() -> *mut leanh::LeanObject {
    let mut v_natZero_225_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_intZero_226_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_natZero_225_ = leanh::lean_unsigned_to_nat(0);
    v_intZero_226_ = lean_nat_to_int(v_natZero_225_);
    return v_intZero_226_;
}
pub unsafe fn l_Float_ofInt(mut v_x_227_: *mut leanh::LeanObject) -> f64 {
    let mut v_intZero_228_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_229_: u8 = 0;
    v_intZero_228_ = leanh::lean_obj_once(
    ...
    if v_isNeg_229_ == 0 {
        ...
        let mut v_abs_232_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_233_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v_one_233_ = leanh::lean_unsigned_to_nat(1);
        v_a_234_ = lean_nat_sub(v_abs_232_, v_one_233_);
        leanh::lean_dec(v_abs_232_);
...
pub unsafe fn l_Float_ofInt___boxed(
    ...
    leanh::lean_dec(v_x_238_);
    v_r_240_ = leanh::lean_box_float(v_res_239_);
    return v_r_240_;
}
pub unsafe fn l_instOfNatFloat(mut v_n_241_: *mut leanh::LeanObject) -> f64 {
    let mut v___x_242_: f64 = 0.0;
    v___x_242_ = lean_float_of_nat(v_n_241_);
    return v___x_242_;
}
pub unsafe fn l_instOfNatFloat___boxed(
    mut v_n_243_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_244_: f64 = 0.0;
    let mut v_r_245_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_244_ = l_instOfNatFloat(v_n_243_);
    v_r_245_ = leanh::lean_box_float(v_res_244_);
    return v_r_245_;
}
pub unsafe fn l_Nat_toFloat(mut v_n_246_: *mut leanh::LeanObject) -> f64 {
    let mut v___x_247_: f64 = 0.0;
    v___x_247_ = lean_float_of_nat(v_n_246_);
    return v___x_247_;
}
pub unsafe fn l_Nat_toFloat___boxed(
    mut v_n_248_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_249_: f64 = 0.0;
    let mut v_r_250_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_249_ = l_Nat_toFloat(v_n_248_);
    v_r_250_ = leanh::lean_box_float(v_res_249_);
    return v_r_250_;
}
pub unsafe fn l_Float32_ofBinaryScientific(
    ...
    let mut v_s_255_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_e_259_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_260_: f32 = 0.0f32;
    let mut v___x_261_: f32 = 0.0f32;
    v___x_253_ = lean_nat_log2(v_m_251_);
    v___x_254_ = leanh::lean_unsigned_to_nat(63);
    ...
    leanh::lean_dec(v_e_259_);
    return v___x_261_;
}
pub unsafe fn l_Float32_ofBinaryScientific___boxed(
    mut v_m_262_: *mut leanh::LeanObject,
    mut v_e_263_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_264_: f32 = 0.0f32;
    let mut v_r_265_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_264_ = l_Float32_ofBinaryScientific(v_m_262_, v_e_263_);
    leanh::lean_dec(v_e_263_);
    leanh::lean_dec(v_m_262_);
    v_r_265_ = leanh::lean_box_float32(v_res_264_);
    return v_r_265_;
}
pub unsafe fn l_Float32_ofScientific(
    mut v_m_266_: *mut leanh::LeanObject,
    mut v_s_267_: u8,
    mut v_e_268_: *mut leanh::LeanObject,
) -> f32 {
    if v_s_267_ == 0 {
        ...
        v___x_269_ = leanh::lean_unsigned_to_nat(5);
        ...
        let mut v_s_276_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        let mut v_m_283_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Float32_ofScientific___boxed(
    ...
    mut v_e_292_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_s_boxed_293_: u8 = 0;
    let mut v_res_294_: f32 = 0.0f32;
    let mut v_r_295_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_s_boxed_293_ = (leanh::lean_unbox(v_s_291_) as u8);
    v_res_294_ = l_Float32_ofScientific(v_m_290_, v_s_boxed_293_, v_e_292_);
    leanh::lean_dec(v_m_290_);
    v_r_295_ = leanh::lean_box_float32(v_res_294_);
    return v_r_295_;
}
pub unsafe fn lean_float32_of_nat(mut v_n_298_: *mut leanh::LeanObject) -> f32 {
...
pub unsafe fn l_Float32_ofNat___boxed(
    ...
    v_r_304_ = leanh::lean_box_float32(v_res_303_);
    return v_r_304_;
}
pub unsafe fn l_Float32_ofInt(mut v_x_305_: *mut leanh::LeanObject) -> f32 {
    let mut v_intZero_306_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_307_: u8 = 0;
    v_intZero_306_ = leanh::lean_obj_once(
        core::ptr::addr_of_mut!(l_Float_ofInt___closed__0),
        core::ptr::addr_of_mut!(l_Float_ofInt___closed__0_once),
        _init_l_Float_ofInt___closed__0,
    );
    ...
    if v_isNeg_307_ == 0 {
        ...
        let mut v_abs_310_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_311_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v_one_311_ = leanh::lean_unsigned_to_nat(1);
        v_a_312_ = lean_nat_sub(v_abs_310_, v_one_311_);
        leanh::lean_dec(v_abs_310_);
        v___x_313_ = lean_nat_add(v_a_312_, v_one_311_);
        leanh::lean_dec(v_a_312_);
...
pub unsafe fn l_Float32_ofInt___boxed(
    ...
    v_r_318_ = leanh::lean_box_float32(v_res_317_);
    return v_r_318_;
}
pub unsafe fn l_instOfNatFloat32(mut v_n_319_: *mut leanh::LeanObject) -> f32 {
...
pub unsafe fn l_instOfNatFloat32___boxed(
    ...
    let mut v_r_323_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_322_ = l_instOfNatFloat32(v_n_321_);
    v_r_323_ = leanh::lean_box_float32(v_res_322_);
    return v_r_323_;
}
pub unsafe fn l_Nat_toFloat32(mut v_n_324_: *mut leanh::LeanObject) -> f32 {
...
pub unsafe fn l_Nat_toFloat32___boxed(
    ...
    v_r_328_ = leanh::lean_box_float32(v_res_327_);
    return v_r_328_;
}
...
pub unsafe fn meta_initialize_Init_Data_OfScientific(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_OfScientific(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
