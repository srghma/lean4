...
static mut l_Float_ofScientific___closed__0: *mut crate::leanh::LeanObject = core::ptr::null_mut();
static mut l_Float_ofScientific___closed__1_once: crate::leanh::LeanOnceCell =
    crate::leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Float_ofScientific___closed__1: *mut crate::leanh::LeanObject = core::ptr::null_mut();
pub static l_instOfScientificFloat___closed__0_value: crate::leanh::LeanClosureObject<0> =
...
static mut l_instOfScientificFloat___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat___closed__0_value) as *mut crate::leanh::LeanObject;
pub static mut l_instOfScientificFloat: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat___closed__0_value) as *mut crate::leanh::LeanObject;
static mut l_Float_ofInt___closed__0_once: crate::leanh::LeanOnceCell =
    crate::leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Float_ofInt___closed__0: *mut crate::leanh::LeanObject = core::ptr::null_mut();
pub static l_instOfScientificFloat32___closed__0_value: crate::leanh::LeanClosureObject<0> =
    crate::leanh::LeanClosureObject {
        m_header: crate::leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<crate::leanh::LeanObject>()
...
static mut l_instOfScientificFloat32___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat32___closed__0_value)
        as *mut crate::leanh::LeanObject;
pub static mut l_instOfScientificFloat32: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_instOfScientificFloat32___closed__0_value)
        as *mut crate::leanh::LeanObject;
...
pub unsafe fn l_Float_ofBinaryScientific(
    ...
    mut v_e_168_: *mut crate::leanh::LeanObject,
) -> f64 {
    ...
    let mut v_s_171_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Float_ofBinaryScientific___boxed(
    ...
    crate::leanh::lean_dec(v_e_179_);
    crate::leanh::lean_dec(v_m_178_);
    v_r_181_ = crate::leanh::lean_box_float(v_res_180_);
    return v_r_181_;
}
pub unsafe fn _init_l_Float_ofScientific___closed__0() -> *mut crate::leanh::LeanObject {
    ...
    v___x_182_ = crate::leanh::lean_unsigned_to_nat(4);
    v___x_183_ = lean_nat_to_int(v___x_182_);
    return v___x_183_;
}
pub unsafe fn _init_l_Float_ofScientific___closed__1() -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Float_ofScientific(
    mut v_m_186_: *mut crate::leanh::LeanObject,
    mut v_s_187_: u8,
    mut v_e_188_: *mut crate::leanh::LeanObject,
) -> f64 {
    if v_s_187_ == 0 {
        ...
        v___x_189_ = crate::leanh::lean_unsigned_to_nat(5);
        ...
        crate::leanh::lean_dec(v___x_191_);
        return v___x_193_;
    } else {
        ...
        let mut v_s_196_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        ...
        let mut v_m_203_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        ...
        crate::leanh::lean_dec(v___x_205_);
...
pub unsafe fn l_Float_ofScientific___boxed(
    ...
    v_s_boxed_213_ = (crate::leanh::lean_unbox(v_s_211_) as u8);
    v_res_214_ = l_Float_ofScientific(v_m_210_, v_s_boxed_213_, v_e_212_);
    crate::leanh::lean_dec(v_m_210_);
    v_r_215_ = crate::leanh::lean_box_float(v_res_214_);
    return v_r_215_;
}
pub unsafe fn lean_float_of_nat(mut v_n_218_: *mut crate::leanh::LeanObject) -> f64 {
    ...
    crate::leanh::lean_dec(v_n_218_);
    return v___x_221_;
}
pub unsafe fn l_Float_ofNat___boxed(
    ...
    v_r_224_ = crate::leanh::lean_box_float(v_res_223_);
    return v_r_224_;
}
pub unsafe fn _init_l_Float_ofInt___closed__0() -> *mut crate::leanh::LeanObject {
    let mut v_natZero_225_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_intZero_226_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_natZero_225_ = crate::leanh::lean_unsigned_to_nat(0);
    v_intZero_226_ = lean_nat_to_int(v_natZero_225_);
    return v_intZero_226_;
}
pub unsafe fn l_Float_ofInt(mut v_x_227_: *mut crate::leanh::LeanObject) -> f64 {
    let mut v_intZero_228_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_229_: u8 = 0;
    v_intZero_228_ = crate::leanh::lean_obj_once(
    ...
    if v_isNeg_229_ == 0 {
        ...
        let mut v_abs_232_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_233_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        ...
        v_one_233_ = crate::leanh::lean_unsigned_to_nat(1);
        v_a_234_ = lean_nat_sub(v_abs_232_, v_one_233_);
        crate::leanh::lean_dec(v_abs_232_);
...
pub unsafe fn l_Float_ofInt___boxed(
    ...
    crate::leanh::lean_dec(v_x_238_);
    v_r_240_ = crate::leanh::lean_box_float(v_res_239_);
    return v_r_240_;
}
pub unsafe fn l_instOfNatFloat(mut v_n_241_: *mut crate::leanh::LeanObject) -> f64 {
    let mut v___x_242_: f64 = 0.0;
    v___x_242_ = lean_float_of_nat(v_n_241_);
    return v___x_242_;
}
pub unsafe fn l_instOfNatFloat___boxed(
    mut v_n_243_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    v_r_245_ = crate::leanh::lean_box_float(v_res_244_);
    return v_r_245_;
}
pub unsafe fn l_Nat_toFloat(mut v_n_246_: *mut crate::leanh::LeanObject) -> f64 {
    let mut v___x_247_: f64 = 0.0;
    v___x_247_ = lean_float_of_nat(v_n_246_);
    return v___x_247_;
}
pub unsafe fn l_Nat_toFloat___boxed(
    ...
    v_r_250_ = crate::leanh::lean_box_float(v_res_249_);
    return v_r_250_;
}
pub unsafe fn l_Float32_ofBinaryScientific(
    ...
    let mut v_s_255_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_e_259_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_260_: f32 = 0.0f32;
    let mut v___x_261_: f32 = 0.0f32;
    v___x_253_ = lean_nat_log2(v_m_251_);
    v___x_254_ = crate::leanh::lean_unsigned_to_nat(63);
    ...
    crate::leanh::lean_dec(v_e_259_);
    return v___x_261_;
}
pub unsafe fn l_Float32_ofBinaryScientific___boxed(
    mut v_m_262_: *mut crate::leanh::LeanObject,
    mut v_e_263_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_264_: f32 = 0.0f32;
    let mut v_r_265_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_264_ = l_Float32_ofBinaryScientific(v_m_262_, v_e_263_);
    crate::leanh::lean_dec(v_e_263_);
    crate::leanh::lean_dec(v_m_262_);
    v_r_265_ = crate::leanh::lean_box_float32(v_res_264_);
    return v_r_265_;
}
pub unsafe fn l_Float32_ofScientific(
    mut v_m_266_: *mut crate::leanh::LeanObject,
    mut v_s_267_: u8,
    mut v_e_268_: *mut crate::leanh::LeanObject,
) -> f32 {
    if v_s_267_ == 0 {
        ...
        v___x_269_ = crate::leanh::lean_unsigned_to_nat(5);
        ...
        let mut v_s_276_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        ...
        let mut v_m_283_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Float32_ofScientific___boxed(
    ...
    mut v_e_292_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_s_boxed_293_: u8 = 0;
    let mut v_res_294_: f32 = 0.0f32;
    let mut v_r_295_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_s_boxed_293_ = (crate::leanh::lean_unbox(v_s_291_) as u8);
    v_res_294_ = l_Float32_ofScientific(v_m_290_, v_s_boxed_293_, v_e_292_);
    crate::leanh::lean_dec(v_m_290_);
    v_r_295_ = crate::leanh::lean_box_float32(v_res_294_);
    return v_r_295_;
}
pub unsafe fn lean_float32_of_nat(mut v_n_298_: *mut crate::leanh::LeanObject) -> f32 {
    ...
    crate::leanh::lean_dec(v_n_298_);
    return v___x_301_;
}
pub unsafe fn l_Float32_ofNat___boxed(
    ...
    v_r_304_ = crate::leanh::lean_box_float32(v_res_303_);
    return v_r_304_;
}
pub unsafe fn l_Float32_ofInt(mut v_x_305_: *mut crate::leanh::LeanObject) -> f32 {
    let mut v_intZero_306_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_307_: u8 = 0;
    v_intZero_306_ = crate::leanh::lean_obj_once(
        core::ptr::addr_of_mut!(l_Float_ofInt___closed__0),
        core::ptr::addr_of_mut!(l_Float_ofInt___closed__0_once),
        _init_l_Float_ofInt___closed__0,
    );
    ...
    if v_isNeg_307_ == 0 {
        ...
        let mut v_abs_310_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_311_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Float32_ofInt___boxed(
    ...
    v_r_318_ = crate::leanh::lean_box_float32(v_res_317_);
    return v_r_318_;
}
pub unsafe fn l_instOfNatFloat32(mut v_n_319_: *mut crate::leanh::LeanObject) -> f32 {
    let mut v___x_320_: f32 = 0.0f32;
    v___x_320_ = lean_float32_of_nat(v_n_319_);
    return v___x_320_;
}
pub unsafe fn l_instOfNatFloat32___boxed(
    mut v_n_321_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_322_: f32 = 0.0f32;
    let mut v_r_323_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_322_ = l_instOfNatFloat32(v_n_321_);
    v_r_323_ = crate::leanh::lean_box_float32(v_res_322_);
    return v_r_323_;
}
pub unsafe fn l_Nat_toFloat32(mut v_n_324_: *mut crate::leanh::LeanObject) -> f32 {
    let mut v___x_325_: f32 = 0.0f32;
    v___x_325_ = lean_float32_of_nat(v_n_324_);
    return v___x_325_;
}
pub unsafe fn l_Nat_toFloat32___boxed(
    ...
    v_r_328_ = crate::leanh::lean_box_float32(v_res_327_);
    return v_r_328_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_OfScientific(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_OfScientific(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_OfScientific(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
