...
pub unsafe fn l_instOrdSubtype___redArg___lam__0(
    ...
    mut v_a_18_: *mut leanh::LeanObject,
    mut v_b_19_: *mut leanh::LeanObject,
) -> u8 {
    let mut v___x_20_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_21_: u8 = 0;
    v___x_20_ = leanh::lean_apply_2(v_inst_17_, v_a_18_, v_b_19_);
    v___x_21_ = (leanh::lean_unbox(v___x_20_) as u8);
    return v___x_21_;
}
pub unsafe fn l_instOrdSubtype___redArg___lam__0___boxed(
    mut v_inst_22_: *mut leanh::LeanObject,
    mut v_a_23_: *mut leanh::LeanObject,
    mut v_b_24_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_25_: u8 = 0;
    let mut v_r_26_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_25_ = l_instOrdSubtype___redArg___lam__0(v_inst_22_, v_a_23_, v_b_24_);
    v_r_26_ = leanh::lean_box((v_res_25_) as usize);
    return v_r_26_;
}
pub unsafe fn l_instOrdSubtype___redArg(
    mut v_inst_27_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_28_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_28_ = leanh::lean_alloc_closure(
        l_instOrdSubtype___redArg___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_28_, 0, v_inst_27_);
    return v___f_28_;
}
pub unsafe fn l_instOrdSubtype(
    mut v_00_u03b1_29_: *mut leanh::LeanObject,
    mut v_inst_30_: *mut leanh::LeanObject,
    mut v_P_31_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___f_32_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_32_ = leanh::lean_alloc_closure(
        l_instOrdSubtype___redArg___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_32_, 0, v_inst_30_);
    return v___f_32_;
}
