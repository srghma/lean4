...
pub unsafe fn l_Float32_toInt8___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_53_ =
        leanh::lean_unbox_float32(v_a_00___x40___internal___hyg_52_);
...
pub unsafe fn l_Float32_toInt16___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_58_ =
        leanh::lean_unbox_float32(v_a_00___x40___internal___hyg_57_);
...
pub unsafe fn l_Float32_toInt32___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_63_ =
        leanh::lean_unbox_float32(v_a_00___x40___internal___hyg_62_);
...
pub unsafe fn l_Float32_toInt64___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_68_ =
        leanh::lean_unbox_float32(v_a_00___x40___internal___hyg_67_);
...
pub unsafe fn l_Float32_toISize___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_73_ =
        leanh::lean_unbox_float32(v_a_00___x40___internal___hyg_72_);
...
pub unsafe fn l_Int8_toFloat32___boxed(
    ...
    v_r_80_ = leanh::lean_box_float32(v_res_79_);
    return v_r_80_;
}
pub unsafe fn l_Int16_toFloat32___boxed(
    ...
    v_r_85_ = leanh::lean_box_float32(v_res_84_);
    return v_r_85_;
}
pub unsafe fn l_Int32_toFloat32___boxed(
    ...
    v_r_90_ = leanh::lean_box_float32(v_res_89_);
    return v_r_90_;
}
pub unsafe fn l_Int64_toFloat32___boxed(
    ...
    v_r_95_ = leanh::lean_box_float32(v_res_94_);
    return v_r_95_;
}
pub unsafe fn l_ISize_toFloat32___boxed(
    ...
    v_r_100_ = leanh::lean_box_float32(v_res_99_);
    return v_r_100_;
}
...
pub unsafe fn meta_initialize_Init_Data_SInt_Float32(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_SInt_Float32(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
