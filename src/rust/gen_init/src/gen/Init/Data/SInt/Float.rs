...
pub unsafe fn l_Float_toInt8___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_53_ =
        crate::leanh::lean_unbox_float(v_a_00___x40___internal___hyg_52_);
...
pub unsafe fn l_Float_toInt16___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_58_ =
        crate::leanh::lean_unbox_float(v_a_00___x40___internal___hyg_57_);
...
pub unsafe fn l_Float_toInt32___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_63_ =
        crate::leanh::lean_unbox_float(v_a_00___x40___internal___hyg_62_);
...
pub unsafe fn l_Float_toInt64___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_68_ =
        crate::leanh::lean_unbox_float(v_a_00___x40___internal___hyg_67_);
...
pub unsafe fn l_Float_toISize___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_73_ =
        crate::leanh::lean_unbox_float(v_a_00___x40___internal___hyg_72_);
...
pub unsafe fn l_Int8_toFloat___boxed(
    ...
    v_r_80_ = crate::leanh::lean_box_float(v_res_79_);
    return v_r_80_;
}
pub unsafe fn l_Int16_toFloat___boxed(
    ...
    v_r_85_ = crate::leanh::lean_box_float(v_res_84_);
    return v_r_85_;
}
pub unsafe fn l_Int32_toFloat___boxed(
    ...
    v_r_90_ = crate::leanh::lean_box_float(v_res_89_);
    return v_r_90_;
}
pub unsafe fn l_Int64_toFloat___boxed(
    ...
    v_r_95_ = crate::leanh::lean_box_float(v_res_94_);
    return v_r_95_;
}
pub unsafe fn l_ISize_toFloat___boxed(
    ...
    v_r_100_ = crate::leanh::lean_box_float(v_res_99_);
    return v_r_100_;
}
...
pub unsafe fn meta_initialize_Init_Data_SInt_Float(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_SInt_Float(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
