...
static mut l_BitVec_instDecidableForallBitVec___redArg___closed__0: *mut leanh::LeanObject =
    core::ptr::null_mut();
...
pub unsafe fn l_BitVec_instDecidableForallBitVecZero___redArg___boxed(
    ...
    let mut v_r_176_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_18__boxed_174_ = (leanh::lean_unbox(v_x_173_) as u8);
    v_res_175_ = l_BitVec_instDecidableForallBitVecZero___redArg(v_x_18__boxed_174_);
    v_r_176_ = leanh::lean_box((v_res_175_) as usize);
    return v_r_176_;
}
pub unsafe fn l_BitVec_instDecidableForallBitVecZero(
    mut v_P_177_: *mut leanh::LeanObject,
    mut v_x_178_: u8,
) -> u8 {
    return v_x_178_;
}
pub unsafe fn l_BitVec_instDecidableForallBitVecZero___boxed(
    ...
    let mut v_r_183_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_x_21__boxed_181_ = (leanh::lean_unbox(v_x_180_) as u8);
    v_res_182_ = l_BitVec_instDecidableForallBitVecZero(v_P_179_, v_x_21__boxed_181_);
    v_r_183_ = leanh::lean_box((v_res_182_) as usize);
    return v_r_183_;
}
...
pub unsafe fn l_BitVec_instDecidableForallBitVecSucc___redArg___boxed(
    ...
    v_inst_10__boxed_186_ = (leanh::lean_unbox(v_inst_185_) as u8);
    v_res_187_ = l_BitVec_instDecidableForallBitVecSucc___redArg(v_inst_10__boxed_186_);
    v_r_188_ = leanh::lean_box((v_res_187_) as usize);
    return v_r_188_;
}
pub unsafe fn l_BitVec_instDecidableForallBitVecSucc(
    mut v_n_189_: *mut leanh::LeanObject,
    mut v_P_190_: *mut leanh::LeanObject,
...
pub unsafe fn l_BitVec_instDecidableForallBitVecSucc___boxed(
    mut v_n_193_: *mut leanh::LeanObject,
    ...
    let mut v_r_199_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_inst_14__boxed_197_ = (leanh::lean_unbox(v_inst_196_) as u8);
    ...
    leanh::lean_dec(v_n_193_);
    v_r_199_ = leanh::lean_box((v_res_198_) as usize);
    return v_r_199_;
}
...
pub unsafe fn l_BitVec_instDecidableExistsBitVecZero___redArg___boxed(
    ...
    let mut v_r_204_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_inst_27__boxed_202_ = (leanh::lean_unbox(v_inst_201_) as u8);
    v_res_203_ = l_BitVec_instDecidableExistsBitVecZero___redArg(v_inst_27__boxed_202_);
    v_r_204_ = leanh::lean_box((v_res_203_) as usize);
    return v_r_204_;
}
...
pub unsafe fn l_BitVec_instDecidableExistsBitVecZero___boxed(
    ...
    v_inst_30__boxed_209_ = (leanh::lean_unbox(v_inst_208_) as u8);
...
pub unsafe fn l_BitVec_instDecidableExistsBitVecSucc___redArg___boxed(
    ...
    v_inst_21__boxed_216_ = (leanh::lean_unbox(v_inst_215_) as u8);
...
pub unsafe fn l_BitVec_instDecidableExistsBitVecSucc___boxed(
    ...
    v_inst_29__boxed_228_ = (leanh::lean_unbox(v_inst_227_) as u8);
    ...
    leanh::lean_dec_ref(v_inst_226_);
...
pub unsafe fn l_BitVec_instDecidableForallBitVec___redArg___lam__0(
    ...
    v___x_236_ = leanh::lean_apply_1(v_x_233_, v___x_235_);
    v___x_237_ = (leanh::lean_unbox(v___x_236_) as u8);
    return v___x_237_;
}
pub unsafe fn l_BitVec_instDecidableForallBitVec___redArg___lam__0___boxed(
    mut v_n_238_: *mut leanh::LeanObject,
    ...
    v_a_boxed_242_ = (leanh::lean_unbox(v_a_239_) as u8);
...
pub unsafe fn l_BitVec_instDecidableForallBitVec___redArg___lam__1___boxed(
    ...
    v_a_boxed_250_ = (leanh::lean_unbox(v_a_249_) as u8);
    v_res_251_ =
...
pub unsafe fn l_BitVec_instDecidableForallBitVec___redArg(
    ...
    let mut v_zero_255_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_256_: u8 = 0;
    v_zero_255_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_256_ == 1 {
        ...
        v___x_257_ = leanh::lean_obj_once(
        ...
        v___x_258_ = leanh::lean_apply_1(v_x_254_, v___x_257_);
        v___x_259_ = (leanh::lean_unbox(v___x_258_) as u8);
        return v___x_259_;
    } else {
        let mut v_one_260_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_261_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___f_262_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_263_: u8 = 0;
        v_one_260_ = leanh::lean_unsigned_to_nat(1);
        ...
        leanh::lean_closure_set(v___f_262_, 0, v_n_261_);
        leanh::lean_closure_set(v___f_262_, 1, v_x_254_);
...
pub unsafe fn l_BitVec_instDecidableForallBitVec___redArg___lam__1(
    ...
    v___x_267_ = leanh::lean_box((v_a_266_) as usize);
    leanh::lean_inc(v_n_264_);
    v___f_268_ = leanh::lean_alloc_closure(
        l_BitVec_instDecidableForallBitVec___redArg___lam__0___boxed as *mut core::ffi::c_void,
        4,
        3,
    );
    leanh::lean_closure_set(v___f_268_, 0, v_n_264_);
    leanh::lean_closure_set(v___f_268_, 1, v___x_267_);
    leanh::lean_closure_set(v___f_268_, 2, v_x_265_);
    v___x_269_ = l_BitVec_instDecidableForallBitVec___redArg(v_n_264_, v___f_268_);
    leanh::lean_dec(v_n_264_);
    return v___x_269_;
}
...
pub unsafe fn l_BitVec_instDecidableExistsBitVec___redArg___lam__0(
    ...
    v___x_289_ = leanh::lean_apply_1(v_x_285_, v___x_288_);
    v___x_290_ = (leanh::lean_unbox(v___x_289_) as u8);
    if v___x_290_ == 0 {
...
pub unsafe fn l_BitVec_instDecidableExistsBitVec___redArg___lam__0___boxed(
    ...
    mut v_isZero_295_: *mut leanh::LeanObject,
    ...
    v_a_boxed_297_ = (leanh::lean_unbox(v_a_293_) as u8);
    v_isZero_boxed_298_ = (leanh::lean_unbox(v_isZero_295_) as u8);
...
pub unsafe fn l_BitVec_instDecidableExistsBitVec___redArg___lam__1(
    mut v_n_301_: *mut leanh::LeanObject,
    ...
    v___x_305_ = leanh::lean_box((v_a_304_) as usize);
    v___x_306_ = leanh::lean_box((v_isZero_303_) as usize);
    leanh::lean_inc(v_n_301_);
    v___f_307_ = leanh::lean_alloc_closure(
        l_BitVec_instDecidableExistsBitVec___redArg___lam__0___boxed as *mut core::ffi::c_void,
        5,
        4,
    );
    leanh::lean_closure_set(v___f_307_, 0, v_n_301_);
    leanh::lean_closure_set(v___f_307_, 1, v___x_305_);
    leanh::lean_closure_set(v___f_307_, 2, v_x_302_);
    leanh::lean_closure_set(v___f_307_, 3, v___x_306_);
    v___x_308_ = l_BitVec_instDecidableForallBitVec___redArg(v_n_301_, v___f_307_);
    leanh::lean_dec(v_n_301_);
    return v___x_308_;
}
pub unsafe fn l_BitVec_instDecidableExistsBitVec___redArg___lam__1___boxed(
    mut v_n_309_: *mut leanh::LeanObject,
    mut v_x_310_: *mut leanh::LeanObject,
    mut v_isZero_311_: *mut leanh::LeanObject,
    mut v_a_312_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_isZero_boxed_313_: u8 = 0;
    let mut v_a_boxed_314_: u8 = 0;
    let mut v_res_315_: u8 = 0;
    let mut v_r_316_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_isZero_boxed_313_ = (leanh::lean_unbox(v_isZero_311_) as u8);
    v_a_boxed_314_ = (leanh::lean_unbox(v_a_312_) as u8);
    ...
    v_r_316_ = leanh::lean_box((v_res_315_) as usize);
    return v_r_316_;
}
pub unsafe fn l_BitVec_instDecidableExistsBitVec___redArg(
    ...
    if v_isZero_320_ == 1 {
        ...
        v___x_321_ = leanh::lean_obj_once(
            core::ptr::addr_of_mut!(l_BitVec_instDecidableForallBitVec___redArg___closed__0),
            core::ptr::addr_of_mut!(l_BitVec_instDecidableForallBitVec___redArg___closed__0_once),
            _init_l_BitVec_instDecidableForallBitVec___redArg___closed__0,
        );
        v___x_322_ = leanh::lean_apply_1(v_x_318_, v___x_321_);
        v___x_323_ = (leanh::lean_unbox(v___x_322_) as u8);
        return v___x_323_;
    } else {
        let mut v_one_324_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_325_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v___x_326_ = leanh::lean_box((v_isZero_320_) as usize);
        v___f_327_ = leanh::lean_alloc_closure(
            l_BitVec_instDecidableExistsBitVec___redArg___lam__1___boxed as *mut core::ffi::c_void,
            4,
            3,
        );
        leanh::lean_closure_set(v___f_327_, 0, v_n_325_);
        leanh::lean_closure_set(v___f_327_, 1, v_x_318_);
        leanh::lean_closure_set(v___f_327_, 2, v___x_326_);
...
pub unsafe fn initialize_Init_Data_BitVec_Decidable(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
