...
use crate::ffi::{
    lean_uint8_to_uint32, lean_uint32_add, lean_uint32_dec_eq, lean_uint32_dec_le,
    lean_uint32_dec_lt, lean_uint32_to_nat, lean_uint32_to_uint8,
};
...
pub static mut l_Char_instLT: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Char_instLE: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Char_instInhabited: u32 = 0;
pub unsafe fn _init_l_Char_instLT() -> *mut leanh::LeanObject {
    let mut v___x_158_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_158_ = leanh::lean_box(0);
    return v___x_158_;
}
pub unsafe fn _init_l_Char_instLE() -> *mut leanh::LeanObject {
...
pub unsafe fn l_Char_instDecidableLt___boxed(
    ...
    mut v_b_164_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_a_boxed_165_: u32 = 0;
    let mut v_b_boxed_166_: u32 = 0;
    let mut v_res_167_: u8 = 0;
    let mut v_r_168_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_a_boxed_165_ = leanh::lean_unbox_uint32(v_a_163_);
    leanh::lean_dec(v_a_163_);
    v_b_boxed_166_ = leanh::lean_unbox_uint32(v_b_164_);
    leanh::lean_dec(v_b_164_);
    v_res_167_ = l_Char_instDecidableLt(v_a_boxed_165_, v_b_boxed_166_);
    v_r_168_ = leanh::lean_box((v_res_167_) as usize);
    return v_r_168_;
}
...
pub unsafe fn l_Char_instDecidableLe___boxed(
    ...
    let mut v_r_177_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_a_boxed_174_ = leanh::lean_unbox_uint32(v_a_172_);
    leanh::lean_dec(v_a_172_);
    v_b_boxed_175_ = leanh::lean_unbox_uint32(v_b_173_);
    leanh::lean_dec(v_b_173_);
    v_res_176_ = l_Char_instDecidableLe(v_a_boxed_174_, v_b_boxed_175_);
    v_r_177_ = leanh::lean_box((v_res_176_) as usize);
    return v_r_177_;
}
pub unsafe fn l_Char_toNat(mut v_c_178_: u32) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Char_toNat___boxed(
    mut v_c_180_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_181_: u32 = 0;
    let mut v_res_182_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_181_ = leanh::lean_unbox_uint32(v_c_180_);
    leanh::lean_dec(v_c_180_);
...
pub unsafe fn l_Char_ofUInt8___boxed(
    ...
    let mut v_r_194_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_n_boxed_192_ = (leanh::lean_unbox(v_n_191_) as u8);
    v_res_193_ = l_Char_ofUInt8(v_n_boxed_192_);
    v_r_194_ = leanh::lean_box_uint32(v_res_193_);
    return v_r_194_;
}
...
pub unsafe fn l_Char_isWhitespace___boxed(
    ...
    v_c_boxed_208_ = leanh::lean_unbox_uint32(v_c_207_);
    leanh::lean_dec(v_c_207_);
...
pub unsafe fn l_Char_isLower___boxed(
    mut v_c_225_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_226_: u32 = 0;
    let mut v_res_227_: u8 = 0;
    let mut v_r_228_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_226_ = leanh::lean_unbox_uint32(v_c_225_);
    leanh::lean_dec(v_c_225_);
    v_res_227_ = l_Char_isLower(v_c_boxed_226_);
    v_r_228_ = leanh::lean_box((v_res_227_) as usize);
    return v_r_228_;
}
...
pub unsafe fn l_Char_isAlpha___boxed(
    mut v_c_239_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_240_: u32 = 0;
    let mut v_res_241_: u8 = 0;
    let mut v_r_242_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_240_ = leanh::lean_unbox_uint32(v_c_239_);
    leanh::lean_dec(v_c_239_);
    v_res_241_ = l_Char_isAlpha(v_c_boxed_240_);
    v_r_242_ = leanh::lean_box((v_res_241_) as usize);
    return v_r_242_;
}
...
pub unsafe fn l_Char_toLower___boxed(
    mut v_c_300_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_301_: u32 = 0;
    let mut v_res_302_: u32 = 0;
    let mut v_r_303_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_301_ = leanh::lean_unbox_uint32(v_c_300_);
    leanh::lean_dec(v_c_300_);
    v_res_302_ = l_Char_toLower(v_c_boxed_301_);
    v_r_303_ = leanh::lean_box_uint32(v_res_302_);
    return v_r_303_;
}
...
pub unsafe fn runtime_initialize_Init_Data_Char_Basic(
    ...
    leanh::lean_mark_persistent(l_Char_instLT);
    l_Char_instLE = _init_l_Char_instLE();
    leanh::lean_mark_persistent(l_Char_instLE);
    l_Char_instInhabited = _init_l_Char_instInhabited();
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
static mut _G_meta_initialized: bool = false;
pub unsafe fn meta_initialize_Init_Data_Char_Basic(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Char_Basic(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
