...
pub static mut l_Char_numSurrogates: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Char_numCodePoints: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Char_succ_x3f___closed__0___boxed__const__1: *mut leanh::LeanObject =
    core::ptr::null_mut();
static mut l_Char_succ_x3f___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Char_succ_x3f___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
pub unsafe fn _init_l_Char_numSurrogates() -> *mut leanh::LeanObject {
    let mut v___x_60_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_60_ = leanh::lean_unsigned_to_nat(2048);
    return v___x_60_;
}
pub unsafe fn _init_l_Char_numCodePoints() -> *mut leanh::LeanObject {
    let mut v___x_61_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_61_ = leanh::lean_unsigned_to_nat(1112064);
    return v___x_61_;
}
pub unsafe fn l_Char_ordinal(mut v_c_62_: u32) -> *mut leanh::LeanObject {
    ...
    if v___x_64_ == 0 {
        ...
        v___x_66_ = leanh::lean_unsigned_to_nat(2048);
        v___x_67_ = lean_nat_sub(v___x_65_, v___x_66_);
        leanh::lean_dec(v___x_65_);
        return v___x_67_;
    } else {
...
pub unsafe fn l_Char_ordinal___boxed(
    mut v_c_69_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_70_: u32 = 0;
    let mut v_res_71_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_70_ = leanh::lean_unbox_uint32(v_c_69_);
    leanh::lean_dec(v_c_69_);
    v_res_71_ = l_Char_ordinal(v_c_boxed_70_);
    return v_res_71_;
}
pub unsafe fn l_Char_ofOrdinal(mut v_f_72_: *mut leanh::LeanObject) -> u32 {
    let mut v___x_73_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_74_: u8 = 0;
    v___x_73_ = leanh::lean_unsigned_to_nat(55296);
    ...
    if v___x_74_ == 0 {
        ...
        v___x_75_ = leanh::lean_unsigned_to_nat(2048);
...
pub unsafe fn l_Char_ofOrdinal___boxed(
    mut v_f_79_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_80_: u32 = 0;
    let mut v_r_81_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_80_ = l_Char_ofOrdinal(v_f_79_);
    leanh::lean_dec(v_f_79_);
    v_r_81_ = leanh::lean_box_uint32(v_res_80_);
    return v_r_81_;
}
pub unsafe fn _init_l_Char_succ_x3f___closed__0___boxed__const__1() -> *mut leanh::LeanObject
{
    let mut v___x_82_: u32 = 0;
    let mut v___x_83_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_82_ = 57344;
    v___x_83_ = leanh::lean_box_uint32(v___x_82_);
    return v___x_83_;
}
pub unsafe fn _init_l_Char_succ_x3f___closed__0() -> *mut leanh::LeanObject {
    ...
    v___x_85_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
    leanh::lean_ctor_set(v___x_85_, 0, v___x_84_);
    return v___x_85_;
}
pub unsafe fn l_Char_succ_x3f(mut v_c_86_: u32) -> *mut leanh::LeanObject {
    ...
    if v___x_88_ == 0 {
        ...
        if v___x_89_ == 0 {
            ...
            if v___x_91_ == 0 {
                ...
                v___x_95_ = leanh::lean_box_uint32(v___x_94_);
                v___x_96_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                leanh::lean_ctor_set(v___x_96_, 0, v___x_95_);
                return v___x_96_;
            }
        } else {
            let mut v___x_97_: *mut leanh::LeanObject = core::ptr::null_mut();
            v___x_97_ = leanh::lean_obj_once(
        ...
        v___x_100_ = leanh::lean_box_uint32(v___x_99_);
        v___x_101_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
        leanh::lean_ctor_set(v___x_101_, 0, v___x_100_);
        return v___x_101_;
    }
}
pub unsafe fn l_Char_succ_x3f___boxed(
    mut v_c_102_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_103_: u32 = 0;
    let mut v_res_104_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_103_ = leanh::lean_unbox_uint32(v_c_102_);
    leanh::lean_dec(v_c_102_);
...
pub unsafe fn l_Char_succMany_x3f(
    ...
    v___x_107_ = leanh::lean_unsigned_to_nat(1112064);
    ...
    if v___x_110_ == 0 {
        ...
        leanh::lean_dec(v___x_109_);
        v___x_113_ = leanh::lean_box_uint32(v___x_112_);
...
pub unsafe fn l_Char_succMany_x3f___boxed(
    mut v_m_115_: *mut leanh::LeanObject,
    mut v_c_116_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_c_boxed_117_: u32 = 0;
    let mut v_res_118_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_c_boxed_117_ = leanh::lean_unbox_uint32(v_c_116_);
    leanh::lean_dec(v_c_116_);
    v_res_118_ = l_Char_succMany_x3f(v_m_115_, v_c_boxed_117_);
    leanh::lean_dec(v_m_115_);
    return v_res_118_;
}
...
pub unsafe fn runtime_initialize_Init_Data_Char_Ordinal(
    ...
    leanh::lean_mark_persistent(l_Char_numSurrogates);
    l_Char_numCodePoints = _init_l_Char_numCodePoints();
    leanh::lean_mark_persistent(l_Char_numCodePoints);
    l_Char_succ_x3f___closed__0___boxed__const__1 =
        _init_l_Char_succ_x3f___closed__0___boxed__const__1();
    leanh::lean_mark_persistent(l_Char_succ_x3f___closed__0___boxed__const__1);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
static mut _G_meta_initialized: bool = false;
pub unsafe fn meta_initialize_Init_Data_Char_Ordinal(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Char_Ordinal(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
