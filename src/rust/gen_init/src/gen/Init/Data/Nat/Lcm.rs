...
pub unsafe fn l_Nat_lcm(
    mut v_m_9_: *mut leanh::LeanObject,
    mut v_n_10_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v___x_11_);
    return v___x_13_;
}
pub unsafe fn l_Nat_lcm___boxed(
    mut v_m_14_: *mut leanh::LeanObject,
    mut v_n_15_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_16_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_16_ = l_Nat_lcm(v_m_14_, v_n_15_);
    leanh::lean_dec(v_n_15_);
    leanh::lean_dec(v_m_14_);
    return v_res_16_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Nat_Lcm(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Nat_Lcm(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Nat_Lcm(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
