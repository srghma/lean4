...
pub static mut l___private_Init_Data_Nat_Fold_0__Nat_apply__dfoldCast___auto__3:
    *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Nat_dfold___auto__1: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Nat_dfoldRev___auto__1: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Nat_dfold__zero___auto__1: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l___private_Init_Data_Nat_Fold_0__Nat_dfold__loop__succ___auto__5:
    *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Nat_dfold__succ___auto__3: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Nat_dfold__congr___auto__1: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Nat_dfold__add___auto__5: *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Nat_dfoldRev__zero___auto__1: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static mut l_Nat_dfoldRev__succ___auto__3: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static mut l_Nat_dfoldRev__congr___auto__1: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static mut l_Nat_dfoldRev__add___auto__5: *mut leanh::LeanObject = core::ptr::null_mut();
pub unsafe fn l_Nat_fold___redArg___lam__0(
    mut v_x_642_: *mut leanh::LeanObject,
    mut v_i_643_: *mut leanh::LeanObject,
    mut v_h_644_: *mut leanh::LeanObject,
    mut v___y_645_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_646_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_646_ =
        leanh::lean_apply_3(v_x_642_, v_i_643_, leanh::lean_box(0), v___y_645_);
    return v___x_646_;
}
pub unsafe fn l_Nat_fold___redArg(
    ...
    let mut v_zero_650_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_651_: u8 = 0;
    v_zero_650_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop___redArg(
    ...
    mut v_j_673_: *mut leanh::LeanObject,
    mut v_a_674_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_675_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_676_: u8 = 0;
    let mut v_one_677_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_678_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_675_ = leanh::lean_unsigned_to_nat(0);
                v_isZero_676_ = lean_nat_dec_eq(v_j_673_, v_zero_675_);
                if v_isZero_676_ == 1 {
                    leanh::lean_dec(v_j_673_);
                    leanh::lean_dec(v_f_672_);
                    return v_a_674_;
                } else {
                    v_one_677_ = leanh::lean_unsigned_to_nat(1);
                    v_n_678_ = lean_nat_sub(v_j_673_, v_one_677_);
                    v___x_679_ = lean_nat_sub(v_n_671_, v_j_673_);
                    leanh::lean_dec(v_j_673_);
                    leanh::lean_inc(v_f_672_);
                    v___x_680_ = leanh::lean_apply_3(
                        v_f_672_,
                        v___x_679_,
                        leanh::lean_box(0),
                        v_a_674_,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop___redArg___boxed(
    ...
    mut v_f_683_: *mut leanh::LeanObject,
    mut v_j_684_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop(
    ...
    mut v_n_688_: *mut leanh::LeanObject,
    mut v_f_689_: *mut leanh::LeanObject,
    mut v_j_690_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop___boxed(
    ...
    mut v_n_695_: *mut leanh::LeanObject,
    mut v_f_696_: *mut leanh::LeanObject,
    mut v_j_697_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_foldTR(
    ...
    mut v_f_707_: *mut leanh::LeanObject,
    mut v_init_708_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_709_: *mut leanh::LeanObject = core::ptr::null_mut();
    leanh::lean_inc(v_n_706_);
...
pub unsafe fn l_Nat_foldRev___redArg(
    ...
    let mut v_zero_713_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_714_: u8 = 0;
    let mut v___f_715_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_one_716_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_717_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_718_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_zero_713_ = leanh::lean_unsigned_to_nat(0);
                v_isZero_714_ = lean_nat_dec_eq(v_x_710_, v_zero_713_);
                if v_isZero_714_ == 1 {
                    leanh::lean_dec(v_x_711_);
                    leanh::lean_dec(v_x_710_);
                    return v_x_712_;
                } else {
                    leanh::lean_inc(v_x_711_);
                    v___f_715_ = leanh::lean_alloc_closure(
                        l_Nat_fold___redArg___lam__0 as *mut core::ffi::c_void,
                        4,
                        1,
                    );
                    leanh::lean_closure_set(v___f_715_, 0, v_x_711_);
                    v_one_716_ = leanh::lean_unsigned_to_nat(1);
                    v_n_717_ = lean_nat_sub(v_x_710_, v_one_716_);
                    leanh::lean_dec(v_x_710_);
                    leanh::lean_inc(v_n_717_);
                    v___x_718_ = leanh::lean_apply_3(
                        v_x_711_,
                        v_n_717_,
                        leanh::lean_box(0),
                        v_x_712_,
...
pub unsafe fn l_Nat_any(
    ...
    if v_isZero_738_ == 1 {
        ...
        if v___x_743_ == 0 {
            ...
            v___x_744_ = leanh::lean_apply_2(v_x_736_, v_n_742_, leanh::lean_box(0));
            v___x_745_ = (leanh::lean_unbox(v___x_744_) as u8);
            return v___x_745_;
        } else {
            leanh::lean_dec(v_n_742_);
            leanh::lean_dec_ref(v_x_736_);
            return v___x_743_;
        }
    }
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop___redArg(
    ...
    mut v_i_752_: *mut leanh::LeanObject,
) -> u8 {
    ...
    let mut v_one_759_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_760_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v_isZero_754_ == 1 {
                    leanh::lean_dec(v_i_752_);
                    leanh::lean_dec_ref(v_f_751_);
                    v___x_755_ = 0;
                    return v___x_755_;
                } else {
                    v___x_756_ = lean_nat_sub(v_n_750_, v_i_752_);
                    leanh::lean_inc_ref(v_f_751_);
                    v___x_757_ =
                        leanh::lean_apply_2(v_f_751_, v___x_756_, leanh::lean_box(0));
                    v___x_758_ = (leanh::lean_unbox(v___x_757_) as u8);
                    if v___x_758_ == 0 {
                        v_one_759_ = leanh::lean_unsigned_to_nat(1);
                        ...
                        leanh::lean_dec(v_i_752_);
                        leanh::lean_dec_ref(v_f_751_);
                        v___x_762_ = (leanh::lean_unbox(v___x_757_) as u8);
                        return v___x_762_;
                    }
                }
            }
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop___redArg___boxed(
    mut v_n_763_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_n_763_);
    v_r_767_ = leanh::lean_box((v_res_766_) as usize);
    return v_r_767_;
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop(
    mut v_n_768_: *mut leanh::LeanObject,
    mut v_f_769_: *mut leanh::LeanObject,
    mut v_i_770_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop___boxed(
    mut v_n_773_: *mut leanh::LeanObject,
    mut v_f_774_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_all(
    ...
    let mut v_zero_788_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_789_: u8 = 0;
    v_zero_788_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_789_ == 1 {
        ...
        let mut v_one_791_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_792_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        leanh::lean_closure_set(v___f_790_, 0, v_x_787_);
        v_one_791_ = leanh::lean_unsigned_to_nat(1);
        v_n_792_ = lean_nat_sub(v_x_786_, v_one_791_);
        v___x_793_ = l_Nat_all(v_n_792_, v___f_790_);
        if v___x_793_ == 0 {
            leanh::lean_dec(v_n_792_);
            leanh::lean_dec_ref(v_x_787_);
            return v___x_793_;
        } else {
            let mut v___x_794_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_795_: u8 = 0;
            v___x_794_ = leanh::lean_apply_2(v_x_787_, v_n_792_, leanh::lean_box(0));
            v___x_795_ = (leanh::lean_unbox(v___x_794_) as u8);
            return v___x_795_;
        }
    }
}
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_allTR_loop___redArg(
    mut v_n_800_: *mut leanh::LeanObject,
    mut v_f_801_: *mut leanh::LeanObject,
    mut v_i_802_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_zero_803_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_one_809_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_n_810_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_zero_803_ = leanh::lean_unsigned_to_nat(0);
                v_isZero_804_ = lean_nat_dec_eq(v_i_802_, v_zero_803_);
                if v_isZero_804_ == 1 {
                    leanh::lean_dec(v_i_802_);
                    leanh::lean_dec_ref(v_f_801_);
                    return v_isZero_804_;
                } else {
                    v___x_805_ = lean_nat_sub(v_n_800_, v_i_802_);
                    leanh::lean_inc_ref(v_f_801_);
                    v___x_806_ =
                        leanh::lean_apply_2(v_f_801_, v___x_805_, leanh::lean_box(0));
                    v___x_807_ = (leanh::lean_unbox(v___x_806_) as u8);
                    if v___x_807_ == 0 {
                        leanh::lean_dec(v_i_802_);
                        leanh::lean_dec_ref(v_f_801_);
                        v___x_808_ = (leanh::lean_unbox(v___x_806_) as u8);
                        return v___x_808_;
                    } else {
                        v_one_809_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop_match__1_splitter___redArg(
    ...
    let mut v_zero_839_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_840_: u8 = 0;
    v_zero_839_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_840_ == 1 {
        ...
        v___x_841_ = leanh::lean_apply_2(v_h__1_837_, leanh::lean_box(0), v_x_836_);
        return v___x_841_;
    } else {
        let mut v_one_842_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_843_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_844_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_837_);
        v_one_842_ = leanh::lean_unsigned_to_nat(1);
        v_n_843_ = lean_nat_sub(v_x_835_, v_one_842_);
        v___x_844_ =
            leanh::lean_apply_3(v_h__2_838_, v_n_843_, leanh::lean_box(0), v_x_836_);
        return v___x_844_;
    }
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop_match__1_splitter___redArg___boxed(
    ...
    mut v_h__1_847_: *mut leanh::LeanObject,
    mut v_h__2_848_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop_match__1_splitter(
    ...
    mut v_n_851_: *mut leanh::LeanObject,
    ...
    mut v_h__1_856_: *mut leanh::LeanObject,
    mut v_h__2_857_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_858_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_859_: u8 = 0;
    v_zero_858_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_859_ = lean_nat_dec_eq(v_x_853_, v_zero_858_);
    if v_isZero_859_ == 1 {
        let mut v___x_860_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_857_);
        v___x_860_ = leanh::lean_apply_2(v_h__1_856_, leanh::lean_box(0), v_x_855_);
        return v___x_860_;
    } else {
        let mut v_one_861_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_862_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_863_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_856_);
        v_one_861_ = leanh::lean_unsigned_to_nat(1);
        v_n_862_ = lean_nat_sub(v_x_853_, v_one_861_);
        v___x_863_ =
            leanh::lean_apply_3(v_h__2_857_, v_n_862_, leanh::lean_box(0), v_x_855_);
        return v___x_863_;
    }
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop_match__1_splitter___boxed(
    ...
    mut v_n_865_: *mut leanh::LeanObject,
    mut v_motive_866_: *mut leanh::LeanObject,
    mut v_x_867_: *mut leanh::LeanObject,
    mut v_x_868_: *mut leanh::LeanObject,
    mut v_x_869_: *mut leanh::LeanObject,
    mut v_h__1_870_: *mut leanh::LeanObject,
    mut v_h__2_871_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_fold_match__1_splitter___redArg(
    ...
    mut v_h__1_876_: *mut leanh::LeanObject,
    mut v_h__2_877_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_878_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_879_: u8 = 0;
    v_zero_878_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_879_ = lean_nat_dec_eq(v_x_873_, v_zero_878_);
    if v_isZero_879_ == 1 {
        let mut v___x_880_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_877_);
        v___x_880_ = leanh::lean_apply_2(v_h__1_876_, v_x_874_, v_x_875_);
        return v___x_880_;
    } else {
        let mut v_one_881_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_882_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_883_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_876_);
        v_one_881_ = leanh::lean_unsigned_to_nat(1);
        v_n_882_ = lean_nat_sub(v_x_873_, v_one_881_);
        v___x_883_ = leanh::lean_apply_3(v_h__2_877_, v_n_882_, v_x_874_, v_x_875_);
        return v___x_883_;
    }
}
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_fold_match__1_splitter(
    mut v_00_u03b1_890_: *mut leanh::LeanObject,
    mut v_motive_891_: *mut leanh::LeanObject,
    mut v_x_892_: *mut leanh::LeanObject,
    mut v_x_893_: *mut leanh::LeanObject,
    mut v_x_894_: *mut leanh::LeanObject,
    mut v_h__1_895_: *mut leanh::LeanObject,
    mut v_h__2_896_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    if v_isZero_898_ == 1 {
        ...
        leanh::lean_dec(v_h__2_896_);
        v___x_899_ = leanh::lean_apply_2(v_h__1_895_, v_x_893_, v_x_894_);
        return v___x_899_;
    } else {
        let mut v_one_900_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_901_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_902_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_895_);
        v_one_900_ = leanh::lean_unsigned_to_nat(1);
        v_n_901_ = lean_nat_sub(v_x_892_, v_one_900_);
        v___x_902_ = leanh::lean_apply_3(v_h__2_896_, v_n_901_, v_x_893_, v_x_894_);
        return v___x_902_;
    }
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_fold_match__1_splitter___boxed(
    ...
    mut v_h__1_908_: *mut leanh::LeanObject,
    mut v_h__2_909_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop_match__1_splitter___redArg(
    ...
    let mut v_zero_914_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_915_: u8 = 0;
    v_zero_914_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_915_ == 1 {
        ...
        v___x_916_ = leanh::lean_apply_1(v_h__1_912_, leanh::lean_box(0));
        return v___x_916_;
    } else {
        let mut v_one_917_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_918_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_919_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_912_);
        v_one_917_ = leanh::lean_unsigned_to_nat(1);
        v_n_918_ = lean_nat_sub(v_x_911_, v_one_917_);
        v___x_919_ = leanh::lean_apply_2(v_h__2_913_, v_n_918_, leanh::lean_box(0));
        return v___x_919_;
    }
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop_match__1_splitter___redArg___boxed(
    ...
    leanh::lean_dec(v_x_920_);
    return v_res_923_;
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop_match__1_splitter(
    mut v_n_924_: *mut leanh::LeanObject,
    mut v_motive_925_: *mut leanh::LeanObject,
    mut v_x_926_: *mut leanh::LeanObject,
    mut v_x_927_: *mut leanh::LeanObject,
    mut v_h__1_928_: *mut leanh::LeanObject,
    mut v_h__2_929_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_930_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_931_: u8 = 0;
    v_zero_930_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_931_ = lean_nat_dec_eq(v_x_926_, v_zero_930_);
    if v_isZero_931_ == 1 {
        let mut v___x_932_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_929_);
        v___x_932_ = leanh::lean_apply_1(v_h__1_928_, leanh::lean_box(0));
        return v___x_932_;
    } else {
        let mut v_one_933_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_934_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_935_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_928_);
        v_one_933_ = leanh::lean_unsigned_to_nat(1);
        v_n_934_ = lean_nat_sub(v_x_926_, v_one_933_);
        v___x_935_ = leanh::lean_apply_2(v_h__2_929_, v_n_934_, leanh::lean_box(0));
        return v___x_935_;
    }
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_anyTR_loop_match__1_splitter___boxed(
    mut v_n_936_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_x_938_);
    leanh::lean_dec(v_n_936_);
    return v_res_942_;
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_any_match__1_splitter___redArg(
    ...
    mut v_h__1_945_: *mut leanh::LeanObject,
    mut v_h__2_946_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_947_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_948_: u8 = 0;
    v_zero_947_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_948_ = lean_nat_dec_eq(v_x_943_, v_zero_947_);
    if v_isZero_948_ == 1 {
        let mut v___x_949_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_946_);
        v___x_949_ = leanh::lean_apply_1(v_h__1_945_, v_x_944_);
        return v___x_949_;
    } else {
        let mut v_one_950_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_951_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_952_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_945_);
        v_one_950_ = leanh::lean_unsigned_to_nat(1);
        v_n_951_ = lean_nat_sub(v_x_943_, v_one_950_);
        v___x_952_ = leanh::lean_apply_2(v_h__2_946_, v_n_951_, v_x_944_);
        return v___x_952_;
    }
}
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_any_match__1_splitter(
    mut v_motive_958_: *mut leanh::LeanObject,
    mut v_x_959_: *mut leanh::LeanObject,
    mut v_x_960_: *mut leanh::LeanObject,
    mut v_h__1_961_: *mut leanh::LeanObject,
    mut v_h__2_962_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_963_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_964_: u8 = 0;
    v_zero_963_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_964_ = lean_nat_dec_eq(v_x_959_, v_zero_963_);
    if v_isZero_964_ == 1 {
        let mut v___x_965_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_962_);
        v___x_965_ = leanh::lean_apply_1(v_h__1_961_, v_x_960_);
        return v___x_965_;
    } else {
        let mut v_one_966_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_967_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_968_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_961_);
        v_one_966_ = leanh::lean_unsigned_to_nat(1);
        v_n_967_ = lean_nat_sub(v_x_959_, v_one_966_);
        v___x_968_ = leanh::lean_apply_2(v_h__2_962_, v_n_967_, v_x_960_);
        return v___x_968_;
    }
}
...
-> *mut leanh::LeanObject {
    ...
    leanh::lean_ctor_set(v___x_1029_, 1, v___x_1027_);
    leanh::lean_ctor_set(v___x_1029_, 2, v___x_1026_);
    return v___x_1029_;
}
...
-> *mut leanh::LeanObject {
    ...
    v___x_1035_ = leanh::lean_box(2);
    v___x_1036_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
    leanh::lean_ctor_set(v___x_1036_, 0, v___x_1035_);
    leanh::lean_ctor_set(v___x_1036_, 1, v___x_1034_);
    leanh::lean_ctor_set(v___x_1036_, 2, v___x_1033_);
    return v___x_1036_;
}
...
-> *mut leanh::LeanObject {
    ...
    v___x_1043_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
    leanh::lean_ctor_set(v___x_1043_, 0, v___x_1042_);
    leanh::lean_ctor_set(v___x_1043_, 1, v___x_1041_);
    leanh::lean_ctor_set(v___x_1043_, 2, v___x_1040_);
    return v___x_1043_;
}
...
-> *mut leanh::LeanObject {
    ...
    v___x_1049_ = leanh::lean_box(2);
    v___x_1050_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
    leanh::lean_ctor_set(v___x_1050_, 0, v___x_1049_);
    leanh::lean_ctor_set(v___x_1050_, 1, v___x_1048_);
    leanh::lean_ctor_set(v___x_1050_, 2, v___x_1047_);
    return v___x_1050_;
}
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfoldCast(
    mut v_n_1055_: *mut leanh::LeanObject,
    mut v_00_u03b1_1056_: *mut leanh::LeanObject,
    mut v_i_1057_: *mut leanh::LeanObject,
    mut v_j_1058_: *mut leanh::LeanObject,
    mut v_hi_1059_: *mut leanh::LeanObject,
    mut v_w_1060_: *mut leanh::LeanObject,
    mut v_x_1061_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    leanh::lean_inc(v_x_1061_);
    return v_x_1061_;
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfoldCast___boxed(
    ...
    mut v_j_1065_: *mut leanh::LeanObject,
    mut v_hi_1066_: *mut leanh::LeanObject,
    mut v_w_1067_: *mut leanh::LeanObject,
...
pub unsafe fn _init_l_Nat_dfold___auto__1() -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_loop___redArg(
    mut v_n_1073_: *mut leanh::LeanObject,
    mut v_f_1074_: *mut leanh::LeanObject,
    mut v_j_1075_: *mut leanh::LeanObject,
    mut v_a_1076_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_1077_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_1078_: u8 = 0;
    let mut v_one_1079_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_1077_ = leanh::lean_unsigned_to_nat(0);
                v_isZero_1078_ = lean_nat_dec_eq(v_j_1075_, v_zero_1077_);
                if v_isZero_1078_ == 1 {
                    leanh::lean_dec(v_j_1075_);
                    leanh::lean_dec(v_f_1074_);
                    return v_a_1076_;
                } else {
                    v_one_1079_ = leanh::lean_unsigned_to_nat(1);
                    v_n_1080_ = lean_nat_sub(v_j_1075_, v_one_1079_);
                    v___x_1081_ = lean_nat_sub(v_n_1073_, v_j_1075_);
                    leanh::lean_dec(v_j_1075_);
                    leanh::lean_inc(v_f_1074_);
                    v___x_1082_ = leanh::lean_apply_3(
                        v_f_1074_,
                        v___x_1081_,
                        leanh::lean_box(0),
                        v_a_1076_,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_loop___redArg___boxed(
    mut v_n_1084_: *mut leanh::LeanObject,
    mut v_f_1085_: *mut leanh::LeanObject,
    mut v_j_1086_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_n_1084_);
    return v_res_1088_;
}
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_loop(
    mut v_n_1089_: *mut leanh::LeanObject,
    mut v_00_u03b1_1090_: *mut leanh::LeanObject,
    mut v_f_1091_: *mut leanh::LeanObject,
    mut v_j_1092_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_loop___boxed(
    mut v_n_1096_: *mut leanh::LeanObject,
    mut v_00_u03b1_1097_: *mut leanh::LeanObject,
    mut v_f_1098_: *mut leanh::LeanObject,
    mut v_j_1099_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_dfold(
    ...
    mut v_init_1110_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_1111_: *mut leanh::LeanObject = core::ptr::null_mut();
    leanh::lean_inc(v_n_1107_);
    ...
    leanh::lean_dec(v_n_1107_);
    return v___x_1111_;
}
pub unsafe fn _init_l_Nat_dfoldRev___auto__1() -> *mut leanh::LeanObject {
...
pub unsafe fn l_Nat_dfoldRev___redArg___lam__0(
    ...
    mut v_i_1114_: *mut leanh::LeanObject,
    ...
    loop {
        match state {
            0 => {
                ...
                if v_isZero_1122_ == 1 {
                    leanh::lean_dec(v_f_1119_);
                    leanh::lean_dec(v_n_1118_);
                    return v_init_1120_;
                } else {
                    leanh::lean_inc(v_f_1119_);
                    v___f_1123_ = leanh::lean_alloc_closure(
                        l_Nat_dfoldRev___redArg___lam__0 as *mut core::ffi::c_void,
                        4,
                        1,
                    );
                    leanh::lean_closure_set(v___f_1123_, 0, v_f_1119_);
                    v_one_1124_ = leanh::lean_unsigned_to_nat(1);
                    v_n_1125_ = lean_nat_sub(v_n_1118_, v_one_1124_);
                    leanh::lean_dec(v_n_1118_);
                    leanh::lean_inc(v_n_1125_);
                    v___x_1126_ = leanh::lean_apply_3(
                        v_f_1119_,
                        v_n_1125_,
                        leanh::lean_box(0),
                        v_init_1120_,
...
pub unsafe fn l_Nat_dfoldRev(
    ...
    mut v_init_1131_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Nat_dfold__zero___auto__1() -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_match__2_splitter___redArg(
    ...
    let mut v_zero_1138_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_1139_: u8 = 0;
    v_zero_1138_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v_isZero_1139_ == 1 {
        ...
        v___x_1140_ =
            leanh::lean_apply_2(v_h__1_1136_, leanh::lean_box(0), v_x_1135_);
        return v___x_1140_;
    } else {
        let mut v_one_1141_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_1142_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_1143_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_1136_);
        v_one_1141_ = leanh::lean_unsigned_to_nat(1);
        v_n_1142_ = lean_nat_sub(v_x_1134_, v_one_1141_);
        v___x_1143_ = leanh::lean_apply_3(
            v_h__2_1137_,
            v_n_1142_,
            leanh::lean_box(0),
            v_x_1135_,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_match__2_splitter___redArg___boxed(
    ...
    mut v_h__1_1146_: *mut leanh::LeanObject,
    mut v_h__2_1147_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_match__2_splitter(
    ...
    mut v_00_u03b1_1150_: *mut leanh::LeanObject,
    ...
    mut v_h__1_1155_: *mut leanh::LeanObject,
    mut v_h__2_1156_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_1157_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_1158_: u8 = 0;
    v_zero_1157_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_1158_ = lean_nat_dec_eq(v_x_1152_, v_zero_1157_);
    if v_isZero_1158_ == 1 {
        let mut v___x_1159_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_1156_);
        v___x_1159_ =
            leanh::lean_apply_2(v_h__1_1155_, leanh::lean_box(0), v_x_1154_);
        return v___x_1159_;
    } else {
        let mut v_one_1160_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_1161_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_1162_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_1155_);
        v_one_1160_ = leanh::lean_unsigned_to_nat(1);
        v_n_1161_ = lean_nat_sub(v_x_1152_, v_one_1160_);
        v___x_1162_ = leanh::lean_apply_3(
            v_h__2_1156_,
            v_n_1161_,
            leanh::lean_box(0),
            v_x_1154_,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfold_match__2_splitter___boxed(
    ...
    mut v_motive_1165_: *mut leanh::LeanObject,
    mut v_x_1166_: *mut leanh::LeanObject,
    mut v_x_1167_: *mut leanh::LeanObject,
    mut v_x_1168_: *mut leanh::LeanObject,
    mut v_h__1_1169_: *mut leanh::LeanObject,
    mut v_h__2_1170_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Nat_dfold__succ___auto__3() -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Nat_dfold__congr___auto__1() -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Nat_dfold__add___auto__5() -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Nat_dfoldRev__zero___auto__1() -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfoldRev_match__1_splitter___redArg(
    ...
    mut v_init_1179_: *mut leanh::LeanObject,
    mut v_h__1_1180_: *mut leanh::LeanObject,
    mut v_h__2_1181_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_1182_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_1183_: u8 = 0;
    v_zero_1182_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_1183_ = lean_nat_dec_eq(v_n_1177_, v_zero_1182_);
    if v_isZero_1183_ == 1 {
        let mut v___x_1184_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_1181_);
        v___x_1184_ = leanh::lean_apply_3(
            v_h__1_1180_,
            leanh::lean_box(0),
            v_f_1178_,
            v_init_1179_,
        ...
        let mut v_one_1185_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_1186_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_1187_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_1180_);
        v_one_1185_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfoldRev_match__1_splitter___redArg___boxed(
    ...
    mut v_f_1189_: *mut leanh::LeanObject,
    mut v_init_1190_: *mut leanh::LeanObject,
    mut v_h__1_1191_: *mut leanh::LeanObject,
    mut v_h__2_1192_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfoldRev_match__1_splitter(
    ...
    mut v_f_1197_: *mut leanh::LeanObject,
    mut v_init_1198_: *mut leanh::LeanObject,
    mut v_h__1_1199_: *mut leanh::LeanObject,
    mut v_h__2_1200_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_zero_1201_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_1202_: u8 = 0;
    v_zero_1201_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_1202_ = lean_nat_dec_eq(v_n_1195_, v_zero_1201_);
    if v_isZero_1202_ == 1 {
        let mut v___x_1203_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_1200_);
        v___x_1203_ = leanh::lean_apply_3(
            v_h__1_1199_,
            leanh::lean_box(0),
            v_f_1197_,
            v_init_1198_,
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_dfoldRev_match__1_splitter___boxed(
    ...
    mut v_n_1208_: *mut leanh::LeanObject,
    mut v_00_u03b1_1209_: *mut leanh::LeanObject,
    mut v_f_1210_: *mut leanh::LeanObject,
    mut v_init_1211_: *mut leanh::LeanObject,
    mut v_h__1_1212_: *mut leanh::LeanObject,
    mut v_h__2_1213_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_n_1208_);
    return v_res_1214_;
}
pub unsafe fn _init_l_Nat_dfoldRev__succ___auto__3() -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Nat_dfoldRev__congr___auto__1() -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Nat_dfoldRev__add___auto__5() -> *mut leanh::LeanObject {
...
pub unsafe fn l_Prod_foldI___redArg___lam__0(
    mut v_fst_1218_: *mut leanh::LeanObject,
    mut v_f_1219_: *mut leanh::LeanObject,
    mut v_j_1220_: *mut leanh::LeanObject,
    ...
    v___x_1224_ = leanh::lean_apply_4(
        v_f_1219_,
        v___x_1223_,
        leanh::lean_box(0),
        leanh::lean_box(0),
...
pub unsafe fn l_Prod_foldI___redArg___lam__0___boxed(
    ...
    mut v_j_1227_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_j_1227_);
    leanh::lean_dec(v_fst_1225_);
    return v_res_1230_;
}
pub unsafe fn l_Prod_foldI___redArg(
    mut v_i_1231_: *mut leanh::LeanObject,
    mut v_f_1232_: *mut leanh::LeanObject,
    mut v_init_1233_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_fst_1234_ = leanh::lean_ctor_get(v_i_1231_, 0);
    leanh::lean_inc_n(v_fst_1234_, 2);
    v_snd_1235_ = leanh::lean_ctor_get(v_i_1231_, 1);
    leanh::lean_inc(v_snd_1235_);
    leanh::lean_dec_ref(v_i_1231_);
    v___f_1236_ = leanh::lean_alloc_closure(
        l_Prod_foldI___redArg___lam__0___boxed as *mut core::ffi::c_void,
        5,
        2,
    );
    leanh::lean_closure_set(v___f_1236_, 0, v_fst_1234_);
    leanh::lean_closure_set(v___f_1236_, 1, v_f_1232_);
    v___x_1237_ = lean_nat_sub(v_snd_1235_, v_fst_1234_);
    leanh::lean_dec(v_fst_1234_);
    leanh::lean_dec(v_snd_1235_);
    leanh::lean_inc(v___x_1237_);
...
pub unsafe fn l_Prod_foldI(
    ...
    mut v_i_1240_: *mut leanh::LeanObject,
    mut v_f_1241_: *mut leanh::LeanObject,
    mut v_init_1242_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v_fst_1243_ = leanh::lean_ctor_get(v_i_1240_, 0);
    leanh::lean_inc_n(v_fst_1243_, 2);
    v_snd_1244_ = leanh::lean_ctor_get(v_i_1240_, 1);
    leanh::lean_inc(v_snd_1244_);
    leanh::lean_dec_ref(v_i_1240_);
    v___f_1245_ = leanh::lean_alloc_closure(
        l_Prod_foldI___redArg___lam__0___boxed as *mut core::ffi::c_void,
        5,
        2,
    );
    leanh::lean_closure_set(v___f_1245_, 0, v_fst_1243_);
    leanh::lean_closure_set(v___f_1245_, 1, v_f_1241_);
    v___x_1246_ = lean_nat_sub(v_snd_1244_, v_fst_1243_);
    leanh::lean_dec(v_fst_1243_);
    leanh::lean_dec(v_snd_1244_);
    leanh::lean_inc(v___x_1246_);
...
pub unsafe fn l_Prod_anyI___lam__0(
    ...
    mut v_f_1249_: *mut leanh::LeanObject,
    mut v_j_1250_: *mut leanh::LeanObject,
    ...
    v___x_1253_ = leanh::lean_apply_3(
        v_f_1249_,
        v___x_1252_,
        leanh::lean_box(0),
        leanh::lean_box(0),
...
pub unsafe fn l_Prod_anyI(
    ...
    let mut v___f_1265_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1266_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1267_: u8 = 0;
    v_fst_1263_ = leanh::lean_ctor_get(v_i_1261_, 0);
    leanh::lean_inc_n(v_fst_1263_, 2);
    v_snd_1264_ = leanh::lean_ctor_get(v_i_1261_, 1);
    leanh::lean_inc(v_snd_1264_);
    leanh::lean_dec_ref(v_i_1261_);
    v___f_1265_ = leanh::lean_alloc_closure(
        l_Prod_anyI___lam__0___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___f_1265_, 0, v_fst_1263_);
    leanh::lean_closure_set(v___f_1265_, 1, v_f_1262_);
    v___x_1266_ = lean_nat_sub(v_snd_1264_, v_fst_1263_);
    leanh::lean_dec(v_fst_1263_);
    leanh::lean_dec(v_snd_1264_);
    leanh::lean_inc(v___x_1266_);
...
pub unsafe fn l_Prod_allI(
    ...
    let mut v_fst_1274_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_fst_1274_ = leanh::lean_ctor_get(v_i_1272_, 0);
    leanh::lean_inc_n(v_fst_1274_, 2);
    v_snd_1275_ = leanh::lean_ctor_get(v_i_1272_, 1);
    leanh::lean_inc(v_snd_1275_);
    leanh::lean_dec_ref(v_i_1272_);
    v___f_1276_ = leanh::lean_alloc_closure(
        l_Prod_anyI___lam__0___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___f_1276_, 0, v_fst_1274_);
    leanh::lean_closure_set(v___f_1276_, 1, v_f_1273_);
    v___x_1277_ = lean_nat_sub(v_snd_1275_, v_fst_1274_);
    leanh::lean_dec(v_fst_1274_);
    leanh::lean_dec(v_snd_1275_);
    leanh::lean_inc(v___x_1277_);
...
pub unsafe fn runtime_initialize_Init_Data_Nat_Fold(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Nat_Fold(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    leanh::lean_mark_persistent(l___private_Init_Data_Nat_Fold_0__Nat_dfoldCast___auto__1);
    ...
    leanh::lean_mark_persistent(l_Nat_dfold___auto__1);
    l_Nat_dfoldRev___auto__1 = _init_l_Nat_dfoldRev___auto__1();
    leanh::lean_mark_persistent(l_Nat_dfoldRev___auto__1);
    l_Nat_dfold__zero___auto__1 = _init_l_Nat_dfold__zero___auto__1();
    leanh::lean_mark_persistent(l_Nat_dfold__zero___auto__1);
    ...
    leanh::lean_mark_persistent(l_Nat_dfold__succ___auto__3);
    l_Nat_dfold__congr___auto__1 = _init_l_Nat_dfold__congr___auto__1();
    leanh::lean_mark_persistent(l_Nat_dfold__congr___auto__1);
    l_Nat_dfold__add___auto__5 = _init_l_Nat_dfold__add___auto__5();
    leanh::lean_mark_persistent(l_Nat_dfold__add___auto__5);
    l_Nat_dfoldRev__zero___auto__1 = _init_l_Nat_dfoldRev__zero___auto__1();
    leanh::lean_mark_persistent(l_Nat_dfoldRev__zero___auto__1);
    l_Nat_dfoldRev__succ___auto__3 = _init_l_Nat_dfoldRev__succ___auto__3();
    leanh::lean_mark_persistent(l_Nat_dfoldRev__succ___auto__3);
    l_Nat_dfoldRev__congr___auto__1 = _init_l_Nat_dfoldRev__congr___auto__1();
    leanh::lean_mark_persistent(l_Nat_dfoldRev__congr___auto__1);
    l_Nat_dfoldRev__add___auto__5 = _init_l_Nat_dfoldRev__add___auto__5();
    leanh::lean_mark_persistent(l_Nat_dfoldRev__add___auto__5);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
static mut _G_initialized: bool = false;
pub unsafe fn initialize_Init_Data_Nat_Fold(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
