...
pub unsafe fn l_Nat_decidableBallLT___redArg___lam__0(
    ...
    v___x_216_ = leanh::lean_apply_2(v_x_213_, v_n_214_, leanh::lean_box(0));
    v___x_217_ = (leanh::lean_unbox(v___x_216_) as u8);
    return v___x_217_;
}
...
pub unsafe fn l_Nat_decidableBallLT___redArg(
    ...
    let mut v_zero_225_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_226_: u8 = 0;
    v_zero_225_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_226_ = lean_nat_dec_eq(v_x_223_, v_zero_225_);
    if v_isZero_226_ == 1 {
        leanh::lean_dec_ref(v_x_224_);
        return v_isZero_226_;
    } else {
        let mut v___f_227_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_228_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_229_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_230_: u8 = 0;
        leanh::lean_inc_ref(v_x_224_);
        v___f_227_ = leanh::lean_alloc_closure(
            l_Nat_decidableBallLT___redArg___lam__0___boxed as *mut core::ffi::c_void,
            3,
            1,
        );
        leanh::lean_closure_set(v___f_227_, 0, v_x_224_);
        v_one_228_ = leanh::lean_unsigned_to_nat(1);
        v_n_229_ = lean_nat_sub(v_x_223_, v_one_228_);
        v___x_230_ = l_Nat_decidableBallLT___redArg(v_n_229_, v___f_227_);
        if v___x_230_ == 0 {
            leanh::lean_dec(v_n_229_);
            leanh::lean_dec_ref(v_x_224_);
            return v___x_230_;
        } else {
            let mut v___x_231_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_232_: u8 = 0;
            v___x_231_ = leanh::lean_apply_2(v_x_224_, v_n_229_, leanh::lean_box(0));
            v___x_232_ = (leanh::lean_unbox(v___x_231_) as u8);
            return v___x_232_;
        }
    }
}
pub unsafe fn l_Nat_decidableBallLT___redArg___boxed(
    ...
    let mut v_r_236_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_235_ = l_Nat_decidableBallLT___redArg(v_x_233_, v_x_234_);
    leanh::lean_dec(v_x_233_);
    v_r_236_ = leanh::lean_box((v_res_235_) as usize);
    return v_r_236_;
}
...
pub unsafe fn l_Nat_decidableBallLT___boxed(
    ...
    v_r_245_ = leanh::lean_box((v_res_244_) as usize);
    return v_r_245_;
}
pub unsafe fn l_Nat_decidableForallFin___redArg___lam__0(
    ...
    v___x_249_ = leanh::lean_apply_1(v_inst_246_, v_n_247_);
    v___x_250_ = (leanh::lean_unbox(v___x_249_) as u8);
    return v___x_250_;
}
pub unsafe fn l_Nat_decidableForallFin___redArg___lam__0___boxed(
    mut v_inst_251_: *mut leanh::LeanObject,
    mut v_n_252_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_decidableForallFin___redArg___boxed(
    ...
    let mut v_r_263_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_262_ = l_Nat_decidableForallFin___redArg(v_n_260_, v_inst_261_);
    leanh::lean_dec(v_n_260_);
    v_r_263_ = leanh::lean_box((v_res_262_) as usize);
    return v_r_263_;
}
pub unsafe fn l_Nat_decidableForallFin(
    mut v_n_264_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_decidableBallLE___redArg(
    ...
    v___f_285_ = leanh::lean_alloc_closure(
        l_Nat_decidableBallLE___redArg___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_285_, 0, v_inst_284_);
    v___x_286_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_Nat_decidableBallLE___redArg___boxed(
    mut v_n_289_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_decidableBallLE___boxed(
    ...
    mut v_P_298_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_decidableExistsLT___redArg(
    mut v_h_302_: *mut leanh::LeanObject,
    mut v_x_303_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_zero_304_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_305_: u8 = 0;
    v_zero_304_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_305_ = lean_nat_dec_eq(v_x_303_, v_zero_304_);
    if v_isZero_305_ == 1 {
        let mut v___x_306_: u8 = 0;
        leanh::lean_dec_ref(v_h_302_);
        v___x_306_ = 0;
        return v___x_306_;
    } else {
        let mut v_one_307_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_308_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        leanh::lean_inc_ref(v_h_302_);
        leanh::lean_inc(v_n_308_);
        v___x_309_ = leanh::lean_apply_1(v_h_302_, v_n_308_);
        v___x_310_ = l_Nat_decidableExistsLT___redArg(v_h_302_, v_n_308_);
        leanh::lean_dec(v_n_308_);
        if v___x_310_ == 0 {
            let mut v___x_311_: u8 = 0;
            v___x_311_ = (leanh::lean_unbox(v___x_309_) as u8);
            return v___x_311_;
        } else {
            return v___x_310_;
        }
...
pub unsafe fn l_Nat_decidableExistsLT___redArg___boxed(
    mut v_h_312_: *mut leanh::LeanObject,
    ...
    v_r_315_ = leanh::lean_box((v_res_314_) as usize);
    return v_r_315_;
}
pub unsafe fn l_Nat_decidableExistsLT(
    mut v_p_316_: *mut leanh::LeanObject,
    mut v_h_317_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_decidableExistsLT___boxed(
    mut v_p_320_: *mut leanh::LeanObject,
    mut v_h_321_: *mut leanh::LeanObject,
    mut v_x_322_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_323_: u8 = 0;
    let mut v_r_324_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_323_ = l_Nat_decidableExistsLT(v_p_320_, v_h_321_, v_x_322_);
    leanh::lean_dec(v_x_322_);
    v_r_324_ = leanh::lean_box((v_res_323_) as usize);
    return v_r_324_;
}
...
pub unsafe fn l_Nat_decidableExistsLE___redArg___boxed(
    ...
    let mut v_r_333_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_332_ = l_Nat_decidableExistsLE___redArg(v_inst_330_, v_n_331_);
    leanh::lean_dec(v_n_331_);
    v_r_333_ = leanh::lean_box((v_res_332_) as usize);
    return v_r_333_;
}
...
pub unsafe fn l_Nat_decidableExistsLE___boxed(
    ...
    mut v_n_340_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_341_: u8 = 0;
    let mut v_r_342_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_341_ = l_Nat_decidableExistsLE(v_p_338_, v_inst_339_, v_n_340_);
    leanh::lean_dec(v_n_340_);
    v_r_342_ = leanh::lean_box((v_res_341_) as usize);
    return v_r_342_;
}
pub unsafe fn l_Nat_decidableExistsLT_x27___redArg___lam__0(
    mut v_I_343_: *mut leanh::LeanObject,
    mut v_m_344_: *mut leanh::LeanObject,
    mut v_h_345_: *mut leanh::LeanObject,
) -> u8 {
    let mut v___x_346_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_347_: u8 = 0;
    v___x_346_ = leanh::lean_apply_2(v_I_343_, v_m_344_, leanh::lean_box(0));
    v___x_347_ = (leanh::lean_unbox(v___x_346_) as u8);
    return v___x_347_;
}
pub unsafe fn l_Nat_decidableExistsLT_x27___redArg___lam__0___boxed(
    mut v_I_348_: *mut leanh::LeanObject,
    ...
    v_r_352_ = leanh::lean_box((v_res_351_) as usize);
    return v_r_352_;
}
pub unsafe fn l_Nat_decidableExistsLT_x27___redArg(
    mut v_k_353_: *mut leanh::LeanObject,
    mut v_I_354_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_zero_355_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isZero_356_: u8 = 0;
    v_zero_355_ = leanh::lean_unsigned_to_nat(0);
    v_isZero_356_ = lean_nat_dec_eq(v_k_353_, v_zero_355_);
    if v_isZero_356_ == 1 {
        let mut v___x_357_: u8 = 0;
        leanh::lean_dec_ref(v_I_354_);
        v___x_357_ = 0;
        return v___x_357_;
    } else {
        let mut v___f_358_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_359_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_n_360_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_361_: u8 = 0;
        leanh::lean_inc_ref(v_I_354_);
        v___f_358_ = leanh::lean_alloc_closure(
            l_Nat_decidableExistsLT_x27___redArg___lam__0___boxed as *mut core::ffi::c_void,
            3,
            1,
        );
        leanh::lean_closure_set(v___f_358_, 0, v_I_354_);
        v_one_359_ = leanh::lean_unsigned_to_nat(1);
        ...
        if v___x_361_ == 0 {
            ...
            v___x_362_ = leanh::lean_apply_2(v_I_354_, v_n_360_, leanh::lean_box(0));
            v___x_363_ = (leanh::lean_unbox(v___x_362_) as u8);
            return v___x_363_;
        } else {
            leanh::lean_dec(v_n_360_);
            leanh::lean_dec_ref(v_I_354_);
            return v___x_361_;
        }
    }
...
pub unsafe fn l_Nat_decidableExistsLT_x27___redArg___boxed(
    ...
    mut v_I_365_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Nat_decidableExistsLT_x27___boxed(
    ...
    mut v_p_373_: *mut leanh::LeanObject,
    mut v_I_374_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Nat_decidableExistsLE_x27___redArg(
    ...
    leanh::lean_closure_set(v___f_379_, 0, v_I_378_);
...
pub unsafe fn l_Nat_decidableExistsLE_x27___redArg___boxed(
    ...
    mut v_I_384_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Nat_decidableExistsLE_x27(
    ...
    mut v_p_388_: *mut leanh::LeanObject,
    mut v_I_389_: *mut leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Nat_decidableExistsLE_x27___boxed(
    mut v_k_391_: *mut leanh::LeanObject,
    mut v_p_392_: *mut leanh::LeanObject,
...
pub unsafe fn l_Nat_decidableExistsFin___redArg___lam__0(
    ...
    if v___x_399_ == 0 {
        ...
        v___x_401_ = leanh::lean_apply_1(v_inst_397_, v_a_398_);
        v___x_402_ = (leanh::lean_unbox(v___x_401_) as u8);
        return v___x_402_;
    }
}
...
pub unsafe fn l_Nat_decidableExistsFin___redArg___boxed(
    ...
    let mut v_r_415_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_414_ = l_Nat_decidableExistsFin___redArg(v_n_412_, v_inst_413_);
    v_r_415_ = leanh::lean_box((v_res_414_) as usize);
    return v_r_415_;
}
pub unsafe fn l_Nat_decidableExistsFin(
    mut v_n_416_: *mut leanh::LeanObject,
    mut v_P_417_: *mut leanh::LeanObject,
...
pub unsafe fn meta_initialize_Init_Data_Nat_Lemmas(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Nat_Lemmas(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
