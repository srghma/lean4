...
pub unsafe fn l_Nat_instDecidableIsPowerOfTwo(mut v_n_12_: *mut leanh::LeanObject) -> u8 {
    ...
    if v___x_14_ == 0 {
        ...
        v___x_15_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_Nat_instDecidableIsPowerOfTwo___boxed(
    mut v_n_20_: *mut leanh::LeanObject,
...
pub unsafe fn initialize_Init_Data_Nat_Power2_Lemmas(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
