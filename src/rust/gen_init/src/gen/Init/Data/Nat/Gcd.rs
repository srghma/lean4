...
pub unsafe fn l_Nat_gcd___boxed(
    ...
    let mut v_res_33_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_33_ = lean_nat_gcd(v_m_31_, v_n_32_);
    leanh::lean_dec(v_n_32_);
    leanh::lean_dec(v_m_31_);
    return v_res_33_;
}
pub unsafe fn l_Nat_dvdProdDvdOfDvdProd___redArg(
    mut v_k_34_: *mut leanh::LeanObject,
    ...
    v___x_38_ = leanh::lean_unsigned_to_nat(0);
    ...
    if v___x_39_ == 0 {
        ...
        leanh::lean_ctor_set(v___x_41_, 0, v___x_37_);
        ...
        v___x_42_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
        leanh::lean_ctor_set(v___x_42_, 0, v___x_38_);
        leanh::lean_ctor_set(v___x_42_, 1, v_n_36_);
        return v___x_42_;
    }
}
pub unsafe fn l_Nat_dvdProdDvdOfDvdProd___redArg___boxed(
    mut v_k_43_: *mut leanh::LeanObject,
    mut v_m_44_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_m_44_);
    leanh::lean_dec(v_k_43_);
    return v_res_46_;
}
pub unsafe fn l_Nat_dvdProdDvdOfDvdProd(
    ...
    mut v_h_50_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Nat_dvdProdDvdOfDvdProd___boxed(
    mut v_k_52_: *mut leanh::LeanObject,
    mut v_m_53_: *mut leanh::LeanObject,
    mut v_n_54_: *mut leanh::LeanObject,
    mut v_h_55_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_m_53_);
    leanh::lean_dec(v_k_52_);
    return v_res_56_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Nat_Gcd(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Nat_Gcd(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Nat_Gcd(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
