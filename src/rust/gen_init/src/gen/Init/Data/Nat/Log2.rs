...
pub unsafe fn l_Nat_log2___boxed(
    mut v_n_5_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_6_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_6_ = lean_nat_log2(v_n_5_);
    leanh::lean_dec(v_n_5_);
    return v_res_6_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Nat_Log2(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Nat_Log2(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Nat_Log2(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
