...
-> *mut crate::leanh::LeanObject {
    let mut v_natZero_81_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_intZero_82_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_natZero_81_ = crate::leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l___private_Init_Data_Int_DivMod_Bootstrap_0__Int_ediv_match__1_splitter___redArg(
    ...
    mut v_h__3_87_: *mut crate::leanh::LeanObject,
    mut v_h__4_88_: *mut crate::leanh::LeanObject,
    mut v_h__5_89_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_natZero_90_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_intZero_91_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_92_: u8 = 0;
    v_natZero_90_ = crate::leanh::lean_unsigned_to_nat(0);
    ...
    if v_isNeg_92_ == 0 {
        ...
        crate::leanh::lean_dec(v_h__5_89_);
        crate::leanh::lean_dec(v_h__4_88_);
        crate::leanh::lean_dec(v_h__3_87_);
        ...
        if v_isNeg_94_ == 0 {
            ...
            v___x_96_ = crate::leanh::lean_apply_2(v_h__1_85_, v_a_93_, v_a_95_);
            return v___x_96_;
        } else {
            let mut v_abs_97_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            let mut v_one_98_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            ...
            v_one_98_ = crate::leanh::lean_unsigned_to_nat(1);
            v_a_99_ = lean_nat_sub(v_abs_97_, v_one_98_);
            crate::leanh::lean_dec(v_abs_97_);
            v___x_100_ = crate::leanh::lean_apply_2(v_h__2_86_, v_a_93_, v_a_99_);
            return v___x_100_;
        }
    } else {
        let mut v_abs_101_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_102_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_a_103_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_isNeg_104_: u8 = 0;
        crate::leanh::lean_dec(v_h__2_86_);
        crate::leanh::lean_dec(v_h__1_85_);
        v_abs_101_ = lean_nat_abs(v_x_83_);
        v_one_102_ = crate::leanh::lean_unsigned_to_nat(1);
        v_a_103_ = lean_nat_sub(v_abs_101_, v_one_102_);
        crate::leanh::lean_dec(v_abs_101_);
        v_isNeg_104_ = lean_int_dec_lt(v_x_84_, v_intZero_91_);
        if v_isNeg_104_ == 0 {
            let mut v_a_105_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            ...
            if v_isZero_106_ == 1 {
                ...
                crate::leanh::lean_dec(v_h__4_88_);
                v___x_107_ = crate::leanh::lean_apply_1(v_h__3_87_, v_a_103_);
                return v___x_107_;
            } else {
                let mut v_n_108_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
                let mut v___x_109_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
                crate::leanh::lean_dec(v_h__3_87_);
                v_n_108_ = lean_nat_sub(v_a_105_, v_one_102_);
                crate::leanh::lean_dec(v_a_105_);
                v___x_109_ = crate::leanh::lean_apply_2(v_h__4_88_, v_a_103_, v_n_108_);
                return v___x_109_;
            }
        } else {
            let mut v_abs_110_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            let mut v_a_111_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            ...
            crate::leanh::lean_dec(v_abs_110_);
            v___x_112_ = crate::leanh::lean_apply_2(v_h__5_89_, v_a_103_, v_a_111_);
            return v___x_112_;
        }
    }
}
pub unsafe fn l___private_Init_Data_Int_DivMod_Bootstrap_0__Int_ediv_match__1_splitter___redArg___boxed(
    ...
    mut v_h__4_118_: *mut crate::leanh::LeanObject,
    mut v_h__5_119_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l___private_Init_Data_Int_DivMod_Bootstrap_0__Int_ediv_match__1_splitter(
    ...
    mut v_h__4_127_: *mut crate::leanh::LeanObject,
    mut v_h__5_128_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_natZero_129_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_intZero_130_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_131_: u8 = 0;
    v_natZero_129_ = crate::leanh::lean_unsigned_to_nat(0);
    v_intZero_130_ = crate::leanh::lean_obj_once(core::ptr::addr_of_mut!(l___private_Init_Data_Int_DivMod_Bootstrap_0__Int_ediv_match__1_splitter___redArg___closed__0), core::ptr::addr_of_mut!(l___private_Init_Data_Int_DivMod_Bootstrap_0__Int_ediv_match__1_splitter___redArg___closed__0_once), _init_l___private_Init_Data_Int_DivMod_Bootstrap_0__Int_ediv_match__1_splitter___redArg___closed__0);
    ...
    if v_isNeg_131_ == 0 {
        ...
        crate::leanh::lean_dec(v_h__5_128_);
        crate::leanh::lean_dec(v_h__4_127_);
        ...
        if v_isNeg_133_ == 0 {
            ...
            v___x_135_ = crate::leanh::lean_apply_2(v_h__1_124_, v_a_132_, v_a_134_);
            return v___x_135_;
        } else {
            let mut v_abs_136_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            let mut v_one_137_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            ...
            v_one_137_ = crate::leanh::lean_unsigned_to_nat(1);
            v_a_138_ = lean_nat_sub(v_abs_136_, v_one_137_);
            crate::leanh::lean_dec(v_abs_136_);
            v___x_139_ = crate::leanh::lean_apply_2(v_h__2_125_, v_a_132_, v_a_138_);
            return v___x_139_;
        }
    } else {
        let mut v_abs_140_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_141_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_a_142_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
        let mut v_isNeg_143_: u8 = 0;
        crate::leanh::lean_dec(v_h__2_125_);
        crate::leanh::lean_dec(v_h__1_124_);
        v_abs_140_ = lean_nat_abs(v_x_122_);
        v_one_141_ = crate::leanh::lean_unsigned_to_nat(1);
        v_a_142_ = lean_nat_sub(v_abs_140_, v_one_141_);
        crate::leanh::lean_dec(v_abs_140_);
        v_isNeg_143_ = lean_int_dec_lt(v_x_123_, v_intZero_130_);
        if v_isNeg_143_ == 0 {
            let mut v_a_144_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            ...
            if v_isZero_145_ == 1 {
                ...
                crate::leanh::lean_dec(v_h__4_127_);
                v___x_146_ = crate::leanh::lean_apply_1(v_h__3_126_, v_a_142_);
                return v___x_146_;
            } else {
                let mut v_n_147_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
                let mut v___x_148_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
                crate::leanh::lean_dec(v_h__3_126_);
                v_n_147_ = lean_nat_sub(v_a_144_, v_one_141_);
                crate::leanh::lean_dec(v_a_144_);
                v___x_148_ = crate::leanh::lean_apply_2(v_h__4_127_, v_a_142_, v_n_147_);
                return v___x_148_;
            }
        } else {
            let mut v_abs_149_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
            ...
            crate::leanh::lean_dec(v_abs_149_);
            v___x_151_ = crate::leanh::lean_apply_2(v_h__5_128_, v_a_142_, v_a_150_);
            return v___x_151_;
        }
    }
}
pub unsafe fn l___private_Init_Data_Int_DivMod_Bootstrap_0__Int_ediv_match__1_splitter___boxed(
    ...
    mut v_h__4_158_: *mut crate::leanh::LeanObject,
    mut v_h__5_159_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
