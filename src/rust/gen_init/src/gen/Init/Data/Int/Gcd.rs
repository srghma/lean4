...
use crate::ffi::{lean_int_dec_le, lean_int_neg, lean_nat_abs, lean_nat_gcd, lean_nat_to_int};
...
static mut l_Int_dvdProdDvdOfDvdProd___redArg___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Int_dvdProdDvdOfDvdProd___redArg___closed__0: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub unsafe fn l_Int_gcd(
    mut v_m_67_: *mut leanh::LeanObject,
    mut v_n_68_: *mut leanh::LeanObject,
...
pub unsafe fn l_Int_dvdProdDvdOfDvdProd___redArg(
    ...
    let mut v_d_u2080_85_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_86_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_87_: u8 = 0;
    let mut v_fst_88_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_89_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                leanh::lean_dec(v___x_83_);
                leanh::lean_dec(v___x_82_);
                v___x_86_ = leanh::lean_obj_once(
                ...
                if v___x_87_ == 0 {
                    v_fst_88_ = leanh::lean_ctor_get(v_d_u2080_85_, 0);
                    v_snd_89_ = leanh::lean_ctor_get(v_d_u2080_85_, 1);
                    v_isSharedCheck_99_ = (!leanh::lean_is_exclusive(v_d_u2080_85_)) as u8;
                    if v_isSharedCheck_99_ == 0 {
                        ...
                        leanh::lean_inc(v_snd_89_);
                        leanh::lean_inc(v_fst_88_);
                        leanh::lean_dec(v_d_u2080_85_);
                    ...
                    v_fst_100_ = leanh::lean_ctor_get(v_d_u2080_85_, 0);
                    v_snd_101_ = leanh::lean_ctor_get(v_d_u2080_85_, 1);
                    v_isSharedCheck_110_ = (!leanh::lean_is_exclusive(v_d_u2080_85_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_92_ == 0 {
                    leanh::lean_ctor_set(v___x_91_, 1, v___x_95_);
                    leanh::lean_ctor_set(v___x_91_, 0, v___x_94_);
                    v___x_97_ = v___x_91_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_98_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_98_, 0, v___x_94_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_98_, 1, v___x_95_);
            ...
            3 => {
                ...
                if v_isShared_104_ == 0 {
                    leanh::lean_ctor_set(v___x_103_, 1, v___x_106_);
                    leanh::lean_ctor_set(v___x_103_, 0, v___x_105_);
                    v___x_108_ = v___x_103_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_109_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_109_, 0, v___x_105_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_109_, 1, v___x_106_);
...
pub unsafe fn l_Int_dvdProdDvdOfDvdProd___redArg___boxed(
    mut v_k_111_: *mut leanh::LeanObject,
    mut v_m_112_: *mut leanh::LeanObject,
    mut v_n_113_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_n_113_);
    leanh::lean_dec(v_m_112_);
    leanh::lean_dec(v_k_111_);
    return v_res_114_;
}
pub unsafe fn l_Int_dvdProdDvdOfDvdProd(
    mut v_k_115_: *mut leanh::LeanObject,
    mut v_m_116_: *mut leanh::LeanObject,
    mut v_n_117_: *mut leanh::LeanObject,
    mut v_h_118_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Int_dvdProdDvdOfDvdProd___boxed(
    mut v_k_120_: *mut leanh::LeanObject,
    mut v_m_121_: *mut leanh::LeanObject,
    mut v_n_122_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_n_122_);
    leanh::lean_dec(v_m_121_);
    leanh::lean_dec(v_k_120_);
    return v_res_124_;
}
pub unsafe fn l_Int_lcm(
    mut v_m_125_: *mut leanh::LeanObject,
    mut v_n_126_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Int_lcm___boxed(
    ...
    leanh::lean_dec(v_m_130_);
    return v_res_132_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Int_Gcd(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Int_Gcd(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_Gcd(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
