...
use crate::ffi::{
    lean_int_dec_lt, lean_nat_abs, lean_nat_add, lean_nat_sub, lean_nat_to_int, lean_string_append,
};
...
static mut l_Int_repr___closed__0_once: leanh::LeanOnceCell = leanh::LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Int_repr___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_Int_repr___closed__1_value: leanh::LeanStringObject<2> =
...
static mut l_Int_repr___closed__1: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_repr___closed__1_value) as *mut leanh::LeanObject;
pub static l_Int_instRepr___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_Int_instRepr___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instRepr___closed__0_value) as *mut leanh::LeanObject;
pub static mut l_Int_instRepr: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instRepr___closed__0_value) as *mut leanh::LeanObject;
pub unsafe fn _init_l_Int_repr___closed__0() -> *mut leanh::LeanObject {
    let mut v_natZero_32_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_intZero_33_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_natZero_32_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l_Int_repr(
    ...
    v_intZero_36_ = leanh::lean_obj_once(
    ...
    if v_isNeg_37_ == 0 {
        ...
        let mut v_abs_40_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Int_instRepr___lam__0(
    ...
    if v___x_52_ == 0 {
        ...
        v___x_54_ = leanh::lean_alloc_ctor(3, 1, (0) as u32);
        ...
        v___x_56_ = leanh::lean_alloc_ctor(3, 1, (0) as u32);
        leanh::lean_ctor_set(v___x_56_, 0, v___x_55_);
        v___x_57_ = l_Repr_addAppParen(v___x_56_, v_prec_50_);
        return v___x_57_;
    }
}
pub unsafe fn l_Int_instRepr___lam__0___boxed(
    mut v_i_58_: *mut leanh::LeanObject,
    mut v_prec_59_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_60_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_60_ = l_Int_instRepr___lam__0(v_i_58_, v_prec_59_);
    leanh::lean_dec(v_prec_59_);
    leanh::lean_dec(v_i_58_);
    return v_res_60_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Int_Repr(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Int_Repr(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_Repr(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
