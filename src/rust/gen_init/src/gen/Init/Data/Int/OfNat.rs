...
static mut l_Int_Nonneg_num__cert___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Int_Nonneg_num__cert___closed__0: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub unsafe fn _init_l_Int_Nonneg_num__cert___closed__0() -> *mut leanh::LeanObject {
    let mut v___x_9_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_10_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_9_ = leanh::lean_unsigned_to_nat(0);
    v___x_10_ = lean_nat_to_int(v___x_9_);
    return v___x_10_;
}
pub unsafe fn l_Int_Nonneg_num__cert(mut v_a_11_: *mut leanh::LeanObject) -> u8 {
    let mut v___x_12_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_13_: u8 = 0;
    v___x_12_ = leanh::lean_obj_once(
...
pub unsafe fn l_Int_Nonneg_num__cert___boxed(
    mut v_a_14_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_15_: u8 = 0;
    let mut v_r_16_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_15_ = l_Int_Nonneg_num__cert(v_a_14_);
    leanh::lean_dec(v_a_14_);
    v_r_16_ = leanh::lean_box((v_res_15_) as usize);
    return v_r_16_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Int_OfNat(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Int_OfNat(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_OfNat(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
