...
// Imports: Init.Data.Int.DivMod.Basic Init.Data.Int.DivMod.Bootstrap Init.Data.Int.DivMod.Lemmas Init.Data.Int.DivMod.Pow
...
use crate::r#gen::Init::Data::Int::DivMod::Pow::{
    initialize_Init_Data_Int_DivMod_Pow, runtime_initialize_Init_Data_Int_DivMod_Pow,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Int_DivMod(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_Int_DivMod(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_DivMod(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
