...
static mut l_Int_not___closed__0_once: leanh::LeanOnceCell = leanh::LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Int_not___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_Int_instComplement___closed__0_value: leanh::LeanClosureObject<0> =
...
static mut l_Int_instComplement___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instComplement___closed__0_value) as *mut leanh::LeanObject;
pub static mut l_Int_instComplement: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instComplement___closed__0_value) as *mut leanh::LeanObject;
pub static l_Int_instHShiftRightNat___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Int_instHShiftRightNat___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instHShiftRightNat___closed__0_value)
        as *mut leanh::LeanObject;
pub static mut l_Int_instHShiftRightNat: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instHShiftRightNat___closed__0_value)
        as *mut leanh::LeanObject;
pub static l_Int_instHShiftLeftNat___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_Int_instHShiftLeftNat___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instHShiftLeftNat___closed__0_value) as *mut leanh::LeanObject;
pub static mut l_Int_instHShiftLeftNat: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Int_instHShiftLeftNat___closed__0_value) as *mut leanh::LeanObject;
pub unsafe fn _init_l_Int_not___closed__0() -> *mut leanh::LeanObject {
    let mut v_natZero_52_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_intZero_53_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_natZero_52_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l_Int_not(
    ...
    let mut v_intZero_55_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_56_: u8 = 0;
    v_intZero_55_ = leanh::lean_obj_once(
    ...
    if v_isNeg_56_ == 0 {
        let mut v_a_57_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        let mut v_abs_59_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_60_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v_one_60_ = leanh::lean_unsigned_to_nat(1);
        v_a_61_ = lean_nat_sub(v_abs_59_, v_one_60_);
        leanh::lean_dec(v_abs_59_);
...
pub unsafe fn l_Int_shiftRight(
    ...
    let mut v_intZero_69_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_70_: u8 = 0;
    v_intZero_69_ = leanh::lean_obj_once(
        core::ptr::addr_of_mut!(l_Int_not___closed__0),
        core::ptr::addr_of_mut!(l_Int_not___closed__0_once),
        _init_l_Int_not___closed__0,
    );
    ...
    if v_isNeg_70_ == 0 {
        ...
        leanh::lean_dec(v_a_71_);
        v___x_73_ = lean_nat_to_int(v___x_72_);
        return v___x_73_;
    } else {
        let mut v_abs_74_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_75_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_a_76_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v_one_75_ = leanh::lean_unsigned_to_nat(1);
        v_a_76_ = lean_nat_sub(v_abs_74_, v_one_75_);
        leanh::lean_dec(v_abs_74_);
        v___x_77_ = lean_nat_shiftr(v_a_76_, v_x_68_);
        leanh::lean_dec(v_a_76_);
...
pub unsafe fn l_Int_shiftLeft(
    ...
    let mut v_intZero_86_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isNeg_87_: u8 = 0;
    v_intZero_86_ = leanh::lean_obj_once(
        core::ptr::addr_of_mut!(l_Int_not___closed__0),
        core::ptr::addr_of_mut!(l_Int_not___closed__0_once),
        _init_l_Int_not___closed__0,
    );
    ...
    if v_isNeg_87_ == 0 {
        ...
        leanh::lean_dec(v_a_88_);
        v___x_90_ = lean_nat_to_int(v___x_89_);
        return v___x_90_;
    } else {
        let mut v_abs_91_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_one_92_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_Bitwise_Basic(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
