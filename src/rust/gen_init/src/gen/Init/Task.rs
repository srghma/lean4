...
pub unsafe fn l___private_Init_Task_0__Task_mapList_go___redArg___lam__0(
    ...
    mut v_f_98_: *mut leanh::LeanObject,
    ...
    v___x_101_ = leanh::lean_apply_1(v_f_98_, v___x_100_);
    return v___x_101_;
}
pub unsafe fn l___private_Init_Task_0__Task_mapList_go___redArg___lam__1(
    ...
    leanh::lean_ctor_set(v___x_105_, 0, v_a_104_);
    leanh::lean_ctor_set(v___x_105_, 1, v_x_102_);
    v___x_106_ = l_List_reverse___redArg(v___x_105_);
    v___x_107_ = leanh::lean_apply_1(v_f_103_, v___x_106_);
    return v___x_107_;
}
pub unsafe fn l___private_Init_Task_0__Task_mapList_go___redArg___lam__2___boxed(
    ...
    mut v_prio_110_: *mut leanh::LeanObject,
    mut v_sync_111_: *mut leanh::LeanObject,
    mut v_tail_112_: *mut leanh::LeanObject,
    mut v_a_113_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_sync_boxed_114_: u8 = 0;
    let mut v_res_115_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_sync_boxed_114_ = (leanh::lean_unbox(v_sync_111_) as u8);
...
pub unsafe fn l___private_Init_Task_0__Task_mapList_go___redArg(
    mut v_f_116_: *mut leanh::LeanObject,
    mut v_prio_117_: *mut leanh::LeanObject,
    mut v_sync_118_: u8,
    ...
    if leanh::lean_obj_tag(v_x_119_) == 0 {
        if v_sync_118_ == 0 {
            ...
            leanh::lean_closure_set(v___f_121_, 0, v_x_120_);
            leanh::lean_closure_set(v___f_121_, 1, v_f_116_);
            ...
            leanh::lean_dec(v_prio_117_);
            v___x_123_ = l_List_reverse___redArg(v_x_120_);
            v___x_124_ = leanh::lean_apply_1(v_f_116_, v___x_123_);
            v___x_125_ = lean_task_pure(v___x_124_);
            return v___x_125_;
        }
    } else {
        let mut v_tail_126_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_tail_126_ = leanh::lean_ctor_get(v_x_119_, 1);
        if leanh::lean_obj_tag(v_tail_126_) == 0 {
            let mut v_head_127_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___f_128_: *mut leanh::LeanObject = core::ptr::null_mut();
            let mut v___x_129_: *mut leanh::LeanObject = core::ptr::null_mut();
            v_head_127_ = leanh::lean_ctor_get(v_x_119_, 0);
            leanh::lean_inc(v_head_127_);
            ...
            leanh::lean_closure_set(v___f_128_, 0, v_x_120_);
            leanh::lean_closure_set(v___f_128_, 1, v_f_116_);
            v___x_129_ = lean_task_map(v___f_128_, v_head_127_, v_prio_117_, v_sync_118_);
            return v___x_129_;
        } else {
            let mut v_head_130_: *mut leanh::LeanObject = core::ptr::null_mut();
            ...
            v_head_130_ = leanh::lean_ctor_get(v_x_119_, 0);
            leanh::lean_inc(v_head_130_);
            leanh::lean_dec_ref_known(v_x_119_, 2);
            v___x_131_ = leanh::lean_box((v_sync_118_) as usize);
            leanh::lean_inc(v_prio_117_);
            v___f_132_ = leanh::lean_alloc_closure(
                l___private_Init_Task_0__Task_mapList_go___redArg___lam__2___boxed
                    as *mut core::ffi::c_void,
                6,
                5,
            );
            leanh::lean_closure_set(v___f_132_, 0, v_x_120_);
            leanh::lean_closure_set(v___f_132_, 1, v_f_116_);
            leanh::lean_closure_set(v___f_132_, 2, v_prio_117_);
            leanh::lean_closure_set(v___f_132_, 3, v___x_131_);
            leanh::lean_closure_set(v___f_132_, 4, v_tail_126_);
...
pub unsafe fn l___private_Init_Task_0__Task_mapList_go___redArg___lam__2(
    ...
    mut v_prio_136_: *mut leanh::LeanObject,
    mut v_sync_137_: u8,
    mut v_tail_138_: *mut leanh::LeanObject,
    ...
    v___x_140_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_140_, 0, v_a_139_);
    leanh::lean_ctor_set(v___x_140_, 1, v_x_134_);
...
pub unsafe fn l___private_Init_Task_0__Task_mapList_go___redArg___boxed(
    mut v_f_142_: *mut leanh::LeanObject,
    mut v_prio_143_: *mut leanh::LeanObject,
    mut v_sync_144_: *mut leanh::LeanObject,
    mut v_x_145_: *mut leanh::LeanObject,
    mut v_x_146_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_sync_boxed_147_: u8 = 0;
    let mut v_res_148_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_sync_boxed_147_ = (leanh::lean_unbox(v_sync_144_) as u8);
...
pub unsafe fn l___private_Init_Task_0__Task_mapList_go(
    ...
    mut v_prio_152_: *mut leanh::LeanObject,
    mut v_sync_153_: u8,
...
pub unsafe fn l___private_Init_Task_0__Task_mapList_go___boxed(
    ...
    mut v_00_u03b2_158_: *mut leanh::LeanObject,
    mut v_f_159_: *mut leanh::LeanObject,
    mut v_prio_160_: *mut leanh::LeanObject,
    mut v_sync_161_: *mut leanh::LeanObject,
    ...
    v_sync_boxed_164_ = (leanh::lean_unbox(v_sync_161_) as u8);
...
pub unsafe fn l_Task_mapList___redArg(
    ...
    mut v_tasks_167_: *mut leanh::LeanObject,
    mut v_prio_168_: *mut leanh::LeanObject,
    mut v_sync_169_: u8,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Task_mapList___redArg___boxed(
    ...
    mut v_tasks_173_: *mut leanh::LeanObject,
    mut v_prio_174_: *mut leanh::LeanObject,
    mut v_sync_175_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_sync_boxed_176_: u8 = 0;
    let mut v_res_177_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_sync_boxed_176_ = (leanh::lean_unbox(v_sync_175_) as u8);
...
pub unsafe fn l_Task_mapList(
    ...
    mut v_tasks_181_: *mut leanh::LeanObject,
    mut v_prio_182_: *mut leanh::LeanObject,
    mut v_sync_183_: u8,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Task_mapList___boxed(
    ...
    mut v_tasks_188_: *mut leanh::LeanObject,
    mut v_prio_189_: *mut leanh::LeanObject,
    mut v_sync_190_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_sync_boxed_191_: u8 = 0;
    let mut v_res_192_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_sync_boxed_191_ = (leanh::lean_unbox(v_sync_190_) as u8);
...
pub unsafe fn runtime_initialize_Init_Task(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Task(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Task(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
