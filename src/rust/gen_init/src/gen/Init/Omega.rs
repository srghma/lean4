...
// Module: Init.Omega
// Imports: Init.Omega.Int Init.Omega.IntList Init.Omega.LinearCombo Init.Omega.Constraint Init.Omega.Logic Init.Data.Int.Lemmas Init.Data.Int.Order Init.Data.Nat.Order Init.Data.Order.Lemmas
...
use crate::r#gen::Init::Omega::Constraint::{
    initialize_Init_Omega_Constraint, runtime_initialize_Init_Omega_Constraint,
};
...
use crate::r#gen::Init::Omega::IntList::{
    initialize_Init_Omega_IntList, runtime_initialize_Init_Omega_IntList,
};
use crate::r#gen::Init::Omega::LinearCombo::{
    initialize_Init_Omega_LinearCombo, runtime_initialize_Init_Omega_LinearCombo,
};
use crate::r#gen::Init::Omega::Logic::{
    initialize_Init_Omega_Logic, runtime_initialize_Init_Omega_Logic,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Omega(builtin: u8) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_dec_ref(res);
    res = runtime_initialize_Init_Omega_Logic(builtin);
    if crate::leanh::lean_io_result_is_error(res) {
        return res;
    }
    crate::leanh::lean_dec_ref(res);
...
pub unsafe fn meta_initialize_Init_Omega(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Omega(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
    ...
    crate::leanh::lean_dec_ref(res);
    res = meta_initialize_Init_Omega(builtin);
    if crate::leanh::lean_io_result_is_error(res) {
        return res;
    }
    crate::leanh::lean_dec_ref(res);
    return initialize_Init_Omega(builtin);
}
