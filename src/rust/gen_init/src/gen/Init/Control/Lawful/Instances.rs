...
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__ExceptT_bindCont_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_152_) == 0 {
        ...
        v_a_155_ = leanh::lean_ctor_get(v_x_152_, 0);
        leanh::lean_inc(v_a_155_);
        leanh::lean_dec_ref_known(v_x_152_, 1);
        ...
        v_a_157_ = leanh::lean_ctor_get(v_x_152_, 0);
...
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__ExceptT_bindCont_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_162_) == 0 {
        ...
        v_a_165_ = leanh::lean_ctor_get(v_x_162_, 0);
        leanh::lean_inc(v_a_165_);
        leanh::lean_dec_ref_known(v_x_162_, 1);
        v___x_166_ = leanh::lean_apply_1(v_h__2_164_, v_a_165_);
        return v___x_166_;
    } else {
        ...
        v_a_167_ = leanh::lean_ctor_get(v_x_162_, 0);
        leanh::lean_inc(v_a_167_);
        leanh::lean_dec_ref_known(v_x_162_, 1);
        v___x_168_ = leanh::lean_apply_1(v_h__1_163_, v_a_167_);
        return v___x_168_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__ExceptT_run__bind_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_169_) == 0 {
        let mut v_a_172_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_173_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_170_);
        v_a_172_ = leanh::lean_ctor_get(v_x_169_, 0);
        leanh::lean_inc(v_a_172_);
        leanh::lean_dec_ref_known(v_x_169_, 1);
        v___x_173_ = leanh::lean_apply_1(v_h__2_171_, v_a_172_);
        return v___x_173_;
    } else {
        ...
        v_a_174_ = leanh::lean_ctor_get(v_x_169_, 0);
        leanh::lean_inc(v_a_174_);
        leanh::lean_dec_ref_known(v_x_169_, 1);
        v___x_175_ = leanh::lean_apply_1(v_h__1_170_, v_a_174_);
        return v___x_175_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__ExceptT_run__bind_match__1_splitter(
    mut v_00_u03b5_176_: *mut leanh::LeanObject,
    ...
    if leanh::lean_obj_tag(v_x_179_) == 0 {
        ...
        v_a_182_ = leanh::lean_ctor_get(v_x_179_, 0);
        leanh::lean_inc(v_a_182_);
        leanh::lean_dec_ref_known(v_x_179_, 1);
        v___x_183_ = leanh::lean_apply_1(v_h__2_181_, v_a_182_);
        return v___x_183_;
    } else {
        let mut v_a_184_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_185_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_181_);
        v_a_184_ = leanh::lean_ctor_get(v_x_179_, 0);
        leanh::lean_inc(v_a_184_);
        leanh::lean_dec_ref_known(v_x_179_, 1);
        v___x_185_ = leanh::lean_apply_1(v_h__1_180_, v_a_184_);
        return v___x_185_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__OptionT_bind_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_____do__lift_186_) == 0 {
        ...
        v___x_190_ = leanh::lean_apply_1(v_h__2_188_, v___x_189_);
        return v___x_190_;
    } else {
        ...
        v___x_192_ = leanh::lean_apply_1(v_h__1_187_, v_val_191_);
        return v___x_192_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__OptionT_bind_match__1_splitter(
    ...
    mut v_____do__lift_195_: *mut leanh::LeanObject,
    mut v_h__1_196_: *mut leanh::LeanObject,
    mut v_h__2_197_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_____do__lift_195_) == 0 {
        let mut v___x_198_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_199_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_196_);
        v___x_198_ = leanh::lean_box(0);
        v___x_199_ = leanh::lean_apply_1(v_h__2_197_, v___x_198_);
        return v___x_199_;
    } else {
        let mut v_val_200_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_201_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__2_197_);
        v_val_200_ = leanh::lean_ctor_get(v_____do__lift_195_, 0);
        leanh::lean_inc(v_val_200_);
        leanh::lean_dec_ref_known(v_____do__lift_195_, 1);
        v___x_201_ = leanh::lean_apply_1(v_h__1_196_, v_val_200_);
        return v___x_201_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__Option_getD_match__1_splitter___redArg(
    mut v_opt_202_: *mut leanh::LeanObject,
    mut v_h__1_203_: *mut leanh::LeanObject,
    mut v_h__2_204_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    if leanh::lean_obj_tag(v_opt_202_) == 0 {
        ...
        v___x_206_ = leanh::lean_apply_1(v_h__2_204_, v___x_205_);
        return v___x_206_;
    } else {
        ...
        v_val_207_ = leanh::lean_ctor_get(v_opt_202_, 0);
        leanh::lean_inc(v_val_207_);
        leanh::lean_dec_ref_known(v_opt_202_, 1);
        v___x_208_ = leanh::lean_apply_1(v_h__1_203_, v_val_207_);
        return v___x_208_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__Option_getD_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_opt_211_) == 0 {
        ...
        v___x_215_ = leanh::lean_apply_1(v_h__2_213_, v___x_214_);
        return v___x_215_;
    } else {
        ...
        v_val_216_ = leanh::lean_ctor_get(v_opt_211_, 0);
        leanh::lean_inc(v_val_216_);
        leanh::lean_dec_ref_known(v_opt_211_, 1);
        v___x_217_ = leanh::lean_apply_1(v_h__1_212_, v_val_216_);
        return v___x_217_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__Option_elim_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_218_) == 0 {
        ...
        v___x_223_ = leanh::lean_apply_2(v_h__2_222_, v_x_219_, v_x_220_);
        return v___x_223_;
    } else {
        ...
        v_val_224_ = leanh::lean_ctor_get(v_x_218_, 0);
        leanh::lean_inc(v_val_224_);
        leanh::lean_dec_ref_known(v_x_218_, 1);
        v___x_225_ = leanh::lean_apply_3(v_h__1_221_, v_val_224_, v_x_219_, v_x_220_);
        return v___x_225_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__Option_elim_match__1_splitter(
    ...
    if leanh::lean_obj_tag(v_x_229_) == 0 {
        let mut v___x_234_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_232_);
        v___x_234_ = leanh::lean_apply_2(v_h__2_233_, v_x_230_, v_x_231_);
        return v___x_234_;
    } else {
        ...
        v_val_235_ = leanh::lean_ctor_get(v_x_229_, 0);
        leanh::lean_inc(v_val_235_);
        leanh::lean_dec_ref_known(v_x_229_, 1);
        v___x_236_ = leanh::lean_apply_3(v_h__1_232_, v_val_235_, v_x_230_, v_x_231_);
        return v___x_236_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__EStateM_adaptExcept_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_237_) == 0 {
        ...
        v_a_240_ = leanh::lean_ctor_get(v_x_237_, 0);
        leanh::lean_inc(v_a_240_);
        v_a_241_ = leanh::lean_ctor_get(v_x_237_, 1);
        leanh::lean_inc(v_a_241_);
        leanh::lean_dec_ref_known(v_x_237_, 2);
        v___x_242_ = leanh::lean_apply_2(v_h__2_239_, v_a_240_, v_a_241_);
        return v___x_242_;
    } else {
        ...
        v_a_243_ = leanh::lean_ctor_get(v_x_237_, 0);
        leanh::lean_inc(v_a_243_);
        v_a_244_ = leanh::lean_ctor_get(v_x_237_, 1);
        leanh::lean_inc(v_a_244_);
        leanh::lean_dec_ref_known(v_x_237_, 2);
        v___x_245_ = leanh::lean_apply_2(v_h__1_238_, v_a_243_, v_a_244_);
        return v___x_245_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__EStateM_adaptExcept_match__1_splitter(
    mut v_00_u03b5_246_: *mut leanh::LeanObject,
    mut v_00_u03c3_247_: *mut leanh::LeanObject,
    ...
    if leanh::lean_obj_tag(v_x_250_) == 0 {
        ...
        let mut v_a_254_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_255_: *mut leanh::LeanObject = core::ptr::null_mut();
        leanh::lean_dec(v_h__1_251_);
        v_a_253_ = leanh::lean_ctor_get(v_x_250_, 0);
        leanh::lean_inc(v_a_253_);
        v_a_254_ = leanh::lean_ctor_get(v_x_250_, 1);
        leanh::lean_inc(v_a_254_);
        leanh::lean_dec_ref_known(v_x_250_, 2);
        v___x_255_ = leanh::lean_apply_2(v_h__2_252_, v_a_253_, v_a_254_);
        return v___x_255_;
    } else {
        ...
        v_a_256_ = leanh::lean_ctor_get(v_x_250_, 0);
        leanh::lean_inc(v_a_256_);
        v_a_257_ = leanh::lean_ctor_get(v_x_250_, 1);
        leanh::lean_inc(v_a_257_);
        leanh::lean_dec_ref_known(v_x_250_, 2);
        v___x_258_ = leanh::lean_apply_2(v_h__1_251_, v_a_256_, v_a_257_);
        return v___x_258_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__EStateM_run__bind_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_259_) == 0 {
        ...
        v_a_262_ = leanh::lean_ctor_get(v_x_259_, 0);
        leanh::lean_inc(v_a_262_);
        v_a_263_ = leanh::lean_ctor_get(v_x_259_, 1);
        leanh::lean_inc(v_a_263_);
        leanh::lean_dec_ref_known(v_x_259_, 2);
        v___x_264_ = leanh::lean_apply_2(v_h__1_260_, v_a_262_, v_a_263_);
        return v___x_264_;
    } else {
        ...
        v_a_265_ = leanh::lean_ctor_get(v_x_259_, 0);
        leanh::lean_inc(v_a_265_);
        v_a_266_ = leanh::lean_ctor_get(v_x_259_, 1);
        leanh::lean_inc(v_a_266_);
        leanh::lean_dec_ref_known(v_x_259_, 2);
        v___x_267_ = leanh::lean_apply_2(v_h__2_261_, v_a_265_, v_a_266_);
        return v___x_267_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__EStateM_run__bind_match__1_splitter(
    mut v_00_u03b5_268_: *mut leanh::LeanObject,
    ...
    if leanh::lean_obj_tag(v_x_272_) == 0 {
        ...
        v_a_275_ = leanh::lean_ctor_get(v_x_272_, 0);
        leanh::lean_inc(v_a_275_);
        v_a_276_ = leanh::lean_ctor_get(v_x_272_, 1);
        leanh::lean_inc(v_a_276_);
        leanh::lean_dec_ref_known(v_x_272_, 2);
        v___x_277_ = leanh::lean_apply_2(v_h__1_273_, v_a_275_, v_a_276_);
        return v___x_277_;
    } else {
        ...
        v_a_278_ = leanh::lean_ctor_get(v_x_272_, 0);
        leanh::lean_inc(v_a_278_);
        v_a_279_ = leanh::lean_ctor_get(v_x_272_, 1);
        leanh::lean_inc(v_a_279_);
        leanh::lean_dec_ref_known(v_x_272_, 2);
        v___x_280_ = leanh::lean_apply_2(v_h__2_274_, v_a_278_, v_a_279_);
        return v___x_280_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__EStateM_bind_match__1_splitter___redArg(
    ...
    if leanh::lean_obj_tag(v_x_281_) == 0 {
        ...
        v_a_284_ = leanh::lean_ctor_get(v_x_281_, 0);
        leanh::lean_inc(v_a_284_);
        v_a_285_ = leanh::lean_ctor_get(v_x_281_, 1);
        leanh::lean_inc(v_a_285_);
        leanh::lean_dec_ref_known(v_x_281_, 2);
        v___x_286_ = leanh::lean_apply_2(v_h__1_282_, v_a_284_, v_a_285_);
        return v___x_286_;
    } else {
        let mut v_a_287_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        v_a_287_ = leanh::lean_ctor_get(v_x_281_, 0);
        leanh::lean_inc(v_a_287_);
        v_a_288_ = leanh::lean_ctor_get(v_x_281_, 1);
        leanh::lean_inc(v_a_288_);
        leanh::lean_dec_ref_known(v_x_281_, 2);
        v___x_289_ = leanh::lean_apply_2(v_h__2_283_, v_a_287_, v_a_288_);
        return v___x_289_;
    }
}
pub unsafe fn l___private_Init_Control_Lawful_Instances_0__EStateM_bind_match__1_splitter(
    mut v_00_u03b5_290_: *mut leanh::LeanObject,
    ...
    if leanh::lean_obj_tag(v_x_294_) == 0 {
        ...
        v_a_297_ = leanh::lean_ctor_get(v_x_294_, 0);
        leanh::lean_inc(v_a_297_);
        v_a_298_ = leanh::lean_ctor_get(v_x_294_, 1);
        leanh::lean_inc(v_a_298_);
        leanh::lean_dec_ref_known(v_x_294_, 2);
        v___x_299_ = leanh::lean_apply_2(v_h__1_295_, v_a_297_, v_a_298_);
        return v___x_299_;
    } else {
        ...
        v_a_300_ = leanh::lean_ctor_get(v_x_294_, 0);
        leanh::lean_inc(v_a_300_);
        v_a_301_ = leanh::lean_ctor_get(v_x_294_, 1);
        leanh::lean_inc(v_a_301_);
        leanh::lean_dec_ref_known(v_x_294_, 2);
        v___x_302_ = leanh::lean_apply_2(v_h__2_296_, v_a_300_, v_a_301_);
        return v___x_302_;
    }
}
