...
pub static l_instSizeOfDefault___closed__0_value: leanh::LeanClosureObject<1> =
...
static mut l_instSizeOfDefault___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_instSizeOfDefault___closed__0_value) as *mut leanh::LeanObject;
pub static l_instSizeOfNat___closed__0_value: leanh::LeanClosureObject<0> =
    leanh::LeanClosureObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<leanh::LeanObject>()
...
static mut l_instSizeOfNat___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_instSizeOfNat___closed__0_value) as *mut leanh::LeanObject;
pub static mut l_instSizeOfNat: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_instSizeOfNat___closed__0_value) as *mut leanh::LeanObject;
pub unsafe fn l_default_sizeOf(
    ...
    v___x_27_ = leanh::lean_unsigned_to_nat(0);
    return v___x_27_;
}
pub unsafe fn l_default_sizeOf___boxed(
    mut v_00_u03b1_28_: *mut leanh::LeanObject,
...
pub unsafe fn l_instSizeOfForallUnit___redArg___lam__0(
    ...
    v___x_42_ = leanh::lean_apply_1(v_f_40_, v___x_41_);
    v___x_43_ = leanh::lean_apply_1(v_inst_39_, v___x_42_);
    return v___x_43_;
}
...
pub unsafe fn l_instSizeOfForallUnit(
    ...
    let mut v___f_48_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___f_48_ = leanh::lean_alloc_closure(
        l_instSizeOfForallUnit___redArg___lam__0 as *mut core::ffi::c_void,
        2,
        1,
    );
    leanh::lean_closure_set(v___f_48_, 0, v_inst_47_);
    return v___f_48_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_SizeOf(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_SizeOf(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_SizeOf(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
