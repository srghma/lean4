...
pub unsafe fn runtime_initialize_Init_Grind_Ring_OfScientific(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Grind_Ring_OfScientific(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Grind_Ring_OfScientific(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
