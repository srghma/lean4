...
pub unsafe fn l_Lean_Grind_IntModule_toNatModule___redArg(
    mut v_I_14_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_toAddCommGroup_15_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_nsmul_16_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_toAddCommMonoid_17_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_18_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_toAddCommGroup_15_ = leanh::lean_ctor_get(v_I_14_, 0);
    v_nsmul_16_ = leanh::lean_ctor_get(v_I_14_, 1);
    v_toAddCommMonoid_17_ = leanh::lean_ctor_get(v_toAddCommGroup_15_, 0);
    leanh::lean_inc(v_nsmul_16_);
    leanh::lean_inc_ref(v_toAddCommMonoid_17_);
    v___x_18_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
    leanh::lean_ctor_set(v___x_18_, 0, v_toAddCommMonoid_17_);
    leanh::lean_ctor_set(v___x_18_, 1, v_nsmul_16_);
    return v___x_18_;
}
pub unsafe fn l_Lean_Grind_IntModule_toNatModule___redArg___boxed(
    mut v_I_19_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_20_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_20_ = l_Lean_Grind_IntModule_toNatModule___redArg(v_I_19_);
    leanh::lean_dec_ref(v_I_19_);
    return v_res_20_;
}
pub unsafe fn l_Lean_Grind_IntModule_toNatModule(
    mut v_M_21_: *mut leanh::LeanObject,
    mut v_I_22_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn initialize_Init_Grind_Module_Basic(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
