...
pub unsafe fn l_Lean_Grind_Fin_npow___redArg(
    ...
    mut v_y_74_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Grind_Fin_npow___boxed(
    ...
    mut v_y_91_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_y_91_);
    return v_res_92_;
}
pub unsafe fn l_Lean_Grind_Fin_instHPowFinNatOfNeZero___redArg(
    mut v_n_93_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_94_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_94_ = leanh::lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___x_94_, 0, v_n_93_);
    leanh::lean_closure_set(v___x_94_, 1, leanh::lean_box(0));
    return v___x_94_;
}
pub unsafe fn l_Lean_Grind_Fin_instHPowFinNatOfNeZero(
    mut v_n_95_: *mut leanh::LeanObject,
    mut v_inst_96_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_97_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_97_ = leanh::lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___x_97_, 0, v_n_95_);
    leanh::lean_closure_set(v___x_97_, 1, leanh::lean_box(0));
    return v___x_97_;
}
pub unsafe fn l_Lean_Grind_Fin_instPowFinNatOfNeZero___redArg(
    ...
    v___x_99_ = leanh::lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___x_99_, 0, v_n_98_);
    leanh::lean_closure_set(v___x_99_, 1, leanh::lean_box(0));
    return v___x_99_;
}
pub unsafe fn l_Lean_Grind_Fin_instPowFinNatOfNeZero(
    mut v_n_100_: *mut leanh::LeanObject,
    mut v_inst_101_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_102_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_102_ = leanh::lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___x_102_, 0, v_n_100_);
    leanh::lean_closure_set(v___x_102_, 1, leanh::lean_box(0));
    return v___x_102_;
}
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__0(
    mut v_n_103_: *mut leanh::LeanObject,
    mut v_n_104_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__0___boxed(
    ...
    leanh::lean_dec(v_n_106_);
    return v_res_108_;
}
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__1(
    mut v_n_109_: *mut leanh::LeanObject,
    mut v_k_110_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__1___boxed(
    ...
    mut v_k_115_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_k_115_);
    leanh::lean_dec(v_n_114_);
    return v_res_117_;
}
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__2(
    mut v_n_118_: *mut leanh::LeanObject,
    mut v_k_119_: *mut leanh::LeanObject,
    mut v_i_120_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg(
    ...
    let mut v___f_129_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___f_130_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_131_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_132_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___f_133_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    leanh::lean_closure_set(v___f_128_, 0, v_n_127_);
    v___f_129_ = leanh::lean_alloc_closure(
        l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__1___boxed
            as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_129_, 0, v_n_127_);
    v___f_130_ = leanh::lean_alloc_closure(
        l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__2___boxed
            as *mut core::ffi::c_void,
        3,
        1,
    );
    leanh::lean_closure_set(v___f_130_, 0, v_n_127_);
    v___x_131_ =
        leanh::lean_alloc_closure(l_Fin_add___boxed as *mut core::ffi::c_void, 3, 1);
    leanh::lean_closure_set(v___x_131_, 0, v_n_127_);
    v___x_132_ =
        leanh::lean_alloc_closure(l_Fin_mul___boxed as *mut core::ffi::c_void, 3, 1);
    leanh::lean_closure_set(v___x_132_, 0, v_n_127_);
    v___f_133_ = leanh::lean_alloc_closure(
        l_Fin_NatCast_instNatCast___redArg___lam__0___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    leanh::lean_closure_set(v___f_133_, 0, v_n_127_);
    v___f_134_ = leanh::lean_alloc_closure(
        l_Fin_neg___lam__0___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    leanh::lean_closure_set(v___f_134_, 0, v_n_127_);
    v___x_135_ =
        leanh::lean_alloc_closure(l_Fin_sub___boxed as *mut core::ffi::c_void, 3, 1);
    leanh::lean_closure_set(v___x_135_, 0, v_n_127_);
    v___x_136_ = leanh::lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    leanh::lean_closure_set(v___x_136_, 0, v_n_127_);
    leanh::lean_closure_set(v___x_136_, 1, leanh::lean_box(0));
    v___x_137_ = leanh::lean_alloc_ctor(0, 6, (0) as u32);
    leanh::lean_ctor_set(v___x_137_, 0, v___x_131_);
    leanh::lean_ctor_set(v___x_137_, 1, v___x_132_);
    leanh::lean_ctor_set(v___x_137_, 2, v___f_133_);
    leanh::lean_ctor_set(v___x_137_, 3, v___f_128_);
    leanh::lean_ctor_set(v___x_137_, 4, v___f_129_);
    leanh::lean_ctor_set(v___x_137_, 5, v___x_136_);
    v___x_138_ =
        leanh::lean_alloc_closure(l_Fin_intCast___boxed as *mut core::ffi::c_void, 3, 2);
    leanh::lean_closure_set(v___x_138_, 0, v_n_127_);
    leanh::lean_closure_set(v___x_138_, 1, leanh::lean_box(0));
    v___x_139_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
    leanh::lean_ctor_set(v___x_139_, 0, v___x_137_);
    leanh::lean_ctor_set(v___x_139_, 1, v___f_134_);
    leanh::lean_ctor_set(v___x_139_, 2, v___x_135_);
    leanh::lean_ctor_set(v___x_139_, 3, v___x_138_);
    leanh::lean_ctor_set(v___x_139_, 4, v___f_130_);
    return v___x_139_;
}
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat(
    mut v_n_140_: *mut leanh::LeanObject,
