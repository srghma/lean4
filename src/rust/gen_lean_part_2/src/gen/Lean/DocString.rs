...
pub unsafe fn l_Lean_findDocString_x3f(
    mut v_env_38_: *mut leanh::LeanObject,
    mut v_declName_39_: *mut leanh::LeanObject,
    mut v_includeBuiltin_40_: u8,
) -> *mut leanh::LeanObject {
    let mut v___y_43_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_exts_44_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_spellings_45_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                leanh::lean_inc(v_declName_39_);
                leanh::lean_inc_ref(v_env_38_);
                v___x_67_ = l_Lean_Parser_Tactic_Doc_alternativeOfTactic(v_env_38_, v_declName_39_);
                if leanh::lean_obj_tag(v___x_67_) == 0 {
                    v___y_43_ = v_declName_39_;
                    state = 1;
                    continue;
                } else {
                    leanh::lean_dec(v_declName_39_);
                    v_val_68_ = leanh::lean_ctor_get(v___x_67_, 0);
                    leanh::lean_inc(v_val_68_);
                    leanh::lean_dec_ref_known(v___x_67_, 1);
                    v___y_43_ = v_val_68_;
                    state = 1;
                    continue;
                }
            ...
            1 => {
                leanh::lean_inc_n(v___y_43_, 2);
                leanh::lean_inc_ref_n(v_env_38_, 2);
                v_exts_44_ =
                ...
                if leanh::lean_obj_tag(v___x_46_) == 0 {
                    v_a_47_ = leanh::lean_ctor_get(v___x_46_, 0);
                    leanh::lean_inc(v_a_47_);
                    if leanh::lean_obj_tag(v_a_47_) == 0 {
                        leanh::lean_dec_ref(v_spellings_45_);
                        leanh::lean_dec_ref(v_exts_44_);
                        return v___x_46_;
                    } else {
                        v_isSharedCheck_65_ = (!leanh::lean_is_exclusive(v___x_46_)) as u8;
                        if v_isSharedCheck_65_ == 0 {
                            v_unused_66_ = leanh::lean_ctor_get(v___x_46_, 0);
            ...
            2 => {
                v_val_51_ = leanh::lean_ctor_get(v_a_47_, 0);
                v_isSharedCheck_64_ = (!leanh::lean_is_exclusive(v_a_47_)) as u8;
            ...
            3 => {
                ...
                if v_isShared_54_ == 0 {
                    leanh::lean_ctor_set(v___x_53_, 0, v___x_57_);
                    v___x_59_ = v___x_53_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_63_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_63_, 0, v___x_57_);
            ...
            4 => {
                if v_isShared_50_ == 0 {
                    leanh::lean_ctor_set(v___x_49_, 0, v___x_59_);
                    v___x_61_ = v___x_49_;
                    state = 5;
                    continue;
                } else {
                    v_reuseFailAlloc_62_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_62_, 0, v___x_59_);
...
pub unsafe fn l_Lean_findDocString_x3f___boxed(
    mut v_env_69_: *mut leanh::LeanObject,
    mut v_declName_70_: *mut leanh::LeanObject,
    mut v_includeBuiltin_71_: *mut leanh::LeanObject,
    mut v_a_72_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_includeBuiltin_boxed_73_: u8 = 0;
    let mut v_res_74_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_includeBuiltin_boxed_73_ = (leanh::lean_unbox(v_includeBuiltin_71_) as u8);
    v_res_74_ = l_Lean_findDocString_x3f(v_env_69_, v_declName_70_, v_includeBuiltin_boxed_73_);
    return v_res_74_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lean_DocString(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_DocString(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_DocString(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
