...
use crate::ffi::{lean_infer_type, lean_nat_dec_eq};
...
pub static l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_boolAtom___closed__4_value:
    ...
    m_objs: [
        ...
        core::ptr::addr_of!(l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_boolAtom___closed__3_value)
            as *mut leanh::LeanObject,
        17737472716185871225 as *mut leanh::LeanObject,
    ],
};
...
static mut l___private_Lean_Meta_Tactic_BVDecide_Reflect_ReifiedBVPred_0__Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred_congrThmOfBinPred___closed__2: *mut leanh::LeanObject = core::ptr::addr_of!(l___private_Lean_Meta_Tactic_BVDecide_Reflect_ReifiedBVPred_0__Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred_congrThmOfBinPred___closed__2_value) as *mut leanh::LeanObject;
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_boolAtom___lam__0(
    mut v_width_529_: *mut leanh::LeanObject,
    mut v_expr_530_: *mut leanh::LeanObject,
    mut v_a_531_: *mut leanh::LeanObject,
    mut v___x_532_: *mut leanh::LeanObject,
    mut v___x_533_: *mut leanh::LeanObject,
    mut v___x_534_: *mut leanh::LeanObject,
    mut v___x_535_: *mut leanh::LeanObject,
    mut v___x_536_: *mut leanh::LeanObject,
    mut v_origExpr_537_: *mut leanh::LeanObject,
    ...
    let mut v_val_563_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_544_) == 0 {
                    v_a_545_ = leanh::lean_ctor_get(v___x_544_, 0);
                    leanh::lean_inc(v_a_545_);
                    leanh::lean_dec_ref_known(v___x_544_, 1);
                    ...
                    if leanh::lean_obj_tag(v___x_546_) == 0 {
                        v_a_547_ = leanh::lean_ctor_get(v___x_546_, 0);
                        v_isSharedCheck_564_ = (!leanh::lean_is_exclusive(v___x_546_)) as u8;
                        ...
                        leanh::lean_dec(v_a_545_);
                        leanh::lean_dec_ref(v_origExpr_537_);
                        leanh::lean_dec(v___x_536_);
                        leanh::lean_dec_ref(v___x_535_);
                        leanh::lean_dec_ref(v___x_534_);
                        leanh::lean_dec_ref(v___x_533_);
                        leanh::lean_dec_ref(v___x_532_);
                        leanh::lean_dec(v_width_529_);
                        return v___x_546_;
                    }
                } else {
                    leanh::lean_dec_ref(v_origExpr_537_);
                    ...
                    leanh::lean_dec(v_width_529_);
                    v_a_565_ = leanh::lean_ctor_get(v___x_544_, 0);
                    v_isSharedCheck_572_ = (!leanh::lean_is_exclusive(v___x_544_)) as u8;
            ...
            1 => {
                if leanh::lean_obj_tag(v_a_547_) == 0 {
                    leanh::lean_inc(v_a_545_);
                    v___x_562_ =
                    ...
                    leanh::lean_dec(v_width_529_);
                    v_val_563_ = leanh::lean_ctor_get(v_a_547_, 0);
                    leanh::lean_inc(v_val_563_);
                    leanh::lean_dec_ref_known(v_a_547_, 1);
            ...
            2 => {
                ...
                if v_isShared_550_ == 0 {
                    leanh::lean_ctor_set(v___x_549_, 0, v___x_558_);
                    v___x_560_ = v___x_549_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_561_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
            ...
            4 => {
                if v_isShared_568_ == 0 {
                    ...
                    v_reuseFailAlloc_571_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_571_, 0, v_a_565_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_boolAtom___lam__0___boxed(
    mut v_width_573_: *mut leanh::LeanObject,
    mut v_expr_574_: *mut leanh::LeanObject,
    ...
    mut v___x_579_: *mut leanh::LeanObject,
    mut v___x_580_: *mut leanh::LeanObject,
    mut v_origExpr_581_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_boolAtom(
    mut v_origExpr_618_: *mut leanh::LeanObject,
    ...
    let mut v_width_648_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_bvExpr_649_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_650_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                leanh::lean_inc_ref(v_a_622_);
                leanh::lean_inc(v_a_621_);
                leanh::lean_inc_ref(v_a_620_);
                leanh::lean_inc_ref(v_origExpr_618_);
                v___x_625_ =
                ...
                if leanh::lean_obj_tag(v___x_625_) == 0 {
                    ...
                    v_isSharedCheck_675_ = (!leanh::lean_is_exclusive(v___x_625_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_origExpr_618_);
                    v_a_676_ = leanh::lean_ctor_get(v___x_625_, 0);
                    v_isSharedCheck_683_ = (!leanh::lean_is_exclusive(v___x_625_)) as u8;
            ...
            1 => {
                ...
                if v___x_632_ == 0 {
                    ...
                    if v_isShared_629_ == 0 {
                        leanh::lean_ctor_set(v___x_628_, 0, v___x_633_);
                        v___x_635_ = v___x_628_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_636_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_636_, 0, v___x_633_);
                        v___x_635_ = v_reuseFailAlloc_636_;
                        state = 2;
                        continue;
                    }
                } else {
                    leanh::lean_del_object(v___x_628_);
                    ...
                    if leanh::lean_obj_tag(v___x_643_) == 0 {
                        v_a_644_ = leanh::lean_ctor_get(v___x_643_, 0);
                        v_isSharedCheck_666_ = (!leanh::lean_is_exclusive(v___x_643_)) as u8;
                        ...
                        leanh::lean_dec_ref(v_origExpr_618_);
                        v_a_667_ = leanh::lean_ctor_get(v___x_643_, 0);
                        v_isSharedCheck_674_ = (!leanh::lean_is_exclusive(v___x_643_)) as u8;
            ...
            3 => {
                v_width_648_ = leanh::lean_ctor_get(v_a_644_, 0);
                leanh::lean_inc_n(v_width_648_, 2);
                v_bvExpr_649_ = leanh::lean_ctor_get(v_a_644_, 1);
                v_expr_650_ = leanh::lean_ctor_get(v_a_644_, 4);
                leanh::lean_inc_ref_n(v_expr_650_, 2);
                v___x_651_ = leanh::lean_unsigned_to_nat(0);
                leanh::lean_inc_ref(v_bvExpr_649_);
                v___x_652_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
                leanh::lean_ctor_set(v___x_652_, 0, v_width_648_);
                leanh::lean_ctor_set(v___x_652_, 1, v_bvExpr_649_);
                leanh::lean_ctor_set(v___x_652_, 2, v___x_651_);
                ...
                leanh::lean_inc_ref(v_origExpr_618_);
                v___f_656_ = leanh::lean_alloc_closure(
                    l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_boolAtom___lam__0___boxed
                        as *mut core::ffi::c_void,
                    15,
                    9,
                );
                leanh::lean_closure_set(v___f_656_, 0, v_width_648_);
                leanh::lean_closure_set(v___f_656_, 1, v_expr_650_);
                leanh::lean_closure_set(v___f_656_, 2, v_a_644_);
                leanh::lean_closure_set(v___f_656_, 3, v___x_653_);
                leanh::lean_closure_set(v___f_656_, 4, v___x_654_);
                leanh::lean_closure_set(v___f_656_, 5, v___x_655_);
                leanh::lean_closure_set(v___f_656_, 6, v___x_637_);
                leanh::lean_closure_set(v___f_656_, 7, v___x_638_);
                leanh::lean_closure_set(v___f_656_, 8, v_origExpr_618_);
                ...
                v___x_661_ = leanh::lean_alloc_ctor(0, 4, (0) as u32);
                leanh::lean_ctor_set(v___x_661_, 0, v___x_652_);
                leanh::lean_ctor_set(v___x_661_, 1, v_origExpr_618_);
                leanh::lean_ctor_set(v___x_661_, 2, v___f_656_);
                leanh::lean_ctor_set(v___x_661_, 3, v___x_660_);
                v___x_662_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                leanh::lean_ctor_set(v___x_662_, 0, v___x_661_);
                if v_isShared_647_ == 0 {
                    leanh::lean_ctor_set(v___x_646_, 0, v___x_662_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_boolAtom___boxed(
    mut v_origExpr_684_: *mut leanh::LeanObject,
...
pub unsafe fn l___private_Lean_Meta_Tactic_BVDecide_Reflect_ReifiedBVPred_0__Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred_congrThmOfBinPred___boxed(
    mut v_pred_711_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_pred_boxed_712_: u8 = 0;
    let mut v_res_713_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_pred_boxed_712_ = (leanh::lean_unbox(v_pred_711_) as u8);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_M_simplifyBinaryProof_x27___at___00Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred_spec__0(
    ...
    mut v_fst_715_: *mut leanh::LeanObject,
    mut v_fproof_716_: *mut leanh::LeanObject,
    mut v_snd_717_: *mut leanh::LeanObject,
    mut v_sproof_718_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_fproof_716_) == 0 {
                    leanh::lean_dec_ref(v_snd_717_);
                    if leanh::lean_obj_tag(v_sproof_718_) == 0 {
                        leanh::lean_dec_ref(v_fst_715_);
                        leanh::lean_dec(v___x_714_);
                        v___x_719_ = leanh::lean_box(0);
                        return v___x_719_;
                    } else {
                        v_val_720_ = leanh::lean_ctor_get(v_sproof_718_, 0);
                        v_isSharedCheck_729_ =
                            (!leanh::lean_is_exclusive(v_sproof_718_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_fst_715_);
                    if leanh::lean_obj_tag(v_sproof_718_) == 0 {
                        v_val_730_ = leanh::lean_ctor_get(v_fproof_716_, 0);
                        v_isSharedCheck_739_ =
                            (!leanh::lean_is_exclusive(v_fproof_716_)) as u8;
                        ...
                        leanh::lean_dec_ref(v_snd_717_);
                        leanh::lean_dec(v___x_714_);
                        v_val_740_ = leanh::lean_ctor_get(v_fproof_716_, 0);
                        leanh::lean_inc(v_val_740_);
                        leanh::lean_dec_ref_known(v_fproof_716_, 1);
                        v_val_741_ = leanh::lean_ctor_get(v_sproof_718_, 0);
            ...
            1 => {
                ...
                v___x_725_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_725_, 0, v___x_724_);
                leanh::lean_ctor_set(v___x_725_, 1, v_val_720_);
                if v_isShared_723_ == 0 {
                    leanh::lean_ctor_set(v___x_722_, 0, v___x_725_);
                    v___x_727_ = v___x_722_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_728_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
            ...
            3 => {
                ...
                leanh::lean_ctor_set(v___x_735_, 0, v_val_730_);
                leanh::lean_ctor_set(v___x_735_, 1, v___x_734_);
                if v_isShared_733_ == 0 {
                    leanh::lean_ctor_set(v___x_732_, 0, v___x_735_);
            ...
            5 => {
                ...
                leanh::lean_ctor_set(v___x_745_, 0, v_val_740_);
                leanh::lean_ctor_set(v___x_745_, 1, v_val_741_);
                if v_isShared_744_ == 0 {
                    ...
                    v_reuseFailAlloc_748_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred___redArg___lam__0(
    mut v_width_750_: *mut leanh::LeanObject,
    mut v_expr_751_: *mut leanh::LeanObject,
    mut v_width_752_: *mut leanh::LeanObject,
    mut v_expr_753_: *mut leanh::LeanObject,
    mut v_lhs_754_: *mut leanh::LeanObject,
    mut v_rhs_755_: *mut leanh::LeanObject,
    mut v_congrThm_756_: *mut leanh::LeanObject,
    mut v___x_757_: *mut leanh::LeanObject,
    mut v___x_758_: *mut leanh::LeanObject,
    mut v_lhsExpr_759_: *mut leanh::LeanObject,
    mut v_rhsExpr_760_: *mut leanh::LeanObject,
    ...
    let mut v_fst_783_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_784_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_767_) == 0 {
                    v_a_768_ = leanh::lean_ctor_get(v___x_767_, 0);
                    leanh::lean_inc(v_a_768_);
                    leanh::lean_dec_ref_known(v___x_767_, 1);
                    ...
                    if leanh::lean_obj_tag(v___x_769_) == 0 {
                        v_a_770_ = leanh::lean_ctor_get(v___x_769_, 0);
                        leanh::lean_inc(v_a_770_);
                        leanh::lean_dec_ref_known(v___x_769_, 1);
                        ...
                        if leanh::lean_obj_tag(v___x_771_) == 0 {
                            ...
                            if leanh::lean_obj_tag(v___x_773_) == 0 {
                                ...
                                leanh::lean_dec_ref(v_rhsExpr_760_);
                                leanh::lean_dec_ref(v_lhsExpr_759_);
                                leanh::lean_dec_ref(v___x_758_);
                                leanh::lean_dec(v___x_757_);
                                leanh::lean_dec(v_congrThm_756_);
                                leanh::lean_dec(v_width_750_);
                                return v___x_773_;
                            }
                        } else {
                            leanh::lean_dec(v_a_770_);
                        ...
                        leanh::lean_dec(v_congrThm_756_);
                        leanh::lean_dec_ref(v_rhs_755_);
                        leanh::lean_dec_ref(v_lhs_754_);
                        leanh::lean_dec(v_width_750_);
                        v_a_799_ = leanh::lean_ctor_get(v___x_769_, 0);
                        v_isSharedCheck_806_ = (!leanh::lean_is_exclusive(v___x_769_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_rhs_755_);
                    leanh::lean_dec_ref(v_lhs_754_);
                    leanh::lean_dec_ref(v_expr_753_);
                    leanh::lean_dec(v_width_752_);
                    leanh::lean_dec(v_width_750_);
                    v_a_807_ = leanh::lean_ctor_get(v___x_767_, 0);
                    v_isSharedCheck_814_ = (!leanh::lean_is_exclusive(v___x_767_)) as u8;
            ...
            1 => {
                ...
                if leanh::lean_obj_tag(v___x_778_) == 1 {
                    v_val_779_ = leanh::lean_ctor_get(v___x_778_, 0);
                    v_isSharedCheck_793_ = (!leanh::lean_is_exclusive(v___x_778_)) as u8;
                    ...
                    if v_isShared_777_ == 0 {
                        leanh::lean_ctor_set(v___x_776_, 0, v___x_794_);
                        v___x_796_ = v___x_776_;
                        state = 5;
                        continue;
                    } else {
                        v_reuseFailAlloc_797_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
            ...
            2 => {
                v_fst_783_ = leanh::lean_ctor_get(v_val_779_, 0);
                leanh::lean_inc(v_fst_783_);
                v_snd_784_ = leanh::lean_ctor_get(v_val_779_, 1);
                leanh::lean_inc(v_snd_784_);
                ...
                if v_isShared_782_ == 0 {
                    leanh::lean_ctor_set(v___x_781_, 0, v___x_786_);
                    v___x_788_ = v___x_781_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_792_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_792_, 0, v___x_786_);
            ...
            3 => {
                if v_isShared_777_ == 0 {
                    leanh::lean_ctor_set(v___x_776_, 0, v___x_788_);
                    v___x_790_ = v___x_776_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_791_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
            ...
            6 => {
                if v_isShared_802_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_805_, 0, v_a_799_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred___redArg___lam__0___boxed(
    ...
    let mut v_width_815_: *mut leanh::LeanObject = *_args.add(0);
    let mut v_expr_816_: *mut leanh::LeanObject = *_args.add(1);
    let mut v_width_817_: *mut leanh::LeanObject = *_args.add(2);
    let mut v_expr_818_: *mut leanh::LeanObject = *_args.add(3);
    let mut v_lhs_819_: *mut leanh::LeanObject = *_args.add(4);
    let mut v_rhs_820_: *mut leanh::LeanObject = *_args.add(5);
    let mut v_congrThm_821_: *mut leanh::LeanObject = *_args.add(6);
    let mut v___x_822_: *mut leanh::LeanObject = *_args.add(7);
    let mut v___x_823_: *mut leanh::LeanObject = *_args.add(8);
    let mut v_lhsExpr_824_: *mut leanh::LeanObject = *_args.add(9);
    let mut v_rhsExpr_825_: *mut leanh::LeanObject = *_args.add(10);
    let mut v___y_826_: *mut leanh::LeanObject = *_args.add(11);
    let mut v___y_827_: *mut leanh::LeanObject = *_args.add(12);
    let mut v___y_828_: *mut leanh::LeanObject = *_args.add(13);
    let mut v___y_829_: *mut leanh::LeanObject = *_args.add(14);
    let mut v___y_830_: *mut leanh::LeanObject = *_args.add(15);
    let mut v___y_831_: *mut leanh::LeanObject = *_args.add(16);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred___redArg(
    mut v_lhs_864_: *mut leanh::LeanObject,
    mut v_rhs_865_: *mut leanh::LeanObject,
    mut v_lhsExpr_866_: *mut leanh::LeanObject,
    mut v_rhsExpr_867_: *mut leanh::LeanObject,
    mut v_pred_868_: u8,
    mut v_origExpr_869_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_width_871_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_bvExpr_872_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_873_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_width_874_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_bvExpr_875_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_876_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_congrThm_880_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_bvExpr_881_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_proof_885_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___y_887_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_888_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_width_871_ = leanh::lean_ctor_get(v_lhs_864_, 0);
                leanh::lean_inc(v_width_871_);
                v_bvExpr_872_ = leanh::lean_ctor_get(v_lhs_864_, 1);
                v_expr_873_ = leanh::lean_ctor_get(v_lhs_864_, 4);
                leanh::lean_inc_ref(v_expr_873_);
                v_width_874_ = leanh::lean_ctor_get(v_rhs_865_, 0);
                leanh::lean_inc(v_width_874_);
                v_bvExpr_875_ = leanh::lean_ctor_get(v_rhs_865_, 1);
                v_expr_876_ = leanh::lean_ctor_get(v_rhs_865_, 4);
                leanh::lean_inc_ref(v_expr_876_);
                v___x_877_ = lean_nat_dec_eq(v_width_871_, v_width_874_);
                if v___x_877_ == 0 {
                    leanh::lean_dec_ref(v_expr_876_);
                    leanh::lean_dec(v_width_874_);
                    leanh::lean_dec_ref(v_expr_873_);
                    leanh::lean_dec(v_width_871_);
                    leanh::lean_dec_ref(v_origExpr_869_);
                    leanh::lean_dec_ref(v_rhsExpr_867_);
                    leanh::lean_dec_ref(v_lhsExpr_866_);
                    leanh::lean_dec_ref(v_rhs_865_);
                    leanh::lean_dec_ref(v_lhs_864_);
                    ...
                    leanh::lean_inc_ref(v_bvExpr_875_);
                    leanh::lean_inc_ref(v_bvExpr_872_);
                    leanh::lean_inc_n(v_width_871_, 2);
                    v_bvExpr_881_ = leanh::lean_alloc_ctor(0, 3, (1) as u32);
                    leanh::lean_ctor_set(v_bvExpr_881_, 0, v_width_871_);
                    leanh::lean_ctor_set(v_bvExpr_881_, 1, v_bvExpr_872_);
                    leanh::lean_ctor_set(v_bvExpr_881_, 2, v_bvExpr_875_);
                    ...
                    leanh::lean_inc_ref(v_expr_876_);
                    leanh::lean_inc_ref(v_expr_873_);
                    v_proof_885_ = leanh::lean_alloc_closure(l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred___redArg___lam__0___boxed as *mut core::ffi::c_void, 17, 11);
                    leanh::lean_closure_set(v_proof_885_, 0, v_width_871_);
                    leanh::lean_closure_set(v_proof_885_, 1, v_expr_873_);
                    leanh::lean_closure_set(v_proof_885_, 2, v_width_874_);
                    leanh::lean_closure_set(v_proof_885_, 3, v_expr_876_);
                    leanh::lean_closure_set(v_proof_885_, 4, v_lhs_864_);
                    leanh::lean_closure_set(v_proof_885_, 5, v_rhs_865_);
                    leanh::lean_closure_set(v_proof_885_, 6, v_congrThm_880_);
                    leanh::lean_closure_set(v_proof_885_, 7, v___x_882_);
                    leanh::lean_closure_set(v_proof_885_, 8, v___x_884_);
                    leanh::lean_closure_set(v_proof_885_, 9, v_lhsExpr_866_);
                    leanh::lean_closure_set(v_proof_885_, 10, v_rhsExpr_867_);
                    if v_pred_868_ == 0 {
            ...
            1 => {
                leanh::lean_inc_ref(v___y_887_);
                v_expr_888_ =
                    l_Lean_mkApp4(v___x_883_, v___x_884_, v_expr_873_, v___y_887_, v_expr_876_);
                v___x_889_ = leanh::lean_alloc_ctor(0, 4, (0) as u32);
                leanh::lean_ctor_set(v___x_889_, 0, v_bvExpr_881_);
                leanh::lean_ctor_set(v___x_889_, 1, v_origExpr_869_);
                leanh::lean_ctor_set(v___x_889_, 2, v_proof_885_);
                leanh::lean_ctor_set(v___x_889_, 3, v_expr_888_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred___redArg___boxed(
    ...
    mut v_lhsExpr_896_: *mut leanh::LeanObject,
    mut v_rhsExpr_897_: *mut leanh::LeanObject,
    mut v_pred_898_: *mut leanh::LeanObject,
    mut v_origExpr_899_: *mut leanh::LeanObject,
    mut v_a_900_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_pred_boxed_901_: u8 = 0;
    let mut v_res_902_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_pred_boxed_901_ = (leanh::lean_unbox(v_pred_898_) as u8);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred(
    ...
    mut v_lhsExpr_905_: *mut leanh::LeanObject,
    mut v_rhsExpr_906_: *mut leanh::LeanObject,
    mut v_pred_907_: u8,
    mut v_origExpr_908_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkBinPred___boxed(
    mut v_lhs_916_: *mut leanh::LeanObject,
    mut v_rhs_917_: *mut leanh::LeanObject,
    mut v_lhsExpr_918_: *mut leanh::LeanObject,
    mut v_rhsExpr_919_: *mut leanh::LeanObject,
    mut v_pred_920_: *mut leanh::LeanObject,
    mut v_origExpr_921_: *mut leanh::LeanObject,
    ...
    v_pred_boxed_928_ = (leanh::lean_unbox(v_pred_920_) as u8);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkGetLsbD___redArg___lam__0(
    mut v_sub_931_: *mut leanh::LeanObject,
    mut v_width_932_: *mut leanh::LeanObject,
    mut v_expr_933_: *mut leanh::LeanObject,
    ...
    mut v_idxExpr_938_: *mut leanh::LeanObject,
    mut v___x_939_: *mut leanh::LeanObject,
    mut v_subExpr_940_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_947_) == 0 {
                    ...
                    v_isSharedCheck_987_ = (!leanh::lean_is_exclusive(v___x_947_)) as u8;
                    ...
                    leanh::lean_dec_ref(v_subExpr_940_);
                    leanh::lean_dec_ref(v___x_939_);
                    leanh::lean_dec_ref(v_idxExpr_938_);
                    leanh::lean_dec(v___x_937_);
                    leanh::lean_dec_ref(v___x_936_);
                    leanh::lean_dec_ref(v___x_935_);
                    leanh::lean_dec_ref(v___x_934_);
                    leanh::lean_dec_ref(v_expr_933_);
                    leanh::lean_dec(v_width_932_);
                    return v___x_947_;
                }
            }
            1 => {
                if leanh::lean_obj_tag(v_a_948_) == 1 {
                    leanh::lean_del_object(v___x_950_);
                    v_val_952_ = leanh::lean_ctor_get(v_a_948_, 0);
                    v_isSharedCheck_982_ = (!leanh::lean_is_exclusive(v_a_948_)) as u8;
                    ...
                    if v_isShared_951_ == 0 {
                        leanh::lean_ctor_set(v___x_950_, 0, v___x_983_);
            ...
            2 => {
                ...
                if leanh::lean_obj_tag(v___x_956_) == 0 {
                    ...
                    v_isSharedCheck_973_ = (!leanh::lean_is_exclusive(v___x_956_)) as u8;
                    ...
                    leanh::lean_del_object(v___x_954_);
                    leanh::lean_dec(v_val_952_);
                    leanh::lean_dec_ref(v_subExpr_940_);
                    leanh::lean_dec_ref(v___x_939_);
                    leanh::lean_dec_ref(v_idxExpr_938_);
                    leanh::lean_dec(v___x_937_);
                    ...
                    leanh::lean_dec_ref(v___x_935_);
                    leanh::lean_dec_ref(v___x_934_);
                    v_a_974_ = leanh::lean_ctor_get(v___x_956_, 0);
                    v_isSharedCheck_981_ = (!leanh::lean_is_exclusive(v___x_956_)) as u8;
            ...
            3 => {
                ...
                if v_isShared_955_ == 0 {
                    leanh::lean_ctor_set(v___x_954_, 0, v___x_966_);
                    v___x_968_ = v___x_954_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_972_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_972_, 0, v___x_966_);
            ...
            4 => {
                if v_isShared_960_ == 0 {
                    leanh::lean_ctor_set(v___x_959_, 0, v___x_968_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkGetLsbD___redArg___lam__0___boxed(
    mut v_sub_988_: *mut leanh::LeanObject,
    mut v_width_989_: *mut leanh::LeanObject,
    mut v_expr_990_: *mut leanh::LeanObject,
    mut v___x_991_: *mut leanh::LeanObject,
    mut v___x_992_: *mut leanh::LeanObject,
    mut v___x_993_: *mut leanh::LeanObject,
    mut v___x_994_: *mut leanh::LeanObject,
    mut v_idxExpr_995_: *mut leanh::LeanObject,
    mut v___x_996_: *mut leanh::LeanObject,
    mut v_subExpr_997_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkGetLsbD___redArg(
    mut v_sub_1005_: *mut leanh::LeanObject,
    mut v_subExpr_1006_: *mut leanh::LeanObject,
    mut v_idx_1007_: *mut leanh::LeanObject,
    mut v_origExpr_1008_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_width_1010_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_bvExpr_1011_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_1012_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_bvExpr_1013_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_idxExpr_1014_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_proof_1021_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_1022_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1023_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_1024_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_width_1010_ = leanh::lean_ctor_get(v_sub_1005_, 0);
    leanh::lean_inc_n(v_width_1010_, 3);
    v_bvExpr_1011_ = leanh::lean_ctor_get(v_sub_1005_, 1);
    v_expr_1012_ = leanh::lean_ctor_get(v_sub_1005_, 4);
    leanh::lean_inc_ref_n(v_expr_1012_, 2);
    leanh::lean_inc(v_idx_1007_);
    leanh::lean_inc_ref(v_bvExpr_1011_);
    v_bvExpr_1013_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
    leanh::lean_ctor_set(v_bvExpr_1013_, 0, v_width_1010_);
    leanh::lean_ctor_set(v_bvExpr_1013_, 1, v_bvExpr_1011_);
    leanh::lean_ctor_set(v_bvExpr_1013_, 2, v_idx_1007_);
    ...
    leanh::lean_inc_ref(v___x_1020_);
    leanh::lean_inc_ref(v_idxExpr_1014_);
    v_proof_1021_ = leanh::lean_alloc_closure(
        l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkGetLsbD___redArg___lam__0___boxed
            as *mut core::ffi::c_void,
        16,
        10,
    );
    leanh::lean_closure_set(v_proof_1021_, 0, v_sub_1005_);
    leanh::lean_closure_set(v_proof_1021_, 1, v_width_1010_);
    leanh::lean_closure_set(v_proof_1021_, 2, v_expr_1012_);
    leanh::lean_closure_set(v_proof_1021_, 3, v___x_1015_);
    leanh::lean_closure_set(v_proof_1021_, 4, v___x_1016_);
    leanh::lean_closure_set(v_proof_1021_, 5, v___x_1017_);
    leanh::lean_closure_set(v_proof_1021_, 6, v___x_1018_);
    leanh::lean_closure_set(v_proof_1021_, 7, v_idxExpr_1014_);
    leanh::lean_closure_set(v_proof_1021_, 8, v___x_1020_);
    leanh::lean_closure_set(v_proof_1021_, 9, v_subExpr_1006_);
    v_expr_1022_ = l_Lean_mkApp3(v___x_1019_, v___x_1020_, v_expr_1012_, v_idxExpr_1014_);
    v___x_1023_ = leanh::lean_alloc_ctor(0, 4, (0) as u32);
    leanh::lean_ctor_set(v___x_1023_, 0, v_bvExpr_1013_);
    leanh::lean_ctor_set(v___x_1023_, 1, v_origExpr_1008_);
    leanh::lean_ctor_set(v___x_1023_, 2, v_proof_1021_);
    leanh::lean_ctor_set(v___x_1023_, 3, v_expr_1022_);
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkGetLsbD___redArg___boxed(
    mut v_sub_1025_: *mut leanh::LeanObject,
    mut v_subExpr_1026_: *mut leanh::LeanObject,
    mut v_idx_1027_: *mut leanh::LeanObject,
    mut v_origExpr_1028_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkGetLsbD(
    mut v_sub_1031_: *mut leanh::LeanObject,
    mut v_subExpr_1032_: *mut leanh::LeanObject,
    mut v_idx_1033_: *mut leanh::LeanObject,
    mut v_origExpr_1034_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Tactic_BVDecide_ReifiedBVPred_mkGetLsbD___boxed(
    mut v_sub_1042_: *mut leanh::LeanObject,
    mut v_subExpr_1043_: *mut leanh::LeanObject,
    mut v_idx_1044_: *mut leanh::LeanObject,
    mut v_origExpr_1045_: *mut leanh::LeanObject,
