...
use crate::ffi::{
    ...
    lean_array_push, lean_nat_add, lean_nat_dec_lt, lean_st_ref_set, lean_st_ref_take,
...
static mut l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2___redArg___closed__2: *mut leanh::LeanObject = core::ptr::null_mut();
pub static l_Lean_MVarId_rename___closed__0_value: leanh::LeanStringObject<7> =
...
static mut l_Lean_MVarId_rename___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_MVarId_rename___closed__0_value) as *mut leanh::LeanObject;
pub static l_Lean_MVarId_rename___closed__1_value: leanh::LeanCtorObject<3> =
    leanh::LeanCtorObject {
        ...
        m_objs: [
            ...
            16251432624378154990 as *mut leanh::LeanObject,
        ],
    };
static mut l_Lean_MVarId_rename___closed__1: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_MVarId_rename___closed__1_value) as *mut leanh::LeanObject;
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_rename_spec__1___redArg(
    mut v_mvarId_412_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_419_) == 0 {
                    ...
                    v_isSharedCheck_427_ = (!leanh::lean_is_exclusive(v___x_419_)) as u8;
                    ...
                    v_a_428_ = leanh::lean_ctor_get(v___x_419_, 0);
                    v_isSharedCheck_435_ = (!leanh::lean_is_exclusive(v___x_419_)) as u8;
            ...
            1 => {
                if v_isShared_423_ == 0 {
                    ...
                    v_reuseFailAlloc_426_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_426_, 0, v_a_420_);
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_rename_spec__1___redArg___boxed(
    mut v_mvarId_436_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_rename_spec__1(
    ...
    mut v_mvarId_445_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_rename_spec__1___boxed(
    ...
    mut v_mvarId_454_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNodeAux___at___00Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2_spec__3_spec__4___redArg(
    ...
    let mut v_ks_466_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_467_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_k_x27_478_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_490_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_491_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_ks_466_ = leanh::lean_ctor_get(v_x_462_, 0);
                v_vs_467_ = leanh::lean_ctor_get(v_x_462_, 1);
                v_isSharedCheck_491_ = (!leanh::lean_is_exclusive(v_x_462_)) as u8;
                if v_isSharedCheck_491_ == 0 {
                    ...
                    leanh::lean_inc(v_vs_467_);
                    leanh::lean_inc(v_ks_466_);
            ...
            1 => {
                ...
                if v___x_472_ == 0 {
                    leanh::lean_dec(v_x_463_);
                    v___x_473_ = lean_array_push(v_ks_466_, v_x_464_);
                    v___x_474_ = lean_array_push(v_vs_467_, v_x_465_);
                    if v_isShared_470_ == 0 {
                        leanh::lean_ctor_set(v___x_469_, 1, v___x_474_);
                        leanh::lean_ctor_set(v___x_469_, 0, v___x_473_);
                        v___x_476_ = v___x_469_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_477_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    ...
                    if v___x_479_ == 0 {
                        if v_isShared_470_ == 0 {
                            ...
                            leanh::lean_ctor_set(v_reuseFailAlloc_485_, 0, v_ks_466_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_485_, 1, v_vs_467_);
                        ...
                        leanh::lean_dec(v_x_463_);
                        if v_isShared_470_ == 0 {
                            leanh::lean_ctor_set(v___x_469_, 1, v___x_487_);
                            leanh::lean_ctor_set(v___x_469_, 0, v___x_486_);
                            v___x_489_ = v___x_469_;
                            state = 4;
                            continue;
                        } else {
                            v_reuseFailAlloc_490_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                            leanh::lean_ctor_set(v_reuseFailAlloc_490_, 0, v___x_486_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_490_, 1, v___x_487_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2___redArg(
    ...
    let mut v_es_509_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_510_: usize = 0;
    let mut v___x_511_: usize = 0;
    let mut v___x_512_: usize = 0;
    let mut v___x_513_: usize = 0;
    let mut v_j_514_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_v_520_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_521_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_xs_x27_522_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_key_529_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_node_541_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_554_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ks_555_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_556_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_newNode_562_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___y_564_: u8 = 0;
    let mut v_ks_565_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_566_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_504_) == 0 {
                    ...
                    if v___x_516_ == 0 {
                        leanh::lean_dec(v_j_514_);
                        leanh::lean_dec(v_x_508_);
                        leanh::lean_dec(v_x_507_);
                        return v_x_504_;
                    } else {
                        leanh::lean_inc_ref(v_es_509_);
                        v_isSharedCheck_553_ = (!leanh::lean_is_exclusive(v_x_504_)) as u8;
                        if v_isSharedCheck_553_ == 0 {
                            v_unused_554_ = leanh::lean_ctor_get(v_x_504_, 0);
                            leanh::lean_dec(v_unused_554_);
                            v___x_518_ = v_x_504_;
                    ...
                    v_ks_555_ = leanh::lean_ctor_get(v_x_504_, 0);
                    v_vs_556_ = leanh::lean_ctor_get(v_x_504_, 1);
                    v_isSharedCheck_576_ = (!leanh::lean_is_exclusive(v_x_504_)) as u8;
                    if v_isSharedCheck_576_ == 0 {
                        ...
                        leanh::lean_inc(v_vs_556_);
                        leanh::lean_inc(v_ks_555_);
                        leanh::lean_dec(v_x_504_);
            ...
            1 => {
                ...
                match leanh::lean_obj_tag(v_v_520_) {
                    0 => {
                        v_key_529_ = leanh::lean_ctor_get(v_v_520_, 0);
                        v_val_530_ = leanh::lean_ctor_get(v_v_520_, 1);
                        v_isSharedCheck_540_ = (!leanh::lean_is_exclusive(v_v_520_)) as u8;
                        if v_isSharedCheck_540_ == 0 {
                            ...
                            leanh::lean_inc(v_key_529_);
                            leanh::lean_dec(v_v_520_);
                    ...
                    1 => {
                        v_node_541_ = leanh::lean_ctor_get(v_v_520_, 0);
                        v_isSharedCheck_551_ = (!leanh::lean_is_exclusive(v_v_520_)) as u8;
                    ...
                    _ => {
                        ...
                        leanh::lean_ctor_set(v___x_552_, 0, v_x_507_);
                        leanh::lean_ctor_set(v___x_552_, 1, v_x_508_);
            ...
            2 => {
                ...
                if v_isShared_519_ == 0 {
                    leanh::lean_ctor_set(v___x_518_, 0, v___x_525_);
            ...
            4 => {
                ...
                if v___x_534_ == 0 {
                    ...
                    v___x_536_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    ...
                    leanh::lean_dec(v_key_529_);
                    if v_isShared_533_ == 0 {
                        leanh::lean_ctor_set(v___x_532_, 1, v_x_508_);
                        leanh::lean_ctor_set(v___x_532_, 0, v_x_507_);
                        v___x_538_ = v___x_532_;
                        state = 5;
                        continue;
                    } else {
                        v_reuseFailAlloc_539_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_539_, 0, v_x_507_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_539_, 1, v_x_508_);
            ...
            6 => {
                ...
                if v_isShared_544_ == 0 {
                    leanh::lean_ctor_set(v___x_543_, 0, v___x_547_);
            ...
            8 => {
                if v_isShared_559_ == 0 {
                    ...
                    v_reuseFailAlloc_575_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_575_, 0, v_ks_555_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_575_, 1, v_vs_556_);
            ...
            9 => {
                ...
                if v___x_571_ == 0 {
                    ...
                    v___x_573_ = leanh::lean_unsigned_to_nat(4);
            ...
            10 => {
                if v___y_564_ == 0 {
                    v_ks_565_ = leanh::lean_ctor_get(v_newNode_562_, 0);
                    leanh::lean_inc_ref(v_ks_565_);
                    v_vs_566_ = leanh::lean_ctor_get(v_newNode_562_, 1);
                    leanh::lean_inc_ref(v_vs_566_);
                    leanh::lean_dec_ref(v_newNode_562_);
                    ...
                    leanh::lean_dec_ref(v_vs_566_);
                    leanh::lean_dec_ref(v_ks_565_);
                    return v___x_569_;
                } else {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2_spec__4___redArg(
    ...
    mut v_keys_578_: *mut leanh::LeanObject,
    mut v_vals_579_: *mut leanh::LeanObject,
    mut v_i_580_: *mut leanh::LeanObject,
    mut v_entries_581_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    let mut v_v_585_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2_spec__4___redArg___boxed(
    mut v_depth_597_: *mut leanh::LeanObject,
    mut v_keys_598_: *mut leanh::LeanObject,
    mut v_vals_599_: *mut leanh::LeanObject,
    mut v_i_600_: *mut leanh::LeanObject,
    mut v_entries_601_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_602_: usize = 0;
    let mut v_res_603_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_602_ = leanh::lean_unbox_usize(v_depth_597_);
    leanh::lean_dec(v_depth_597_);
    ...
    leanh::lean_dec_ref(v_vals_599_);
    leanh::lean_dec_ref(v_keys_598_);
    return v_res_603_;
}
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2___redArg___boxed(
    ...
    v_x_1519__boxed_609_ = leanh::lean_unbox_usize(v_x_605_);
    leanh::lean_dec(v_x_605_);
    v_x_1520__boxed_610_ = leanh::lean_unbox_usize(v_x_606_);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0___redArg(
    ...
    mut v_val_620_: *mut leanh::LeanObject,
    ...
    let mut v_cache_625_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_626_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_627_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_628_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_630_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_631_: u8 = 0;
    let mut v_depth_632_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_levelAssignDepth_633_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lmvarCounter_634_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mvarCounter_635_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lDecls_636_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_decls_637_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_userNames_638_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lAssignment_639_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_eAssignment_640_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_dAssignment_641_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_cache_625_ = leanh::lean_ctor_get(v___x_623_, 1);
                v_zetaDeltaFVarIds_626_ = leanh::lean_ctor_get(v___x_623_, 2);
                v_postponed_627_ = leanh::lean_ctor_get(v___x_623_, 3);
                v_diag_628_ = leanh::lean_ctor_get(v___x_623_, 4);
                v_isSharedCheck_656_ = (!leanh::lean_is_exclusive(v___x_623_)) as u8;
                if v_isSharedCheck_656_ == 0 {
                    ...
                    leanh::lean_inc(v_diag_628_);
                    leanh::lean_inc(v_postponed_627_);
                    leanh::lean_inc(v_zetaDeltaFVarIds_626_);
                    leanh::lean_inc(v_cache_625_);
                    leanh::lean_inc(v_mctx_624_);
            ...
            1 => {
                v_depth_632_ = leanh::lean_ctor_get(v_mctx_624_, 0);
                v_levelAssignDepth_633_ = leanh::lean_ctor_get(v_mctx_624_, 1);
                v_lmvarCounter_634_ = leanh::lean_ctor_get(v_mctx_624_, 2);
                v_mvarCounter_635_ = leanh::lean_ctor_get(v_mctx_624_, 3);
                v_lDecls_636_ = leanh::lean_ctor_get(v_mctx_624_, 4);
                v_decls_637_ = leanh::lean_ctor_get(v_mctx_624_, 5);
                v_userNames_638_ = leanh::lean_ctor_get(v_mctx_624_, 6);
                v_lAssignment_639_ = leanh::lean_ctor_get(v_mctx_624_, 7);
                v_eAssignment_640_ = leanh::lean_ctor_get(v_mctx_624_, 8);
                v_dAssignment_641_ = leanh::lean_ctor_get(v_mctx_624_, 9);
                v_isSharedCheck_655_ = (!leanh::lean_is_exclusive(v_mctx_624_)) as u8;
                if v_isSharedCheck_655_ == 0 {
                    ...
                    leanh::lean_inc(v_dAssignment_641_);
                    leanh::lean_inc(v_eAssignment_640_);
                    leanh::lean_inc(v_lAssignment_639_);
                    leanh::lean_inc(v_userNames_638_);
                    leanh::lean_inc(v_decls_637_);
                    leanh::lean_inc(v_lDecls_636_);
                    leanh::lean_inc(v_mvarCounter_635_);
                    leanh::lean_inc(v_lmvarCounter_634_);
                    leanh::lean_inc(v_levelAssignDepth_633_);
                    leanh::lean_inc(v_depth_632_);
                    leanh::lean_dec(v_mctx_624_);
            ...
            2 => {
                ...
                if v_isShared_644_ == 0 {
                    leanh::lean_ctor_set(v___x_643_, 8, v___x_645_);
                    v___x_647_ = v___x_643_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_654_ = leanh::lean_alloc_ctor(0, 10, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 0, v_depth_632_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 1, v_levelAssignDepth_633_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 2, v_lmvarCounter_634_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 3, v_mvarCounter_635_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 4, v_lDecls_636_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 5, v_decls_637_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 6, v_userNames_638_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 7, v_lAssignment_639_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 8, v___x_645_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_654_, 9, v_dAssignment_641_);
            ...
            3 => {
                if v_isShared_631_ == 0 {
                    leanh::lean_ctor_set(v___x_630_, 0, v___x_647_);
                    v___x_649_ = v___x_630_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_653_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_653_, 0, v___x_647_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_653_, 1, v_cache_625_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_653_, 2, v_zetaDeltaFVarIds_626_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_653_, 3, v_postponed_627_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_653_, 4, v_diag_628_);
            ...
            4 => {
                ...
                v___x_652_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0___redArg___boxed(
    mut v_mvarId_657_: *mut leanh::LeanObject,
    mut v_val_658_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_rename___lam__0(
    mut v_mvarId_662_: *mut leanh::LeanObject,
    mut v___x_663_: *mut leanh::LeanObject,
    mut v_fvarId_664_: *mut leanh::LeanObject,
    mut v_userNameNew_665_: *mut leanh::LeanObject,
    ...
    let mut v_lctx_676_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_localInstances_677_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_692_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_671_) == 0 {
                    ...
                    if leanh::lean_obj_tag(v___x_672_) == 0 {
                        v_a_673_ = leanh::lean_ctor_get(v___x_672_, 0);
                        ...
                        if leanh::lean_obj_tag(v___x_674_) == 0 {
                            ...
                            v_lctx_676_ = leanh::lean_ctor_get(v___y_666_, 2);
                            v_localInstances_677_ = leanh::lean_ctor_get(v___y_666_, 3);
                            leanh::lean_inc_ref(v_localInstances_677_);
                            leanh::lean_inc_ref(v_lctx_676_);
                            ...
                            if leanh::lean_obj_tag(v___x_681_) == 0 {
                                ...
                                v_isSharedCheck_691_ =
                                    (!leanh::lean_is_exclusive(v___x_683_)) as u8;
                                if v_isSharedCheck_691_ == 0 {
                                    v_unused_692_ = leanh::lean_ctor_get(v___x_683_, 0);
                                    leanh::lean_dec(v_unused_692_);
                                ...
                                leanh::lean_dec(v_mvarId_662_);
                                v_a_693_ = leanh::lean_ctor_get(v___x_681_, 0);
                                v_isSharedCheck_700_ =
                                    (!leanh::lean_is_exclusive(v___x_681_)) as u8;
                            ...
                            leanh::lean_dec_ref(v___y_666_);
                            leanh::lean_dec(v_userNameNew_665_);
                            leanh::lean_dec(v_fvarId_664_);
                            leanh::lean_dec(v_mvarId_662_);
                            v_a_701_ = leanh::lean_ctor_get(v___x_674_, 0);
                            v_isSharedCheck_708_ =
                                (!leanh::lean_is_exclusive(v___x_674_)) as u8;
                        ...
                        leanh::lean_dec(v_fvarId_664_);
                        leanh::lean_dec(v_mvarId_662_);
                        v_a_709_ = leanh::lean_ctor_get(v___x_672_, 0);
                        v_isSharedCheck_716_ = (!leanh::lean_is_exclusive(v___x_672_)) as u8;
                    ...
                    leanh::lean_dec(v_fvarId_664_);
                    leanh::lean_dec(v_mvarId_662_);
                    v_a_717_ = leanh::lean_ctor_get(v___x_671_, 0);
                    v_isSharedCheck_724_ = (!leanh::lean_is_exclusive(v___x_671_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_686_ == 0 {
                    ...
                    v_reuseFailAlloc_690_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_690_, 0, v___x_687_);
...
pub unsafe fn l_Lean_MVarId_rename___lam__0___boxed(
    mut v_mvarId_725_: *mut leanh::LeanObject,
    mut v___x_726_: *mut leanh::LeanObject,
    mut v_fvarId_727_: *mut leanh::LeanObject,
    mut v_userNameNew_728_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_rename(
    mut v_mvarId_738_: *mut leanh::LeanObject,
    mut v_fvarId_739_: *mut leanh::LeanObject,
    mut v_userNameNew_740_: *mut leanh::LeanObject,
    ...
    leanh::lean_inc(v_mvarId_738_);
    v___f_747_ = leanh::lean_alloc_closure(
        l_Lean_MVarId_rename___lam__0___boxed as *mut core::ffi::c_void,
        9,
        4,
    );
    leanh::lean_closure_set(v___f_747_, 0, v_mvarId_738_);
    leanh::lean_closure_set(v___f_747_, 1, v___x_746_);
    leanh::lean_closure_set(v___f_747_, 2, v_fvarId_739_);
    leanh::lean_closure_set(v___f_747_, 3, v_userNameNew_740_);
...
pub unsafe fn l_Lean_MVarId_rename___boxed(
    mut v_mvarId_749_: *mut leanh::LeanObject,
    mut v_fvarId_750_: *mut leanh::LeanObject,
    mut v_userNameNew_751_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_a_752_);
    return v_res_757_;
}
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0(
    mut v_mvarId_758_: *mut leanh::LeanObject,
    mut v_val_759_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0___boxed(
    mut v_mvarId_766_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0(
    mut v_00_u03b2_774_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2(
    mut v_00_u03b2_779_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2___boxed(
    ...
    v_x_1907__boxed_792_ = leanh::lean_unbox_usize(v_x_788_);
    leanh::lean_dec(v_x_788_);
    v_x_1908__boxed_793_ = leanh::lean_unbox_usize(v_x_789_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2_spec__3(
    ...
    mut v_v_798_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2_spec__4(
    ...
    mut v_heq_804_: *mut leanh::LeanObject,
    mut v_i_805_: *mut leanh::LeanObject,
    mut v_entries_806_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_MVarId_rename_spec__0_spec__0_spec__2_spec__4___boxed(
    ...
    mut v_depth_809_: *mut leanh::LeanObject,
    mut v_keys_810_: *mut leanh::LeanObject,
    mut v_vals_811_: *mut leanh::LeanObject,
    mut v_heq_812_: *mut leanh::LeanObject,
    mut v_i_813_: *mut leanh::LeanObject,
    mut v_entries_814_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_815_: usize = 0;
    let mut v_res_816_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_815_ = leanh::lean_unbox_usize(v_depth_809_);
    leanh::lean_dec(v_depth_809_);
    ...
    leanh::lean_dec_ref(v_vals_811_);
    leanh::lean_dec_ref(v_keys_810_);
    return v_res_816_;
}
...
pub unsafe fn initialize_Lean_Meta_Tactic_Rename(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
