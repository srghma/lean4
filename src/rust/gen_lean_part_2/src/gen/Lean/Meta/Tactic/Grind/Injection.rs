...
use crate::ffi::{
    ...
    lean_array_push, lean_infer_type, lean_name_eq, lean_nat_add, lean_nat_dec_lt, lean_st_ref_set,
...
static mut l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2___redArg___closed__2: *mut leanh::LeanObject = core::ptr::null_mut();
...
static mut l_Lean_Meta_Grind_injection_x3f___lam__0___closed__0: *mut leanh::LeanObject =
...
static mut l_Lean_Meta_Grind_injection_x3f___lam__0___closed__1: *mut leanh::LeanObject =
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_Meta_Grind_injection_x3f_spec__1___redArg(
    mut v_mvarId_526_: *mut leanh::LeanObject,
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_533_) == 0 {
                    ...
                    v_isSharedCheck_541_ = (!leanh::lean_is_exclusive(v___x_533_)) as u8;
                    ...
                    v_a_542_ = leanh::lean_ctor_get(v___x_533_, 0);
                    v_isSharedCheck_549_ = (!leanh::lean_is_exclusive(v___x_533_)) as u8;
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_Meta_Grind_injection_x3f_spec__1___redArg___boxed(
    mut v_mvarId_550_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v___y_554_);
    leanh::lean_dec(v___y_553_);
    leanh::lean_dec_ref(v___y_552_);
    return v_res_557_;
}
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_Meta_Grind_injection_x3f_spec__1___boxed(
    ...
    mut v_mvarId_568_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v___y_572_);
    leanh::lean_dec(v___y_571_);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNodeAux___at___00Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2_spec__3_spec__4___redArg(
    ...
    let mut v_ks_580_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_581_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_k_x27_592_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_ks_580_ = leanh::lean_ctor_get(v_x_576_, 0);
                v_vs_581_ = leanh::lean_ctor_get(v_x_576_, 1);
                v_isSharedCheck_605_ = (!leanh::lean_is_exclusive(v_x_576_)) as u8;
                if v_isSharedCheck_605_ == 0 {
                    ...
                    leanh::lean_inc(v_vs_581_);
                    leanh::lean_inc(v_ks_580_);
            ...
            1 => {
                ...
                if v___x_586_ == 0 {
                    leanh::lean_dec(v_x_577_);
                    v___x_587_ = lean_array_push(v_ks_580_, v_x_578_);
                    v___x_588_ = lean_array_push(v_vs_581_, v_x_579_);
                    if v_isShared_584_ == 0 {
                        leanh::lean_ctor_set(v___x_583_, 1, v___x_588_);
                        leanh::lean_ctor_set(v___x_583_, 0, v___x_587_);
                        v___x_590_ = v___x_583_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_591_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_591_, 0, v___x_587_);
                    ...
                    if v___x_593_ == 0 {
                        if v_isShared_584_ == 0 {
                            ...
                            leanh::lean_ctor_set(v_reuseFailAlloc_599_, 0, v_ks_580_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_599_, 1, v_vs_581_);
                        ...
                        leanh::lean_dec(v_x_577_);
                        if v_isShared_584_ == 0 {
                            leanh::lean_ctor_set(v___x_583_, 1, v___x_601_);
                            leanh::lean_ctor_set(v___x_583_, 0, v___x_600_);
                            v___x_603_ = v___x_583_;
                            state = 4;
                            continue;
                        } else {
                            v_reuseFailAlloc_604_ = leanh::lean_alloc_ctor(1, 2, (0) as u32);
                            leanh::lean_ctor_set(v_reuseFailAlloc_604_, 0, v___x_600_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_604_, 1, v___x_601_);
            ...
            3 => {
                v___x_596_ = leanh::lean_unsigned_to_nat(1);
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2___redArg(
    ...
    let mut v_es_623_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_624_: usize = 0;
    let mut v___x_625_: usize = 0;
    let mut v___x_626_: usize = 0;
    let mut v___x_627_: usize = 0;
    let mut v_j_628_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_v_634_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_635_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_xs_x27_636_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_key_643_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_val_644_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_node_655_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_668_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_ks_669_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_670_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_newNode_676_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___y_678_: u8 = 0;
    let mut v_ks_679_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_vs_680_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_618_) == 0 {
                    ...
                    if v___x_630_ == 0 {
                        leanh::lean_dec(v_j_628_);
                        leanh::lean_dec(v_x_622_);
                        leanh::lean_dec(v_x_621_);
                        return v_x_618_;
                    } else {
                        leanh::lean_inc_ref(v_es_623_);
                        v_isSharedCheck_667_ = (!leanh::lean_is_exclusive(v_x_618_)) as u8;
                        if v_isSharedCheck_667_ == 0 {
                            v_unused_668_ = leanh::lean_ctor_get(v_x_618_, 0);
                            leanh::lean_dec(v_unused_668_);
                            v___x_632_ = v_x_618_;
                            v_isShared_633_ = v_isSharedCheck_667_;
                            state = 1;
                            continue;
                        } else {
                            leanh::lean_dec(v_x_618_);
                    ...
                    v_ks_669_ = leanh::lean_ctor_get(v_x_618_, 0);
                    v_vs_670_ = leanh::lean_ctor_get(v_x_618_, 1);
                    v_isSharedCheck_690_ = (!leanh::lean_is_exclusive(v_x_618_)) as u8;
                    if v_isSharedCheck_690_ == 0 {
                        ...
                        leanh::lean_inc(v_vs_670_);
                        leanh::lean_inc(v_ks_669_);
                        leanh::lean_dec(v_x_618_);
            ...
            1 => {
                ...
                match leanh::lean_obj_tag(v_v_634_) {
                    0 => {
                        v_key_643_ = leanh::lean_ctor_get(v_v_634_, 0);
                        v_val_644_ = leanh::lean_ctor_get(v_v_634_, 1);
                        v_isSharedCheck_654_ = (!leanh::lean_is_exclusive(v_v_634_)) as u8;
                        if v_isSharedCheck_654_ == 0 {
                            ...
                            leanh::lean_inc(v_val_644_);
                            leanh::lean_inc(v_key_643_);
                            leanh::lean_dec(v_v_634_);
                    ...
                    1 => {
                        v_node_655_ = leanh::lean_ctor_get(v_v_634_, 0);
                        v_isSharedCheck_665_ = (!leanh::lean_is_exclusive(v_v_634_)) as u8;
                    ...
                    _ => {
                        ...
                        leanh::lean_ctor_set(v___x_666_, 0, v_x_621_);
                        leanh::lean_ctor_set(v___x_666_, 1, v_x_622_);
            ...
            2 => {
                ...
                if v_isShared_633_ == 0 {
                    leanh::lean_ctor_set(v___x_632_, 0, v___x_639_);
                    v___x_641_ = v___x_632_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_642_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_642_, 0, v___x_639_);
            ...
            4 => {
                ...
                if v___x_648_ == 0 {
                    leanh::lean_del_object(v___x_646_);
                    ...
                    leanh::lean_dec(v_val_644_);
                    leanh::lean_dec(v_key_643_);
                    if v_isShared_647_ == 0 {
                        leanh::lean_ctor_set(v___x_646_, 1, v_x_622_);
                        leanh::lean_ctor_set(v___x_646_, 0, v_x_621_);
                        v___x_652_ = v___x_646_;
                        state = 5;
                        continue;
                    } else {
                        v_reuseFailAlloc_653_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_653_, 0, v_x_621_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_653_, 1, v_x_622_);
            ...
            6 => {
                ...
                if v_isShared_658_ == 0 {
                    leanh::lean_ctor_set(v___x_657_, 0, v___x_661_);
                    v___x_663_ = v___x_657_;
                    state = 7;
                    continue;
                } else {
                    v_reuseFailAlloc_664_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_664_, 0, v___x_661_);
            ...
            8 => {
                if v_isShared_673_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_689_, 0, v_ks_669_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_689_, 1, v_vs_670_);
            ...
            9 => {
                ...
                if v___x_685_ == 0 {
                    ...
                    v___x_687_ = leanh::lean_unsigned_to_nat(4);
            ...
            10 => {
                if v___y_678_ == 0 {
                    ...
                    leanh::lean_dec_ref(v_vs_680_);
                    leanh::lean_dec_ref(v_ks_679_);
                    return v___x_683_;
                } else {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2_spec__4___redArg(
    ...
    mut v_keys_692_: *mut leanh::LeanObject,
    mut v_vals_693_: *mut leanh::LeanObject,
    mut v_i_694_: *mut leanh::LeanObject,
    mut v_entries_695_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    let mut v_v_699_: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2_spec__4___redArg___boxed(
    mut v_depth_711_: *mut leanh::LeanObject,
    mut v_keys_712_: *mut leanh::LeanObject,
    mut v_vals_713_: *mut leanh::LeanObject,
    mut v_i_714_: *mut leanh::LeanObject,
    mut v_entries_715_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_716_: usize = 0;
    let mut v_res_717_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_716_ = leanh::lean_unbox_usize(v_depth_711_);
    leanh::lean_dec(v_depth_711_);
    v_res_717_ = l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2_spec__4___redArg(v_depth_boxed_716_, v_keys_712_, v_vals_713_, v_i_714_, v_entries_715_);
    leanh::lean_dec_ref(v_vals_713_);
    leanh::lean_dec_ref(v_keys_712_);
    return v_res_717_;
}
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2___redArg___boxed(
    ...
    v_x_4803__boxed_723_ = leanh::lean_unbox_usize(v_x_719_);
    leanh::lean_dec(v_x_719_);
    v_x_4804__boxed_724_ = leanh::lean_unbox_usize(v_x_720_);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0___redArg(
    mut v_mvarId_733_: *mut leanh::LeanObject,
    mut v_val_734_: *mut leanh::LeanObject,
    mut v___y_735_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_737_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mctx_738_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_739_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_740_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_741_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_742_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_744_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_745_: u8 = 0;
    let mut v_depth_746_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_levelAssignDepth_747_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lmvarCounter_748_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_mvarCounter_749_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lDecls_750_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_decls_751_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_userNames_752_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_lAssignment_753_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_eAssignment_754_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_dAssignment_755_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_mctx_738_ = leanh::lean_ctor_get(v___x_737_, 0);
                v_cache_739_ = leanh::lean_ctor_get(v___x_737_, 1);
                v_zetaDeltaFVarIds_740_ = leanh::lean_ctor_get(v___x_737_, 2);
                v_postponed_741_ = leanh::lean_ctor_get(v___x_737_, 3);
                v_diag_742_ = leanh::lean_ctor_get(v___x_737_, 4);
                v_isSharedCheck_770_ = (!leanh::lean_is_exclusive(v___x_737_)) as u8;
                if v_isSharedCheck_770_ == 0 {
                    ...
                    leanh::lean_inc(v_diag_742_);
                    leanh::lean_inc(v_postponed_741_);
                    leanh::lean_inc(v_zetaDeltaFVarIds_740_);
                    leanh::lean_inc(v_cache_739_);
                    leanh::lean_inc(v_mctx_738_);
            ...
            1 => {
                v_depth_746_ = leanh::lean_ctor_get(v_mctx_738_, 0);
                v_levelAssignDepth_747_ = leanh::lean_ctor_get(v_mctx_738_, 1);
                v_lmvarCounter_748_ = leanh::lean_ctor_get(v_mctx_738_, 2);
                v_mvarCounter_749_ = leanh::lean_ctor_get(v_mctx_738_, 3);
                v_lDecls_750_ = leanh::lean_ctor_get(v_mctx_738_, 4);
                v_decls_751_ = leanh::lean_ctor_get(v_mctx_738_, 5);
                v_userNames_752_ = leanh::lean_ctor_get(v_mctx_738_, 6);
                v_lAssignment_753_ = leanh::lean_ctor_get(v_mctx_738_, 7);
                v_eAssignment_754_ = leanh::lean_ctor_get(v_mctx_738_, 8);
                v_dAssignment_755_ = leanh::lean_ctor_get(v_mctx_738_, 9);
                v_isSharedCheck_769_ = (!leanh::lean_is_exclusive(v_mctx_738_)) as u8;
                if v_isSharedCheck_769_ == 0 {
                    ...
                    leanh::lean_inc(v_dAssignment_755_);
                    leanh::lean_inc(v_eAssignment_754_);
                    leanh::lean_inc(v_lAssignment_753_);
                    leanh::lean_inc(v_userNames_752_);
                    leanh::lean_inc(v_decls_751_);
                    leanh::lean_inc(v_lDecls_750_);
                    leanh::lean_inc(v_mvarCounter_749_);
                    leanh::lean_inc(v_lmvarCounter_748_);
                    leanh::lean_inc(v_levelAssignDepth_747_);
                    leanh::lean_inc(v_depth_746_);
                    leanh::lean_dec(v_mctx_738_);
            ...
            2 => {
                ...
                if v_isShared_758_ == 0 {
                    leanh::lean_ctor_set(v___x_757_, 8, v___x_759_);
                    v___x_761_ = v___x_757_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_768_ = leanh::lean_alloc_ctor(0, 10, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 0, v_depth_746_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 1, v_levelAssignDepth_747_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 2, v_lmvarCounter_748_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 3, v_mvarCounter_749_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 4, v_lDecls_750_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 5, v_decls_751_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 6, v_userNames_752_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 7, v_lAssignment_753_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 8, v___x_759_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_768_, 9, v_dAssignment_755_);
            ...
            3 => {
                if v_isShared_745_ == 0 {
                    leanh::lean_ctor_set(v___x_744_, 0, v___x_761_);
                    v___x_763_ = v___x_744_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_767_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_767_, 0, v___x_761_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_767_, 1, v_cache_739_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_767_, 2, v_zetaDeltaFVarIds_740_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_767_, 3, v_postponed_741_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_767_, 4, v_diag_742_);
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0___redArg___boxed(
    mut v_mvarId_771_: *mut leanh::LeanObject,
    mut v_val_772_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_injection_x3f___lam__0(
    mut v_fvarId_779_: *mut leanh::LeanObject,
    ...
    let mut v_arg_799_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_827_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_829_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_830_: u8 = 0;
    let mut v_binderType_831_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_836_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_val_923_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_toConstantVal_924_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_val_925_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_toConstantVal_926_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_name_927_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_name_928_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_786_) == 0 {
                    ...
                    v_isSharedCheck_952_ = (!leanh::lean_is_exclusive(v___x_786_)) as u8;
                    ...
                    leanh::lean_dec(v_mvarId_780_);
                    leanh::lean_dec(v_fvarId_779_);
                    v_a_953_ = leanh::lean_ctor_get(v___x_786_, 0);
                    v_isSharedCheck_960_ = (!leanh::lean_is_exclusive(v___x_786_)) as u8;
            ...
            1 => {
                ...
                if v___x_798_ == 0 {
                    ...
                    v_arg_799_ = leanh::lean_ctor_get(v___x_797_, 1);
                    leanh::lean_inc_ref(v_arg_799_);
                        ...
                        if v___x_804_ == 0 {
                            ...
                            if v___x_807_ == 0 {
                                ...
                                if leanh::lean_obj_tag(v___x_808_) == 0 {
                                    ...
                                    leanh::lean_dec(v_mvarId_780_);
                                    leanh::lean_dec(v_fvarId_779_);
                                    v_a_944_ = leanh::lean_ctor_get(v___x_808_, 0);
            ...
            4 => {
                ...
                if leanh::lean_obj_tag(v___x_813_) == 0 {
                    ...
                    v_isSharedCheck_934_ = (!leanh::lean_is_exclusive(v___x_813_)) as u8;
                    ...
                    leanh::lean_del_object(v___x_811_);
                    ...
                    leanh::lean_dec(v_mvarId_780_);
                    leanh::lean_dec(v_fvarId_779_);
                    v_a_935_ = leanh::lean_ctor_get(v___x_813_, 0);
                    v_isSharedCheck_942_ = (!leanh::lean_is_exclusive(v___x_813_)) as u8;
            ...
            5 => {
                if leanh::lean_obj_tag(v_a_809_) == 1 {
                    if leanh::lean_obj_tag(v_a_814_) == 1 {
                        leanh::lean_del_object(v___x_816_);
                        v_val_923_ = leanh::lean_ctor_get(v_a_809_, 0);
                        leanh::lean_inc(v_val_923_);
                        leanh::lean_dec_ref_known(v_a_809_, 1);
                        v_toConstantVal_924_ = leanh::lean_ctor_get(v_val_923_, 0);
                        leanh::lean_inc_ref(v_toConstantVal_924_);
                        leanh::lean_dec(v_val_923_);
                        v_val_925_ = leanh::lean_ctor_get(v_a_814_, 0);
                        leanh::lean_inc(v_val_925_);
                        leanh::lean_dec_ref_known(v_a_814_, 1);
                        v_toConstantVal_926_ = leanh::lean_ctor_get(v_val_925_, 0);
                        leanh::lean_inc_ref(v_toConstantVal_926_);
                        leanh::lean_dec(v_val_925_);
                        v_name_927_ = leanh::lean_ctor_get(v_toConstantVal_924_, 0);
                        leanh::lean_inc(v_name_927_);
                        leanh::lean_dec_ref(v_toConstantVal_924_);
                        v_name_928_ = leanh::lean_ctor_get(v_toConstantVal_926_, 0);
                        leanh::lean_inc(v_name_928_);
                        leanh::lean_dec_ref(v_toConstantVal_926_);
                        v___x_929_ = lean_name_eq(v_name_927_, v_name_928_);
                        leanh::lean_dec(v_name_928_);
                        leanh::lean_dec(v_name_927_);
                        if v___x_929_ == 0 {
                            if v___x_807_ == 0 {
                                leanh::lean_del_object(v___x_811_);
                                state = 6;
                                ...
                                if v_isShared_812_ == 0 {
                                    leanh::lean_ctor_set(v___x_811_, 0, v___x_930_);
            ...
            6 => {
                ...
                if leanh::lean_obj_tag(v___x_819_) == 0 {
                    ...
                    leanh::lean_dec_ref_known(v___x_819_, 1);
                    leanh::lean_inc(v_fvarId_779_);
                    ...
                    if leanh::lean_obj_tag(v___x_822_) == 0 {
                        ...
                        leanh::lean_inc_n(v_a_823_, 2);
                        leanh::lean_dec_ref_known(v___x_822_, 1);
                        leanh::lean_inc(v___y_784_);
                        leanh::lean_inc_ref(v___y_783_);
                        leanh::lean_inc(v___y_782_);
                        leanh::lean_inc_ref(v___y_781_);
                        ...
                        if leanh::lean_obj_tag(v___x_824_) == 0 {
                            ...
                            if leanh::lean_obj_tag(v___x_826_) == 0 {
                                v_a_827_ = leanh::lean_ctor_get(v___x_826_, 0);
                                v_isSharedCheck_885_ =
                                    (!leanh::lean_is_exclusive(v___x_826_)) as u8;
                                ...
                                leanh::lean_dec(v_mvarId_780_);
                                leanh::lean_dec(v_fvarId_779_);
                                v_a_886_ = leanh::lean_ctor_get(v___x_826_, 0);
                            ...
                            leanh::lean_dec(v_mvarId_780_);
                            leanh::lean_dec(v_fvarId_779_);
                            v_a_894_ = leanh::lean_ctor_get(v___x_824_, 0);
                            v_isSharedCheck_901_ =
                                (!leanh::lean_is_exclusive(v___x_824_)) as u8;
                        ...
                        leanh::lean_dec(v_mvarId_780_);
                        leanh::lean_dec(v_fvarId_779_);
                        v_a_902_ = leanh::lean_ctor_get(v___x_822_, 0);
                        v_isSharedCheck_909_ = (!leanh::lean_is_exclusive(v___x_822_)) as u8;
                    ...
                    leanh::lean_dec(v_mvarId_780_);
                    leanh::lean_dec(v_fvarId_779_);
                    v_a_910_ = leanh::lean_ctor_get(v___x_819_, 0);
                    v_isSharedCheck_917_ = (!leanh::lean_is_exclusive(v___x_819_)) as u8;
            ...
            7 => {
                if leanh::lean_obj_tag(v_a_827_) == 7 {
                    leanh::lean_del_object(v___x_829_);
                    v_binderType_831_ = leanh::lean_ctor_get(v_a_827_, 1);
                    leanh::lean_inc_ref(v_binderType_831_);
                    leanh::lean_dec_ref_known(v_a_827_, 3);
                    leanh::lean_inc(v_mvarId_780_);
                    ...
                    if leanh::lean_obj_tag(v___x_832_) == 0 {
                        ...
                        leanh::lean_dec_ref_known(v___x_832_, 1);
                        ...
                        if leanh::lean_obj_tag(v___x_835_) == 0 {
                            v_a_836_ = leanh::lean_ctor_get(v___x_835_, 0);
                            leanh::lean_inc_n(v_a_836_, 2);
                            leanh::lean_dec_ref_known(v___x_835_, 1);
                            ...
                            v_isSharedCheck_863_ =
                                (!leanh::lean_is_exclusive(v___x_838_)) as u8;
                            if v_isSharedCheck_863_ == 0 {
                                v_unused_864_ = leanh::lean_ctor_get(v___x_838_, 0);
                            ...
                            leanh::lean_dec(v_mvarId_780_);
                            leanh::lean_dec(v_fvarId_779_);
                            v_a_865_ = leanh::lean_ctor_get(v___x_835_, 0);
                            v_isSharedCheck_872_ =
                                (!leanh::lean_is_exclusive(v___x_835_)) as u8;
                        ...
                        leanh::lean_dec_ref(v_binderType_831_);
                        leanh::lean_dec(v_a_823_);
                        leanh::lean_dec(v___y_784_);
                        leanh::lean_dec_ref(v___y_783_);
                        leanh::lean_dec(v___y_782_);
                        ...
                        leanh::lean_dec(v_mvarId_780_);
                        leanh::lean_dec(v_fvarId_779_);
                        v_a_873_ = leanh::lean_ctor_get(v___x_832_, 0);
                        v_isSharedCheck_880_ = (!leanh::lean_is_exclusive(v___x_832_)) as u8;
                    ...
                    if v_isShared_830_ == 0 {
                        leanh::lean_ctor_set(v___x_829_, 0, v___x_881_);
            ...
            8 => {
                ...
                if leanh::lean_obj_tag(v___x_843_) == 0 {
                    ...
                    v_isSharedCheck_854_ = (!leanh::lean_is_exclusive(v___x_843_)) as u8;
                    ...
                    v_a_855_ = leanh::lean_ctor_get(v___x_843_, 0);
                    v_isSharedCheck_862_ = (!leanh::lean_is_exclusive(v___x_843_)) as u8;
            ...
            9 => {
                if v_isShared_841_ == 0 {
                    leanh::lean_ctor_set_tag(v___x_840_, 1);
                    leanh::lean_ctor_set(v___x_840_, 0, v_a_844_);
            ...
            10 => {
                if v_isShared_847_ == 0 {
                    leanh::lean_ctor_set(v___x_846_, 0, v___x_849_);
                    v___x_851_ = v___x_846_;
                    state = 11;
                    continue;
                } else {
                    v_reuseFailAlloc_852_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_852_, 0, v___x_849_);
            ...
            23 => {
                if v_isShared_905_ == 0 {
                    ...
                    v_reuseFailAlloc_908_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_908_, 0, v_a_902_);
            ...
            25 => {
                if v_isShared_913_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_916_, 0, v_a_910_);
            ...
            27 => {
                ...
                if v_isShared_817_ == 0 {
                    leanh::lean_ctor_set(v___x_816_, 0, v___x_919_);
                    v___x_921_ = v___x_816_;
                    state = 28;
                    continue;
                } else {
                    v_reuseFailAlloc_922_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_922_, 0, v___x_919_);
            ...
            30 => {
                if v_isShared_938_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_941_, 0, v_a_935_);
...
pub unsafe fn l_Lean_Meta_Grind_injection_x3f___lam__0___boxed(
    mut v_fvarId_961_: *mut leanh::LeanObject,
    mut v_mvarId_962_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_injection_x3f(
    mut v_mvarId_969_: *mut leanh::LeanObject,
    mut v_fvarId_970_: *mut leanh::LeanObject,
    ...
    leanh::lean_inc(v_mvarId_969_);
    v___f_976_ = leanh::lean_alloc_closure(
        l_Lean_Meta_Grind_injection_x3f___lam__0___boxed as *mut core::ffi::c_void,
        7,
        2,
    );
    leanh::lean_closure_set(v___f_976_, 0, v_fvarId_970_);
    leanh::lean_closure_set(v___f_976_, 1, v_mvarId_969_);
...
pub unsafe fn l_Lean_Meta_Grind_injection_x3f___boxed(
    mut v_mvarId_978_: *mut leanh::LeanObject,
    mut v_fvarId_979_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0___boxed(
    mut v_mvarId_994_: *mut leanh::LeanObject,
    mut v_val_995_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v___y_997_);
    leanh::lean_dec_ref(v___y_996_);
    return v_res_1001_;
}
pub unsafe fn l_Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0(
    mut v_00_u03b2_1002_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2___boxed(
    mut v_00_u03b2_1014_: *mut leanh::LeanObject,
    ...
    v_x_5428__boxed_1020_ = leanh::lean_unbox_usize(v_x_1016_);
    leanh::lean_dec(v_x_1016_);
    v_x_5429__boxed_1021_ = leanh::lean_unbox_usize(v_x_1017_);
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2_spec__4(
    ...
    mut v_keys_1030_: *mut leanh::LeanObject,
    mut v_vals_1031_: *mut leanh::LeanObject,
    mut v_heq_1032_: *mut leanh::LeanObject,
    mut v_i_1033_: *mut leanh::LeanObject,
    mut v_entries_1034_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Lean_Data_PersistentHashMap_0__Lean_PersistentHashMap_insertAux_traverse___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2_spec__4___boxed(
    ...
    mut v_depth_1037_: *mut leanh::LeanObject,
    mut v_keys_1038_: *mut leanh::LeanObject,
    mut v_vals_1039_: *mut leanh::LeanObject,
    mut v_heq_1040_: *mut leanh::LeanObject,
    mut v_i_1041_: *mut leanh::LeanObject,
    mut v_entries_1042_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_depth_boxed_1043_: usize = 0;
    let mut v_res_1044_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_depth_boxed_1043_ = leanh::lean_unbox_usize(v_depth_1037_);
    leanh::lean_dec(v_depth_1037_);
    ...
    leanh::lean_dec_ref(v_vals_1039_);
    leanh::lean_dec_ref(v_keys_1038_);
    return v_res_1044_;
}
pub unsafe fn l_Lean_PersistentHashMap_insertAtCollisionNodeAux___at___00Lean_PersistentHashMap_insertAtCollisionNode___at___00Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_MVarId_assign___at___00Lean_Meta_Grind_injection_x3f_spec__0_spec__0_spec__2_spec__3_spec__4(
    mut v_00_u03b2_1045_: *mut leanh::LeanObject,
