    ...
    loop {
        match state {
            ...
            1 => {
                ...
                v___f_224_ = leanh::lean_alloc_closure(l_Lean_Meta_Sym_Arith_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__1 as *mut core::ffi::c_void, 2, 1);
                leanh::lean_closure_set(v___f_224_, 0, v_modifyCommSemiring_219_);
                v___f_225_ = leanh::lean_alloc_closure(l_Lean_Meta_Sym_Arith_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__2 as *mut core::ffi::c_void, 2, 1);
    ...
    loop {
        match state {
            ...
            1 => {
                ...
                v___f_242_ = leanh::lean_alloc_closure(l_Lean_Meta_Sym_Arith_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__1 as *mut core::ffi::c_void, 2, 1);
                leanh::lean_closure_set(v___f_242_, 0, v_modifyCommSemiring_237_);
                v___f_243_ = leanh::lean_alloc_closure(l_Lean_Meta_Sym_Arith_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__2 as *mut core::ffi::c_void, 2, 1);
