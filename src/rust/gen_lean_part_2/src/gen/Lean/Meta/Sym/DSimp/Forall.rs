...
pub static l_Lean_Meta_Sym_DSimp_dsimpForall___closed__0_value: leanh::LeanArrayObject<0> =
...
static mut l_Lean_Meta_Sym_DSimp_dsimpForall___closed__0: *mut leanh::LeanObject =
    ...
    loop {
        match state {
            0 => {
                ...
                v___f_360_ = leanh::lean_alloc_closure(l_Lean_Meta_withLocalDecl___at___00__private_Lean_Meta_Sym_DSimp_Forall_0__Lean_Meta_Sym_DSimp_dsimpForall_go_spec__0___redArg___lam__0___boxed as *mut core::ffi::c_void, 12, 6);
...
pub unsafe fn l___private_Lean_Meta_Sym_DSimp_Forall_0__Lean_Meta_Sym_DSimp_dsimpForall_go(
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_e_470_) == 7 {
                    ...
                    if leanh::lean_obj_tag(v___x_487_) == 0 {
                        ...
                        if leanh::lean_obj_tag(v___x_489_) == 0 {
                            ...
                            if leanh::lean_obj_tag(v_a_490_) == 0 {
                                ...
                                v___f_492_ = leanh::lean_alloc_closure(l___private_Lean_Meta_Sym_DSimp_Forall_0__Lean_Meta_Sym_DSimp_dsimpForall_go___lam__0___boxed as *mut core::ffi::c_void, 14, 3);
                                ...
                                v___f_496_ = leanh::lean_alloc_closure(l___private_Lean_Meta_Sym_DSimp_Forall_0__Lean_Meta_Sym_DSimp_dsimpForall_go___lam__1___boxed as *mut core::ffi::c_void, 13, 2);
...
pub unsafe fn initialize_Lean_Meta_Sym_DSimp_Forall(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
