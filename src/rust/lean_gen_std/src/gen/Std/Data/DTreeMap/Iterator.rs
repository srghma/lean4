...
// Module: Std.Data.DTreeMap.Iterator
// Imports: Std.Data.DTreeMap.Raw.Iterator
...
pub unsafe fn l_Std_DTreeMap_iter___redArg(
...
pub unsafe fn l_Std_DTreeMap_iter___redArg___boxed(
    mut v_m_45_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_46_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_46_ = l_Std_DTreeMap_iter___redArg(v_m_45_);
    crate::leanh::lean_dec(v_m_45_);
    return v_res_46_;
}
pub unsafe fn l_Std_DTreeMap_iter(
...
pub unsafe fn l_Std_DTreeMap_iter___boxed(
    ...
    v_res_56_ = l_Std_DTreeMap_iter(v_00_u03b1_52_, v_00_u03b2_53_, v_cmp_54_, v_m_55_);
    crate::leanh::lean_dec(v_m_55_);
    crate::leanh::lean_dec_ref(v_cmp_54_);
    return v_res_56_;
}
pub unsafe fn l_Std_DTreeMap_keysIter___redArg(
...
pub unsafe fn l_Std_DTreeMap_keysIter___redArg___boxed(
    mut v_m_59_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_60_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_60_ = l_Std_DTreeMap_keysIter___redArg(v_m_59_);
    crate::leanh::lean_dec(v_m_59_);
    return v_res_60_;
}
pub unsafe fn l_Std_DTreeMap_keysIter(
...
pub unsafe fn l_Std_DTreeMap_keysIter___boxed(
    ...
    v_res_70_ = l_Std_DTreeMap_keysIter(v_00_u03b1_66_, v_00_u03b2_67_, v_cmp_68_, v_m_69_);
    crate::leanh::lean_dec(v_m_69_);
    crate::leanh::lean_dec_ref(v_cmp_68_);
    return v_res_70_;
}
pub unsafe fn l_Std_DTreeMap_valuesIter___redArg(
...
pub unsafe fn l_Std_DTreeMap_valuesIter___redArg___boxed(
    mut v_m_73_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_74_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_74_ = l_Std_DTreeMap_valuesIter___redArg(v_m_73_);
    crate::leanh::lean_dec(v_m_73_);
    return v_res_74_;
}
pub unsafe fn l_Std_DTreeMap_valuesIter(
...
pub unsafe fn l_Std_DTreeMap_valuesIter___boxed(
    ...
    v_res_84_ = l_Std_DTreeMap_valuesIter(v_00_u03b1_80_, v_00_u03b2_81_, v_cmp_82_, v_m_83_);
    crate::leanh::lean_dec(v_m_83_);
    crate::leanh::lean_dec_ref(v_cmp_82_);
    return v_res_84_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Data_DTreeMap_Iterator(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_DTreeMap_Iterator(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_DTreeMap_Iterator(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
    ...
    crate::leanh::lean_dec_ref(res);
    res = meta_initialize_Std_Data_DTreeMap_Iterator(builtin);
    if crate::leanh::lean_io_result_is_error(res) {
        return res;
    }
    crate::leanh::lean_dec_ref(res);
    return initialize_Std_Data_DTreeMap_Iterator(builtin);
}
