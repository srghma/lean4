...
// Imports: Std.Do.Internal.Ensures.Def Init.Control.Lawful.MonadAttach.Lemmas Init.RCases
...
pub unsafe fn runtime_initialize_Std_Do_Internal_Ensures_Lemmas(
    builtin: u8,
...
pub unsafe fn meta_initialize_Std_Do_Internal_Ensures_Lemmas(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Do_Internal_Ensures_Lemmas(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
