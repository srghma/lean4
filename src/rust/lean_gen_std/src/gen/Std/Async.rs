...
// Module: Std.Async
// Imports: Std.Async.Basic Std.Async.ContextAsync Std.Async.Timer Std.Async.TCP Std.Async.UDP Std.Async.DNS Std.Async.Select Std.Async.Process Std.Async.System Std.Async.Signal Std.Async.IO
use crate::r#gen::Std::Async::Basic::{
    initialize_Std_Async_Basic, runtime_initialize_Std_Async_Basic,
};
use crate::r#gen::Std::Async::ContextAsync::{
    initialize_Std_Async_ContextAsync, runtime_initialize_Std_Async_ContextAsync,
};
use crate::r#gen::Std::Async::DNS::{initialize_Std_Async_DNS, runtime_initialize_Std_Async_DNS};
use crate::r#gen::Std::Async::IO::{initialize_Std_Async_IO, runtime_initialize_Std_Async_IO};
use crate::r#gen::Std::Async::Process::{
    initialize_Std_Async_Process, runtime_initialize_Std_Async_Process,
};
use crate::r#gen::Std::Async::Select::{
    initialize_Std_Async_Select, runtime_initialize_Std_Async_Select,
};
use crate::r#gen::Std::Async::Signal::{
    initialize_Std_Async_Signal, runtime_initialize_Std_Async_Signal,
};
use crate::r#gen::Std::Async::System::{
    initialize_Std_Async_System, runtime_initialize_Std_Async_System,
};
...
use crate::r#gen::Std::Async::UDP::{initialize_Std_Async_UDP, runtime_initialize_Std_Async_UDP};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Async(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Async(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Async(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
