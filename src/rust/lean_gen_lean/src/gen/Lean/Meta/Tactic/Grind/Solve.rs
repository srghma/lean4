...
pub unsafe fn l_Lean_Meta_Grind_solve(
    mut v_goal_76_: *mut crate::leanh::LeanObject,
    ...
    mut v_a_85_: *mut crate::leanh::LeanObject,
    ...
    let mut v_a_91_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_gs_99_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_108_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_114_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_118_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_126_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_128_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_129_: u8 = 0;
    let mut v_ref_130_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v___x_87_ = crate::leanh::lean_unsigned_to_nat(10000);
                v___x_88_ = l_Lean_Meta_Grind_Action_mkFinish(v___x_87_);
                if crate::leanh::lean_obj_tag(v___x_88_) == 0 {
                    v_a_89_ = crate::leanh::lean_ctor_get(v___x_88_, 0);
                    crate::leanh::lean_inc(v_a_89_);
                    crate::leanh::lean_dec_ref_known(v___x_88_, 1);
                    crate::leanh::lean_inc_ref(v_goal_76_);
                    ...
                    if crate::leanh::lean_obj_tag(v___x_90_) == 0 {
                        v_a_91_ = crate::leanh::lean_ctor_get(v___x_90_, 0);
                        v_isSharedCheck_117_ = (!crate::leanh::lean_is_exclusive(v___x_90_)) as u8;
                        if v_isSharedCheck_117_ == 0 {
                            ...
                            crate::leanh::lean_inc(v_a_91_);
                            crate::leanh::lean_dec(v___x_90_);
                        ...
                        crate::leanh::lean_dec_ref(v_goal_76_);
                        v_a_118_ = crate::leanh::lean_ctor_get(v___x_90_, 0);
                        v_isSharedCheck_125_ = (!crate::leanh::lean_is_exclusive(v___x_90_)) as u8;
                    ...
                    crate::leanh::lean_dec_ref(v_goal_76_);
                    v_a_126_ = crate::leanh::lean_ctor_get(v___x_88_, 0);
                    v_isSharedCheck_138_ = (!crate::leanh::lean_is_exclusive(v___x_88_)) as u8;
                    if v_isSharedCheck_138_ == 0 {
                        ...
                        crate::leanh::lean_inc(v_a_126_);
                        crate::leanh::lean_dec(v___x_88_);
            ...
            1 => {
                if crate::leanh::lean_obj_tag(v_a_91_) == 0 {
                    crate::leanh::lean_dec_ref_known(v_a_91_, 1);
                    crate::leanh::lean_dec_ref(v_goal_76_);
                    v___x_95_ = crate::leanh::lean_box(0);
                    if v_isShared_94_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_93_, 0, v___x_95_);
                        v___x_97_ = v___x_93_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_98_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_98_, 0, v___x_95_);
                        v___x_97_ = v_reuseFailAlloc_98_;
                        state = 2;
                        continue;
                    }
                } else {
                    v_gs_99_ = crate::leanh::lean_ctor_get(v_a_91_, 0);
                    v_isSharedCheck_116_ = (!crate::leanh::lean_is_exclusive(v_a_91_)) as u8;
            ...
            3 => {
                if crate::leanh::lean_obj_tag(v_gs_99_) == 1 {
                    crate::leanh::lean_dec_ref(v_goal_76_);
                    v_head_103_ = crate::leanh::lean_ctor_get(v_gs_99_, 0);
                    crate::leanh::lean_inc(v_head_103_);
                    crate::leanh::lean_dec_ref_known(v_gs_99_, 2);
                    if v_isShared_102_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_101_, 0, v_head_103_);
                        v___x_105_ = v___x_101_;
                        state = 4;
                        continue;
                    } else {
                        v_reuseFailAlloc_109_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_109_, 0, v_head_103_);
                        v___x_105_ = v_reuseFailAlloc_109_;
                        state = 4;
                        continue;
                    }
                } else {
                    crate::leanh::lean_dec(v_gs_99_);
                    if v_isShared_102_ == 0 {
                        crate::leanh::lean_ctor_set(v___x_101_, 0, v_goal_76_);
                        v___x_111_ = v___x_101_;
                        state = 6;
                        continue;
                    } else {
                        v_reuseFailAlloc_115_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        crate::leanh::lean_ctor_set(v_reuseFailAlloc_115_, 0, v_goal_76_);
            ...
            4 => {
                if v_isShared_94_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_93_, 0, v___x_105_);
                    v___x_107_ = v___x_93_;
                    state = 5;
                    continue;
                } else {
                    v_reuseFailAlloc_108_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_108_, 0, v___x_105_);
            ...
            6 => {
                if v_isShared_94_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_93_, 0, v___x_111_);
                    v___x_113_ = v___x_93_;
                    state = 7;
                    continue;
                } else {
                    v_reuseFailAlloc_114_ = crate::leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_114_, 0, v___x_111_);
            ...
            8 => {
                if v_isShared_121_ == 0 {
                    ...
                    v_reuseFailAlloc_124_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_124_, 0, v_a_118_);
            ...
            10 => {
                v_ref_130_ = crate::leanh::lean_ctor_get(v_a_84_, 5);
                v___x_131_ = lean_io_error_to_string(v_a_126_);
                v___x_132_ = crate::leanh::lean_alloc_ctor(3, 1, (0) as u32);
                crate::leanh::lean_ctor_set(v___x_132_, 0, v___x_131_);
                v___x_133_ = l_Lean_MessageData_ofFormat(v___x_132_);
                crate::leanh::lean_inc(v_ref_130_);
                v___x_134_ = crate::leanh::lean_alloc_ctor(0, 2, (0) as u32);
                crate::leanh::lean_ctor_set(v___x_134_, 0, v_ref_130_);
                crate::leanh::lean_ctor_set(v___x_134_, 1, v___x_133_);
                if v_isShared_129_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_128_, 0, v___x_134_);
                    v___x_136_ = v___x_128_;
                    state = 11;
                    continue;
                } else {
                    v_reuseFailAlloc_137_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_137_, 0, v___x_134_);
...
pub unsafe fn l_Lean_Meta_Grind_solve___boxed(
    mut v_goal_139_: *mut crate::leanh::LeanObject,
    ...
    mut v_a_147_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec_ref(v_a_147_);
    crate::leanh::lean_dec(v_a_146_);
    crate::leanh::lean_dec_ref(v_a_145_);
    crate::leanh::lean_dec(v_a_144_);
    crate::leanh::lean_dec_ref(v_a_143_);
