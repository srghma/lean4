...
pub static mut l_Lean_instToLevel: *mut crate::leanh::LeanObject = core::ptr::null_mut();
pub unsafe fn _init_l_Lean_instToLevel() -> *mut crate::leanh::LeanObject {
    let mut v___x_10_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_10_ = crate::leanh::lean_box(0);
    return v___x_10_;
}
pub unsafe fn l_Lean_instToLevel__1(
    mut v_inst_11_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Lean_ToLevel_max(
    ...
    mut v_inst_14_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn runtime_initialize_Lean_ToLevel(builtin: u8) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_mark_persistent(l_Lean_instToLevel);
    return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
}
static mut _G_meta_initialized: bool = false;
pub unsafe fn meta_initialize_Lean_ToLevel(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_ToLevel(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
