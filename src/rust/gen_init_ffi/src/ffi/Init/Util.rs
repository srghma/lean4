...
use leanh_l1::{
    ...
    emitted::{
        lean_box::lean_box, lean_is_exclusive::lean_is_exclusive, lean_is_scalar::lean_is_scalar,
        lean_mk_string::lean_mk_string,
    },
    r#priv::{
        lean_is_shared::lean_is_shared, lean_string_cstr::lean_string_cstr,
...
#[inline]
pub unsafe fn lean_is_exclusive_obj(o: *mut LeanObject) -> bool {
    lean_is_exclusive(o)
}
