...
extern "C" {
    ...
    fn lean_closure_byte_size(o: *mut LeanObject) -> usize;
    fn lean_small_object_size(o: *mut LeanObject) -> usize;
    fn lean_array_data_byte_size(o: *mut LeanObject) -> usize;
    fn lean_sarray_data_byte_size(o: *mut LeanObject) -> usize;
    fn lean_string_data_byte_size(o: *mut LeanObject) -> usize;
    fn lean_closure_data_byte_size(o: *mut LeanObject) -> usize;
    ...
    fn initialize_ir_interpreter_cxx();
    #[link_name = "_ZN4lean23finalize_ir_interpreterEv"]
    fn finalize_ir_interpreter_cxx();
...
pub unsafe fn lean_alloc_ctor(tag: c_uint, num_objs: c_uint, scalar_sz: c_uint) -> *mut LeanObject {
...
pub unsafe extern "C" fn lean_array_cptr_export(obj: *mut LeanObject) -> *mut *mut LeanObject {
    (obj as *mut u8).add(core::mem::size_of::<LeanArrayObject>()) as *mut *mut LeanObject
}
...
pub unsafe extern "C" fn lean_closure_set(obj: *mut LeanObject, i: c_uint, value: *mut LeanObject) {
    *lean_closure_arg_cptr(obj).add(i as usize) = value;
}
...
unsafe fn lean_name_hash_ptr_rs(n: *mut LeanObject) -> u64 {
    ...
    *((n as *const u8).add(2 * core::mem::size_of::<*mut LeanObject>()) as *const u64)
}

#[inline]
unsafe fn lean_string_bytes_eq(s1: *mut LeanObject, s2: *mut LeanObject) -> bool {
    let len1 = core::ffi::CStr::from_ptr(lean_string_cstr(s1)).to_bytes();
    let len2 = core::ffi::CStr::from_ptr(lean_string_cstr(s2)).to_bytes();
    len1 == len2
}

#[export_name = "lean_string_hash"]
pub unsafe extern "C" fn lean_string_hash_export(s: *mut LeanObject) -> u64 {
    let len = core::ffi::CStr::from_ptr(lean_string_cstr(s)).to_bytes().len();
...
pub unsafe extern "C" fn lean_name_eq(mut n1: *mut LeanObject, mut n2: *mut LeanObject) -> u8 {
    ...
    loop {
        ...
        } else if !crate::runtime_object_nat_int_impl::lean_nat_big_eq(lean_ctor_get(n1, 1), lean_ctor_get(n2, 1)) {
            return 0;
        }
...
unsafe fn initialize_library_module_body() {
    ...
    initialize_dynlib();
    initialize_ir_interpreter_cxx();
}

unsafe fn finalize_library_module_body() {
    finalize_ir_interpreter_cxx();
    finalize_time_task();
...
pub extern "C" fn lean_cxx_initialize_time_task() {
    unsafe { initialize_time_task(); }
}

#[no_mangle]
pub extern "C" fn lean_cxx_finalize_time_task() {
    unsafe { finalize_time_task(); }
}
