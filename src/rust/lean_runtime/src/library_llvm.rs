...
mod library_llvm_impl {
    ...
    extern "C" {
        ...
        fn LLVMBuildCall2(builder: usize, ty: usize, fnval: usize, args: *const usize, num_args: usize, name: *const core::ffi::c_char) -> usize;
        ...
        fn LLVMBuildGlobalString(builder: usize, string: *const core::ffi::c_char, name: *const core::ffi::c_char) -> usize;
        fn LLVMGetUndef(ty: usize) -> usize;
        fn LLVMSetInitializer(global: usize, initializer: usize);
        fn LLVMFunctionType(return_ty: usize, args: *const usize, num_args: usize, is_var_arg: u8) -> usize;
        ...
        fn LLVMAppendBasicBlockInContext(ctx: usize, fnval: usize, name: *const core::ffi::c_char) -> usize;
        ...
        fn LLVMBuildLoad2(builder: usize, ty: usize, slot: usize, name: *const core::ffi::c_char) -> usize;
        ...
        fn LLVMBuildInBoundsGEP2(builder: usize, ty: usize, pointer: usize, indices: *const usize, num_indices: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildGEP2(builder: usize, ty: usize, pointer: usize, indices: *const usize, num_indices: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildSExt(builder: usize, val: usize, dest_ty: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildZExt(builder: usize, val: usize, dest_ty: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildTrunc(builder: usize, val: usize, dest_ty: usize, name: *const core::ffi::c_char) -> usize;
        ...
        fn LLVMBuildPtrToInt(builder: usize, ptr: usize, dest_ty: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildMul(builder: usize, lhs: usize, rhs: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildAdd(builder: usize, lhs: usize, rhs: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildSub(builder: usize, lhs: usize, rhs: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildNot(builder: usize, v: usize, name: *const core::ffi::c_char) -> usize;
        fn LLVMBuildICmp(builder: usize, predicate: core::ffi::c_uint, x: usize, y: usize, name: *const core::ffi::c_char) -> usize;
        ...
        fn LLVMConstStringInContext(ctx: usize, string: *const core::ffi::c_char, len: usize, dont_null_terminate: u8) -> usize;
        ...
        fn LLVMCreateMemoryBufferWithContentsOfFile(path: *const core::ffi::c_char, out: *mut usize, err: *mut *mut core::ffi::c_char) -> core::ffi::c_int;
        fn LLVMParseBitcodeInContext(ctx: usize, membuf: usize, out_module: *mut usize, err: *mut *mut core::ffi::c_char) -> core::ffi::c_int;
        fn LLVMLinkModules2(dest: usize, src: usize) -> core::ffi::c_int;
        fn LLVMCreateTargetMachine(target: usize, triple: *const core::ffi::c_char, cpu: *const core::ffi::c_char, features: *const core::ffi::c_char, opt_level: core::ffi::c_uint, reloc_mode: core::ffi::c_uint, code_model: core::ffi::c_uint) -> usize;
        fn LLVMGetTargetFromTriple(triple: *const core::ffi::c_char, out_target: *mut usize, out_err: *mut *mut core::ffi::c_char) -> core::ffi::c_int;
        fn LLVMGetDefaultTargetTriple() -> *mut core::ffi::c_char;
        fn LLVMTargetMachineEmitToFile(target_machine: usize, module: usize, filepath: *mut core::ffi::c_char, codegen_type: core::ffi::c_uint, err_msg: *mut *mut core::ffi::c_char) -> core::ffi::c_int;
        ...
        fn LLVMVerifyModule(module: usize, action: core::ffi::c_uint, err: *mut *mut core::ffi::c_char) -> core::ffi::c_int;
        ...
        fn LLVMCreateStringAttribute(ctx: usize, key: *const core::ffi::c_char, key_len: usize, value: *const core::ffi::c_char, value_len: usize) -> usize;
        fn LLVMModuleCreateWithNameInContext(name: *const core::ffi::c_char, ctx: usize) -> usize;
        fn LLVMWriteBitcodeToFile(module: usize, path: *const core::ffi::c_char) -> core::ffi::c_int;
        fn LLVMPrintModuleToString(module: usize) -> *mut core::ffi::c_char;
        fn LLVMPrintModuleToFile(module: usize, path: *const core::ffi::c_char, err_msg: *mut *mut core::ffi::c_char) -> core::ffi::c_int;
    ...
    fn llvm_unavailable() -> ! {
        panic!("Please build a version of Lean4 with -DLLVM=ON to invoke the LLVM backend function.");
    }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_call2_impl(builder: usize, ty: usize, fnval: usize, args: Vec<usize>, name: *mut LeanObject) -> usize {
        LLVMBuildCall2(builder, ty, fnval, args.as_ptr(), args.len(), lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_call2_impl(_builder: usize, _ty: usize, _fnval: usize, _args: Vec<usize>, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_cond_br_impl(builder: usize, cond: usize, thenbb: usize, elsebb: usize) -> usize {
        LLVMBuildCondBr(builder, cond, thenbb, elsebb)
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_cond_br_impl(_builder: usize, _cond: usize, _thenbb: usize, _elsebb: usize) -> usize {
        llvm_unavailable()
    }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_load2_impl(builder: usize, ty: usize, slot: usize, name: *mut LeanObject) -> usize {
        LLVMBuildLoad2(builder, ty, slot, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_load2_impl(_builder: usize, _ty: usize, _slot: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_inbounds_gep2_impl(builder: usize, ty: usize, pointer: usize, indices: Vec<usize>, name: *mut LeanObject) -> usize {
        LLVMBuildInBoundsGEP2(builder, ty, pointer, indices.as_ptr(), indices.len(), lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_inbounds_gep2_impl(_builder: usize, _ty: usize, _pointer: usize, _indices: Vec<usize>, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_gep2_impl(builder: usize, ty: usize, pointer: usize, indices: Vec<usize>, name: *mut LeanObject) -> usize {
        LLVMBuildGEP2(builder, ty, pointer, indices.as_ptr(), indices.len(), lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_gep2_impl(_builder: usize, _ty: usize, _pointer: usize, _indices: Vec<usize>, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_sext_impl(builder: usize, val: usize, ty: usize, name: *mut LeanObject) -> usize {
        LLVMBuildSExt(builder, val, ty, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_sext_impl(_builder: usize, _val: usize, _ty: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_zext_impl(builder: usize, val: usize, ty: usize, name: *mut LeanObject) -> usize {
        LLVMBuildZExt(builder, val, ty, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_zext_impl(_builder: usize, _val: usize, _ty: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_sext_or_trunc_impl(builder: usize, val: usize, dest_ty: usize, name: *mut LeanObject) -> usize {
    ...
    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_sext_or_trunc_impl(_builder: usize, _val: usize, _dest_ty: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_switch_impl(builder: usize, val: usize, elsebb: usize, num_cases: usize) -> usize {
        LLVMBuildSwitch(builder, val, elsebb, num_cases)
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_switch_impl(_builder: usize, _val: usize, _elsebb: usize, _num_cases: usize) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_ptr_to_int_impl(builder: usize, ptr: usize, dest_ty: usize, name: *mut LeanObject) -> usize {
        LLVMBuildPtrToInt(builder, ptr, dest_ty, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_ptr_to_int_impl(_builder: usize, _ptr: usize, _dest_ty: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_mul_impl(builder: usize, lhs: usize, rhs: usize, name: *mut LeanObject) -> usize {
        LLVMBuildMul(builder, lhs, rhs, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_mul_impl(_builder: usize, _lhs: usize, _rhs: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_add_impl(builder: usize, lhs: usize, rhs: usize, name: *mut LeanObject) -> usize {
        LLVMBuildAdd(builder, lhs, rhs, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_add_impl(_builder: usize, _lhs: usize, _rhs: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_sub_impl(builder: usize, lhs: usize, rhs: usize, name: *mut LeanObject) -> usize {
        LLVMBuildSub(builder, lhs, rhs, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_sub_impl(_builder: usize, _lhs: usize, _rhs: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_icmp_impl(builder: usize, predicate: usize, x: usize, y: usize, name: *mut LeanObject) -> usize {
        LLVMBuildICmp(builder, predicate as core::ffi::c_uint, x, y, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_icmp_impl(_builder: usize, _predicate: usize, _x: usize, _y: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }
    ...
    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_add_case_impl(_switch_: usize, _on_val: usize, _destbb: usize) -> *mut LeanObject {
        llvm_unavailable()
    }
    ...
    unsafe fn llvm_create_memory_buffer_with_contents_of_file_impl(path: *mut LeanObject) -> usize {
        ...
        let is_error = LLVMCreateMemoryBufferWithContentsOfFile(path_cstr, &mut membuf, &mut err_str);
        if is_error != 0 {
            if !err_str.is_null() {
                eprintln!(
    ...
    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_create_memory_buffer_with_contents_of_file_impl(_path: *mut LeanObject) -> usize {
        llvm_unavailable()
    }
    ...
    unsafe fn llvm_parse_bitcode_impl(ctx: usize, membuf: usize) -> usize {
        ...
        if is_error != 0 {
            if !err_str.is_null() {
                eprintln!("LLVMParseBitcodeInContext failed: {}", CStr::from_ptr(err_str).to_string_lossy());
                LLVMDisposeMessage(err_str);
            }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_create_target_machine_impl(target: usize, triple: *mut LeanObject, cpu: *mut LeanObject, features: *mut LeanObject) -> usize {
    ...
    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_create_target_machine_impl(_target: usize, _triple: *mut LeanObject, _cpu: *mut LeanObject, _features: *mut LeanObject) -> usize {
        llvm_unavailable()
    }
    ...
    unsafe fn llvm_target_machine_emit_to_file_impl(
        ...
        let mut err_msg: *mut core::ffi::c_char = core::ptr::null_mut();
        let mut filepath_cstr = lean_string_cstr(filepath) as *const core::ffi::c_char as *mut core::ffi::c_char;
        ...
        if is_error != 0 {
            if !err_msg.is_null() {
                eprintln!("LLVMTargetMachineEmitToFile failed: {}", CStr::from_ptr(err_msg).to_string_lossy());
                LLVMDisposeMessage(err_msg);
            }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_create_string_attribute_impl(ctx: usize, key: *mut LeanObject, value: *mut LeanObject) -> usize {
        LLVMCreateStringAttribute(ctx, lean_string_cstr(key), lean_string_len(key), lean_string_cstr(value), lean_string_len(value))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_create_string_attribute_impl(_ctx: usize, _key: *mut LeanObject, _value: *mut LeanObject) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_add_attribute_at_index_impl(fnval: usize, idx: usize, attr: usize) -> *mut LeanObject {
        LLVMAddAttributeAtIndex(fnval, idx as u64, attr);
        lean_box(0)
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_add_attribute_at_index_impl(_fnval: usize, _idx: usize, _attr: usize) -> *mut LeanObject {
        llvm_unavailable()
    }
    ...
    unsafe fn llvm_get_first_instruction_impl(bb: usize) -> *mut LeanObject {
        ...
        if instr == 0 { llvm_option_none() } else { llvm_option_some(instr) }
    }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_add_function_impl(_ctx: usize, module: usize, name: *mut LeanObject, ty: usize) -> usize {
        LLVMAddFunction(module, lean_string_cstr(name), ty)
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_add_function_impl(_ctx: usize, _module: usize, _name: *mut LeanObject, _ty: usize) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_get_named_function_impl(_ctx: usize, module: usize, name: *mut LeanObject) -> *mut LeanObject {
        let result = LLVMGetNamedFunction(module, lean_string_cstr(name));
        if result == 0 { llvm_option_none() } else { llvm_option_some(result) }
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_get_named_function_impl(_ctx: usize, _module: usize, _name: *mut LeanObject) -> *mut LeanObject {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_add_global_impl(_ctx: usize, module: usize, name: *mut LeanObject, ty: usize) -> usize {
        LLVMAddGlobal(module, ty, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_add_global_impl(_ctx: usize, _module: usize, _name: *mut LeanObject, _ty: usize) -> usize {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_get_named_global_impl(_ctx: usize, module: usize, name: *mut LeanObject) -> *mut LeanObject {
        let result = LLVMGetNamedGlobal(module, lean_string_cstr(name));
        if result == 0 { llvm_option_none() } else { llvm_option_some(result) }
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_get_named_global_impl(_ctx: usize, _module: usize, _name: *mut LeanObject) -> *mut LeanObject {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_build_global_string_impl(_ctx: usize, builder: usize, string: *mut LeanObject, name: *mut LeanObject) -> usize {
        LLVMBuildGlobalString(builder, lean_string_cstr(string), lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_build_global_string_impl(_ctx: usize, _builder: usize, _string: *mut LeanObject, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_set_initializer_impl(_ctx: usize, global: usize, initializer: usize) -> *mut LeanObject {
        LLVMSetInitializer(global, initializer);
        lean_box(0)
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_set_initializer_impl(_ctx: usize, _global: usize, _initializer: usize) -> *mut LeanObject {
        llvm_unavailable()
    }

    #[cfg(lean_has_llvm)]
    unsafe fn llvm_function_type_impl(_ctx: usize, return_ty: usize, arg_tys: *mut LeanObject, is_var_arg: u8) -> usize {
        let tys = llvm_type_array(arg_tys);
        LLVMFunctionType(return_ty, tys.as_ptr(), tys.len(), is_var_arg)
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_function_type_impl(_ctx: usize, _return_ty: usize, _arg_tys: *mut LeanObject, _is_var_arg: u8) -> usize {
        llvm_unavailable()
    }
    ...
    #[cfg(lean_has_llvm)]
    unsafe fn llvm_append_basic_block_in_context_impl(ctx: usize, function: usize, name: *mut LeanObject) -> usize {
        LLVMAppendBasicBlockInContext(ctx, function, lean_string_cstr(name))
    }

    #[cfg(not(lean_has_llvm))]
    unsafe fn llvm_append_basic_block_in_context_impl(_ctx: usize, _function: usize, _name: *mut LeanObject) -> usize {
        llvm_unavailable()
    }
    ...
    pub unsafe extern "C" fn lean_llvm_build_cond_br(p0: *mut LeanObject, p1: *mut LeanObject, p2: *mut LeanObject, p3: *mut LeanObject, p4: *mut LeanObject) -> usize {
        llvm_build_cond_br_impl(lean_unbox(p1), lean_unbox(p2), lean_unbox(p3), lean_unbox(p4))
    }
    ...
    pub unsafe extern "C" fn lean_llvm_build_switch(p0: *mut LeanObject, p1: *mut LeanObject, p2: *mut LeanObject, p3: *mut LeanObject, p4: *mut LeanObject) -> usize {
        llvm_build_switch_impl(lean_unbox(p1), lean_unbox(p2), lean_unbox(p3), lean_unbox(p4))
    }
    ...
    pub unsafe extern "C" fn lean_llvm_build_icmp(p0: *mut LeanObject, p1: *mut LeanObject, p2: *mut LeanObject, p3: *mut LeanObject, p4: *mut LeanObject, p5: *mut LeanObject) -> usize {
        llvm_build_icmp_impl(lean_unbox(p1), lean_unbox(p2), lean_unbox(p3), lean_unbox(p4), p5)
    }
