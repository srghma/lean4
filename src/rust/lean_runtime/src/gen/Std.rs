...
use crate::r#gen::Std::Internal::{initialize_Std_Internal, runtime_initialize_Std_Internal};
use crate::r#gen::Std::Net::{initialize_Std_Net, runtime_initialize_Std_Net};
use crate::r#gen::Std::Sat::{initialize_Std_Sat, runtime_initialize_Std_Sat};
use crate::r#gen::Std::Sync::{initialize_Std_Sync, runtime_initialize_Std_Sync};
use crate::r#gen::Std::Tactic::{initialize_Std_Tactic, runtime_initialize_Std_Tactic};
use crate::r#gen::Std::Time::{initialize_Std_Time, runtime_initialize_Std_Time};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
