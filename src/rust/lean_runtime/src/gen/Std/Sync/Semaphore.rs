...
static mut l_Std_Semaphore_new___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Std_Semaphore_new___closed__0: *mut LeanObject = core::ptr::null_mut();
pub static l_Std_Semaphore_acquire___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Std_Semaphore_acquire___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Semaphore_acquire___closed__0_value) as *mut LeanObject;
pub static l_Std_Semaphore_tryAcquire___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
            + core::mem::size_of::<*const core::ffi::c_void>()
...
static mut l_Std_Semaphore_tryAcquire___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Semaphore_tryAcquire___closed__0_value) as *mut LeanObject;
pub static l_Std_Semaphore_release___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
            + core::mem::size_of::<*const core::ffi::c_void>()
...
static mut l_Std_Semaphore_release___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Semaphore_release___closed__0_value) as *mut LeanObject;
pub static l_Std_Semaphore_availablePermits___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Std_Semaphore_availablePermits___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Semaphore_availablePermits___closed__0_value) as *mut LeanObject;
...
pub unsafe fn _init_l_Std_Semaphore_new___closed__0() -> *mut LeanObject {
    let mut v___x_196_: *mut LeanObject = core::ptr::null_mut();
    v___x_196_ = l_Std_Queue_empty(lean_box(0));
    return v___x_196_;
}
pub unsafe fn l_Std_Semaphore_new(mut v_permits_197_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Semaphore_acquire_spec__0___redArg(
    mut v_mutex_205_: *mut LeanObject,
    mut v_k_206_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_ref_208_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mutex_209_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_ref_208_ = lean_ctor_get(v_mutex_205_, 0);
    lean_inc(v_ref_208_);
    v_mutex_209_ = lean_ctor_get(v_mutex_205_, 1);
    lean_inc(v_mutex_209_);
    lean_dec_ref(v_mutex_205_);
    v___x_210_ = lean_io_basemutex_lock(v_mutex_209_);
    v___x_211_ = lean_apply_2(v_k_206_, v_ref_208_, lean_box(0));
    v___x_212_ = lean_io_basemutex_unlock(v_mutex_209_);
    lean_dec(v_mutex_209_);
    return v___x_211_;
}
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Semaphore_acquire_spec__0___redArg___boxed(
    mut v_mutex_213_: *mut LeanObject,
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Semaphore_acquire_spec__0(
    ...
    mut v_mutex_219_: *mut LeanObject,
    mut v_k_220_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Semaphore_acquire_spec__0___boxed(
    ...
    mut v_mutex_225_: *mut LeanObject,
...
pub unsafe fn l_Std_Semaphore_acquire___lam__0(mut v___y_229_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_231_: *mut LeanObject = core::ptr::null_mut();
    let mut v_permits_232_: *mut LeanObject = core::ptr::null_mut();
    let mut v_waiters_233_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_permits_232_ = lean_ctor_get(v___x_231_, 0);
                v_waiters_233_ = lean_ctor_get(v___x_231_, 1);
                v_isSharedCheck_253_ = (!lean_is_exclusive(v___x_231_)) as u8;
                if v_isSharedCheck_253_ == 0 {
                    ...
                    lean_inc(v_waiters_233_);
                    lean_inc(v_permits_232_);
                    lean_dec(v___x_231_);
            ...
            1 => {
                v___x_237_ = lean_unsigned_to_nat(0);
                ...
                if v___x_238_ == 0 {
                    ...
                    if v_isShared_236_ == 0 {
                        ...
                        lean_ctor_set(v_reuseFailAlloc_244_, 0, v_permits_232_);
                    ...
                    if v_isShared_236_ == 0 {
                        ...
                        lean_ctor_set(v_reuseFailAlloc_252_, 1, v_waiters_233_);
...
pub unsafe fn l_Std_Semaphore_acquire(mut v_sem_258_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_Semaphore_tryAcquire___lam__0(mut v___y_265_: *mut LeanObject) -> u8 {
    let mut v___x_267_: *mut LeanObject = core::ptr::null_mut();
    let mut v_permits_268_: *mut LeanObject = core::ptr::null_mut();
    let mut v_waiters_269_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_permits_268_ = lean_ctor_get(v___x_267_, 0);
                v_waiters_269_ = lean_ctor_get(v___x_267_, 1);
                v_isSharedCheck_281_ = (!lean_is_exclusive(v___x_267_)) as u8;
                if v_isSharedCheck_281_ == 0 {
                    ...
                    lean_inc(v_waiters_269_);
                    lean_inc(v_permits_268_);
                    lean_dec(v___x_267_);
            ...
            1 => {
                v___x_273_ = lean_unsigned_to_nat(0);
                v___x_274_ = lean_nat_dec_lt(v___x_273_, v_permits_268_);
                if v___x_274_ == 0 {
                    lean_del_object(v___x_271_);
                    lean_dec_ref(v_waiters_269_);
                    lean_dec(v_permits_268_);
                    return v___x_274_;
                } else {
                    ...
                    if v_isShared_272_ == 0 {
                        ...
                        lean_ctor_set(v_reuseFailAlloc_280_, 1, v_waiters_269_);
...
pub unsafe fn l_Std_Semaphore_tryAcquire(mut v_sem_287_: *mut LeanObject) -> u8 {
...
pub unsafe fn l_Std_Semaphore_release___lam__0(mut v___y_296_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_298_: *mut LeanObject = core::ptr::null_mut();
    let mut v_permits_299_: *mut LeanObject = core::ptr::null_mut();
    let mut v_waiters_300_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_snd_317_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_permits_299_ = lean_ctor_get(v___x_298_, 0);
                v_waiters_300_ = lean_ctor_get(v___x_298_, 1);
                v_isSharedCheck_326_ = (!lean_is_exclusive(v___x_298_)) as u8;
                if v_isSharedCheck_326_ == 0 {
                    ...
                    lean_inc(v_waiters_300_);
                    lean_inc(v_permits_299_);
                    lean_dec(v___x_298_);
            ...
            1 => {
                ...
                if lean_obj_tag(v___x_304_) == 0 {
                    ...
                    if v_isShared_303_ == 0 {
                        ...
                        v_reuseFailAlloc_311_ = lean_alloc_ctor(0, 2, (0) as u32);
                        lean_ctor_set(v_reuseFailAlloc_311_, 0, v___x_306_);
                        lean_ctor_set(v_reuseFailAlloc_311_, 1, v_waiters_300_);
                        v___x_308_ = v_reuseFailAlloc_311_;
                        state = 2;
                        continue;
                    }
                } else {
                    lean_dec_ref(v_waiters_300_);
                    v_val_312_ = lean_ctor_get(v___x_304_, 0);
                    v_isSharedCheck_325_ = (!lean_is_exclusive(v___x_304_)) as u8;
            ...
            3 => {
                v_fst_316_ = lean_ctor_get(v_val_312_, 0);
                lean_inc(v_fst_316_);
                v_snd_317_ = lean_ctor_get(v_val_312_, 1);
                lean_inc(v_snd_317_);
                lean_dec(v_val_312_);
                if v_isShared_303_ == 0 {
                    lean_ctor_set(v___x_302_, 1, v_snd_317_);
                    v___x_319_ = v___x_302_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_324_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_324_, 0, v_permits_299_);
            ...
            4 => {
                ...
                if v_isShared_315_ == 0 {
                    ...
                    v_reuseFailAlloc_323_ = lean_alloc_ctor(1, 1, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_323_, 0, v_fst_316_);
...
pub unsafe fn l_Std_Semaphore_release(mut v_sem_331_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_Semaphore_availablePermits___lam__0(
    ...
    let mut v_permits_345_: *mut LeanObject = core::ptr::null_mut();
    v___x_344_ = lean_st_ref_get(v___y_342_);
    v_permits_345_ = lean_ctor_get(v___x_344_, 0);
    lean_inc(v_permits_345_);
    lean_dec(v___x_344_);
...
pub unsafe fn l_Std_Semaphore_availablePermits(mut v_sem_350_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Std_Sync_Semaphore(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Sync_Semaphore(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sync_Semaphore(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
