...
pub static l_Std_Barrier_new___closed__0_value: LeanCtorObject<2> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Std_Barrier_new___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Barrier_new___closed__0_value) as *mut LeanObject;
pub unsafe fn l_Std_Barrier_new(mut v_numThreads_160_: *mut LeanObject) -> *mut LeanObject {
    ...
    v___x_165_ = lean_alloc_ctor(0, 3, (0) as u32);
    lean_ctor_set(v___x_165_, 0, v___x_163_);
    lean_ctor_set(v___x_165_, 1, v___x_164_);
    lean_ctor_set(v___x_165_, 2, v_numThreads_160_);
    return v___x_165_;
}
pub unsafe fn l_Std_Barrier_new___boxed(
    mut v_numThreads_166_: *mut LeanObject,
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Barrier_wait_spec__1___redArg(
    mut v_mutex_169_: *mut LeanObject,
    mut v_k_170_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_ref_172_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mutex_173_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_ref_172_ = lean_ctor_get(v_mutex_169_, 0);
    lean_inc(v_ref_172_);
    v_mutex_173_ = lean_ctor_get(v_mutex_169_, 1);
    lean_inc(v_mutex_173_);
    lean_dec_ref(v_mutex_169_);
    v___x_174_ = lean_io_basemutex_lock(v_mutex_173_);
    v___x_175_ = lean_apply_2(v_k_170_, v_ref_172_, lean_box(0));
    v___x_176_ = lean_io_basemutex_unlock(v_mutex_173_);
    lean_dec(v_mutex_173_);
    return v___x_175_;
}
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Barrier_wait_spec__1___redArg___boxed(
    mut v_mutex_177_: *mut LeanObject,
    mut v_k_178_: *mut LeanObject,
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Barrier_wait_spec__1(
    ...
    mut v_mutex_183_: *mut LeanObject,
...
pub unsafe fn l_Std_Mutex_atomically___at___00Std_Barrier_wait_spec__1___boxed(
    ...
    mut v_mutex_189_: *mut LeanObject,
...
pub unsafe fn l_Std_Barrier_wait___lam__0___boxed(
    mut v_generationId_201_: *mut LeanObject,
    mut v___x_202_: *mut LeanObject,
...
pub unsafe fn l___private_Init_While_0__whileM_erased___at___00Std_Condvar_waitUntil___at___00Std_Barrier_wait_spec__0_spec__0___redArg(
    mut v_pred_208_: *mut LeanObject,
    mut v_condvar_209_: *mut LeanObject,
    mut v_mutex_210_: *mut LeanObject,
    ...
    loop {
        match state {
            0 => {
                lean_inc_ref(v_pred_208_);
                lean_inc(v___y_211_);
                v___x_213_ = lean_apply_2(v_pred_208_, v___y_211_, lean_box(0));
                v___x_214_ = (lean_unbox(v___x_213_) as u8);
                if v___x_214_ == 0 {
                    v___x_215_ = lean_io_condvar_wait(v_condvar_209_, v_mutex_210_);
                    state = 0;
                    continue;
                } else {
                    lean_dec_ref(v_pred_208_);
...
pub unsafe fn l___private_Init_While_0__whileM_erased___at___00Std_Condvar_waitUntil___at___00Std_Barrier_wait_spec__0_spec__0___redArg___boxed(
    mut v_pred_218_: *mut LeanObject,
    mut v_condvar_219_: *mut LeanObject,
    mut v_mutex_220_: *mut LeanObject,
    ...
    lean_dec(v___y_221_);
    lean_dec(v_mutex_220_);
    lean_dec(v_condvar_219_);
    return v_res_223_;
}
pub unsafe fn l_Std_Condvar_waitUntil___at___00Std_Barrier_wait_spec__0(
    mut v_condvar_224_: *mut LeanObject,
    mut v_mutex_225_: *mut LeanObject,
    mut v_pred_226_: *mut LeanObject,
...
pub unsafe fn l_Std_Condvar_waitUntil___at___00Std_Barrier_wait_spec__0___boxed(
    mut v_condvar_231_: *mut LeanObject,
    mut v_mutex_232_: *mut LeanObject,
    mut v_pred_233_: *mut LeanObject,
    mut v___y_234_: *mut LeanObject,
    mut v___y_235_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec(v___y_234_);
    lean_dec(v_mutex_232_);
    lean_dec(v_condvar_231_);
    return v_res_236_;
}
pub unsafe fn l_Std_Barrier_wait___lam__1(
    mut v_numThreads_237_: *mut LeanObject,
    mut v_cvar_238_: *mut LeanObject,
    mut v_lock_239_: *mut LeanObject,
    mut v___y_240_: *mut LeanObject,
) -> u8 {
    let mut v___x_242_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_243_: *mut LeanObject = core::ptr::null_mut();
    let mut v_count_244_: *mut LeanObject = core::ptr::null_mut();
    let mut v_generationId_245_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_count_255_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_256_: u8 = 0;
    let mut v___x_257_: *mut LeanObject = core::ptr::null_mut();
    let mut v_generationId_258_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_271_: *mut LeanObject = core::ptr::null_mut();
    let mut v_generationId_272_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mutex_273_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_count_244_ = lean_ctor_get(v___x_243_, 0);
                v_generationId_245_ = lean_ctor_get(v___x_243_, 1);
                v_isSharedCheck_279_ = (!lean_is_exclusive(v___x_243_)) as u8;
                if v_isSharedCheck_279_ == 0 {
                    ...
                    lean_inc(v_generationId_245_);
                    lean_inc(v_count_244_);
                    lean_dec(v___x_243_);
            ...
            1 => {
                v___x_249_ = lean_unsigned_to_nat(1);
                v___x_250_ = lean_nat_add(v_count_244_, v___x_249_);
                lean_dec(v_count_244_);
                if v_isShared_248_ == 0 {
                    ...
                    v_reuseFailAlloc_278_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_278_, 0, v___x_250_);
                    lean_ctor_set(v_reuseFailAlloc_278_, 1, v_generationId_245_);
            ...
            2 => {
                ...
                v_count_255_ = lean_ctor_get(v___x_254_, 0);
                lean_inc(v_count_255_);
                lean_dec(v___x_254_);
                v___x_256_ = lean_nat_dec_lt(v_count_255_, v_numThreads_237_);
                lean_dec(v_count_255_);
                if v___x_256_ == 0 {
                    lean_dec(v___x_242_);
                    v___x_257_ = lean_st_ref_take(v___y_240_);
                    v_generationId_258_ = lean_ctor_get(v___x_257_, 1);
                    v_isSharedCheck_270_ = (!lean_is_exclusive(v___x_257_)) as u8;
                    ...
                    v_generationId_272_ = lean_ctor_get(v___x_242_, 1);
                    lean_inc(v_generationId_272_);
                    lean_dec(v___x_242_);
                    v_mutex_273_ = lean_ctor_get(v_lock_239_, 1);
                    v___x_274_ = lean_box((v___x_256_) as usize);
                    v___f_275_ = lean_alloc_closure(
                        l_Std_Barrier_wait___lam__0___boxed as *mut core::ffi::c_void,
                        4,
                        2,
                    );
                    lean_closure_set(v___f_275_, 0, v_generationId_272_);
            ...
            3 => {
                ...
                if v_isShared_261_ == 0 {
                    ...
                    v_reuseFailAlloc_269_ = lean_alloc_ctor(0, 2, (0) as u32);
...
pub unsafe fn l_Std_Barrier_wait___lam__1___boxed(
    mut v_numThreads_280_: *mut LeanObject,
    mut v_cvar_281_: *mut LeanObject,
    mut v_lock_282_: *mut LeanObject,
    ...
    lean_dec(v___y_283_);
    lean_dec_ref(v_lock_282_);
    lean_dec(v_cvar_281_);
    lean_dec(v_numThreads_280_);
    v_r_286_ = lean_box((v_res_285_) as usize);
    return v_r_286_;
}
pub unsafe fn l_Std_Barrier_wait(mut v_barrier_287_: *mut LeanObject) -> u8 {
    let mut v_lock_289_: *mut LeanObject = core::ptr::null_mut();
    let mut v_cvar_290_: *mut LeanObject = core::ptr::null_mut();
    let mut v_numThreads_291_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_lock_289_ = lean_ctor_get(v_barrier_287_, 0);
    lean_inc_ref_n(v_lock_289_, 2);
    v_cvar_290_ = lean_ctor_get(v_barrier_287_, 1);
    lean_inc(v_cvar_290_);
    v_numThreads_291_ = lean_ctor_get(v_barrier_287_, 2);
    lean_inc(v_numThreads_291_);
    lean_dec_ref(v_barrier_287_);
    v___f_292_ = lean_alloc_closure(
        l_Std_Barrier_wait___lam__1___boxed as *mut core::ffi::c_void,
        5,
        3,
    );
    lean_closure_set(v___f_292_, 0, v_numThreads_291_);
    lean_closure_set(v___f_292_, 1, v_cvar_290_);
    lean_closure_set(v___f_292_, 2, v_lock_289_);
    v___x_293_ =
        l_Std_Mutex_atomically___at___00Std_Barrier_wait_spec__1___redArg(v_lock_289_, v___f_292_);
    v___x_294_ = (lean_unbox(v___x_293_) as u8);
    lean_dec(v___x_293_);
    return v___x_294_;
}
pub unsafe fn l_Std_Barrier_wait___boxed(
    mut v_barrier_295_: *mut LeanObject,
...
pub unsafe fn l___private_Init_While_0__whileM_erased___at___00Std_Condvar_waitUntil___at___00Std_Barrier_wait_spec__0_spec__0(
    mut v_pred_299_: *mut LeanObject,
    mut v_condvar_300_: *mut LeanObject,
    mut v_mutex_301_: *mut LeanObject,
...
pub unsafe fn l___private_Init_While_0__whileM_erased___at___00Std_Condvar_waitUntil___at___00Std_Barrier_wait_spec__0_spec__0___boxed(
    mut v_pred_307_: *mut LeanObject,
    mut v_condvar_308_: *mut LeanObject,
    ...
    lean_dec(v_condvar_308_);
    return v_res_314_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Sync_Barrier(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Sync_Barrier(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sync_Barrier(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
