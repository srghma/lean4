...
// Imports: Std.Data.ExtHashMap.Basic Std.Data.ExtDHashMap.Basic Std.Data.ExtDHashMap.Lemmas
...
use crate::r#gen::Std::Data::ExtDHashMap::Lemmas::{
    initialize_Std_Data_ExtDHashMap_Lemmas, runtime_initialize_Std_Data_ExtDHashMap_Lemmas,
};
...
pub unsafe fn l___private_Std_Data_ExtHashMap_Lemmas_0__GetElem_x3f_match__1_splitter___redArg(
...
pub unsafe fn l___private_Std_Data_ExtHashMap_Lemmas_0__GetElem_x3f_match__1_splitter(
...
pub unsafe fn runtime_initialize_Std_Data_ExtHashMap_Lemmas(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_ExtHashMap_Lemmas(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_ExtHashMap_Lemmas(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
    ...
    lean_dec_ref(res);
    res = meta_initialize_Std_Data_ExtHashMap_Lemmas(builtin);
    if lean_io_result_is_error(res) {
        return res;
    }
    lean_dec_ref(res);
    return initialize_Std_Data_ExtHashMap_Lemmas(builtin);
}
