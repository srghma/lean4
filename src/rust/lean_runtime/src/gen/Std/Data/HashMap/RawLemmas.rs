...
pub unsafe fn l_Std_HashMap_Raw_Equiv_instTrans(
    mut v_00_u03b1_4_: *mut crate::leanh::LeanObject,
    mut v_00_u03b2_5_: *mut crate::leanh::LeanObject,
...
pub unsafe fn initialize_Std_Data_HashMap_RawLemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
