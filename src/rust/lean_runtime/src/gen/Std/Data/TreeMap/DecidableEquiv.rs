...
pub unsafe fn l_Std_TreeMap_instDecidableEquivOfTransCmpOfLawfulEqCmpOfLawfulBEq___redArg___lam__0(
    ...
    mut v___y_48_: *mut crate::leanh::LeanObject,
    mut v___y_49_: *mut crate::leanh::LeanObject,
) -> u8 {
    let mut v___x_50_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_51_: u8 = 0;
    v___x_50_ = crate::leanh::lean_apply_2(v_inst_46_, v___y_48_, v___y_49_);
    v___x_51_ = (crate::leanh::lean_unbox(v___x_50_) as u8);
    return v___x_51_;
}
...
pub unsafe fn l_Std_TreeMap_instDecidableEquivOfTransCmpOfLawfulEqCmpOfLawfulBEq___redArg(
    mut v_cmp_58_: *mut crate::leanh::LeanObject,
    mut v_inst_59_: *mut crate::leanh::LeanObject,
    mut v_t_u2081_60_: *mut crate::leanh::LeanObject,
    mut v_t_u2082_61_: *mut crate::leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_TreeMap_instDecidableEquivOfTransCmpOfLawfulEqCmpOfLawfulBEq___redArg___boxed(
    mut v_cmp_64_: *mut crate::leanh::LeanObject,
    mut v_inst_65_: *mut crate::leanh::LeanObject,
    mut v_t_u2081_66_: *mut crate::leanh::LeanObject,
    mut v_t_u2082_67_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    v_r_69_ = crate::leanh::lean_box((v_res_68_) as usize);
    return v_r_69_;
}
pub unsafe fn l_Std_TreeMap_instDecidableEquivOfTransCmpOfLawfulEqCmpOfLawfulBEq(
    ...
    mut v_t_u2081_77_: *mut crate::leanh::LeanObject,
    mut v_t_u2082_78_: *mut crate::leanh::LeanObject,
) -> u8 {
...
pub unsafe fn l_Std_TreeMap_instDecidableEquivOfTransCmpOfLawfulEqCmpOfLawfulBEq___boxed(
    ...
    mut v_t_u2081_87_: *mut crate::leanh::LeanObject,
    mut v_t_u2082_88_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    v_r_90_ = crate::leanh::lean_box((v_res_89_) as usize);
    return v_r_90_;
}
