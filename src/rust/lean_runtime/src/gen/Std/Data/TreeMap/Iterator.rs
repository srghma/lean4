...
pub unsafe fn l_Std_TreeMap_iter___redArg(mut v_m_43_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_44_: *mut LeanObject = core::ptr::null_mut();
    v___x_44_ = l_Std_DTreeMap_Internal_Zipper_iterOfTree___redArg(v_m_43_);
    return v___x_44_;
}
pub unsafe fn l_Std_TreeMap_iter___redArg___boxed(mut v_m_45_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_TreeMap_keysIter___redArg(mut v_m_57_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_TreeMap_valuesIter___redArg(mut v_m_71_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Std_Data_TreeMap_Iterator(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_TreeMap_Iterator(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_TreeMap_Iterator(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
