...
pub unsafe fn l_Std_TreeMap_Raw_Equiv_instTrans(
    ...
    mut v_00_u03b2_10_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Std_TreeMap_Raw_Equiv_instTrans___boxed(
    ...
    mut v_00_u03b2_14_: *mut crate::leanh::LeanObject,
    mut v_cmp_15_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_dec_ref(v_cmp_15_);
    return v_res_16_;
}
...
pub unsafe fn initialize_Std_Data_TreeMap_Raw_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
