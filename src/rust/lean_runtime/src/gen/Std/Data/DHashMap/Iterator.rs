...
pub unsafe fn l_Std_DHashMap_Raw_iter___redArg(mut v_m_193_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_DHashMap_iter___redArg(mut v_m_277_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_DHashMap_keysIter___redArg(mut v_m_313_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Std_DHashMap_valuesIter___redArg(mut v_m_349_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Std_Data_DHashMap_Iterator(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_DHashMap_Iterator(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_DHashMap_Iterator(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
