...
pub unsafe fn l_Std_DHashMap_filterMap(
    ...
    mut v_00_u03b4_44_: *mut LeanObject,
...
pub unsafe fn l_Std_DHashMap_filterMap___boxed(
    ...
    mut v_00_u03b4_52_: *mut LeanObject,
...
pub unsafe fn l_Std_DHashMap_map(
    ...
    mut v_00_u03b4_63_: *mut LeanObject,
...
pub unsafe fn l_Std_DHashMap_map___boxed(
    ...
    mut v_00_u03b4_71_: *mut LeanObject,
...
pub unsafe fn initialize_Std_Data_DHashMap_AdditionalOperations(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
