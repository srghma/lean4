...
pub unsafe fn l_Std_DTreeMap_Raw_Equiv_instTrans(
    ...
    mut v_00_u03b2_30_: *mut LeanObject,
    mut v_cmp_31_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Raw_Equiv_instTrans___boxed(
    ...
    mut v_00_u03b2_34_: *mut LeanObject,
...
pub unsafe fn l___private_Std_Data_DTreeMap_Raw_Lemmas_0__Break_runK_match__1_splitter___redArg(
    ...
    if lean_obj_tag(v_x_37_) == 0 {
        ...
        let mut v_val_42_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn runtime_initialize_Std_Data_DTreeMap_Raw_Lemmas(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_DTreeMap_Raw_Lemmas(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_DTreeMap_Raw_Lemmas(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
