...
// Imports: Std.Data.DTreeMap.Internal.Def Std.Data.Internal.Cut Init.Data.List.Pairwise Init.Data.List.Sublist
...
use crate::r#gen::Std::Data::Internal::Cut::{
    initialize_Std_Data_Internal_Cut, runtime_initialize_Std_Data_Internal_Cut,
};
use crate::leanh::{
...
pub unsafe fn runtime_initialize_Std_Data_DTreeMap_Internal_Ordered(
    builtin: u8,
) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_DTreeMap_Internal_Ordered(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_DTreeMap_Internal_Ordered(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
