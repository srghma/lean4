...
pub unsafe fn l_Std_IterStep_bundledQuotient___redArg(
    ...
    mut v_step_61_: *mut crate::leanh::LeanObject,
    ...
    let mut v_reuseFailAlloc_70_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_79_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_80_: u8 = 0;
    let mut v___x_81_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => match crate::leanh::lean_obj_tag(v_step_61_) {
                0 => {
                    v_it_62_ = crate::leanh::lean_ctor_get(v_step_61_, 0);
                    v_out_63_ = crate::leanh::lean_ctor_get(v_step_61_, 1);
                    v_isSharedCheck_71_ = (!crate::leanh::lean_is_exclusive(v_step_61_)) as u8;
                    if v_isSharedCheck_71_ == 0 {
                        ...
                        crate::leanh::lean_dec(v_step_61_);
                ...
                1 => {
                    v_it_72_ = crate::leanh::lean_ctor_get(v_step_61_, 0);
                    v_isSharedCheck_80_ = (!crate::leanh::lean_is_exclusive(v_step_61_)) as u8;
                ...
                _ => {
                    ...
                    v___x_81_ = crate::leanh::lean_box(2);
                    return v___x_81_;
                }
            },
            1 => {
                v___x_67_ = crate::leanh::lean_alloc_ctor(0, 2, (0) as u32);
                crate::leanh::lean_ctor_set(v___x_67_, 0, v_inst_60_);
                crate::leanh::lean_ctor_set(v___x_67_, 1, v_it_62_);
                if v_isShared_66_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_65_, 0, v___x_67_);
                    v___x_69_ = v___x_65_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_70_ = crate::leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_70_, 0, v___x_67_);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_70_, 1, v_out_63_);
            ...
            3 => {
                v___x_76_ = crate::leanh::lean_alloc_ctor(0, 2, (0) as u32);
                crate::leanh::lean_ctor_set(v___x_76_, 0, v_inst_60_);
                crate::leanh::lean_ctor_set(v___x_76_, 1, v_it_72_);
                if v_isShared_75_ == 0 {
                    crate::leanh::lean_ctor_set(v___x_74_, 0, v___x_76_);
                    v___x_78_ = v___x_74_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_79_ = crate::leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    crate::leanh::lean_ctor_set(v_reuseFailAlloc_79_, 0, v___x_76_);
...
pub unsafe fn l_Std_IterStep_bundledQuotient(
    ...
    mut v_step_88_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Std_IterStep_bundledQuotient___boxed(
    ...
    mut v_step_96_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    ...
    crate::leanh::lean_dec_ref(v_inst_94_);
    return v_res_97_;
}
...
pub unsafe fn l_Std_IterM_QuotStep_bundledQuotient___boxed(
    mut v_00_u03b1_110_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_dec(v_it_116_);
    crate::leanh::lean_dec_ref(v_inst_114_);
    return v_res_118_;
}
