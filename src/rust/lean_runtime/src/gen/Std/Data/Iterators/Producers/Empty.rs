...
pub unsafe fn l_Std_Iter_empty(mut v_00_u03b2_3_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_Iterators_Producers_Empty(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_Iterators_Producers_Empty(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
