...
// Imports: Std.Data.Iterators.Lemmas.Consumers.Monadic.Collect Std.Data.Iterators.Lemmas.Consumers.Monadic.Loop Std.Data.Iterators.Lemmas.Consumers.Monadic.Set
use crate::r#gen::Std::Data::Iterators::Lemmas::Consumers::Monadic::Collect::{
    initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Collect,
    runtime_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Collect,
};
use crate::r#gen::Std::Data::Iterators::Lemmas::Consumers::Monadic::Loop::{
    initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Loop,
    runtime_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Loop,
};
...
pub unsafe fn runtime_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic(
    builtin: u8,
...
pub unsafe fn meta_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
