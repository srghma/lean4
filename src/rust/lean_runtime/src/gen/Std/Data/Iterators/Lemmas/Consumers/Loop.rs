...
// Imports: Init.Data.Iterators.Lemmas.Consumers.Loop Std.Data.Iterators.Lemmas.Consumers.Collect Std.Data.Iterators.Lemmas.Consumers.Monadic.Loop
...
pub unsafe fn runtime_initialize_Std_Data_Iterators_Lemmas_Consumers_Loop(
    builtin: u8,
) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Data_Iterators_Lemmas_Consumers_Loop(
    builtin: u8,
) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_Iterators_Lemmas_Consumers_Loop(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
