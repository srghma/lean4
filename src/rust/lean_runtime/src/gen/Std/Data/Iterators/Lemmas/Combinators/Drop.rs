...
pub unsafe fn l___private_Std_Data_Iterators_Lemmas_Combinators_Drop_0__Std_Iter_step__drop_match__3_splitter(
    ...
    mut v_it_209_: *mut LeanObject,
    mut v_motive_210_: *mut LeanObject,
    mut v_x_211_: *mut LeanObject,
    mut v_h__1_212_: *mut LeanObject,
    mut v_h__2_213_: *mut LeanObject,
    mut v_h__3_214_: *mut LeanObject,
) -> *mut LeanObject {
    match lean_obj_tag(v_x_211_) {
        0 => {
            let mut v_it_215_: *mut LeanObject = core::ptr::null_mut();
            let mut v_out_216_: *mut LeanObject = core::ptr::null_mut();
            let mut v___x_217_: *mut LeanObject = core::ptr::null_mut();
            lean_dec(v_h__3_214_);
            lean_dec(v_h__2_213_);
            v_it_215_ = lean_ctor_get(v_x_211_, 0);
            lean_inc(v_it_215_);
            v_out_216_ = lean_ctor_get(v_x_211_, 1);
            lean_inc(v_out_216_);
            lean_dec_ref_known(v_x_211_, 2);
            v___x_217_ = lean_apply_3(v_h__1_212_, v_it_215_, v_out_216_, lean_box(0));
            return v___x_217_;
        }
        1 => {
            ...
            v_it_218_ = lean_ctor_get(v_x_211_, 0);
            lean_inc(v_it_218_);
            lean_dec_ref_known(v_x_211_, 1);
            v___x_219_ = lean_apply_2(v_h__2_213_, v_it_218_, lean_box(0));
            return v___x_219_;
        }
        _ => {
            ...
            lean_dec(v_h__2_213_);
            lean_dec(v_h__1_212_);
            v___x_220_ = lean_apply_1(v_h__3_214_, lean_box(0));
            return v___x_220_;
        }
    }
}
pub unsafe fn l___private_Std_Data_Iterators_Lemmas_Combinators_Drop_0__Std_Iter_step__drop_match__3_splitter___boxed(
    ...
    mut v_motive_225_: *mut LeanObject,
...
pub unsafe fn l___private_Std_Data_Iterators_Lemmas_Combinators_Drop_0__Std_Iter_step__drop_match__1_splitter___redArg(
    ...
    if v_isZero_235_ == 1 {
        ...
        v___x_237_ = lean_apply_1(v_h__1_232_, v___x_236_);
        return v___x_237_;
    } else {
        let mut v_one_238_: *mut LeanObject = core::ptr::null_mut();
        let mut v_n_239_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_240_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_h__1_232_);
        v_one_238_ = lean_unsigned_to_nat(1);
        v_n_239_ = lean_nat_sub(v_n_231_, v_one_238_);
        v___x_240_ = lean_apply_1(v_h__2_233_, v_n_239_);
        return v___x_240_;
    }
}
...
pub unsafe fn l___private_Std_Data_Iterators_Lemmas_Combinators_Drop_0__Std_Iter_step__drop_match__1_splitter(
    ...
    mut v_n_246_: *mut LeanObject,
    mut v_h__1_247_: *mut LeanObject,
    mut v_h__2_248_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_zero_249_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isZero_250_: u8 = 0;
    v_zero_249_ = lean_unsigned_to_nat(0);
    ...
    if v_isZero_250_ == 1 {
        ...
        v___x_252_ = lean_apply_1(v_h__1_247_, v___x_251_);
        return v___x_252_;
    } else {
        ...
        v___x_255_ = lean_apply_1(v_h__2_248_, v_n_254_);
        return v___x_255_;
    }
}
