...
pub unsafe fn l_Std_Iter_takeWhile___redArg(mut v_it_13_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_it_13_);
    return v_it_13_;
}
...
pub unsafe fn initialize_Std_Data_Iterators_Combinators_TakeWhile(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
