...
// Imports: Init.Data.Iterators.Lemmas.Consumers.Monadic.Loop Std.Data.Iterators.Lemmas.Consumers.Monadic.Collect Init.Data.Iterators.Lemmas.Monadic.Basic
...
pub unsafe fn runtime_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Loop(
    builtin: u8,
...
pub unsafe fn meta_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Loop(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Loop(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
    ...
    crate::leanh::lean_dec_ref(res);
    res = meta_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Loop(builtin);
    if crate::leanh::lean_io_result_is_error(res) {
        return res;
    }
    crate::leanh::lean_dec_ref(res);
    return initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Loop(builtin);
}
