...
static mut l_Array_filterMapM___at___00Std_Sat_CNF_maxLiteral_spec__0___closed__0: *mut LeanObject = core::ptr::addr_of!(
...
pub unsafe fn l_List_mapTR_loop___at___00Std_Sat_CNF_Clause_maxLiteral_spec__0(
    ...
    let mut v_head_175_: *mut LeanObject = core::ptr::null_mut();
    let mut v_tail_176_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if lean_obj_tag(v_a_172_) == 0 {
                    ...
                    v_isSharedCheck_185_ = (!lean_is_exclusive(v_a_172_)) as u8;
            ...
            1 => {
                v_fst_180_ = lean_ctor_get(v_head_175_, 0);
                lean_inc(v_fst_180_);
                lean_dec(v_head_175_);
                if v_isShared_179_ == 0 {
                    lean_ctor_set(v___x_178_, 1, v_a_173_);
                    lean_ctor_set(v___x_178_, 0, v_fst_180_);
                    v___x_182_ = v___x_178_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_184_ = lean_alloc_ctor(1, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_184_, 0, v_fst_180_);
...
pub unsafe fn l_List_max_x3f___at___00Std_Sat_CNF_Clause_maxLiteral_spec__1(
    ...
    if lean_obj_tag(v_x_196_) == 0 {
        ...
        let mut v_head_198_: *mut LeanObject = core::ptr::null_mut();
        let mut v_tail_199_: *mut LeanObject = core::ptr::null_mut();
        ...
        v___x_201_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Std_Sat_CNF_Clause_maxLiteral(mut v_c_204_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Array_filterMapM___at___00Std_Sat_CNF_maxLiteral_spec__0_spec__0(
    mut v_as_208_: *mut LeanObject,
    mut v_i_209_: usize,
    mut v_stop_210_: usize,
    mut v_b_211_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___y_213_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Array_filterMapM___at___00Std_Sat_CNF_maxLiteral_spec__0_spec__0___boxed(
    mut v_as_222_: *mut LeanObject,
    mut v_i_223_: *mut LeanObject,
    mut v_stop_224_: *mut LeanObject,
    mut v_b_225_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Array_filterMapM___at___00Std_Sat_CNF_maxLiteral_spec__0(
    mut v_as_231_: *mut LeanObject,
    mut v_start_232_: *mut LeanObject,
    mut v_stop_233_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Array_filterMapM___at___00Std_Sat_CNF_maxLiteral_spec__0___boxed(
    mut v_as_245_: *mut LeanObject,
    mut v_start_246_: *mut LeanObject,
    mut v_stop_247_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Array_max___at___00Array_max_x3f___at___00Std_Sat_CNF_maxLiteral_spec__1_spec__2_spec__3(
    ...
    mut v_b_252_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___y_254_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Array_max___at___00Array_max_x3f___at___00Std_Sat_CNF_maxLiteral_spec__1_spec__2_spec__3___boxed(
    mut v_as_261_: *mut LeanObject,
    mut v_i_262_: *mut LeanObject,
    mut v_stop_263_: *mut LeanObject,
    mut v_b_264_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec(v_i_262_);
    v_stop_boxed_266_ = lean_unbox_usize(v_stop_263_);
...
pub unsafe fn l_Array_max___at___00Array_max_x3f___at___00Std_Sat_CNF_maxLiteral_spec__1_spec__2___redArg(
    ...
    v___x_271_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l_Array_max_x3f___at___00Std_Sat_CNF_maxLiteral_spec__1(
    ...
    v___x_285_ = lean_unsigned_to_nat(0);
    ...
    if v___x_286_ == 0 {
        ...
        v___x_288_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Array_max_x3f___at___00Std_Sat_CNF_maxLiteral_spec__1___boxed(
    ...
    lean_dec_ref(v_arr_290_);
    return v_res_291_;
}
pub unsafe fn l_Std_Sat_CNF_maxLiteral(mut v_f_292_: *mut LeanObject) -> *mut LeanObject {
    ...
    v___x_293_ = lean_unsigned_to_nat(0);
...
pub unsafe fn l_Std_Sat_CNF_maxLiteral___boxed(mut v_f_297_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Array_max___at___00Array_max_x3f___at___00Std_Sat_CNF_maxLiteral_spec__1_spec__2(
    mut v_arr_299_: *mut LeanObject,
    mut v_h_300_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Array_max___at___00Array_max_x3f___at___00Std_Sat_CNF_maxLiteral_spec__1_spec__2___boxed(
    mut v_arr_302_: *mut LeanObject,
    mut v_h_303_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec_ref(v_arr_302_);
    return v_res_304_;
}
pub unsafe fn l_Std_Sat_CNF_numLiterals(mut v_f_305_: *mut LeanObject) -> *mut LeanObject {
    ...
    if lean_obj_tag(v___x_306_) == 0 {
        ...
        v___x_309_ = lean_unsigned_to_nat(1);
        v___x_310_ = lean_nat_add(v_val_308_, v___x_309_);
        lean_dec(v_val_308_);
        return v___x_310_;
    }
}
pub unsafe fn l_Std_Sat_CNF_numLiterals___boxed(mut v_f_311_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l___private_Std_Sat_CNF_RelabelFin_0__Std_Sat_CNF_numLiterals_match__1_splitter___redArg(
    ...
    mut v_h__1_314_: *mut LeanObject,
    mut v_h__2_315_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Std_Sat_CNF_RelabelFin_0__Std_Sat_CNF_numLiterals_match__1_splitter(
    mut v_motive_320_: *mut LeanObject,
...
pub unsafe fn l_Std_Sat_CNF_relabelFin(mut v_f_335_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_336_: u8 = 0;
    lean_inc_ref(v_f_335_);
...
pub unsafe fn runtime_initialize_Std_Sat_CNF_RelabelFin(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Sat_CNF_RelabelFin(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Sat_CNF_RelabelFin(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
