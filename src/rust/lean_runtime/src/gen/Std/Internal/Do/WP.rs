...
// Imports: Std.Internal.Do.WP.Basic Std.Internal.Do.WP.Lemmas
use crate::r#gen::Std::Internal::Do::WP::Basic::{
    initialize_Std_Internal_Do_WP_Basic, runtime_initialize_Std_Internal_Do_WP_Basic,
};
use crate::r#gen::Std::Internal::Do::WP::Lemmas::{
    initialize_Std_Internal_Do_WP_Lemmas, runtime_initialize_Std_Internal_Do_WP_Lemmas,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Std_Internal_Do_WP(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Std_Internal_Do_WP(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Internal_Do_WP(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
