...
use crate::leanh::{
    ...
    lean_inc, lean_inc_ref, lean_io_result_is_error, lean_io_result_mk_ok,
};
pub unsafe fn l_Std_Internal_Do_assertGadget___redArg(
    mut v_inst_26_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_toApplicative_27_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toPure_28_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_29_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_30_: *mut LeanObject = core::ptr::null_mut();
    v_toApplicative_27_ = lean_ctor_get(v_inst_26_, 0);
    lean_inc_ref(v_toApplicative_27_);
    lean_dec_ref(v_inst_26_);
    v_toPure_28_ = lean_ctor_get(v_toApplicative_27_, 1);
    lean_inc(v_toPure_28_);
    lean_dec_ref(v_toApplicative_27_);
    v___x_29_ = lean_box(0);
    v___x_30_ = lean_apply_2(v_toPure_28_, lean_box(0), v___x_29_);
    return v___x_30_;
}
pub unsafe fn l_Std_Internal_Do_assertGadget(
    mut v_m_31_: *mut LeanObject,
    mut v_Pred_32_: *mut LeanObject,
    mut v_EPred_33_: *mut LeanObject,
    mut v_inst_34_: *mut LeanObject,
    mut v_inst_35_: *mut LeanObject,
    mut v_inst_36_: *mut LeanObject,
    mut v_inst_37_: *mut LeanObject,
    mut v_name_38_: *mut LeanObject,
    mut v_as_39_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Internal_Do_assertGadget___boxed(
    mut v_m_41_: *mut LeanObject,
    mut v_Pred_42_: *mut LeanObject,
    mut v_EPred_43_: *mut LeanObject,
    mut v_inst_44_: *mut LeanObject,
    mut v_inst_45_: *mut LeanObject,
    mut v_inst_46_: *mut LeanObject,
    mut v_inst_47_: *mut LeanObject,
    mut v_name_48_: *mut LeanObject,
    mut v_as_49_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Std_Internal_Do_Triple_Gadget(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Internal_Do_Triple_Gadget(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Internal_Do_Triple_Gadget(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
