...
pub unsafe fn l_Std_Internal_UV_Loop_configure___boxed(
    mut v_options_12_: *mut LeanObject,
    mut v_a_00___x40___internal___hyg_13_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Internal_UV_Loop_alive___boxed(
    mut v_a_00___x40___internal___hyg_16_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Std_Internal_UV_Loop(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Internal_UV_Loop(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Internal_UV_Loop(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
