...
static mut l_Std_Time_Database_defaultGetLocalZoneRules___closed__0_once: LeanOnceCell =
    LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Std_Time_Database_defaultGetLocalZoneRules___closed__0: u64 = 0;
static mut l_Std_Time_Database_defaultGetLocalZoneRules___closed__1_once: LeanOnceCell =
    LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
...
pub unsafe fn _init_l_Std_Time_Database_defaultGetLocalZoneRules___closed__0() -> u64 {
    ...
    v___x_41_ = lean_unsigned_to_nat(2147483648);
...
pub unsafe fn l_Std_Time_Database_defaultGetLocalZoneRules() -> *mut LeanObject {
        ...
        match state {
            0 => {
                ...
                if v___x_46_ == 0 {
                    ...
                    if lean_obj_tag(v___x_50_) == 0 {
                        ...
                        v_isSharedCheck_60_ = (!lean_is_exclusive(v___x_50_)) as u8;
            ...
            1 => {
                if v_isShared_56_ == 0 {
                    ...
                    v_reuseFailAlloc_59_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn runtime_initialize_Std_Time_Zoned_Database(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Std_Time_Zoned_Database(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Std_Time_Zoned_Database(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
