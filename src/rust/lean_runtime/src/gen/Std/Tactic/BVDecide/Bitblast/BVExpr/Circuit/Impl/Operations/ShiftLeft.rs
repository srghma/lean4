...
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___closed__0_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___closed__0:
    *mut LeanObject = core::ptr::null_mut();
static mut l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___closed__1_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg(
    mut v_w_231_: *mut LeanObject,
    mut v_aig_232_: *mut LeanObject,
    mut v_input_233_: *mut LeanObject,
    mut v_distance_234_: *mut LeanObject,
    mut v_curr_235_: *mut LeanObject,
    mut v_s_236_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_gate_238_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_246_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_252_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_261_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                ...
                if v___x_248_ == 0 {
                    lean_dec(v_curr_235_);
                    v___x_249_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_249_, 0, v_aig_232_);
                    lean_ctor_set(v___x_249_, 1, v_s_236_);
                    return v___x_249_;
                } else {
            ...
            1 => {
                ...
                lean_dec(v_curr_235_);
                v___x_242_ = lean_unsigned_to_nat(2);
                v___x_243_ = lean_nat_mul(v_gate_238_, v___x_242_);
                lean_dec(v_gate_238_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___redArg___boxed(
    ...
    mut v_input_265_: *mut LeanObject,
    mut v_distance_266_: *mut LeanObject,
    mut v_curr_267_: *mut LeanObject,
    mut v_s_268_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec(v_distance_266_);
    lean_dec_ref(v_input_265_);
    lean_dec(v_w_263_);
    return v_res_269_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go(
    ...
    mut v_w_273_: *mut LeanObject,
    mut v_aig_274_: *mut LeanObject,
    mut v_input_275_: *mut LeanObject,
    mut v_distance_276_: *mut LeanObject,
    mut v_curr_277_: *mut LeanObject,
    mut v_hcurr_278_: *mut LeanObject,
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst_go___boxed(
    ...
    mut v_w_284_: *mut LeanObject,
    mut v_aig_285_: *mut LeanObject,
    mut v_input_286_: *mut LeanObject,
    mut v_distance_287_: *mut LeanObject,
    mut v_curr_288_: *mut LeanObject,
    mut v_hcurr_289_: *mut LeanObject,
    ...
    lean_dec(v_distance_287_);
    lean_dec_ref(v_input_286_);
    lean_dec(v_w_284_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst___redArg(
    ...
    mut v_aig_293_: *mut LeanObject,
    mut v_target_294_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_vec_295_: *mut LeanObject = core::ptr::null_mut();
    let mut v_distance_296_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_vec_295_ = lean_ctor_get(v_target_294_, 0);
    v_distance_296_ = lean_ctor_get(v_target_294_, 1);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst___redArg___boxed(
    mut v_w_300_: *mut LeanObject,
    mut v_aig_301_: *mut LeanObject,
    mut v_target_302_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeftConst(
    ...
    mut v_w_307_: *mut LeanObject,
    mut v_aig_308_: *mut LeanObject,
    mut v_target_309_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift___redArg(
    ...
    mut v_w_320_: *mut LeanObject,
    mut v_aig_321_: *mut LeanObject,
    mut v_target_322_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_n_323_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lhs_324_: *mut LeanObject = core::ptr::null_mut();
    let mut v_rhs_325_: *mut LeanObject = core::ptr::null_mut();
    let mut v_pow_326_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_333_: *mut LeanObject = core::ptr::null_mut();
    let mut v_vec_334_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_339_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_n_323_ = lean_ctor_get(v_target_322_, 0);
                v_lhs_324_ = lean_ctor_get(v_target_322_, 1);
                v_rhs_325_ = lean_ctor_get(v_target_322_, 2);
                v_pow_326_ = lean_ctor_get(v_target_322_, 3);
                v___x_327_ = lean_nat_dec_lt(v_pow_326_, v_n_323_);
                if v___x_327_ == 0 {
                    lean_dec_ref(v_inst_319_);
                    lean_dec_ref(v_inst_318_);
                    lean_inc_ref(v_lhs_324_);
                    v___x_328_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_328_, 0, v_aig_321_);
                    lean_ctor_set(v___x_328_, 1, v_lhs_324_);
                    return v___x_328_;
                } else {
                    ...
                    lean_ctor_set(v___x_331_, 0, v_lhs_324_);
                    ...
                    v_aig_333_ = lean_ctor_get(v_res_332_, 0);
                    lean_inc_ref(v_aig_333_);
                    v_vec_334_ = lean_ctor_get(v_res_332_, 1);
                    lean_inc_ref(v_vec_334_);
                    lean_dec_ref(v_res_332_);
                    ...
                    v___x_343_ = lean_unsigned_to_nat(0);
                    v___x_344_ = lean_nat_dec_eq(v___x_342_, v___x_343_);
                    lean_dec(v___x_342_);
                    if v___x_344_ == 0 {
                        v___x_345_ = lean_alloc_ctor(0, 1, (1) as u32);
                        ...
                        v___x_346_ = 0;
                        v___x_347_ = lean_alloc_ctor(0, 1, (1) as u32);
            ...
            1 => {
                lean_inc_ref(v_lhs_324_);
                v___x_337_ = lean_alloc_ctor(0, 3, (0) as u32);
                lean_ctor_set(v___x_337_, 0, v___y_336_);
                lean_ctor_set(v___x_337_, 1, v_vec_334_);
                lean_ctor_set(v___x_337_, 2, v_lhs_324_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift___redArg___boxed(
    ...
    mut v_w_350_: *mut LeanObject,
    mut v_aig_351_: *mut LeanObject,
    mut v_target_352_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift(
    ...
    mut v_w_357_: *mut LeanObject,
    mut v_aig_358_: *mut LeanObject,
    mut v_target_359_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_twoPowShift___boxed(
    ...
    mut v_aig_365_: *mut LeanObject,
    mut v_target_366_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go___redArg(
    ...
    mut v_w_370_: *mut LeanObject,
    mut v_n_371_: *mut LeanObject,
    mut v_aig_372_: *mut LeanObject,
    mut v_distance_373_: *mut LeanObject,
    mut v_curr_374_: *mut LeanObject,
    mut v_acc_375_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    loop {
        match state {
            0 => {
                ...
                lean_dec(v___x_377_);
                if v___x_378_ == 0 {
                    lean_dec(v_curr_374_);
                    lean_dec_ref(v_distance_373_);
                    lean_dec(v_n_371_);
                    lean_dec_ref(v_inst_369_);
                    lean_dec_ref(v_inst_368_);
                    v___x_379_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_379_, 0, v_aig_372_);
                    lean_ctor_set(v___x_379_, 1, v_acc_375_);
                    return v___x_379_;
                } else {
                    v___x_380_ = lean_nat_add(v_curr_374_, v___x_376_);
                    lean_dec(v_curr_374_);
                    lean_inc(v___x_380_);
                    lean_inc_ref(v_distance_373_);
                    lean_inc(v_n_371_);
                    v___x_381_ = lean_alloc_ctor(0, 4, (0) as u32);
                    lean_ctor_set(v___x_381_, 0, v_n_371_);
                    lean_ctor_set(v___x_381_, 1, v_acc_375_);
                    lean_ctor_set(v___x_381_, 2, v_distance_373_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go___redArg___boxed(
    ...
    mut v_w_388_: *mut LeanObject,
    mut v_n_389_: *mut LeanObject,
    mut v_aig_390_: *mut LeanObject,
    mut v_distance_391_: *mut LeanObject,
    mut v_curr_392_: *mut LeanObject,
    mut v_acc_393_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go(
    ...
    mut v_w_398_: *mut LeanObject,
    mut v_n_399_: *mut LeanObject,
    mut v_aig_400_: *mut LeanObject,
    mut v_distance_401_: *mut LeanObject,
    mut v_curr_402_: *mut LeanObject,
    mut v_acc_403_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft_go___boxed(
    ...
    mut v_w_408_: *mut LeanObject,
    mut v_n_409_: *mut LeanObject,
    mut v_aig_410_: *mut LeanObject,
    mut v_distance_411_: *mut LeanObject,
    mut v_curr_412_: *mut LeanObject,
    mut v_acc_413_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft___redArg(
    ...
    mut v_w_417_: *mut LeanObject,
    mut v_aig_418_: *mut LeanObject,
    mut v_target_419_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_n_420_: *mut LeanObject = core::ptr::null_mut();
    let mut v_target_421_: *mut LeanObject = core::ptr::null_mut();
    let mut v_distance_422_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_423_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_424_: u8 = 0;
    v_n_420_ = lean_ctor_get(v_target_419_, 0);
    lean_inc(v_n_420_);
    v_target_421_ = lean_ctor_get(v_target_419_, 1);
    lean_inc_ref(v_target_421_);
    v_distance_422_ = lean_ctor_get(v_target_419_, 2);
    lean_inc_ref(v_distance_422_);
    ...
    if v___x_424_ == 0 {
        ...
        lean_ctor_set(v___x_425_, 0, v_n_420_);
        lean_ctor_set(v___x_425_, 1, v_target_421_);
        lean_ctor_set(v___x_425_, 2, v_distance_422_);
        ...
        lean_dec_ref_known(v___x_425_, 4);
        ...
        lean_dec_ref(v_distance_422_);
        lean_dec(v_n_420_);
        lean_dec_ref(v_inst_416_);
        lean_dec_ref(v_inst_415_);
        v___x_430_ = lean_alloc_ctor(0, 2, (0) as u32);
        lean_ctor_set(v___x_430_, 0, v_aig_418_);
        lean_ctor_set(v___x_430_, 1, v_target_421_);
        return v___x_430_;
    }
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft___redArg___boxed(
    ...
    mut v_w_433_: *mut LeanObject,
    mut v_aig_434_: *mut LeanObject,
    mut v_target_435_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft(
    ...
    mut v_w_440_: *mut LeanObject,
    mut v_aig_441_: *mut LeanObject,
    mut v_target_442_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftLeft___boxed(
    ...
    mut v_w_447_: *mut LeanObject,
    mut v_aig_448_: *mut LeanObject,
    mut v_target_449_: *mut LeanObject,
) -> *mut LeanObject {
