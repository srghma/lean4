...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUmod___redArg(
    ...
    mut v_w_51_: *mut LeanObject,
    mut v_aig_52_: *mut LeanObject,
    mut v_input_53_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_lhs_54_: *mut LeanObject = core::ptr::null_mut();
    let mut v_rhs_55_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_zero_61_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_63_: *mut LeanObject = core::ptr::null_mut();
    let mut v_res_64_: *mut LeanObject = core::ptr::null_mut();
    let mut v_aig_65_: *mut LeanObject = core::ptr::null_mut();
    let mut v_ref_66_: *mut LeanObject = core::ptr::null_mut();
    let mut v_res_67_: *mut LeanObject = core::ptr::null_mut();
    let mut v_aig_68_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_gate_73_: *mut LeanObject = core::ptr::null_mut();
    let mut v_invert_74_: u8 = 0;
    let mut v___x_76_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_77_: u8 = 0;
    let mut v_discr_79_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_81_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_82_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reuseFailAlloc_83_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reuseFailAlloc_84_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_85_: u8 = 0;
    let mut v_isSharedCheck_86_: u8 = 0;
    let mut v_unused_87_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_lhs_54_ = lean_ctor_get(v_input_53_, 0);
                v_rhs_55_ = lean_ctor_get(v_input_53_, 1);
                v_isSharedCheck_89_ = (!lean_is_exclusive(v_input_53_)) as u8;
            ...
            1 => {
                ...
                lean_dec(v___x_60_);
                lean_inc_ref(v_zero_61_);
                lean_inc_ref(v_rhs_55_);
                if v_isShared_58_ == 0 {
                    lean_ctor_set(v___x_57_, 1, v_zero_61_);
                    lean_ctor_set(v___x_57_, 0, v_rhs_55_);
                    v___x_63_ = v___x_57_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_88_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_88_, 0, v_rhs_55_);
                    lean_ctor_set(v_reuseFailAlloc_88_, 1, v_zero_61_);
            ...
            2 => {
                ...
                lean_inc_ref_n(v_inst_49_, 2);
                v_res_64_ = l_Std_Tactic_BVDecide_BVPred_mkEq___redArg(
                    v_inst_49_, v_inst_50_, v_w_51_, v_aig_52_, v___x_63_,
                );
                lean_dec_ref(v___x_63_);
                v_aig_65_ = lean_ctor_get(v_res_64_, 0);
                lean_inc_ref(v_aig_65_);
                v_ref_66_ = lean_ctor_get(v_res_64_, 1);
                lean_inc_ref(v_ref_66_);
                lean_dec_ref(v_res_64_);
                lean_inc_ref(v_zero_61_);
                lean_inc(v_w_51_);
                ...
                v_r_69_ = lean_ctor_get(v_res_67_, 2);
                v_isSharedCheck_86_ = (!lean_is_exclusive(v_res_67_)) as u8;
                if v_isSharedCheck_86_ == 0 {
                    v_unused_87_ = lean_ctor_get(v_res_67_, 1);
            ...
            3 => {
                v_gate_73_ = lean_ctor_get(v_ref_66_, 0);
                v_invert_74_ = lean_ctor_get_uint8(
                    v_ref_66_,
                    (core::mem::size_of::<*mut LeanObject>() * 1) as u32,
                );
                v_isSharedCheck_85_ = (!lean_is_exclusive(v_ref_66_)) as u8;
            ...
            4 => {
                if v_isShared_77_ == 0 {
                    ...
                    v_reuseFailAlloc_84_ = lean_alloc_ctor(0, 1, (1) as u32);
                    lean_ctor_set(v_reuseFailAlloc_84_, 0, v_gate_73_);
                    lean_ctor_set_uint8(
            ...
            5 => {
                if v_isShared_72_ == 0 {
                    lean_ctor_set(v___x_71_, 1, v_lhs_54_);
                    lean_ctor_set(v___x_71_, 0, v_discr_79_);
                    v___x_81_ = v___x_71_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_83_ = lean_alloc_ctor(0, 3, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_83_, 0, v_discr_79_);
                    lean_ctor_set(v_reuseFailAlloc_83_, 1, v_lhs_54_);
                    lean_ctor_set(v_reuseFailAlloc_83_, 2, v_r_69_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastUmod(
    ...
    mut v_w_93_: *mut LeanObject,
    mut v_aig_94_: *mut LeanObject,
    mut v_input_95_: *mut LeanObject,
) -> *mut LeanObject {
