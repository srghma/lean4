...
use crate::leanh::{
    ...
    LeanTaskObject, LeanThunkObject, lean_apply_1, lean_box, lean_dec, lean_dec_ref, lean_inc,
...
static mut l_Std_Tactic_BVDecide_LRAT_Internal_instBEqAssignment___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Tactic_BVDecide_LRAT_Internal_instBEqAssignment___closed__0_value)
        as *mut LeanObject;
pub static mut l_Std_Tactic_BVDecide_LRAT_Internal_instBEqAssignment: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Tactic_BVDecide_LRAT_Internal_instBEqAssignment___closed__0_value)
        as *mut LeanObject;
pub static l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString___lam__0___closed__0_value: LeanStringObject<4> = LeanStringObject { m_header: LeanObject { rc: 0, cs_size: (0) as u16, other: 0, tag: 249 }, m_size: 4, m_capacity: 4, m_length: 3, m_data: [112, 111, 115, 0]};
...
pub static l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString___lam__0___closed__1_value: LeanStringObject<4> = LeanStringObject { m_header: LeanObject { rc: 0, cs_size: (0) as u16, other: 0, tag: 249 }, m_size: 4, m_capacity: 4, m_length: 3, m_data: [110, 101, 103, 0]};
...
pub static l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString___lam__0___closed__2_value: LeanStringObject<5> = LeanStringObject { m_header: LeanObject { rc: 0, cs_size: (0) as u16, other: 0, tag: 249 }, m_size: 5, m_capacity: 5, m_length: 4, m_data: [98, 111, 116, 104, 0]};
...
pub static l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString___lam__0___closed__3_value: LeanStringObject<11> = LeanStringObject { m_header: LeanObject { rc: 0, cs_size: (0) as u16, other: 0, tag: 249 }, m_size: 11, m_capacity: 11, m_length: 10, m_data: [117, 110, 97, 115, 115, 105, 103, 110, 101, 100, 0]};
...
pub static mut l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString: *mut LeanObject = core::ptr::addr_of!(
    l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString___closed__0_value
)
    as *mut LeanObject;
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_ctorIdx(
    ...
    match v_x_261_ {
        ...
        2 => {
            ...
            v___x_264_ = lean_unsigned_to_nat(2);
            return v___x_264_;
        }
        _ => {
            let mut v___x_265_: *mut LeanObject = core::ptr::null_mut();
            v___x_265_ = lean_unsigned_to_nat(3);
            return v___x_265_;
        }
    }
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_ctorIdx___boxed(
    ...
    v_x_boxed_267_ = (lean_unbox(v_x_266_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_toCtorIdx___boxed(
    ...
    v_x_4__boxed_272_ = (lean_unbox(v_x_271_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_ctorElim(
    ...
    mut v_ctorIdx_278_: *mut LeanObject,
    mut v_t_279_: u8,
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_ctorElim___boxed(
    ...
    mut v_ctorIdx_283_: *mut LeanObject,
    mut v_t_284_: *mut LeanObject,
    mut v_h_285_: *mut LeanObject,
    mut v_k_286_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_t_boxed_287_: u8 = 0;
    let mut v_res_288_: *mut LeanObject = core::ptr::null_mut();
    v_t_boxed_287_ = (lean_unbox(v_t_284_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_pos_elim(
    ...
    mut v_t_293_: u8,
    mut v_h_294_: *mut LeanObject,
    mut v_pos_295_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_pos_295_);
    return v_pos_295_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_pos_elim___boxed(
    ...
    mut v_h_298_: *mut LeanObject,
    mut v_pos_299_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_t_boxed_300_: u8 = 0;
    let mut v_res_301_: *mut LeanObject = core::ptr::null_mut();
    v_t_boxed_300_ = (lean_unbox(v_t_297_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_both_elim___redArg___boxed(
    ...
    lean_dec(v_both_316_);
    return v_res_317_;
}
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_both_elim(
    mut v_motive_318_: *mut LeanObject,
    mut v_t_319_: u8,
    mut v_h_320_: *mut LeanObject,
    mut v_both_321_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_both_321_);
    return v_both_321_;
}
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_unassigned_elim(
    ...
    mut v_unassigned_334_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_unassigned_334_);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_instBEqAssignment_beq___boxed(
    ...
    v_x_17__boxed_375_ = (lean_unbox(v_x_373_) as u8);
    v_y_18__boxed_376_ = (lean_unbox(v_y_374_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString___lam__0___boxed(
    ...
    v_a_boxed_391_ = (lean_unbox(v_a_390_) as u8);
    v_res_392_ =
...
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Assignment_0__Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString_match__1_splitter___redArg(
    ...
    match v_a_439_ {
        ...
        1 => {
            ...
            v___x_447_ = lean_apply_1(v_h__2_441_, v___x_446_);
            return v___x_447_;
        }
        2 => {
        ...
        _ => {
            ...
            v___x_451_ = lean_apply_1(v_h__4_443_, v___x_450_);
            return v___x_451_;
        }
    }
}
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Assignment_0__Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString_match__1_splitter___redArg___boxed(
    ...
    v_a_46__boxed_457_ = (lean_unbox(v_a_452_) as u8);
...
pub unsafe fn l___private_Std_Tactic_BVDecide_LRAT_Internal_Assignment_0__Std_Tactic_BVDecide_LRAT_Internal_Assignment_instToString_match__1_splitter(
    ...
    mut v_a_460_: u8,
    mut v_h__1_461_: *mut LeanObject,
    mut v_h__2_462_: *mut LeanObject,
    mut v_h__3_463_: *mut LeanObject,
    mut v_h__4_464_: *mut LeanObject,
) -> *mut LeanObject {
    match v_a_460_ {
        0 => {
            let mut v___x_465_: *mut LeanObject = core::ptr::null_mut();
            let mut v___x_466_: *mut LeanObject = core::ptr::null_mut();
            lean_dec(v_h__4_464_);
            lean_dec(v_h__3_463_);
            lean_dec(v_h__2_462_);
            v___x_465_ = lean_box(0);
            v___x_466_ = lean_apply_1(v_h__1_461_, v___x_465_);
            return v___x_466_;
        }
        1 => {
            ...
            v___x_468_ = lean_apply_1(v_h__2_462_, v___x_467_);
            return v___x_468_;
        }
        2 => {
        ...
        _ => {
            ...
            v___x_472_ = lean_apply_1(v_h__4_464_, v___x_471_);
            return v___x_472_;
        }
    }
}
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_addAssignment___boxed(
    mut v_b_487_: *mut LeanObject,
    mut v_a_488_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_b_boxed_489_: u8 = 0;
    let mut v_a_boxed_490_: u8 = 0;
    let mut v_res_491_: u8 = 0;
    let mut v_r_492_: *mut LeanObject = core::ptr::null_mut();
    v_b_boxed_489_ = (lean_unbox(v_b_487_) as u8);
    v_a_boxed_490_ = (lean_unbox(v_a_488_) as u8);
    v_res_491_ = l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_addAssignment(
        v_b_boxed_489_,
        v_a_boxed_490_,
    );
    v_r_492_ = lean_box((v_res_491_) as usize);
    return v_r_492_;
}
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_removeAssignment___boxed(
    ...
    v_b_boxed_501_ = (lean_unbox(v_b_499_) as u8);
    v_a_boxed_502_ = (lean_unbox(v_a_500_) as u8);
...
pub unsafe fn l_Std_Tactic_BVDecide_LRAT_Internal_Assignment_hasAssignment___boxed(
    ...
    v_b_boxed_513_ = (lean_unbox(v_b_511_) as u8);
    v_a_boxed_514_ = (lean_unbox(v_a_512_) as u8);
