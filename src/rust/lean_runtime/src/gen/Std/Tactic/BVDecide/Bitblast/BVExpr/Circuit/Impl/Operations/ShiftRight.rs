...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst_go___redArg(
    ...
    mut v_input_463_: *mut LeanObject,
    mut v_distance_464_: *mut LeanObject,
    mut v_curr_465_: *mut LeanObject,
    mut v_s_466_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_gate_468_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_476_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_487_: *mut LeanObject = core::ptr::null_mut();
    let mut v_ref_489_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_478_ == 0 {
                    lean_dec(v_curr_465_);
                    v___x_479_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_479_, 0, v_aig_462_);
                    lean_ctor_set(v___x_479_, 1, v_s_466_);
                    return v___x_479_;
                } else {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst_go___redArg___boxed(
    mut v_w_496_: *mut LeanObject,
    mut v_aig_497_: *mut LeanObject,
    mut v_input_498_: *mut LeanObject,
    mut v_distance_499_: *mut LeanObject,
    mut v_curr_500_: *mut LeanObject,
    ...
    lean_dec(v_distance_499_);
    lean_dec_ref(v_input_498_);
    lean_dec(v_w_496_);
    return v_res_502_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst_go(
    ...
    mut v_w_506_: *mut LeanObject,
    mut v_aig_507_: *mut LeanObject,
    mut v_input_508_: *mut LeanObject,
    mut v_distance_509_: *mut LeanObject,
    mut v_curr_510_: *mut LeanObject,
    mut v_hcurr_511_: *mut LeanObject,
    mut v_s_512_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst_go___boxed(
    ...
    mut v_input_519_: *mut LeanObject,
    mut v_distance_520_: *mut LeanObject,
    mut v_curr_521_: *mut LeanObject,
    mut v_hcurr_522_: *mut LeanObject,
    ...
    lean_dec(v_distance_520_);
    lean_dec_ref(v_input_519_);
    lean_dec(v_w_517_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst___redArg(
    mut v_w_525_: *mut LeanObject,
    mut v_aig_526_: *mut LeanObject,
    mut v_target_527_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_vec_528_: *mut LeanObject = core::ptr::null_mut();
    let mut v_distance_529_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_vec_528_ = lean_ctor_get(v_target_527_, 0);
    v_distance_529_ = lean_ctor_get(v_target_527_, 1);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst___redArg___boxed(
    mut v_w_533_: *mut LeanObject,
    mut v_aig_534_: *mut LeanObject,
    mut v_target_535_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst(
    ...
    mut v_w_540_: *mut LeanObject,
    mut v_aig_541_: *mut LeanObject,
    mut v_target_542_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRightConst___boxed(
    ...
    mut v_w_547_: *mut LeanObject,
    mut v_aig_548_: *mut LeanObject,
    mut v_target_549_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst_go___redArg(
    mut v_w_551_: *mut LeanObject,
    mut v_input_552_: *mut LeanObject,
    mut v_distance_553_: *mut LeanObject,
    mut v_curr_554_: *mut LeanObject,
    mut v_s_555_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_gate_557_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_579_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_587_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_567_ == 0 {
                    ...
                    if v___x_569_ == 0 {
                        ...
                        v___x_591_ = lean_unsigned_to_nat(0);
            ...
            2 => {
                ...
                lean_dec(v_curr_554_);
                v___x_575_ = lean_unsigned_to_nat(2);
                v___x_576_ = lean_nat_mul(v_gate_572_, v___x_575_);
                lean_dec(v_gate_572_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst_go___redArg___boxed(
    mut v_w_594_: *mut LeanObject,
    mut v_input_595_: *mut LeanObject,
    mut v_distance_596_: *mut LeanObject,
    mut v_curr_597_: *mut LeanObject,
    ...
    lean_dec(v_distance_596_);
    lean_dec_ref(v_input_595_);
    lean_dec(v_w_594_);
    return v_res_599_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst_go(
    ...
    mut v_input_605_: *mut LeanObject,
    mut v_distance_606_: *mut LeanObject,
    mut v_curr_607_: *mut LeanObject,
    mut v_hcurr_608_: *mut LeanObject,
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst_go___boxed(
    ...
    mut v_w_614_: *mut LeanObject,
    mut v_aig_615_: *mut LeanObject,
    mut v_input_616_: *mut LeanObject,
    mut v_distance_617_: *mut LeanObject,
    mut v_curr_618_: *mut LeanObject,
    mut v_hcurr_619_: *mut LeanObject,
    ...
    lean_dec(v_distance_617_);
    lean_dec_ref(v_input_616_);
    lean_dec_ref(v_aig_615_);
    lean_dec(v_w_614_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst___redArg(
    mut v_w_622_: *mut LeanObject,
    mut v_aig_623_: *mut LeanObject,
    mut v_target_624_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_vec_625_: *mut LeanObject = core::ptr::null_mut();
    let mut v_distance_626_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_vec_625_ = lean_ctor_get(v_target_624_, 0);
                v_distance_626_ = lean_ctor_get(v_target_624_, 1);
                v_isSharedCheck_636_ = (!lean_is_exclusive(v_target_624_)) as u8;
            ...
            1 => {
                v___x_630_ = lean_unsigned_to_nat(0);
                ...
                lean_dec(v_distance_626_);
                lean_dec_ref(v_vec_625_);
                if v_isShared_629_ == 0 {
                    lean_ctor_set(v___x_628_, 1, v___x_632_);
                    lean_ctor_set(v___x_628_, 0, v_aig_623_);
                    v___x_634_ = v___x_628_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_635_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_635_, 0, v_aig_623_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst___redArg___boxed(
    mut v_w_637_: *mut LeanObject,
    mut v_aig_638_: *mut LeanObject,
    mut v_target_639_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst(
    ...
    mut v_w_644_: *mut LeanObject,
    mut v_aig_645_: *mut LeanObject,
    mut v_target_646_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst___boxed(
    ...
    mut v_w_651_: *mut LeanObject,
    mut v_aig_652_: *mut LeanObject,
    mut v_target_653_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_twoPowShift___redArg(
    ...
    mut v_w_657_: *mut LeanObject,
    mut v_aig_658_: *mut LeanObject,
    mut v_target_659_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_n_660_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lhs_661_: *mut LeanObject = core::ptr::null_mut();
    let mut v_rhs_662_: *mut LeanObject = core::ptr::null_mut();
    let mut v_pow_663_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_670_: *mut LeanObject = core::ptr::null_mut();
    let mut v_vec_671_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_ref_676_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_n_660_ = lean_ctor_get(v_target_659_, 0);
                v_lhs_661_ = lean_ctor_get(v_target_659_, 1);
                v_rhs_662_ = lean_ctor_get(v_target_659_, 2);
                v_pow_663_ = lean_ctor_get(v_target_659_, 3);
                v___x_664_ = lean_nat_dec_lt(v_pow_663_, v_n_660_);
                if v___x_664_ == 0 {
                    lean_dec_ref(v_inst_656_);
                    lean_dec_ref(v_inst_655_);
                    lean_inc_ref(v_lhs_661_);
                    v___x_665_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_665_, 0, v_aig_658_);
                    lean_ctor_set(v___x_665_, 1, v_lhs_661_);
                    return v___x_665_;
                } else {
                    v___x_666_ = lean_unsigned_to_nat(2);
                    v___x_667_ = lean_nat_pow(v___x_666_, v_pow_663_);
                    lean_inc_ref(v_lhs_661_);
                    v___x_668_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_668_, 0, v_lhs_661_);
                    ...
                    v_aig_670_ = lean_ctor_get(v_res_669_, 0);
                    lean_inc_ref(v_aig_670_);
                    v_vec_671_ = lean_ctor_get(v_res_669_, 1);
                    lean_inc_ref(v_vec_671_);
                    lean_dec_ref(v_res_669_);
                    v_ref_676_ = lean_array_fget_borrowed(v_rhs_662_, v_pow_663_);
                    v___x_677_ = lean_unsigned_to_nat(1);
                    ...
                    lean_dec(v___x_679_);
                    if v___x_681_ == 0 {
                        v___x_682_ = lean_alloc_ctor(0, 1, (1) as u32);
                        ...
                        v___x_683_ = 0;
                        v___x_684_ = lean_alloc_ctor(0, 1, (1) as u32);
            ...
            1 => {
                lean_inc_ref(v_lhs_661_);
                v___x_674_ = lean_alloc_ctor(0, 3, (0) as u32);
                lean_ctor_set(v___x_674_, 0, v___y_673_);
                lean_ctor_set(v___x_674_, 1, v_vec_671_);
                lean_ctor_set(v___x_674_, 2, v_lhs_661_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_twoPowShift___redArg___boxed(
    ...
    mut v_w_687_: *mut LeanObject,
    mut v_aig_688_: *mut LeanObject,
    mut v_target_689_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_twoPowShift(
    ...
    mut v_w_694_: *mut LeanObject,
    mut v_aig_695_: *mut LeanObject,
    mut v_target_696_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_twoPowShift___boxed(
    ...
    mut v_w_701_: *mut LeanObject,
    mut v_aig_702_: *mut LeanObject,
    mut v_target_703_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_go___redArg(
    ...
    mut v_aig_709_: *mut LeanObject,
    mut v_distance_710_: *mut LeanObject,
    mut v_curr_711_: *mut LeanObject,
    mut v_acc_712_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    let mut v_aig_720_: *mut LeanObject = core::ptr::null_mut();
    let mut v_vec_721_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v___x_713_ = lean_unsigned_to_nat(1);
                v___x_714_ = lean_nat_sub(v_n_708_, v___x_713_);
                v___x_715_ = lean_nat_dec_lt(v_curr_711_, v___x_714_);
                lean_dec(v___x_714_);
                if v___x_715_ == 0 {
                    lean_dec(v_curr_711_);
                    lean_dec_ref(v_distance_710_);
                    lean_dec(v_n_708_);
                    lean_dec_ref(v_inst_706_);
                    lean_dec_ref(v_inst_705_);
                    v___x_716_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_716_, 0, v_aig_709_);
                    lean_ctor_set(v___x_716_, 1, v_acc_712_);
                    return v___x_716_;
                } else {
                    v___x_717_ = lean_nat_add(v_curr_711_, v___x_713_);
                    lean_dec(v_curr_711_);
                    lean_inc(v___x_717_);
                    lean_inc_ref(v_distance_710_);
                    lean_inc(v_n_708_);
                    v___x_718_ = lean_alloc_ctor(0, 4, (0) as u32);
                    lean_ctor_set(v___x_718_, 0, v_n_708_);
                    lean_ctor_set(v___x_718_, 1, v_acc_712_);
                    lean_ctor_set(v___x_718_, 2, v_distance_710_);
                    ...
                    lean_dec_ref_known(v___x_718_, 4);
                    v_aig_720_ = lean_ctor_get(v_res_719_, 0);
                    lean_inc_ref(v_aig_720_);
                    v_vec_721_ = lean_ctor_get(v_res_719_, 1);
                    lean_inc_ref(v_vec_721_);
                    lean_dec_ref(v_res_719_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_go___redArg___boxed(
    ...
    mut v_w_725_: *mut LeanObject,
    mut v_n_726_: *mut LeanObject,
    mut v_aig_727_: *mut LeanObject,
    mut v_distance_728_: *mut LeanObject,
    mut v_curr_729_: *mut LeanObject,
    mut v_acc_730_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_go(
    ...
    mut v_w_735_: *mut LeanObject,
    mut v_n_736_: *mut LeanObject,
    mut v_aig_737_: *mut LeanObject,
    mut v_distance_738_: *mut LeanObject,
    mut v_curr_739_: *mut LeanObject,
    mut v_acc_740_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight_go___boxed(
    ...
    mut v_w_745_: *mut LeanObject,
    mut v_n_746_: *mut LeanObject,
    mut v_aig_747_: *mut LeanObject,
    mut v_distance_748_: *mut LeanObject,
    mut v_curr_749_: *mut LeanObject,
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight___redArg(
    ...
    mut v_w_754_: *mut LeanObject,
    mut v_aig_755_: *mut LeanObject,
    mut v_target_756_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_n_757_: *mut LeanObject = core::ptr::null_mut();
    let mut v_target_758_: *mut LeanObject = core::ptr::null_mut();
    let mut v_distance_759_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_760_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_761_: u8 = 0;
    v_n_757_ = lean_ctor_get(v_target_756_, 0);
    lean_inc(v_n_757_);
    v_target_758_ = lean_ctor_get(v_target_756_, 1);
    lean_inc_ref(v_target_758_);
    v_distance_759_ = lean_ctor_get(v_target_756_, 2);
    lean_inc_ref(v_distance_759_);
    lean_dec_ref(v_target_756_);
    v___x_760_ = lean_unsigned_to_nat(0);
    v___x_761_ = lean_nat_dec_eq(v_n_757_, v___x_760_);
    if v___x_761_ == 0 {
        let mut v___x_762_: *mut LeanObject = core::ptr::null_mut();
        let mut v_res_763_: *mut LeanObject = core::ptr::null_mut();
        let mut v_aig_764_: *mut LeanObject = core::ptr::null_mut();
        let mut v_vec_765_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_766_: *mut LeanObject = core::ptr::null_mut();
        lean_inc_ref(v_distance_759_);
        lean_inc(v_n_757_);
        v___x_762_ = lean_alloc_ctor(0, 4, (0) as u32);
        lean_ctor_set(v___x_762_, 0, v_n_757_);
        lean_ctor_set(v___x_762_, 1, v_target_758_);
        lean_ctor_set(v___x_762_, 2, v_distance_759_);
        lean_ctor_set(v___x_762_, 3, v___x_760_);
        ...
        lean_dec_ref_known(v___x_762_, 4);
        v_aig_764_ = lean_ctor_get(v_res_763_, 0);
        lean_inc_ref(v_aig_764_);
        v_vec_765_ = lean_ctor_get(v_res_763_, 1);
        lean_inc_ref(v_vec_765_);
        ...
        lean_dec_ref(v_distance_759_);
        lean_dec(v_n_757_);
        lean_dec_ref(v_inst_753_);
        lean_dec_ref(v_inst_752_);
        v___x_767_ = lean_alloc_ctor(0, 2, (0) as u32);
        lean_ctor_set(v___x_767_, 0, v_aig_755_);
        lean_ctor_set(v___x_767_, 1, v_target_758_);
        return v___x_767_;
    }
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight___redArg___boxed(
    ...
    mut v_w_770_: *mut LeanObject,
    mut v_aig_771_: *mut LeanObject,
    mut v_target_772_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight(
    ...
    mut v_w_777_: *mut LeanObject,
    mut v_aig_778_: *mut LeanObject,
    mut v_target_779_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastShiftRight___boxed(
    ...
    mut v_w_784_: *mut LeanObject,
    mut v_aig_785_: *mut LeanObject,
    mut v_target_786_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_twoPowShift___redArg(
    ...
    mut v_aig_791_: *mut LeanObject,
    mut v_target_792_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_n_793_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lhs_794_: *mut LeanObject = core::ptr::null_mut();
    let mut v_rhs_795_: *mut LeanObject = core::ptr::null_mut();
    let mut v_pow_796_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_aig_803_: *mut LeanObject = core::ptr::null_mut();
    let mut v_vec_804_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_n_793_ = lean_ctor_get(v_target_792_, 0);
                v_lhs_794_ = lean_ctor_get(v_target_792_, 1);
                v_rhs_795_ = lean_ctor_get(v_target_792_, 2);
                v_pow_796_ = lean_ctor_get(v_target_792_, 3);
                ...
                if v___x_797_ == 0 {
                    ...
                    lean_ctor_set(v___x_798_, 0, v_aig_791_);
                    lean_ctor_set(v___x_798_, 1, v_lhs_794_);
                    return v___x_798_;
                } else {
                    v___x_799_ = lean_unsigned_to_nat(2);
                    v___x_800_ = lean_nat_pow(v___x_799_, v_pow_796_);
                    lean_inc_ref(v_lhs_794_);
                    v___x_801_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_801_, 0, v_lhs_794_);
                    lean_ctor_set(v___x_801_, 1, v___x_800_);
                    v_res_802_ =
                        l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRightConst___redArg(
                            v_w_790_, v_aig_791_, v___x_801_,
                        );
                    v_aig_803_ = lean_ctor_get(v_res_802_, 0);
                    lean_inc_ref(v_aig_803_);
                    v_vec_804_ = lean_ctor_get(v_res_802_, 1);
                    lean_inc_ref(v_vec_804_);
                    lean_dec_ref(v_res_802_);
                    ...
                    lean_dec(v___x_812_);
                    if v___x_814_ == 0 {
                        v___x_815_ = lean_alloc_ctor(0, 1, (1) as u32);
                        ...
                        v___x_816_ = 0;
                        v___x_817_ = lean_alloc_ctor(0, 1, (1) as u32);
            ...
            1 => {
                ...
                lean_ctor_set(v___x_807_, 0, v___y_806_);
                lean_ctor_set(v___x_807_, 1, v_vec_804_);
                lean_ctor_set(v___x_807_, 2, v_lhs_794_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_twoPowShift___redArg___boxed(
    ...
    mut v_w_820_: *mut LeanObject,
    mut v_aig_821_: *mut LeanObject,
    mut v_target_822_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_twoPowShift(
    ...
    mut v_w_827_: *mut LeanObject,
    mut v_aig_828_: *mut LeanObject,
    mut v_target_829_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_twoPowShift___boxed(
    ...
    mut v_w_834_: *mut LeanObject,
    mut v_aig_835_: *mut LeanObject,
    mut v_target_836_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_go___redArg(
    ...
    mut v_w_840_: *mut LeanObject,
    mut v_n_841_: *mut LeanObject,
    mut v_aig_842_: *mut LeanObject,
    mut v_distance_843_: *mut LeanObject,
    mut v_curr_844_: *mut LeanObject,
    mut v_acc_845_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    let mut v_aig_853_: *mut LeanObject = core::ptr::null_mut();
    let mut v_vec_854_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                ...
                lean_dec(v___x_847_);
                if v___x_848_ == 0 {
                    lean_dec(v_curr_844_);
                    lean_dec_ref(v_distance_843_);
                    lean_dec(v_n_841_);
                    lean_dec_ref(v_inst_839_);
                    lean_dec_ref(v_inst_838_);
                    v___x_849_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_849_, 0, v_aig_842_);
                    lean_ctor_set(v___x_849_, 1, v_acc_845_);
                    return v___x_849_;
                } else {
                    v___x_850_ = lean_nat_add(v_curr_844_, v___x_846_);
                    lean_dec(v_curr_844_);
                    lean_inc(v___x_850_);
                    lean_inc_ref(v_distance_843_);
                    lean_inc(v_n_841_);
                    v___x_851_ = lean_alloc_ctor(0, 4, (0) as u32);
                    lean_ctor_set(v___x_851_, 0, v_n_841_);
                    lean_ctor_set(v___x_851_, 1, v_acc_845_);
                    lean_ctor_set(v___x_851_, 2, v_distance_843_);
                    ...
                    lean_dec_ref_known(v___x_851_, 4);
                    v_aig_853_ = lean_ctor_get(v_res_852_, 0);
                    lean_inc_ref(v_aig_853_);
                    v_vec_854_ = lean_ctor_get(v_res_852_, 1);
                    lean_inc_ref(v_vec_854_);
                    lean_dec_ref(v_res_852_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_go___redArg___boxed(
    ...
    mut v_w_858_: *mut LeanObject,
    mut v_n_859_: *mut LeanObject,
    mut v_aig_860_: *mut LeanObject,
    mut v_distance_861_: *mut LeanObject,
    mut v_curr_862_: *mut LeanObject,
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_go(
    ...
    mut v_w_868_: *mut LeanObject,
    mut v_n_869_: *mut LeanObject,
    mut v_aig_870_: *mut LeanObject,
    mut v_distance_871_: *mut LeanObject,
    mut v_curr_872_: *mut LeanObject,
    mut v_acc_873_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight_go___boxed(
    ...
    mut v_w_878_: *mut LeanObject,
    mut v_n_879_: *mut LeanObject,
    mut v_aig_880_: *mut LeanObject,
    mut v_distance_881_: *mut LeanObject,
    mut v_curr_882_: *mut LeanObject,
    mut v_acc_883_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight___redArg(
    ...
    mut v_w_887_: *mut LeanObject,
    mut v_aig_888_: *mut LeanObject,
    mut v_target_889_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_n_890_: *mut LeanObject = core::ptr::null_mut();
    let mut v_target_891_: *mut LeanObject = core::ptr::null_mut();
    let mut v_distance_892_: *mut LeanObject = core::ptr::null_mut();
    ...
    if v___x_894_ == 0 {
        ...
        let mut v_aig_897_: *mut LeanObject = core::ptr::null_mut();
        let mut v_vec_898_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight___redArg___boxed(
    ...
    mut v_w_903_: *mut LeanObject,
    mut v_aig_904_: *mut LeanObject,
    mut v_target_905_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight(
    ...
    mut v_w_910_: *mut LeanObject,
    mut v_aig_911_: *mut LeanObject,
    mut v_target_912_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastArithShiftRight___boxed(
    ...
    mut v_inst_916_: *mut LeanObject,
    mut v_w_917_: *mut LeanObject,
    mut v_aig_918_: *mut LeanObject,
    mut v_target_919_: *mut LeanObject,
) -> *mut LeanObject {
