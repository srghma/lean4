...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastConst_go___redArg(
    ...
    mut v_val_62_: *mut LeanObject,
    mut v_curr_63_: *mut LeanObject,
    ...
    let mut v_s_72_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastConst_go___redArg___boxed(
    ...
    mut v_val_75_: *mut LeanObject,
    mut v_curr_76_: *mut LeanObject,
    mut v_s_77_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastConst_go(
    ...
    mut v_w_82_: *mut LeanObject,
    mut v_aig_83_: *mut LeanObject,
    mut v_val_84_: *mut LeanObject,
    mut v_curr_85_: *mut LeanObject,
    mut v_s_86_: *mut LeanObject,
    mut v_hcurr_87_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastConst_go___boxed(
    ...
    mut v_w_92_: *mut LeanObject,
    mut v_aig_93_: *mut LeanObject,
    mut v_val_94_: *mut LeanObject,
    mut v_curr_95_: *mut LeanObject,
    mut v_s_96_: *mut LeanObject,
    mut v_hcurr_97_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastConst___redArg(
    mut v_w_99_: *mut LeanObject,
    mut v_val_100_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastConst___redArg___boxed(
    mut v_w_104_: *mut LeanObject,
    mut v_val_105_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastConst(
    ...
    mut v_w_110_: *mut LeanObject,
    mut v_aig_111_: *mut LeanObject,
    mut v_val_112_: *mut LeanObject,
) -> *mut LeanObject {
