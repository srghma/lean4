...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend_go___redArg(
    ...
    let mut v_s_105_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_s_115_: *mut LeanObject = core::ptr::null_mut();
    let mut v_ref_117_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_107_ == 0 {
                    lean_dec(v_curr_94_);
                    v___x_108_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_108_, 0, v_aig_90_);
                    lean_ctor_set(v___x_108_, 1, v_s_95_);
                    return v___x_108_;
                } else {
            ...
            1 => {
                ...
                lean_dec(v_curr_94_);
                v___x_101_ = lean_unsigned_to_nat(2);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend_go___redArg___boxed(
    mut v_aig_124_: *mut LeanObject,
    mut v_w_125_: *mut LeanObject,
    mut v_input_126_: *mut LeanObject,
    mut v_newWidth_127_: *mut LeanObject,
    mut v_curr_128_: *mut LeanObject,
    ...
    lean_dec(v_newWidth_127_);
    lean_dec_ref(v_input_126_);
    lean_dec(v_w_125_);
    return v_res_130_;
}
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend_go(
    ...
    mut v_w_135_: *mut LeanObject,
    mut v_input_136_: *mut LeanObject,
    mut v_newWidth_137_: *mut LeanObject,
    mut v_curr_138_: *mut LeanObject,
    mut v_hcurr_139_: *mut LeanObject,
    mut v_s_140_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend_go___boxed(
    ...
    mut v_aig_145_: *mut LeanObject,
    mut v_w_146_: *mut LeanObject,
    mut v_input_147_: *mut LeanObject,
    mut v_newWidth_148_: *mut LeanObject,
    mut v_curr_149_: *mut LeanObject,
    mut v_hcurr_150_: *mut LeanObject,
    ...
    lean_dec(v_newWidth_148_);
    lean_dec_ref(v_input_147_);
    lean_dec(v_w_146_);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend___redArg(
    mut v_newWidth_153_: *mut LeanObject,
    mut v_aig_154_: *mut LeanObject,
    mut v_target_155_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_w_156_: *mut LeanObject = core::ptr::null_mut();
    let mut v_vec_157_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_w_156_ = lean_ctor_get(v_target_155_, 0);
    v_vec_157_ = lean_ctor_get(v_target_155_, 1);
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend___redArg___boxed(
    mut v_newWidth_161_: *mut LeanObject,
    mut v_aig_162_: *mut LeanObject,
    mut v_target_163_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend(
    ...
    mut v_newWidth_168_: *mut LeanObject,
    mut v_aig_169_: *mut LeanObject,
    mut v_target_170_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_Tactic_BVDecide_BVExpr_bitblast_blastZeroExtend___boxed(
    ...
    mut v_target_177_: *mut LeanObject,
) -> *mut LeanObject {
