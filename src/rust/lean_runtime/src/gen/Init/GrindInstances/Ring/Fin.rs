...
pub unsafe fn l_Lean_Grind_Fin_npow___redArg(
    mut v_n_72_: *mut LeanObject,
    mut v_x_73_: *mut LeanObject,
    mut v_y_74_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    v___x_77_ = lean_alloc_closure(l_Fin_mul___boxed as *mut core::ffi::c_void, 3, 1);
    lean_closure_set(v___x_77_, 0, v_n_72_);
...
pub unsafe fn l_Lean_Grind_Fin_instPowFinNatOfNeZero___redArg(
    ...
    v___x_99_ = lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    lean_closure_set(v___x_99_, 0, v_n_98_);
...
pub unsafe fn l_Lean_Grind_Fin_instPowFinNatOfNeZero(
    ...
    v___x_102_ = lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    lean_closure_set(v___x_102_, 0, v_n_100_);
...
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__2(
    ...
    mut v_k_119_: *mut LeanObject,
    mut v_i_120_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg(
    ...
    let mut v___f_129_: *mut LeanObject = core::ptr::null_mut();
    let mut v___f_130_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_131_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_132_: *mut LeanObject = core::ptr::null_mut();
    let mut v___f_133_: *mut LeanObject = core::ptr::null_mut();
    ...
    v___f_129_ = lean_alloc_closure(
        l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__1___boxed
            as *mut core::ffi::c_void,
        3,
        1,
    );
    lean_closure_set(v___f_129_, 0, v_n_127_);
    v___f_130_ = lean_alloc_closure(
        l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat___redArg___lam__2___boxed
            as *mut core::ffi::c_void,
        3,
        1,
    );
    lean_closure_set(v___f_130_, 0, v_n_127_);
    v___x_131_ = lean_alloc_closure(l_Fin_add___boxed as *mut core::ffi::c_void, 3, 1);
    lean_closure_set(v___x_131_, 0, v_n_127_);
    v___x_132_ = lean_alloc_closure(l_Fin_mul___boxed as *mut core::ffi::c_void, 3, 1);
    lean_closure_set(v___x_132_, 0, v_n_127_);
    v___f_133_ = lean_alloc_closure(
        l_Fin_NatCast_instNatCast___redArg___lam__0___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    lean_closure_set(v___f_133_, 0, v_n_127_);
    v___f_134_ = lean_alloc_closure(l_Fin_neg___lam__0___boxed as *mut core::ffi::c_void, 2, 1);
    lean_closure_set(v___f_134_, 0, v_n_127_);
    v___x_135_ = lean_alloc_closure(l_Fin_sub___boxed as *mut core::ffi::c_void, 3, 1);
    lean_closure_set(v___x_135_, 0, v_n_127_);
    v___x_136_ = lean_alloc_closure(
        l_Lean_Grind_Fin_npow___boxed as *mut core::ffi::c_void,
        4,
        2,
    );
    lean_closure_set(v___x_136_, 0, v_n_127_);
    lean_closure_set(v___x_136_, 1, lean_box(0));
    v___x_137_ = lean_alloc_ctor(0, 6, (0) as u32);
    lean_ctor_set(v___x_137_, 0, v___x_131_);
    lean_ctor_set(v___x_137_, 1, v___x_132_);
    lean_ctor_set(v___x_137_, 2, v___f_133_);
    lean_ctor_set(v___x_137_, 3, v___f_128_);
    lean_ctor_set(v___x_137_, 4, v___f_129_);
    lean_ctor_set(v___x_137_, 5, v___x_136_);
    v___x_138_ = lean_alloc_closure(l_Fin_intCast___boxed as *mut core::ffi::c_void, 3, 2);
    lean_closure_set(v___x_138_, 0, v_n_127_);
    lean_closure_set(v___x_138_, 1, lean_box(0));
    v___x_139_ = lean_alloc_ctor(0, 5, (0) as u32);
    ...
    lean_ctor_set(v___x_139_, 4, v___f_130_);
    return v___x_139_;
}
pub unsafe fn l_Lean_Grind_Fin_instCommRingFinOfNeZeroNat(
    mut v_n_140_: *mut LeanObject,
...
pub unsafe fn runtime_initialize_Init_GrindInstances_Ring_Fin(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_GrindInstances_Ring_Fin(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_GrindInstances_Ring_Fin(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
