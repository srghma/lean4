...
pub static mut l_ShareCommon_StateFactoryPointed: *mut LeanObject = core::ptr::null_mut();
pub static l_ShareCommon_StateFactory_mkImpl___lam__2___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_ShareCommon_StateFactory_mkImpl___lam__2___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_ShareCommon_StateFactory_mkImpl___lam__2___closed__0_value)
        as *mut LeanObject;
pub static l_ShareCommon_StateFactory_mkImpl___lam__2___closed__1_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_ShareCommon_StateFactory_mkImpl___lam__2___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_ShareCommon_StateFactory_mkImpl___lam__2___closed__1_value)
        as *mut LeanObject;
pub static l_ShareCommon_StateFactory_mkImpl___lam__2___closed__2_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_ShareCommon_StateFactory_mkImpl___lam__2___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_ShareCommon_StateFactory_mkImpl___lam__2___closed__2_value)
        as *mut LeanObject;
pub static l_ShareCommon_StateFactory_mkImpl___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_ShareCommon_StateFactory_mkImpl___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_ShareCommon_StateFactory_mkImpl___closed__0_value) as *mut LeanObject;
pub static l_ShareCommonT_run___redArg___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_ShareCommonT_run___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_ShareCommonT_run___redArg___closed__0_value) as *mut LeanObject;
pub unsafe fn l_ShareCommon_Object_ptrEq(
    mut v_a_192_: *mut LeanObject,
    mut v_b_193_: *mut LeanObject,
) -> u8 {
...
pub unsafe fn l_ShareCommon_Object_ptrEq___boxed(
    ...
    mut v_b_198_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_res_199_: u8 = 0;
    let mut v_r_200_: *mut LeanObject = core::ptr::null_mut();
    v_res_199_ = l_ShareCommon_Object_ptrEq(v_a_197_, v_b_198_);
    lean_dec(v_b_198_);
    lean_dec(v_a_197_);
    v_r_200_ = lean_box((v_res_199_) as usize);
    return v_r_200_;
}
pub unsafe fn l_ShareCommon_Object_ptrHash(mut v_a_201_: *mut LeanObject) -> u64 {
...
pub unsafe fn l_ShareCommon_Object_ptrHash___boxed(
    ...
    let mut v_r_206_: *mut LeanObject = core::ptr::null_mut();
    v_res_205_ = l_ShareCommon_Object_ptrHash(v_a_204_);
    lean_dec(v_a_204_);
    v_r_206_ = lean_box_uint64(v_res_205_);
    return v_r_206_;
}
pub unsafe fn _init_l_ShareCommon_StateFactoryPointed() -> *mut LeanObject {
...
pub unsafe fn l_ShareCommon_Object_hash___boxed(mut v_a_215_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_ShareCommon_StateFactory_mkImpl___lam__0(mut v___y_218_: *mut LeanObject) -> u64 {
...
pub unsafe fn l_ShareCommon_StateFactory_mkImpl___lam__0___boxed(
    ...
    lean_dec(v___y_221_);
    v_r_223_ = lean_box_uint64(v_res_222_);
    return v_r_223_;
}
pub unsafe fn l_ShareCommon_StateFactory_mkImpl___lam__2(
    mut v_mkMap_227_: *mut LeanObject,
    mut v___f_228_: *mut LeanObject,
    mut v_mkSet_229_: *mut LeanObject,
    ...
    v___x_232_ = lean_unsigned_to_nat(1024);
    v___x_233_ = lean_apply_5(
        v_mkMap_227_,
        lean_box(0),
        lean_box(0),
        v___x_231_,
...
pub unsafe fn l_ShareCommon_StateFactory_mkImpl(mut v_x_239_: *mut LeanObject) -> *mut LeanObject {
    let mut v_mkMap_240_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mapFind_x3f_241_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mapInsert_242_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mkSet_243_: *mut LeanObject = core::ptr::null_mut();
    let mut v_setFind_x3f_244_: *mut LeanObject = core::ptr::null_mut();
    let mut v_setInsert_245_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_mkMap_240_ = lean_ctor_get(v_x_239_, 0);
    lean_inc(v_mkMap_240_);
    v_mapFind_x3f_241_ = lean_ctor_get(v_x_239_, 1);
    lean_inc_ref(v_mapFind_x3f_241_);
    v_mapInsert_242_ = lean_ctor_get(v_x_239_, 2);
    lean_inc(v_mapInsert_242_);
    v_mkSet_243_ = lean_ctor_get(v_x_239_, 3);
    lean_inc(v_mkSet_243_);
    v_setFind_x3f_244_ = lean_ctor_get(v_x_239_, 4);
    lean_inc_ref(v_setFind_x3f_244_);
    v_setInsert_245_ = lean_ctor_get(v_x_239_, 5);
    lean_inc(v_setInsert_245_);
    ...
    lean_closure_set(v___f_247_, 0, v_mkMap_240_);
    lean_closure_set(v___f_247_, 1, v___f_246_);
    lean_closure_set(v___f_247_, 2, v_mkSet_243_);
    v___x_248_ = l_ShareCommon_StateFactory_mkImpl___lam__2___closed__0;
    v___x_249_ = lean_apply_4(
        v_mapFind_x3f_241_,
        lean_box(0),
        lean_box(0),
        v___x_248_,
    ...
    v___x_253_ = lean_apply_3(v_setFind_x3f_244_, lean_box(0), v___x_251_, v___x_252_);
    v___x_254_ = lean_apply_3(v_setInsert_245_, lean_box(0), v___x_251_, v___x_252_);
    v___x_255_ = lean_alloc_ctor(0, 5, (0) as u32);
    lean_ctor_set(v___x_255_, 0, v___f_247_);
    lean_ctor_set(v___x_255_, 1, v___x_249_);
    lean_ctor_set(v___x_255_, 2, v___x_250_);
    lean_ctor_set(v___x_255_, 3, v___x_253_);
    lean_ctor_set(v___x_255_, 4, v___x_254_);
    return v___x_255_;
}
pub unsafe fn l_ShareCommon_StateFactory_get(mut v_a_256_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_a_256_);
    return v_a_256_;
}
...
pub unsafe fn l_ShareCommon_StatePointed(mut v_00_u03c3_259_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_260_: *mut LeanObject = core::ptr::null_mut();
    v___x_260_ = lean_box(0);
    return v___x_260_;
}
pub unsafe fn l_ShareCommon_StatePointed___boxed(
    mut v_00_u03c3_261_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_res_262_: *mut LeanObject = core::ptr::null_mut();
    v_res_262_ = l_ShareCommon_StatePointed(v_00_u03c3_261_);
    lean_dec(v_00_u03c3_261_);
    return v_res_262_;
}
pub unsafe fn l_ShareCommon_mkStateImpl(mut v_00_u03c3_263_: *mut LeanObject) -> *mut LeanObject {
    let mut v_mkState_264_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_265_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_266_: *mut LeanObject = core::ptr::null_mut();
    v_mkState_264_ = lean_ctor_get(v_00_u03c3_263_, 0);
    lean_inc_ref(v_mkState_264_);
    lean_dec(v_00_u03c3_263_);
    v___x_265_ = lean_box(0);
    v___x_266_ = lean_apply_1(v_mkState_264_, v___x_265_);
    return v___x_266_;
}
pub unsafe fn l_ShareCommon_instInhabitedState(
    mut v_00_u03c3_267_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_ShareCommon_State_shareCommon___boxed(
    ...
    mut v_00_u03c3_274_: *mut LeanObject,
...
pub unsafe fn l_shareCommonM___redArg(
    ...
    v___x_288_ = lean_apply_2(v_inst_286_, lean_box(0), v_a_287_);
    return v___x_288_;
}
pub unsafe fn l_shareCommonM(
    ...
    v___x_293_ = lean_apply_2(v_inst_291_, lean_box(0), v_a_292_);
    return v___x_293_;
}
pub unsafe fn l_ShareCommonT_withShareCommon___redArg(
    mut v_00_u03c3_294_: *mut LeanObject,
    ...
    v_toPure_299_ = lean_ctor_get(v_toApplicative_298_, 1);
    ...
    v___x_301_ = lean_apply_2(v_toPure_299_, lean_box(0), v___x_300_);
    return v___x_301_;
}
pub unsafe fn l_ShareCommonT_withShareCommon___redArg___boxed(
    mut v_00_u03c3_302_: *mut LeanObject,
...
pub unsafe fn l_ShareCommonT_withShareCommon___boxed(
    mut v_m_314_: *mut LeanObject,
    mut v_00_u03b1_315_: *mut LeanObject,
    mut v_00_u03c3_316_: *mut LeanObject,
...
pub unsafe fn l_ShareCommonT_monadShareCommon___redArg___lam__0___boxed(
    mut v_00_u03c3_327_: *mut LeanObject,
    ...
    lean_dec(v_00_u03c3_327_);
    return v_res_332_;
}
pub unsafe fn l_ShareCommonT_monadShareCommon___redArg(
    mut v_00_u03c3_333_: *mut LeanObject,
    ...
    lean_closure_set(v___f_335_, 0, v_00_u03c3_333_);
    lean_closure_set(v___f_335_, 1, v_inst_334_);
    return v___f_335_;
}
pub unsafe fn l_ShareCommonT_monadShareCommon(
    mut v_m_336_: *mut LeanObject,
    mut v_00_u03c3_337_: *mut LeanObject,
    mut v_inst_338_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___f_339_: *mut LeanObject = core::ptr::null_mut();
    v___f_339_ = lean_alloc_closure(
        l_ShareCommonT_monadShareCommon___redArg___lam__0___boxed as *mut core::ffi::c_void,
        5,
        2,
    );
    lean_closure_set(v___f_339_, 0, v_00_u03c3_337_);
    lean_closure_set(v___f_339_, 1, v_inst_338_);
    return v___f_339_;
}
pub unsafe fn l_ShareCommonT_run___redArg___lam__0(
    mut v_x_340_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_341_: *mut LeanObject = core::ptr::null_mut();
    v_fst_341_ = lean_ctor_get(v_x_340_, 0);
    lean_inc(v_fst_341_);
    return v_fst_341_;
}
...
pub unsafe fn l_ShareCommonT_run___redArg(
    ...
    let mut v_toApplicative_348_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_349_: *mut LeanObject = core::ptr::null_mut();
    let mut v_map_350_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toApplicative_348_ = lean_ctor_get(v_inst_346_, 0);
    lean_inc_ref(v_toApplicative_348_);
    lean_dec_ref(v_inst_346_);
    v_toFunctor_349_ = lean_ctor_get(v_toApplicative_348_, 0);
    lean_inc_ref(v_toFunctor_349_);
    lean_dec_ref(v_toApplicative_348_);
    v_map_350_ = lean_ctor_get(v_toFunctor_349_, 0);
    lean_inc(v_map_350_);
    lean_dec_ref(v_toFunctor_349_);
    v___f_351_ = l_ShareCommonT_run___redArg___closed__0;
    v___x_352_ = l_ShareCommon_mkStateImpl(v_00_u03c3_345_);
    v___x_353_ = lean_apply_1(v_x_347_, v___x_352_);
    v___x_354_ = lean_apply_4(v_map_350_, lean_box(0), lean_box(0), v___f_351_, v___x_353_);
    return v___x_354_;
}
pub unsafe fn l_ShareCommonT_run(
    mut v_m_355_: *mut LeanObject,
    mut v_00_u03c3_356_: *mut LeanObject,
    mut v_00_u03b1_357_: *mut LeanObject,
    mut v_inst_358_: *mut LeanObject,
    mut v_x_359_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_toApplicative_360_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_361_: *mut LeanObject = core::ptr::null_mut();
    let mut v_map_362_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toFunctor_361_ = lean_ctor_get(v_toApplicative_360_, 0);
    lean_inc_ref(v_toFunctor_361_);
    lean_dec_ref(v_toApplicative_360_);
    v_map_362_ = lean_ctor_get(v_toFunctor_361_, 0);
    lean_inc(v_map_362_);
    lean_dec_ref(v_toFunctor_361_);
    v___f_363_ = l_ShareCommonT_run___redArg___closed__0;
    v___x_364_ = l_ShareCommon_mkStateImpl(v_00_u03c3_356_);
    v___x_365_ = lean_apply_1(v_x_359_, v___x_364_);
    v___x_366_ = lean_apply_4(v_map_362_, lean_box(0), lean_box(0), v___f_363_, v___x_365_);
    return v___x_366_;
}
pub unsafe fn l_ShareCommonM_run___redArg(
    mut v_00_u03c3_367_: *mut LeanObject,
    ...
    let mut v_fst_371_: *mut LeanObject = core::ptr::null_mut();
    v___x_369_ = l_ShareCommon_mkStateImpl(v_00_u03c3_367_);
    v___x_370_ = lean_apply_1(v_x_368_, v___x_369_);
...
pub unsafe fn l_ShareCommonM_run(
    mut v_00_u03c3_372_: *mut LeanObject,
    ...
    let mut v_fst_377_: *mut LeanObject = core::ptr::null_mut();
    v___x_375_ = l_ShareCommon_mkStateImpl(v_00_u03c3_372_);
    v___x_376_ = lean_apply_1(v_x_374_, v___x_375_);
...
pub unsafe fn runtime_initialize_Init_ShareCommon(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_ShareCommon(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_ShareCommon(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
