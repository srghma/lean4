...
use crate::leanh::{
    ...
    lean_inc, lean_inc_n, lean_io_result_is_error, lean_io_result_mk_ok, lean_unsigned_to_nat,
};
pub static l_List_ofFnM___redArg___closed__0_value: LeanClosureObject<1> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_List_ofFnM___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_List_ofFnM___redArg___closed__0_value) as *mut LeanObject;
pub unsafe fn l_Fin_foldr_loop___at___00List_ofFn_spec__0___redArg(
    mut v_f_62_: *mut LeanObject,
    mut v_i_63_: *mut LeanObject,
    mut v_a_64_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_zero_65_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isZero_66_: u8 = 0;
    let mut v_one_67_: *mut LeanObject = core::ptr::null_mut();
    let mut v_n_68_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_65_ = lean_unsigned_to_nat(0);
                ...
                if v_isZero_66_ == 1 {
                    ...
                    v_one_67_ = lean_unsigned_to_nat(1);
                    v_n_68_ = lean_nat_sub(v_i_63_, v_one_67_);
                    lean_dec(v_i_63_);
                    lean_inc(v_f_62_);
                    lean_inc(v_n_68_);
                    v___x_69_ = lean_apply_1(v_f_62_, v_n_68_);
                    v___x_70_ = lean_alloc_ctor(1, 2, (0) as u32);
                    lean_ctor_set(v___x_70_, 0, v___x_69_);
                    lean_ctor_set(v___x_70_, 1, v_a_64_);
                    v_i_63_ = v_n_68_;
                    v_a_64_ = v___x_70_;
                    state = 0;
                    continue;
...
pub unsafe fn l_Fin_foldr_loop___at___00List_ofFn_spec__0___boxed(
    ...
    mut v_i_90_: *mut LeanObject,
    mut v_a_91_: *mut LeanObject,
    mut v_a_92_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_List_ofFnM___redArg___lam__0(
    mut v_xs_94_: *mut LeanObject,
    mut v_x_95_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_96_: *mut LeanObject = core::ptr::null_mut();
    v___x_96_ = lean_alloc_ctor(1, 2, (0) as u32);
    lean_ctor_set(v___x_96_, 0, v_x_95_);
    lean_ctor_set(v___x_96_, 1, v_xs_94_);
    return v___x_96_;
}
pub unsafe fn l_List_ofFnM___redArg___lam__1(
    mut v_f_97_: *mut LeanObject,
    mut v_map_98_: *mut LeanObject,
    mut v_xs_99_: *mut LeanObject,
    mut v_i_100_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___f_101_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_102_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_103_: *mut LeanObject = core::ptr::null_mut();
    v___f_101_ = lean_alloc_closure(
        l_List_ofFnM___redArg___lam__0 as *mut core::ffi::c_void,
        2,
        1,
    );
    lean_closure_set(v___f_101_, 0, v_xs_99_);
    v___x_102_ = lean_apply_1(v_f_97_, v_i_100_);
    v___x_103_ = lean_apply_4(v_map_98_, lean_box(0), lean_box(0), v___f_101_, v___x_102_);
    return v___x_103_;
}
pub unsafe fn l_List_ofFnM___redArg(
    mut v_n_105_: *mut LeanObject,
    mut v_inst_106_: *mut LeanObject,
    mut v_f_107_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_toApplicative_108_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_109_: *mut LeanObject = core::ptr::null_mut();
    let mut v_map_110_: *mut LeanObject = core::ptr::null_mut();
    let mut v___f_111_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toApplicative_108_ = lean_ctor_get(v_inst_106_, 0);
    v_toFunctor_109_ = lean_ctor_get(v_toApplicative_108_, 0);
    v_map_110_ = lean_ctor_get(v_toFunctor_109_, 0);
    lean_inc_n(v_map_110_, 2);
    v___f_111_ = lean_alloc_closure(
        l_List_ofFnM___redArg___lam__1 as *mut core::ffi::c_void,
        4,
        2,
    );
    lean_closure_set(v___f_111_, 0, v_f_107_);
    lean_closure_set(v___f_111_, 1, v_map_110_);
    v___x_112_ = l_List_ofFnM___redArg___closed__0;
    v___x_113_ = lean_box(0);
    v___x_114_ = lean_unsigned_to_nat(0);
    ...
    v___x_116_ = lean_apply_4(v_map_110_, lean_box(0), lean_box(0), v___x_112_, v___x_115_);
    return v___x_116_;
}
...
pub unsafe fn runtime_initialize_Init_Data_List_OfFn(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List_OfFn(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_OfFn(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
