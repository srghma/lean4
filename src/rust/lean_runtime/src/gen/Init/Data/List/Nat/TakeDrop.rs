...
// Imports: Init.Data.List.Lemmas Init.Data.Nat.MinMax Init.ByCases Init.Data.Bool Init.Data.List.Find Init.Data.List.Sublist Init.Data.List.TakeDrop Init.Data.List.Zip Init.Data.Nat.Lemmas Init.Data.Option.Lemmas Init.Omega
...
pub unsafe fn runtime_initialize_Init_Data_List_Nat_TakeDrop(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List_Nat_TakeDrop(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Nat_TakeDrop(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
    ...
    lean_dec_ref(res);
    res = meta_initialize_Init_Data_List_Nat_TakeDrop(builtin);
    if lean_io_result_is_error(res) {
        return res;
    }
    lean_dec_ref(res);
    return initialize_Init_Data_List_Nat_TakeDrop(builtin);
}
