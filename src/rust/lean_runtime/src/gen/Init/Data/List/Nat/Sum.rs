...
// Imports: Init.Data.List.MinMax Init.BinderPredicates Init.NotationExtra Init.Data.Nat.Div.Lemmas Init.Data.Nat.Lemmas Init.Data.Nat.MinMax Init.Data.Option.Lemmas Init.Omega
...
pub unsafe fn runtime_initialize_Init_Data_List_Nat_Sum(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List_Nat_Sum(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Nat_Sum(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
