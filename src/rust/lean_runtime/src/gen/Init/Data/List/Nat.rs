...
use crate::r#gen::Init::Data::List::Nat::Count::{
    initialize_Init_Data_List_Nat_Count, runtime_initialize_Init_Data_List_Nat_Count,
};
...
use crate::r#gen::Init::Data::List::Nat::Pairwise::{
    initialize_Init_Data_List_Nat_Pairwise, runtime_initialize_Init_Data_List_Nat_Pairwise,
};
use crate::r#gen::Init::Data::List::Nat::Perm::{
    initialize_Init_Data_List_Nat_Perm, runtime_initialize_Init_Data_List_Nat_Perm,
};
use crate::r#gen::Init::Data::List::Nat::Prod::{
    initialize_Init_Data_List_Nat_Prod, runtime_initialize_Init_Data_List_Nat_Prod,
};
use crate::r#gen::Init::Data::List::Nat::Range::{
    initialize_Init_Data_List_Nat_Range, runtime_initialize_Init_Data_List_Nat_Range,
};
use crate::r#gen::Init::Data::List::Nat::Sublist::{
    initialize_Init_Data_List_Nat_Sublist, runtime_initialize_Init_Data_List_Nat_Sublist,
};
...
pub unsafe fn runtime_initialize_Init_Data_List_Nat(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List_Nat(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Nat(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
