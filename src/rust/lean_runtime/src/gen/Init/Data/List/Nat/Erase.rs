...
// Imports: Init.GetElem Init.Data.List.Erase Init.Data.List.Nat.TakeDrop Init.Data.List.TakeDrop Init.Omega
...
pub unsafe fn runtime_initialize_Init_Data_List_Nat_Erase(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_List_Nat_Erase(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_List_Nat_Erase(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
