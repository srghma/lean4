...
// Imports: Init.Data.Range.Polymorphic.Nat Init.Data.List.BasicAux Init.Data.Range.Polymorphic.Iterators Init.ByCases Init.Data.Array.Bootstrap Init.Data.Array.Lemmas Init.Data.List.Range Init.Data.Nat.Simproc Init.Data.Option.Lemmas Init.Data.Range.Polymorphic.Lemmas Init.Omega
...
pub unsafe fn runtime_initialize_Init_Data_Range_Polymorphic_NatLemmas(
    builtin: u8,
) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Range_Polymorphic_NatLemmas(
    builtin: u8,
) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Range_Polymorphic_NatLemmas(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
