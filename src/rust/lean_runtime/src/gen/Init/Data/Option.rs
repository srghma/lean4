...
// Imports: Init.Data.Option.Basic Init.Data.Option.BasicAux Init.Data.Option.Coe Init.Data.Option.Instances Init.Data.Option.Lemmas Init.Data.Option.Attach Init.Data.Option.List Init.Data.Option.Monadic Init.Data.Option.Array Init.Data.Option.Function
...
use crate::r#gen::Init::Data::Option::Function::{
    initialize_Init_Data_Option_Function, runtime_initialize_Init_Data_Option_Function,
};
...
use crate::r#gen::Init::Data::Option::Monadic::{
    initialize_Init_Data_Option_Monadic, runtime_initialize_Init_Data_Option_Monadic,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Option(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Option(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Option(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
