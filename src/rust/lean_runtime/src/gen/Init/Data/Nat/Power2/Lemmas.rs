...
pub unsafe fn l_Nat_instDecidableIsPowerOfTwo(mut v_n_12_: *mut LeanObject) -> u8 {
    ...
    if v___x_14_ == 0 {
        ...
        v___x_15_ = lean_unsigned_to_nat(1);
...
pub unsafe fn runtime_initialize_Init_Data_Nat_Power2_Lemmas(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Nat_Power2_Lemmas(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Nat_Power2_Lemmas(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
