...
static mut l_Int_Nonneg_num__cert___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Int_Nonneg_num__cert___closed__0: *mut LeanObject = core::ptr::null_mut();
pub unsafe fn _init_l_Int_Nonneg_num__cert___closed__0() -> *mut LeanObject {
    let mut v___x_9_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_10_: *mut LeanObject = core::ptr::null_mut();
    v___x_9_ = lean_unsigned_to_nat(0);
    v___x_10_ = lean_nat_to_int(v___x_9_);
    return v___x_10_;
}
pub unsafe fn l_Int_Nonneg_num__cert(mut v_a_11_: *mut LeanObject) -> u8 {
    let mut v___x_12_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_13_: u8 = 0;
    v___x_12_ = lean_obj_once(
...
pub unsafe fn l_Int_Nonneg_num__cert___boxed(mut v_a_14_: *mut LeanObject) -> *mut LeanObject {
    let mut v_res_15_: u8 = 0;
    let mut v_r_16_: *mut LeanObject = core::ptr::null_mut();
    v_res_15_ = l_Int_Nonneg_num__cert(v_a_14_);
    lean_dec(v_a_14_);
    v_r_16_ = lean_box((v_res_15_) as usize);
    return v_r_16_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Int_OfNat(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Int_OfNat(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_OfNat(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
