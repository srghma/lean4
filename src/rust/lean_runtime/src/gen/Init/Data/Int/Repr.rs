...
static mut l_Int_repr___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Int_repr___closed__0: *mut LeanObject = core::ptr::null_mut();
pub static l_Int_repr___closed__1_value: LeanStringObject<2> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Int_repr___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Int_repr___closed__1_value) as *mut LeanObject;
pub static l_Int_instRepr___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Int_instRepr___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Int_instRepr___closed__0_value) as *mut LeanObject;
pub static mut l_Int_instRepr: *mut LeanObject =
    core::ptr::addr_of!(l_Int_instRepr___closed__0_value) as *mut LeanObject;
pub unsafe fn _init_l_Int_repr___closed__0() -> *mut LeanObject {
    let mut v_natZero_32_: *mut LeanObject = core::ptr::null_mut();
    let mut v_intZero_33_: *mut LeanObject = core::ptr::null_mut();
    v_natZero_32_ = lean_unsigned_to_nat(0);
    v_intZero_33_ = lean_nat_to_int(v_natZero_32_);
    return v_intZero_33_;
}
pub unsafe fn l_Int_repr(mut v_x_35_: *mut LeanObject) -> *mut LeanObject {
    let mut v_intZero_36_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isNeg_37_: u8 = 0;
    v_intZero_36_ = lean_obj_once(
    ...
    if v_isNeg_37_ == 0 {
        ...
        let mut v_abs_40_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Int_repr___boxed(mut v_x_47_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Int_instRepr___lam__0(
    ...
    if v___x_52_ == 0 {
        ...
        v___x_54_ = lean_alloc_ctor(3, 1, (0) as u32);
        ...
        v___x_56_ = lean_alloc_ctor(3, 1, (0) as u32);
...
pub unsafe fn l_Int_instRepr___lam__0___boxed(
    mut v_i_58_: *mut LeanObject,
    mut v_prec_59_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Init_Data_Int_Repr(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Int_Repr(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_Repr(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
