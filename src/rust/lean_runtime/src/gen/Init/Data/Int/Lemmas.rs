...
pub unsafe fn runtime_initialize_Init_Data_Int_Lemmas(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_Int_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Int_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
