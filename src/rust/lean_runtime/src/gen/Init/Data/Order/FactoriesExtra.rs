...
pub unsafe fn l_DecidableLE_ofOrd___redArg(
    ...
    mut v_b_102_: *mut LeanObject,
) -> u8 {
    let mut v___x_103_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_104_: u8 = 0;
    v___x_103_ = lean_apply_2(v_inst_100_, v_a_101_, v_b_102_);
    v___x_104_ = (lean_unbox(v___x_103_) as u8);
    if v___x_104_ == 2 {
...
pub unsafe fn l_DecidableLE_ofOrd(
    ...
    mut v_a_116_: *mut LeanObject,
    mut v_b_117_: *mut LeanObject,
) -> u8 {
    let mut v___x_118_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_119_: u8 = 0;
    v___x_118_ = lean_apply_2(v_inst_114_, v_a_116_, v_b_117_);
    v___x_119_ = (lean_unbox(v___x_118_) as u8);
    if v___x_119_ == 2 {
...
pub unsafe fn l_DecidableLT_ofOrd___redArg(
    ...
    v___x_139_ = lean_apply_2(v_inst_136_, v_a_137_, v_b_138_);
    v___x_140_ = 0;
    v___x_141_ = (lean_unbox(v___x_139_) as u8);
...
pub unsafe fn l_DecidableLT_ofOrd___redArg___boxed(
    ...
    v_r_147_ = lean_box((v_res_146_) as usize);
    return v_r_147_;
}
pub unsafe fn l_DecidableLT_ofOrd(
    ...
    v___x_156_ = lean_apply_2(v_inst_151_, v_a_154_, v_b_155_);
    v___x_157_ = 0;
    v___x_158_ = (lean_unbox(v___x_156_) as u8);
...
pub unsafe fn l_BEq_ofOrd___redArg___lam__0(
    ...
    v___x_173_ = lean_apply_2(v_inst_170_, v_a_171_, v_b_172_);
    v___x_174_ = 1;
    v___x_175_ = (lean_unbox(v___x_173_) as u8);
...
pub unsafe fn l_BEq_ofOrd___redArg(mut v_inst_182_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_BEq_ofOrd(
    mut v_00_u03b1_184_: *mut LeanObject,
    mut v_inst_185_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___f_186_: *mut LeanObject = core::ptr::null_mut();
    v___f_186_ = lean_alloc_closure(
        l_BEq_ofOrd___redArg___lam__0___boxed as *mut core::ffi::c_void,
        3,
        1,
    );
...
pub unsafe fn runtime_initialize_Init_Data_Order_FactoriesExtra(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Order_FactoriesExtra(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Order_FactoriesExtra(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
