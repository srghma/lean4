...
pub unsafe fn l___private_Init_Data_Option_Monadic_0__Option_instDecidableEq_match__1_splitter___redArg(
    ...
    if lean_obj_tag(v_b_33_) == 0 {
        ...
        lean_dec(v_h__1_34_);
        v_val_38_ = lean_ctor_get(v_b_33_, 0);
        lean_inc(v_val_38_);
...
pub unsafe fn l___private_Init_Data_Option_Monadic_0__Option_instDecidableEq_match__1_splitter(
    ...
    if lean_obj_tag(v_b_42_) == 0 {
        ...
        lean_dec(v_h__1_43_);
        v_val_47_ = lean_ctor_get(v_b_42_, 0);
        lean_inc(v_val_47_);
        lean_dec_ref_known(v_b_42_, 1);
        v___x_48_ = lean_apply_1(v_h__2_44_, v_val_47_);
        return v___x_48_;
    }
}
pub unsafe fn l___private_Init_Data_Option_Monadic_0__Option_instForIn_x27InferInstanceMembershipOfMonad_match__1_splitter___redArg(
    ...
    if lean_obj_tag(v_____do__lift_49_) == 0 {
        ...
        lean_dec(v_h__1_50_);
        v_a_54_ = lean_ctor_get(v_____do__lift_49_, 0);
        lean_inc(v_a_54_);
        lean_dec_ref_known(v_____do__lift_49_, 1);
...
pub unsafe fn l___private_Init_Data_Option_Monadic_0__Option_instForIn_x27InferInstanceMembershipOfMonad_match__1_splitter(
    ...
    mut v_____do__lift_58_: *mut LeanObject,
...
pub unsafe fn runtime_initialize_Init_Data_Option_Monadic(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Option_Monadic(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Option_Monadic(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
