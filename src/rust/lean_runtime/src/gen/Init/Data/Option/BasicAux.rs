...
pub static l_Option_get_x21___redArg___closed__0_value: LeanStringObject<26> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Option_get_x21___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Option_get_x21___redArg___closed__0_value) as *mut LeanObject;
pub static l_Option_get_x21___redArg___closed__1_value: LeanStringObject<12> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Option_get_x21___redArg___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Option_get_x21___redArg___closed__1_value) as *mut LeanObject;
pub static l_Option_get_x21___redArg___closed__2_value: LeanStringObject<14> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Option_get_x21___redArg___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Option_get_x21___redArg___closed__2_value) as *mut LeanObject;
static mut l_Option_get_x21___redArg___closed__3_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Option_get_x21___redArg___closed__3: *mut LeanObject = core::ptr::null_mut();
pub unsafe fn _init_l_Option_get_x21___redArg___closed__3() -> *mut LeanObject {
    ...
    v___x_32_ = lean_unsigned_to_nat(14);
    v___x_33_ = lean_unsigned_to_nat(22);
...
pub unsafe fn runtime_initialize_Init_Data_Option_BasicAux(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Option_BasicAux(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Option_BasicAux(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
