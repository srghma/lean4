...
// Imports: Init.Data.Fin.Basic Init.Data.Nat.Bitwise.Lemmas Init.Data.Nat.Div.Basic
...
pub unsafe fn runtime_initialize_Init_Data_Fin_Bitwise(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Fin_Bitwise(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Fin_Bitwise(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
