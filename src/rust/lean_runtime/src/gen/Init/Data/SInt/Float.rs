...
use crate::leanh::{
    ...
    LeanTaskObject, LeanThunkObject, lean_box, lean_box_float, lean_box_uint32, lean_box_uint64,
    lean_box_usize, lean_dec, lean_dec_ref, lean_io_result_is_error, lean_io_result_mk_ok,
    lean_unbox, lean_unbox_float, lean_unbox_uint32, lean_unbox_uint64, lean_unbox_usize,
};
pub unsafe fn l_Float_toInt8___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_53_ =
        lean_unbox_float(v_a_00___x40___internal___hyg_52_);
...
pub unsafe fn l_Float_toInt16___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_58_ =
        lean_unbox_float(v_a_00___x40___internal___hyg_57_);
...
pub unsafe fn l_Float_toInt32___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_63_ =
        lean_unbox_float(v_a_00___x40___internal___hyg_62_);
...
pub unsafe fn l_Float_toInt64___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_68_ =
        lean_unbox_float(v_a_00___x40___internal___hyg_67_);
...
pub unsafe fn l_Float_toISize___boxed(
    ...
    v_a_00___x40___internal___hyg_1__boxed_73_ =
        lean_unbox_float(v_a_00___x40___internal___hyg_72_);
...
pub unsafe fn l_Int8_toFloat___boxed(mut v_n_77_: *mut LeanObject) -> *mut LeanObject {
    ...
    v_r_80_ = lean_box_float(v_res_79_);
    return v_r_80_;
}
pub unsafe fn l_Int16_toFloat___boxed(mut v_n_82_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Int32_toFloat___boxed(mut v_n_87_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Int64_toFloat___boxed(mut v_n_92_: *mut LeanObject) -> *mut LeanObject {
    ...
    v_r_95_ = lean_box_float(v_res_94_);
    return v_r_95_;
}
pub unsafe fn l_ISize_toFloat___boxed(mut v_n_97_: *mut LeanObject) -> *mut LeanObject {
    ...
    v_r_100_ = lean_box_float(v_res_99_);
    return v_r_100_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_SInt_Float(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_SInt_Float(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_SInt_Float(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
