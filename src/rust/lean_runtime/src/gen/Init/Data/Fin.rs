...
// Imports: Init.Data.Fin.Basic Init.Data.Fin.Log2 Init.Data.Fin.Iterate Init.Data.Fin.Fold Init.Data.Fin.Lemmas Init.Data.Fin.OverflowAware
...
use crate::r#gen::Init::Data::Fin::Fold::{
    initialize_Init_Data_Fin_Fold, runtime_initialize_Init_Data_Fin_Fold,
};
use crate::r#gen::Init::Data::Fin::Iterate::{
    initialize_Init_Data_Fin_Iterate, runtime_initialize_Init_Data_Fin_Iterate,
};
...
pub unsafe fn runtime_initialize_Init_Data_Fin(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Fin(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Fin(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
    ...
    crate::leanh::lean_dec_ref(res);
    res = meta_initialize_Init_Data_Fin(builtin);
    if crate::leanh::lean_io_result_is_error(res) {
        return res;
    }
    crate::leanh::lean_dec_ref(res);
    return initialize_Init_Data_Fin(builtin);
}
