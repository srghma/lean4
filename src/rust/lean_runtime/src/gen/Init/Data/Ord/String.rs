...
pub static l_String_instOrd___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_String_instOrd___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_String_instOrd___closed__0_value) as *mut LeanObject;
pub static mut l_String_instOrd: *mut LeanObject =
    core::ptr::addr_of!(l_String_instOrd___closed__0_value) as *mut LeanObject;
pub unsafe fn l_String_compare___boxed(
    mut v_s_u2081_11_: *mut LeanObject,
    mut v_s_u2082_12_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_res_13_: u8 = 0;
    let mut v_r_14_: *mut LeanObject = core::ptr::null_mut();
    v_res_13_ = lean_string_compare(v_s_u2081_11_, v_s_u2082_12_);
    lean_dec_ref(v_s_u2082_12_);
    lean_dec_ref(v_s_u2081_11_);
    v_r_14_ = lean_box((v_res_13_) as usize);
    return v_r_14_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Ord_String(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Ord_String(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Ord_String(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
