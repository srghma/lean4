...
// Imports: Init.Data.Iterators.Basic Init.Data.Iterators.PostconditionMonad Init.Data.Iterators.Consumers Init.Data.Iterators.Producers Init.Data.Iterators.Combinators Init.Data.Iterators.Lemmas Init.Data.Iterators.ToIterator Init.Data.Iterators.Internal
...
use crate::r#gen::Init::Data::Iterators::Combinators::{
    initialize_Init_Data_Iterators_Combinators, runtime_initialize_Init_Data_Iterators_Combinators,
};
...
use crate::r#gen::Init::Data::Iterators::Producers::{
    initialize_Init_Data_Iterators_Producers, runtime_initialize_Init_Data_Iterators_Producers,
};
...
pub unsafe fn runtime_initialize_Init_Data_Iterators(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Iterators(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Iterators(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
