...
// Imports: Init.Data.Iterators.Consumers.Monadic Init.Data.Iterators.Consumers.Access Init.Data.Iterators.Consumers.Collect Init.Data.Iterators.Consumers.Loop Init.Data.Iterators.Consumers.Partial Init.Data.Iterators.Consumers.Total Init.Data.Iterators.Consumers.Stream
...
use crate::r#gen::Init::Data::Iterators::Consumers::Stream::{
    initialize_Init_Data_Iterators_Consumers_Stream,
    runtime_initialize_Init_Data_Iterators_Consumers_Stream,
};
...
pub unsafe fn runtime_initialize_Init_Data_Iterators_Consumers(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_Iterators_Consumers(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Iterators_Consumers(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
