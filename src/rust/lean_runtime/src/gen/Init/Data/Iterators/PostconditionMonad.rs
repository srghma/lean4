...
pub static l_Std_Iterators_PostconditionT_lift___redArg___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_Std_Iterators_PostconditionT_lift___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Iterators_PostconditionT_lift___redArg___closed__0_value)
        as *mut LeanObject;
pub static l_Std_Iterators_PostconditionT_bind___redArg___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Std_Iterators_PostconditionT_bind___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Std_Iterators_PostconditionT_bind___redArg___closed__0_value)
        as *mut LeanObject;
pub static l_Std_Iterators_PostconditionT_run___redArg___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
        ...
        m_fun: l_Std_Iterators_PostconditionT_run___redArg___lam__0___boxed
            as *const core::ffi::c_void,
        m_arity: 1,
        m_num_fixed: 0,
        m_objs: [],
    };
static mut l_Std_Iterators_PostconditionT_run___redArg___closed__0: *mut LeanObject =
...
pub unsafe fn l_Std_Iterators_PostconditionT_lift___redArg(
    ...
    v_map_298_ = lean_ctor_get(v_inst_296_, 0);
    lean_inc(v_map_298_);
    lean_dec_ref(v_inst_296_);
    v___f_299_ = l_Std_Iterators_PostconditionT_lift___redArg___closed__0;
    v___x_300_ = lean_apply_4(v_map_298_, lean_box(0), lean_box(0), v___f_299_, v_x_297_);
    return v___x_300_;
}
...
pub unsafe fn l_Std_Iterators_PostconditionT_attachLift___redArg(
    ...
    v___x_310_ = lean_apply_2(v_inst_308_, lean_box(0), v_x_309_);
    return v___x_310_;
}
pub unsafe fn l_Std_Iterators_PostconditionT_attachLift(
    ...
    v___x_315_ = lean_apply_2(v_inst_313_, lean_box(0), v_x_314_);
    return v___x_315_;
}
pub unsafe fn l_Std_Iterators_PostconditionT_pure___redArg(
    ...
    v___x_318_ = lean_apply_2(v_inst_316_, lean_box(0), v_a_317_);
    return v___x_318_;
}
pub unsafe fn l_Std_Iterators_PostconditionT_pure(
    ...
    v___x_323_ = lean_apply_2(v_inst_320_, lean_box(0), v_a_322_);
    return v___x_323_;
}
...
pub unsafe fn l_Std_Iterators_PostconditionT_map___redArg(
    ...
    v___x_344_ = lean_apply_4(v_map_342_, lean_box(0), lean_box(0), v___f_343_, v_x_341_);
    return v___x_344_;
}
pub unsafe fn l_Std_Iterators_PostconditionT_map(
    ...
    lean_closure_set(v___f_352_, 0, v_f_349_);
    v___x_353_ = lean_apply_4(v_map_351_, lean_box(0), lean_box(0), v___f_352_, v_x_350_);
    return v___x_353_;
}
...
pub unsafe fn l_Std_Iterators_PostconditionT_bind___redArg___lam__1(
    mut v_toFunctor_357_: *mut LeanObject,
    mut v_f_358_: *mut LeanObject,
    mut v___f_359_: *mut LeanObject,
    ...
    v_map_361_ = lean_ctor_get(v_toFunctor_357_, 0);
    lean_inc(v_map_361_);
    lean_dec_ref(v_toFunctor_357_);
    v___x_362_ = lean_apply_1(v_f_358_, v_a_360_);
    v___x_363_ = lean_apply_4(v_map_361_, lean_box(0), lean_box(0), v___f_359_, v___x_362_);
    return v___x_363_;
}
pub unsafe fn l_Std_Iterators_PostconditionT_bind___redArg(
    ...
    let mut v_toFunctor_370_: *mut LeanObject = core::ptr::null_mut();
    ...
    lean_closure_set(v___f_372_, 0, v_toFunctor_370_);
    lean_closure_set(v___f_372_, 1, v_f_367_);
    lean_closure_set(v___f_372_, 2, v___f_371_);
    v___x_373_ = lean_apply_4(
        v_toBind_369_,
        lean_box(0),
        lean_box(0),
        v_x_366_,
...
pub unsafe fn l_Std_Iterators_PostconditionT_bind(
    ...
    let mut v_toApplicative_380_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toBind_381_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_382_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toApplicative_380_ = lean_ctor_get(v_inst_375_, 0);
    lean_inc_ref(v_toApplicative_380_);
    v_toBind_381_ = lean_ctor_get(v_inst_375_, 1);
    lean_inc(v_toBind_381_);
    lean_dec_ref(v_inst_375_);
    v_toFunctor_382_ = lean_ctor_get(v_toApplicative_380_, 0);
    ...
    lean_closure_set(v___f_384_, 0, v_toFunctor_382_);
    lean_closure_set(v___f_384_, 1, v_f_379_);
...
pub unsafe fn l_Std_Iterators_PostconditionT_pbind___redArg(
    ...
    let mut v_toFunctor_391_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toFunctor_391_ = lean_ctor_get(v_toApplicative_389_, 0);
    ...
    lean_closure_set(v___f_393_, 1, v_f_388_);
...
pub unsafe fn l_Std_Iterators_PostconditionT_pbind(
    ...
    let mut v_toApplicative_401_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toBind_402_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_403_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toFunctor_403_ = lean_ctor_get(v_toApplicative_401_, 0);
    ...
    v___f_405_ = lean_alloc_closure(
        l_Std_Iterators_PostconditionT_bind___redArg___lam__1 as *mut core::ffi::c_void,
        4,
        3,
    );
    lean_closure_set(v___f_405_, 0, v_toFunctor_403_);
    lean_closure_set(v___f_405_, 1, v_f_400_);
    lean_closure_set(v___f_405_, 2, v___f_404_);
    v___x_406_ = lean_apply_4(
        v_toBind_402_,
        lean_box(0),
        lean_box(0),
        v_x_399_,
...
pub unsafe fn l_Std_Iterators_PostconditionT_liftMap___redArg(
    ...
    let mut v_toApplicative_410_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_411_: *mut LeanObject = core::ptr::null_mut();
    let mut v_map_412_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_map_412_ = lean_ctor_get(v_toFunctor_411_, 0);
    lean_inc(v_map_412_);
    ...
    lean_closure_set(v___f_413_, 0, v_f_408_);
    v___x_414_ = lean_apply_4(v_map_412_, lean_box(0), lean_box(0), v___f_413_, v_x_409_);
    return v___x_414_;
}
pub unsafe fn l_Std_Iterators_PostconditionT_liftMap(
    ...
    let mut v_toApplicative_421_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_422_: *mut LeanObject = core::ptr::null_mut();
    let mut v_map_423_: *mut LeanObject = core::ptr::null_mut();
    let mut v___f_424_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_425_: *mut LeanObject = core::ptr::null_mut();
    v_toApplicative_421_ = lean_ctor_get(v_inst_416_, 0);
    ...
    lean_closure_set(v___f_424_, 0, v_f_419_);
    v___x_425_ = lean_apply_4(v_map_423_, lean_box(0), lean_box(0), v___f_424_, v_x_420_);
    return v___x_425_;
}
...
pub unsafe fn l_Std_Iterators_PostconditionT_run___redArg(
    ...
    let mut v_toApplicative_432_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_433_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toApplicative_432_ = lean_ctor_get(v_inst_430_, 0);
    ...
    v_map_434_ = lean_ctor_get(v_toFunctor_433_, 0);
    lean_inc(v_map_434_);
    lean_dec_ref(v_toFunctor_433_);
    v___f_435_ = l_Std_Iterators_PostconditionT_run___redArg___closed__0;
    v___x_436_ = lean_apply_4(v_map_434_, lean_box(0), lean_box(0), v___f_435_, v_x_431_);
    return v___x_436_;
}
pub unsafe fn l_Std_Iterators_PostconditionT_run(
    mut v_m_437_: *mut LeanObject,
    mut v_inst_438_: *mut LeanObject,
    mut v_00_u03b1_439_: *mut LeanObject,
    mut v_x_440_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_toApplicative_441_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_442_: *mut LeanObject = core::ptr::null_mut();
    let mut v_map_443_: *mut LeanObject = core::ptr::null_mut();
    ...
    v___x_445_ = lean_apply_4(v_map_443_, lean_box(0), lean_box(0), v___f_444_, v_x_440_);
    return v___x_445_;
}
...
pub unsafe fn l_Std_Iterators_instFunctorPostconditionT___redArg___lam__1(
    ...
    mut v_00_u03b2_453_: *mut LeanObject,
    ...
    v_map_456_ = lean_ctor_get(v_inst_451_, 0);
    lean_inc(v_map_456_);
    ...
    lean_closure_set(v___f_457_, 0, v___y_454_);
    v___x_458_ = lean_apply_4(v_map_456_, lean_box(0), lean_box(0), v___f_457_, v___y_455_);
    return v___x_458_;
}
pub unsafe fn l_Std_Iterators_instFunctorPostconditionT___redArg(
    mut v_inst_459_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___f_460_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__4(
    mut v_toFunctor_466_: *mut LeanObject,
    mut v_y_467_: *mut LeanObject,
    mut v___f_468_: *mut LeanObject,
    mut v_a_469_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_map_470_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_map_470_ = lean_ctor_get(v_toFunctor_466_, 0);
    lean_inc(v_map_470_);
    lean_dec_ref(v_toFunctor_466_);
    v___x_471_ = lean_box(0);
    v___x_472_ = lean_apply_1(v_y_467_, v___x_471_);
    v___x_473_ = lean_apply_4(v_map_470_, lean_box(0), lean_box(0), v___f_468_, v___x_472_);
    return v___x_473_;
}
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__4___boxed(
    mut v_toFunctor_474_: *mut LeanObject,
    mut v_y_475_: *mut LeanObject,
    mut v___f_476_: *mut LeanObject,
...
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__0(
    mut v_toFunctor_479_: *mut LeanObject,
    mut v___f_480_: *mut LeanObject,
    ...
    lean_closure_set(v___f_486_, 0, v_toFunctor_479_);
    lean_closure_set(v___f_486_, 1, v_y_485_);
    lean_closure_set(v___f_486_, 2, v___f_480_);
    v___x_487_ = lean_apply_4(
        v_toBind_481_,
        lean_box(0),
        lean_box(0),
        v_x_484_,
...
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__1(
    ...
    mut v_map_490_: *mut LeanObject,
    mut v___f_491_: *mut LeanObject,
    ...
    v___x_493_ = lean_apply_2(v_toPure_488_, lean_box(0), v_a_489_);
    v___x_494_ = lean_apply_4(v_map_490_, lean_box(0), lean_box(0), v___f_491_, v___x_493_);
    return v___x_494_;
}
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__1___boxed(
    ...
    mut v_map_497_: *mut LeanObject,
    mut v___f_498_: *mut LeanObject,
...
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__2(
    mut v_toFunctor_501_: *mut LeanObject,
    mut v_toPure_502_: *mut LeanObject,
    mut v___f_503_: *mut LeanObject,
    mut v_y_504_: *mut LeanObject,
    mut v_toBind_505_: *mut LeanObject,
    mut v___f_506_: *mut LeanObject,
    mut v_a_507_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_map_508_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_map_508_ = lean_ctor_get(v_toFunctor_501_, 0);
    lean_inc_n(v_map_508_, 2);
    ...
    lean_closure_set(v___f_509_, 0, v_toPure_502_);
    lean_closure_set(v___f_509_, 1, v_a_507_);
    lean_closure_set(v___f_509_, 2, v_map_508_);
    lean_closure_set(v___f_509_, 3, v___f_503_);
    v___x_510_ = lean_box(0);
    v___x_511_ = lean_apply_1(v_y_504_, v___x_510_);
    ...
    v___x_513_ = lean_apply_4(v_map_508_, lean_box(0), lean_box(0), v___f_506_, v___x_512_);
    return v___x_513_;
}
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__3(
    mut v_toFunctor_514_: *mut LeanObject,
    mut v_toPure_515_: *mut LeanObject,
    mut v___f_516_: *mut LeanObject,
    mut v_toBind_517_: *mut LeanObject,
    mut v___f_518_: *mut LeanObject,
    mut v_00_u03b1_519_: *mut LeanObject,
    mut v_00_u03b2_520_: *mut LeanObject,
    mut v_x_521_: *mut LeanObject,
    mut v_y_522_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_closure_set(v___f_523_, 1, v_toPure_515_);
    lean_closure_set(v___f_523_, 2, v___f_516_);
    lean_closure_set(v___f_523_, 3, v_y_522_);
    lean_closure_set(v___f_523_, 4, v_toBind_517_);
    lean_closure_set(v___f_523_, 5, v___f_518_);
    v___x_524_ = lean_apply_4(
        v_toBind_517_,
        lean_box(0),
        lean_box(0),
        v_x_521_,
...
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__6(
    ...
    v_map_532_ = lean_ctor_get(v_toFunctor_528_, 0);
    lean_inc_n(v_map_532_, 2);
    lean_dec_ref(v_toFunctor_528_);
    v___f_533_ = lean_alloc_closure(
        l_Std_Iterators_instMonadPostconditionT___redArg___lam__5 as *mut core::ffi::c_void,
        2,
        1,
    );
    lean_closure_set(v___f_533_, 0, v_a_531_);
    v___x_534_ = lean_box(0);
    v___x_535_ = lean_apply_1(v_x_529_, v___x_534_);
    v___x_536_ = lean_apply_4(v_map_532_, lean_box(0), lean_box(0), v___f_533_, v___x_535_);
    v___x_537_ = lean_apply_4(v_map_532_, lean_box(0), lean_box(0), v___f_530_, v___x_536_);
    return v___x_537_;
}
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg___lam__7(
    mut v_toFunctor_538_: *mut LeanObject,
    mut v___f_539_: *mut LeanObject,
    mut v_toBind_540_: *mut LeanObject,
    ...
    lean_closure_set(v___f_545_, 0, v_toFunctor_538_);
    lean_closure_set(v___f_545_, 1, v_x_544_);
    lean_closure_set(v___f_545_, 2, v___f_539_);
...
pub unsafe fn l_Std_Iterators_instMonadPostconditionT___redArg(
    ...
    let mut v_toApplicative_548_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toBind_549_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_550_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toPure_551_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_569_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_toApplicative_548_ = lean_ctor_get(v_inst_547_, 0);
                lean_inc_ref(v_toApplicative_548_);
                v_toBind_549_ = lean_ctor_get(v_inst_547_, 1);
                v_toFunctor_550_ = lean_ctor_get(v_toApplicative_548_, 0);
                v_toPure_551_ = lean_ctor_get(v_toApplicative_548_, 1);
                v_isSharedCheck_566_ = (!lean_is_exclusive(v_toApplicative_548_)) as u8;
                if v_isSharedCheck_566_ == 0 {
                    v_unused_567_ = lean_ctor_get(v_toApplicative_548_, 4);
                    lean_dec(v_unused_567_);
                    v_unused_568_ = lean_ctor_get(v_toApplicative_548_, 3);
                    lean_dec(v_unused_568_);
                    v_unused_569_ = lean_ctor_get(v_toApplicative_548_, 2);
            ...
            1 => {
                ...
                lean_inc_n(v_toBind_549_, 3);
                lean_inc_ref_n(v_toFunctor_550_, 3);
                ...
                lean_closure_set(v___f_556_, 0, v_toFunctor_550_);
                lean_closure_set(v___f_556_, 1, v___f_555_);
                lean_closure_set(v___f_556_, 2, v_toBind_549_);
                lean_inc(v_toPure_551_);
                v___f_557_ = lean_alloc_closure(
                    l_Std_Iterators_instMonadPostconditionT___redArg___lam__3
                        as *mut core::ffi::c_void,
                    9,
                    5,
                );
                lean_closure_set(v___f_557_, 0, v_toFunctor_550_);
                lean_closure_set(v___f_557_, 1, v_toPure_551_);
                lean_closure_set(v___f_557_, 2, v___f_555_);
                lean_closure_set(v___f_557_, 3, v_toBind_549_);
                ...
                lean_closure_set(v___f_558_, 0, v_toFunctor_550_);
                lean_closure_set(v___f_558_, 1, v___f_555_);
                lean_closure_set(v___f_558_, 2, v_toBind_549_);
                v___x_559_ = l_Std_Iterators_instFunctorPostconditionT___redArg(v_toFunctor_550_);
                v___x_560_ = lean_alloc_closure(
                    l_Std_Iterators_PostconditionT_pure as *mut core::ffi::c_void,
                    4,
                    2,
                );
                lean_closure_set(v___x_560_, 0, lean_box(0));
                lean_closure_set(v___x_560_, 1, v_toPure_551_);
                if v_isShared_554_ == 0 {
                    lean_ctor_set(v___x_553_, 4, v___f_556_);
                    lean_ctor_set(v___x_553_, 3, v___f_557_);
                    lean_ctor_set(v___x_553_, 2, v___f_558_);
                    ...
                    lean_ctor_set(v_reuseFailAlloc_565_, 1, v___x_560_);
                    lean_ctor_set(v_reuseFailAlloc_565_, 2, v___f_558_);
                    lean_ctor_set(v_reuseFailAlloc_565_, 3, v___f_557_);
                    lean_ctor_set(v_reuseFailAlloc_565_, 4, v___f_556_);
...
pub unsafe fn l_Std_Iterators_instMonadLiftPostconditionT___redArg___lam__0(
    ...
    v___x_576_ = lean_apply_2(v_inst_573_, lean_box(0), v_x_575_);
    return v___x_576_;
}
...
pub unsafe fn initialize_Init_Data_Iterators_PostconditionMonad(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
