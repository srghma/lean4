...
pub unsafe fn l_String_utf8EncodeCharFast(mut v_c_1180_: u32) -> *mut LeanObject {
    ...
    if v___x_1182_ == 0 {
        ...
        if v___x_1184_ == 0 {
            ...
            if v___x_1186_ == 0 {
                ...
                v___x_1210_ = lean_box((v___x_1208_) as usize);
                v___x_1211_ = lean_alloc_ctor(1, 2, (0) as u32);
                lean_ctor_set(v___x_1211_, 0, v___x_1210_);
                lean_ctor_set(v___x_1211_, 1, v___x_1209_);
                v___x_1212_ = lean_box((v___x_1205_) as usize);
                v___x_1213_ = lean_alloc_ctor(1, 2, (0) as u32);
                lean_ctor_set(v___x_1213_, 0, v___x_1212_);
                lean_ctor_set(v___x_1213_, 1, v___x_1211_);
                v___x_1214_ = lean_box((v___x_1200_) as usize);
                v___x_1215_ = lean_alloc_ctor(1, 2, (0) as u32);
                lean_ctor_set(v___x_1215_, 0, v___x_1214_);
                lean_ctor_set(v___x_1215_, 1, v___x_1213_);
                v___x_1216_ = lean_box((v___x_1193_) as usize);
                ...
                v___x_1236_ = lean_box((v___x_1234_) as usize);
                v___x_1237_ = lean_alloc_ctor(1, 2, (0) as u32);
                lean_ctor_set(v___x_1237_, 0, v___x_1236_);
                lean_ctor_set(v___x_1237_, 1, v___x_1235_);
                v___x_1238_ = lean_box((v___x_1231_) as usize);
                v___x_1239_ = lean_alloc_ctor(1, 2, (0) as u32);
                lean_ctor_set(v___x_1239_, 0, v___x_1238_);
                lean_ctor_set(v___x_1239_, 1, v___x_1237_);
                v___x_1240_ = lean_box((v___x_1224_) as usize);
        ...
        v___x_1261_ = lean_box((v___x_1259_) as usize);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_ctorIdx(
    ...
    match v_x_1266_ {
        ...
        1 => {
            ...
            v___x_1268_ = lean_unsigned_to_nat(1);
            return v___x_1268_;
        }
        2 => {
        ...
        3 => {
            ...
            v___x_1270_ = lean_unsigned_to_nat(3);
            return v___x_1270_;
        }
        _ => {
            let mut v___x_1271_: *mut LeanObject = core::ptr::null_mut();
            v___x_1271_ = lean_unsigned_to_nat(4);
            return v___x_1271_;
        }
    }
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_ctorIdx___boxed(
    ...
    v_x_boxed_1273_ = (lean_unbox(v_x_1272_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_toCtorIdx___boxed(
    ...
    v_x_4__boxed_1278_ = (lean_unbox(v_x_1277_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_ctorElim___boxed(
    mut v_motive_1288_: *mut LeanObject,
    mut v_ctorIdx_1289_: *mut LeanObject,
    mut v_t_1290_: *mut LeanObject,
    mut v_h_1291_: *mut LeanObject,
    mut v_k_1292_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_t_boxed_1293_: u8 = 0;
    let mut v_res_1294_: *mut LeanObject = core::ptr::null_mut();
    v_t_boxed_1293_ = (lean_unbox(v_t_1290_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_invalid_elim(
    ...
    mut v_invalid_1301_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_invalid_1301_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_done_elim(
    ...
    mut v_done_1314_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_done_1314_);
    return v_done_1314_;
}
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_oneMore_elim___redArg___boxed(
    ...
    lean_dec(v_oneMore_1322_);
    return v_res_1323_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_oneMore_elim(
    mut v_motive_1324_: *mut LeanObject,
    mut v_t_1325_: u8,
    mut v_h_1326_: *mut LeanObject,
    mut v_oneMore_1327_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_oneMore_1327_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_oneMore_elim___boxed(
    ...
    mut v_t_1329_: *mut LeanObject,
    mut v_h_1330_: *mut LeanObject,
    mut v_oneMore_1331_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_t_boxed_1332_: u8 = 0;
    let mut v_res_1333_: *mut LeanObject = core::ptr::null_mut();
    v_t_boxed_1332_ = (lean_unbox(v_t_1329_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_twoMore_elim___redArg___boxed(
    ...
    lean_dec(v_twoMore_1335_);
    return v_res_1336_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_twoMore_elim(
    mut v_motive_1337_: *mut LeanObject,
    mut v_t_1338_: u8,
    mut v_h_1339_: *mut LeanObject,
    mut v_twoMore_1340_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_twoMore_1340_);
    return v_twoMore_1340_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_twoMore_elim___boxed(
    mut v_motive_1341_: *mut LeanObject,
    mut v_t_1342_: *mut LeanObject,
    mut v_h_1343_: *mut LeanObject,
    mut v_twoMore_1344_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_t_boxed_1345_: u8 = 0;
    let mut v_res_1346_: *mut LeanObject = core::ptr::null_mut();
    v_t_boxed_1345_ = (lean_unbox(v_t_1342_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_threeMore_elim(
    ...
    mut v_threeMore_1353_: *mut LeanObject,
) -> *mut LeanObject {
    lean_inc(v_threeMore_1353_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_FirstByte_threeMore_elim___boxed(
    ...
    mut v_t_1355_: *mut LeanObject,
    mut v_h_1356_: *mut LeanObject,
    mut v_threeMore_1357_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_t_boxed_1358_: u8 = 0;
    let mut v_res_1359_: *mut LeanObject = core::ptr::null_mut();
    v_t_boxed_1358_ = (lean_unbox(v_t_1355_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_parseFirstByte___boxed(
    ...
    v_b_boxed_1381_ = (lean_unbox(v_b_1380_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2081___redArg(
    ...
    v___x_1397_ = lean_box_uint32(v___x_1396_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2081___boxed(
    mut v_w_1407_: *mut LeanObject,
    mut v_h_1408_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_w_boxed_1409_: u8 = 0;
    let mut v_res_1410_: *mut LeanObject = core::ptr::null_mut();
    v_w_boxed_1409_ = (lean_unbox(v_w_1407_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2081(
    mut v_w_1411_: u8,
    mut v___w_1412_: u8,
    mut v___h_1413_: *mut LeanObject,
) -> u8 {
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2081___boxed(
    mut v_w_1415_: *mut LeanObject,
    mut v___w_1416_: *mut LeanObject,
    mut v___h_1417_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    v_w_boxed_1418_ = (lean_unbox(v_w_1415_) as u8);
    v___w_boxed_1419_ = (lean_unbox(v___w_1416_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2082Unchecked___boxed(
    ...
    v_w_boxed_1435_ = (lean_unbox(v_w_1433_) as u8);
    v_x_boxed_1436_ = (lean_unbox(v_x_1434_) as u8);
    v_res_1437_ =
        l_ByteArray_utf8DecodeChar_x3f_assemble_u2082Unchecked(v_w_boxed_1435_, v_x_boxed_1436_);
    v_r_1438_ = lean_box_uint32(v_res_1437_);
    return v_r_1438_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2082(
    ...
    if v___x_1444_ == 0 {
        ...
        if v___x_1456_ == 0 {
            ...
            v___x_1457_ = lean_box_uint32(v_r_1454_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2082___boxed(
    ...
    v_w_boxed_1462_ = (lean_unbox(v_w_1460_) as u8);
    v_x_boxed_1463_ = (lean_unbox(v_x_1461_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2082___boxed(
    ...
    v_w_boxed_1484_ = (lean_unbox(v_w_1482_) as u8);
    v_x_boxed_1485_ = (lean_unbox(v_x_1483_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2083Unchecked___boxed(
    ...
    v_w_boxed_1508_ = (lean_unbox(v_w_1505_) as u8);
    v_x_boxed_1509_ = (lean_unbox(v_x_1506_) as u8);
    v_y_boxed_1510_ = (lean_unbox(v_y_1507_) as u8);
    v_res_1511_ = l_ByteArray_utf8DecodeChar_x3f_assemble_u2083Unchecked(
        v_w_boxed_1508_,
        v_x_boxed_1509_,
        v_y_boxed_1510_,
    );
    v_r_1512_ = lean_box_uint32(v_res_1511_);
    return v_r_1512_;
}
        ...
        if v___x_1522_ == 0 {
            ...
            if v___x_1539_ == 0 {
                ...
                if v___x_1541_ == 0 {
                    ...
                    v___x_1542_ = lean_box_uint32(v_r_1537_);
                    v___x_1543_ = lean_alloc_ctor(1, 1, (0) as u32);
                    ...
                    if v___x_1545_ == 0 {
                        ...
                        v___x_1546_ = lean_box_uint32(v_r_1537_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2083___boxed(
    mut v_w_1550_: *mut LeanObject,
    mut v_x_1551_: *mut LeanObject,
    mut v_y_1552_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    v_w_boxed_1553_ = (lean_unbox(v_w_1550_) as u8);
    v_x_boxed_1554_ = (lean_unbox(v_x_1551_) as u8);
    v_y_boxed_1555_ = (lean_unbox(v_y_1552_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2083___boxed(
    mut v_w_1587_: *mut LeanObject,
    mut v_x_1588_: *mut LeanObject,
    mut v_y_1589_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_w_boxed_1590_: u8 = 0;
    let mut v_x_boxed_1591_: u8 = 0;
    let mut v_y_boxed_1592_: u8 = 0;
    let mut v_res_1593_: u8 = 0;
    let mut v_r_1594_: *mut LeanObject = core::ptr::null_mut();
    v_w_boxed_1590_ = (lean_unbox(v_w_1587_) as u8);
    v_x_boxed_1591_ = (lean_unbox(v_x_1588_) as u8);
    v_y_boxed_1592_ = (lean_unbox(v_y_1589_) as u8);
    v_res_1593_ = l_ByteArray_utf8DecodeChar_x3f_verify_u2083(
        v_w_boxed_1590_,
        v_x_boxed_1591_,
        v_y_boxed_1592_,
    );
    v_r_1594_ = lean_box((v_res_1593_) as usize);
    return v_r_1594_;
}
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2084Unchecked___boxed(
    mut v_w_1618_: *mut LeanObject,
    mut v_x_1619_: *mut LeanObject,
    mut v_y_1620_: *mut LeanObject,
    mut v_z_1621_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    let mut v_r_1627_: *mut LeanObject = core::ptr::null_mut();
    v_w_boxed_1622_ = (lean_unbox(v_w_1618_) as u8);
    v_x_boxed_1623_ = (lean_unbox(v_x_1619_) as u8);
    v_y_boxed_1624_ = (lean_unbox(v_y_1620_) as u8);
    v_z_boxed_1625_ = (lean_unbox(v_z_1621_) as u8);
    ...
    v_r_1627_ = lean_box_uint32(v_res_1626_);
    return v_r_1627_;
}
            ...
            if v___x_1641_ == 0 {
                ...
                if v___x_1663_ == 0 {
                    ...
                    if v___x_1665_ == 0 {
                        ...
                        v___x_1666_ = lean_box_uint32(v_r_1661_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_assemble_u2084___boxed(
    mut v_w_1670_: *mut LeanObject,
    mut v_x_1671_: *mut LeanObject,
    mut v_y_1672_: *mut LeanObject,
    mut v_z_1673_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    v_w_boxed_1674_ = (lean_unbox(v_w_1670_) as u8);
    v_x_boxed_1675_ = (lean_unbox(v_x_1671_) as u8);
    v_y_boxed_1676_ = (lean_unbox(v_y_1672_) as u8);
    v_z_boxed_1677_ = (lean_unbox(v_z_1673_) as u8);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f_verify_u2084___boxed(
    mut v_w_1715_: *mut LeanObject,
    mut v_x_1716_: *mut LeanObject,
    mut v_y_1717_: *mut LeanObject,
    mut v_z_1718_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    v_w_boxed_1719_ = (lean_unbox(v_w_1715_) as u8);
    v_x_boxed_1720_ = (lean_unbox(v_x_1716_) as u8);
    v_y_boxed_1721_ = (lean_unbox(v_y_1717_) as u8);
    v_z_boxed_1722_ = (lean_unbox(v_z_1718_) as u8);
    ...
    v_r_1724_ = lean_box((v_res_1723_) as usize);
    return v_r_1724_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f(
    mut v_bytes_1725_: *mut LeanObject,
    mut v_i_1726_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    if v___x_1728_ == 0 {
        ...
        if v___x_1734_ == 0 {
            ...
            if v___x_1738_ == 0 {
                ...
                if v___x_1741_ == 0 {
                    ...
                    if v___x_1744_ == 0 {
                        ...
                        v___x_1746_ = lean_unsigned_to_nat(3);
                        ...
                        if v___x_1748_ == 0 {
                            ...
                            if v___x_1754_ == 0 {
                                ...
                                v___x_1756_ = lean_unsigned_to_nat(2);
                                ...
                                if v___x_1760_ == 0 {
                                    ...
                                    if v___x_1764_ == 0 {
                                        let mut v___x_1765_: *mut LeanObject =
                                            core::ptr::null_mut();
                                        ...
                                        if v___x_1786_ == 0 {
                                            ...
                                            if v___x_1788_ == 0 {
                                                let mut v___x_1789_: *mut LeanObject =
                                                    core::ptr::null_mut();
                                                let mut v___x_1790_: *mut LeanObject =
                                                    core::ptr::null_mut();
                                                v___x_1789_ = lean_box_uint32(v_r_1784_);
                                                v___x_1790_ = lean_alloc_ctor(1, 1, (0) as u32);
                                                lean_ctor_set(v___x_1790_, 0, v___x_1789_);
                                                return v___x_1790_;
                                            } else {
                                                let mut v___x_1791_: *mut LeanObject =
                                                    core::ptr::null_mut();
                                                v___x_1791_ = lean_box(0);
                                                return v___x_1791_;
                                            }
                                        } else {
                                            let mut v___x_1792_: *mut LeanObject =
                                                core::ptr::null_mut();
                        ...
                        if v___x_1801_ == 0 {
                            ...
                            if v___x_1805_ == 0 {
                                ...
                                if v___x_1822_ == 0 {
                                    ...
                                    if v___x_1824_ == 0 {
                                        let mut v___x_1825_: *mut LeanObject =
                                            core::ptr::null_mut();
                                        let mut v___x_1826_: *mut LeanObject =
                                            core::ptr::null_mut();
                                        v___x_1825_ = lean_box_uint32(v_r_1820_);
                                        v___x_1826_ = lean_alloc_ctor(1, 1, (0) as u32);
                                        ...
                                        if v___x_1828_ == 0 {
                                            let mut v___x_1829_: *mut LeanObject =
                                                core::ptr::null_mut();
                                            let mut v___x_1830_: *mut LeanObject =
                                                core::ptr::null_mut();
                                            v___x_1829_ = lean_box_uint32(v_r_1820_);
                                            v___x_1830_ = lean_alloc_ctor(1, 1, (0) as u32);
                                            lean_ctor_set(v___x_1830_, 0, v___x_1829_);
                                            return v___x_1830_;
                                        } else {
                                            let mut v___x_1831_: *mut LeanObject =
                                                core::ptr::null_mut();
                ...
                if v___x_1835_ == 0 {
                    ...
                    if v___x_1839_ == 0 {
                        ...
                        if v___x_1851_ == 0 {
                            ...
                            v___x_1852_ = lean_box_uint32(v_r_1849_);
            ...
            v___x_1856_ = lean_box_uint32(v___x_1855_);
...
pub unsafe fn l_ByteArray_utf8DecodeChar_x3f___boxed(
    mut v_bytes_1858_: *mut LeanObject,
    ...
    lean_dec(v_i_1859_);
    lean_dec_ref(v_bytes_1858_);
    return v_res_1860_;
}
pub unsafe fn l_ByteArray_validateUTF8At(
    mut v_bytes_1861_: *mut LeanObject,
            ...
            if v___x_1873_ == 0 {
                ...
                if v___x_1876_ == 0 {
                    ...
                    if v___x_1879_ == 0 {
                        ...
                        v___x_1880_ = lean_unsigned_to_nat(3);
                    ...
                    v___x_1919_ = lean_unsigned_to_nat(2);
                ...
                v___x_1950_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l_ByteArray_validateUTF8At___boxed(
    mut v_bytes_1967_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter___redArg(
    mut v_x_1971_: u8,
    mut v_h__1_1972_: *mut LeanObject,
    mut v_h__2_1973_: *mut LeanObject,
    mut v_h__3_1974_: *mut LeanObject,
    mut v_h__4_1975_: *mut LeanObject,
    mut v_h__5_1976_: *mut LeanObject,
) -> *mut LeanObject {
    match v_x_1971_ {
        0 => {
            let mut v___x_1977_: *mut LeanObject = core::ptr::null_mut();
            lean_dec(v_h__5_1976_);
            lean_dec(v_h__4_1975_);
            lean_dec(v_h__3_1974_);
            lean_dec(v_h__2_1973_);
            v___x_1977_ = lean_apply_1(v_h__1_1972_, lean_box(0));
            return v___x_1977_;
        }
        1 => {
            ...
            v___x_1978_ = lean_apply_1(v_h__2_1973_, lean_box(0));
            return v___x_1978_;
        }
        2 => {
            ...
            lean_dec(v_h__2_1973_);
            lean_dec(v_h__1_1972_);
            v___x_1979_ = lean_apply_1(v_h__3_1974_, lean_box(0));
            return v___x_1979_;
        }
        3 => {
            ...
            lean_dec(v_h__2_1973_);
            lean_dec(v_h__1_1972_);
            v___x_1980_ = lean_apply_1(v_h__4_1975_, lean_box(0));
            return v___x_1980_;
        }
        _ => {
            ...
            lean_dec(v_h__2_1973_);
            lean_dec(v_h__1_1972_);
            v___x_1981_ = lean_apply_1(v_h__5_1976_, lean_box(0));
            return v___x_1981_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter___redArg___boxed(
    ...
    mut v_h__1_1983_: *mut LeanObject,
    mut v_h__2_1984_: *mut LeanObject,
    mut v_h__3_1985_: *mut LeanObject,
    mut v_h__4_1986_: *mut LeanObject,
    mut v_h__5_1987_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_x_47__boxed_1988_: u8 = 0;
    let mut v_res_1989_: *mut LeanObject = core::ptr::null_mut();
    v_x_47__boxed_1988_ = (lean_unbox(v_x_1982_) as u8);
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter(
    mut v_motive_1990_: *mut LeanObject,
    mut v_x_1991_: u8,
    mut v_h__1_1992_: *mut LeanObject,
    mut v_h__2_1993_: *mut LeanObject,
    mut v_h__3_1994_: *mut LeanObject,
    mut v_h__4_1995_: *mut LeanObject,
    mut v_h__5_1996_: *mut LeanObject,
) -> *mut LeanObject {
    match v_x_1991_ {
        0 => {
            let mut v___x_1997_: *mut LeanObject = core::ptr::null_mut();
            lean_dec(v_h__5_1996_);
            lean_dec(v_h__4_1995_);
            lean_dec(v_h__3_1994_);
            lean_dec(v_h__2_1993_);
            v___x_1997_ = lean_apply_1(v_h__1_1992_, lean_box(0));
            return v___x_1997_;
        }
        1 => {
            ...
            lean_dec(v_h__4_1995_);
            lean_dec(v_h__3_1994_);
            lean_dec(v_h__1_1992_);
            v___x_1998_ = lean_apply_1(v_h__2_1993_, lean_box(0));
            return v___x_1998_;
        }
        2 => {
            ...
            lean_dec(v_h__2_1993_);
            lean_dec(v_h__1_1992_);
            v___x_1999_ = lean_apply_1(v_h__3_1994_, lean_box(0));
            return v___x_1999_;
        }
        3 => {
            ...
            lean_dec(v_h__2_1993_);
            lean_dec(v_h__1_1992_);
            v___x_2000_ = lean_apply_1(v_h__4_1995_, lean_box(0));
            return v___x_2000_;
        }
        _ => {
            ...
            lean_dec(v_h__2_1993_);
            lean_dec(v_h__1_1992_);
            v___x_2001_ = lean_apply_1(v_h__5_1996_, lean_box(0));
            return v___x_2001_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_match__1_splitter___boxed(
    ...
    mut v_h__1_2004_: *mut LeanObject,
    mut v_h__2_2005_: *mut LeanObject,
    mut v_h__3_2006_: *mut LeanObject,
    mut v_h__4_2007_: *mut LeanObject,
    mut v_h__5_2008_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_x_60__boxed_2009_: u8 = 0;
    let mut v_res_2010_: *mut LeanObject = core::ptr::null_mut();
    v_x_60__boxed_2009_ = (lean_unbox(v_x_2003_) as u8);
    v_res_2010_ =
...
pub unsafe fn l_ByteArray_utf8DecodeChar___redArg(
    mut v_bytes_2011_: *mut LeanObject,
    ...
    if v___x_2019_ == 0 {
        ...
        if v___x_2023_ == 0 {
            ...
            if v___x_2026_ == 0 {
                ...
                v___x_2030_ = lean_unsigned_to_nat(3);
                ...
                v___x_2038_ = lean_unsigned_to_nat(2);
            ...
            v___x_2100_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l_ByteArray_utf8DecodeChar___redArg___boxed(
    mut v_bytes_2118_: *mut LeanObject,
    ...
    lean_dec(v_i_2119_);
    lean_dec_ref(v_bytes_2118_);
    v_r_2121_ = lean_box_uint32(v_res_2120_);
    return v_r_2121_;
}
pub unsafe fn l_ByteArray_utf8DecodeChar(
    mut v_bytes_2122_: *mut LeanObject,
    mut v_i_2123_: *mut LeanObject,
    mut v_h_2124_: *mut LeanObject,
) -> u32 {
    ...
    if v___x_2131_ == 0 {
        ...
        if v___x_2135_ == 0 {
            ...
            if v___x_2138_ == 0 {
                ...
                v___x_2142_ = lean_unsigned_to_nat(3);
                ...
                v___x_2150_ = lean_unsigned_to_nat(2);
                ...
                v___x_2181_ = lean_unsigned_to_nat(2);
            ...
            v___x_2212_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l_ByteArray_utf8DecodeChar___boxed(
    mut v_bytes_2230_: *mut LeanObject,
    mut v_i_2231_: *mut LeanObject,
    mut v_h_2232_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec(v_i_2231_);
    lean_dec_ref(v_bytes_2230_);
    v_r_2234_ = lean_box_uint32(v_res_2233_);
    return v_r_2234_;
}
...
pub unsafe fn l_UInt8_instDecidableIsUTF8FirstByte___boxed(
    ...
    let mut v_r_2259_: *mut LeanObject = core::ptr::null_mut();
    v___y_4__boxed_2257_ = (lean_unbox(v___y_2256_) as u8);
    v_res_2258_ = l_UInt8_instDecidableIsUTF8FirstByte(v___y_4__boxed_2257_);
    v_r_2259_ = lean_box((v_res_2258_) as usize);
    return v_r_2259_;
}
pub unsafe fn l_UInt8_utf8ByteSize___redArg(mut v_c_2260_: u8) -> *mut LeanObject {
    ...
    if v___x_2264_ == 0 {
        ...
        if v___x_2268_ == 0 {
            ...
            if v___x_2271_ == 0 {
                ...
                v___x_2272_ = lean_unsigned_to_nat(4);
                return v___x_2272_;
            } else {
                let mut v___x_2273_: *mut LeanObject = core::ptr::null_mut();
                v___x_2273_ = lean_unsigned_to_nat(3);
                return v___x_2273_;
            }
        } else {
            let mut v___x_2274_: *mut LeanObject = core::ptr::null_mut();
            v___x_2274_ = lean_unsigned_to_nat(2);
            return v___x_2274_;
        }
    } else {
    ...
    if v___x_2284_ == 0 {
        ...
        if v___x_2288_ == 0 {
            ...
            if v___x_2291_ == 0 {
                ...
                v___x_2292_ = lean_unsigned_to_nat(4);
                return v___x_2292_;
            } else {
                let mut v___x_2293_: *mut LeanObject = core::ptr::null_mut();
                v___x_2293_ = lean_unsigned_to_nat(3);
                return v___x_2293_;
            }
        } else {
            let mut v___x_2294_: *mut LeanObject = core::ptr::null_mut();
            v___x_2294_ = lean_unsigned_to_nat(2);
            return v___x_2294_;
        }
    } else {
...
pub unsafe fn l_UInt8_utf8ByteSize___boxed(
    mut v_c_2296_: *mut LeanObject,
    mut v___h_2297_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_c_boxed_2298_: u8 = 0;
    let mut v_res_2299_: *mut LeanObject = core::ptr::null_mut();
    v_c_boxed_2298_ = (lean_unbox(v_c_2296_) as u8);
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize(
    ...
    match v_x_2300_ {
        ...
        2 => {
            ...
            v___x_2303_ = lean_unsigned_to_nat(2);
            return v___x_2303_;
        }
        3 => {
        ...
        _ => {
            ...
            v___x_2305_ = lean_unsigned_to_nat(4);
            return v___x_2305_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize___boxed(
    ...
    v_x_54__boxed_2307_ = (lean_unbox(v_x_2306_) as u8);
    v_res_2308_ =
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter___redArg(
    ...
    mut v_h__3_2312_: *mut LeanObject,
    mut v_h__4_2313_: *mut LeanObject,
    mut v_h__5_2314_: *mut LeanObject,
) -> *mut LeanObject {
    match v_x_2309_ {
        0 => {
            ...
            v___x_2316_ = lean_apply_1(v_h__1_2310_, v___x_2315_);
            return v___x_2316_;
        }
        1 => {
            ...
            v___x_2318_ = lean_apply_1(v_h__2_2311_, v___x_2317_);
            return v___x_2318_;
        }
        2 => {
            ...
            v___x_2320_ = lean_apply_1(v_h__3_2312_, v___x_2319_);
            return v___x_2320_;
        }
        3 => {
            ...
            v___x_2322_ = lean_apply_1(v_h__4_2313_, v___x_2321_);
            return v___x_2322_;
        }
        _ => {
            ...
            v___x_2324_ = lean_apply_1(v_h__5_2314_, v___x_2323_);
            return v___x_2324_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter___redArg___boxed(
    ...
    mut v_h__1_2326_: *mut LeanObject,
    mut v_h__2_2327_: *mut LeanObject,
    mut v_h__3_2328_: *mut LeanObject,
    mut v_h__4_2329_: *mut LeanObject,
    mut v_h__5_2330_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_x_56__boxed_2331_: u8 = 0;
    let mut v_res_2332_: *mut LeanObject = core::ptr::null_mut();
    v_x_56__boxed_2331_ = (lean_unbox(v_x_2325_) as u8);
...
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter(
    ...
    mut v_x_2334_: u8,
    mut v_h__1_2335_: *mut LeanObject,
    mut v_h__2_2336_: *mut LeanObject,
    mut v_h__3_2337_: *mut LeanObject,
    mut v_h__4_2338_: *mut LeanObject,
    mut v_h__5_2339_: *mut LeanObject,
) -> *mut LeanObject {
    match v_x_2334_ {
        0 => {
            let mut v___x_2340_: *mut LeanObject = core::ptr::null_mut();
            let mut v___x_2341_: *mut LeanObject = core::ptr::null_mut();
            lean_dec(v_h__5_2339_);
            lean_dec(v_h__4_2338_);
            lean_dec(v_h__3_2337_);
            lean_dec(v_h__2_2336_);
            v___x_2340_ = lean_box(0);
            v___x_2341_ = lean_apply_1(v_h__1_2335_, v___x_2340_);
            return v___x_2341_;
        }
        1 => {
            ...
            v___x_2343_ = lean_apply_1(v_h__2_2336_, v___x_2342_);
            return v___x_2343_;
        }
        2 => {
            ...
            v___x_2345_ = lean_apply_1(v_h__3_2337_, v___x_2344_);
            return v___x_2345_;
        }
        3 => {
            ...
            v___x_2347_ = lean_apply_1(v_h__4_2338_, v___x_2346_);
            return v___x_2347_;
        }
        _ => {
            ...
            v___x_2349_ = lean_apply_1(v_h__5_2339_, v___x_2348_);
            return v___x_2349_;
        }
    }
}
pub unsafe fn l___private_Init_Data_String_Decode_0__ByteArray_utf8DecodeChar_x3f_FirstByte_utf8ByteSize_match__1_splitter___boxed(
    ...
    mut v_h__1_2352_: *mut LeanObject,
    mut v_h__2_2353_: *mut LeanObject,
    mut v_h__3_2354_: *mut LeanObject,
    mut v_h__4_2355_: *mut LeanObject,
    mut v_h__5_2356_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_x_79__boxed_2357_: u8 = 0;
    let mut v_res_2358_: *mut LeanObject = core::ptr::null_mut();
    v_x_79__boxed_2357_ = (lean_unbox(v_x_2351_) as u8);
...
pub unsafe fn runtime_initialize_Init_Data_String_Decode(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_String_Decode(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String_Decode(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
