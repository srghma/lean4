...
// Imports: Init.Data.String.Basic Init.Data.Order.Classes Init.Data.List.Lex Init.Data.Char.Lemmas Init.Data.Char.Order Init.Data.Order.Factories Init.Data.Order.Lemmas
...
pub unsafe fn runtime_initialize_Init_Data_String_Lemmas_StringOrder(
    builtin: u8,
) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_String_Lemmas_StringOrder(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String_Lemmas_StringOrder(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
