...
// Imports: Init.Data.String.Length Init.Data.String.Modify Init.Data.String.Lemmas.Modify Init.Data.String.Lemmas.Intercalate
...
pub unsafe fn runtime_initialize_Init_Data_String_Lemmas_Length(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_String_Lemmas_Length(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String_Lemmas_Length(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
