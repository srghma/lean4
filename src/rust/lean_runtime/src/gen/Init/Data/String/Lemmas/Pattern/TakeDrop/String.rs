...
// Imports: Init.Data.String.Slice Init.Data.String.TakeDrop Init.Data.String.Lemmas.Splits Init.Data.String.Lemmas.Pattern.TakeDrop.Basic Init.Data.String.Lemmas.Pattern.String Init.Data.List.Sublist Init.Data.Option.Lemmas Init.Data.String.Lemmas.Basic
...
pub unsafe fn runtime_initialize_Init_Data_String_Lemmas_Pattern_TakeDrop_String(
    builtin: u8,
...
pub unsafe fn meta_initialize_Init_Data_String_Lemmas_Pattern_TakeDrop_String(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String_Lemmas_Pattern_TakeDrop_String(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
