...
pub static l_String_instHashableRaw___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_String_instHashableRaw___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_String_instHashableRaw___closed__0_value) as *mut LeanObject;
pub static mut l_String_instHashableRaw: *mut LeanObject =
    core::ptr::addr_of!(l_String_instHashableRaw___closed__0_value) as *mut LeanObject;
pub unsafe fn l_String_instHashableRaw_hash(mut v_x_44_: *mut LeanObject) -> u64 {
...
pub unsafe fn l_String_instHashablePos_hash___redArg(mut v_x_53_: *mut LeanObject) -> u64 {
...
pub unsafe fn l_String_instHashablePos_hash___boxed(
    mut v_s_64_: *mut LeanObject,
    mut v_x_65_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_res_66_: u64 = 0;
    let mut v_r_67_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_String_instHashablePos(mut v_s_68_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_69_: *mut LeanObject = core::ptr::null_mut();
    v___x_69_ = lean_alloc_closure(
        l_String_instHashablePos_hash___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    lean_closure_set(v___x_69_, 0, v_s_68_);
    return v___x_69_;
}
pub unsafe fn l_String_instHashablePos__1_hash___redArg(mut v_x_70_: *mut LeanObject) -> u64 {
...
pub unsafe fn l_String_instHashablePos__1_hash___boxed(
    ...
    let mut v_r_84_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_String_instHashablePos__1(mut v_s_85_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_86_: *mut LeanObject = core::ptr::null_mut();
    v___x_86_ = lean_alloc_closure(
        l_String_instHashablePos__1_hash___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    lean_closure_set(v___x_86_, 0, v_s_85_);
    return v___x_86_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_String_Hashable(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_String_Hashable(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_String_Hashable(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
