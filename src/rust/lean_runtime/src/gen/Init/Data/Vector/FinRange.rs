...
pub static l_Vector_finRange___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Vector_finRange___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Vector_finRange___closed__0_value) as *mut LeanObject;
pub unsafe fn l_Vector_finRange___lam__0(mut v_i_8_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_i_8_);
    return v_i_8_;
}
pub unsafe fn l_Vector_finRange___lam__0___boxed(mut v_i_9_: *mut LeanObject) -> *mut LeanObject {
    let mut v_res_10_: *mut LeanObject = core::ptr::null_mut();
    v_res_10_ = l_Vector_finRange___lam__0(v_i_9_);
    lean_dec(v_i_9_);
    return v_res_10_;
}
pub unsafe fn l_Vector_finRange(mut v_n_12_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Init_Data_Vector_FinRange(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Vector_FinRange(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Vector_FinRange(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
