...
// Imports: Init.Data.Array.Basic Init.Data.Vector.Basic Init.Data.Vector.Attach Init.Data.Array.Find Init.Data.Bool Init.Data.Fin.Lemmas Init.Data.List.Find Init.Data.List.Impl Init.Data.Subtype.Basic
...
pub unsafe fn runtime_initialize_Init_Data_Vector_Find(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Vector_Find(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Vector_Find(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
