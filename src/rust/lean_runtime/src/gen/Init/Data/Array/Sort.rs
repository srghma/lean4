...
// Imports: Init.Data.Array.Sort.Basic Init.Data.Array.Sort.Lemmas
...
use crate::r#gen::Init::Data::Array::Sort::Lemmas::{
    initialize_Init_Data_Array_Sort_Lemmas, runtime_initialize_Init_Data_Array_Sort_Lemmas,
};
use crate::leanh::{
...
pub unsafe fn runtime_initialize_Init_Data_Array_Sort(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Array_Sort(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array_Sort(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
