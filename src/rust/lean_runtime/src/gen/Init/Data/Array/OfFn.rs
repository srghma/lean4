...
pub unsafe fn l___private_Init_Data_Array_OfFn_0__Array_ofFn_go_match__1_splitter___redArg(
    ...
    let mut v_zero_59_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isZero_60_: u8 = 0;
    v_zero_59_ = lean_unsigned_to_nat(0);
    v_isZero_60_ = lean_nat_dec_eq(v_x_56_, v_zero_59_);
    if v_isZero_60_ == 1 {
        let mut v___x_61_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_h__1_57_);
        v___x_61_ = lean_apply_1(v_h__2_58_, lean_box(0));
        return v___x_61_;
    } else {
        let mut v_one_62_: *mut LeanObject = core::ptr::null_mut();
        let mut v_n_63_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_64_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_h__2_58_);
        v_one_62_ = lean_unsigned_to_nat(1);
        v_n_63_ = lean_nat_sub(v_x_56_, v_one_62_);
        v___x_64_ = lean_apply_2(v_h__1_57_, v_n_63_, lean_box(0));
        return v___x_64_;
    }
}
...
pub unsafe fn l___private_Init_Data_Array_OfFn_0__Array_ofFn_go_match__1_splitter(
    ...
    mut v_motive_70_: *mut LeanObject,
    mut v_x_71_: *mut LeanObject,
    mut v_x_72_: *mut LeanObject,
    mut v_h__1_73_: *mut LeanObject,
    mut v_h__2_74_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_zero_75_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isZero_76_: u8 = 0;
    v_zero_75_ = lean_unsigned_to_nat(0);
    v_isZero_76_ = lean_nat_dec_eq(v_x_71_, v_zero_75_);
    if v_isZero_76_ == 1 {
        let mut v___x_77_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_h__1_73_);
        v___x_77_ = lean_apply_1(v_h__2_74_, lean_box(0));
        return v___x_77_;
    } else {
        let mut v_one_78_: *mut LeanObject = core::ptr::null_mut();
        let mut v_n_79_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_80_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_h__2_74_);
        v_one_78_ = lean_unsigned_to_nat(1);
        v_n_79_ = lean_nat_sub(v_x_71_, v_one_78_);
        v___x_80_ = lean_apply_2(v_h__1_73_, v_n_79_, lean_box(0));
        return v___x_80_;
    }
}
...
pub unsafe fn l_Array_ofFnM___redArg___lam__0(
    mut v_toFunctor_88_: *mut LeanObject,
    mut v_f_89_: *mut LeanObject,
    mut v_xs_90_: *mut LeanObject,
    mut v_i_91_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_map_92_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_map_92_ = lean_ctor_get(v_toFunctor_88_, 0);
    lean_inc(v_map_92_);
    lean_dec_ref(v_toFunctor_88_);
    v___x_93_ = lean_alloc_closure(l_Array_push___boxed as *mut core::ffi::c_void, 3, 2);
    lean_closure_set(v___x_93_, 0, lean_box(0));
    lean_closure_set(v___x_93_, 1, v_xs_90_);
    v___x_94_ = lean_apply_1(v_f_89_, v_i_91_);
    v___x_95_ = lean_apply_4(v_map_92_, lean_box(0), lean_box(0), v___x_93_, v___x_94_);
    return v___x_95_;
}
pub unsafe fn l_Array_ofFnM___redArg(
    ...
    let mut v_toApplicative_99_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toFunctor_100_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_toApplicative_99_ = lean_ctor_get(v_inst_97_, 0);
    v_toFunctor_100_ = lean_ctor_get(v_toApplicative_99_, 0);
    ...
    lean_closure_set(v___f_101_, 0, v_toFunctor_100_);
    lean_closure_set(v___f_101_, 1, v_f_98_);
    v___x_102_ = lean_mk_empty_array_with_capacity(v_n_96_);
    v___x_103_ = lean_unsigned_to_nat(0);
...
pub unsafe fn runtime_initialize_Init_Data_Array_OfFn(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Array_OfFn(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array_OfFn(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
