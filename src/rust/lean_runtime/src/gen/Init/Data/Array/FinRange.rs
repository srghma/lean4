...
pub static l_Array_finRange___closed__0_value: crate::leanh::LeanClosureObject<0> =
...
static mut l_Array_finRange___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Array_finRange___closed__0_value) as *mut crate::leanh::LeanObject;
pub unsafe fn l_Array_finRange___lam__0(
    mut v_i_8_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    crate::leanh::lean_inc(v_i_8_);
    return v_i_8_;
}
pub unsafe fn l_Array_finRange___lam__0___boxed(
...
pub unsafe fn l_Array_finRange(
...
pub unsafe fn runtime_initialize_Init_Data_Array_FinRange(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Array_FinRange(
    builtin: u8,
) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array_FinRange(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
