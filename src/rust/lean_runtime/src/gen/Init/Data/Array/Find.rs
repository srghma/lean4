...
pub unsafe fn l___private_Init_Data_Array_Find_0__Array_of__findIdx_x3f__eq__some_match__1_splitter___redArg(
    ...
    if lean_obj_tag(v_x_59_) == 0 {
        ...
        let mut v_val_64_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Init_Data_Array_Find_0__Array_of__findIdx_x3f__eq__some_match__1_splitter(
    ...
    mut v_motive_67_: *mut LeanObject,
    ...
    if lean_obj_tag(v_x_68_) == 0 {
        ...
        let mut v_val_73_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Init_Data_Array_Find_0__Option_pmap__or_match__1_splitter(
    ...
    mut v_p_98_: *mut LeanObject,
    mut v_o_x27_99_: *mut LeanObject,
    mut v_motive_100_: *mut LeanObject,
    mut v_o_101_: *mut LeanObject,
    mut v_h_102_: *mut LeanObject,
    mut v_h__1_103_: *mut LeanObject,
    mut v_h__2_104_: *mut LeanObject,
) -> *mut LeanObject {
    if lean_obj_tag(v_o_101_) == 0 {
        ...
        v_val_106_ = lean_ctor_get(v_o_101_, 0);
        lean_inc(v_val_106_);
        lean_dec_ref_known(v_o_101_, 1);
...
pub unsafe fn l___private_Init_Data_Array_Find_0__Option_pmap__or_match__1_splitter___boxed(
    ...
    mut v_o_x27_110_: *mut LeanObject,
    mut v_motive_111_: *mut LeanObject,
    mut v_o_112_: *mut LeanObject,
    mut v_h_113_: *mut LeanObject,
    ...
    lean_dec(v_o_x27_110_);
    return v_res_116_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Init_Data_Array_Find(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Data_Array_Find(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Data_Array_Find(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
