...
use crate::leanh::{
    ...
    lean_dec_ref, lean_inc, lean_io_result_is_error, lean_io_result_mk_ok, lean_unsigned_to_nat,
};
pub unsafe fn l_Lean_Omega_Coeffs_toList(mut v_xs_98_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_xs_98_);
    return v_xs_98_;
}
pub unsafe fn l_Lean_Omega_Coeffs_toList___boxed(mut v_xs_99_: *mut LeanObject) -> *mut LeanObject {
    let mut v_res_100_: *mut LeanObject = core::ptr::null_mut();
    v_res_100_ = l_Lean_Omega_Coeffs_toList(v_xs_99_);
    lean_dec(v_xs_99_);
    return v_res_100_;
}
pub unsafe fn l_Lean_Omega_Coeffs_ofList(mut v_xs_101_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_xs_101_);
    return v_xs_101_;
}
pub unsafe fn l_Lean_Omega_Coeffs_ofList___boxed(
    mut v_xs_102_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_set(
    ...
    mut v_i_105_: *mut LeanObject,
    mut v_y_106_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_set___boxed(
    mut v_xs_108_: *mut LeanObject,
    mut v_i_109_: *mut LeanObject,
    mut v_y_110_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_get(
    mut v_xs_112_: *mut LeanObject,
    mut v_i_113_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_gcd(mut v_xs_118_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_119_: *mut LeanObject = core::ptr::null_mut();
    v___x_119_ = l_Lean_Omega_IntList_gcd(v_xs_118_);
    return v___x_119_;
}
pub unsafe fn l_Lean_Omega_Coeffs_gcd___boxed(mut v_xs_120_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_smul(
    mut v_xs_122_: *mut LeanObject,
    mut v_g_123_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_smul___boxed(
    mut v_xs_125_: *mut LeanObject,
    mut v_g_126_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_sdiv(
    mut v_xs_128_: *mut LeanObject,
    mut v_g_129_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_sdiv___boxed(
    mut v_xs_131_: *mut LeanObject,
    mut v_g_132_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_dot(
    mut v_xs_134_: *mut LeanObject,
    mut v_ys_135_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_dot___boxed(
    mut v_xs_137_: *mut LeanObject,
    mut v_ys_138_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_add(
    mut v_xs_140_: *mut LeanObject,
    mut v_ys_141_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_sub(
    mut v_xs_143_: *mut LeanObject,
    mut v_ys_144_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_neg(mut v_xs_146_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_combo(
    ...
    mut v_xs_149_: *mut LeanObject,
    mut v_b_150_: *mut LeanObject,
    mut v_ys_151_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_combo___boxed(
    ...
    mut v_b_155_: *mut LeanObject,
    mut v_ys_156_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_length(mut v_xs_158_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_leading(mut v_xs_162_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Omega_Coeffs_bmod(
    ...
    lean_closure_set(v___f_182_, 0, v_m_181_);
...
pub unsafe fn l_Lean_Omega_Coeffs_bmod__dot__sub__dot__bmod(
    ...
    lean_closure_set(v___f_188_, 0, v_m_185_);
    lean_inc(v_b_187_);
...
pub unsafe fn runtime_initialize_Init_Omega_Coeffs(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Omega_Coeffs(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Omega_Coeffs(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
