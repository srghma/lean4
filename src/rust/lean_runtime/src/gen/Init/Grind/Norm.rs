...
// Imports: Init.Data.Int.Lemmas Init.Data.Int.Linear Init.Data.Rat.Lemmas Init.Grind.Ring.OfScientific Init.Data.Int.Pow Init.Data.Int.DivMod.Lemmas Init.Omega Init.ByCases
...
pub unsafe fn runtime_initialize_Init_Grind_Norm(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Grind_Norm(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Grind_Norm(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
