...
use crate::r#gen::Init::Grind::Ordered::Int::{
    initialize_Init_Grind_Ordered_Int, runtime_initialize_Init_Grind_Ordered_Int,
};
...
pub unsafe fn runtime_initialize_Init_Grind_Ordered(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_Grind_Ordered(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Grind_Ordered(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
