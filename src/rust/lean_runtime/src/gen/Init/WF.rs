...
use crate::leanh::{
    ...
    lean_closure_set, lean_ctor_get, lean_dec, lean_dec_ref, lean_inc, lean_inc_n,
    lean_io_result_is_error, lean_io_result_mk_ok, lean_mark_persistent, lean_unbox,
    lean_unsigned_to_nat,
};
pub static mut l_Nat_lt__wfRel: *mut LeanObject = core::ptr::null_mut();
pub static l_WellFounded_Nat_fix_go___redArg___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_WellFounded_Nat_fix_go___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_WellFounded_Nat_fix_go___redArg___closed__0_value) as *mut LeanObject;
pub unsafe fn l_WellFounded_wrap___redArg(mut v_x_196_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_x_196_);
    return v_x_196_;
}
...
pub unsafe fn l_emptyWf(mut v_00_u03b1_208_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn _init_l_Nat_lt__wfRel() -> *mut LeanObject {
...
pub unsafe fn l_Prod_Lex_instDecidableRelOfDecidableEq___redArg(
    mut v_00_u03b1eqDec_233_: *mut LeanObject,
    mut v_rDec_234_: *mut LeanObject,
    mut v_sDec_235_: *mut LeanObject,
    ...
    v_fst_238_ = lean_ctor_get(v_x_236_, 0);
    lean_inc_n(v_fst_238_, 2);
    v_snd_239_ = lean_ctor_get(v_x_236_, 1);
    lean_inc(v_snd_239_);
    lean_dec_ref(v_x_236_);
    v_fst_240_ = lean_ctor_get(v_x_237_, 0);
    lean_inc_n(v_fst_240_, 2);
    v_snd_241_ = lean_ctor_get(v_x_237_, 1);
    lean_inc(v_snd_241_);
    lean_dec_ref(v_x_237_);
    v___x_242_ = lean_apply_2(v_00_u03b1eqDec_233_, v_fst_238_, v_fst_240_);
    v___x_243_ = lean_apply_2(v_rDec_234_, v_fst_238_, v_fst_240_);
    v___x_244_ = (lean_unbox(v___x_243_) as u8);
    if v___x_244_ == 0 {
        let mut v___x_245_: u8 = 0;
        v___x_245_ = (lean_unbox(v___x_242_) as u8);
        if v___x_245_ == 0 {
            let mut v___x_246_: u8 = 0;
            lean_dec(v_snd_241_);
            lean_dec(v_snd_239_);
            lean_dec_ref(v_sDec_235_);
            v___x_246_ = (lean_unbox(v___x_242_) as u8);
            return v___x_246_;
        } else {
            let mut v___x_247_: *mut LeanObject = core::ptr::null_mut();
            let mut v___x_248_: u8 = 0;
            v___x_247_ = lean_apply_2(v_sDec_235_, v_snd_239_, v_snd_241_);
            v___x_248_ = (lean_unbox(v___x_247_) as u8);
            return v___x_248_;
        }
    } else {
        ...
        lean_dec(v_snd_239_);
        lean_dec_ref(v_sDec_235_);
        v___x_249_ = (lean_unbox(v___x_243_) as u8);
        return v___x_249_;
    }
}
pub unsafe fn l_Prod_Lex_instDecidableRelOfDecidableEq___redArg___boxed(
    mut v_00_u03b1eqDec_250_: *mut LeanObject,
    mut v_rDec_251_: *mut LeanObject,
    mut v_sDec_252_: *mut LeanObject,
    mut v_x_253_: *mut LeanObject,
    mut v_x_254_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_res_255_: u8 = 0;
    let mut v_r_256_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_r_256_ = lean_box((v_res_255_) as usize);
    return v_r_256_;
}
pub unsafe fn l_Prod_Lex_instDecidableRelOfDecidableEq(
    ...
    mut v_00_u03b1eqDec_259_: *mut LeanObject,
    mut v_r_260_: *mut LeanObject,
    mut v_rDec_261_: *mut LeanObject,
    mut v_s_262_: *mut LeanObject,
    mut v_sDec_263_: *mut LeanObject,
...
pub unsafe fn l_Prod_Lex_instDecidableRelOfDecidableEq___boxed(
    ...
    mut v_00_u03b1eqDec_269_: *mut LeanObject,
    mut v_r_270_: *mut LeanObject,
    mut v_rDec_271_: *mut LeanObject,
    mut v_s_272_: *mut LeanObject,
    mut v_sDec_273_: *mut LeanObject,
...
pub unsafe fn l_Prod_lex(
    ...
    mut v_ha_280_: *mut LeanObject,
    mut v_hb_281_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Prod_instWellFoundedRelation(
    ...
    mut v_ha_285_: *mut LeanObject,
    mut v_hb_286_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Prod_rprod(
    ...
    mut v_ha_290_: *mut LeanObject,
    mut v_hb_291_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_PSigma_lex(
    ...
    mut v_ha_295_: *mut LeanObject,
    mut v_hb_296_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_PSigma_lex___boxed(
    ...
    mut v_ha_300_: *mut LeanObject,
    mut v_hb_301_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_PSigma_instWellFoundedRelation___boxed(
    ...
    mut v_00_u03b2_309_: *mut LeanObject,
    mut v_ha_310_: *mut LeanObject,
    mut v_hb_311_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec_ref(v_hb_311_);
    return v_res_312_;
}
pub unsafe fn l_PSigma_skipLeft(
    mut v_00_u03b1_313_: *mut LeanObject,
    mut v_00_u03b2_314_: *mut LeanObject,
    mut v_hb_315_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_316_: *mut LeanObject = core::ptr::null_mut();
    v___x_316_ = lean_box(0);
    return v___x_316_;
}
pub unsafe fn l_WellFounded_Nat_eager(mut v_n_317_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_n_317_);
    return v_n_317_;
}
pub unsafe fn l_WellFounded_Nat_eager___boxed(mut v_n_318_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_WellFounded_Nat_fix_go___redArg___lam__1(
    mut v_ih_325_: *mut LeanObject,
    mut v_y_326_: *mut LeanObject,
    mut v_hy_327_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_328_: *mut LeanObject = core::ptr::null_mut();
    v___x_328_ = lean_apply_2(v_ih_325_, v_y_326_, lean_box(0));
    return v___x_328_;
}
pub unsafe fn l_WellFounded_Nat_fix_go___redArg___lam__2(
    mut v_F_329_: *mut LeanObject,
    mut v_x_330_: *mut LeanObject,
    mut v_ih_331_: *mut LeanObject,
    mut v_x_332_: *mut LeanObject,
    mut v_hfuel_333_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_closure_set(v___f_334_, 0, v_ih_331_);
    v___x_335_ = lean_apply_2(v_F_329_, v_x_332_, v___f_334_);
    return v___x_335_;
}
pub unsafe fn l_WellFounded_Nat_fix_go___redArg___lam__2___boxed(
    mut v_F_336_: *mut LeanObject,
    mut v_x_337_: *mut LeanObject,
    mut v_ih_338_: *mut LeanObject,
    mut v_x_339_: *mut LeanObject,
    mut v_hfuel_340_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_WellFounded_Nat_fix_go___redArg(
    ...
    mut v_fuel_344_: *mut LeanObject,
    ...
    let mut v___x_10__overap_348_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_WellFounded_Nat_fix_go(
    ...
    mut v_fuel_358_: *mut LeanObject,
...
pub unsafe fn l_WellFounded_Nat_fix_go___boxed(
    ...
    mut v_fuel_366_: *mut LeanObject,
    mut v_x_367_: *mut LeanObject,
    mut v_a_368_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec_ref(v_h_364_);
    return v_res_369_;
}
pub unsafe fn l_WellFounded_Nat_fix___redArg(
    mut v_h_370_: *mut LeanObject,
    ...
    lean_inc(v_x_372_);
    v___x_373_ = lean_apply_1(v_h_370_, v_x_372_);
...
pub unsafe fn l_wfParam___redArg(mut v_a_383_: *mut LeanObject) -> *mut LeanObject {
    lean_inc(v_a_383_);
    return v_a_383_;
}
pub unsafe fn l_wfParam___redArg___boxed(mut v_a_384_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Init_WF(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Init_WF(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_WF(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
