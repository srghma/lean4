...
// Imports: Init.Data.Rat.Basic Init.Data.SInt.Basic Init.Data.Int.DivMod.Lemmas Init.Data.Nat.Dvd Init.Data.String.Basic Init.Data.BitVec.Lemmas Init.Data.Int.Order Init.Data.UInt.Lemmas
...
pub unsafe fn runtime_initialize_Init_Sym_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_Sym_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_Sym_Lemmas(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
