...
pub unsafe fn l_Acc_wfRel(
    ...
    mut v_r_72_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Acc_recC___redArg(
    mut v_intro_74_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_inc(v_intro_74_);
    v___f_76_ = crate::leanh::lean_alloc_closure(
        l_Acc_recC___redArg___lam__0 as *mut core::ffi::c_void,
        3,
        1,
    );
    crate::leanh::lean_closure_set(v___f_76_, 0, v_intro_74_);
    v___x_77_ =
        crate::leanh::lean_apply_3(v_intro_74_, v_a_75_, crate::leanh::lean_box(0), v___f_76_);
    return v___x_77_;
}
pub unsafe fn l_Acc_recC___redArg___lam__0(
    mut v_intro_78_: *mut crate::leanh::LeanObject,
    mut v_x_79_: *mut crate::leanh::LeanObject,
    mut v_hr_80_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Acc_recC(
    ...
    mut v_motive_84_: *mut crate::leanh::LeanObject,
    mut v_intro_85_: *mut crate::leanh::LeanObject,
    mut v_a_86_: *mut crate::leanh::LeanObject,
    mut v_t_87_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Acc_ndrecC(
    ...
    mut v_r_93_: *mut crate::leanh::LeanObject,
    mut v_C_94_: *mut crate::leanh::LeanObject,
    mut v_m_95_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_Acc_ndrecOnC___redArg(
    ...
    mut v_m_100_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Acc_ndrecOnC(
    ...
    mut v_C_104_: *mut crate::leanh::LeanObject,
    mut v_a_105_: *mut crate::leanh::LeanObject,
    mut v_n_106_: *mut crate::leanh::LeanObject,
    mut v_m_107_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_WellFounded_fixFC___redArg___lam__0(
    ...
    mut v_x_u2081_110_: *mut crate::leanh::LeanObject,
    mut v_h_111_: *mut crate::leanh::LeanObject,
    mut v_ih_112_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v___x_113_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___x_113_ = crate::leanh::lean_apply_2(v_F_109_, v_x_u2081_110_, v_ih_112_);
    return v___x_113_;
}
pub unsafe fn l_WellFounded_fixFC___redArg(
    mut v_F_114_: *mut crate::leanh::LeanObject,
    ...
    crate::leanh::lean_closure_set(v___f_116_, 0, v_F_114_);
...
pub unsafe fn l_WellFounded_fixFC(
    ...
    mut v_r_119_: *mut crate::leanh::LeanObject,
    mut v_C_120_: *mut crate::leanh::LeanObject,
    mut v_F_121_: *mut crate::leanh::LeanObject,
    mut v_x_122_: *mut crate::leanh::LeanObject,
    mut v_a_123_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v___f_124_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_125_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v___f_124_ = crate::leanh::lean_alloc_closure(
        l_WellFounded_fixFC___redArg___lam__0 as *mut core::ffi::c_void,
        4,
        1,
    );
    crate::leanh::lean_closure_set(v___f_124_, 0, v_F_121_);
    v___x_125_ = l_Acc_recC___redArg(v___f_124_, v_x_122_);
    return v___x_125_;
}
pub unsafe fn l_WellFounded_fixC___redArg(
    mut v_F_126_: *mut crate::leanh::LeanObject,
...
pub unsafe fn l_WellFounded_fixC(
    ...
    mut v_C_135_: *mut crate::leanh::LeanObject,
    mut v_r_136_: *mut crate::leanh::LeanObject,
    mut v_hwf_137_: *mut crate::leanh::LeanObject,
...
pub unsafe fn runtime_initialize_Init_WFComputable(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Init_WFComputable(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Init_WFComputable(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
