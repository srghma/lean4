...
pub static l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___lam__0___closed__0_value: LeanArrayObject<0> =
    LeanArrayObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___lam__0___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___lam__0___closed__0_value)
        as *mut LeanObject;
pub static l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
        ...
        m_fun: l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___lam__0___boxed
            as *const core::ffi::c_void,
        m_arity: 4,
        m_num_fixed: 0,
        m_objs: [],
    };
static mut l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__0_value)
        as *mut LeanObject;
static mut l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__1_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__1: *mut LeanObject =
    core::ptr::null_mut();
static mut l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__2_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__2: *mut LeanObject =
    core::ptr::null_mut();
pub static l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__3_value: LeanCtorObject<1> =
    LeanCtorObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__3: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__3_value)
        as *mut LeanObject;
pub static l_Lean_Compiler_LCNF_isDeclPublic___closed__0_value: LeanCtorObject<2> =
    LeanCtorObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lean_Compiler_LCNF_isDeclPublic___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Compiler_LCNF_isDeclPublic___closed__0_value) as *mut LeanObject;
pub static l_Lean_Compiler_LCNF_isDeclPublic___closed__1_value: LeanStringObject<7> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_Compiler_LCNF_isDeclPublic___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Compiler_LCNF_isDeclPublic___closed__1_value) as *mut LeanObject;
pub unsafe fn l_List_foldl___at___00Lean_Compiler_LCNF_mkOrderedDeclSetExt_spec__0(
    mut v_newState_130_: *mut LeanObject,
    ...
    let mut v_snd_144_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_159_: *mut LeanObject = core::ptr::null_mut();
    let mut v_unused_160_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if lean_obj_tag(v_x_132_) == 0 {
                    ...
                    v_isSharedCheck_162_ = (!lean_is_exclusive(v_x_132_)) as u8;
            ...
            1 => {
                v_fst_138_ = lean_ctor_get(v_x_131_, 0);
                v_snd_139_ = lean_ctor_get(v_x_131_, 1);
                v___x_140_ = l_Lean_NameSet_contains(v_snd_139_, v_head_133_);
                if v___x_140_ == 0 {
                    lean_inc(v_snd_139_);
                    lean_inc(v_fst_138_);
                    v_isSharedCheck_158_ = (!lean_is_exclusive(v_x_131_)) as u8;
                    if v_isSharedCheck_158_ == 0 {
                        v_unused_159_ = lean_ctor_get(v_x_131_, 1);
                        lean_dec(v_unused_159_);
                        v_unused_160_ = lean_ctor_get(v_x_131_, 0);
            ...
            2 => {
                v_snd_144_ = lean_ctor_get(v_newState_130_, 1);
                lean_inc(v_head_133_);
                if v_isShared_137_ == 0 {
                    lean_ctor_set(v___x_136_, 1, v_fst_138_);
                    v___x_146_ = v___x_136_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_157_ = lean_alloc_ctor(1, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_157_, 0, v_head_133_);
                    lean_ctor_set(v_reuseFailAlloc_157_, 1, v_fst_138_);
            ...
            3 => {
                ...
                if v___x_147_ == 0 {
                    ...
                    if v_isShared_143_ == 0 {
                        ...
                        v_reuseFailAlloc_151_ = lean_alloc_ctor(0, 2, (0) as u32);
                        lean_ctor_set(v_reuseFailAlloc_151_, 0, v___x_146_);
                        lean_ctor_set(v_reuseFailAlloc_151_, 1, v_snd_139_);
                    ...
                    if v_isShared_143_ == 0 {
                        lean_ctor_set(v___x_142_, 1, v___x_152_);
                        lean_ctor_set(v___x_142_, 0, v___x_146_);
                        ...
                        lean_ctor_set(v_reuseFailAlloc_156_, 1, v___x_152_);
...
pub unsafe fn l_List_foldl___at___00Lean_Compiler_LCNF_mkOrderedDeclSetExt_spec__0___boxed(
    mut v_newState_163_: *mut LeanObject,
    ...
    lean_dec_ref(v_newState_163_);
    return v_res_166_;
}
pub unsafe fn l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___lam__0(
    mut v_oldState_169_: *mut LeanObject,
    mut v_newState_170_: *mut LeanObject,
    mut v_x_171_: *mut LeanObject,
    mut v_s_172_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_173_: *mut LeanObject = core::ptr::null_mut();
    let mut v_fst_174_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_newEntries_179_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_180_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_181_: *mut LeanObject = core::ptr::null_mut();
    v_fst_173_ = lean_ctor_get(v_newState_170_, 0);
    v_fst_174_ = lean_ctor_get(v_oldState_169_, 0);
    ...
    lean_dec_ref(v_newState_170_);
    return v___x_181_;
}
pub unsafe fn l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___lam__0___boxed(
    mut v_oldState_182_: *mut LeanObject,
    mut v_newState_183_: *mut LeanObject,
    mut v_x_184_: *mut LeanObject,
    mut v_s_185_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn _init_l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__1() -> *mut LeanObject {
...
pub unsafe fn _init_l_Lean_Compiler_LCNF_mkOrderedDeclSetExt___closed__2() -> *mut LeanObject {
    let mut v___x_197_: *mut LeanObject = core::ptr::null_mut();
    let mut v___f_198_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Lean_Compiler_LCNF_mkOrderedDeclSetExt() -> *mut LeanObject {
...
pub unsafe fn l_Lean_Compiler_LCNF_isDeclPublic(
    mut v_env_216_: *mut LeanObject,
    mut v_declName_217_: *mut LeanObject,
) -> u8 {
    let mut v___y_219_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_220_: *mut LeanObject = core::ptr::null_mut();
    let mut v_asyncMode_221_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_pre_230_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_isModule_228_ = lean_ctor_get_uint8(
                    v___x_227_,
                ...
                if v_isModule_228_ == 0 {
                    ...
                    if lean_obj_tag(v_declName_217_) == 1 {
                        v_pre_230_ = lean_ctor_get(v_declName_217_, 0);
                        v_str_231_ = lean_ctor_get(v_declName_217_, 1);
            ...
            1 => {
                ...
                v_asyncMode_221_ = lean_ctor_get(v___x_220_, 2);
                ...
                v_snd_225_ = lean_ctor_get(v___x_224_, 1);
                lean_inc(v_snd_225_);
                lean_dec(v___x_224_);
...
pub unsafe fn l_Lean_Compiler_LCNF_isDeclPublic___boxed(
    mut v_env_234_: *mut LeanObject,
    mut v_declName_235_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Compiler_LCNF_setDeclPublic___lam__0(
    mut v_declName_238_: *mut LeanObject,
    mut v_s_239_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_240_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_241_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_fst_240_ = lean_ctor_get(v_s_239_, 0);
                v_snd_241_ = lean_ctor_get(v_s_239_, 1);
                v_isSharedCheck_250_ = (!lean_is_exclusive(v_s_239_)) as u8;
            ...
            1 => {
                ...
                v___x_245_ = lean_alloc_ctor(1, 2, (0) as u32);
                lean_ctor_set(v___x_245_, 0, v_declName_238_);
                lean_ctor_set(v___x_245_, 1, v_fst_240_);
...
pub unsafe fn l_Lean_Compiler_LCNF_setDeclPublic(
    mut v_env_251_: *mut LeanObject,
    mut v_declName_252_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    if v___x_253_ == 0 {
        ...
        let mut v_asyncMode_255_: *mut LeanObject = core::ptr::null_mut();
        ...
        v_asyncMode_255_ = lean_ctor_get(v___x_254_, 2);
...
pub unsafe fn runtime_initialize_Lean_Compiler_LCNF_PublicDeclsExt(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Compiler_LCNF_PublicDeclsExt(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Compiler_LCNF_PublicDeclsExt(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
