...
use crate::r#gen::Lean::Server::CodeActions::Attr::{
    initialize_Lean_Server_CodeActions_Attr, runtime_initialize_Lean_Server_CodeActions_Attr,
};
...
use crate::r#gen::Lean::Server::CodeActions::Provider::{
    initialize_Lean_Server_CodeActions_Provider,
    runtime_initialize_Lean_Server_CodeActions_Provider,
};
use crate::leanh::{
...
pub unsafe fn runtime_initialize_Lean_Server_CodeActions(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Server_CodeActions(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Server_CodeActions(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
