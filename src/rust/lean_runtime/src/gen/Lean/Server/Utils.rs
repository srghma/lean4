...
use crate::leanh::{
    ...
    lean_apply_2, lean_box, lean_box_usize, lean_closure_set, lean_ctor_get, lean_ctor_set,
...
pub static l_Lean_Server_instInhabitedDocumentMeta_default___closed__0_value: LeanStringObject<1> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_Server_instInhabitedDocumentMeta_default___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Server_instInhabitedDocumentMeta_default___closed__0_value)
        as *mut LeanObject;
static mut l_Lean_Server_instInhabitedDocumentMeta_default___closed__1_once: LeanOnceCell =
    LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Lean_Server_instInhabitedDocumentMeta_default___closed__1: *mut LeanObject =
    core::ptr::null_mut();
pub static mut l_Lean_Server_instInhabitedDocumentMeta_default: *mut LeanObject =
    core::ptr::null_mut();
pub static mut l_Lean_Server_instInhabitedDocumentMeta: *mut LeanObject = core::ptr::null_mut();
pub static l_Lean_Server_mkPublishDiagnosticsNotification___closed__0_value: LeanStringObject<32> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
        ...
        m_length: 31,
        m_data: [
            116, 101, 120, 116, 68, 111, 99, 117, 109, 101, 110, 116, 47, 112, 117, 98, 108, 105,
            115, 104, 68, 105, 97, 103, 110, 111, 115, 116, 105, 99, 115, 0,
        ],
    };
static mut l_Lean_Server_mkPublishDiagnosticsNotification___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Server_mkPublishDiagnosticsNotification___closed__0_value)
        as *mut LeanObject;
pub static l_Lean_Server_mkFileProgressNotification___closed__0_value: LeanStringObject<20> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
        ...
        m_length: 19,
        m_data: [
            36, 47, 108, 101, 97, 110, 47, 102, 105, 108, 101, 80, 114, 111, 103, 114, 101, 115,
            115, 0,
        ],
    };
static mut l_Lean_Server_mkFileProgressNotification___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Server_mkFileProgressNotification___closed__0_value)
        as *mut LeanObject;
pub static l_Lean_Server_mkFileProgressDoneNotification___closed__0_value: LeanArrayObject<0> =
    LeanArrayObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_Lean_Server_mkFileProgressDoneNotification___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Server_mkFileProgressDoneNotification___closed__0_value)
        as *mut LeanObject;
pub static l_Lean_Server_mkApplyWorkspaceEditRequest___closed__0_value: LeanStringObject<20> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
        ...
        m_length: 19,
        m_data: [
            119, 111, 114, 107, 115, 112, 97, 99, 101, 47, 97, 112, 112, 108, 121, 69, 100, 105,
            116, 0,
        ],
    };
static mut l_Lean_Server_mkApplyWorkspaceEditRequest___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Server_mkApplyWorkspaceEditRequest___closed__0_value)
        as *mut LeanObject;
pub static l_Lean_Server_mkApplyWorkspaceEditRequest___closed__1_value: LeanCtorObject<1> =
    LeanCtorObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lean_Server_mkApplyWorkspaceEditRequest___closed__1: *mut LeanObject =
...
static mut l_String_dropPrefix_x3f___at___00__private_Lean_Server_Utils_0__Lean_Server_externalNameToUri_x3f_spec__0___redArg___closed__0_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
static mut l_String_dropPrefix_x3f___at___00__private_Lean_Server_Utils_0__Lean_Server_externalNameToUri_x3f_spec__0___redArg___closed__0: *mut LeanObject = core::ptr::null_mut();
pub static l_Lean_Server_documentUriFromModule_x3f___closed__0_value: LeanStringObject<5> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_Server_documentUriFromModule_x3f___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Server_documentUriFromModule_x3f___closed__0_value)
        as *mut LeanObject;
pub static l_Lean_Server_moduleFromDocumentUri___closed__0_value: LeanCtorObject<1> =
    LeanCtorObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lean_Server_moduleFromDocumentUri___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Server_moduleFromDocumentUri___closed__0_value) as *mut LeanObject;
pub unsafe fn l_IO_throwServerError___redArg(mut v_err_595_: *mut LeanObject) -> *mut LeanObject {
    ...
    v___x_598_ = lean_alloc_ctor(1, 1, (0) as u32);
    lean_ctor_set(v___x_598_, 0, v___x_597_);
    return v___x_598_;
}
pub unsafe fn l_IO_throwServerError___redArg___boxed(
    mut v_err_599_: *mut LeanObject,
...
pub unsafe fn l_IO_FS_Stream_chainRight___lam__0(
    mut v_read_610_: *mut LeanObject,
    ...
    let mut v_flush_618_: *mut LeanObject = core::ptr::null_mut();
    let mut v_write_619_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v___x_615_ = lean_box_usize(v_sz_613_);
                v___x_616_ = lean_apply_2(v_read_610_, v___x_615_, lean_box(0));
                if lean_obj_tag(v___x_616_) == 0 {
                    v_a_617_ = lean_ctor_get(v___x_616_, 0);
                    lean_inc_n(v_a_617_, 2);
                    lean_dec_ref_known(v___x_616_, 1);
                    v_flush_618_ = lean_ctor_get(v_b_611_, 0);
                    lean_inc_ref(v_flush_618_);
                    v_write_619_ = lean_ctor_get(v_b_611_, 2);
                    lean_inc_ref(v_write_619_);
                    lean_dec_ref(v_b_611_);
                    v___x_620_ = lean_apply_2(v_write_619_, v_a_617_, lean_box(0));
                    if lean_obj_tag(v___x_620_) == 0 {
                        v_isSharedCheck_644_ = (!lean_is_exclusive(v___x_620_)) as u8;
                        if v_isSharedCheck_644_ == 0 {
                            v_unused_645_ = lean_ctor_get(v___x_620_, 0);
                        ...
                        lean_dec_ref(v_flush_618_);
                        lean_dec(v_a_617_);
                        v_a_646_ = lean_ctor_get(v___x_620_, 0);
                        v_isSharedCheck_653_ = (!lean_is_exclusive(v___x_620_)) as u8;
            ...
            1 => {
                if v_flushEagerly_612_ == 0 {
                    ...
                    if v_isShared_623_ == 0 {
                        ...
                        lean_ctor_set(v_reuseFailAlloc_626_, 0, v_a_617_);
                    ...
                    v___x_627_ = lean_apply_1(v_flush_618_, lean_box(0));
                    if lean_obj_tag(v___x_627_) == 0 {
                        v_isSharedCheck_634_ = (!lean_is_exclusive(v___x_627_)) as u8;
                        ...
                        v_isSharedCheck_643_ = (!lean_is_exclusive(v___x_627_)) as u8;
            ...
            3 => {
                if v_isShared_630_ == 0 {
                    ...
                    v_reuseFailAlloc_633_ = lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_IO_FS_Stream_chainRight___lam__0___boxed(
    mut v_read_654_: *mut LeanObject,
    mut v_b_655_: *mut LeanObject,
    mut v_flushEagerly_656_: *mut LeanObject,
    mut v_sz_657_: *mut LeanObject,
    ...
    v_flushEagerly_boxed_659_ = (lean_unbox(v_flushEagerly_656_) as u8);
...
pub unsafe fn l_IO_FS_Stream_chainRight___lam__1(
    mut v_getLine_662_: *mut LeanObject,
    mut v_b_663_: *mut LeanObject,
    mut v_flushEagerly_664_: u8,
) -> *mut LeanObject {
    let mut v___x_666_: *mut LeanObject = core::ptr::null_mut();
    let mut v_a_667_: *mut LeanObject = core::ptr::null_mut();
    let mut v_flush_668_: *mut LeanObject = core::ptr::null_mut();
    let mut v_putStr_669_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v___x_666_ = lean_apply_1(v_getLine_662_, lean_box(0));
                if lean_obj_tag(v___x_666_) == 0 {
                    v_a_667_ = lean_ctor_get(v___x_666_, 0);
                    lean_inc_n(v_a_667_, 2);
                    lean_dec_ref_known(v___x_666_, 1);
                    v_flush_668_ = lean_ctor_get(v_b_663_, 0);
                    lean_inc_ref(v_flush_668_);
                    v_putStr_669_ = lean_ctor_get(v_b_663_, 4);
                    lean_inc_ref(v_putStr_669_);
                    lean_dec_ref(v_b_663_);
                    v___x_670_ = lean_apply_2(v_putStr_669_, v_a_667_, lean_box(0));
                    if lean_obj_tag(v___x_670_) == 0 {
                        v_isSharedCheck_694_ = (!lean_is_exclusive(v___x_670_)) as u8;
                        if v_isSharedCheck_694_ == 0 {
                            v_unused_695_ = lean_ctor_get(v___x_670_, 0);
                        ...
                        lean_dec_ref(v_flush_668_);
                        lean_dec(v_a_667_);
                        v_a_696_ = lean_ctor_get(v___x_670_, 0);
                        v_isSharedCheck_703_ = (!lean_is_exclusive(v___x_670_)) as u8;
            ...
            1 => {
                if v_flushEagerly_664_ == 0 {
                    ...
                    if v_isShared_673_ == 0 {
                        ...
                        lean_ctor_set(v_reuseFailAlloc_676_, 0, v_a_667_);
                    ...
                    v___x_677_ = lean_apply_1(v_flush_668_, lean_box(0));
                    if lean_obj_tag(v___x_677_) == 0 {
                        v_isSharedCheck_684_ = (!lean_is_exclusive(v___x_677_)) as u8;
                        if v_isSharedCheck_684_ == 0 {
                            v_unused_685_ = lean_ctor_get(v___x_677_, 0);
                        ...
                        v_isSharedCheck_693_ = (!lean_is_exclusive(v___x_677_)) as u8;
            ...
            3 => {
                if v_isShared_680_ == 0 {
                    lean_ctor_set(v___x_679_, 0, v_a_667_);
                    v___x_682_ = v___x_679_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_683_ = lean_alloc_ctor(0, 1, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_683_, 0, v_a_667_);
...
pub unsafe fn l_IO_FS_Stream_chainRight___lam__1___boxed(
    mut v_getLine_704_: *mut LeanObject,
    mut v_b_705_: *mut LeanObject,
    mut v_flushEagerly_706_: *mut LeanObject,
    mut v___y_707_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_flushEagerly_boxed_708_: u8 = 0;
    let mut v_res_709_: *mut LeanObject = core::ptr::null_mut();
    v_flushEagerly_boxed_708_ = (lean_unbox(v_flushEagerly_706_) as u8);
    v_res_709_ =
...
pub unsafe fn l_IO_FS_Stream_chainRight___lam__2(
    mut v_flush_710_: *mut LeanObject,
    mut v_b_711_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_713_: *mut LeanObject = core::ptr::null_mut();
    v___x_713_ = lean_apply_1(v_flush_710_, lean_box(0));
    if lean_obj_tag(v___x_713_) == 0 {
        let mut v_flush_714_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_715_: *mut LeanObject = core::ptr::null_mut();
        lean_dec_ref_known(v___x_713_, 1);
        v_flush_714_ = lean_ctor_get(v_b_711_, 0);
        lean_inc_ref(v_flush_714_);
        lean_dec_ref(v_b_711_);
        v___x_715_ = lean_apply_1(v_flush_714_, lean_box(0));
        return v___x_715_;
    } else {
        lean_dec_ref(v_b_711_);
        return v___x_713_;
...
pub unsafe fn l_IO_FS_Stream_chainRight___lam__2___boxed(
    mut v_flush_716_: *mut LeanObject,
...
pub unsafe fn l_IO_FS_Stream_chainRight(
    ...
    let mut v_flush_723_: *mut LeanObject = core::ptr::null_mut();
    let mut v_read_724_: *mut LeanObject = core::ptr::null_mut();
    let mut v_write_725_: *mut LeanObject = core::ptr::null_mut();
    let mut v_getLine_726_: *mut LeanObject = core::ptr::null_mut();
    let mut v_putStr_727_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isTty_728_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_flush_723_ = lean_ctor_get(v_a_720_, 0);
                v_read_724_ = lean_ctor_get(v_a_720_, 1);
                v_write_725_ = lean_ctor_get(v_a_720_, 2);
                v_getLine_726_ = lean_ctor_get(v_a_720_, 3);
                v_putStr_727_ = lean_ctor_get(v_a_720_, 4);
                v_isTty_728_ = lean_ctor_get(v_a_720_, 5);
                v_isSharedCheck_740_ = (!lean_is_exclusive(v_a_720_)) as u8;
                if v_isSharedCheck_740_ == 0 {
                    ...
                    lean_inc(v_isTty_728_);
                    lean_inc(v_putStr_727_);
                    lean_inc(v_getLine_726_);
                    lean_inc(v_write_725_);
                    lean_inc(v_read_724_);
                    lean_inc(v_flush_723_);
                    lean_dec(v_a_720_);
            ...
            1 => {
                v___x_732_ = lean_box((v_flushEagerly_722_) as usize);
                lean_inc_ref_n(v_b_721_, 2);
                v___f_733_ = lean_alloc_closure(
                    l_IO_FS_Stream_chainRight___lam__0___boxed as *mut core::ffi::c_void,
                    5,
                    3,
                );
                lean_closure_set(v___f_733_, 0, v_read_724_);
                lean_closure_set(v___f_733_, 1, v_b_721_);
                lean_closure_set(v___f_733_, 2, v___x_732_);
                v___x_734_ = lean_box((v_flushEagerly_722_) as usize);
                v___f_735_ = lean_alloc_closure(
                    l_IO_FS_Stream_chainRight___lam__1___boxed as *mut core::ffi::c_void,
                    4,
                    3,
                );
                lean_closure_set(v___f_735_, 0, v_getLine_726_);
                lean_closure_set(v___f_735_, 1, v_b_721_);
                ...
                lean_closure_set(v___f_736_, 0, v_flush_723_);
                lean_closure_set(v___f_736_, 1, v_b_721_);
                if v_isShared_731_ == 0 {
                    lean_ctor_set(v___x_730_, 3, v___f_735_);
                    lean_ctor_set(v___x_730_, 1, v___f_733_);
                    lean_ctor_set(v___x_730_, 0, v___f_736_);
                    v___x_738_ = v___x_730_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_739_ = lean_alloc_ctor(0, 6, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_739_, 0, v___f_736_);
                    lean_ctor_set(v_reuseFailAlloc_739_, 1, v___f_733_);
                    lean_ctor_set(v_reuseFailAlloc_739_, 2, v_write_725_);
                    lean_ctor_set(v_reuseFailAlloc_739_, 3, v___f_735_);
                    lean_ctor_set(v_reuseFailAlloc_739_, 4, v_putStr_727_);
                    lean_ctor_set(v_reuseFailAlloc_739_, 5, v_isTty_728_);
...
pub unsafe fn l_IO_FS_Stream_chainRight___boxed(
    ...
    mut v_flushEagerly_743_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_flushEagerly_boxed_744_: u8 = 0;
    let mut v_res_745_: *mut LeanObject = core::ptr::null_mut();
    v_flushEagerly_boxed_744_ = (lean_unbox(v_flushEagerly_743_) as u8);
...
pub unsafe fn l_IO_FS_Stream_chainLeft___lam__0(
    mut v_flush_746_: *mut LeanObject,
    mut v_flush_747_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_749_: *mut LeanObject = core::ptr::null_mut();
    v___x_749_ = lean_apply_1(v_flush_746_, lean_box(0));
    if lean_obj_tag(v___x_749_) == 0 {
        let mut v___x_750_: *mut LeanObject = core::ptr::null_mut();
        lean_dec_ref_known(v___x_749_, 1);
        v___x_750_ = lean_apply_1(v_flush_747_, lean_box(0));
        return v___x_750_;
    } else {
        lean_dec_ref(v_flush_747_);
        return v___x_749_;
    }
}
pub unsafe fn l_IO_FS_Stream_chainLeft___lam__0___boxed(
    mut v_flush_751_: *mut LeanObject,
    mut v_flush_752_: *mut LeanObject,
...
pub unsafe fn l_IO_FS_Stream_chainLeft___lam__1(
    mut v_write_755_: *mut LeanObject,
    mut v_flushEagerly_756_: u8,
    mut v_write_757_: *mut LeanObject,
    mut v_flush_758_: *mut LeanObject,
    mut v_bs_759_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_761_: *mut LeanObject = core::ptr::null_mut();
    lean_inc_ref(v_bs_759_);
    v___x_761_ = lean_apply_2(v_write_755_, v_bs_759_, lean_box(0));
    if lean_obj_tag(v___x_761_) == 0 {
        lean_dec_ref_known(v___x_761_, 1);
        if v_flushEagerly_756_ == 0 {
            let mut v___x_762_: *mut LeanObject = core::ptr::null_mut();
            lean_dec_ref(v_flush_758_);
            v___x_762_ = lean_apply_2(v_write_757_, v_bs_759_, lean_box(0));
            return v___x_762_;
        } else {
            let mut v___x_763_: *mut LeanObject = core::ptr::null_mut();
            v___x_763_ = lean_apply_1(v_flush_758_, lean_box(0));
            if lean_obj_tag(v___x_763_) == 0 {
                let mut v___x_764_: *mut LeanObject = core::ptr::null_mut();
                lean_dec_ref_known(v___x_763_, 1);
                v___x_764_ = lean_apply_2(v_write_757_, v_bs_759_, lean_box(0));
                return v___x_764_;
            } else {
                lean_dec_ref(v_bs_759_);
                lean_dec_ref(v_write_757_);
                return v___x_763_;
            }
        }
    } else {
...
pub unsafe fn l_IO_FS_Stream_chainLeft___lam__1___boxed(
    mut v_write_765_: *mut LeanObject,
    mut v_flushEagerly_766_: *mut LeanObject,
    mut v_write_767_: *mut LeanObject,
    mut v_flush_768_: *mut LeanObject,
    ...
    v_flushEagerly_boxed_771_ = (lean_unbox(v_flushEagerly_766_) as u8);
...
pub unsafe fn l_IO_FS_Stream_chainLeft___lam__2(
    mut v_putStr_773_: *mut LeanObject,
    mut v_flushEagerly_774_: u8,
    mut v_putStr_775_: *mut LeanObject,
    mut v_flush_776_: *mut LeanObject,
    mut v_s_777_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_779_: *mut LeanObject = core::ptr::null_mut();
    lean_inc_ref(v_s_777_);
    v___x_779_ = lean_apply_2(v_putStr_773_, v_s_777_, lean_box(0));
    if lean_obj_tag(v___x_779_) == 0 {
        lean_dec_ref_known(v___x_779_, 1);
        if v_flushEagerly_774_ == 0 {
            let mut v___x_780_: *mut LeanObject = core::ptr::null_mut();
            lean_dec_ref(v_flush_776_);
            v___x_780_ = lean_apply_2(v_putStr_775_, v_s_777_, lean_box(0));
            return v___x_780_;
        } else {
            let mut v___x_781_: *mut LeanObject = core::ptr::null_mut();
            v___x_781_ = lean_apply_1(v_flush_776_, lean_box(0));
            if lean_obj_tag(v___x_781_) == 0 {
                let mut v___x_782_: *mut LeanObject = core::ptr::null_mut();
                lean_dec_ref_known(v___x_781_, 1);
                v___x_782_ = lean_apply_2(v_putStr_775_, v_s_777_, lean_box(0));
                return v___x_782_;
            } else {
                lean_dec_ref(v_s_777_);
                lean_dec_ref(v_putStr_775_);
                return v___x_781_;
            }
        }
    } else {
...
pub unsafe fn l_IO_FS_Stream_chainLeft___lam__2___boxed(
    mut v_putStr_783_: *mut LeanObject,
    mut v_flushEagerly_784_: *mut LeanObject,
    mut v_putStr_785_: *mut LeanObject,
    mut v_flush_786_: *mut LeanObject,
    mut v_s_787_: *mut LeanObject,
    mut v___y_788_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_flushEagerly_boxed_789_: u8 = 0;
    let mut v_res_790_: *mut LeanObject = core::ptr::null_mut();
    v_flushEagerly_boxed_789_ = (lean_unbox(v_flushEagerly_784_) as u8);
...
pub unsafe fn l_IO_FS_Stream_chainLeft(
    ...
    mut v_b_792_: *mut LeanObject,
    mut v_flushEagerly_793_: u8,
) -> *mut LeanObject {
    let mut v_flush_794_: *mut LeanObject = core::ptr::null_mut();
    let mut v_write_795_: *mut LeanObject = core::ptr::null_mut();
    let mut v_putStr_796_: *mut LeanObject = core::ptr::null_mut();
    let mut v_flush_797_: *mut LeanObject = core::ptr::null_mut();
    let mut v_read_798_: *mut LeanObject = core::ptr::null_mut();
    let mut v_write_799_: *mut LeanObject = core::ptr::null_mut();
    let mut v_getLine_800_: *mut LeanObject = core::ptr::null_mut();
    let mut v_putStr_801_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isTty_802_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_flush_794_ = lean_ctor_get(v_a_791_, 0);
                lean_inc_ref(v_flush_794_);
                v_write_795_ = lean_ctor_get(v_a_791_, 2);
                lean_inc_ref(v_write_795_);
                v_putStr_796_ = lean_ctor_get(v_a_791_, 4);
                lean_inc_ref(v_putStr_796_);
                lean_dec_ref(v_a_791_);
                v_flush_797_ = lean_ctor_get(v_b_792_, 0);
                v_read_798_ = lean_ctor_get(v_b_792_, 1);
                v_write_799_ = lean_ctor_get(v_b_792_, 2);
                v_getLine_800_ = lean_ctor_get(v_b_792_, 3);
                v_putStr_801_ = lean_ctor_get(v_b_792_, 4);
                v_isTty_802_ = lean_ctor_get(v_b_792_, 5);
                v_isSharedCheck_814_ = (!lean_is_exclusive(v_b_792_)) as u8;
                if v_isSharedCheck_814_ == 0 {
                    ...
                    lean_inc(v_isTty_802_);
                    lean_inc(v_putStr_801_);
                    lean_inc(v_getLine_800_);
                    lean_inc(v_write_799_);
                    lean_inc(v_read_798_);
                    lean_inc(v_flush_797_);
                    lean_dec(v_b_792_);
            ...
            1 => {
                lean_inc_ref_n(v_flush_794_, 2);
                v___f_806_ = lean_alloc_closure(
                    l_IO_FS_Stream_chainLeft___lam__0___boxed as *mut core::ffi::c_void,
                    3,
                    2,
                );
                lean_closure_set(v___f_806_, 0, v_flush_794_);
                lean_closure_set(v___f_806_, 1, v_flush_797_);
                v___x_807_ = lean_box((v_flushEagerly_793_) as usize);
                v___f_808_ = lean_alloc_closure(
                    l_IO_FS_Stream_chainLeft___lam__1___boxed as *mut core::ffi::c_void,
                    6,
                    4,
                );
                lean_closure_set(v___f_808_, 0, v_write_795_);
                lean_closure_set(v___f_808_, 1, v___x_807_);
                lean_closure_set(v___f_808_, 2, v_write_799_);
                lean_closure_set(v___f_808_, 3, v_flush_794_);
                v___x_809_ = lean_box((v_flushEagerly_793_) as usize);
                v___f_810_ = lean_alloc_closure(
                    l_IO_FS_Stream_chainLeft___lam__2___boxed as *mut core::ffi::c_void,
                    6,
                    4,
                );
                lean_closure_set(v___f_810_, 0, v_putStr_796_);
                lean_closure_set(v___f_810_, 1, v___x_809_);
                lean_closure_set(v___f_810_, 2, v_putStr_801_);
                lean_closure_set(v___f_810_, 3, v_flush_794_);
                if v_isShared_805_ == 0 {
                    lean_ctor_set(v___x_804_, 4, v___f_810_);
                    lean_ctor_set(v___x_804_, 2, v___f_808_);
                    lean_ctor_set(v___x_804_, 0, v___f_806_);
                    v___x_812_ = v___x_804_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_813_ = lean_alloc_ctor(0, 6, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_813_, 0, v___f_806_);
                    lean_ctor_set(v_reuseFailAlloc_813_, 1, v_read_798_);
                    lean_ctor_set(v_reuseFailAlloc_813_, 2, v___f_808_);
                    lean_ctor_set(v_reuseFailAlloc_813_, 3, v_getLine_800_);
                    lean_ctor_set(v_reuseFailAlloc_813_, 4, v___f_810_);
                    lean_ctor_set(v_reuseFailAlloc_813_, 5, v_isTty_802_);
...
pub unsafe fn l_IO_FS_Stream_chainLeft___boxed(
    ...
    mut v_b_816_: *mut LeanObject,
    mut v_flushEagerly_817_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_flushEagerly_boxed_818_: u8 = 0;
    let mut v_res_819_: *mut LeanObject = core::ptr::null_mut();
    v_flushEagerly_boxed_818_ = (lean_unbox(v_flushEagerly_817_) as u8);
...
pub unsafe fn l_IO_FS_Stream_withPrefix___lam__0(
    mut v_putStr_820_: *mut LeanObject,
    mut v_pre_821_: *mut LeanObject,
    mut v_write_822_: *mut LeanObject,
    mut v_bs_823_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_825_: *mut LeanObject = core::ptr::null_mut();
    v___x_825_ = lean_apply_2(v_putStr_820_, v_pre_821_, lean_box(0));
    if lean_obj_tag(v___x_825_) == 0 {
        let mut v___x_826_: *mut LeanObject = core::ptr::null_mut();
        lean_dec_ref_known(v___x_825_, 1);
        v___x_826_ = lean_apply_2(v_write_822_, v_bs_823_, lean_box(0));
        return v___x_826_;
    } else {
        lean_dec_ref(v_bs_823_);
        lean_dec_ref(v_write_822_);
        return v___x_825_;
    }
}
pub unsafe fn l_IO_FS_Stream_withPrefix___lam__0___boxed(
    mut v_putStr_827_: *mut LeanObject,
    mut v_pre_828_: *mut LeanObject,
    mut v_write_829_: *mut LeanObject,
    mut v_bs_830_: *mut LeanObject,
...
pub unsafe fn l_IO_FS_Stream_withPrefix___lam__1(
    mut v_pre_833_: *mut LeanObject,
    mut v_putStr_834_: *mut LeanObject,
    ...
    v___x_838_ = lean_apply_2(v_putStr_834_, v___x_837_, lean_box(0));
    return v___x_838_;
}
pub unsafe fn l_IO_FS_Stream_withPrefix___lam__1___boxed(
    mut v_pre_839_: *mut LeanObject,
    mut v_putStr_840_: *mut LeanObject,
...
pub unsafe fn l_IO_FS_Stream_withPrefix(
    ...
    mut v_pre_845_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_flush_846_: *mut LeanObject = core::ptr::null_mut();
    let mut v_read_847_: *mut LeanObject = core::ptr::null_mut();
    let mut v_write_848_: *mut LeanObject = core::ptr::null_mut();
    let mut v_getLine_849_: *mut LeanObject = core::ptr::null_mut();
    let mut v_putStr_850_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isTty_851_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_853_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_854_: u8 = 0;
    let mut v___f_855_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_flush_846_ = lean_ctor_get(v_a_844_, 0);
                v_read_847_ = lean_ctor_get(v_a_844_, 1);
                v_write_848_ = lean_ctor_get(v_a_844_, 2);
                v_getLine_849_ = lean_ctor_get(v_a_844_, 3);
                v_putStr_850_ = lean_ctor_get(v_a_844_, 4);
                v_isTty_851_ = lean_ctor_get(v_a_844_, 5);
                v_isSharedCheck_860_ = (!lean_is_exclusive(v_a_844_)) as u8;
                if v_isSharedCheck_860_ == 0 {
                    ...
                    lean_inc(v_isTty_851_);
                    lean_inc(v_putStr_850_);
                    lean_inc(v_getLine_849_);
                    lean_inc(v_write_848_);
                    lean_inc(v_read_847_);
                    lean_inc(v_flush_846_);
                    lean_dec(v_a_844_);
            ...
            1 => {
                lean_inc_ref(v_pre_845_);
                lean_inc_ref(v_putStr_850_);
                v___f_855_ = lean_alloc_closure(
                    l_IO_FS_Stream_withPrefix___lam__0___boxed as *mut core::ffi::c_void,
                    5,
                    3,
                );
                lean_closure_set(v___f_855_, 0, v_putStr_850_);
                lean_closure_set(v___f_855_, 1, v_pre_845_);
                lean_closure_set(v___f_855_, 2, v_write_848_);
                v___f_856_ = lean_alloc_closure(
                    l_IO_FS_Stream_withPrefix___lam__1___boxed as *mut core::ffi::c_void,
                    4,
                    2,
                );
                lean_closure_set(v___f_856_, 0, v_pre_845_);
                lean_closure_set(v___f_856_, 1, v_putStr_850_);
                if v_isShared_854_ == 0 {
                    lean_ctor_set(v___x_853_, 4, v___f_856_);
                    lean_ctor_set(v___x_853_, 2, v___f_855_);
                    v___x_858_ = v___x_853_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_859_ = lean_alloc_ctor(0, 6, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_859_, 0, v_flush_846_);
                    lean_ctor_set(v_reuseFailAlloc_859_, 1, v_read_847_);
                    lean_ctor_set(v_reuseFailAlloc_859_, 2, v___f_855_);
                    lean_ctor_set(v_reuseFailAlloc_859_, 3, v_getLine_849_);
                    lean_ctor_set(v_reuseFailAlloc_859_, 4, v___f_856_);
                    lean_ctor_set(v_reuseFailAlloc_859_, 5, v_isTty_851_);
...
pub unsafe fn _init_l_Lean_Server_instInhabitedDocumentMeta_default___closed__1() -> *mut LeanObject
{
    ...
    v___x_867_ = lean_alloc_ctor(0, 4, (1) as u32);
...
pub unsafe fn _init_l_Lean_Server_instInhabitedDocumentMeta_default() -> *mut LeanObject {
...
pub unsafe fn _init_l_Lean_Server_instInhabitedDocumentMeta() -> *mut LeanObject {
...
pub unsafe fn l_Lean_Server_DocumentMeta_mkInputContext(
    mut v_doc_870_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_text_871_: *mut LeanObject = core::ptr::null_mut();
    let mut v_uri_872_: *mut LeanObject = core::ptr::null_mut();
    let mut v_source_873_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_val_879_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_text_871_ = lean_ctor_get(v_doc_870_, 3);
                lean_inc_ref(v_text_871_);
                v_uri_872_ = lean_ctor_get(v_doc_870_, 0);
                lean_inc_ref(v_uri_872_);
                lean_dec_ref(v_doc_870_);
                v_source_873_ = lean_ctor_get(v_text_871_, 0);
                lean_inc_ref(v_source_873_);
            ...
            1 => {
                ...
                v___x_877_ = lean_alloc_ctor(0, 4, (0) as u32);
                lean_ctor_set(v___x_877_, 0, v_source_873_);
                lean_ctor_set(v___x_877_, 1, v___y_875_);
                lean_ctor_set(v___x_877_, 2, v_text_871_);
...
pub unsafe fn l_Lean_Server_replaceLspRange(
    mut v_text_880_: *mut LeanObject,
    mut v_r_881_: *mut LeanObject,
    mut v_newText_882_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_start_883_: *mut LeanObject = core::ptr::null_mut();
    let mut v_end_884_: *mut LeanObject = core::ptr::null_mut();
    let mut v_source_885_: *mut LeanObject = core::ptr::null_mut();
    let mut v_start_886_: *mut LeanObject = core::ptr::null_mut();
    let mut v_end_887_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_888_: *mut LeanObject = core::ptr::null_mut();
    let mut v_pre_889_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_890_: *mut LeanObject = core::ptr::null_mut();
    let mut v_post_891_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_892_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_893_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_894_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_895_: *mut LeanObject = core::ptr::null_mut();
    v_start_883_ = lean_ctor_get(v_r_881_, 0);
    lean_inc_ref(v_start_883_);
    v_end_884_ = lean_ctor_get(v_r_881_, 1);
    lean_inc_ref(v_end_884_);
    lean_dec_ref(v_r_881_);
    v_source_885_ = lean_ctor_get(v_text_880_, 0);
...
pub unsafe fn l_Lean_Server_replaceLspRange___boxed(
    mut v_text_896_: *mut LeanObject,
    mut v_r_897_: *mut LeanObject,
    mut v_newText_898_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec_ref(v_newText_898_);
    lean_dec_ref(v_text_896_);
    return v_res_899_;
}
pub unsafe fn l_Lean_Server_applyDocumentChange(
    mut v_oldText_900_: *mut LeanObject,
    mut v_x_901_: *mut LeanObject,
) -> *mut LeanObject {
    if lean_obj_tag(v_x_901_) == 0 {
        let mut v_range_902_: *mut LeanObject = core::ptr::null_mut();
        let mut v_text_903_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_904_: *mut LeanObject = core::ptr::null_mut();
        v_range_902_ = lean_ctor_get(v_x_901_, 0);
        lean_inc_ref(v_range_902_);
        v_text_903_ = lean_ctor_get(v_x_901_, 1);
        lean_inc_ref(v_text_903_);
        lean_dec_ref_known(v_x_901_, 2);
        v___x_904_ = l_Lean_Server_replaceLspRange(v_oldText_900_, v_range_902_, v_text_903_);
        lean_dec_ref(v_text_903_);
        return v___x_904_;
    } else {
        let mut v_text_905_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_906_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_907_: *mut LeanObject = core::ptr::null_mut();
        v_text_905_ = lean_ctor_get(v_x_901_, 0);
        lean_inc_ref(v_text_905_);
        lean_dec_ref_known(v_x_901_, 1);
        v___x_906_ = l_String_crlfToLf(v_text_905_);
        lean_dec_ref(v_text_905_);
        v___x_907_ = l_String_toFileMap(v___x_906_);
        return v___x_907_;
    }
}
pub unsafe fn l_Lean_Server_applyDocumentChange___boxed(
    mut v_oldText_908_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Server_foldDocumentChanges_spec__0___boxed(
    ...
    mut v_i_922_: *mut LeanObject,
    mut v_stop_923_: *mut LeanObject,
    mut v_b_924_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Server_foldDocumentChanges(
    mut v_changes_928_: *mut LeanObject,
    mut v_oldText_929_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Server_foldDocumentChanges___boxed(
    mut v_changes_940_: *mut LeanObject,
    mut v_oldText_941_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Server_mkPublishDiagnosticsNotification(
    ...
    mut v_diagnostics_947_: *mut LeanObject,
    mut v_isIncremental_948_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_uri_949_: *mut LeanObject = core::ptr::null_mut();
    let mut v_version_950_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_uri_949_ = lean_ctor_get(v_m_946_, 0);
    lean_inc_ref(v_uri_949_);
    v_version_950_ = lean_ctor_get(v_m_946_, 2);
    lean_inc(v_version_950_);
    ...
    v___x_954_ = lean_alloc_ctor(0, 4, (0) as u32);
    lean_ctor_set(v___x_954_, 0, v_uri_949_);
    lean_ctor_set(v___x_954_, 1, v___x_953_);
    lean_ctor_set(v___x_954_, 2, v_isIncremental_948_);
    lean_ctor_set(v___x_954_, 3, v_diagnostics_947_);
...
pub unsafe fn l_Lean_Server_mkFileProgressNotification(
    mut v_m_957_: *mut LeanObject,
    mut v_processing_958_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_uri_959_: *mut LeanObject = core::ptr::null_mut();
    let mut v_version_960_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_uri_959_ = lean_ctor_get(v_m_957_, 0);
    v_version_960_ = lean_ctor_get(v_m_957_, 2);
    v___x_961_ = l_Lean_Server_mkFileProgressNotification___closed__0;
    lean_inc(v_version_960_);
    v___x_962_ = lean_alloc_ctor(1, 1, (0) as u32);
    lean_ctor_set(v___x_962_, 0, v_version_960_);
    lean_inc_ref(v_uri_959_);
    v___x_963_ = lean_alloc_ctor(0, 2, (0) as u32);
    lean_ctor_set(v___x_963_, 0, v_uri_959_);
    lean_ctor_set(v___x_963_, 1, v___x_962_);
    v___x_964_ = lean_alloc_ctor(0, 2, (0) as u32);
    lean_ctor_set(v___x_964_, 0, v___x_963_);
    lean_ctor_set(v___x_964_, 1, v_processing_958_);
...
pub unsafe fn l_Lean_Server_mkFileProgressNotification___boxed(
    mut v_m_966_: *mut LeanObject,
    mut v_processing_967_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Server_mkFileProgressAtPosNotification(
    mut v_m_969_: *mut LeanObject,
    mut v_pos_970_: *mut LeanObject,
    mut v_kind_971_: u8,
) -> *mut LeanObject {
    let mut v_text_972_: *mut LeanObject = core::ptr::null_mut();
    let mut v_source_973_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_text_972_ = lean_ctor_get(v_m_969_, 3);
    v_source_973_ = lean_ctor_get(v_text_972_, 0);
    lean_inc_ref_n(v_text_972_, 2);
    ...
    v___x_978_ = lean_alloc_ctor(0, 1, (1) as u32);
...
pub unsafe fn l_Lean_Server_mkFileProgressAtPosNotification___boxed(
    ...
    mut v_pos_984_: *mut LeanObject,
    mut v_kind_985_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_kind_boxed_986_: u8 = 0;
    let mut v_res_987_: *mut LeanObject = core::ptr::null_mut();
    v_kind_boxed_986_ = (lean_unbox(v_kind_985_) as u8);
    v_res_987_ =
...
pub unsafe fn l_Lean_Server_mkApplyWorkspaceEditRequest(
    mut v_params_998_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Lean_Server_Utils_0__Lean_Server_externalUriToName___boxed(
    mut v_uri_1008_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_String_dropPrefix_x3f___at___00__private_Lean_Server_Utils_0__Lean_Server_externalNameToUri_x3f_spec__0___redArg(
    ...
    if v___x_1016_ == 0 {
        ...
        v___x_1018_ = lean_unsigned_to_nat(0);
        ...
        if v___x_1019_ == 0 {
            ...
            lean_inc_ref(v_s_1012_);
            v___x_1021_ = lean_alloc_ctor(0, 3, (0) as u32);
            lean_ctor_set(v___x_1021_, 0, v_s_1012_);
            ...
            v___x_1023_ = lean_alloc_ctor(0, 3, (0) as u32);
            lean_ctor_set(v___x_1023_, 0, v_s_1012_);
            lean_ctor_set(v___x_1023_, 1, v___x_1022_);
            lean_ctor_set(v___x_1023_, 2, v___x_1014_);
...
pub unsafe fn l_String_dropPrefix_x3f___at___00__private_Lean_Server_Utils_0__Lean_Server_externalNameToUri_x3f_spec__0(
    mut v_s_1025_: *mut LeanObject,
    mut v_pat_1026_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_String_dropPrefix_x3f___at___00__private_Lean_Server_Utils_0__Lean_Server_externalNameToUri_x3f_spec__0___boxed(
    ...
    mut v_pat_1029_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Lean_Server_Utils_0__Lean_Server_externalNameToUri_x3f(
    ...
    loop {
        match state {
            0 => {
                if lean_obj_tag(v_name_1031_) == 1 {
                    v_pre_1032_ = lean_ctor_get(v_name_1031_, 0);
                    if lean_obj_tag(v_pre_1032_) == 0 {
                        v_str_1033_ = lean_ctor_get(v_name_1031_, 1);
                        lean_inc_ref(v_str_1033_);
                        lean_dec_ref_known(v_name_1031_, 2);
                        ...
                        if lean_obj_tag(v___x_1034_) == 0 {
                            ...
                            v_isSharedCheck_1044_ = (!lean_is_exclusive(v___x_1034_)) as u8;
...
pub unsafe fn l_Lean_Server_documentUriFromModule_x3f(
    mut v_modName_1048_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    let mut v_val_1060_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
                ...
                if lean_obj_tag(v___x_1050_) == 1 {
                    ...
                    if lean_obj_tag(v___x_1052_) == 0 {
                        ...
                        if lean_obj_tag(v___x_1055_) == 0 {
                            ...
                            v_isSharedCheck_1090_ = (!lean_is_exclusive(v___x_1055_)) as u8;
                            ...
                            v_isSharedCheck_1098_ = (!lean_is_exclusive(v___x_1055_)) as u8;
                        ...
                        v_isSharedCheck_1106_ = (!lean_is_exclusive(v___x_1052_)) as u8;
            ...
            1 => {
                if lean_obj_tag(v_a_1056_) == 1 {
                    ...
                    v_isSharedCheck_1085_ = (!lean_is_exclusive(v_a_1056_)) as u8;
                    ...
                    if v_isShared_1059_ == 0 {
                        ...
                        v_reuseFailAlloc_1089_ = lean_alloc_ctor(0, 1, (0) as u32);
            ...
            2 => {
                ...
                if lean_obj_tag(v___x_1064_) == 0 {
                    ...
                    v_isSharedCheck_1076_ = (!lean_is_exclusive(v___x_1064_)) as u8;
                    ...
                    v_isSharedCheck_1084_ = (!lean_is_exclusive(v___x_1064_)) as u8;
...
pub unsafe fn l_Lean_Server_documentUriFromModule_x3f___boxed(
    mut v_modName_1107_: *mut LeanObject,
...
pub unsafe fn l_Option_instBEq_beq___at___00Lean_Server_moduleFromDocumentUri_spec__0(
    ...
    if lean_obj_tag(v_x_1110_) == 0 {
        ...
        if lean_obj_tag(v_x_1111_) == 0 {
            ...
            v_val_1115_ = lean_ctor_get(v_x_1110_, 0);
            v_val_1116_ = lean_ctor_get(v_x_1111_, 0);
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_1126_) == 1 {
                    ...
                    v_isSharedCheck_1170_ = (!lean_is_exclusive(v___x_1126_)) as u8;
                ...
                if v___x_1133_ == 0 {
                    ...
                    if lean_obj_tag(v___x_1138_) == 0 {
                        ...
                        if lean_obj_tag(v___x_1140_) == 0 {
                            ...
                            v_isSharedCheck_1153_ = (!lean_is_exclusive(v___x_1140_)) as u8;
                            ...
                            v_isSharedCheck_1161_ = (!lean_is_exclusive(v___x_1140_)) as u8;
                        ...
                        v_isSharedCheck_1169_ = (!lean_is_exclusive(v___x_1138_)) as u8;
            ...
            3 => {
                if lean_obj_tag(v_a_1141_) == 1 {
                    v_val_1145_ = lean_ctor_get(v_a_1141_, 0);
                    lean_inc(v_val_1145_);
                    lean_dec_ref_known(v_a_1141_, 1);
                    if v_isShared_1144_ == 0 {
                        lean_ctor_set(v___x_1143_, 0, v_val_1145_);
                        v___x_1147_ = v___x_1143_;
                        state = 4;
                        continue;
                    } else {
                        v_reuseFailAlloc_1148_ = lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_Server_moduleFromDocumentUri___boxed(
    mut v_uri_1173_: *mut LeanObject,
    ...
    lean_dec_ref(v_uri_1173_);
    return v_res_1175_;
}
pub unsafe fn l_Lean_Syntax_Range_toLspRange(
    mut v_text_1176_: *mut LeanObject,
    mut v_r_1177_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_start_1178_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stop_1179_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_start_1178_ = lean_ctor_get(v_r_1177_, 0);
                v_stop_1179_ = lean_ctor_get(v_r_1177_, 1);
                v_isSharedCheck_1188_ = (!lean_is_exclusive(v_r_1177_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_1182_ == 0 {
                    ...
                    v_reuseFailAlloc_1187_ = lean_alloc_ctor(0, 2, (0) as u32);
...
pub unsafe fn runtime_initialize_Lean_Server_Utils(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Server_Utils(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Server_Utils(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
