...
static mut l_Lean_sortExprs___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_sortExprs___closed__0: *mut LeanObject = core::ptr::null_mut();
static mut l_Lean_sortExprs___closed__1_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_sortExprs___closed__1: *mut LeanObject = core::ptr::null_mut();
static mut l_Lean_sortExprs___closed__2_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_sortExprs___closed__2: *mut LeanObject = core::ptr::null_mut();
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_sortExprs_spec__1(
    mut v_sz_533_: usize,
    mut v_i_534_: usize,
    mut v_bs_535_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_536_: u8 = 0;
    let mut v_v_537_: *mut LeanObject = core::ptr::null_mut();
    let mut v_fst_538_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_539_: *mut LeanObject = core::ptr::null_mut();
    let mut v_bs_x27_540_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_536_ == 0 {
                    ...
                    v_fst_538_ = lean_ctor_get(v_v_537_, 0);
                    lean_inc(v_fst_538_);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_sortExprs_spec__1___boxed(
    mut v_sz_545_: *mut LeanObject,
    mut v_i_546_: *mut LeanObject,
    mut v_bs_547_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__4_spec__7___redArg(
    mut v_hi_560_: *mut LeanObject,
    mut v_pivot_561_: *mut LeanObject,
    mut v_as_562_: *mut LeanObject,
    mut v_i_563_: *mut LeanObject,
    mut v_k_564_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    let mut v_fst_569_: *mut LeanObject = core::ptr::null_mut();
    let mut v_fst_570_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_565_ == 0 {
                    ...
                    v___x_567_ = lean_alloc_ctor(0, 2, (0) as u32);
                    ...
                    v_fst_570_ = lean_ctor_get(v_pivot_561_, 0);
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__4_spec__7___redArg___boxed(
    mut v_hi_580_: *mut LeanObject,
    mut v_pivot_581_: *mut LeanObject,
    mut v_as_582_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__4___redArg(
    mut v_n_586_: *mut LeanObject,
    mut v_as_587_: *mut LeanObject,
    mut v_lo_588_: *mut LeanObject,
    mut v_hi_589_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___y_591_: *mut LeanObject = core::ptr::null_mut();
    let mut v_pivot_592_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_mid_604_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_601_ == 0 {
                    ...
                    v___x_603_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_replace___at___00Std_DHashMap_Internal_Raw_u2080_insert___at___00Lean_sortExprs_spec__0_spec__2___redArg(
    ...
    let mut v_key_629_: *mut LeanObject = core::ptr::null_mut();
    let mut v_value_630_: *mut LeanObject = core::ptr::null_mut();
    let mut v_tail_631_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if lean_obj_tag(v_x_628_) == 0 {
                    ...
                    v_isSharedCheck_643_ = (!lean_is_exclusive(v_x_628_)) as u8;
            ...
            1 => {
                ...
                if v___x_635_ == 0 {
                    ...
                    if v_isShared_634_ == 0 {
                        ...
                        v_reuseFailAlloc_639_ = lean_alloc_ctor(1, 3, (0) as u32);
                    ...
                    if v_isShared_634_ == 0 {
                        ...
                        v_reuseFailAlloc_642_ = lean_alloc_ctor(1, 3, (0) as u32);
        ...
        match state {
            0 => {
                if lean_obj_tag(v_x_645_) == 0 {
                    ...
                    v_isSharedCheck_671_ = (!lean_is_exclusive(v_x_645_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_651_ == 0 {
                    ...
                    v_reuseFailAlloc_670_ = lean_alloc_ctor(1, 3, (0) as u32);
...
pub unsafe fn l___private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insert___at___00Lean_sortExprs_spec__0_spec__1_spec__2___redArg(
    ...
    mut v_source_673_: *mut LeanObject,
    mut v_target_674_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_675_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_676_: u8 = 0;
    let mut v_es_677_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_678_: *mut LeanObject = core::ptr::null_mut();
    let mut v_source_679_: *mut LeanObject = core::ptr::null_mut();
    let mut v_target_680_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insert___at___00Lean_sortExprs_spec__0_spec__1___redArg(
    ...
    v___x_686_ = lean_unsigned_to_nat(2);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_insert___at___00Lean_sortExprs_spec__0___redArg(
    ...
    let mut v_size_706_: *mut LeanObject = core::ptr::null_mut();
    let mut v_buckets_707_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_bkt_724_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_buckets_x27_744_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_isSharedCheck_750_ = (!lean_is_exclusive(v_m_703_)) as u8;
            ...
            1 => {
                ...
                if v___x_725_ == 0 {
                    ...
                    lean_ctor_set(v___x_728_, 2, v_bkt_724_);
                    ...
                    if v___x_735_ == 0 {
                        ...
                        if v_isShared_710_ == 0 {
                            lean_ctor_set(v___x_709_, 1, v_val_736_);
                            lean_ctor_set(v___x_709_, 0, v_size_x27_727_);
                        ...
                        if v_isShared_710_ == 0 {
                            lean_ctor_set(v___x_709_, 1, v_buckets_x27_729_);
                            lean_ctor_set(v___x_709_, 0, v_size_x27_727_);
                    ...
                    if v_isShared_710_ == 0 {
                        lean_ctor_set(v___x_709_, 1, v___x_746_);
                        v___x_748_ = v___x_709_;
                        state = 4;
                        continue;
                    } else {
                        v_reuseFailAlloc_749_ = lean_alloc_ctor(0, 2, (0) as u32);
                        lean_ctor_set(v_reuseFailAlloc_749_, 0, v_size_706_);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_sortExprs_spec__2(
    ...
    let mut v_fst_756_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_757_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_755_ == 0 {
                    v_fst_756_ = lean_ctor_get(v_b_754_, 0);
                    lean_inc(v_fst_756_);
                    v_snd_757_ = lean_ctor_get(v_b_754_, 1);
                    lean_inc(v_snd_757_);
                    lean_dec_ref(v_b_754_);
                    v___x_758_ = lean_array_uget(v_as_751_, v_i_752_);
                    v_snd_759_ = lean_ctor_get(v___x_758_, 1);
                    v_isSharedCheck_772_ = (!lean_is_exclusive(v___x_758_)) as u8;
                    if v_isSharedCheck_772_ == 0 {
                        v_unused_773_ = lean_ctor_get(v___x_758_, 0);
            ...
            1 => {
                ...
                if v_isShared_762_ == 0 {
                    lean_ctor_set(v___x_761_, 1, v___x_765_);
                    lean_ctor_set(v___x_761_, 0, v___x_764_);
                    v___x_767_ = v___x_761_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_771_ = lean_alloc_ctor(0, 2, (0) as u32);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_sortExprs_spec__2___boxed(
    mut v_as_774_: *mut LeanObject,
    mut v_i_775_: *mut LeanObject,
    mut v_stop_776_: *mut LeanObject,
...
pub unsafe fn l_Array_mapFinIdxM_map___at___00Lean_sortExprs_spec__3___redArg(
    mut v_as_781_: *mut LeanObject,
    mut v_i_782_: *mut LeanObject,
    mut v_j_783_: *mut LeanObject,
    mut v_bs_784_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_zero_785_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isZero_786_: u8 = 0;
    let mut v_one_787_: *mut LeanObject = core::ptr::null_mut();
    let mut v_n_788_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_785_ = lean_unsigned_to_nat(0);
                ...
                if v_isZero_786_ == 1 {
                    ...
                    v_one_787_ = lean_unsigned_to_nat(1);
                    v_n_788_ = lean_nat_sub(v_i_782_, v_one_787_);
                    lean_dec(v_i_782_);
                    v___x_789_ = lean_array_fget_borrowed(v_as_781_, v_j_783_);
                    lean_inc(v_j_783_);
                    lean_inc(v___x_789_);
                    v___x_790_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_790_, 0, v___x_789_);
                    lean_ctor_set(v___x_790_, 1, v_j_783_);
...
pub unsafe fn l_Array_mapFinIdxM_map___at___00Lean_sortExprs_spec__3___redArg___boxed(
    mut v_as_794_: *mut LeanObject,
    mut v_i_795_: *mut LeanObject,
    mut v_j_796_: *mut LeanObject,
    mut v_bs_797_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5_spec__9___redArg(
    mut v_hi_799_: *mut LeanObject,
    mut v_pivot_800_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5_spec__9___redArg___boxed(
    mut v_hi_819_: *mut LeanObject,
    mut v_pivot_820_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5___redArg___lam__0(
    ...
    let mut v_fst_828_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_829_: u8 = 0;
    v_fst_827_ = lean_ctor_get(v_x_825_, 0);
    v_fst_828_ = lean_ctor_get(v_x_826_, 0);
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5___redArg(
    mut v_n_834_: *mut LeanObject,
    mut v_as_835_: *mut LeanObject,
    mut v_lo_836_: *mut LeanObject,
    mut v_hi_837_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___y_839_: *mut LeanObject = core::ptr::null_mut();
    let mut v_pivot_840_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_mid_852_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_849_ == 0 {
                    ...
                    v___x_851_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5___redArg___boxed(
    ...
    mut v_lo_871_: *mut LeanObject,
    mut v_hi_872_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn _init_l_Lean_sortExprs___closed__0() -> *mut LeanObject {
    let mut v___x_874_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_875_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_876_: *mut LeanObject = core::ptr::null_mut();
    v___x_874_ = lean_box(0);
    v___x_875_ = lean_unsigned_to_nat(16);
    v___x_876_ = lean_mk_array(v___x_875_, v___x_874_);
    return v___x_876_;
}
pub unsafe fn _init_l_Lean_sortExprs___closed__1() -> *mut LeanObject {
    ...
    v___x_878_ = lean_unsigned_to_nat(0);
    v___x_879_ = lean_alloc_ctor(0, 2, (0) as u32);
    lean_ctor_set(v___x_879_, 0, v___x_878_);
    lean_ctor_set(v___x_879_, 1, v___x_877_);
    return v___x_879_;
}
pub unsafe fn _init_l_Lean_sortExprs___closed__2() -> *mut LeanObject {
    ...
    loop {
        match state {
            ...
            1 => {
                ...
                lean_ctor_set(v___x_891_, 0, v_es_890_);
                lean_ctor_set(v___x_891_, 1, v_snd_887_);
                return v___x_891_;
            }
            2 => {
...
pub unsafe fn l_Lean_sortExprs___boxed(
    mut v_es_938_: *mut LeanObject,
    mut v_lt_939_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_lt_boxed_940_: u8 = 0;
    let mut v_res_941_: *mut LeanObject = core::ptr::null_mut();
    v_lt_boxed_940_ = (lean_unbox(v_lt_939_) as u8);
...
pub unsafe fn l_Array_mapFinIdxM_map___at___00Lean_sortExprs_spec__3(
    mut v_as_947_: *mut LeanObject,
    mut v_i_948_: *mut LeanObject,
    mut v_j_949_: *mut LeanObject,
    mut v_inv_950_: *mut LeanObject,
    mut v_bs_951_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Array_mapFinIdxM_map___at___00Lean_sortExprs_spec__3___boxed(
    ...
    mut v_j_955_: *mut LeanObject,
    mut v_inv_956_: *mut LeanObject,
    mut v_bs_957_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__4(
    mut v_n_959_: *mut LeanObject,
    mut v_as_960_: *mut LeanObject,
    mut v_lo_961_: *mut LeanObject,
    mut v_hi_962_: *mut LeanObject,
    mut v_w_963_: *mut LeanObject,
    mut v_hlo_964_: *mut LeanObject,
    mut v_hhi_965_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__4___boxed(
    mut v_n_967_: *mut LeanObject,
    mut v_as_968_: *mut LeanObject,
    mut v_lo_969_: *mut LeanObject,
    mut v_hi_970_: *mut LeanObject,
    mut v_w_971_: *mut LeanObject,
    mut v_hlo_972_: *mut LeanObject,
    mut v_hhi_973_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5(
    ...
    mut v_lo_977_: *mut LeanObject,
    mut v_hi_978_: *mut LeanObject,
    mut v_w_979_: *mut LeanObject,
    mut v_hlo_980_: *mut LeanObject,
    mut v_hhi_981_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5___boxed(
    ...
    mut v_as_984_: *mut LeanObject,
    mut v_lo_985_: *mut LeanObject,
    mut v_hi_986_: *mut LeanObject,
    mut v_w_987_: *mut LeanObject,
    mut v_hlo_988_: *mut LeanObject,
    mut v_hhi_989_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insert___at___00Lean_sortExprs_spec__0_spec__1(
    ...
    mut v_data_1001_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_replace___at___00Std_DHashMap_Internal_Raw_u2080_insert___at___00Lean_sortExprs_spec__0_spec__2(
    mut v_00_u03b2_1003_: *mut LeanObject,
    mut v_a_1004_: *mut LeanObject,
    mut v_b_1005_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__4_spec__7(
    mut v_n_1008_: *mut LeanObject,
    mut v_lo_1009_: *mut LeanObject,
    mut v_hi_1010_: *mut LeanObject,
    mut v_hhi_1011_: *mut LeanObject,
    mut v_pivot_1012_: *mut LeanObject,
    mut v_as_1013_: *mut LeanObject,
    mut v_i_1014_: *mut LeanObject,
    mut v_k_1015_: *mut LeanObject,
    mut v_ilo_1016_: *mut LeanObject,
    mut v_ik_1017_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__4_spec__7___boxed(
    mut v_n_1020_: *mut LeanObject,
    mut v_lo_1021_: *mut LeanObject,
    mut v_hi_1022_: *mut LeanObject,
    mut v_hhi_1023_: *mut LeanObject,
    mut v_pivot_1024_: *mut LeanObject,
    mut v_as_1025_: *mut LeanObject,
    mut v_i_1026_: *mut LeanObject,
    mut v_k_1027_: *mut LeanObject,
    mut v_ilo_1028_: *mut LeanObject,
    mut v_ik_1029_: *mut LeanObject,
    mut v_w_1030_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5_spec__9(
    mut v_n_1032_: *mut LeanObject,
    mut v_lo_1033_: *mut LeanObject,
    mut v_hi_1034_: *mut LeanObject,
    mut v_hhi_1035_: *mut LeanObject,
    mut v_pivot_1036_: *mut LeanObject,
    mut v_as_1037_: *mut LeanObject,
    mut v_i_1038_: *mut LeanObject,
    mut v_k_1039_: *mut LeanObject,
    mut v_ilo_1040_: *mut LeanObject,
    mut v_ik_1041_: *mut LeanObject,
    mut v_w_1042_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Init_Data_Array_QSort_Basic_0__Array_qpartition_loop___at___00__private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_sortExprs_spec__5_spec__9___boxed(
    ...
    mut v_lo_1045_: *mut LeanObject,
    mut v_hi_1046_: *mut LeanObject,
    mut v_hhi_1047_: *mut LeanObject,
    mut v_pivot_1048_: *mut LeanObject,
    mut v_as_1049_: *mut LeanObject,
    mut v_i_1050_: *mut LeanObject,
    mut v_k_1051_: *mut LeanObject,
    mut v_ilo_1052_: *mut LeanObject,
    mut v_ik_1053_: *mut LeanObject,
    mut v_w_1054_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insert___at___00Lean_sortExprs_spec__0_spec__1_spec__2(
    ...
    mut v_source_1058_: *mut LeanObject,
    mut v_target_1059_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Lean_Util_SortExprs(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Util_SortExprs(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Util_SortExprs(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
