...
use crate::leanh::{
    ...
    lean_ctor_set_tag, lean_dec, lean_dec_ref, lean_inc, lean_io_result_is_error,
    lean_io_result_mk_ok, lean_is_exclusive, lean_obj_tag,
};
pub static l_Lean_determineLakePath___closed__0_value: LeanStringObject<5> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lean_determineLakePath___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__0_value) as *mut LeanObject;
pub static l_Lean_determineLakePath___closed__1_value: LeanStringObject<13> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lean_determineLakePath___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__1_value) as *mut LeanObject;
pub static l_Lean_determineLakePath___closed__2_value: LeanStringObject<5> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lean_determineLakePath___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__2_value) as *mut LeanObject;
pub static l_Lean_determineLakePath___closed__3_value: LeanStringObject<4> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lean_determineLakePath___closed__3: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_determineLakePath___closed__3_value) as *mut LeanObject;
pub unsafe fn l_Lean_determineLakePath() -> *mut LeanObject {
    ...
    let mut v_reuseFailAlloc_69_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_81_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_49_) == 1 {
                    ...
                    v_isSharedCheck_57_ = (!lean_is_exclusive(v___x_49_)) as u8;
                    ...
                    if lean_obj_tag(v___x_59_) == 0 {
                        ...
                        if lean_obj_tag(v___x_60_) == 0 {
                            ...
                            v_isSharedCheck_70_ = (!lean_is_exclusive(v___x_60_)) as u8;
                        ...
                        v_val_71_ = lean_ctor_get(v___x_59_, 0);
                        v_isSharedCheck_82_ = (!lean_is_exclusive(v___x_59_)) as u8;
            ...
            1 => {
                if v_isShared_53_ == 0 {
                    lean_ctor_set_tag(v___x_52_, 0);
                    v___x_55_ = v___x_52_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_56_ = lean_alloc_ctor(0, 1, (0) as u32);
            ...
            5 => {
                ...
                if v_isShared_74_ == 0 {
                    ...
                    lean_ctor_set(v___x_73_, 0, v___x_78_);
                    v___x_80_ = v___x_73_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_81_ = lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_determineLakePath___boxed(mut v_a_83_: *mut LeanObject) -> *mut LeanObject {
    let mut v_res_84_: *mut LeanObject = core::ptr::null_mut();
    v_res_84_ = l_Lean_determineLakePath();
    return v_res_84_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lean_Util_LakePath(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Util_LakePath(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Util_LakePath(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
