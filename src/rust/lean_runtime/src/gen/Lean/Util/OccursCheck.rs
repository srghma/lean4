...
static mut l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6___closed__0: *mut LeanObject = core::ptr::addr_of!(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6___closed__0_value) as *mut LeanObject;
...
static mut l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6___closed__1: *mut LeanObject = core::ptr::addr_of!(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6___closed__1_value) as *mut LeanObject;
pub static l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6___closed__2_value: LeanCtorObject<1> = LeanCtorObject { m_header: LeanObject { rc: 0, cs_size: (core::mem::size_of::<LeanObject>() + core::mem::size_of::<*mut LeanObject>()*1 + 0) as u16, other: 1, tag: 1 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut LeanObject] };
static mut l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6___closed__2: *mut LeanObject = core::ptr::addr_of!(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6___closed__2_value) as *mut LeanObject;
...
pub static l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar___redArg___closed__1_value: LeanCtorObject<1> = LeanCtorObject { m_header: LeanObject { rc: 0, cs_size: (core::mem::size_of::<LeanObject>() + core::mem::size_of::<*mut LeanObject>()*1 + 0) as u16, other: 1, tag: 0 }, m_objs: [((( 0 as usize) << 1) | 1) as *mut LeanObject] };
...
static mut l_Lean_occursCheck___redArg___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_occursCheck___redArg___closed__0: *mut LeanObject = core::ptr::null_mut();
static mut l_Lean_occursCheck___redArg___closed__1_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_occursCheck___redArg___closed__1: *mut LeanObject = core::ptr::null_mut();
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__7(
    mut v_toPure_407_: *mut LeanObject,
    mut v_____x_408_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_409_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_410_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_fst_409_ = lean_ctor_get(v_____x_408_, 0);
                v_snd_410_ = lean_ctor_get(v_____x_408_, 1);
                v_isSharedCheck_419_ = (!lean_is_exclusive(v_____x_408_)) as u8;
            ...
            1 => {
                v___x_414_ = lean_alloc_ctor(1, 1, (0) as u32);
                lean_ctor_set(v___x_414_, 0, v_fst_409_);
                if v_isShared_413_ == 0 {
                    ...
                    lean_ctor_set(v_reuseFailAlloc_418_, 1, v_snd_410_);
            ...
            2 => {
                v___x_417_ = lean_apply_2(v_toPure_407_, lean_box(0), v___x_416_);
                return v___x_417_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__5(
    mut v_toPure_420_: *mut LeanObject,
    mut v_____x_421_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_422_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_fst_422_ = lean_ctor_get(v_____x_421_, 0);
                v_snd_423_ = lean_ctor_get(v_____x_421_, 1);
                v_isSharedCheck_432_ = (!lean_is_exclusive(v_____x_421_)) as u8;
            ...
            1 => {
                ...
                lean_ctor_set(v___x_427_, 0, v_fst_422_);
                if v_isShared_426_ == 0 {
                    ...
                    v_reuseFailAlloc_431_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_431_, 0, v___x_427_);
                    lean_ctor_set(v_reuseFailAlloc_431_, 1, v_snd_423_);
            ...
            2 => {
                v___x_430_ = lean_apply_2(v_toPure_420_, lean_box(0), v___x_429_);
                return v___x_430_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6(
    ...
    mut v_____x_441_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    let mut v_unused_460_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_484_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_fst_442_ = lean_ctor_get(v_____x_441_, 0);
                lean_inc(v_fst_442_);
                if lean_obj_tag(v_fst_442_) == 0 {
                    lean_dec(v___f_440_);
                    lean_dec(v_toBind_439_);
                    lean_dec_ref(v_e_438_);
                    v_snd_443_ = lean_ctor_get(v_____x_441_, 1);
                    v_isSharedCheck_459_ = (!lean_is_exclusive(v_____x_441_)) as u8;
                    if v_isSharedCheck_459_ == 0 {
                        v_unused_460_ = lean_ctor_get(v_____x_441_, 0);
                    ...
                    v_snd_461_ = lean_ctor_get(v_____x_441_, 1);
                    v_isSharedCheck_483_ = (!lean_is_exclusive(v_____x_441_)) as u8;
                    if v_isSharedCheck_483_ == 0 {
                        v_unused_484_ = lean_ctor_get(v_____x_441_, 0);
            ...
            1 => {
                ...
                v_isSharedCheck_458_ = (!lean_is_exclusive(v_fst_442_)) as u8;
            ...
            2 => {
                if v_isShared_450_ == 0 {
                    ...
                    v_reuseFailAlloc_457_ = lean_alloc_ctor(0, 1, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_457_, 0, v_a_447_);
            ...
            3 => {
                if v_isShared_446_ == 0 {
                    ...
                    v_reuseFailAlloc_456_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_456_, 0, v___x_452_);
                    lean_ctor_set(v_reuseFailAlloc_456_, 1, v_snd_443_);
            ...
            4 => {
                v___x_455_ = lean_apply_2(v_toPure_437_, lean_box(0), v___x_454_);
                return v___x_455_;
            }
            5 => {
                v_a_465_ = lean_ctor_get(v_fst_442_, 0);
                lean_inc(v_a_465_);
                ...
                if v___x_468_ == 0 {
                    ...
                    v___f_469_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__5 as *mut core::ffi::c_void, 2, 1);
                    lean_closure_set(v___f_469_, 0, v_toPure_437_);
                    ...
                    if v_isShared_464_ == 0 {
                        lean_ctor_set(v___x_463_, 1, v___x_471_);
                        lean_ctor_set(v___x_463_, 0, v___x_470_);
                        v___x_473_ = v___x_463_;
                        state = 6;
                        continue;
                    } else {
                        v_reuseFailAlloc_477_ = lean_alloc_ctor(0, 2, (0) as u32);
                    ...
                    if v_isShared_464_ == 0 {
                        ...
                        v_reuseFailAlloc_482_ = lean_alloc_ctor(0, 2, (0) as u32);
                        lean_ctor_set(v_reuseFailAlloc_482_, 0, v___x_478_);
                        lean_ctor_set(v_reuseFailAlloc_482_, 1, v_snd_461_);
            ...
            6 => {
                v___x_474_ = lean_apply_2(v_toPure_437_, lean_box(0), v___x_473_);
            ...
            7 => {
                v___x_481_ = lean_apply_2(v_toPure_437_, lean_box(0), v___x_480_);
                return v___x_481_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__1(
    ...
    mut v_mvarId_488_: *mut LeanObject,
    mut v_body_489_: *mut LeanObject,
    mut v_____x_490_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_491_: *mut LeanObject = core::ptr::null_mut();
    v_fst_491_ = lean_ctor_get(v_____x_490_, 0);
    if lean_obj_tag(v_fst_491_) == 0 {
        ...
        v___x_492_ = lean_apply_2(v_toPure_485_, lean_box(0), v_____x_490_);
        return v___x_492_;
    } else {
        let mut v_snd_493_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_494_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_toPure_485_);
        v_snd_493_ = lean_ctor_get(v_____x_490_, 1);
        lean_inc(v_snd_493_);
        lean_dec_ref(v_____x_490_);
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__2(
    ...
    mut v_mvarId_498_: *mut LeanObject,
    mut v_value_499_: *mut LeanObject,
    mut v_toBind_500_: *mut LeanObject,
    mut v___f_501_: *mut LeanObject,
    mut v_____x_502_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_503_: *mut LeanObject = core::ptr::null_mut();
    v_fst_503_ = lean_ctor_get(v_____x_502_, 0);
    if lean_obj_tag(v_fst_503_) == 0 {
        let mut v___x_504_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v___f_501_);
        lean_dec(v_toBind_500_);
        lean_dec_ref(v_value_499_);
        lean_dec(v_mvarId_498_);
        lean_dec_ref(v_inst_497_);
        lean_dec_ref(v_inst_496_);
        v___x_504_ = lean_apply_2(v_toPure_495_, lean_box(0), v_____x_502_);
        return v___x_504_;
    } else {
        let mut v_snd_505_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_506_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_507_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_toPure_495_);
        v_snd_505_ = lean_ctor_get(v_____x_502_, 1);
        lean_inc(v_snd_505_);
        lean_dec_ref(v_____x_502_);
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__3(
    ...
    if lean_obj_tag(v_fst_514_) == 0 {
        ...
        v___x_515_ = lean_apply_2(v_toPure_508_, lean_box(0), v_____x_513_);
        return v___x_515_;
    } else {
        let mut v_snd_516_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_517_: *mut LeanObject = core::ptr::null_mut();
        lean_dec(v_toPure_508_);
        v_snd_516_ = lean_ctor_get(v_____x_513_, 1);
        lean_inc(v_snd_516_);
        lean_dec_ref(v_____x_513_);
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar___redArg___lam__0(
    mut v_toApplicative_519_: *mut LeanObject,
    mut v_inst_520_: *mut LeanObject,
    mut v_inst_521_: *mut LeanObject,
    mut v_mvarId_522_: *mut LeanObject,
    mut v_____x_523_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_524_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_525_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_543_: *mut LeanObject = core::ptr::null_mut();
    let mut v_a_544_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_545_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_547_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_548_: u8 = 0;
    let mut v_toPure_549_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_556_: *mut LeanObject = core::ptr::null_mut();
    let mut v_val_557_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_558_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mvarIdPending_559_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_560_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_fst_524_ = lean_ctor_get(v_____x_523_, 0);
                lean_inc(v_fst_524_);
                if lean_obj_tag(v_fst_524_) == 0 {
                    lean_dec(v_mvarId_522_);
                    lean_dec_ref(v_inst_521_);
                    lean_dec_ref(v_inst_520_);
                    v_snd_525_ = lean_ctor_get(v_____x_523_, 1);
                    v_isSharedCheck_542_ = (!lean_is_exclusive(v_____x_523_)) as u8;
                    if v_isSharedCheck_542_ == 0 {
                        v_unused_543_ = lean_ctor_get(v_____x_523_, 0);
                    ...
                    v_a_544_ = lean_ctor_get(v_fst_524_, 0);
                    lean_inc(v_a_544_);
                    ...
                    if lean_obj_tag(v_a_544_) == 0 {
                        ...
                        lean_dec_ref(v_inst_521_);
                        lean_dec_ref(v_inst_520_);
                        v_snd_545_ = lean_ctor_get(v_____x_523_, 1);
                        v_isSharedCheck_555_ = (!lean_is_exclusive(v_____x_523_)) as u8;
                        if v_isSharedCheck_555_ == 0 {
                            v_unused_556_ = lean_ctor_get(v_____x_523_, 0);
                        ...
                        v_val_557_ = lean_ctor_get(v_a_544_, 0);
                        lean_inc(v_val_557_);
                        lean_dec_ref_known(v_a_544_, 1);
                        v_snd_558_ = lean_ctor_get(v_____x_523_, 1);
                        lean_inc(v_snd_558_);
                        lean_dec_ref(v_____x_523_);
                        v_mvarIdPending_559_ = lean_ctor_get(v_val_557_, 1);
                        lean_inc(v_mvarIdPending_559_);
                        lean_dec(v_val_557_);
            ...
            1 => {
                v_a_529_ = lean_ctor_get(v_fst_524_, 0);
                v_isSharedCheck_541_ = (!lean_is_exclusive(v_fst_524_)) as u8;
            ...
            2 => {
                ...
                if v_isShared_532_ == 0 {
                    ...
                    lean_ctor_set(v_reuseFailAlloc_540_, 0, v_a_529_);
            ...
            3 => {
                if v_isShared_528_ == 0 {
                    ...
                    lean_ctor_set(v_reuseFailAlloc_539_, 1, v_snd_525_);
            ...
            4 => {
                v___x_538_ = lean_apply_2(v_toPure_533_, lean_box(0), v___x_537_);
                return v___x_538_;
            }
            5 => {
                v_toPure_549_ = lean_ctor_get(v_toApplicative_519_, 1);
                ...
                if v_isShared_548_ == 0 {
                    ...
                    lean_ctor_set(v_reuseFailAlloc_554_, 1, v_snd_545_);
            ...
            6 => {
                v___x_553_ = lean_apply_2(v_toPure_549_, lean_box(0), v___x_552_);
                return v___x_553_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar___redArg___lam__1(
    mut v_toApplicative_561_: *mut LeanObject,
    mut v___x_562_: *mut LeanObject,
    mut v___x_563_: *mut LeanObject,
    mut v_mvarId_x27_564_: *mut LeanObject,
    mut v_toBind_565_: *mut LeanObject,
    mut v___f_566_: *mut LeanObject,
    mut v_inst_567_: *mut LeanObject,
    mut v_inst_568_: *mut LeanObject,
    mut v_mvarId_569_: *mut LeanObject,
    mut v_____x_570_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    let mut v_toPure_580_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_590_: *mut LeanObject = core::ptr::null_mut();
    let mut v_a_591_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_592_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_5693__overap_593_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v_fst_571_) == 0 {
                    ...
                    lean_dec(v_mvarId_x27_564_);
                    lean_dec_ref(v___x_563_);
                    lean_dec_ref(v___x_562_);
                    v_snd_572_ = lean_ctor_get(v_____x_570_, 1);
                    v_isSharedCheck_589_ = (!lean_is_exclusive(v_____x_570_)) as u8;
                    if v_isSharedCheck_589_ == 0 {
                        v_unused_590_ = lean_ctor_get(v_____x_570_, 0);
                    ...
                    v_a_591_ = lean_ctor_get(v_fst_571_, 0);
                    lean_inc(v_a_591_);
                    ...
                    if lean_obj_tag(v_a_591_) == 0 {
                        ...
                        lean_dec_ref(v_inst_568_);
                        lean_dec_ref(v_inst_567_);
                        v_snd_592_ = lean_ctor_get(v_____x_570_, 1);
                        lean_inc(v_snd_592_);
                        ...
                        v___x_594_ = lean_apply_1(v___x_5693__overap_593_, v_snd_592_);
                        ...
                        lean_dec_ref(v___x_563_);
                        lean_dec_ref(v___x_562_);
                        v_snd_596_ = lean_ctor_get(v_____x_570_, 1);
                        lean_inc(v_snd_596_);
                        lean_dec_ref(v_____x_570_);
            ...
            1 => {
                v_a_576_ = lean_ctor_get(v_fst_571_, 0);
                v_isSharedCheck_588_ = (!lean_is_exclusive(v_fst_571_)) as u8;
            ...
            2 => {
                v_toPure_580_ = lean_ctor_get(v_toApplicative_561_, 1);
                ...
                if v_isShared_579_ == 0 {
                    ...
                    v_reuseFailAlloc_587_ = lean_alloc_ctor(0, 1, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_587_, 0, v_a_576_);
            ...
            3 => {
                if v_isShared_575_ == 0 {
                    ...
                    lean_ctor_set(v_reuseFailAlloc_586_, 1, v_snd_572_);
            ...
            4 => {
                v___x_585_ = lean_apply_2(v_toPure_580_, lean_box(0), v___x_584_);
                return v___x_585_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar___redArg(
    ...
    mut v_mvarId_603_: *mut LeanObject,
    mut v_mvarId_x27_604_: *mut LeanObject,
    ...
    let mut v___f_609_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v___f_620_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_getMCtx_627_: *mut LeanObject = core::ptr::null_mut();
    let mut v_modifyMCtx_628_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_toApplicative_637_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toBind_638_: *mut LeanObject = core::ptr::null_mut();
    let mut v___f_639_: *mut LeanObject = core::ptr::null_mut();
    let mut v___f_640_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_1342__overap_641_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_606_ == 0 {
                    lean_inc_ref_n(v_inst_601_, 11);
                    v___f_607_ = lean_alloc_closure(
                        l_StateT_instMonad___redArg___lam__1 as *mut core::ffi::c_void,
                        6,
                        1,
                    );
                    lean_closure_set(v___f_607_, 0, v_inst_601_);
                    v___f_608_ = lean_alloc_closure(
                        l_StateT_instMonad___redArg___lam__4 as *mut core::ffi::c_void,
                        6,
                        1,
                    );
                    lean_closure_set(v___f_608_, 0, v_inst_601_);
                    v___f_609_ = lean_alloc_closure(
                        l_StateT_instMonad___redArg___lam__7 as *mut core::ffi::c_void,
                        6,
                        1,
                    );
                    lean_closure_set(v___f_609_, 0, v_inst_601_);
                    v___f_610_ = lean_alloc_closure(
                        l_StateT_instMonad___redArg___lam__9 as *mut core::ffi::c_void,
                        6,
                        1,
                    );
                    lean_closure_set(v___f_610_, 0, v_inst_601_);
                    v___x_611_ = lean_alloc_closure(l_StateT_map as *mut core::ffi::c_void, 8, 3);
                    lean_closure_set(v___x_611_, 0, lean_box(0));
                    lean_closure_set(v___x_611_, 1, lean_box(0));
                    lean_closure_set(v___x_611_, 2, v_inst_601_);
                    v___x_612_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_612_, 0, v___x_611_);
                    lean_ctor_set(v___x_612_, 1, v___f_607_);
                    v___x_613_ = lean_alloc_closure(l_StateT_pure as *mut core::ffi::c_void, 6, 3);
                    lean_closure_set(v___x_613_, 0, lean_box(0));
                    lean_closure_set(v___x_613_, 1, lean_box(0));
                    lean_closure_set(v___x_613_, 2, v_inst_601_);
                    v___x_614_ = lean_alloc_ctor(0, 5, (0) as u32);
                    lean_ctor_set(v___x_614_, 0, v___x_612_);
                    lean_ctor_set(v___x_614_, 1, v___x_613_);
                    lean_ctor_set(v___x_614_, 2, v___f_608_);
                    lean_ctor_set(v___x_614_, 3, v___f_609_);
                    lean_ctor_set(v___x_614_, 4, v___f_610_);
                    v___x_615_ = lean_alloc_closure(l_StateT_bind as *mut core::ffi::c_void, 8, 3);
                    lean_closure_set(v___x_615_, 0, lean_box(0));
                    lean_closure_set(v___x_615_, 1, lean_box(0));
                    lean_closure_set(v___x_615_, 2, v_inst_601_);
                    v___x_616_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_616_, 0, v___x_614_);
                    lean_ctor_set(v___x_616_, 1, v___x_615_);
                    lean_inc_ref_n(v___x_616_, 7);
                    ...
                    lean_closure_set(v___f_618_, 0, v___x_616_);
                    v___f_619_ = lean_alloc_closure(
                        l_ExceptT_instMonad___redArg___lam__7 as *mut core::ffi::c_void,
                        5,
                        1,
                    );
                    lean_closure_set(v___f_619_, 0, v___x_616_);
                    v___f_620_ = lean_alloc_closure(
                        l_ExceptT_instMonad___redArg___lam__9 as *mut core::ffi::c_void,
                        5,
                        1,
                    );
                    lean_closure_set(v___f_620_, 0, v___x_616_);
                    v___x_621_ = lean_alloc_closure(l_ExceptT_map as *mut core::ffi::c_void, 7, 3);
                    lean_closure_set(v___x_621_, 0, lean_box(0));
                    lean_closure_set(v___x_621_, 1, lean_box(0));
                    lean_closure_set(v___x_621_, 2, v___x_616_);
                    v___x_622_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_622_, 0, v___x_621_);
                    lean_ctor_set(v___x_622_, 1, v___f_617_);
                    v___x_623_ = lean_alloc_closure(l_ExceptT_pure as *mut core::ffi::c_void, 5, 3);
                    lean_closure_set(v___x_623_, 0, lean_box(0));
                    lean_closure_set(v___x_623_, 1, lean_box(0));
                    lean_closure_set(v___x_623_, 2, v___x_616_);
                    v___x_624_ = lean_alloc_ctor(0, 5, (0) as u32);
                    lean_ctor_set(v___x_624_, 0, v___x_622_);
                    lean_ctor_set(v___x_624_, 1, v___x_623_);
                    lean_ctor_set(v___x_624_, 2, v___f_618_);
                    lean_ctor_set(v___x_624_, 3, v___f_619_);
                    lean_ctor_set(v___x_624_, 4, v___f_620_);
                    v___x_625_ = lean_alloc_closure(l_ExceptT_bind as *mut core::ffi::c_void, 7, 3);
                    lean_closure_set(v___x_625_, 0, lean_box(0));
                    lean_closure_set(v___x_625_, 1, lean_box(0));
                    lean_closure_set(v___x_625_, 2, v___x_616_);
                    v___x_626_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_626_, 0, v___x_624_);
                    lean_ctor_set(v___x_626_, 1, v___x_625_);
                    v_getMCtx_627_ = lean_ctor_get(v_inst_602_, 0);
                    v_modifyMCtx_628_ = lean_ctor_get(v_inst_602_, 1);
                    v___x_629_ = lean_alloc_closure(l_ExceptT_lift as *mut core::ffi::c_void, 5, 3);
                    lean_closure_set(v___x_629_, 0, lean_box(0));
                    lean_closure_set(v___x_629_, 1, lean_box(0));
                    lean_closure_set(v___x_629_, 2, v___x_616_);
                    v___x_630_ = lean_alloc_closure(l_StateT_lift as *mut core::ffi::c_void, 6, 3);
                    lean_closure_set(v___x_630_, 0, lean_box(0));
                    lean_closure_set(v___x_630_, 1, lean_box(0));
                    lean_closure_set(v___x_630_, 2, v_inst_601_);
                    lean_inc(v_modifyMCtx_628_);
                    v___f_631_ = lean_alloc_closure(
                        l_Lean_instMonadMCtxOfMonadLift___redArg___lam__0 as *mut core::ffi::c_void,
                        3,
                        2,
                    );
                    lean_closure_set(v___f_631_, 0, v_modifyMCtx_628_);
                    lean_closure_set(v___f_631_, 1, v___x_630_);
                    lean_inc(v_getMCtx_627_);
                    v___x_632_ = lean_alloc_closure(l_StateT_lift as *mut core::ffi::c_void, 6, 5);
                    lean_closure_set(v___x_632_, 0, lean_box(0));
                    lean_closure_set(v___x_632_, 1, lean_box(0));
                    lean_closure_set(v___x_632_, 2, v_inst_601_);
                    lean_closure_set(v___x_632_, 3, lean_box(0));
                    lean_closure_set(v___x_632_, 4, v_getMCtx_627_);
                    v___f_633_ = lean_alloc_closure(
                        l_Lean_instMonadMCtxOfMonadLift___redArg___lam__0 as *mut core::ffi::c_void,
                        3,
                        2,
                    );
                    lean_closure_set(v___f_633_, 0, v___f_631_);
                    lean_closure_set(v___f_633_, 1, v___x_629_);
                    v___f_634_ = l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar___redArg___closed__0;
                    v___x_635_ = lean_alloc_closure(l_StateT_map as *mut core::ffi::c_void, 8, 7);
                    lean_closure_set(v___x_635_, 0, lean_box(0));
                    lean_closure_set(v___x_635_, 1, lean_box(0));
                    lean_closure_set(v___x_635_, 2, v_inst_601_);
                    lean_closure_set(v___x_635_, 3, lean_box(0));
                    lean_closure_set(v___x_635_, 4, lean_box(0));
                    lean_closure_set(v___x_635_, 5, v___f_634_);
                    lean_closure_set(v___x_635_, 6, v___x_632_);
                    v___x_636_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_636_, 0, v___x_635_);
                    lean_ctor_set(v___x_636_, 1, v___f_633_);
                    v_toApplicative_637_ = lean_ctor_get(v_inst_601_, 0);
                    lean_inc_ref_n(v_toApplicative_637_, 2);
                    v_toBind_638_ = lean_ctor_get(v_inst_601_, 1);
                    lean_inc_n(v_toBind_638_, 2);
                    lean_inc(v_mvarId_603_);
                    lean_inc_ref(v_inst_602_);
                    v___f_639_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar___redArg___lam__0 as *mut core::ffi::c_void, 5, 4);
                    lean_closure_set(v___f_639_, 0, v_toApplicative_637_);
                    lean_closure_set(v___f_639_, 1, v_inst_601_);
                    lean_closure_set(v___f_639_, 2, v_inst_602_);
                    lean_closure_set(v___f_639_, 3, v_mvarId_603_);
                    lean_inc(v_mvarId_x27_604_);
                    lean_inc_ref(v___x_636_);
                    lean_inc_ref(v___x_626_);
                    v___f_640_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar___redArg___lam__1 as *mut core::ffi::c_void, 10, 9);
                    lean_closure_set(v___f_640_, 0, v_toApplicative_637_);
                    lean_closure_set(v___f_640_, 1, v___x_626_);
                    lean_closure_set(v___f_640_, 2, v___x_636_);
                    lean_closure_set(v___f_640_, 3, v_mvarId_x27_604_);
                    lean_closure_set(v___f_640_, 4, v_toBind_638_);
                    lean_closure_set(v___f_640_, 5, v___f_639_);
                    lean_closure_set(v___f_640_, 6, v_inst_601_);
                    lean_closure_set(v___f_640_, 7, v_inst_602_);
                    lean_closure_set(v___f_640_, 8, v_mvarId_603_);
                    v___x_1342__overap_641_ = l_Lean_getExprMVarAssignment_x3f___redArg(
                        v___x_626_,
                        v___x_636_,
                        v_mvarId_x27_604_,
                    );
                    v___x_642_ = lean_apply_1(v___x_1342__overap_641_, v_a_605_);
                    ...
                    lean_dec(v_mvarId_x27_604_);
                    lean_dec(v_mvarId_603_);
                    lean_dec_ref(v_inst_602_);
                    v_toApplicative_644_ = lean_ctor_get(v_inst_601_, 0);
                    v_isSharedCheck_654_ = (!lean_is_exclusive(v_inst_601_)) as u8;
                    if v_isSharedCheck_654_ == 0 {
                        v_unused_655_ = lean_ctor_get(v_inst_601_, 1);
            ...
            1 => {
                ...
                if v_isShared_647_ == 0 {
                    lean_ctor_set(v___x_646_, 1, v_a_605_);
                    ...
                    lean_ctor_set(v_reuseFailAlloc_653_, 1, v_a_605_);
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__4(
    ...
    mut v_toBind_660_: *mut LeanObject,
    mut v_e_661_: *mut LeanObject,
    mut v_____x_662_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_d_664_: *mut LeanObject = core::ptr::null_mut();
    let mut v_b_665_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_fst_670_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_671_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_672_: *mut LeanObject = core::ptr::null_mut();
    let mut v_struct_673_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_674_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_675_: *mut LeanObject = core::ptr::null_mut();
    let mut v_binderType_676_: *mut LeanObject = core::ptr::null_mut();
    let mut v_body_677_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_678_: *mut LeanObject = core::ptr::null_mut();
    let mut v_binderType_679_: *mut LeanObject = core::ptr::null_mut();
    let mut v_body_680_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_681_: *mut LeanObject = core::ptr::null_mut();
    let mut v_type_682_: *mut LeanObject = core::ptr::null_mut();
    let mut v_value_683_: *mut LeanObject = core::ptr::null_mut();
    let mut v_body_684_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_expr_690_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_691_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_692_: *mut LeanObject = core::ptr::null_mut();
    let mut v_fn_693_: *mut LeanObject = core::ptr::null_mut();
    let mut v_arg_694_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_mvarId_699_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_700_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_701_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_711_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_fst_670_ = lean_ctor_get(v_____x_662_, 0);
                if lean_obj_tag(v_fst_670_) == 0 {
                    lean_dec_ref(v_e_661_);
                    lean_dec(v_toBind_660_);
                    lean_dec(v_mvarId_659_);
                    lean_dec_ref(v_inst_658_);
                    lean_dec_ref(v_inst_657_);
                    v___x_671_ = lean_apply_2(v_toPure_656_, lean_box(0), v_____x_662_);
                    return v___x_671_;
                } else {
                    match lean_obj_tag(v_e_661_) {
                        11 => {
                            lean_dec(v_toBind_660_);
                            lean_dec(v_toPure_656_);
                            v_snd_672_ = lean_ctor_get(v_____x_662_, 1);
                            lean_inc(v_snd_672_);
                            lean_dec_ref(v_____x_662_);
                            v_struct_673_ = lean_ctor_get(v_e_661_, 2);
                            lean_inc_ref(v_struct_673_);
                            lean_dec_ref_known(v_e_661_, 3);
                        ...
                        7 => {
                            v_snd_675_ = lean_ctor_get(v_____x_662_, 1);
                            lean_inc(v_snd_675_);
                            lean_dec_ref(v_____x_662_);
                            v_binderType_676_ = lean_ctor_get(v_e_661_, 1);
                            lean_inc_ref(v_binderType_676_);
                            v_body_677_ = lean_ctor_get(v_e_661_, 2);
                        ...
                        6 => {
                            v_snd_678_ = lean_ctor_get(v_____x_662_, 1);
                            lean_inc(v_snd_678_);
                            lean_dec_ref(v_____x_662_);
                            v_binderType_679_ = lean_ctor_get(v_e_661_, 1);
                            lean_inc_ref(v_binderType_679_);
                            v_body_680_ = lean_ctor_get(v_e_661_, 2);
                        ...
                        8 => {
                            v_snd_681_ = lean_ctor_get(v_____x_662_, 1);
                            lean_inc(v_snd_681_);
                            lean_dec_ref(v_____x_662_);
                            v_type_682_ = lean_ctor_get(v_e_661_, 1);
                            lean_inc_ref(v_type_682_);
                            v_value_683_ = lean_ctor_get(v_e_661_, 2);
                            lean_inc_ref(v_value_683_);
                            v_body_684_ = lean_ctor_get(v_e_661_, 3);
                            lean_inc_ref(v_body_684_);
                            lean_dec_ref_known(v_e_661_, 4);
                            lean_inc_n(v_mvarId_659_, 2);
                            lean_inc_ref_n(v_inst_658_, 2);
                            lean_inc_ref_n(v_inst_657_, 2);
                            lean_inc(v_toPure_656_);
                            v___f_685_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__1 as *mut core::ffi::c_void, 6, 5);
                            lean_closure_set(v___f_685_, 0, v_toPure_656_);
                            lean_closure_set(v___f_685_, 1, v_inst_657_);
                            lean_closure_set(v___f_685_, 2, v_inst_658_);
                            lean_closure_set(v___f_685_, 3, v_mvarId_659_);
                            lean_closure_set(v___f_685_, 4, v_body_684_);
                            lean_inc(v_toBind_660_);
                            v___f_686_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__2 as *mut core::ffi::c_void, 8, 7);
                            lean_closure_set(v___f_686_, 0, v_toPure_656_);
                            lean_closure_set(v___f_686_, 1, v_inst_657_);
                            lean_closure_set(v___f_686_, 2, v_inst_658_);
                            lean_closure_set(v___f_686_, 3, v_mvarId_659_);
                            lean_closure_set(v___f_686_, 4, v_value_683_);
                            lean_closure_set(v___f_686_, 5, v_toBind_660_);
                            lean_closure_set(v___f_686_, 6, v___f_685_);
                        ...
                        10 => {
                            lean_dec(v_toBind_660_);
                            lean_dec(v_toPure_656_);
                            v_snd_689_ = lean_ctor_get(v_____x_662_, 1);
                            lean_inc(v_snd_689_);
                            lean_dec_ref(v_____x_662_);
                            v_expr_690_ = lean_ctor_get(v_e_661_, 1);
                            lean_inc_ref(v_expr_690_);
                            lean_dec_ref_known(v_e_661_, 2);
                        ...
                        5 => {
                            v_snd_692_ = lean_ctor_get(v_____x_662_, 1);
                            lean_inc(v_snd_692_);
                            lean_dec_ref(v_____x_662_);
                            v_fn_693_ = lean_ctor_get(v_e_661_, 0);
                            lean_inc_ref(v_fn_693_);
                            v_arg_694_ = lean_ctor_get(v_e_661_, 1);
                            lean_inc_ref(v_arg_694_);
                            lean_dec_ref_known(v_e_661_, 2);
                            lean_inc(v_mvarId_659_);
                            lean_inc_ref(v_inst_658_);
                            lean_inc_ref(v_inst_657_);
                            v___f_695_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__3 as *mut core::ffi::c_void, 6, 5);
                            lean_closure_set(v___f_695_, 0, v_toPure_656_);
                            lean_closure_set(v___f_695_, 1, v_inst_657_);
                            lean_closure_set(v___f_695_, 2, v_inst_658_);
                            lean_closure_set(v___f_695_, 3, v_mvarId_659_);
                            lean_closure_set(v___f_695_, 4, v_arg_694_);
                        ...
                        2 => {
                            lean_dec(v_toBind_660_);
                            lean_dec(v_toPure_656_);
                            v_snd_698_ = lean_ctor_get(v_____x_662_, 1);
                            lean_inc(v_snd_698_);
                            lean_dec_ref(v_____x_662_);
                            v_mvarId_699_ = lean_ctor_get(v_e_661_, 0);
                            lean_inc(v_mvarId_699_);
                            lean_dec_ref_known(v_e_661_, 1);
                        ...
                        _ => {
                            ...
                            lean_dec_ref(v_inst_658_);
                            lean_dec_ref(v_inst_657_);
                            v_snd_701_ = lean_ctor_get(v_____x_662_, 1);
                            v_isSharedCheck_710_ = (!lean_is_exclusive(v_____x_662_)) as u8;
                            if v_isSharedCheck_710_ == 0 {
                                v_unused_711_ = lean_ctor_get(v_____x_662_, 0);
            ...
            1 => {
                ...
                lean_closure_set(v___f_667_, 0, v_toPure_656_);
                lean_closure_set(v___f_667_, 1, v_inst_657_);
                lean_closure_set(v___f_667_, 2, v_inst_658_);
                lean_closure_set(v___f_667_, 3, v_mvarId_659_);
                lean_closure_set(v___f_667_, 4, v_b_665_);
            ...
            2 => {
                ...
                if v_isShared_704_ == 0 {
                    ...
                    v_reuseFailAlloc_709_ = lean_alloc_ctor(0, 2, (0) as u32);
            ...
            3 => {
                v___x_708_ = lean_apply_2(v_toPure_656_, lean_box(0), v___x_707_);
                return v___x_708_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg(
    ...
    let mut v_reuseFailAlloc_727_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_728_: u8 = 0;
    let mut v_unused_729_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toApplicative_730_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toBind_731_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toPure_732_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_717_ == 0 {
                    ...
                    v_isSharedCheck_728_ = (!lean_is_exclusive(v_inst_712_)) as u8;
                    if v_isSharedCheck_728_ == 0 {
                        v_unused_729_ = lean_ctor_get(v_inst_712_, 1);
                    ...
                    v_toApplicative_730_ = lean_ctor_get(v_inst_712_, 0);
                    v_toBind_731_ = lean_ctor_get(v_inst_712_, 1);
                    lean_inc_n(v_toBind_731_, 4);
                    v_toPure_732_ = lean_ctor_get(v_toApplicative_730_, 1);
                    lean_inc_n(v_toPure_732_, 4);
                    lean_inc_ref(v_e_715_);
                    v___f_733_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__4 as *mut core::ffi::c_void, 7, 6);
                    lean_closure_set(v___f_733_, 0, v_toPure_732_);
                    lean_closure_set(v___f_733_, 1, v_inst_712_);
                    lean_closure_set(v___f_733_, 2, v_inst_713_);
                    lean_closure_set(v___f_733_, 3, v_mvarId_714_);
                    lean_closure_set(v___f_733_, 4, v_toBind_731_);
                    lean_closure_set(v___f_733_, 5, v_e_715_);
                    v___f_734_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__6 as *mut core::ffi::c_void, 5, 4);
                    lean_closure_set(v___f_734_, 0, v_toPure_732_);
                    lean_closure_set(v___f_734_, 1, v_e_715_);
                    lean_closure_set(v___f_734_, 2, v_toBind_731_);
                    lean_closure_set(v___f_734_, 3, v___f_733_);
                    v___f_735_ = lean_alloc_closure(l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__7 as *mut core::ffi::c_void, 2, 1);
                    lean_closure_set(v___f_735_, 0, v_toPure_732_);
                    lean_inc_ref(v_a_716_);
                    v___x_736_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v___x_736_, 0, v_a_716_);
                    lean_ctor_set(v___x_736_, 1, v_a_716_);
                    v___x_737_ = lean_apply_2(v_toPure_732_, lean_box(0), v___x_736_);
            ...
            1 => {
                v_toPure_722_ = lean_ctor_get(v_toApplicative_718_, 1);
                ...
                if v_isShared_721_ == 0 {
                    ...
                    v_reuseFailAlloc_727_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_727_, 0, v___x_723_);
                    lean_ctor_set(v_reuseFailAlloc_727_, 1, v_a_716_);
            ...
            2 => {
                v___x_726_ = lean_apply_2(v_toPure_722_, lean_box(0), v___x_725_);
                return v___x_726_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit___redArg___lam__0(
    ...
    mut v_mvarId_743_: *mut LeanObject,
    mut v_b_744_: *mut LeanObject,
    mut v_____x_745_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_746_: *mut LeanObject = core::ptr::null_mut();
    v_fst_746_ = lean_ctor_get(v_____x_745_, 0);
    if lean_obj_tag(v_fst_746_) == 0 {
        ...
        v___x_747_ = lean_apply_2(v_toPure_740_, lean_box(0), v_____x_745_);
        return v___x_747_;
    } else {
        ...
        v_snd_748_ = lean_ctor_get(v_____x_745_, 1);
        lean_inc(v_snd_748_);
        lean_dec_ref(v_____x_745_);
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visitMVar(
    mut v_m_750_: *mut LeanObject,
    mut v_inst_751_: *mut LeanObject,
    mut v_inst_752_: *mut LeanObject,
    mut v_mvarId_753_: *mut LeanObject,
    mut v_mvarId_x27_754_: *mut LeanObject,
...
pub unsafe fn l___private_Lean_Util_OccursCheck_0__Lean_occursCheck_visit(
    ...
    mut v_mvarId_760_: *mut LeanObject,
...
pub unsafe fn l_Lean_occursCheck___redArg___lam__0(
    ...
    if lean_obj_tag(v_fst_768_) == 0 {
        ...
        v_toPure_772_ = lean_ctor_get(v_toApplicative_764_, 1);
        lean_inc(v_toPure_772_);
        lean_dec_ref(v_toApplicative_764_);
        v___x_773_ = lean_box((v___x_766_) as usize);
        v___x_774_ = lean_apply_2(v_toPure_772_, lean_box(0), v___x_773_);
        return v___x_774_;
    }
}
pub unsafe fn l_Lean_occursCheck___redArg___lam__0___boxed(
    mut v_toApplicative_775_: *mut LeanObject,
    mut v___x_776_: *mut LeanObject,
    mut v___x_777_: *mut LeanObject,
    mut v_____do__lift_778_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_245__boxed_779_: u8 = 0;
    let mut v___x_246__boxed_780_: u8 = 0;
    let mut v_res_781_: *mut LeanObject = core::ptr::null_mut();
    v___x_245__boxed_779_ = (lean_unbox(v___x_776_) as u8);
    v___x_246__boxed_780_ = (lean_unbox(v___x_777_) as u8);
    ...
    lean_dec_ref(v_____do__lift_778_);
    return v_res_781_;
}
pub unsafe fn _init_l_Lean_occursCheck___redArg___closed__0() -> *mut LeanObject {
    let mut v___x_782_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_783_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_784_: *mut LeanObject = core::ptr::null_mut();
    v___x_782_ = lean_box(0);
    v___x_783_ = lean_unsigned_to_nat(16);
    v___x_784_ = lean_mk_array(v___x_783_, v___x_782_);
    return v___x_784_;
}
pub unsafe fn _init_l_Lean_occursCheck___redArg___closed__1() -> *mut LeanObject {
    ...
    v___x_786_ = lean_unsigned_to_nat(0);
...
pub unsafe fn l_Lean_occursCheck___redArg(
    ...
    mut v_mvarId_790_: *mut LeanObject,
    mut v_e_791_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_792_: u8 = 0;
    v___x_792_ = l_Lean_Expr_hasExprMVar(v_e_791_);
    if v___x_792_ == 0 {
        let mut v_toApplicative_793_: *mut LeanObject = core::ptr::null_mut();
        let mut v_toPure_794_: *mut LeanObject = core::ptr::null_mut();
        ...
        v_toApplicative_793_ = lean_ctor_get(v_inst_788_, 0);
        lean_inc_ref(v_toApplicative_793_);
        lean_dec_ref(v_inst_788_);
        v_toPure_794_ = lean_ctor_get(v_toApplicative_793_, 1);
        lean_inc(v_toPure_794_);
        lean_dec_ref(v_toApplicative_793_);
        v___x_795_ = 1;
        v___x_796_ = lean_box((v___x_795_) as usize);
        v___x_797_ = lean_apply_2(v_toPure_794_, lean_box(0), v___x_796_);
        return v___x_797_;
    } else {
        let mut v_toApplicative_798_: *mut LeanObject = core::ptr::null_mut();
        let mut v_toBind_799_: *mut LeanObject = core::ptr::null_mut();
        ...
        v_toApplicative_798_ = lean_ctor_get(v_inst_788_, 0);
        v_toBind_799_ = lean_ctor_get(v_inst_788_, 1);
        lean_inc(v_toBind_799_);
        v___x_800_ = 0;
        v___x_801_ = lean_box((v___x_800_) as usize);
        v___x_802_ = lean_box((v___x_792_) as usize);
        ...
        lean_closure_set(v___f_803_, 0, v_toApplicative_798_);
        lean_closure_set(v___f_803_, 1, v___x_801_);
        lean_closure_set(v___f_803_, 2, v___x_802_);
...
pub unsafe fn l_Lean_occursCheck(
    ...
    mut v_mvarId_810_: *mut LeanObject,
...
pub unsafe fn runtime_initialize_Lean_Util_OccursCheck(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Util_OccursCheck(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Util_OccursCheck(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
