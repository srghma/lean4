...
pub static mut l_Lean_Language_Lean_instToSnapshotTreeCommandResultSnapshot: *mut LeanObject = core::ptr::addr_of!(
    l_Lean_Language_Lean_instToSnapshotTreeCommandResultSnapshot___closed__0_value
)
    as *mut LeanObject;
...
pub static l_Lean_Language_Lean_instToSnapshotTreeCommandElaboratingSnapshot_go___closed__1_value: LeanClosureObject<0> = LeanClosureObject { m_header: LeanObject { rc: 0, cs_size: (core::mem::size_of::<LeanObject>() + core::mem::size_of::<*const core::ffi::c_void>() + 4 + core::mem::size_of::<*mut LeanObject>()*0) as u16, other: 0, tag: 245 }, m_fun: l_Lean_Language_Lean_instToSnapshotTreeCommandElaboratingSnapshot_go___lam__2 as *const core::ffi::c_void, m_arity: 1, m_num_fixed: 0, m_objs: [] };
...
pub static mut l_Lean_Language_Lean_instToSnapshotTreeCommandElaboratingSnapshot: *mut LeanObject = core::ptr::addr_of!(
    l_Lean_Language_Lean_instToSnapshotTreeCommandElaboratingSnapshot___closed__0_value
)
    as *mut LeanObject;
...
pub static mut l_Lean_Language_Lean_instToSnapshotTreeCommandParsedSnapshot: *mut LeanObject = core::ptr::addr_of!(
    l_Lean_Language_Lean_instToSnapshotTreeCommandParsedSnapshot___closed__0_value
)
    as *mut LeanObject;
...
pub static mut l_Lean_Language_Lean_instToSnapshotTreeHeaderProcessedSnapshot: *mut LeanObject = core::ptr::addr_of!(
    l_Lean_Language_Lean_instToSnapshotTreeHeaderProcessedSnapshot___closed__0_value
)
    as *mut LeanObject;
...
pub static mut l_Lean_Language_Lean_instToSnapshotTreeHeaderParsedSnapshot: *mut LeanObject = core::ptr::addr_of!(
    l_Lean_Language_Lean_instToSnapshotTreeHeaderParsedSnapshot___closed__0_value
)
    as *mut LeanObject;
...
static mut l_Lean_Language_Lean_HeaderParsedSnapshot_processedResult___closed__0: *mut LeanObject =
    core::ptr::null_mut();
...
static mut l_Lean_Language_Lean_HeaderParsedSnapshot_processedResult___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Language_Lean_HeaderParsedSnapshot_processedResult___closed__1_value)
        as *mut LeanObject;
pub unsafe fn l_Lean_Language_Lean_pushOpt___redArg(
    mut v_a_x3f_179_: *mut LeanObject,
    mut v_as_180_: *mut LeanObject,
) -> *mut LeanObject {
    if lean_obj_tag(v_a_x3f_179_) == 0 {
        return v_as_180_;
    } else {
        let mut v_val_181_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_182_: *mut LeanObject = core::ptr::null_mut();
        v_val_181_ = lean_ctor_get(v_a_x3f_179_, 0);
        lean_inc(v_val_181_);
        lean_dec_ref_known(v_a_x3f_179_, 1);
...
pub unsafe fn l_Lean_Language_Lean_pushOpt(
    ...
    mut v_a_x3f_184_: *mut LeanObject,
    mut v_as_185_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Language_Lean_instToSnapshotTreeCommandResultSnapshot___lam__0(
    ...
    let mut v_toSnapshot_190_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_199_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_toSnapshot_190_ = lean_ctor_get(v_s_189_, 0);
                v_isSharedCheck_198_ = (!lean_is_exclusive(v_s_189_)) as u8;
                if v_isSharedCheck_198_ == 0 {
                    v_unused_199_ = lean_ctor_get(v_s_189_, 1);
            ...
            1 => {
                ...
                if v_isShared_193_ == 0 {
                    ...
                    lean_ctor_set(v_reuseFailAlloc_197_, 0, v_toSnapshot_190_);
...
pub unsafe fn l_Lean_Language_Lean_instToSnapshotTreeCommandElaboratingSnapshot_go___lam__0(
    mut v_s_202_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_tree_203_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_204_: *mut LeanObject = core::ptr::null_mut();
    v_tree_203_ = lean_ctor_get(v_s_202_, 1);
...
pub unsafe fn l_Lean_Language_Lean_instToSnapshotTreeCommandElaboratingSnapshot_go___lam__2(
    ...
    v___x_209_ = lean_alloc_ctor(0, 2, (0) as u32);
    lean_ctor_set(v___x_209_, 0, v_s_207_);
...
pub unsafe fn l_Lean_Language_Lean_instToSnapshotTreeCommandElaboratingSnapshot_go(
    ...
    let mut v_elabSnap_213_: *mut LeanObject = core::ptr::null_mut();
    let mut v_resultSnap_214_: *mut LeanObject = core::ptr::null_mut();
    let mut v_infoTreeSnap_215_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toSnapshot_216_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportSnap_217_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_x3f_218_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_219_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_x3f_220_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_221_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_x3f_222_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_223_: *mut LeanObject = core::ptr::null_mut();
    ...
    v_elabSnap_213_ = lean_ctor_get(v_s_212_, 1);
    lean_inc_ref(v_elabSnap_213_);
    v_resultSnap_214_ = lean_ctor_get(v_s_212_, 2);
    lean_inc_ref(v_resultSnap_214_);
    v_infoTreeSnap_215_ = lean_ctor_get(v_s_212_, 3);
    lean_inc_ref(v_infoTreeSnap_215_);
    v_toSnapshot_216_ = lean_ctor_get(v_s_212_, 0);
    lean_inc_ref(v_toSnapshot_216_);
    v_reportSnap_217_ = lean_ctor_get(v_s_212_, 4);
    lean_inc_ref(v_reportSnap_217_);
    lean_dec_ref(v_s_212_);
    v_stx_x3f_218_ = lean_ctor_get(v_elabSnap_213_, 0);
    lean_inc(v_stx_x3f_218_);
    v_reportingRange_219_ = lean_ctor_get(v_elabSnap_213_, 1);
    lean_inc(v_reportingRange_219_);
    v_stx_x3f_220_ = lean_ctor_get(v_resultSnap_214_, 0);
    lean_inc(v_stx_x3f_220_);
    v_reportingRange_221_ = lean_ctor_get(v_resultSnap_214_, 1);
    lean_inc(v_reportingRange_221_);
    v_stx_x3f_222_ = lean_ctor_get(v_infoTreeSnap_215_, 0);
    lean_inc(v_stx_x3f_222_);
    v_reportingRange_223_ = lean_ctor_get(v_infoTreeSnap_215_, 1);
    lean_inc(v_reportingRange_223_);
    ...
    v___x_231_ = lean_unsigned_to_nat(4);
    ...
    v___x_237_ = lean_alloc_ctor(0, 2, (0) as u32);
    lean_ctor_set(v___x_237_, 0, v_toSnapshot_216_);
...
pub unsafe fn l_Lean_Language_Lean_instToSnapshotTreeCommandParsedSnapshot_go(
    ...
    let mut v_toSnapshot_241_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_242_: *mut LeanObject = core::ptr::null_mut();
    let mut v_elabSnap_243_: *mut LeanObject = core::ptr::null_mut();
    let mut v_nextCmdSnap_x3f_244_: *mut LeanObject = core::ptr::null_mut();
    let mut v___y_246_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_stx_x3f_260_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_261_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_toSnapshot_241_ = lean_ctor_get(v_s_240_, 0);
                lean_inc_ref(v_toSnapshot_241_);
                v_stx_242_ = lean_ctor_get(v_s_240_, 1);
                lean_inc(v_stx_242_);
                v_elabSnap_243_ = lean_ctor_get(v_s_240_, 3);
                lean_inc_ref(v_elabSnap_243_);
                v_nextCmdSnap_x3f_244_ = lean_ctor_get(v_s_240_, 4);
                lean_inc(v_nextCmdSnap_x3f_244_);
                lean_dec_ref(v_s_240_);
                if lean_obj_tag(v_nextCmdSnap_x3f_244_) == 0 {
                    v___x_255_ = lean_box(0);
                    v___y_246_ = v___x_255_;
                    state = 1;
                    continue;
                } else {
                    v_val_256_ = lean_ctor_get(v_nextCmdSnap_x3f_244_, 0);
                    v_isSharedCheck_268_ = (!lean_is_exclusive(v_nextCmdSnap_x3f_244_)) as u8;
                    if v_isSharedCheck_268_ == 0 {
                        ...
                        lean_inc(v_val_256_);
                        lean_dec(v_nextCmdSnap_x3f_244_);
            ...
            1 => {
                v___x_247_ = lean_alloc_ctor(1, 1, (0) as u32);
                lean_ctor_set(v___x_247_, 0, v_stx_242_);
                ...
                v___x_250_ = lean_unsigned_to_nat(1);
                ...
                v___x_254_ = lean_alloc_ctor(0, 2, (0) as u32);
                lean_ctor_set(v___x_254_, 0, v_toSnapshot_241_);
                lean_ctor_set(v___x_254_, 1, v___x_253_);
                return v___x_254_;
            }
            2 => {
                v_stx_x3f_260_ = lean_ctor_get(v_val_256_, 0);
                lean_inc(v_stx_x3f_260_);
                v_reportingRange_261_ = lean_ctor_get(v_val_256_, 1);
                lean_inc(v_reportingRange_261_);
                v___x_262_ = lean_alloc_closure(
                ...
                if v_isShared_259_ == 0 {
                    ...
                    v_reuseFailAlloc_267_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Language_Lean_instToSnapshotTreeHeaderProcessedSnapshot___lam__1(
    mut v___f_271_: *mut LeanObject,
    mut v_s_272_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_toSnapshot_273_: *mut LeanObject = core::ptr::null_mut();
    let mut v_metaSnap_274_: *mut LeanObject = core::ptr::null_mut();
    let mut v_result_x3f_275_: *mut LeanObject = core::ptr::null_mut();
    let mut v___y_277_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_x3f_278_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_279_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_firstCmdSnap_292_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_x3f_293_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_294_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_300_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_301_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_toSnapshot_273_ = lean_ctor_get(v_s_272_, 0);
                lean_inc_ref(v_toSnapshot_273_);
                v_metaSnap_274_ = lean_ctor_get(v_s_272_, 1);
                lean_inc_ref(v_metaSnap_274_);
                v_result_x3f_275_ = lean_ctor_get(v_s_272_, 2);
                lean_inc(v_result_x3f_275_);
                lean_dec_ref(v_s_272_);
                if lean_obj_tag(v_result_x3f_275_) == 0 {
                    v___x_287_ = lean_box(0);
                    v___y_277_ = v___x_287_;
                    state = 1;
                    continue;
                } else {
                    v_val_288_ = lean_ctor_get(v_result_x3f_275_, 0);
                    v_isSharedCheck_301_ = (!lean_is_exclusive(v_result_x3f_275_)) as u8;
            ...
            1 => {
                v_stx_x3f_278_ = lean_ctor_get(v_metaSnap_274_, 0);
                lean_inc(v_stx_x3f_278_);
                v_reportingRange_279_ = lean_ctor_get(v_metaSnap_274_, 1);
                lean_inc(v_reportingRange_279_);
                v___x_280_ = 1;
                ...
                v___x_282_ = lean_unsigned_to_nat(1);
                ...
                lean_ctor_set(v___x_286_, 0, v_toSnapshot_273_);
                lean_ctor_set(v___x_286_, 1, v___x_285_);
                return v___x_286_;
            }
            2 => {
                v_firstCmdSnap_292_ = lean_ctor_get(v_val_288_, 1);
                lean_inc_ref(v_firstCmdSnap_292_);
                lean_dec(v_val_288_);
                v_stx_x3f_293_ = lean_ctor_get(v_firstCmdSnap_292_, 0);
                lean_inc(v_stx_x3f_293_);
                v_reportingRange_294_ = lean_ctor_get(v_firstCmdSnap_292_, 1);
                lean_inc(v_reportingRange_294_);
                v___x_295_ =
                ...
                if v_isShared_291_ == 0 {
                    ...
                    v_reuseFailAlloc_300_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Language_Lean_instToSnapshotTreeHeaderParsedSnapshot___lam__3(
    ...
    mut v___f_306_: *mut LeanObject,
    mut v_s_307_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_toSnapshot_308_: *mut LeanObject = core::ptr::null_mut();
    let mut v_metaSnap_309_: *mut LeanObject = core::ptr::null_mut();
    let mut v_result_x3f_310_: *mut LeanObject = core::ptr::null_mut();
    let mut v___y_312_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_x3f_313_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_314_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_val_323_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_325_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_326_: u8 = 0;
    let mut v_processedSnap_327_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stx_x3f_328_: *mut LeanObject = core::ptr::null_mut();
    let mut v_reportingRange_329_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_334_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_335_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_toSnapshot_308_ = lean_ctor_get(v_s_307_, 0);
                lean_inc_ref(v_toSnapshot_308_);
                v_metaSnap_309_ = lean_ctor_get(v_s_307_, 1);
                lean_inc_ref(v_metaSnap_309_);
                v_result_x3f_310_ = lean_ctor_get(v_s_307_, 4);
                lean_inc(v_result_x3f_310_);
                lean_dec_ref(v_s_307_);
                if lean_obj_tag(v_result_x3f_310_) == 0 {
                    ...
                    v_val_323_ = lean_ctor_get(v_result_x3f_310_, 0);
                    v_isSharedCheck_335_ = (!lean_is_exclusive(v_result_x3f_310_)) as u8;
            ...
            1 => {
                v_stx_x3f_313_ = lean_ctor_get(v_metaSnap_309_, 0);
                lean_inc(v_stx_x3f_313_);
                v_reportingRange_314_ = lean_ctor_get(v_metaSnap_309_, 1);
                lean_inc(v_reportingRange_314_);
                v___x_315_ = 1;
                ...
                v___x_321_ = lean_alloc_ctor(0, 2, (0) as u32);
                lean_ctor_set(v___x_321_, 0, v_toSnapshot_308_);
                lean_ctor_set(v___x_321_, 1, v___x_320_);
                return v___x_321_;
            }
            2 => {
                v_processedSnap_327_ = lean_ctor_get(v_val_323_, 1);
                lean_inc_ref(v_processedSnap_327_);
                lean_dec(v_val_323_);
                v_stx_x3f_328_ = lean_ctor_get(v_processedSnap_327_, 0);
                lean_inc(v_stx_x3f_328_);
                v_reportingRange_329_ = lean_ctor_get(v_processedSnap_327_, 1);
                lean_inc(v_reportingRange_329_);
                v___x_330_ = 1;
                ...
                if v_isShared_326_ == 0 {
                    ...
                    v_reuseFailAlloc_334_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Language_Lean_HeaderParsedSnapshot_processedResult___lam__0(
    ...
    let mut v_result_x3f_341_: *mut LeanObject = core::ptr::null_mut();
    v_result_x3f_341_ = lean_ctor_get(v_x_340_, 2);
    lean_inc(v_result_x3f_341_);
...
pub unsafe fn l_Lean_Language_Lean_HeaderParsedSnapshot_processedResult(
    mut v_snap_347_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_result_x3f_348_: *mut LeanObject = core::ptr::null_mut();
    v_result_x3f_348_ = lean_ctor_get(v_snap_347_, 4);
    lean_inc(v_result_x3f_348_);
    lean_dec_ref(v_snap_347_);
    if lean_obj_tag(v_result_x3f_348_) == 0 {
        ...
        let mut v_processedSnap_351_: *mut LeanObject = core::ptr::null_mut();
        let mut v_stx_x3f_352_: *mut LeanObject = core::ptr::null_mut();
        let mut v_reportingRange_353_: *mut LeanObject = core::ptr::null_mut();
        ...
        v_val_350_ = lean_ctor_get(v_result_x3f_348_, 0);
        lean_inc(v_val_350_);
        lean_dec_ref_known(v_result_x3f_348_, 1);
        v_processedSnap_351_ = lean_ctor_get(v_val_350_, 1);
        lean_inc_ref(v_processedSnap_351_);
        lean_dec(v_val_350_);
        v_stx_x3f_352_ = lean_ctor_get(v_processedSnap_351_, 0);
        lean_inc(v_stx_x3f_352_);
        v_reportingRange_353_ = lean_ctor_get(v_processedSnap_351_, 1);
        lean_inc(v_reportingRange_353_);
...
pub unsafe fn runtime_initialize_Lean_Language_Lean_Types(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Language_Lean_Types(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Language_Lean_Types(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
