...
pub static l_Lean_Elab_instInhabitedWhereFinallyView_default___closed__0_value: LeanCtorObject<2> =
    LeanCtorObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_Lean_Elab_instInhabitedWhereFinallyView_default___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Elab_instInhabitedWhereFinallyView_default___closed__0_value)
        as *mut LeanObject;
pub static mut l_Lean_Elab_instInhabitedWhereFinallyView_default: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Elab_instInhabitedWhereFinallyView_default___closed__0_value)
        as *mut LeanObject;
pub static mut l_Lean_Elab_instInhabitedWhereFinallyView: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Elab_instInhabitedWhereFinallyView_default___closed__0_value)
        as *mut LeanObject;
pub static mut l_Lean_Elab_WhereFinallyView_none: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Elab_instInhabitedWhereFinallyView_default___closed__0_value)
        as *mut LeanObject;
pub static l_Lean_Elab_mkWhereFinallyView___redArg___closed__0_value: LeanStringObject<93> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
        ...
        m_length: 92,
        m_data: [
            96, 119, 104, 101, 114, 101, 32, 46, 46, 46, 32, 102, 105, 110, 97, 108, 108, 121, 96,
            32, 100, 111, 101, 115, 32, 110, 111, 116, 32, 99, 117, 114, 114, 101, 110, 116, 108,
            121, 32, 115, 117, 112, 112, 111, 114, 116, 32, 97, 110, 121, 32, 110, 97, 109, 101,
            100, 32, 115, 117, 98, 45, 115, 101, 99, 116, 105, 111, 110, 115, 32, 96, 124, 32, 115,
            101, 99, 116, 105, 111, 110, 78, 97, 109, 101, 32, 61, 62, 32, 46, 46, 46, 96, 0,
        ],
    };
static mut l_Lean_Elab_mkWhereFinallyView___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Elab_mkWhereFinallyView___redArg___closed__0_value)
        as *mut LeanObject;
static mut l_Lean_Elab_mkWhereFinallyView___redArg___closed__1_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_Elab_mkWhereFinallyView___redArg___closed__1: *mut LeanObject =
    core::ptr::null_mut();
pub unsafe fn l_Lean_Elab_WhereFinallyView_isNone(mut v_o_78_: *mut LeanObject) -> u8 {
    let mut v_ref_79_: *mut LeanObject = core::ptr::null_mut();
    let mut v_tactic_80_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_81_: u8 = 0;
    v_ref_79_ = lean_ctor_get(v_o_78_, 0);
    v_tactic_80_ = lean_ctor_get(v_o_78_, 1);
...
pub unsafe fn l_Lean_Elab_WhereFinallyView_isNone___boxed(
    ...
    lean_dec_ref(v_o_83_);
    v_r_85_ = lean_box((v_res_84_) as usize);
    return v_r_85_;
}
pub unsafe fn l_Lean_Elab_mkWhereFinallyView___redArg___lam__0(
    mut v_inst_86_: *mut LeanObject,
    mut v_whereFinally_87_: *mut LeanObject,
    mut v_____r_88_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_toApplicative_89_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_91_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_92_: u8 = 0;
    let mut v_toPure_93_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_94_: *mut LeanObject = core::ptr::null_mut();
    let mut v_tactic_95_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v_isSharedCheck_100_ = (!lean_is_exclusive(v_inst_86_)) as u8;
                if v_isSharedCheck_100_ == 0 {
                    v_unused_101_ = lean_ctor_get(v_inst_86_, 1);
            ...
            1 => {
                v_toPure_93_ = lean_ctor_get(v_toApplicative_89_, 1);
                lean_inc(v_toPure_93_);
                lean_dec_ref(v_toApplicative_89_);
                v___x_94_ = lean_unsigned_to_nat(1);
                v_tactic_95_ = l_Lean_Syntax_getArg(v_whereFinally_87_, v___x_94_);
                if v_isShared_92_ == 0 {
                    lean_ctor_set(v___x_91_, 1, v_tactic_95_);
                    lean_ctor_set(v___x_91_, 0, v_whereFinally_87_);
                    v___x_97_ = v___x_91_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_99_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_99_, 0, v_whereFinally_87_);
                    lean_ctor_set(v_reuseFailAlloc_99_, 1, v_tactic_95_);
            ...
            2 => {
                v___x_98_ = lean_apply_2(v_toPure_93_, lean_box(0), v___x_97_);
                return v___x_98_;
            }
            _ => {}
        }
...
pub unsafe fn l_Lean_Elab_mkWhereFinallyView___redArg___lam__1(
    mut v___f_102_: *mut LeanObject,
    mut v_____r_103_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_104_: *mut LeanObject = core::ptr::null_mut();
    v___x_104_ = lean_apply_1(v___f_102_, v_____r_103_);
    return v___x_104_;
}
pub unsafe fn _init_l_Lean_Elab_mkWhereFinallyView___redArg___closed__1() -> *mut LeanObject {
...
pub unsafe fn l_Lean_Elab_mkWhereFinallyView___redArg(
    ...
    let mut v_whereFinally_114_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_toBind_119_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_toApplicative_128_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_130_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_131_: u8 = 0;
    let mut v_toPure_132_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_139_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v___x_111_ = lean_unsigned_to_nat(2);
                ...
                if v___x_115_ == 0 {
                    ...
                    lean_closure_set(v___f_116_, 1, v_whereFinally_114_);
                    ...
                    lean_dec(v_whereFinally_114_);
                    lean_dec_ref(v_inst_109_);
                    v_toApplicative_128_ = lean_ctor_get(v_inst_108_, 0);
                    v_isSharedCheck_138_ = (!lean_is_exclusive(v_inst_108_)) as u8;
                    if v_isSharedCheck_138_ == 0 {
                        v_unused_139_ = lean_ctor_get(v_inst_108_, 1);
            ...
            1 => {
                v_toBind_119_ = lean_ctor_get(v_inst_108_, 1);
            ...
            2 => {
                v_toPure_132_ = lean_ctor_get(v_toApplicative_128_, 1);
                lean_inc(v_toPure_132_);
                lean_dec_ref(v_toApplicative_128_);
                v___x_133_ = lean_box(0);
                if v_isShared_131_ == 0 {
                    lean_ctor_set(v___x_130_, 1, v___x_133_);
                    lean_ctor_set(v___x_130_, 0, v_stx_110_);
                    v___x_135_ = v___x_130_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_137_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_137_, 0, v_stx_110_);
            ...
            3 => {
                v___x_136_ = lean_apply_2(v_toPure_132_, lean_box(0), v___x_135_);
                return v___x_136_;
            }
            _ => {}
        }
...
pub unsafe fn runtime_initialize_Lean_Elab_WhereFinally(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Elab_WhereFinally(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Elab_WhereFinally(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
