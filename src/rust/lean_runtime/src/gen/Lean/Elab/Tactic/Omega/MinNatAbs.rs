...
pub unsafe fn l_List_filterTR_loop___at___00Lean_Elab_Tactic_Omega_List_nonzeroMinimum_spec__0(
    ...
    let mut v_reuseFailAlloc_96_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if lean_obj_tag(v_a_83_) == 0 {
                    ...
                    v_isSharedCheck_98_ = (!lean_is_exclusive(v_a_83_)) as u8;
            ...
            1 => {
                v___x_91_ = lean_unsigned_to_nat(0);
                ...
                if v___x_92_ == 0 {
                    if v_isShared_90_ == 0 {
                        ...
                        v_reuseFailAlloc_96_ = lean_alloc_ctor(1, 2, (0) as u32);
                        lean_ctor_set(v_reuseFailAlloc_96_, 0, v_head_86_);
                        lean_ctor_set(v_reuseFailAlloc_96_, 1, v_a_84_);
...
pub unsafe fn l_List_min_x3f___at___00Lean_Elab_Tactic_Omega_List_nonzeroMinimum_spec__1(
    ...
    if lean_obj_tag(v_x_109_) == 0 {
        ...
        let mut v_head_111_: *mut LeanObject = core::ptr::null_mut();
        let mut v_tail_112_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_List_mapTR_loop___at___00Lean_Elab_Tactic_Omega_List_minNatAbs_spec__0(
    ...
    let mut v_head_126_: *mut LeanObject = core::ptr::null_mut();
    let mut v_tail_127_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_135_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if lean_obj_tag(v_a_123_) == 0 {
                    ...
                    v_isSharedCheck_136_ = (!lean_is_exclusive(v_a_123_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_130_ == 0 {
                    ...
                    v_reuseFailAlloc_135_ = lean_alloc_ctor(1, 2, (0) as u32);
...
pub unsafe fn l_List_foldl___at___00List_max_x3f___at___00Lean_Elab_Tactic_Omega_List_maxNatAbs_spec__0_spec__0(
    ...
    let mut v_head_143_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_List_max_x3f___at___00Lean_Elab_Tactic_Omega_List_maxNatAbs_spec__0(
    ...
    if lean_obj_tag(v_x_151_) == 0 {
        ...
        let mut v_head_153_: *mut LeanObject = core::ptr::null_mut();
        let mut v_tail_154_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_155_: *mut LeanObject = core::ptr::null_mut();
        let mut v___x_156_: *mut LeanObject = core::ptr::null_mut();
        v_head_153_ = lean_ctor_get(v_x_151_, 0);
        ...
        v___x_156_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Elab_Tactic_Omega_List_maxNatAbs(
    ...
    if lean_obj_tag(v___x_162_) == 0 {
        ...
        v___x_163_ = lean_unsigned_to_nat(0);
        return v___x_163_;
    } else {
        let mut v_val_164_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn runtime_initialize_Lean_Elab_Tactic_Omega_MinNatAbs(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Elab_Tactic_Omega_MinNatAbs(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Elab_Tactic_Omega_MinNatAbs(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
