...
pub unsafe fn runtime_initialize_Lean_Elab_Tactic_Conv(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Elab_Tactic_Conv(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Elab_Tactic_Conv(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
