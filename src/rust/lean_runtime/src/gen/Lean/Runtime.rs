...
static mut l_Lean_closureMaxArgs___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_closureMaxArgs___closed__0: *mut LeanObject = core::ptr::null_mut();
pub static mut l_Lean_closureMaxArgs: *mut LeanObject = core::ptr::null_mut();
static mut l_Lean_maxSmallNat___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_maxSmallNat___closed__0: *mut LeanObject = core::ptr::null_mut();
pub static mut l_Lean_maxSmallNat: *mut LeanObject = core::ptr::null_mut();
static mut l_Lean_libUVVersion___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_libUVVersion___closed__0: *mut LeanObject = core::ptr::null_mut();
pub static mut l_Lean_libUVVersion: *mut LeanObject = core::ptr::null_mut();
pub unsafe fn l_Lean_closureMaxArgsFn___boxed(
    mut v_a_00___x40___internal___hyg_20_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_res_21_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Lean_libUVVersionFn___boxed(
    mut v_a_00___x40___internal___hyg_26_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_res_27_: *mut LeanObject = core::ptr::null_mut();
    v_res_27_ = lean_libuv_version(v_a_00___x40___internal___hyg_26_);
    return v_res_27_;
}
pub unsafe fn _init_l_Lean_closureMaxArgs___closed__0() -> *mut LeanObject {
...
pub unsafe fn _init_l_Lean_closureMaxArgs() -> *mut LeanObject {
    let mut v___x_30_: *mut LeanObject = core::ptr::null_mut();
    v___x_30_ = lean_obj_once(
...
pub unsafe fn _init_l_Lean_maxSmallNat___closed__0() -> *mut LeanObject {
...
pub unsafe fn _init_l_Lean_maxSmallNat() -> *mut LeanObject {
    let mut v___x_33_: *mut LeanObject = core::ptr::null_mut();
    v___x_33_ = lean_obj_once(
...
pub unsafe fn _init_l_Lean_libUVVersion___closed__0() -> *mut LeanObject {
...
pub unsafe fn _init_l_Lean_libUVVersion() -> *mut LeanObject {
    let mut v___x_36_: *mut LeanObject = core::ptr::null_mut();
    v___x_36_ = lean_obj_once(
...
pub unsafe fn runtime_initialize_Lean_Runtime(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Runtime(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Runtime(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
