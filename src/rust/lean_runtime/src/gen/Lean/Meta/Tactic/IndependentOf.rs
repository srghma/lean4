...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_MVarId_isIndependentOf_spec__0___redArg(
    ...
    let mut v_mctx_282_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_283_: *mut LeanObject = core::ptr::null_mut();
    let mut v_fst_284_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_285_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_286_: *mut LeanObject = core::ptr::null_mut();
    let mut v_cache_287_: *mut LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_288_: *mut LeanObject = core::ptr::null_mut();
    let mut v_postponed_289_: *mut LeanObject = core::ptr::null_mut();
    let mut v_diag_290_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_279_ == 0 {
                    ...
                    lean_ctor_set(v___x_280_, 0, v_e_276_);
                    return v___x_280_;
                } else {
                    ...
                    v_cache_287_ = lean_ctor_get(v___x_286_, 1);
                    v_zetaDeltaFVarIds_288_ = lean_ctor_get(v___x_286_, 2);
                    v_postponed_289_ = lean_ctor_get(v___x_286_, 3);
                    v_diag_290_ = lean_ctor_get(v___x_286_, 4);
                    v_isSharedCheck_299_ = (!lean_is_exclusive(v___x_286_)) as u8;
                    if v_isSharedCheck_299_ == 0 {
                        v_unused_300_ = lean_ctor_get(v___x_286_, 0);
                        ...
                        lean_inc(v_diag_290_);
                        lean_inc(v_postponed_289_);
                        lean_inc(v_zetaDeltaFVarIds_288_);
                        lean_inc(v_cache_287_);
                        lean_dec(v___x_286_);
            ...
            1 => {
                if v_isShared_293_ == 0 {
                    lean_ctor_set(v___x_292_, 0, v_snd_285_);
                    v___x_295_ = v___x_292_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_298_ = lean_alloc_ctor(0, 5, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_298_, 0, v_snd_285_);
                    lean_ctor_set(v_reuseFailAlloc_298_, 1, v_cache_287_);
                    lean_ctor_set(v_reuseFailAlloc_298_, 2, v_zetaDeltaFVarIds_288_);
                    lean_ctor_set(v_reuseFailAlloc_298_, 3, v_postponed_289_);
                    lean_ctor_set(v_reuseFailAlloc_298_, 4, v_diag_290_);
            ...
            2 => {
                ...
                v___x_297_ = lean_alloc_ctor(0, 1, (0) as u32);
                lean_ctor_set(v___x_297_, 0, v_fst_284_);
                return v___x_297_;
            }
            _ => {}
        }
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_isIndependentOf_spec__3___redArg(
    mut v_mvarId_319_: *mut LeanObject,
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_326_) == 0 {
                    ...
                    v_isSharedCheck_334_ = (!lean_is_exclusive(v___x_326_)) as u8;
                    ...
                    v_isSharedCheck_342_ = (!lean_is_exclusive(v___x_326_)) as u8;
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_isIndependentOf_spec__3___redArg___boxed(
    mut v_mvarId_343_: *mut LeanObject,
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_isIndependentOf_spec__3(
    ...
    mut v_mvarId_352_: *mut LeanObject,
...
pub unsafe fn l_Lean_MVarId_withContext___at___00Lean_MVarId_isIndependentOf_spec__3___boxed(
    ...
    mut v_mvarId_361_: *mut LeanObject,
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_contains___at___00Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_MVarId_isIndependentOf_spec__1_spec__1___redArg(
    ...
    let mut v_tail_373_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_MVarId_isIndependentOf_spec__1___redArg(
    ...
    let mut v_buckets_382_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if lean_obj_tag(v_x_404_) == 0 {
                    v___x_410_ = 1;
                    v___x_411_ = lean_box((v___x_410_) as usize);
                    v___x_412_ = lean_alloc_ctor(0, 1, (0) as u32);
                    lean_ctor_set(v___x_412_, 0, v___x_411_);
                    return v___x_412_;
                } else {
                    v_head_413_ = lean_ctor_get(v_x_404_, 0);
                    lean_inc(v_head_413_);
                    v_tail_414_ = lean_ctor_get(v_x_404_, 1);
                    ...
                    if lean_obj_tag(v___x_415_) == 0 {
                        ...
                        v_isSharedCheck_427_ = (!lean_is_exclusive(v___x_415_)) as u8;
                        ...
                        v_isSharedCheck_435_ = (!lean_is_exclusive(v___x_415_)) as u8;
            ...
            1 => {
                ...
                if v___x_420_ == 0 {
                    ...
                    if v_a_402_ == 0 {
                        lean_dec(v_tail_414_);
                        v___x_422_ = lean_box((v_a_402_) as usize);
...
pub unsafe fn l_List_allM___at___00Lean_MVarId_isIndependentOf_spec__2___boxed(
    ...
    v_a_2521__boxed_444_ = (lean_unbox(v_a_436_) as u8);
...
pub unsafe fn l_Lean_MVarId_isIndependentOf___lam__0(
    mut v_g_446_: *mut LeanObject,
    mut v_L_447_: *mut LeanObject,
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_453_) == 0 {
                    ...
                    v_isSharedCheck_499_ = (!lean_is_exclusive(v___x_455_)) as u8;
                    ...
                    v_isSharedCheck_507_ = (!lean_is_exclusive(v___x_453_)) as u8;
            ...
            1 => {
                ...
                if v___x_460_ == 0 {
                    ...
                    if lean_obj_tag(v___x_461_) == 0 {
                        ...
                        v_isSharedCheck_485_ = (!lean_is_exclusive(v___x_461_)) as u8;
                        ...
                        lean_dec(v_L_447_);
                        lean_dec(v_g_446_);
                        v_a_486_ = lean_ctor_get(v___x_461_, 0);
                        v_isSharedCheck_493_ = (!lean_is_exclusive(v___x_461_)) as u8;
                    ...
                    lean_dec(v_g_446_);
                    v___x_494_ = 0;
                    v___x_495_ = lean_box((v___x_494_) as usize);
            ...
            2 => {
                ...
                if v___x_467_ == 0 {
                    ...
                    if lean_obj_tag(v___x_468_) == 0 {
                        ...
                        v_isSharedCheck_480_ = (!lean_is_exclusive(v___x_468_)) as u8;
                    ...
                    lean_dec(v_L_447_);
                    lean_dec(v_g_446_);
                    v___x_481_ = lean_box((v___x_466_) as usize);
                    if v_isShared_465_ == 0 {
                        lean_ctor_set(v___x_464_, 0, v___x_481_);
            ...
            3 => {
                v___x_473_ = (lean_unbox(v_a_469_) as u8);
                if v___x_473_ == 0 {
                    lean_del_object(v___x_471_);
                    v___x_474_ = (lean_unbox(v_a_469_) as u8);
                    lean_dec(v_a_469_);
                    ...
                    lean_dec(v_L_447_);
                    lean_dec(v_g_446_);
                    v___x_476_ = lean_box((v___x_466_) as usize);
                    if v_isShared_472_ == 0 {
                        ...
                        v_reuseFailAlloc_479_ = lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_MVarId_isIndependentOf(
    mut v_L_516_: *mut LeanObject,
    mut v_g_517_: *mut LeanObject,
    ...
    lean_closure_set(v___f_523_, 0, v_g_517_);
    lean_closure_set(v___f_523_, 1, v_L_516_);
...
pub unsafe fn l_Lean_MVarId_isIndependentOf___boxed(
    mut v_L_525_: *mut LeanObject,
    mut v_g_526_: *mut LeanObject,
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_MVarId_isIndependentOf_spec__1(
    mut v_00_u03b2_533_: *mut LeanObject,
    mut v_m_534_: *mut LeanObject,
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_MVarId_isIndependentOf_spec__1___boxed(
    mut v_00_u03b2_537_: *mut LeanObject,
    mut v_m_538_: *mut LeanObject,
...
pub unsafe fn runtime_initialize_Lean_Meta_Tactic_IndependentOf(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_Tactic_IndependentOf(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Tactic_IndependentOf(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
