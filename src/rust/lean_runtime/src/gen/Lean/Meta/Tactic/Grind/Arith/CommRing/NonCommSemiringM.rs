...
pub static mut l_Lean_Meta_Grind_Arith_CommRing_instMonadCanonNonCommSemiringM: *mut LeanObject = core::ptr::addr_of!(
    l_Lean_Meta_Grind_Arith_CommRing_instMonadCanonNonCommSemiringM___closed__2_value
)
    as *mut LeanObject;
...
static mut l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringNonCommSemiringM___closed__1:
    *mut LeanObject = core::ptr::null_mut();
pub static mut l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringNonCommSemiringM: *mut LeanObject =
    core::ptr::null_mut();
static mut l_Lean_PersistentHashMap_findAux___at___00Lean_PersistentHashMap_find_x3f___at___00Lean_Meta_Grind_Arith_CommRing_getTermNonCommSemiringId_x3f_spec__0_spec__0___redArg___closed__0_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
...
static mut l_Lean_PersistentHashMap_findAux___at___00Lean_PersistentHashMap_find_x3f___at___00Lean_Meta_Grind_Arith_CommRing_getTermNonCommSemiringId_x3f_spec__0_spec__0___redArg___closed__1_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
...
static mut l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_Meta_Grind_Arith_CommRing_setTermNonCommSemiringId_spec__0_spec__0___redArg___closed__0_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
static mut l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_Meta_Grind_Arith_CommRing_setTermNonCommSemiringId_spec__0_spec__0___redArg___closed__0: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_run___redArg(
    mut v_semiringId_835_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_run___redArg___boxed(
    mut v_semiringId_849_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_run(
    ...
    mut v_semiringId_864_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_run___boxed(
    ...
    mut v_semiringId_879_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_getSemiring(
    ...
    let mut v_ncSemirings_1023_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            ...
            1 => {
                v_ncSemirings_1023_ = lean_ctor_get(v_a_1019_, 9);
                lean_inc_ref(v_ncSemirings_1023_);
                lean_dec(v_a_1019_);
                v___x_1024_ = lean_array_get_size(v_ncSemirings_1023_);
                v___x_1025_ = lean_nat_dec_lt(v_a_1006_, v___x_1024_);
                if v___x_1025_ == 0 {
                    lean_dec_ref(v_ncSemirings_1023_);
                    lean_del_object(v___x_1021_);
                    v___x_1026_ = lean_obj_once(core::ptr::addr_of_mut!(l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_getSemiring___closed__1), core::ptr::addr_of_mut!(l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_getSemiring___closed__1_once), _init_l_Lean_Meta_Grind_Arith_CommRing_NonCommSemiringM_getSemiring___closed__1);
        ...
        match state {
            ...
            1 => {
                ...
                if v_isShared_1105_ == 0 {
                    lean_ctor_set(v___x_1104_, 9, v___x_1110_);
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_getTermNonCommSemiringId_x3f___redArg(
    ...
    let mut v_exprToNCSemiringId_1247_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            ...
            1 => {
                v_exprToNCSemiringId_1247_ = lean_ctor_get(v_a_1243_, 10);
                lean_inc_ref(v_exprToNCSemiringId_1247_);
                lean_dec(v_a_1243_);
                ...
                lean_dec_ref(v_exprToNCSemiringId_1247_);
        ...
        match state {
            ...
            1 => {
                ...
                if v_isShared_1495_ == 0 {
                    lean_ctor_set(v___x_1494_, 10, v___x_1496_);
            ...
            0 => {
                ...
                if lean_obj_tag(v___x_1521_) == 0 {
                    ...
                    if lean_obj_tag(v_a_1522_) == 1 {
                        ...
                        lean_dec(v_a_1522_);
                        lean_inc(v_a_1509_);
                        v___f_1540_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_setTermNonCommSemiringId___redArg___lam__0___boxed as *mut core::ffi::c_void, 3, 2);
