...
static mut l___private_Lean_Meta_Tactic_CasesOnStuckLHS_0__Lean_Meta_casesOnStuckLHS_findFVar_x3f___closed__0_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
static mut l___private_Lean_Meta_Tactic_CasesOnStuckLHS_0__Lean_Meta_casesOnStuckLHS_findFVar_x3f___closed__0: *mut LeanObject = core::ptr::null_mut();
pub static l_Lean_Meta_casesOnStuckLHS___closed__0_value: LeanStringObject<25> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lean_Meta_casesOnStuckLHS___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_casesOnStuckLHS___closed__0_value) as *mut LeanObject;
static mut l_Lean_Meta_casesOnStuckLHS___closed__1_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lean_Meta_casesOnStuckLHS___closed__1: *mut LeanObject = core::ptr::null_mut();
pub static l_Lean_Meta_casesOnStuckLHS___closed__2_value: LeanArrayObject<0> = LeanArrayObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Lean_Meta_casesOnStuckLHS___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_casesOnStuckLHS___closed__2_value) as *mut LeanObject;
pub unsafe fn l_Lean_getProjectionFnInfo_x3f___at___00__private_Lean_Meta_Tactic_CasesOnStuckLHS_0__Lean_Meta_casesOnStuckLHS_findFVar_x3f_spec__0___redArg(
    mut v_declName_316_: *mut LeanObject,
    mut v___y_317_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_319_: *mut LeanObject = core::ptr::null_mut();
    let mut v_env_320_: *mut LeanObject = core::ptr::null_mut();
    ...
    v___x_322_ = lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_getProjectionFnInfo_x3f___at___00__private_Lean_Meta_Tactic_CasesOnStuckLHS_0__Lean_Meta_casesOnStuckLHS_findFVar_x3f_spec__0___redArg___boxed(
    mut v_declName_323_: *mut LeanObject,
...
pub unsafe fn l_Lean_getProjectionFnInfo_x3f___at___00__private_Lean_Meta_Tactic_CasesOnStuckLHS_0__Lean_Meta_casesOnStuckLHS_findFVar_x3f_spec__0(
    mut v_declName_327_: *mut LeanObject,
...
pub unsafe fn l_Lean_getProjectionFnInfo_x3f___at___00__private_Lean_Meta_Tactic_CasesOnStuckLHS_0__Lean_Meta_casesOnStuckLHS_findFVar_x3f_spec__0___boxed(
    mut v_declName_334_: *mut LeanObject,
...
-> *mut LeanObject {
    ...
    let mut v_dummy_342_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l___private_Lean_Meta_Tactic_CasesOnStuckLHS_0__Lean_Meta_casesOnStuckLHS_findFVar_x3f(
    ...
    let mut v_struct_353_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_declName_358_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_nargs_364_: *mut LeanObject = core::ptr::null_mut();
    let mut v_dummy_365_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_args_369_: *mut LeanObject = core::ptr::null_mut();
    let mut v_declName_370_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_371_: *mut LeanObject = core::ptr::null_mut();
    let mut v_env_372_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_numParams_404_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_352_) == 11 {
                    lean_dec_ref(v_e_343_);
                    v_struct_353_ = lean_ctor_get(v___x_352_, 2);
                    lean_inc_ref(v_struct_353_);
                    ...
                    if v___x_355_ == 0 {
                        ...
                        if lean_obj_tag(v___x_359_) == 0 {
                            ...
                            v_isSharedCheck_414_ = (!lean_is_exclusive(v___x_359_)) as u8;
                            ...
                            lean_dec_ref(v___x_352_);
                            lean_dec_ref(v_e_343_);
                            v_a_415_ = lean_ctor_get(v___x_359_, 0);
                            v_isSharedCheck_422_ = (!lean_is_exclusive(v___x_359_)) as u8;
                ...
                if lean_obj_tag(v_a_360_) == 0 {
                    if lean_obj_tag(v___x_352_) == 4 {
                        ...
                        if lean_obj_tag(v___x_374_) == 0 {
                            ...
                            v_isSharedCheck_402_ = (!lean_is_exclusive(v___x_374_)) as u8;
                    ...
                    lean_dec_ref(v___x_352_);
                    v_val_403_ = lean_ctor_get(v_a_360_, 0);
                    lean_inc(v_val_403_);
                    lean_dec_ref_known(v_a_360_, 1);
                    v_numParams_404_ = lean_ctor_get(v_val_403_, 1);
                    lean_inc(v_numParams_404_);
                    lean_dec(v_val_403_);
                    v___x_405_ = lean_array_get_size(v_args_369_);
                    v___x_406_ = lean_nat_dec_lt(v_numParams_404_, v___x_405_);
                    if v___x_406_ == 0 {
                        lean_dec(v_numParams_404_);
                        lean_dec_ref(v_args_369_);
                        v___x_407_ = lean_box(0);
                        if v_isShared_363_ == 0 {
                            lean_ctor_set(v___x_362_, 0, v___x_407_);
            ...
            3 => {
                if lean_obj_tag(v_val_375_) == 7 {
                    v_val_379_ = lean_ctor_get(v_val_375_, 0);
                    ...
                    if v___x_382_ == 0 {
                        ...
                        if v___x_386_ == 0 {
                            ...
                            if v_isShared_363_ == 0 {
                                lean_ctor_set(v___x_362_, 0, v___x_387_);
                        ...
                        if v_isShared_363_ == 0 {
                            lean_ctor_set(v___x_362_, 0, v___x_398_);
            ...
            5 => {
                if v_isShared_363_ == 0 {
                    lean_ctor_set(v___x_362_, 0, v___x_393_);
            ...
            9 => {
                if v_isShared_418_ == 0 {
                    ...
                    v_reuseFailAlloc_421_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Meta_casesOnStuckLHS_spec__1(
    mut v_sz_430_: usize,
    mut v_i_431_: usize,
    mut v_bs_432_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_433_: u8 = 0;
    let mut v_v_434_: *mut LeanObject = core::ptr::null_mut();
    let mut v_toInductionSubgoal_435_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mvarId_436_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_437_: *mut LeanObject = core::ptr::null_mut();
    let mut v_bs_x27_438_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_433_ == 0 {
                    ...
                    v_toInductionSubgoal_435_ = lean_ctor_get(v_v_434_, 0);
                    v_mvarId_436_ = lean_ctor_get(v_toInductionSubgoal_435_, 0);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Meta_casesOnStuckLHS_spec__1___boxed(
    mut v_sz_443_: *mut LeanObject,
    mut v_i_444_: *mut LeanObject,
    mut v_bs_445_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_addMessageContextFull___at___00Lean_throwError___at___00Lean_Meta_casesOnStuckLHS_spec__0_spec__0(
    mut v_msgData_449_: *mut LeanObject,
    ...
    let mut v_mctx_458_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lctx_459_: *mut LeanObject = core::ptr::null_mut();
    let mut v_options_460_: *mut LeanObject = core::ptr::null_mut();
    ...
    v___x_461_ = lean_alloc_ctor(0, 4, (0) as u32);
    ...
    v___x_462_ = lean_alloc_ctor(3, 2, (0) as u32);
    lean_ctor_set(v___x_462_, 0, v___x_461_);
    lean_ctor_set(v___x_462_, 1, v_msgData_449_);
    v___x_463_ = lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_addMessageContextFull___at___00Lean_throwError___at___00Lean_Meta_casesOnStuckLHS_spec__0_spec__0___boxed(
    mut v_msgData_464_: *mut LeanObject,
    ...
    loop {
        match state {
            0 => {
                ...
                v_isSharedCheck_487_ = (!lean_is_exclusive(v___x_478_)) as u8;
...
pub unsafe fn _init_l_Lean_Meta_casesOnStuckLHS___closed__1() -> *mut LeanObject {
...
pub unsafe fn l_Lean_Meta_casesOnStuckLHS(
    mut v_mvarId_500_: *mut LeanObject,
    ...
    let mut v_val_517_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
                ...
                if lean_obj_tag(v___x_513_) == 0 {
                    ...
                    if lean_obj_tag(v___x_515_) == 0 {
                        ...
                        if lean_obj_tag(v_a_516_) == 1 {
                            ...
                            v_snd_518_ = lean_ctor_get(v_val_517_, 1);
                            lean_inc(v_snd_518_);
                            lean_dec(v_val_517_);
                            ...
                            if lean_obj_tag(v___x_519_) == 0 {
                                ...
                                if lean_obj_tag(v_a_520_) == 1 {
                                    ...
                                    if lean_obj_tag(v___x_525_) == 0 {
                                        ...
                                        v_isSharedCheck_536_ =
                                            (!lean_is_exclusive(v___x_525_)) as u8;
                                ...
                                v_isSharedCheck_552_ = (!lean_is_exclusive(v___x_519_)) as u8;
                        ...
                        lean_dec(v_mvarId_500_);
                        v_a_553_ = lean_ctor_get(v___x_515_, 0);
                        v_isSharedCheck_560_ = (!lean_is_exclusive(v___x_515_)) as u8;
                    ...
                    v_isSharedCheck_568_ = (!lean_is_exclusive(v___x_513_)) as u8;
            ...
            2 => {
                ...
                if v_isShared_529_ == 0 {
                    ...
                    v_reuseFailAlloc_535_ = lean_alloc_ctor(0, 1, (0) as u32);
            ...
            6 => {
                if v_isShared_548_ == 0 {
                    ...
                    v_reuseFailAlloc_551_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Meta_casesOnStuckLHS_x3f(
    mut v_mvarId_592_: *mut LeanObject,
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_598_) == 0 {
                    ...
                    v_isSharedCheck_607_ = (!lean_is_exclusive(v___x_598_)) as u8;
                    ...
                    v_isSharedCheck_623_ = (!lean_is_exclusive(v___x_598_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_602_ == 0 {
                    ...
                    v_reuseFailAlloc_606_ = lean_alloc_ctor(0, 1, (0) as u32);
            ...
            4 => {
                if v___y_613_ == 0 {
                    ...
                    if v_isShared_611_ == 0 {
                        ...
                        v_reuseFailAlloc_620_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l_Lean_Meta_casesOnStuckLHS_x3f___boxed(
    mut v_mvarId_624_: *mut LeanObject,
...
pub unsafe fn runtime_initialize_Lean_Meta_Tactic_CasesOnStuckLHS(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_Tactic_CasesOnStuckLHS(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Tactic_CasesOnStuckLHS(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
