...
pub static l_Int_Linear_Expr_renameVars___closed__0_value: LeanCtorObject<1> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Int_Linear_Expr_renameVars___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Int_Linear_Expr_renameVars___closed__0_value) as *mut LeanObject;
...
pub unsafe fn l_Int_Linear_Expr_renameVars(
    ...
    let mut v_k_291_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => match lean_obj_tag(v_e_236_) {
                ...
                _ => {
                    v_a_290_ = lean_ctor_get(v_e_236_, 0);
                    v_k_291_ = lean_ctor_get(v_e_236_, 1);
            ...
            11 => {
                ...
                if v_isShared_294_ == 0 {
                    ...
                    lean_ctor_set(v_reuseFailAlloc_298_, 1, v_k_291_);
    ...
    loop {
        match state {
            0 => match lean_obj_tag(v_e_309_) {
                ...
                6 => {
                    v_a_323_ = lean_ctor_get(v_e_309_, 0);
