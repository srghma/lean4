    ...
    loop {
        match state {
            ...
            1 => {
                ...
                v___f_170_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_instMonadCommSemiringOfMonadLift___redArg___lam__0 as *mut core::ffi::c_void, 3, 2);
    ...
    loop {
        match state {
            ...
            1 => {
                ...
                v___f_185_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_instMonadCommSemiringOfMonadLift___redArg___lam__0 as *mut core::ffi::c_void, 3, 2);
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__1(
    ...
    v___f_208_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__0 as *mut core::ffi::c_void, 2, 1);
    ...
    loop {
        match state {
            ...
            1 => {
                ...
                v___f_224_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__1 as *mut core::ffi::c_void, 2, 1);
                lean_closure_set(v___f_224_, 0, v_modifyCommSemiring_219_);
                v___f_225_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__2 as *mut core::ffi::c_void, 2, 1);
    ...
    loop {
        match state {
            ...
            1 => {
                ...
                v___f_242_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__1 as *mut core::ffi::c_void, 2, 1);
                lean_closure_set(v___f_242_, 0, v_modifyCommSemiring_237_);
                v___f_243_ = lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_instMonadSemiringOfMonadOfMonadCommSemiring___redArg___lam__2 as *mut core::ffi::c_void, 2, 1);
