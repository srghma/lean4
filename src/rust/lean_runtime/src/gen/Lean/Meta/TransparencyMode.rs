...
pub static l_Lean_Meta_TransparencyMode_instHashable__lean___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_Lean_Meta_TransparencyMode_instHashable__lean___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_TransparencyMode_instHashable__lean___closed__0_value)
        as *mut LeanObject;
pub static mut l_Lean_Meta_TransparencyMode_instHashable__lean: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_TransparencyMode_instHashable__lean___closed__0_value)
        as *mut LeanObject;
...
pub unsafe fn l_Lean_Meta_TransparencyMode_hash___boxed(
    ...
    let mut v_r_48_: *mut LeanObject = core::ptr::null_mut();
    v_x_64__boxed_46_ = (lean_unbox(v_x_45_) as u8);
...
pub unsafe fn l_Lean_Meta_TransparencyMode_lt___boxed(
    ...
    v_x_104__boxed_73_ = (lean_unbox(v_x_71_) as u8);
    v_x_105__boxed_74_ = (lean_unbox(v_x_72_) as u8);
...
pub unsafe fn runtime_initialize_Lean_Meta_TransparencyMode(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_TransparencyMode(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_TransparencyMode(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
