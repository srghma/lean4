...
pub static l_Lean_Meta_Sym_instHashableExprPtr___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_Lean_Meta_Sym_instHashableExprPtr___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_instHashableExprPtr___closed__0_value) as *mut LeanObject;
pub static mut l_Lean_Meta_Sym_instHashableExprPtr: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_instHashableExprPtr___closed__0_value) as *mut LeanObject;
pub static l_Lean_Meta_Sym_instBEqExprPtr___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lean_Meta_Sym_instBEqExprPtr___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_instBEqExprPtr___closed__0_value) as *mut LeanObject;
pub static mut l_Lean_Meta_Sym_instBEqExprPtr: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_instBEqExprPtr___closed__0_value) as *mut LeanObject;
...
pub unsafe fn l_Lean_Meta_Sym_hashPtrExpr_unsafe__1(mut v_e_50_: *mut LeanObject) -> u64 {
...
pub unsafe fn l_Lean_Meta_Sym_hashPtrExpr(mut v_e_58_: *mut LeanObject) -> u64 {
    let mut v___x_59_: u64 = 0;
    v___x_59_ = l_Lean_Meta_Sym_hashPtrExpr_unsafe__1(v_e_58_);
    return v___x_59_;
}
pub unsafe fn l_Lean_Meta_Sym_hashPtrExpr___boxed(mut v_e_60_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Lean_Meta_Sym_ExprPtr(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_Sym_ExprPtr(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Sym_ExprPtr(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
