...
pub static l_Lean_Meta_Sym_DSimp_dsimpLambda___closed__0_value: LeanArrayObject<0> =
    LeanArrayObject {
        m_header: LeanObject {
            rc: 0,
...
static mut l_Lean_Meta_Sym_DSimp_dsimpLambda___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_Sym_DSimp_dsimpLambda___closed__0_value) as *mut LeanObject;
    ...
    loop {
        match state {
            0 => {
                ...
                lean_inc(v___y_351_);
                lean_inc(v___y_350_);
                v___f_360_ = lean_alloc_closure(l_Lean_Meta_withLocalDecl___at___00__private_Lean_Meta_Sym_DSimp_Lambda_0__Lean_Meta_Sym_DSimp_dsimpLambda_go_spec__0___redArg___lam__0___boxed as *mut core::ffi::c_void, 12, 6);
                    ...
                    if lean_obj_tag(v___x_487_) == 0 {
                        ...
                        if lean_obj_tag(v___x_489_) == 0 {
                            ...
                            if lean_obj_tag(v_a_490_) == 0 {
                                ...
                                v___f_492_ = lean_alloc_closure(l___private_Lean_Meta_Sym_DSimp_Lambda_0__Lean_Meta_Sym_DSimp_dsimpLambda_go___lam__0___boxed as *mut core::ffi::c_void, 14, 3);
                                ...
                                v___f_496_ = lean_alloc_closure(l___private_Lean_Meta_Sym_DSimp_Lambda_0__Lean_Meta_Sym_DSimp_dsimpLambda_go___lam__1___boxed as *mut core::ffi::c_void, 13, 2);
...
pub unsafe fn runtime_initialize_Lean_Meta_Sym_DSimp_Lambda(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_Sym_DSimp_Lambda(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Sym_DSimp_Lambda(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
