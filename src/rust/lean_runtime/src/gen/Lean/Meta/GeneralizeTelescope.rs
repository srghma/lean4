...
pub static l_Lean_Meta_generalizeTelescope___redArg___closed__0_value: LeanArrayObject<0> =
    LeanArrayObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lean_Meta_generalizeTelescope___redArg___closed__0: *mut LeanObject =
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_updateTypes(
    mut v_e_582_: *mut LeanObject,
    mut v_eNew_583_: *mut LeanObject,
    mut v_entries_584_: *mut LeanObject,
    mut v_i_585_: *mut LeanObject,
    ...
    let mut v_entry_594_: *mut LeanObject = core::ptr::null_mut();
    let mut v_expr_595_: *mut LeanObject = core::ptr::null_mut();
    let mut v_type_596_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_592_ == 0 {
                    ...
                    lean_ctor_set(v___x_593_, 0, v_entries_584_);
                    return v___x_593_;
                } else {
                    v_entry_594_ = lean_array_fget(v_entries_584_, v_i_585_);
                    v_expr_595_ = lean_ctor_get(v_entry_594_, 0);
                    v_type_596_ = lean_ctor_get(v_entry_594_, 1);
                    v_isSharedCheck_623_ = (!lean_is_exclusive(v_entry_594_)) as u8;
                    if v_isSharedCheck_623_ == 0 {
                        ...
                        lean_inc(v_type_596_);
                        lean_inc(v_expr_595_);
                        lean_dec(v_entry_594_);
                ...
                if lean_obj_tag(v___x_601_) == 0 {
                    ...
                    if v___x_603_ == 0 {
                        ...
                        if v_isShared_599_ == 0 {
                            ...
                            v_reuseFailAlloc_614_ = lean_alloc_ctor(0, 2, (1) as u32);
                            lean_ctor_set(v_reuseFailAlloc_614_, 0, v_expr_595_);
                    ...
                    lean_dec_ref(v_expr_595_);
                    lean_dec(v_i_585_);
                    lean_dec_ref(v_entries_584_);
                    lean_dec_ref(v_e_582_);
                    v_a_615_ = lean_ctor_get(v___x_601_, 0);
                    v_isSharedCheck_622_ = (!lean_is_exclusive(v___x_601_)) as u8;
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_updateTypes___boxed(
    ...
    mut v_eNew_625_: *mut LeanObject,
    mut v_entries_626_: *mut LeanObject,
...
pub unsafe fn l_Lean_addMessageContextFull___at___00Lean_throwError___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__3_spec__4(
    mut v_msgData_634_: *mut LeanObject,
    ...
    let mut v_env_641_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_642_: *mut LeanObject = core::ptr::null_mut();
    let mut v_mctx_643_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lctx_644_: *mut LeanObject = core::ptr::null_mut();
    let mut v_options_645_: *mut LeanObject = core::ptr::null_mut();
    ...
    lean_dec(v___x_642_);
    v_lctx_644_ = lean_ctor_get(v___y_635_, 2);
    v_options_645_ = lean_ctor_get(v___y_637_, 2);
    lean_inc_ref(v_options_645_);
    lean_inc_ref(v_lctx_644_);
    v___x_646_ = lean_alloc_ctor(0, 4, (0) as u32);
    lean_ctor_set(v___x_646_, 0, v_env_641_);
    lean_ctor_set(v___x_646_, 1, v_mctx_643_);
    lean_ctor_set(v___x_646_, 2, v_lctx_644_);
    lean_ctor_set(v___x_646_, 3, v_options_645_);
    v___x_647_ = lean_alloc_ctor(3, 2, (0) as u32);
    lean_ctor_set(v___x_647_, 0, v___x_646_);
    lean_ctor_set(v___x_647_, 1, v_msgData_634_);
    v___x_648_ = lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_addMessageContextFull___at___00Lean_throwError___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__3_spec__4___boxed(
    mut v_msgData_649_: *mut LeanObject,
    ...
    loop {
        match state {
            ...
            1 => {
                ...
                lean_ctor_set(v___x_668_, 0, v_ref_662_);
                lean_ctor_set(v___x_668_, 1, v_a_664_);
...
pub unsafe fn l_Lean_Meta_withLocalDecl___at___00Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0_spec__0___redArg(
    mut v_name_696_: *mut LeanObject,
    mut v_bi_697_: u8,
    mut v_type_698_: *mut LeanObject,
    ...
    loop {
        match state {
            0 => {
                v___f_706_ = lean_alloc_closure(l_Lean_Meta_withLocalDecl___at___00Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0_spec__0___redArg___lam__0___boxed as *mut core::ffi::c_void, 7, 1);
                ...
                if lean_obj_tag(v___x_707_) == 0 {
                    ...
                    v_isSharedCheck_715_ = (!lean_is_exclusive(v___x_707_)) as u8;
                    ...
                    v_isSharedCheck_723_ = (!lean_is_exclusive(v___x_707_)) as u8;
...
pub unsafe fn l_Lean_Meta_withLocalDecl___at___00Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0_spec__0___redArg___boxed(
    mut v_name_724_: *mut LeanObject,
    mut v_bi_725_: *mut LeanObject,
    mut v_type_726_: *mut LeanObject,
    mut v_k_727_: *mut LeanObject,
    mut v_kind_728_: *mut LeanObject,
    ...
    v_bi_boxed_734_ = (lean_unbox(v_bi_725_) as u8);
    v_kind_boxed_735_ = (lean_unbox(v_kind_728_) as u8);
...
pub unsafe fn l_Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0___redArg(
    mut v_name_737_: *mut LeanObject,
    mut v_type_738_: *mut LeanObject,
    mut v_k_739_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0___redArg___boxed(
    mut v_name_748_: *mut LeanObject,
    mut v_type_749_: *mut LeanObject,
        ...
        match state {
            0 => {
                if lean_obj_tag(v_a_757_) == 0 {
                    ...
                    v_isSharedCheck_770_ = (!lean_is_exclusive(v_a_757_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_764_ == 0 {
                    ...
                    v_reuseFailAlloc_769_ = lean_alloc_ctor(1, 2, (0) as u32);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__1(
    mut v_sz_771_: usize,
    mut v_i_772_: usize,
    mut v_bs_773_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_774_: u8 = 0;
    let mut v_v_775_: *mut LeanObject = core::ptr::null_mut();
    let mut v_expr_776_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_777_: *mut LeanObject = core::ptr::null_mut();
    let mut v_bs_x27_778_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_774_ == 0 {
                    ...
                    v_expr_776_ = lean_ctor_get(v_v_775_, 0);
                    lean_inc_ref(v_expr_776_);
                    v___x_777_ = lean_unsigned_to_nat(0);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__1___boxed(
    mut v_sz_783_: *mut LeanObject,
    mut v_i_784_: *mut LeanObject,
    mut v_bs_785_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux___redArg___lam__0___boxed(
    ...
    mut v_e_790_: *mut LeanObject,
    mut v_entries_791_: *mut LeanObject,
    mut v_fvars_792_: *mut LeanObject,
    mut v_k_793_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux___redArg(
    ...
    mut v_entries_808_: *mut LeanObject,
    mut v_i_809_: *mut LeanObject,
    mut v_fvars_810_: *mut LeanObject,
    mut v_a_811_: *mut LeanObject,
    mut v_a_812_: *mut LeanObject,
    mut v_a_813_: *mut LeanObject,
    mut v_a_814_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_baseUserName_817_: *mut LeanObject = core::ptr::null_mut();
    let mut v_e_818_: *mut LeanObject = core::ptr::null_mut();
    let mut v_type_819_: *mut LeanObject = core::ptr::null_mut();
    let mut v___y_820_: *mut LeanObject = core::ptr::null_mut();
    let mut v___y_821_: *mut LeanObject = core::ptr::null_mut();
    let mut v___y_822_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_expr_848_: *mut LeanObject = core::ptr::null_mut();
    let mut v_type_849_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_fvarId_885_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_845_ == 0 {
                    lean_dec(v_i_809_);
                    lean_dec_ref(v_entries_808_);
                    lean_inc(v_a_814_);
                    lean_inc_ref(v_a_813_);
                    lean_inc(v_a_812_);
                    lean_inc_ref(v_a_811_);
                    v___x_846_ = lean_apply_6(
                        v_k_807_,
                        v_fvars_810_,
                        v_a_811_,
                        v_a_812_,
                    ...
                    v_expr_848_ = lean_ctor_get(v___x_847_, 0);
                    v_type_849_ = lean_ctor_get(v___x_847_, 1);
                    v_modified_850_ = lean_ctor_get_uint8(
                        v___x_847_,
                        (core::mem::size_of::<*mut LeanObject>() * 2) as u32,
                    );
                    if lean_obj_tag(v_expr_848_) == 1 {
                        if v_modified_850_ == 0 {
                            v_fvarId_885_ = lean_ctor_get(v_expr_848_, 0);
                            ...
                            if lean_obj_tag(v___x_886_) == 0 {
                                ...
                                lean_dec_ref(v_fvars_810_);
                                lean_dec(v_i_809_);
                                lean_dec_ref(v_entries_808_);
                                lean_dec_ref(v_k_807_);
                                v_a_893_ = lean_ctor_get(v___x_886_, 0);
                                v_isSharedCheck_900_ = (!lean_is_exclusive(v___x_886_)) as u8;
            ...
            1 => {
                ...
                if lean_obj_tag(v___x_824_) == 0 {
                    ...
                    v___f_826_ = lean_alloc_closure(l_Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux___redArg___lam__0___boxed as *mut core::ffi::c_void, 11, 5);
                    lean_closure_set(v___f_826_, 0, v_i_809_);
                    lean_closure_set(v___f_826_, 1, v_e_818_);
                    lean_closure_set(v___f_826_, 2, v_entries_808_);
                    lean_closure_set(v___f_826_, 3, v_fvars_810_);
                    lean_closure_set(v___f_826_, 4, v_k_807_);
                    ...
                    lean_dec_ref(v_entries_808_);
                    lean_dec_ref(v_k_807_);
                    v_a_828_ = lean_ctor_get(v___x_824_, 0);
                    v_isSharedCheck_835_ = (!lean_is_exclusive(v___x_824_)) as u8;
            ...
            5 => {
                if v_modified_850_ == 0 {
                    ...
                    if lean_obj_tag(v___x_856_) == 0 {
                        ...
                        v___x_858_ = (lean_unbox(v_a_857_) as u8);
                        lean_dec(v_a_857_);
                        if v___x_858_ == 0 {
                            ...
                            if lean_obj_tag(v___x_868_) == 0 {
                                ...
                                v_isSharedCheck_876_ = (!lean_is_exclusive(v___x_868_)) as u8;
                        ...
                        v_isSharedCheck_884_ = (!lean_is_exclusive(v___x_856_)) as u8;
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux___redArg___lam__0(
    mut v_i_901_: *mut LeanObject,
    mut v_e_902_: *mut LeanObject,
    mut v_entries_903_: *mut LeanObject,
    mut v_fvars_904_: *mut LeanObject,
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_914_) == 0 {
                    ...
                    v_isSharedCheck_925_ = (!lean_is_exclusive(v___x_914_)) as u8;
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux___redArg___boxed(
    ...
    mut v_entries_927_: *mut LeanObject,
    mut v_i_928_: *mut LeanObject,
    mut v_fvars_929_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux(
    ...
    mut v_entries_938_: *mut LeanObject,
    mut v_i_939_: *mut LeanObject,
    mut v_fvars_940_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux___boxed(
    ...
    mut v_entries_949_: *mut LeanObject,
    mut v_i_950_: *mut LeanObject,
    mut v_fvars_951_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_withLocalDecl___at___00Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0_spec__0(
    ...
    mut v_name_959_: *mut LeanObject,
    mut v_bi_960_: u8,
    mut v_type_961_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_withLocalDecl___at___00Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0_spec__0___boxed(
    mut v_00_u03b1_970_: *mut LeanObject,
    mut v_name_971_: *mut LeanObject,
    mut v_bi_972_: *mut LeanObject,
    mut v_type_973_: *mut LeanObject,
    mut v_k_974_: *mut LeanObject,
    mut v_kind_975_: *mut LeanObject,
    ...
    v_bi_boxed_981_ = (lean_unbox(v_bi_972_) as u8);
    v_kind_boxed_982_ = (lean_unbox(v_kind_975_) as u8);
...
pub unsafe fn l_Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0(
    ...
    mut v_name_985_: *mut LeanObject,
    mut v_type_986_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_withLocalDeclD___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__0___boxed(
    ...
    mut v_name_995_: *mut LeanObject,
    mut v_type_996_: *mut LeanObject,
...
pub unsafe fn l_Lean_throwError___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__3(
    ...
    mut v_msg_1005_: *mut LeanObject,
...
pub unsafe fn l_Lean_throwError___at___00Lean_Meta_GeneralizeTelescope_generalizeTelescopeAux_spec__3___boxed(
    mut v_00_u03b1_1012_: *mut LeanObject,
    mut v_msg_1013_: *mut LeanObject,
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Meta_generalizeTelescope_spec__0___redArg(
    ...
    let mut v_fst_1028_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_1029_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_1030_: *mut LeanObject = core::ptr::null_mut();
    let mut v_cache_1031_: *mut LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_1032_: *mut LeanObject = core::ptr::null_mut();
    let mut v_postponed_1033_: *mut LeanObject = core::ptr::null_mut();
    let mut v_diag_1034_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v___x_1023_ == 0 {
                    ...
                    lean_ctor_set(v___x_1024_, 0, v_e_1020_);
                    return v___x_1024_;
                } else {
                    ...
                    v_isSharedCheck_1043_ = (!lean_is_exclusive(v___x_1030_)) as u8;
                    if v_isSharedCheck_1043_ == 0 {
                        v_unused_1044_ = lean_ctor_get(v___x_1030_, 0);
            ...
            1 => {
                if v_isShared_1037_ == 0 {
                    lean_ctor_set(v___x_1036_, 0, v_snd_1029_);
                    v___x_1039_ = v___x_1036_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_1042_ = lean_alloc_ctor(0, 5, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_1042_, 0, v_snd_1029_);
                    lean_ctor_set(v_reuseFailAlloc_1042_, 1, v_cache_1031_);
                    lean_ctor_set(v_reuseFailAlloc_1042_, 2, v_zetaDeltaFVarIds_1032_);
                    lean_ctor_set(v_reuseFailAlloc_1042_, 3, v_postponed_1033_);
                    lean_ctor_set(v_reuseFailAlloc_1042_, 4, v_diag_1034_);
            ...
            2 => {
                ...
                lean_ctor_set(v___x_1041_, 0, v_fst_1028_);
                return v___x_1041_;
            }
            _ => {}
        }
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Meta_generalizeTelescope_spec__1(
    ...
    let mut v_bs_x27_1079_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_1071_ == 0 {
                    v___x_1072_ = lean_alloc_ctor(0, 1, (0) as u32);
                    lean_ctor_set(v___x_1072_, 0, v_bs_1065_);
                    return v___x_1072_;
                } else {
                    ...
                    if lean_obj_tag(v___x_1074_) == 0 {
                        ...
                        if lean_obj_tag(v___x_1076_) == 0 {
                            ...
                            v___x_1080_ = 0;
                            v___x_1081_ = lean_alloc_ctor(0, 2, (1) as u32);
                            lean_ctor_set(v___x_1081_, 0, v_v_1073_);
                            ...
                            lean_dec(v_v_1073_);
                            lean_dec_ref(v_bs_1065_);
                            v_a_1086_ = lean_ctor_get(v___x_1076_, 0);
                            v_isSharedCheck_1093_ = (!lean_is_exclusive(v___x_1076_)) as u8;
                        ...
                        v_isSharedCheck_1101_ = (!lean_is_exclusive(v___x_1074_)) as u8;
            ...
            1 => {
                if v_isShared_1089_ == 0 {
                    ...
                    v_reuseFailAlloc_1092_ = lean_alloc_ctor(1, 1, (0) as u32);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Meta_generalizeTelescope_spec__1___boxed(
    mut v_sz_1102_: *mut LeanObject,
    mut v_i_1103_: *mut LeanObject,
    mut v_bs_1104_: *mut LeanObject,
...
pub unsafe fn l_Lean_Meta_generalizeTelescope___redArg(
    mut v_es_1115_: *mut LeanObject,
    mut v_k_1116_: *mut LeanObject,
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_1124_) == 0 {
                    ...
                    v_isSharedCheck_1136_ = (!lean_is_exclusive(v___x_1124_)) as u8;
...
pub unsafe fn runtime_initialize_Lean_Meta_GeneralizeTelescope(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_GeneralizeTelescope(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_GeneralizeTelescope(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
