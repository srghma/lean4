...
static mut l_Lean_instBEqLBool___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_instBEqLBool___closed__0_value) as *mut crate::leanh::LeanObject;
pub static mut l_Lean_instBEqLBool: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_instBEqLBool___closed__0_value) as *mut crate::leanh::LeanObject;
pub static l_Lean_LBool_toString___closed__0_value: crate::leanh::LeanStringObject<6> =
...
static mut l_Lean_LBool_toString___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_LBool_toString___closed__0_value) as *mut crate::leanh::LeanObject;
pub static l_Lean_LBool_toString___closed__1_value: crate::leanh::LeanStringObject<5> =
    crate::leanh::LeanStringObject {
        m_header: crate::leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_LBool_toString___closed__1: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_LBool_toString___closed__1_value) as *mut crate::leanh::LeanObject;
pub static l_Lean_LBool_toString___closed__2_value: crate::leanh::LeanStringObject<6> =
    crate::leanh::LeanStringObject {
        m_header: crate::leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_LBool_toString___closed__2: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_LBool_toString___closed__2_value) as *mut crate::leanh::LeanObject;
pub static l_Lean_LBool_instToString___closed__0_value: crate::leanh::LeanClosureObject<0> =
    crate::leanh::LeanClosureObject {
        m_header: crate::leanh::LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<crate::leanh::LeanObject>()
...
static mut l_Lean_LBool_instToString___closed__0: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_LBool_instToString___closed__0_value)
        as *mut crate::leanh::LeanObject;
pub static mut l_Lean_LBool_instToString: *mut crate::leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_LBool_instToString___closed__0_value)
        as *mut crate::leanh::LeanObject;
pub unsafe fn l_Lean_LBool_ctorIdx(mut v_x_140_: u8) -> *mut crate::leanh::LeanObject {
    match v_x_140_ {
        0 => {
        ...
        _ => {
            ...
            v___x_143_ = crate::leanh::lean_unsigned_to_nat(2);
            return v___x_143_;
        }
    }
}
pub unsafe fn l_Lean_LBool_ctorIdx___boxed(
    ...
    v_x_boxed_145_ = (crate::leanh::lean_unbox(v_x_144_) as u8);
    v_res_146_ = l_Lean_LBool_ctorIdx(v_x_boxed_145_);
    return v_res_146_;
}
pub unsafe fn l_Lean_LBool_toCtorIdx(mut v_x_147_: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn l_Lean_LBool_toCtorIdx___boxed(
    ...
    v_x_4__boxed_150_ = (crate::leanh::lean_unbox(v_x_149_) as u8);
...
pub unsafe fn l_Lean_LBool_ctorElim___boxed(
    ...
    crate::leanh::lean_dec(v_k_164_);
    crate::leanh::lean_dec(v_ctorIdx_161_);
    return v_res_166_;
}
pub unsafe fn l_Lean_LBool_false_elim___redArg(
    mut v_false_167_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    crate::leanh::lean_inc(v_false_167_);
    return v_false_167_;
}
pub unsafe fn l_Lean_LBool_false_elim___redArg___boxed(
    mut v_false_168_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_res_169_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_res_169_ = l_Lean_LBool_false_elim___redArg(v_false_168_);
    crate::leanh::lean_dec(v_false_168_);
    return v_res_169_;
}
pub unsafe fn l_Lean_LBool_false_elim(
    mut v_motive_170_: *mut crate::leanh::LeanObject,
    mut v_t_171_: u8,
    mut v_h_172_: *mut crate::leanh::LeanObject,
    mut v_false_173_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    crate::leanh::lean_inc(v_false_173_);
    return v_false_173_;
}
...
pub unsafe fn l_Lean_LBool_undef_elim(
    ...
    mut v_undef_199_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    crate::leanh::lean_inc(v_undef_199_);
    return v_undef_199_;
}
pub unsafe fn l_Lean_LBool_undef_elim___boxed(
    mut v_motive_200_: *mut crate::leanh::LeanObject,
    mut v_t_201_: *mut crate::leanh::LeanObject,
    mut v_h_202_: *mut crate::leanh::LeanObject,
    mut v_undef_203_: *mut crate::leanh::LeanObject,
) -> *mut crate::leanh::LeanObject {
    let mut v_t_boxed_204_: u8 = 0;
    let mut v_res_205_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_t_boxed_204_ = (crate::leanh::lean_unbox(v_t_201_) as u8);
    v_res_205_ = l_Lean_LBool_undef_elim(v_motive_200_, v_t_boxed_204_, v_h_202_, v_undef_203_);
    crate::leanh::lean_dec(v_undef_203_);
    return v_res_205_;
}
...
pub unsafe fn l_Lean_instBEqLBool_beq(mut v_x_208_: u8, mut v_y_209_: u8) -> u8 {
    ...
    crate::leanh::lean_dec(v___x_211_);
...
pub unsafe fn l_Lean_instBEqLBool_beq___boxed(
    ...
    v_x_17__boxed_215_ = (crate::leanh::lean_unbox(v_x_213_) as u8);
    v_y_18__boxed_216_ = (crate::leanh::lean_unbox(v_y_214_) as u8);
...
pub unsafe fn l_Lean_LBool_neg___boxed(
    ...
    let mut v_r_227_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_x_25__boxed_225_ = (crate::leanh::lean_unbox(v_x_224_) as u8);
    v_res_226_ = l_Lean_LBool_neg(v_x_25__boxed_225_);
    v_r_227_ = crate::leanh::lean_box((v_res_226_) as usize);
    return v_r_227_;
}
...
pub unsafe fn l_Lean_LBool_and___boxed(
    ...
    let mut v_r_235_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_x_16__boxed_232_ = (crate::leanh::lean_unbox(v_x_230_) as u8);
    v_x_17__boxed_233_ = (crate::leanh::lean_unbox(v_x_231_) as u8);
    v_res_234_ = l_Lean_LBool_and(v_x_16__boxed_232_, v_x_17__boxed_233_);
    v_r_235_ = crate::leanh::lean_box((v_res_234_) as usize);
    return v_r_235_;
}
pub unsafe fn l_Lean_LBool_toString(mut v_x_239_: u8) -> *mut crate::leanh::LeanObject {
    match v_x_239_ {
        0 => {
...
pub unsafe fn l_Lean_LBool_toString___boxed(
    ...
    v_x_31__boxed_244_ = (crate::leanh::lean_unbox(v_x_243_) as u8);
...
pub unsafe fn l_Bool_toLBool___boxed(
    ...
    v_x_18__boxed_252_ = (crate::leanh::lean_unbox(v_x_251_) as u8);
...
pub unsafe fn l_toLBoolM___redArg___lam__0(
    mut v_toPure_255_: *mut crate::leanh::LeanObject,
    mut v_b_256_: u8,
) -> *mut crate::leanh::LeanObject {
    ...
    v___x_258_ = crate::leanh::lean_box((v___x_257_) as usize);
    v___x_259_ = crate::leanh::lean_apply_2(v_toPure_255_, crate::leanh::lean_box(0), v___x_258_);
    return v___x_259_;
}
pub unsafe fn l_toLBoolM___redArg___lam__0___boxed(
    mut v_toPure_260_: *mut crate::leanh::LeanObject,
    ...
    v_b_boxed_262_ = (crate::leanh::lean_unbox(v_b_261_) as u8);
...
pub unsafe fn l_toLBoolM___redArg(
    ...
    v_toApplicative_266_ = crate::leanh::lean_ctor_get(v_inst_264_, 0);
    crate::leanh::lean_inc_ref(v_toApplicative_266_);
    v_toBind_267_ = crate::leanh::lean_ctor_get(v_inst_264_, 1);
    ...
    crate::leanh::lean_dec_ref(v_toApplicative_266_);
...
pub unsafe fn l_toLBoolM(
    ...
    let mut v_toApplicative_274_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_toBind_275_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v_toPure_276_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___f_277_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_278_: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    v_toApplicative_274_ = crate::leanh::lean_ctor_get(v_inst_272_, 0);
    crate::leanh::lean_inc_ref(v_toApplicative_274_);
    v_toBind_275_ = crate::leanh::lean_ctor_get(v_inst_272_, 1);
    crate::leanh::lean_inc(v_toBind_275_);
    crate::leanh::lean_dec_ref(v_inst_272_);
    v_toPure_276_ = crate::leanh::lean_ctor_get(v_toApplicative_274_, 1);
    crate::leanh::lean_inc(v_toPure_276_);
    crate::leanh::lean_dec_ref(v_toApplicative_274_);
    v___f_277_ = crate::leanh::lean_alloc_closure(
        l_toLBoolM___redArg___lam__0___boxed as *mut core::ffi::c_void,
        2,
        1,
    );
    crate::leanh::lean_closure_set(v___f_277_, 0, v_toPure_276_);
    v___x_278_ = crate::leanh::lean_apply_4(
        v_toBind_275_,
        crate::leanh::lean_box(0),
        crate::leanh::lean_box(0),
        v_x_273_,
...
pub unsafe fn runtime_initialize_Lean_Data_LBool(builtin: u8) -> *mut crate::leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_Data_LBool(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Data_LBool(builtin: u8) -> *mut crate::leanh::LeanObject {
    let mut res: *mut crate::leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return crate::leanh::lean_io_result_mk_ok(crate::leanh::lean_box(0));
    }
