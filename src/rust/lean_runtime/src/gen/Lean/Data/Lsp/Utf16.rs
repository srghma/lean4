...
pub unsafe fn l_Char_utf16Size___boxed(mut v_c_285_: *mut LeanObject) -> *mut LeanObject {
    ...
    v_r_288_ = lean_box_uint32(v_res_287_);
    return v_r_288_;
}
...
pub unsafe fn l_WellFounded_opaqueFix_u2083___at___00String_utf16Length_spec__0___redArg(
    ...
    let mut v_prevPos_303_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_300_ == 0 {
                    v___x_301_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l_WellFounded_opaqueFix_u2083___at___00String_utf16Length_spec__0___redArg___boxed(
    mut v___x_308_: *mut LeanObject,
    mut v_s_309_: *mut LeanObject,
    mut v_a_310_: *mut LeanObject,
    mut v_b_311_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_String_utf16Length(mut v_s_313_: *mut LeanObject) -> *mut LeanObject {
    ...
    v___x_316_ = lean_alloc_ctor(0, 3, (0) as u32);
    lean_ctor_set(v___x_316_, 0, v_s_313_);
...
pub unsafe fn l_WellFounded_opaqueFix_u2083___at___00String_utf16Length_spec__0(
    mut v___x_319_: *mut LeanObject,
    mut v_s_320_: *mut LeanObject,
    mut v_inst_321_: *mut LeanObject,
    mut v_R_322_: *mut LeanObject,
    mut v_a_323_: *mut LeanObject,
    mut v_b_324_: *mut LeanObject,
    mut v_c_325_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l___private_Lean_Data_Lsp_Utf16_0__String_codepointPosToUtf16PosFromAux(
    ...
    let mut v_zero_339_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_339_ = lean_unsigned_to_nat(0);
...
pub unsafe fn l_String_codepointPosToUtf16PosFrom___boxed(
    mut v_s_358_: *mut LeanObject,
    mut v_n_359_: *mut LeanObject,
    mut v_off_360_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_String_codepointPosToUtf16Pos(
    mut v_s_362_: *mut LeanObject,
    mut v_pos_363_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_String_utf16PosToCodepointPosFrom(
    ...
    mut v_utf16pos_388_: *mut LeanObject,
    mut v_off_389_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_String_utf16PosToCodepointPosFrom___boxed(
    mut v_s_392_: *mut LeanObject,
    mut v_utf16pos_393_: *mut LeanObject,
    mut v_off_394_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_String_codepointPosToUtf8PosFrom(
    ...
    let mut v_zero_406_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isZero_407_: u8 = 0;
    let mut v_one_408_: *mut LeanObject = core::ptr::null_mut();
    let mut v_n_409_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if v_isZero_407_ == 1 {
                    ...
                    v_one_408_ = lean_unsigned_to_nat(1);
...
pub unsafe fn l___private_Lean_Data_Lsp_Utf16_0__Lean_FileMap_lineStartPos(
    mut v_text_416_: *mut LeanObject,
    mut v_line_417_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_positions_418_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_419_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_420_: u8 = 0;
    v_positions_418_ = lean_ctor_get(v_text_416_, 1);
...
pub unsafe fn l___private_Lean_Data_Lsp_Utf16_0__Lean_FileMap_lineStartPos___boxed(
    mut v_text_427_: *mut LeanObject,
    mut v_line_428_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec(v_line_428_);
    lean_dec_ref(v_text_427_);
    return v_res_429_;
}
pub unsafe fn l_Lean_FileMap_lspPosToUtf8Pos(
    mut v_text_430_: *mut LeanObject,
    mut v_pos_431_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_line_432_: *mut LeanObject = core::ptr::null_mut();
    let mut v_character_433_: *mut LeanObject = core::ptr::null_mut();
    let mut v_source_434_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lineStartPos_435_: *mut LeanObject = core::ptr::null_mut();
    let mut v_chr_436_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_437_: *mut LeanObject = core::ptr::null_mut();
    v_line_432_ = lean_ctor_get(v_pos_431_, 0);
    lean_inc(v_line_432_);
    v_character_433_ = lean_ctor_get(v_pos_431_, 1);
    lean_inc(v_character_433_);
    lean_dec_ref(v_pos_431_);
    v_source_434_ = lean_ctor_get(v_text_430_, 0);
    v_lineStartPos_435_ =
        l___private_Lean_Data_Lsp_Utf16_0__Lean_FileMap_lineStartPos(v_text_430_, v_line_432_);
    lean_dec(v_line_432_);
    lean_inc(v_lineStartPos_435_);
    v_chr_436_ =
...
pub unsafe fn l_Lean_FileMap_lspPosToUtf8Pos___boxed(
    mut v_text_438_: *mut LeanObject,
    mut v_pos_439_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_FileMap_leanPosToLspPos(
    mut v_text_441_: *mut LeanObject,
    mut v_x_442_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_line_443_: *mut LeanObject = core::ptr::null_mut();
    let mut v_column_444_: *mut LeanObject = core::ptr::null_mut();
    let mut v_source_445_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_458_: *mut LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_line_443_ = lean_ctor_get(v_x_442_, 0);
                lean_inc(v_line_443_);
                v_column_444_ = lean_ctor_get(v_x_442_, 1);
                lean_inc(v_column_444_);
                lean_dec_ref(v_x_442_);
                v_source_445_ = lean_ctor_get(v_text_441_, 0);
                lean_inc_ref(v_source_445_);
                v___x_446_ = lean_unsigned_to_nat(1);
                v___x_447_ = lean_nat_sub(v_line_443_, v___x_446_);
                lean_dec(v_line_443_);
                v___x_448_ = l___private_Lean_Data_Lsp_Utf16_0__Lean_FileMap_lineStartPos(
                    v_text_441_,
                    v___x_447_,
                );
                v_isSharedCheck_456_ = (!lean_is_exclusive(v_text_441_)) as u8;
                if v_isSharedCheck_456_ == 0 {
                    v_unused_457_ = lean_ctor_get(v_text_441_, 1);
                    lean_dec(v_unused_457_);
                    v_unused_458_ = lean_ctor_get(v_text_441_, 0);
...
pub unsafe fn l_Lean_FileMap_utf8PosToLspPos(
    mut v_text_459_: *mut LeanObject,
...
pub unsafe fn l_Lean_FileMap_utf8PosToLspPos___boxed(
    mut v_text_463_: *mut LeanObject,
    mut v_pos_464_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_FileMap_utf8RangeToLspRange(
    mut v_text_466_: *mut LeanObject,
    mut v_range_467_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_start_468_: *mut LeanObject = core::ptr::null_mut();
    let mut v_stop_469_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_start_468_ = lean_ctor_get(v_range_467_, 0);
                v_stop_469_ = lean_ctor_get(v_range_467_, 1);
                v_isSharedCheck_478_ = (!lean_is_exclusive(v_range_467_)) as u8;
                if v_isSharedCheck_478_ == 0 {
                    ...
                    lean_inc(v_stop_469_);
                    lean_inc(v_start_468_);
                    lean_dec(v_range_467_);
...
pub unsafe fn l_Lean_FileMap_lspRangeOfStx_x3f(
    mut v_text_479_: *mut LeanObject,
    mut v_stx_480_: *mut LeanObject,
    ...
    let mut v_val_484_: *mut LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if lean_obj_tag(v___x_482_) == 0 {
                    ...
                    v_isSharedCheck_492_ = (!lean_is_exclusive(v___x_482_)) as u8;
...
pub unsafe fn l_Lean_FileMap_lspRangeOfStx_x3f___boxed(
    mut v_text_493_: *mut LeanObject,
    mut v_stx_494_: *mut LeanObject,
    mut v_canonicalOnly_495_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_canonicalOnly_boxed_496_: u8 = 0;
    let mut v_res_497_: *mut LeanObject = core::ptr::null_mut();
    v_canonicalOnly_boxed_496_ = (lean_unbox(v_canonicalOnly_495_) as u8);
    v_res_497_ =
...
pub unsafe fn l_Lean_FileMap_lspRangeToUtf8Range(
    mut v_text_498_: *mut LeanObject,
    mut v_range_499_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_start_500_: *mut LeanObject = core::ptr::null_mut();
    let mut v_end_501_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_start_500_ = lean_ctor_get(v_range_499_, 0);
                v_end_501_ = lean_ctor_get(v_range_499_, 1);
                v_isSharedCheck_510_ = (!lean_is_exclusive(v_range_499_)) as u8;
...
pub unsafe fn l_Lean_FileMap_lspRangeToUtf8Range___boxed(
    mut v_text_511_: *mut LeanObject,
    mut v_range_512_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_DeclarationRange_ofFilePositions(
    mut v_text_514_: *mut LeanObject,
    mut v_pos_515_: *mut LeanObject,
    mut v_endPos_516_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_517_: *mut LeanObject = core::ptr::null_mut();
    let mut v_character_518_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_519_: *mut LeanObject = core::ptr::null_mut();
    let mut v_character_520_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_521_: *mut LeanObject = core::ptr::null_mut();
    lean_inc_ref(v_pos_515_);
    lean_inc_ref(v_text_514_);
    v___x_517_ = l_Lean_FileMap_leanPosToLspPos(v_text_514_, v_pos_515_);
    v_character_518_ = lean_ctor_get(v___x_517_, 1);
    lean_inc(v_character_518_);
    lean_dec_ref(v___x_517_);
    lean_inc_ref(v_endPos_516_);
    v___x_519_ = l_Lean_FileMap_leanPosToLspPos(v_text_514_, v_endPos_516_);
    v_character_520_ = lean_ctor_get(v___x_519_, 1);
    lean_inc(v_character_520_);
    lean_dec_ref(v___x_519_);
    v___x_521_ = lean_alloc_ctor(0, 4, (0) as u32);
    lean_ctor_set(v___x_521_, 0, v_pos_515_);
    lean_ctor_set(v___x_521_, 1, v_character_518_);
    lean_ctor_set(v___x_521_, 2, v_endPos_516_);
    lean_ctor_set(v___x_521_, 3, v_character_520_);
    return v___x_521_;
}
pub unsafe fn l_Lean_DeclarationRange_ofStringPositions(
    mut v_text_522_: *mut LeanObject,
    mut v_pos_523_: *mut LeanObject,
    mut v_endPos_524_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lean_DeclarationRange_ofStringPositions___boxed(
    mut v_text_528_: *mut LeanObject,
    mut v_pos_529_: *mut LeanObject,
    mut v_endPos_530_: *mut LeanObject,
) -> *mut LeanObject {
    ...
    lean_dec(v_endPos_530_);
    lean_dec(v_pos_529_);
    return v_res_531_;
}
pub unsafe fn l_Lean_DeclarationRange_toLspRange(mut v_r_532_: *mut LeanObject) -> *mut LeanObject {
    let mut v_pos_533_: *mut LeanObject = core::ptr::null_mut();
    let mut v_endPos_534_: *mut LeanObject = core::ptr::null_mut();
    let mut v_charUtf16_535_: *mut LeanObject = core::ptr::null_mut();
    let mut v_endCharUtf16_536_: *mut LeanObject = core::ptr::null_mut();
    let mut v_line_537_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_539_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_540_: u8 = 0;
    let mut v_line_541_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_pos_533_ = lean_ctor_get(v_r_532_, 0);
                lean_inc_ref(v_pos_533_);
                v_endPos_534_ = lean_ctor_get(v_r_532_, 2);
                lean_inc_ref(v_endPos_534_);
                v_charUtf16_535_ = lean_ctor_get(v_r_532_, 1);
                lean_inc(v_charUtf16_535_);
                v_endCharUtf16_536_ = lean_ctor_get(v_r_532_, 3);
                lean_inc(v_endCharUtf16_536_);
                lean_dec_ref(v_r_532_);
                v_line_537_ = lean_ctor_get(v_pos_533_, 0);
                v_isSharedCheck_557_ = (!lean_is_exclusive(v_pos_533_)) as u8;
                if v_isSharedCheck_557_ == 0 {
                    v_unused_558_ = lean_ctor_get(v_pos_533_, 1);
            ...
            1 => {
                v_line_541_ = lean_ctor_get(v_endPos_534_, 0);
                v_isSharedCheck_555_ = (!lean_is_exclusive(v_endPos_534_)) as u8;
                if v_isSharedCheck_555_ == 0 {
                    v_unused_556_ = lean_ctor_get(v_endPos_534_, 1);
                    ...
                    lean_inc(v_line_541_);
                    lean_dec(v_endPos_534_);
            ...
            2 => {
                v___x_545_ = lean_unsigned_to_nat(1);
                v___x_546_ = lean_nat_sub(v_line_537_, v___x_545_);
                lean_dec(v_line_537_);
                if v_isShared_544_ == 0 {
                    lean_ctor_set(v___x_543_, 1, v_charUtf16_535_);
                    ...
                    lean_ctor_set(v_reuseFailAlloc_554_, 1, v_charUtf16_535_);
            ...
            3 => {
                ...
                lean_dec(v_line_541_);
                if v_isShared_540_ == 0 {
                    lean_ctor_set(v___x_539_, 1, v_endCharUtf16_536_);
                    lean_ctor_set(v___x_539_, 0, v___x_549_);
                    v___x_551_ = v___x_539_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_553_ = lean_alloc_ctor(0, 2, (0) as u32);
                    lean_ctor_set(v_reuseFailAlloc_553_, 0, v___x_549_);
                    lean_ctor_set(v_reuseFailAlloc_553_, 1, v_endCharUtf16_536_);
...
pub unsafe fn runtime_initialize_Lean_Data_Lsp_Utf16(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lean_Data_Lsp_Utf16(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Data_Lsp_Utf16(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
