...
pub static l_Lake_Target_repr___redArg___closed__0_value: LeanStringObject<15> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lake_Target_repr___redArg___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_Target_repr___redArg___closed__0_value) as *mut LeanObject;
pub static l_Lake_Target_repr___redArg___closed__1_value: LeanCtorObject<1> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
    ...
    m_objs: [core::ptr::addr_of!(l_Lake_Target_repr___redArg___closed__0_value) as *mut LeanObject],
};
static mut l_Lake_Target_repr___redArg___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_Target_repr___redArg___closed__1_value) as *mut LeanObject;
pub static l_Lake_Target_repr___redArg___closed__2_value: LeanCtorObject<2> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lake_Target_repr___redArg___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_Target_repr___redArg___closed__2_value) as *mut LeanObject;
static mut l_Lake_Target_repr___redArg___closed__3_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lake_Target_repr___redArg___closed__3: *mut LeanObject = core::ptr::null_mut();
static mut l_Lake_Target_repr___redArg___closed__4_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lake_Target_repr___redArg___closed__4: *mut LeanObject = core::ptr::null_mut();
pub static l_Lake_Target_instRepr___closed__0_value: LeanClosureObject<1> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lake_Target_instRepr___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_Target_instRepr___closed__0_value) as *mut LeanObject;
pub static l_Lake_Target_instToString___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
            + core::mem::size_of::<*const core::ffi::c_void>()
...
static mut l_Lake_Target_instToString___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_Target_instToString___closed__0_value) as *mut LeanObject;
pub static l_Lake_Target_instCoePartialBuildKey___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lake_Target_instCoePartialBuildKey___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_Target_instCoePartialBuildKey___closed__0_value) as *mut LeanObject;
pub unsafe fn _init_l_Lake_Target_repr___redArg___closed__3() -> *mut LeanObject {
...
pub unsafe fn l_Lake_Target_repr___redArg(
    ...
    let mut v_ctor_67_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v___x_72_ = lean_unsigned_to_nat(1024);
                v___x_73_ = lean_nat_dec_le(v___x_72_, v_prec_61_);
                if v___x_73_ == 0 {
                    v___x_74_ = lean_obj_once(
            ...
            1 => {
                ...
                v___x_65_ = lean_unsigned_to_nat(1024);
                v___x_66_ = l_Lake_instReprBuildKey_repr(v_x_60_, v___x_65_);
                v_ctor_67_ = lean_alloc_ctor(5, 2, (0) as u32);
                lean_ctor_set(v_ctor_67_, 0, v___x_64_);
                lean_ctor_set(v_ctor_67_, 1, v___x_66_);
                lean_inc(v___y_63_);
                v___x_68_ = lean_alloc_ctor(4, 2, (0) as u32);
                lean_ctor_set(v___x_68_, 0, v___y_63_);
                lean_ctor_set(v___x_68_, 1, v_ctor_67_);
                v___x_69_ = 0;
                v___x_70_ = lean_alloc_ctor(6, 1, (1) as u32);
...
pub unsafe fn l_Lake_Target_instRepr(mut v_00_u03b1_88_: *mut LeanObject) -> *mut LeanObject {
    let mut v___x_89_: *mut LeanObject = core::ptr::null_mut();
    v___x_89_ = l_Lake_Target_instRepr___closed__0;
    return v___x_89_;
}
pub unsafe fn l_Lake_Target_instToString(mut v_00_u03b1_91_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn runtime_initialize_Lake_Build_Target_Basic(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lake_Build_Target_Basic(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Build_Target_Basic(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
