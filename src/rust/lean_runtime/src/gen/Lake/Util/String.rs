...
use crate::leanh::{
    ...
    lean_io_result_is_error, lean_io_result_mk_ok, lean_obj_once, lean_unbox, lean_unbox_uint32,
    lean_unbox_uint64, lean_unsigned_to_nat,
};
pub static l_Lake_lpadAscii___closed__0_value: LeanStringObject<1> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lake_lpadAscii___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_lpadAscii___closed__0_value) as *mut LeanObject;
static mut l_Lake_lowerHexUInt64___closed__0_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lake_lowerHexUInt64___closed__0: *mut LeanObject = core::ptr::null_mut();
static mut l_Lake_lowerHexUInt64___closed__1_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lake_lowerHexUInt64___closed__1: *mut LeanObject = core::ptr::null_mut();
pub unsafe fn l___private_Init_Data_Nat_Basic_0__Nat_repeatTR_loop___at___00Lake_lpadAscii_spec__0(
    ...
    let mut v_zero_219_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_zero_219_ = lean_unsigned_to_nat(0);
...
pub unsafe fn l___private_Init_Data_Nat_Basic_0__Nat_repeatTR_loop___at___00Lake_lpadAscii_spec__0___boxed(
    ...
    v_c_boxed_228_ = lean_unbox_uint32(v_c_225_);
    lean_dec(v_c_225_);
    v_res_229_ =
...
pub unsafe fn l_Lake_lpadAscii___boxed(
    ...
    mut v_c_240_: *mut LeanObject,
    mut v_len_241_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_c_boxed_242_: u32 = 0;
    let mut v_res_243_: *mut LeanObject = core::ptr::null_mut();
    v_c_boxed_242_ = lean_unbox_uint32(v_c_240_);
    lean_dec(v_c_240_);
...
pub unsafe fn l_Lake_rpadAscii(
    mut v_s_244_: *mut LeanObject,
    mut v_c_245_: u32,
    mut v_len_246_: *mut LeanObject,
) -> *mut LeanObject {
...
pub unsafe fn l_Lake_rpadAscii___boxed(
    mut v_s_250_: *mut LeanObject,
    mut v_c_251_: *mut LeanObject,
    mut v_len_252_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_c_boxed_253_: u32 = 0;
    let mut v_res_254_: *mut LeanObject = core::ptr::null_mut();
    v_c_boxed_253_ = lean_unbox_uint32(v_c_251_);
    lean_dec(v_c_251_);
...
pub unsafe fn l___private_Init_Data_Nat_Fold_0__Nat_allTR_loop___at___00Lake_isHex_spec__0___redArg(
    ...
    let mut v_zero_266_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isZero_267_: u8 = 0;
    let mut v_one_268_: *mut LeanObject = core::ptr::null_mut();
    let mut v_n_269_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Lake_isHex(mut v_s_292_: *mut LeanObject) -> u8 {
...
pub unsafe fn l_Lake_isHex___boxed(mut v_s_295_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l___private_Lake_Util_String_0__Lake_lowerHexByte___boxed(
    ...
    v_n_boxed_317_ = (lean_unbox(v_n_316_) as u8);
...
pub unsafe fn l_Lake_lowerHexUInt64(mut v_n_331_: u64) -> *mut LeanObject {
...
pub unsafe fn l_Lake_lowerHexUInt64___boxed(mut v_n_428_: *mut LeanObject) -> *mut LeanObject {
    let mut v_n_boxed_429_: u64 = 0;
    let mut v_res_430_: *mut LeanObject = core::ptr::null_mut();
    v_n_boxed_429_ = lean_unbox_uint64(v_n_428_);
    lean_dec_ref(v_n_428_);
    v_res_430_ = l_Lake_lowerHexUInt64(v_n_boxed_429_);
    return v_res_430_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lake_Util_String(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lake_Util_String(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Util_String(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
