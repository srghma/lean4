...
pub static l_Lake_invalidConfigEnvVar___closed__0_value: LeanStringObject<20> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lake_invalidConfigEnvVar___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_invalidConfigEnvVar___closed__0_value) as *mut LeanObject;
pub static mut l_Lake_invalidConfigEnvVar: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_invalidConfigEnvVar___closed__0_value) as *mut LeanObject;
static mut l_panic___at___00__private_Lake_CLI_Serve_0__Lake_setupFile_print_x21_spec__1___closed__0_once: LeanOnceCell = LeanOnceCell { state: core::sync::atomic::AtomicI32::new(0), lock: core::sync::atomic::AtomicI32::new(0) };
static mut l_panic___at___00__private_Lake_CLI_Serve_0__Lake_setupFile_print_x21_spec__1___closed__0: *mut LeanObject = core::ptr::null_mut();
...
static mut l___private_Lake_CLI_Serve_0__Lake_setupFile_print_x21___closed__0: *mut LeanObject =
...
static mut l___private_Lake_CLI_Serve_0__Lake_setupFile_print_x21___closed__1: *mut LeanObject =
...
static mut l___private_Lake_CLI_Serve_0__Lake_setupFile_print_x21___closed__2: *mut LeanObject =
...
static mut l___private_Lake_CLI_Serve_0__Lake_setupFile_eprint_x21___closed__0: *mut LeanObject =
...
static mut l___private_Lake_CLI_Serve_0__Lake_setupFile_eprint_x21___closed__1: *mut LeanObject =
...
static mut l___private_Lake_CLI_Serve_0__Lake_setupFile_eprint_x21___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l___private_Lake_CLI_Serve_0__Lake_setupFile_eprint_x21___closed__2_value)
        as *mut LeanObject;
pub static l_Lake_setupFile___closed__0_value: LeanStringObject<97> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
    ...
    m_length: 96,
    m_data: [
        70, 97, 105, 108, 101, 100, 32, 116, 111, 32, 99, 111, 110, 102, 105, 103, 117, 114, 101,
        32, 116, 104, 101, 32, 76, 97, 107, 101, 32, 119, 111, 114, 107, 115, 112, 97, 99, 101, 46,
        32, 80, 108, 101, 97, 115, 101, 32, 114, 101, 115, 116, 97, 114, 116, 32, 116, 104, 101,
        32, 115, 101, 114, 118, 101, 114, 32, 97, 102, 116, 101, 114, 32, 102, 105, 120, 105, 110,
        103, 32, 116, 104, 101, 32, 101, 114, 114, 111, 114, 32, 97, 98, 111, 118, 101, 46, 10, 0,
    ],
};
static mut l_Lake_setupFile___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_setupFile___closed__0_value) as *mut LeanObject;
pub static l_Lake_setupFile___closed__1_value: LeanStringObject<38> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
    ...
    m_length: 37,
    m_data: [
        70, 97, 105, 108, 101, 100, 32, 116, 111, 32, 98, 117, 105, 108, 100, 32, 109, 111, 100,
        117, 108, 101, 32, 100, 101, 112, 101, 110, 100, 101, 110, 99, 105, 101, 115, 46, 10, 0,
    ],
};
static mut l_Lake_setupFile___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_setupFile___closed__1_value) as *mut LeanObject;
pub static l_Lake_setupFile___closed__2_value: LeanStringObject<36> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
    ...
    m_length: 35,
    m_data: [
        70, 97, 105, 108, 101, 100, 32, 116, 111, 32, 108, 111, 97, 100, 32, 116, 104, 101, 32, 76,
        97, 107, 101, 32, 119, 111, 114, 107, 115, 112, 97, 99, 101, 46, 10, 0,
    ],
};
static mut l_Lake_setupFile___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_setupFile___closed__2_value) as *mut LeanObject;
pub static l_Lake_setupFile___closed__3_value: LeanArrayObject<0> = LeanArrayObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Lake_setupFile___closed__3: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_setupFile___closed__3_value) as *mut LeanObject;
pub static l_Lake_serve___closed__0_value: LeanCtorObject<1> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lake_serve___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_serve___closed__0_value) as *mut LeanObject;
pub static l_Lake_serve___closed__1_value: LeanStringObject<9> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
...
static mut l_Lake_serve___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_serve___closed__1_value) as *mut LeanObject;
pub static l_Lake_serve___closed__2_value: LeanArrayObject<1> = LeanArrayObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
            + core::mem::size_of::<usize>() * 2
    ...
    m_size: 1,
    m_capacity: 1,
    m_data: [core::ptr::addr_of!(l_Lake_serve___closed__1_value) as *mut LeanObject],
};
static mut l_Lake_serve___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_serve___closed__2_value) as *mut LeanObject;
pub static l_Lake_serve___closed__3_value: LeanStringObject<81> = LeanStringObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (0) as u16,
        other: 0,
    ...
    m_length: 80,
    m_data: [
        119, 97, 114, 110, 105, 110, 103, 58, 32, 112, 97, 99, 107, 97, 103, 101, 32, 99, 111, 110,
        102, 105, 103, 117, 114, 97, 116, 105, 111, 110, 32, 104, 97, 115, 32, 101, 114, 114, 111,
        114, 115, 44, 32, 102, 97, 108, 108, 105, 110, 103, 32, 98, 97, 99, 107, 32, 116, 111, 32,
        112, 108, 97, 105, 110, 32, 96, 108, 101, 97, 110, 32, 45, 45, 115, 101, 114, 118, 101,
        114, 96, 0,
    ],
};
static mut l_Lake_serve___closed__3: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_serve___closed__3_value) as *mut LeanObject;
...
pub unsafe fn l_panic___at___00__private_Lake_CLI_Serve_0__Lake_setupFile_print_x21_spec__1(
    mut v_msg_303_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_305_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_284__overap_306_: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_IO_print___at___00IO_println___at___00__private_Lake_CLI_Serve_0__Lake_setupFile_print_x21_spec__0_spec__0(
    ...
    let mut v_putStr_314_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_315_: *mut LeanObject = core::ptr::null_mut();
    v___x_313_ = lean_get_stdout();
    v_putStr_314_ = lean_ctor_get(v___x_313_, 4);
    lean_inc_ref(v_putStr_314_);
    lean_dec_ref(v___x_313_);
    v___x_315_ = lean_apply_2(v_putStr_314_, v_s_311_, lean_box(0));
    return v___x_315_;
}
...
pub unsafe fn l___private_Lake_CLI_Serve_0__Lake_setupFile_print_x21(
    ...
    if lean_obj_tag(v___x_332_) == 0 {
        ...
        v___x_337_ = lean_unsigned_to_nat(80);
        v___x_338_ = lean_unsigned_to_nat(6);
...
pub unsafe fn l___private_Lake_CLI_Serve_0__Lake_setupFile_eprint_x21(
    mut v_msg_360_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v___x_362_: *mut LeanObject = core::ptr::null_mut();
    lean_inc_ref(v_msg_360_);
    ...
    if lean_obj_tag(v___x_362_) == 0 {
        ...
        v___x_367_ = lean_unsigned_to_nat(84);
        v___x_368_ = lean_unsigned_to_nat(6);
...
pub unsafe fn l_Lake_setupFile___lam__0___boxed(
    mut v_val_386_: *mut LeanObject,
    mut v_outLv_387_: *mut LeanObject,
    mut v_val_388_: *mut LeanObject,
    ...
    v_outLv_boxed_391_ = (lean_unbox(v_outLv_387_) as u8);
    v_val_1515__boxed_392_ = (lean_unbox(v_val_388_) as u8);
...
pub unsafe fn l_Lake_setupFile(
    mut v_loadConfig_399_: *mut LeanObject,
    mut v_leanFile_400_: *mut LeanObject,
    mut v_header_x3f_401_: *mut LeanObject,
    mut v_buildConfig_402_: *mut LeanObject,
) -> u32 {
    let mut v___x_404_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lakeEnv_405_: *mut LeanObject = core::ptr::null_mut();
    let mut v_configFile_406_: *mut LeanObject = core::ptr::null_mut();
    ...
    lean_inc_ref(v_leanFile_400_);
    v___x_404_ = l_Lake_resolvePath(v_leanFile_400_);
    v_lakeEnv_405_ = lean_ctor_get(v_loadConfig_399_, 0);
    v_configFile_406_ = lean_ctor_get(v_loadConfig_399_, 8);
    lean_inc_ref(v_configFile_406_);
    v___x_407_ = l_Lake_realConfigFile(v_configFile_406_);
    v___x_408_ = lean_string_utf8_byte_size(v___x_407_);
    v___x_409_ = lean_unsigned_to_nat(0);
    ...
    if v___x_410_ == 0 {
        ...
        if v___x_411_ == 0 {
            ...
            if lean_obj_tag(v___x_413_) == 1 {
                ...
                lean_dec_ref(v_buildConfig_402_);
                lean_dec(v_header_x3f_401_);
                lean_dec_ref(v_leanFile_400_);
                lean_dec_ref(v_loadConfig_399_);
                ...
                let mut v_toLogConfig_419_: *mut LeanObject = core::ptr::null_mut();
                ...
                lean_dec(v___x_413_);
                v_toLogConfig_419_ = lean_ctor_get(v_buildConfig_402_, 0);
                v_outLv_420_ = lean_ctor_get_uint8(
                    v_toLogConfig_419_,
                    (core::mem::size_of::<*mut LeanObject>() * 1 + 1) as u32,
                );
                v_ansiMode_421_ = lean_ctor_get_uint8(
                    v_toLogConfig_419_,
                    (core::mem::size_of::<*mut LeanObject>() * 1 + 2) as u32,
                );
                v_out_422_ = lean_ctor_get(v_toLogConfig_419_, 0);
                ...
                v___x_425_ = lean_box((v_outLv_420_) as usize);
                v___x_426_ = lean_box((v___x_424_) as usize);
                v___f_427_ = lean_alloc_closure(
                    l_Lake_setupFile___lam__0___boxed as *mut core::ffi::c_void,
                    5,
                    3,
                );
                lean_closure_set(v___f_427_, 0, v___x_423_);
                ...
                if lean_obj_tag(v___x_428_) == 0 {
                    ...
                    v___x_430_ = lean_alloc_closure(
                        l_Lake_setupServerModule___boxed as *mut core::ffi::c_void,
                        10,
                        3,
                    );
                    lean_closure_set(v___x_430_, 0, v_leanFile_400_);
                    lean_closure_set(v___x_430_, 1, v___x_404_);
                    lean_closure_set(v___x_430_, 2, v_header_x3f_401_);
            ...
            let mut v_lake_442_: *mut LeanObject = core::ptr::null_mut();
            let mut v_sharedDynlib_443_: *mut LeanObject = core::ptr::null_mut();
            let mut v_path_444_: *mut LeanObject = core::ptr::null_mut();
            ...
            lean_inc_ref(v_lakeEnv_405_);
            lean_dec_ref(v___x_404_);
            lean_dec_ref(v_buildConfig_402_);
            lean_dec(v_header_x3f_401_);
            lean_dec_ref(v_leanFile_400_);
            lean_dec_ref(v_loadConfig_399_);
            v_lake_442_ = lean_ctor_get(v_lakeEnv_405_, 0);
            lean_inc_ref(v_lake_442_);
            lean_dec_ref(v_lakeEnv_405_);
            v_sharedDynlib_443_ = lean_ctor_get(v_lake_442_, 4);
            lean_inc_ref(v_sharedDynlib_443_);
            lean_dec_ref(v_lake_442_);
            v_path_444_ = lean_ctor_get(v_sharedDynlib_443_, 0);
            lean_inc_ref(v_path_444_);
            lean_dec_ref(v_sharedDynlib_443_);
            ...
            v___x_453_ = lean_alloc_ctor(0, 7, (1) as u32);
            lean_ctor_set(v___x_453_, 0, v___x_445_);
            lean_ctor_set(v___x_453_, 1, v___x_446_);
            lean_ctor_set(v___x_453_, 2, v___x_446_);
...
pub unsafe fn l_Lake_setupFile___boxed(
    mut v_loadConfig_458_: *mut LeanObject,
    mut v_leanFile_459_: *mut LeanObject,
    mut v_header_x3f_460_: *mut LeanObject,
    mut v_buildConfig_461_: *mut LeanObject,
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lake_serve_spec__1___boxed(
    mut v_as_480_: *mut LeanObject,
    mut v_i_481_: *mut LeanObject,
    mut v_stop_482_: *mut LeanObject,
    ...
    v_i_boxed_485_ = lean_unbox_usize(v_i_481_);
    lean_dec(v_i_481_);
    v_stop_boxed_486_ = lean_unbox_usize(v_stop_482_);
...
pub unsafe fn l_Lake_serve(
    mut v_config_504_: *mut LeanObject,
    mut v_args_505_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_fst_508_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_509_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_510_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lakeEnv_511_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lean_512_: *mut LeanObject = core::ptr::null_mut();
    let mut v_lean_513_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_fst_534_: *mut LeanObject = core::ptr::null_mut();
    let mut v_snd_535_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_537_: *mut LeanObject = core::ptr::null_mut();
    let mut v_isShared_538_: u8 = 0;
    let mut v_val_540_: *mut LeanObject = core::ptr::null_mut();
    let mut v_packages_541_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_542_: *mut LeanObject = core::ptr::null_mut();
    let mut v___x_543_: *mut LeanObject = core::ptr::null_mut();
    let mut v_config_544_: *mut LeanObject = core::ptr::null_mut();
    let mut v_moreGlobalServerArgs_545_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v_lakeEnv_549_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                v___x_532_ = lean_alloc_closure(
                    l_Lake_loadWorkspace___boxed as *mut core::ffi::c_void,
                    3,
                    1,
                );
                lean_closure_set(v___x_532_, 0, v_config_504_);
                ...
                v_isSharedCheck_588_ = (!lean_is_exclusive(v___x_533_)) as u8;
            ...
            1 => {
                ...
                v_lakeEnv_511_ = lean_ctor_get(v_config_504_, 0);
                lean_inc_ref(v_lakeEnv_511_);
                lean_dec_ref(v_config_504_);
                v_lean_512_ = lean_ctor_get(v_lakeEnv_511_, 1);
                lean_inc_ref(v_lean_512_);
                lean_dec_ref(v_lakeEnv_511_);
                v_lean_513_ = lean_ctor_get(v_lean_512_, 7);
                lean_inc_ref(v_lean_513_);
                lean_dec_ref(v_lean_512_);
                ...
                v___x_518_ = 1;
                v___x_519_ = 0;
                v___x_520_ = lean_alloc_ctor(0, 5, (2) as u32);
                lean_ctor_set(v___x_520_, 0, v___x_510_);
                lean_ctor_set(v___x_520_, 1, v_lean_513_);
                lean_ctor_set(v___x_520_, 2, v___x_516_);
                lean_ctor_set(v___x_520_, 3, v___x_517_);
                lean_ctor_set(v___x_520_, 4, v_fst_508_);
                lean_ctor_set_uint8(
                    v___x_520_,
                ...
                if lean_obj_tag(v___x_521_) == 0 {
                    ...
                    v_isSharedCheck_531_ = (!lean_is_exclusive(v___x_521_)) as u8;
            ...
            2 => {
                if v_isShared_527_ == 0 {
                    ...
                    v_reuseFailAlloc_530_ = lean_alloc_ctor(1, 1, (0) as u32);
            ...
            4 => {
                v___x_577_ = lean_unsigned_to_nat(0);
            ...
            5 => {
                if lean_obj_tag(v_fst_534_) == 1 {
                    lean_del_object(v___x_537_);
                    lean_dec(v_snd_535_);
                    v_val_540_ = lean_ctor_get(v_fst_534_, 0);
                    lean_inc(v_val_540_);
                    lean_dec_ref_known(v_fst_534_, 1);
                    v_packages_541_ = lean_ctor_get(v_val_540_, 4);
                    v___x_542_ = lean_unsigned_to_nat(0);
                    v___x_543_ = lean_array_fget_borrowed(v_packages_541_, v___x_542_);
                    v_config_544_ = lean_ctor_get(v___x_543_, 6);
                    v_moreGlobalServerArgs_545_ = lean_ctor_get(v_config_544_, 3);
                    lean_inc_ref(v_moreGlobalServerArgs_545_);
                    ...
                    if lean_obj_tag(v___x_548_) == 0 {
                        ...
                        v_lakeEnv_549_ = lean_ctor_get(v_config_504_, 0);
                        lean_inc_ref(v_lakeEnv_549_);
                        ...
                        if v_isShared_538_ == 0 {
                            lean_ctor_set(v___x_537_, 1, v___x_553_);
                        ...
                        v_isSharedCheck_566_ = (!lean_is_exclusive(v___x_548_)) as u8;
            ...
            7 => {
                if v_isShared_562_ == 0 {
                    ...
                    v_reuseFailAlloc_565_ = lean_alloc_ctor(1, 1, (0) as u32);
            ...
            9 => {
                if lean_obj_tag(v___y_568_) == 0 {
                    ...
                    v_isSharedCheck_576_ = (!lean_is_exclusive(v___y_568_)) as u8;
...
pub unsafe fn l_Lake_serve___boxed(
    mut v_config_589_: *mut LeanObject,
    mut v_args_590_: *mut LeanObject,
...
pub unsafe fn runtime_initialize_Lake_CLI_Serve(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lake_CLI_Serve(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_CLI_Serve(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
