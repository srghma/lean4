...
// Imports: Lake.Config.Script Lake.Config.Dependency Lake.Config.PackageConfig Lake.Config.FacetConfig Lake.Config.TargetConfig
...
use crate::r#gen::Lake::Config::PackageConfig::{
    initialize_Lake_Config_PackageConfig, runtime_initialize_Lake_Config_PackageConfig,
};
...
pub unsafe fn runtime_initialize_Lake_Config_LakefileConfig(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lake_Config_LakefileConfig(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Config_LakefileConfig(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
