...
pub static l_Lake_instReprConfigLang_repr___closed__0_value: LeanStringObject<21> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lake_instReprConfigLang_repr___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__0_value) as *mut LeanObject;
pub static l_Lake_instReprConfigLang_repr___closed__1_value: LeanCtorObject<1> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
...
static mut l_Lake_instReprConfigLang_repr___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__1_value) as *mut LeanObject;
pub static l_Lake_instReprConfigLang_repr___closed__2_value: LeanStringObject<21> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lake_instReprConfigLang_repr___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__2_value) as *mut LeanObject;
pub static l_Lake_instReprConfigLang_repr___closed__3_value: LeanCtorObject<1> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
            + core::mem::size_of::<*mut LeanObject>() * 1
...
static mut l_Lake_instReprConfigLang_repr___closed__3: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang_repr___closed__3_value) as *mut LeanObject;
static mut l_Lake_instReprConfigLang_repr___closed__4_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lake_instReprConfigLang_repr___closed__4: *mut LeanObject = core::ptr::null_mut();
static mut l_Lake_instReprConfigLang_repr___closed__5_once: LeanOnceCell = LeanOnceCell {
    state: core::sync::atomic::AtomicI32::new(0),
    lock: core::sync::atomic::AtomicI32::new(0),
};
static mut l_Lake_instReprConfigLang_repr___closed__5: *mut LeanObject = core::ptr::null_mut();
pub static l_Lake_instReprConfigLang___closed__0_value: LeanClosureObject<0> = LeanClosureObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lake_instReprConfigLang___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang___closed__0_value) as *mut LeanObject;
pub static mut l_Lake_instReprConfigLang: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instReprConfigLang___closed__0_value) as *mut LeanObject;
pub static mut l_Lake_ConfigLang_default: u8 = 0;
pub static mut l_Lake_instInhabitedConfigLang: u8 = 0;
pub static l_Lake_ConfigLang_ofString_x3f___closed__0_value: LeanStringObject<5> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__0_value) as *mut LeanObject;
pub static l_Lake_ConfigLang_ofString_x3f___closed__1_value: LeanStringObject<5> =
    LeanStringObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__1: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__1_value) as *mut LeanObject;
pub static l_Lake_ConfigLang_ofString_x3f___closed__2_value: LeanCtorObject<1> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
            + core::mem::size_of::<*mut LeanObject>() * 1
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__2: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__2_value) as *mut LeanObject;
pub static l_Lake_ConfigLang_ofString_x3f___closed__3_value: LeanCtorObject<1> = LeanCtorObject {
    m_header: LeanObject {
        rc: 0,
        cs_size: (core::mem::size_of::<LeanObject>()
            + core::mem::size_of::<*mut LeanObject>() * 1
...
static mut l_Lake_ConfigLang_ofString_x3f___closed__3: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_ConfigLang_ofString_x3f___closed__3_value) as *mut LeanObject;
pub static l_Lake_instToStringConfigLang___closed__0_value: LeanClosureObject<0> =
    LeanClosureObject {
        m_header: LeanObject {
            rc: 0,
            cs_size: (core::mem::size_of::<LeanObject>()
...
static mut l_Lake_instToStringConfigLang___closed__0: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instToStringConfigLang___closed__0_value) as *mut LeanObject;
pub static mut l_Lake_instToStringConfigLang: *mut LeanObject =
    core::ptr::addr_of!(l_Lake_instToStringConfigLang___closed__0_value) as *mut LeanObject;
pub unsafe fn l_Lake_ConfigLang_ctorIdx(mut v_x_140_: u8) -> *mut LeanObject {
    if v_x_140_ == 0 {
...
pub unsafe fn l_Lake_ConfigLang_ctorIdx___boxed(mut v_x_143_: *mut LeanObject) -> *mut LeanObject {
    let mut v_x_boxed_144_: u8 = 0;
    let mut v_res_145_: *mut LeanObject = core::ptr::null_mut();
    v_x_boxed_144_ = (lean_unbox(v_x_143_) as u8);
    v_res_145_ = l_Lake_ConfigLang_ctorIdx(v_x_boxed_144_);
    return v_res_145_;
}
pub unsafe fn l_Lake_ConfigLang_toCtorIdx(mut v_x_146_: u8) -> *mut LeanObject {
...
pub unsafe fn l_Lake_ConfigLang_ctorElim___boxed(
    mut v_motive_159_: *mut LeanObject,
    mut v_ctorIdx_160_: *mut LeanObject,
    mut v_t_161_: *mut LeanObject,
    mut v_h_162_: *mut LeanObject,
    mut v_k_163_: *mut LeanObject,
) -> *mut LeanObject {
    let mut v_t_boxed_164_: u8 = 0;
    let mut v_res_165_: *mut LeanObject = core::ptr::null_mut();
    v_t_boxed_164_ = (lean_unbox(v_t_161_) as u8);
...
pub unsafe fn l_Lake_instReprConfigLang_repr(
    ...
    let mut v___y_205_: *mut LeanObject = core::ptr::null_mut();
    ...
    let mut v___y_212_: *mut LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if v_x_202_ == 0 {
                    v___x_218_ = lean_unsigned_to_nat(1024);
                    ...
                    v___x_222_ = lean_unsigned_to_nat(1024);
            ...
            1 => {
                ...
                lean_inc(v___y_205_);
                v___x_207_ = lean_alloc_ctor(4, 2, (0) as u32);
                lean_ctor_set(v___x_207_, 0, v___y_205_);
                lean_ctor_set(v___x_207_, 1, v___x_206_);
                v___x_208_ = 0;
                v___x_209_ = lean_alloc_ctor(6, 1, (1) as u32);
            ...
            2 => {
                ...
                lean_inc(v___y_212_);
                v___x_214_ = lean_alloc_ctor(4, 2, (0) as u32);
                lean_ctor_set(v___x_214_, 0, v___y_212_);
                lean_ctor_set(v___x_214_, 1, v___x_213_);
                v___x_215_ = 0;
                v___x_216_ = lean_alloc_ctor(6, 1, (1) as u32);
...
pub unsafe fn l_Lake_ConfigLang_ofNat___boxed(mut v_n_237_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Lake_instDecidableEqConfigLang___boxed(
    ...
    v_x_13__boxed_247_ = (lean_unbox(v_x_245_) as u8);
    v_y_14__boxed_248_ = (lean_unbox(v_y_246_) as u8);
    v_res_249_ = l_Lake_instDecidableEqConfigLang(v_x_13__boxed_247_, v_y_14__boxed_248_);
    v_r_250_ = lean_box((v_res_249_) as usize);
    return v_r_250_;
}
...
pub unsafe fn l_Lake_ConfigLang_ofString_x3f(mut v_x_261_: *mut LeanObject) -> *mut LeanObject {
...
pub unsafe fn l_Lake_ConfigLang_fileExtension(mut v_x_271_: u8) -> *mut LeanObject {
    if v_x_271_ == 0 {
...
pub unsafe fn l_Lake_ConfigLang_fileExtension___boxed(
    ...
    v_x_20__boxed_275_ = (lean_unbox(v_x_274_) as u8);
    v_res_276_ = l_Lake_ConfigLang_fileExtension(v_x_20__boxed_275_);
    return v_res_276_;
}
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lake_Config_Lang(builtin: u8) -> *mut LeanObject {
...
pub unsafe fn meta_initialize_Lake_Config_Lang(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lake_Config_Lang(builtin: u8) -> *mut LeanObject {
    let mut res: *mut LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return lean_io_result_mk_ok(lean_box(0));
    }
