...
#[inline]
pub unsafe fn LLVMBuildLoad2(builder: usize, ty: usize, slot: usize, name: *const c_char) -> usize {
...
#[inline]
pub unsafe fn LLVMConstInt(ty: usize, val: u64, sext: bool) -> usize {
    core::LLVMConstInt(ty as _, val, sext as _) as usize
}
...
pub unsafe fn LLVMConstStringInContext(
    ...
    core::LLVMConstStringInContext(ctx as _, string, len as _, dont_null_terminate as _)
        as usize
}
...
#[inline]
pub unsafe fn LLVMIsDeclaration(global: usize) -> bool {
    core::LLVMIsDeclaration(global as _) != 0
}

#[inline]
pub unsafe fn LLVMVerifyModule(module: usize, action: c_uint, err: *mut *mut c_char) -> c_int {
