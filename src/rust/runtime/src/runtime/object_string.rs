...
pub(crate) mod runtime_object_string_impl {
    ...
    #[inline]
    pub(crate) fn lean_char_default_value() -> u32 {
        b'A' as u32
    }
    ...
    unsafe fn lean_usize_to_nat(n: usize) -> *mut LeanObject { // duplicate in leanh at line 89 (🔁)
        if n <= LEAN_MAX_SMALL_NAT {
            ...
            crate::runtime::runtime_object_nat_int_impl::lean_big_usize_to_nat(n)
        }
    }
    ...
    unsafe fn lean_nat_add(a1: *mut LeanObject, a2: *mut LeanObject) -> *mut LeanObject { // duplicate in leanh at line 99 (🔁)
        if lean_is_scalar(a1) && lean_is_scalar(a2) {
            ...
            crate::runtime::runtime_object_nat_int_impl::lean_nat_big_add(a1, a2)
        }
    }
    ...
    unsafe fn lean_nat_sub(a1: *mut LeanObject, a2: *mut LeanObject) -> *mut LeanObject { // duplicate in leanh at line 109 (🔁)
        if lean_is_scalar(a1) && lean_is_scalar(a2) {
            ...
            crate::runtime::runtime_object_nat_int_impl::lean_nat_big_sub(a1, a2)
        }
    }
    ...
    #[inline]
    pub(crate) unsafe fn lean_mk_string_from_bytes(
        s: *const c_char,
        sz: usize,
    ) -> *mut LeanObject {
        let mut pos: usize = 0;
    ...
    #[inline]
    pub(crate) unsafe fn lean_mk_string_from_bytes_unchecked(
        s: *const c_char,
        sz: usize,
    ) -> *mut LeanObject {
    ...
    #[inline]
    pub(crate) unsafe fn lean_mk_ascii_string_unchecked(s: *const c_char) -> *mut LeanObject {
        let mut p = s;
        while *p != 0 {
            p = p.add(1);
        }
    ...
    #[inline]
    pub(crate) unsafe fn lean_string_eq_cold(s1: *mut LeanObject, s2: *mut LeanObject) -> bool {
    ...
    #[inline]
    pub(crate) unsafe fn lean_sarray_eq_cold(a1: *mut LeanObject, a2: *mut LeanObject) -> bool {
    ...
    #[inline]
    pub(crate) unsafe fn lean_string_lt(s1: *mut LeanObject, s2: *mut LeanObject) -> bool {
    ...
    #[inline]
    pub(crate) unsafe fn lean_string_utf8_get_fast_cold(
        str: *const c_char,
        i: usize,
        size: usize,
        c: u8,
    ...
    #[inline]
    pub(crate) unsafe fn lean_string_utf8_next_fast_cold(i: usize, c: u8) -> *mut LeanObject {
        if (c & 0xe0) == 0xc0 {
            return lean_box(i + 2);
        }
        if (c & 0xf0) == 0xe0 {
