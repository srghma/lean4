...
use leanh::{
    ...
    LEAN_THUNK_TAG, LeanObject, lean_ctor_get_uint64, lean_dec, lean_io_result_mk_ok,
    lean_is_scalar, lean_is_scalar_bool, lean_mk_string,
};
...
pub(crate) unsafe fn lean_compacted_region_save(
    // [lean-audit] Lean imports from Rust ([extern]): Rust defined this function and function body is not empty (correct) (✅) | Lean: src/Lean/CompactedRegion.lean:69
