...
#[inline]
pub(crate) unsafe fn lean_set_non_heap_header_for_big(obj: *mut LeanObject, tag: u32, other: u32) {
...
pub(crate) unsafe fn lean_alloc_sarray_would_overflow(elem_size: c_uint, capacity: Size) -> bool {
    ...
    if lean_usize_add_would_overflow(
...
pub(crate) unsafe fn lean_sarray_data_byte_size(obj: *mut LeanObject) -> usize {
    core::mem::size_of::<LeanScalarArray>()
        + lean_sarray_elem_size(obj) as usize * lean_sarray_size(obj)
}
...
pub(crate) unsafe fn lean_sarray_eq(a1: *mut LeanObject, a2: *mut LeanObject) -> bool {
    ...
    a1 == a2
        || (lean_sarray_size(a1) == lean_sarray_size(a2)
            && runtime_object_string_impl::lean_sarray_eq_cold(a1, a2))
}
...
pub(crate) fn env_flag(value: &str) -> u8 {
...
#[inline]
pub(crate) unsafe fn lean_nat_eq(a: *mut LeanObject, b: *mut LeanObject) -> bool {
    if lean_is_scalar(a) && lean_is_scalar(b) {
        a == b
    } else {
        runtime_object_nat_int_impl::lean_nat_big_eq(a, b)
    }
}
...
#[inline]
pub(crate) unsafe fn lean_nat_ne(a: *mut LeanObject, b: *mut LeanObject) -> bool {
    !lean_nat_eq(a, b)
}

#[inline]
pub(crate) unsafe fn lean_nat_le(a: *mut LeanObject, b: *mut LeanObject) -> bool {
    if lean_is_scalar(a) && lean_is_scalar(b) {
...
#[inline]
pub(crate) unsafe fn lean_nat_lt(a: *mut LeanObject, b: *mut LeanObject) -> bool {
    if lean_is_scalar(a) && lean_is_scalar(b) {
        (a as usize) < (b as usize)
    } else {
        runtime_object_nat_int_impl::lean_nat_big_lt(a, b)
    }
}
...
macro_rules! define_integer_float_casts {
    (
        ...
        pub unsafe fn $to_f64_u8(a: u8) -> f64 {
            a as f64
        }
        pub unsafe fn $to_f64_u16(a: u16) -> f64 {
            a as f64
        }
        pub unsafe fn $to_f64_u32(a: u32) -> f64 {
            a as f64
        }
        pub unsafe fn $to_f64_u64(a: u64) -> f64 {
            a as f64
        }
        pub unsafe fn $to_f64_usize(a: usize) -> f64 {
            a as f64
        }
        pub unsafe fn $to_f64_i8(a: u8) -> f64 {
            (a as i8) as f64
        }
        pub unsafe fn $to_f64_i16(a: u16) -> f64 {
            (a as i16) as f64
        }
        pub unsafe fn $to_f64_i32(a: u32) -> f64 {
            (a as i32) as f64
        }
        pub unsafe fn $to_f64_i64(a: u64) -> f64 {
            (a as i64) as f64
        }
        pub unsafe fn $to_f64_isize(a: usize) -> f64 {
            (a as isize) as f64
        }
        pub unsafe fn $to_f32_u8(a: u8) -> f32 {
            a as f32
        }
        pub unsafe fn $to_f32_u16(a: u16) -> f32 {
            a as f32
        }
        pub unsafe fn $to_f32_u32(a: u32) -> f32 {
            a as f32
        }
        pub unsafe fn $to_f32_u64(a: u64) -> f32 {
            a as f32
        }
        pub unsafe fn $to_f32_usize(a: usize) -> f32 {
            a as f32
        }
        pub unsafe fn $to_f32_i8(a: u8) -> f32 {
            (a as i8) as f32
        }
        pub unsafe fn $to_f32_i16(a: u16) -> f32 {
            (a as i16) as f32
        }
        pub unsafe fn $to_f32_i32(a: u32) -> f32 {
            (a as i32) as f32
        }
        pub unsafe fn $to_f32_i64(a: u64) -> f32 {
            (a as i64) as f32
        }
        pub unsafe fn $to_f32_isize(a: usize) -> f32 {
            (a as isize) as f32
        }
    };
}
...
pub(crate) unsafe fn consume_io_result(label: &str, result: *mut LeanObject) {
...
#[inline]
pub(crate) unsafe fn lean_smap_foreach(m: *mut LeanObject, cb: LeanMapForeachFn, ctx: *mut c_void) {
...
pub(crate) unsafe fn lean_int64_to_int_rust(value: i64) -> *mut LeanObject {
    runtime_object_nat_int_impl::lean_big_int64_to_int(value)
}
...
#[inline]
pub(crate) unsafe fn lean_runtime_push_unicode_scalar(dst: *mut c_char, code: c_uint) -> c_uint {
