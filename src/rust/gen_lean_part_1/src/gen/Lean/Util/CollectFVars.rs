...
static mut l_Lean_CollectFVars_instInhabitedState_default___closed__3:
    *mut leanh::LeanObject = core::ptr::null_mut();
pub static mut l_Lean_CollectFVars_instInhabitedState_default: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub static mut l_Lean_CollectFVars_instInhabitedState: *mut leanh::LeanObject =
    core::ptr::null_mut();
...
-> *mut leanh::LeanObject {
    ...
    v___x_240_ = leanh::lean_unsigned_to_nat(16);
...
-> *mut leanh::LeanObject {
    ...
    v___x_243_ = leanh::lean_unsigned_to_nat(0);
    v___x_244_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
...
-> *mut leanh::LeanObject {
    ...
    v___x_250_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
...
pub unsafe fn _init_l_Lean_CollectFVars_instInhabitedState_default() -> *mut leanh::LeanObject
{
...
pub unsafe fn _init_l_Lean_CollectFVars_instInhabitedState() -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_CollectFVars_State_add(
    mut v_s_253_: *mut leanh::LeanObject,
    mut v_fvarId_254_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_visitedExpr_255_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fvarSet_256_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fvarIds_257_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_265_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_266_: u8 = 0;
    let mut state = 0;
    loop {
        match state {
            0 => {
                v_visitedExpr_255_ = leanh::lean_ctor_get(v_s_253_, 0);
                v_fvarSet_256_ = leanh::lean_ctor_get(v_s_253_, 1);
                v_fvarIds_257_ = leanh::lean_ctor_get(v_s_253_, 2);
                v_isSharedCheck_266_ = (!leanh::lean_is_exclusive(v_s_253_)) as u8;
                if v_isSharedCheck_266_ == 0 {
                    ...
                    leanh::lean_inc(v_fvarIds_257_);
                    leanh::lean_inc(v_fvarSet_256_);
                    leanh::lean_inc(v_visitedExpr_255_);
                    leanh::lean_dec(v_s_253_);
            ...
            1 => {
                ...
                if v_isShared_260_ == 0 {
                    leanh::lean_ctor_set(v___x_259_, 2, v___x_262_);
                    leanh::lean_ctor_set(v___x_259_, 1, v___x_261_);
                    v___x_264_ = v___x_259_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_265_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_265_, 0, v_visitedExpr_255_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_265_, 1, v___x_261_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_265_, 2, v___x_262_);
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_contains___at___00Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_CollectFVars_visit_spec__0_spec__1___redArg(
    ...
    let mut v_key_270_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_268_) == 0 {
                    ...
                    v_key_270_ = leanh::lean_ctor_get(v_x_268_, 0);
                    v_tail_271_ = leanh::lean_ctor_get(v_x_268_, 2);
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_foldlM___at___00__private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_CollectFVars_visit_spec__1_spec__3_spec__4_spec__5___redArg(
    ...
    let mut v_key_280_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_value_281_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_tail_282_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_279_) == 0 {
                    ...
                    v_key_280_ = leanh::lean_ctor_get(v_x_279_, 0);
                    v_value_281_ = leanh::lean_ctor_get(v_x_279_, 1);
                    v_tail_282_ = leanh::lean_ctor_get(v_x_279_, 2);
                    v_isSharedCheck_305_ = (!leanh::lean_is_exclusive(v_x_279_)) as u8;
                    if v_isSharedCheck_305_ == 0 {
                        ...
                        leanh::lean_inc(v_tail_282_);
                        leanh::lean_inc(v_value_281_);
                        leanh::lean_inc(v_key_280_);
                        leanh::lean_dec(v_x_279_);
            ...
            1 => {
                ...
                leanh::lean_inc(v___x_299_);
                if v_isShared_285_ == 0 {
                    leanh::lean_ctor_set(v___x_284_, 2, v___x_299_);
                    v___x_301_ = v___x_284_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_304_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_304_, 0, v_key_280_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_304_, 1, v_value_281_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_304_, 2, v___x_299_);
...
pub unsafe fn l___private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_CollectFVars_visit_spec__1_spec__3_spec__4___redArg(
    mut v_i_306_: *mut leanh::LeanObject,
    mut v_source_307_: *mut leanh::LeanObject,
    mut v_target_308_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_309_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_310_: u8 = 0;
    let mut v_es_311_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_312_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_source_313_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_target_314_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_310_ == 0 {
                    leanh::lean_dec_ref(v_source_307_);
                    leanh::lean_dec(v_i_306_);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_CollectFVars_visit_spec__1_spec__3___redArg(
    ...
    v___x_320_ = leanh::lean_unsigned_to_nat(2);
    v_nbuckets_321_ = lean_nat_mul(v___x_319_, v___x_320_);
    v___x_322_ = leanh::lean_unsigned_to_nat(0);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_CollectFVars_visit_spec__1___redArg(
    ...
    mut v_b_328_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_size_329_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_buckets_330_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_bkt_344_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_size_x27_350_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_351_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_buckets_x27_352_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_size_329_ = leanh::lean_ctor_get(v_m_326_, 0);
                v_buckets_330_ = leanh::lean_ctor_get(v_m_326_, 1);
                ...
                if v___x_345_ == 0 {
                    leanh::lean_inc_ref(v_buckets_330_);
                    leanh::lean_inc(v_size_329_);
                    v_isSharedCheck_366_ = (!leanh::lean_is_exclusive(v_m_326_)) as u8;
                    if v_isSharedCheck_366_ == 0 {
                        v_unused_367_ = leanh::lean_ctor_get(v_m_326_, 1);
                        leanh::lean_dec(v_unused_367_);
                        v_unused_368_ = leanh::lean_ctor_get(v_m_326_, 0);
                    ...
                    leanh::lean_dec(v_b_328_);
                    leanh::lean_dec_ref(v_a_327_);
                    return v_m_326_;
                }
            }
            1 => {
                ...
                leanh::lean_dec(v_size_329_);
                leanh::lean_inc(v_bkt_344_);
                v___x_351_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
                leanh::lean_ctor_set(v___x_351_, 0, v_a_327_);
                leanh::lean_ctor_set(v___x_351_, 1, v_b_328_);
                leanh::lean_ctor_set(v___x_351_, 2, v_bkt_344_);
                v_buckets_x27_352_ = lean_array_uset(v_buckets_330_, v___x_343_, v___x_351_);
                v___x_353_ = leanh::lean_unsigned_to_nat(4);
                v___x_354_ = lean_nat_mul(v_size_x27_350_, v___x_353_);
                v___x_355_ = leanh::lean_unsigned_to_nat(3);
                ...
                if v___x_358_ == 0 {
                    ...
                    if v_isShared_348_ == 0 {
                        leanh::lean_ctor_set(v___x_347_, 1, v_val_359_);
                        leanh::lean_ctor_set(v___x_347_, 0, v_size_x27_350_);
                        v___x_361_ = v___x_347_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_362_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_362_, 0, v_size_x27_350_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_362_, 1, v_val_359_);
                    ...
                    if v_isShared_348_ == 0 {
                        leanh::lean_ctor_set(v___x_347_, 1, v_buckets_x27_352_);
                        leanh::lean_ctor_set(v___x_347_, 0, v_size_x27_350_);
                        ...
                        leanh::lean_ctor_set(v_reuseFailAlloc_365_, 0, v_size_x27_350_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_365_, 1, v_buckets_x27_352_);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_CollectFVars_visit_spec__0___redArg(
    ...
    let mut v_buckets_371_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_buckets_371_ = leanh::lean_ctor_get(v_m_369_, 1);
...
pub unsafe fn l_Lean_CollectFVars_main(
    ...
    let mut v_d_394_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_395_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___y_396_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_397_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_398_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_struct_399_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_400_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderType_401_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_402_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderType_403_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_404_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_type_405_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_value_406_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_407_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_fn_411_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_arg_412_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_413_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_414_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_415_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_416_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fvarId_417_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_418_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => match leanh::lean_obj_tag(v_x_391_) {
                11 => {
                    v_struct_399_ = leanh::lean_ctor_get(v_x_391_, 2);
                    leanh::lean_inc_ref(v_struct_399_);
                    leanh::lean_dec_ref_known(v_x_391_, 3);
                    v___x_400_ = l_Lean_CollectFVars_visit(v_struct_399_, v_a_392_);
                    return v___x_400_;
                }
                7 => {
                    v_binderType_401_ = leanh::lean_ctor_get(v_x_391_, 1);
                    leanh::lean_inc_ref(v_binderType_401_);
                    v_body_402_ = leanh::lean_ctor_get(v_x_391_, 2);
                    leanh::lean_inc_ref(v_body_402_);
                    leanh::lean_dec_ref_known(v_x_391_, 3);
                ...
                6 => {
                    v_binderType_403_ = leanh::lean_ctor_get(v_x_391_, 1);
                    leanh::lean_inc_ref(v_binderType_403_);
                    v_body_404_ = leanh::lean_ctor_get(v_x_391_, 2);
                    leanh::lean_inc_ref(v_body_404_);
                    leanh::lean_dec_ref_known(v_x_391_, 3);
                ...
                8 => {
                    v_type_405_ = leanh::lean_ctor_get(v_x_391_, 1);
                    leanh::lean_inc_ref(v_type_405_);
                    v_value_406_ = leanh::lean_ctor_get(v_x_391_, 2);
                    leanh::lean_inc_ref(v_value_406_);
                    v_body_407_ = leanh::lean_ctor_get(v_x_391_, 3);
                    leanh::lean_inc_ref(v_body_407_);
                    leanh::lean_dec_ref_known(v_x_391_, 4);
                ...
                5 => {
                    v_fn_411_ = leanh::lean_ctor_get(v_x_391_, 0);
                    leanh::lean_inc_ref(v_fn_411_);
                    v_arg_412_ = leanh::lean_ctor_get(v_x_391_, 1);
                ...
                10 => {
                    v_expr_415_ = leanh::lean_ctor_get(v_x_391_, 1);
                    leanh::lean_inc_ref(v_expr_415_);
                    leanh::lean_dec_ref_known(v_x_391_, 2);
                    v___x_416_ = l_Lean_CollectFVars_visit(v_expr_415_, v_a_392_);
                    return v___x_416_;
                }
                1 => {
                    v_fvarId_417_ = leanh::lean_ctor_get(v_x_391_, 0);
                    leanh::lean_inc(v_fvarId_417_);
                    leanh::lean_dec_ref_known(v_x_391_, 1);
                    v___x_418_ = l_Lean_CollectFVars_State_add(v_a_392_, v_fvarId_417_);
                    return v___x_418_;
                }
                _ => {
                    leanh::lean_dec_ref(v_x_391_);
                    return v_a_392_;
                }
            },
            1 => {
...
pub unsafe fn l_Lean_CollectFVars_visit(
    mut v_e_419_: *mut leanh::LeanObject,
    mut v_s_420_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_421_: u8 = 0;
    let mut v_visitedExpr_422_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fvarSet_423_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fvarIds_424_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_421_ == 0 {
                    leanh::lean_dec_ref(v_e_419_);
                    return v_s_420_;
                } else {
                    v_visitedExpr_422_ = leanh::lean_ctor_get(v_s_420_, 0);
                    v_fvarSet_423_ = leanh::lean_ctor_get(v_s_420_, 1);
                    v_fvarIds_424_ = leanh::lean_ctor_get(v_s_420_, 2);
                    ...
                    if v___x_425_ == 0 {
                        leanh::lean_inc_ref(v_fvarIds_424_);
                        leanh::lean_inc(v_fvarSet_423_);
                        leanh::lean_inc_ref(v_visitedExpr_422_);
                        v_isSharedCheck_435_ = (!leanh::lean_is_exclusive(v_s_420_)) as u8;
                        if v_isSharedCheck_435_ == 0 {
                            v_unused_436_ = leanh::lean_ctor_get(v_s_420_, 2);
                            leanh::lean_dec(v_unused_436_);
                            v_unused_437_ = leanh::lean_ctor_get(v_s_420_, 1);
                            leanh::lean_dec(v_unused_437_);
                            v_unused_438_ = leanh::lean_ctor_get(v_s_420_, 0);
            ...
            1 => {
                ...
                if v_isShared_428_ == 0 {
                    leanh::lean_ctor_set(v___x_427_, 0, v___x_430_);
                    v___x_432_ = v___x_427_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_434_ = leanh::lean_alloc_ctor(0, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_434_, 0, v___x_430_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_434_, 1, v_fvarSet_423_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_434_, 2, v_fvarIds_424_);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_CollectFVars_visit_spec__0(
    ...
    mut v_m_440_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_CollectFVars_visit_spec__0___boxed(
    ...
    let mut v_r_447_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_446_ =
    ...
    leanh::lean_dec_ref(v_m_444_);
    v_r_447_ = leanh::lean_box((v_res_446_) as usize);
    return v_r_447_;
}
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_CollectFVars_visit_spec__1(
    ...
    mut v_b_451_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_contains___at___00Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_CollectFVars_visit_spec__0_spec__1___boxed(
    ...
    v_r_461_ = leanh::lean_box((v_res_460_) as usize);
    return v_r_461_;
}
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_CollectFVars_visit_spec__1_spec__3(
    mut v_00_u03b2_462_: *mut leanh::LeanObject,
    mut v_data_463_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_CollectFVars_visit_spec__1_spec__3_spec__4(
    mut v_00_u03b2_465_: *mut leanh::LeanObject,
    mut v_i_466_: *mut leanh::LeanObject,
    mut v_source_467_: *mut leanh::LeanObject,
    mut v_target_468_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_collectFVars(
    mut v_s_474_: *mut leanh::LeanObject,
...
pub unsafe fn runtime_initialize_Lean_Util_CollectFVars(
    ...
    leanh::lean_mark_persistent(l_Lean_CollectFVars_instInhabitedState_default);
    l_Lean_CollectFVars_instInhabitedState = _init_l_Lean_CollectFVars_instInhabitedState();
    leanh::lean_mark_persistent(l_Lean_CollectFVars_instInhabitedState);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
static mut _G_meta_initialized: bool = false;
pub unsafe fn meta_initialize_Lean_Util_CollectFVars(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Util_CollectFVars(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
