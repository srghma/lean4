...
use crate::ffi::{
    ...
    lean_nat_mul, lean_ptr_addr, lean_uint64_mix_hash, lean_uint64_shift_right,
...
static mut l_Lean_Expr_NumObjs_main___closed__0_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Lean_Expr_NumObjs_main___closed__0: *mut leanh::LeanObject =
    core::ptr::null_mut();
static mut l_Lean_Expr_NumObjs_main___closed__1_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Lean_Expr_NumObjs_main___closed__1: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub unsafe fn l_Std_DHashMap_Internal_AssocList_contains___at___00Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_Expr_NumObjs_visit_spec__0_spec__0___redArg(
    ...
    let mut v_tail_243_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_240_) == 0 {
                    ...
                    v_key_242_ = leanh::lean_ctor_get(v_x_240_, 0);
                    v_tail_243_ = leanh::lean_ctor_get(v_x_240_, 2);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_Expr_NumObjs_visit_spec__0___redArg(
    mut v_m_252_: *mut leanh::LeanObject,
    mut v_a_253_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_buckets_254_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_buckets_254_ = leanh::lean_ctor_get(v_m_252_, 1);
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_foldlM___at___00__private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_Expr_NumObjs_visit_spec__1_spec__2_spec__3_spec__4___redArg(
    ...
    let mut v_key_279_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_value_280_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_278_) == 0 {
                    ...
                    v_key_279_ = leanh::lean_ctor_get(v_x_278_, 0);
                    v_value_280_ = leanh::lean_ctor_get(v_x_278_, 1);
                    v_tail_281_ = leanh::lean_ctor_get(v_x_278_, 2);
                    v_isSharedCheck_307_ = (!leanh::lean_is_exclusive(v_x_278_)) as u8;
                    if v_isSharedCheck_307_ == 0 {
                        ...
                        leanh::lean_inc(v_value_280_);
                        leanh::lean_inc(v_key_279_);
            ...
            1 => {
                ...
                leanh::lean_inc(v___x_301_);
                if v_isShared_284_ == 0 {
                    leanh::lean_ctor_set(v___x_283_, 2, v___x_301_);
                    v___x_303_ = v___x_283_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_306_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_306_, 0, v_key_279_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_306_, 1, v_value_280_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_306_, 2, v___x_301_);
...
pub unsafe fn l___private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_Expr_NumObjs_visit_spec__1_spec__2_spec__3___redArg(
    ...
    mut v_source_309_: *mut leanh::LeanObject,
    mut v_target_310_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v___x_311_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_312_: u8 = 0;
    let mut v_es_313_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_314_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_source_315_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_target_316_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_312_ == 0 {
                    leanh::lean_dec_ref(v_source_309_);
                    leanh::lean_dec(v_i_308_);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_Expr_NumObjs_visit_spec__1_spec__2___redArg(
    ...
    v___x_322_ = leanh::lean_unsigned_to_nat(2);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_Expr_NumObjs_visit_spec__1___redArg(
    ...
    mut v_b_330_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_size_331_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_buckets_332_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_bkt_349_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_size_x27_355_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_356_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_buckets_x27_357_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_size_331_ = leanh::lean_ctor_get(v_m_328_, 0);
                v_buckets_332_ = leanh::lean_ctor_get(v_m_328_, 1);
                ...
                if v___x_350_ == 0 {
                    leanh::lean_inc_ref(v_buckets_332_);
                    leanh::lean_inc(v_size_331_);
                    v_isSharedCheck_371_ = (!leanh::lean_is_exclusive(v_m_328_)) as u8;
                    if v_isSharedCheck_371_ == 0 {
                        v_unused_372_ = leanh::lean_ctor_get(v_m_328_, 1);
                        leanh::lean_dec(v_unused_372_);
                        v_unused_373_ = leanh::lean_ctor_get(v_m_328_, 0);
                    ...
                    leanh::lean_dec(v_b_330_);
                    leanh::lean_dec_ref(v_a_329_);
                    return v_m_328_;
                }
            }
            1 => {
                ...
                leanh::lean_dec(v_size_331_);
                leanh::lean_inc(v_bkt_349_);
                v___x_356_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
                leanh::lean_ctor_set(v___x_356_, 0, v_a_329_);
                leanh::lean_ctor_set(v___x_356_, 1, v_b_330_);
                leanh::lean_ctor_set(v___x_356_, 2, v_bkt_349_);
                v_buckets_x27_357_ = lean_array_uset(v_buckets_332_, v___x_348_, v___x_356_);
                v___x_358_ = leanh::lean_unsigned_to_nat(4);
                v___x_359_ = lean_nat_mul(v_size_x27_355_, v___x_358_);
                v___x_360_ = leanh::lean_unsigned_to_nat(3);
                ...
                if v___x_363_ == 0 {
                    ...
                    if v_isShared_353_ == 0 {
                        leanh::lean_ctor_set(v___x_352_, 1, v_val_364_);
                        leanh::lean_ctor_set(v___x_352_, 0, v_size_x27_355_);
                        v___x_366_ = v___x_352_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_367_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_367_, 0, v_size_x27_355_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_367_, 1, v_val_364_);
                    ...
                    if v_isShared_353_ == 0 {
                        leanh::lean_ctor_set(v___x_352_, 1, v_buckets_x27_357_);
                        leanh::lean_ctor_set(v___x_352_, 0, v_size_x27_355_);
                        v___x_369_ = v___x_352_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_370_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_370_, 0, v_size_x27_355_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_370_, 1, v_buckets_x27_357_);
...
pub unsafe fn l_Lean_Expr_NumObjs_visit(
    mut v_e_374_: *mut leanh::LeanObject,
    mut v_a_375_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_d_377_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_378_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_visited_383_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_counter_384_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_binderType_395_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_396_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_binderType_397_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_398_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_expr_399_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_type_401_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_value_402_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_body_403_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_snd_407_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fn_409_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_arg_410_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_411_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_412_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_struct_414_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_visited_383_ = leanh::lean_ctor_get(v_a_375_, 0);
                v_counter_384_ = leanh::lean_ctor_get(v_a_375_, 1);
                ...
                if v___x_385_ == 0 {
                    leanh::lean_inc(v_counter_384_);
                    leanh::lean_inc_ref(v_visited_383_);
                    v_isSharedCheck_418_ = (!leanh::lean_is_exclusive(v_a_375_)) as u8;
                    if v_isSharedCheck_418_ == 0 {
                        v_unused_419_ = leanh::lean_ctor_get(v_a_375_, 1);
                        leanh::lean_dec(v_unused_419_);
                        v_unused_420_ = leanh::lean_ctor_get(v_a_375_, 0);
            ...
            2 => {
                ...
                leanh::lean_dec(v_counter_384_);
                if v_isShared_388_ == 0 {
                    leanh::lean_ctor_set(v___x_387_, 1, v___x_392_);
                    leanh::lean_ctor_set(v___x_387_, 0, v___x_390_);
                    v___x_394_ = v___x_387_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_417_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_417_, 0, v___x_390_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_417_, 1, v___x_392_);
                    v___x_394_ = v_reuseFailAlloc_417_;
                    state = 3;
                    continue;
                }
            }
            3 => match leanh::lean_obj_tag(v_e_374_) {
                7 => {
                    v_binderType_395_ = leanh::lean_ctor_get(v_e_374_, 1);
                    leanh::lean_inc_ref(v_binderType_395_);
                    v_body_396_ = leanh::lean_ctor_get(v_e_374_, 2);
                    leanh::lean_inc_ref(v_body_396_);
                    leanh::lean_dec_ref_known(v_e_374_, 3);
                ...
                6 => {
                    v_binderType_397_ = leanh::lean_ctor_get(v_e_374_, 1);
                    leanh::lean_inc_ref(v_binderType_397_);
                    v_body_398_ = leanh::lean_ctor_get(v_e_374_, 2);
                    leanh::lean_inc_ref(v_body_398_);
                    leanh::lean_dec_ref_known(v_e_374_, 3);
                ...
                10 => {
                    v_expr_399_ = leanh::lean_ctor_get(v_e_374_, 1);
                    leanh::lean_inc_ref(v_expr_399_);
                    leanh::lean_dec_ref_known(v_e_374_, 2);
                ...
                8 => {
                    v_type_401_ = leanh::lean_ctor_get(v_e_374_, 1);
                    leanh::lean_inc_ref(v_type_401_);
                    v_value_402_ = leanh::lean_ctor_get(v_e_374_, 2);
                    leanh::lean_inc_ref(v_value_402_);
                    v_body_403_ = leanh::lean_ctor_get(v_e_374_, 3);
                    leanh::lean_inc_ref(v_body_403_);
                    leanh::lean_dec_ref_known(v_e_374_, 4);
                    v___x_404_ = l_Lean_Expr_NumObjs_visit(v_type_401_, v___x_394_);
                    v_snd_405_ = leanh::lean_ctor_get(v___x_404_, 1);
                    leanh::lean_inc(v_snd_405_);
                    leanh::lean_dec_ref(v___x_404_);
                    v___x_406_ = l_Lean_Expr_NumObjs_visit(v_value_402_, v_snd_405_);
                    v_snd_407_ = leanh::lean_ctor_get(v___x_406_, 1);
                    leanh::lean_inc(v_snd_407_);
                ...
                5 => {
                    v_fn_409_ = leanh::lean_ctor_get(v_e_374_, 0);
                    leanh::lean_inc_ref(v_fn_409_);
                    v_arg_410_ = leanh::lean_ctor_get(v_e_374_, 1);
                    leanh::lean_inc_ref(v_arg_410_);
                    leanh::lean_dec_ref_known(v_e_374_, 2);
                    v___x_411_ = l_Lean_Expr_NumObjs_visit(v_fn_409_, v___x_394_);
                    v_snd_412_ = leanh::lean_ctor_get(v___x_411_, 1);
                    leanh::lean_inc(v_snd_412_);
                ...
                11 => {
                    v_struct_414_ = leanh::lean_ctor_get(v_e_374_, 2);
                    leanh::lean_inc_ref(v_struct_414_);
                    leanh::lean_dec_ref_known(v_e_374_, 3);
                ...
                _ => {
                    leanh::lean_dec_ref(v_e_374_);
                    v___x_416_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v___x_416_, 0, v___x_389_);
                    leanh::lean_ctor_set(v___x_416_, 1, v___x_394_);
                    return v___x_416_;
                }
            },
            _ => {}
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_Expr_NumObjs_visit_spec__0___boxed(
    mut v_00_u03b2_427_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_Expr_NumObjs_visit_spec__1(
    ...
    mut v_m_433_: *mut leanh::LeanObject,
    mut v_a_434_: *mut leanh::LeanObject,
    mut v_b_435_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_contains___at___00Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_Expr_NumObjs_visit_spec__0_spec__0(
    mut v_00_u03b2_437_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_contains___at___00Std_DHashMap_Internal_Raw_u2080_contains___at___00Lean_Expr_NumObjs_visit_spec__0_spec__0___boxed(
    ...
    let mut v_r_445_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_r_445_ = leanh::lean_box((v_res_444_) as usize);
    return v_r_445_;
}
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_Expr_NumObjs_visit_spec__1_spec__2(
    ...
    mut v_data_447_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l___private_Std_Data_DHashMap_Internal_Defs_0__Std_DHashMap_Internal_Raw_u2080_expand_go___at___00Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00Lean_Expr_NumObjs_visit_spec__1_spec__2_spec__3(
    ...
    mut v_source_451_: *mut leanh::LeanObject,
    mut v_target_452_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn _init_l_Lean_Expr_NumObjs_main___closed__0() -> *mut leanh::LeanObject {
    let mut v___x_458_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_459_: *mut leanh::LeanObject = core::ptr::null_mut();
    v___x_458_ = leanh::lean_unsigned_to_nat(64);
    v___x_459_ = l_Lean_mkPtrSet___redArg(v___x_458_);
    return v___x_459_;
}
pub unsafe fn _init_l_Lean_Expr_NumObjs_main___closed__1() -> *mut leanh::LeanObject {
    ...
    v___x_460_ = leanh::lean_unsigned_to_nat(0);
    ...
    leanh::lean_ctor_set(v___x_462_, 1, v___x_460_);
    return v___x_462_;
}
pub unsafe fn l_Lean_Expr_NumObjs_main(
    mut v_e_463_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    let mut v_counter_467_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_snd_466_ = leanh::lean_ctor_get(v___x_465_, 1);
    leanh::lean_inc(v_snd_466_);
    leanh::lean_dec_ref(v___x_465_);
    v_counter_467_ = leanh::lean_ctor_get(v_snd_466_, 1);
    leanh::lean_inc(v_counter_467_);
    leanh::lean_dec(v_snd_466_);
...
pub unsafe fn runtime_initialize_Lean_Util_NumObjs(builtin: u8) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_Util_NumObjs(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Util_NumObjs(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
