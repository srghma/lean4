...
// Imports: Lean.Meta.Tactic.BVDecide.LRAT.Trim Lean.Meta.Tactic.BVDecide.LRAT.Cert
...
use crate::r#gen::Lean::Meta::Tactic::BVDecide::LRAT::Trim::{
    initialize_Lean_Meta_Tactic_BVDecide_LRAT_Trim,
    runtime_initialize_Lean_Meta_Tactic_BVDecide_LRAT_Trim,
};
static mut _G_runtime_initialized: bool = false;
pub unsafe fn runtime_initialize_Lean_Meta_Tactic_BVDecide_LRAT(
    builtin: u8,
...
pub unsafe fn meta_initialize_Lean_Meta_Tactic_BVDecide_LRAT(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_Tactic_BVDecide_LRAT(
    builtin: u8,
) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
