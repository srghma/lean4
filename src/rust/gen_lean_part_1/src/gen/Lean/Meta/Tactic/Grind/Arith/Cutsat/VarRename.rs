...
pub static l_Int_Linear_Expr_renameVars___closed__0_value: leanh::LeanCtorObject<1> =
...
static mut l_Int_Linear_Expr_renameVars___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_get_x3f___at___00Std_DHashMap_Internal_Raw_u2080_Const_get_x3f___at___00Int_Linear_Poly_renameVars_spec__0_spec__0___redArg(
    ...
    let mut v_key_167_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_value_168_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                if leanh::lean_obj_tag(v_x_165_) == 0 {
                    ...
                    v_key_167_ = leanh::lean_ctor_get(v_x_165_, 0);
                    v_value_168_ = leanh::lean_ctor_get(v_x_165_, 1);
                    v_tail_169_ = leanh::lean_ctor_get(v_x_165_, 2);
                    ...
                    if v___x_170_ == 0 {
                        ...
                        leanh::lean_inc(v_value_168_);
                        v___x_172_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        leanh::lean_ctor_set(v___x_172_, 0, v_value_168_);
                        return v___x_172_;
                    }
                }
            }
...
pub unsafe fn l_Std_DHashMap_Internal_AssocList_get_x3f___at___00Std_DHashMap_Internal_Raw_u2080_Const_get_x3f___at___00Int_Linear_Poly_renameVars_spec__0_spec__0___redArg___boxed(
    ...
    leanh::lean_dec(v_x_174_);
    leanh::lean_dec(v_a_173_);
    return v_res_175_;
}
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_Const_get_x3f___at___00Int_Linear_Poly_renameVars_spec__0___redArg(
    ...
    let mut v_buckets_178_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_buckets_178_ = leanh::lean_ctor_get(v_m_176_, 1);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_Const_get_x3f___at___00Int_Linear_Poly_renameVars_spec__0___redArg___boxed(
    mut v_m_194_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec(v_a_195_);
    leanh::lean_dec_ref(v_m_194_);
    return v_res_196_;
}
pub unsafe fn l_Int_Linear_Poly_renameVars(
    mut v_p_197_: *mut leanh::LeanObject,
    mut v_f_198_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_k_199_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_v_200_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_p_201_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_203_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isShared_204_: u8 = 0;
    let mut v___y_206_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_p_197_) == 0 {
                    return v_p_197_;
                } else {
                    v_k_199_ = leanh::lean_ctor_get(v_p_197_, 0);
                    v_v_200_ = leanh::lean_ctor_get(v_p_197_, 1);
                    v_p_201_ = leanh::lean_ctor_get(v_p_197_, 2);
                    v_isSharedCheck_214_ = (!leanh::lean_is_exclusive(v_p_197_)) as u8;
                    if v_isSharedCheck_214_ == 0 {
                        ...
                        leanh::lean_inc(v_p_201_);
                        leanh::lean_inc(v_v_200_);
                        leanh::lean_inc(v_k_199_);
            ...
            1 => {
                ...
                leanh::lean_dec(v_v_200_);
                if leanh::lean_obj_tag(v___x_211_) == 0 {
                    v___x_212_ = leanh::lean_unsigned_to_nat(0);
                    v___y_206_ = v___x_212_;
                    state = 2;
                    continue;
                } else {
                    v_val_213_ = leanh::lean_ctor_get(v___x_211_, 0);
                    leanh::lean_inc(v_val_213_);
                    leanh::lean_dec_ref_known(v___x_211_, 1);
            ...
            2 => {
                ...
                if v_isShared_204_ == 0 {
                    leanh::lean_ctor_set(v___x_203_, 2, v___x_207_);
                    leanh::lean_ctor_set(v___x_203_, 1, v___y_206_);
                    v___x_209_ = v___x_203_;
                    state = 3;
                    continue;
                } else {
                    v_reuseFailAlloc_210_ = leanh::lean_alloc_ctor(1, 3, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_210_, 0, v_k_199_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_210_, 1, v___y_206_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_210_, 2, v___x_207_);
...
pub unsafe fn l_Std_DHashMap_Internal_Raw_u2080_Const_get_x3f___at___00Int_Linear_Poly_renameVars_spec__0___boxed(
    ...
    leanh::lean_dec(v_a_224_);
    leanh::lean_dec_ref(v_m_223_);
    return v_res_225_;
}
...
pub unsafe fn l_Int_Linear_Expr_renameVars(
    ...
    let mut v_i_238_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_b_250_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_258_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_259_: u8 = 0;
    let mut v_a_260_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_261_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_k_280_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_reuseFailAlloc_288_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_289_: u8 = 0;
    let mut v_a_290_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_k_291_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => match leanh::lean_obj_tag(v_e_236_) {
                0 => {
                    return v_e_236_;
                }
                1 => {
                    v_i_238_ = leanh::lean_ctor_get(v_e_236_, 0);
                    v_isSharedCheck_248_ = (!leanh::lean_is_exclusive(v_e_236_)) as u8;
                    if v_isSharedCheck_248_ == 0 {
                        ...
                        leanh::lean_inc(v_i_238_);
                        leanh::lean_dec(v_e_236_);
                ...
                2 => {
                    v_a_249_ = leanh::lean_ctor_get(v_e_236_, 0);
                    v_b_250_ = leanh::lean_ctor_get(v_e_236_, 1);
                    v_isSharedCheck_259_ = (!leanh::lean_is_exclusive(v_e_236_)) as u8;
                ...
                3 => {
                    v_a_260_ = leanh::lean_ctor_get(v_e_236_, 0);
                    v_b_261_ = leanh::lean_ctor_get(v_e_236_, 1);
                    v_isSharedCheck_270_ = (!leanh::lean_is_exclusive(v_e_236_)) as u8;
                ...
                4 => {
                    v_a_271_ = leanh::lean_ctor_get(v_e_236_, 0);
                    v_isSharedCheck_279_ = (!leanh::lean_is_exclusive(v_e_236_)) as u8;
                ...
                5 => {
                    v_k_280_ = leanh::lean_ctor_get(v_e_236_, 0);
                    v_a_281_ = leanh::lean_ctor_get(v_e_236_, 1);
                    v_isSharedCheck_289_ = (!leanh::lean_is_exclusive(v_e_236_)) as u8;
                ...
                _ => {
                    v_a_290_ = leanh::lean_ctor_get(v_e_236_, 0);
                    v_k_291_ = leanh::lean_ctor_get(v_e_236_, 1);
                    v_isSharedCheck_299_ = (!leanh::lean_is_exclusive(v_e_236_)) as u8;
            ...
            1 => {
                ...
                if leanh::lean_obj_tag(v___x_242_) == 0 {
                    leanh::lean_del_object(v___x_240_);
                    v___x_243_ = l_Int_Linear_Expr_renameVars___closed__0;
                    return v___x_243_;
                } else {
                    v_val_244_ = leanh::lean_ctor_get(v___x_242_, 0);
                    leanh::lean_inc(v_val_244_);
                    leanh::lean_dec_ref_known(v___x_242_, 1);
                    if v_isShared_241_ == 0 {
                        leanh::lean_ctor_set(v___x_240_, 0, v_val_244_);
                        v___x_246_ = v___x_240_;
                        state = 2;
                        continue;
                    } else {
                        v_reuseFailAlloc_247_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_247_, 0, v_val_244_);
            ...
            3 => {
                ...
                if v_isShared_253_ == 0 {
                    leanh::lean_ctor_set(v___x_252_, 1, v___x_255_);
                    leanh::lean_ctor_set(v___x_252_, 0, v___x_254_);
                    v___x_257_ = v___x_252_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_258_ = leanh::lean_alloc_ctor(2, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_258_, 0, v___x_254_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_258_, 1, v___x_255_);
            ...
            5 => {
                ...
                if v_isShared_264_ == 0 {
                    leanh::lean_ctor_set(v___x_263_, 1, v___x_266_);
                    leanh::lean_ctor_set(v___x_263_, 0, v___x_265_);
                    v___x_268_ = v___x_263_;
                    state = 6;
                    continue;
                } else {
                    v_reuseFailAlloc_269_ = leanh::lean_alloc_ctor(3, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_269_, 0, v___x_265_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_269_, 1, v___x_266_);
            ...
            7 => {
                ...
                if v_isShared_274_ == 0 {
                    leanh::lean_ctor_set(v___x_273_, 0, v___x_275_);
                    v___x_277_ = v___x_273_;
                    state = 8;
                    continue;
                } else {
                    v_reuseFailAlloc_278_ = leanh::lean_alloc_ctor(4, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_278_, 0, v___x_275_);
            ...
            9 => {
                ...
                if v_isShared_284_ == 0 {
                    leanh::lean_ctor_set(v___x_283_, 1, v___x_285_);
                    v___x_287_ = v___x_283_;
                    state = 10;
                    continue;
                } else {
                    v_reuseFailAlloc_288_ = leanh::lean_alloc_ctor(5, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_288_, 0, v_k_280_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_288_, 1, v___x_285_);
            ...
            11 => {
                ...
                if v_isShared_294_ == 0 {
                    leanh::lean_ctor_set(v___x_293_, 0, v___x_295_);
                    v___x_297_ = v___x_293_;
                    state = 12;
                    continue;
                } else {
                    v_reuseFailAlloc_298_ = leanh::lean_alloc_ctor(6, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_298_, 0, v___x_295_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_298_, 1, v_k_291_);
...
pub unsafe fn l_Int_Linear_Poly_collectVars(
    ...
    let mut v_v_305_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_p_306_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_307_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_p_303_) == 0 {
                    leanh::lean_dec_ref_known(v_p_303_, 1);
                    return v_a_304_;
                } else {
                    v_v_305_ = leanh::lean_ctor_get(v_p_303_, 1);
                    leanh::lean_inc(v_v_305_);
                    v_p_306_ = leanh::lean_ctor_get(v_p_303_, 2);
                    leanh::lean_inc_ref(v_p_306_);
                    leanh::lean_dec_ref_known(v_p_303_, 3);
...
pub unsafe fn l_Int_Linear_Expr_collectVars(
    mut v_e_309_: *mut leanh::LeanObject,
    mut v_a_310_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_a_312_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_b_313_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___y_314_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_315_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_i_317_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_b_326_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => match leanh::lean_obj_tag(v_e_309_) {
                0 => {
                    leanh::lean_dec_ref_known(v_e_309_, 1);
                    return v_a_310_;
                }
                1 => {
                    v_i_317_ = leanh::lean_ctor_get(v_e_309_, 0);
                    leanh::lean_inc(v_i_317_);
                    leanh::lean_dec_ref_known(v_e_309_, 1);
                    v___x_318_ = l_Lean_Meta_Grind_collectVar(v_i_317_, v_a_310_);
                    return v___x_318_;
                }
                4 => {
                    v_a_319_ = leanh::lean_ctor_get(v_e_309_, 0);
                    leanh::lean_inc_ref(v_a_319_);
                    leanh::lean_dec_ref_known(v_e_309_, 1);
                    v_e_309_ = v_a_319_;
                    state = 0;
                    continue;
                ...
                5 => {
                    v_a_321_ = leanh::lean_ctor_get(v_e_309_, 1);
                    leanh::lean_inc_ref(v_a_321_);
                    leanh::lean_dec_ref_known(v_e_309_, 2);
                    v_e_309_ = v_a_321_;
                    state = 0;
                    continue;
                }
                6 => {
                    v_a_323_ = leanh::lean_ctor_get(v_e_309_, 0);
                ...
                _ => {
                    v_a_325_ = leanh::lean_ctor_get(v_e_309_, 0);
                    leanh::lean_inc_ref(v_a_325_);
                    v_b_326_ = leanh::lean_ctor_get(v_e_309_, 1);
                    leanh::lean_inc_ref(v_b_326_);
                    leanh::lean_dec_ref(v_e_309_);
                    v_a_312_ = v_a_325_;
                    v_b_313_ = v_b_326_;
                    v___y_314_ = v_a_310_;
                    state = 1;
