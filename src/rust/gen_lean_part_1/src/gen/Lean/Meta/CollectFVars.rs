...
pub static l_Lean_Meta_removeUnused___closed__0_value: leanh::LeanArrayObject<0> =
...
static mut l_Lean_Meta_removeUnused___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Expr_collectFVars_spec__0___redArg(
    mut v_e_376_: *mut leanh::LeanObject,
    ...
    let mut v_mctx_382_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_383_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fst_384_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_385_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_386_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_cache_387_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_zetaDeltaFVarIds_388_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_postponed_389_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_diag_390_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_400_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut state = 0;
    loop {
        match state {
            0 => {
                ...
                if v___x_379_ == 0 {
                    v___x_380_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_380_, 0, v_e_376_);
                    return v___x_380_;
                } else {
                    v___x_381_ = lean_st_ref_get(v___y_377_);
                    v_mctx_382_ = leanh::lean_ctor_get(v___x_381_, 0);
                    leanh::lean_inc_ref(v_mctx_382_);
                    leanh::lean_dec(v___x_381_);
                    v___x_383_ = l_Lean_instantiateMVarsCore(v_mctx_382_, v_e_376_);
                    v_fst_384_ = leanh::lean_ctor_get(v___x_383_, 0);
                    leanh::lean_inc(v_fst_384_);
                    v_snd_385_ = leanh::lean_ctor_get(v___x_383_, 1);
                    leanh::lean_inc(v_snd_385_);
                    leanh::lean_dec_ref(v___x_383_);
                    v___x_386_ = lean_st_ref_take(v___y_377_);
                    v_cache_387_ = leanh::lean_ctor_get(v___x_386_, 1);
                    v_zetaDeltaFVarIds_388_ = leanh::lean_ctor_get(v___x_386_, 2);
                    v_postponed_389_ = leanh::lean_ctor_get(v___x_386_, 3);
                    v_diag_390_ = leanh::lean_ctor_get(v___x_386_, 4);
                    v_isSharedCheck_399_ = (!leanh::lean_is_exclusive(v___x_386_)) as u8;
                    if v_isSharedCheck_399_ == 0 {
                        v_unused_400_ = leanh::lean_ctor_get(v___x_386_, 0);
                        leanh::lean_dec(v_unused_400_);
                        v___x_392_ = v___x_386_;
                        v_isShared_393_ = v_isSharedCheck_399_;
                        state = 1;
                        continue;
                    } else {
                        leanh::lean_inc(v_diag_390_);
                        leanh::lean_inc(v_postponed_389_);
                        leanh::lean_inc(v_zetaDeltaFVarIds_388_);
                        leanh::lean_inc(v_cache_387_);
                        leanh::lean_dec(v___x_386_);
            ...
            1 => {
                if v_isShared_393_ == 0 {
                    leanh::lean_ctor_set(v___x_392_, 0, v_snd_385_);
                    v___x_395_ = v___x_392_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_398_ = leanh::lean_alloc_ctor(0, 5, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_398_, 0, v_snd_385_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_398_, 1, v_cache_387_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_398_, 2, v_zetaDeltaFVarIds_388_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_398_, 3, v_postponed_389_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_398_, 4, v_diag_390_);
            ...
            2 => {
                ...
                v___x_397_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                leanh::lean_ctor_set(v___x_397_, 0, v_fst_384_);
                return v___x_397_;
            }
            _ => {}
        }
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Expr_collectFVars_spec__0___redArg___boxed(
    mut v_e_401_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Expr_collectFVars_spec__0(
    mut v_e_405_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_instantiateMVars___at___00Lean_Expr_collectFVars_spec__0___boxed(
    mut v_e_413_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Expr_collectFVars(
    mut v_e_421_: *mut leanh::LeanObject,
    ...
    loop {
        match state {
            0 => {
                ...
                v_isSharedCheck_440_ = (!leanh::lean_is_exclusive(v___x_428_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_432_ == 0 {
                    leanh::lean_ctor_set(v___x_431_, 0, v___x_436_);
                    v___x_438_ = v___x_431_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_439_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_LocalDecl_collectFVars(
    ...
    if leanh::lean_obj_tag(v_localDecl_449_) == 0 {
        ...
        let mut v_type_458_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v_value_459_: *mut leanh::LeanObject = core::ptr::null_mut();
        let mut v___x_460_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_type_458_ = leanh::lean_ctor_get(v_localDecl_449_, 3);
        leanh::lean_inc_ref(v_type_458_);
        v_value_459_ = leanh::lean_ctor_get(v_localDecl_449_, 4);
        leanh::lean_inc_ref(v_value_459_);
        leanh::lean_dec_ref_known(v_localDecl_449_, 5);
        ...
        if leanh::lean_obj_tag(v___x_460_) == 0 {
            ...
            leanh::lean_dec_ref_known(v___x_460_, 1);
            ...
            leanh::lean_dec_ref(v_value_459_);
            return v___x_460_;
        }
    }
}
pub unsafe fn l_Lean_LocalDecl_collectFVars___boxed(
    mut v_localDecl_462_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_a_466_);
    leanh::lean_dec(v_a_465_);
    leanh::lean_dec_ref(v_a_464_);
...
pub unsafe fn l___private_Lean_Meta_CollectFVars_0__Lean_CollectFVars_State_addDependencies_getNext_x3f___redArg(
    ...
    let mut v_fvarIds_475_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    v_fvarIds_475_ = leanh::lean_ctor_get(v___x_473_, 2);
    leanh::lean_inc_ref(v_fvarIds_475_);
    ...
    if v___x_477_ == 0 {
        ...
        leanh::lean_dec_ref(v_fvarIds_475_);
        ...
        v___x_481_ = leanh::lean_unsigned_to_nat(1);
        ...
        v___x_486_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l___private_Lean_Meta_CollectFVars_0__Lean_CollectFVars_State_addDependencies_go(
    ...
    let mut v_lctx_520_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_521_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_val_522_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_514_) == 0 {
                    ...
                    v_isSharedCheck_533_ = (!leanh::lean_is_exclusive(v___x_514_)) as u8;
                    ...
                    v_a_534_ = leanh::lean_ctor_get(v___x_514_, 0);
                    v_isSharedCheck_541_ = (!leanh::lean_is_exclusive(v___x_514_)) as u8;
            ...
            1 => {
                if leanh::lean_obj_tag(v_a_515_) == 1 {
                    v_val_519_ = leanh::lean_ctor_get(v_a_515_, 0);
                    leanh::lean_inc(v_val_519_);
                    leanh::lean_dec_ref_known(v_a_515_, 1);
                    v_lctx_520_ = leanh::lean_ctor_get(v_a_509_, 2);
                    leanh::lean_inc_ref(v_lctx_520_);
                    v___x_521_ = lean_local_ctx_find(v_lctx_520_, v_val_519_);
                    if leanh::lean_obj_tag(v___x_521_) == 1 {
                        leanh::lean_del_object(v___x_517_);
                        v_val_522_ = leanh::lean_ctor_get(v___x_521_, 0);
                        leanh::lean_inc(v_val_522_);
                        ...
                        if v_isShared_518_ == 0 {
                            leanh::lean_ctor_set(v___x_517_, 0, v___x_525_);
                    ...
                    if v_isShared_518_ == 0 {
                        leanh::lean_ctor_set(v___x_517_, 0, v___x_529_);
    ...
    loop {
        match state {
            0 => {
                ...
                v___x_557_ = leanh::lean_unsigned_to_nat(0);
                ...
                if leanh::lean_obj_tag(v___x_559_) == 0 {
                    v_isSharedCheck_568_ = (!leanh::lean_is_exclusive(v___x_559_)) as u8;
                    if v_isSharedCheck_568_ == 0 {
                        v_unused_569_ = leanh::lean_ctor_get(v___x_559_, 0);
                    ...
                    v_a_570_ = leanh::lean_ctor_get(v___x_559_, 0);
                    v_isSharedCheck_577_ = (!leanh::lean_is_exclusive(v___x_559_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_562_ == 0 {
                    leanh::lean_ctor_set(v___x_561_, 0, v___x_564_);
                    v___x_566_ = v___x_561_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_567_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_567_, 0, v___x_564_);
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_contains___at___00Lean_Meta_removeUnused_spec__0___redArg(
    ...
    mut v_t_586_: *mut leanh::LeanObject,
) -> u8 {
    let mut v_k_587_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_l_588_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_r_589_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_t_586_) == 0 {
                    v_k_587_ = leanh::lean_ctor_get(v_t_586_, 1);
                    v_l_588_ = leanh::lean_ctor_get(v_t_586_, 3);
                    v_r_589_ = leanh::lean_ctor_get(v_t_586_, 4);
                    v___x_590_ =
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldrMUnsafe_fold___at___00Lean_Meta_removeUnused_spec__1(
    ...
    let mut v_snd_609_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_610_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_611_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_fst_620_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fvarSet_621_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_a_663_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_unused_672_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_unused_673_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_isSharedCheck_674_: u8 = 0;
    let mut v_unused_675_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if v___x_608_ == 0 {
                    v_snd_609_ = leanh::lean_ctor_get(v_b_602_, 1);
                    leanh::lean_inc(v_snd_609_);
                    v_snd_610_ = leanh::lean_ctor_get(v_snd_609_, 1);
                    leanh::lean_inc(v_snd_610_);
                    v_snd_611_ = leanh::lean_ctor_get(v_snd_610_, 1);
                    v_fst_612_ = leanh::lean_ctor_get(v_b_602_, 0);
                    v_isSharedCheck_676_ = (!leanh::lean_is_exclusive(v_b_602_)) as u8;
                    if v_isSharedCheck_676_ == 0 {
                        v_unused_677_ = leanh::lean_ctor_get(v_b_602_, 1);
                    ...
                    v___x_678_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
                    leanh::lean_ctor_set(v___x_678_, 0, v_b_602_);
                    return v___x_678_;
                }
            }
            1 => {
                v_fst_616_ = leanh::lean_ctor_get(v_snd_609_, 0);
                v_isSharedCheck_674_ = (!leanh::lean_is_exclusive(v_snd_609_)) as u8;
                if v_isSharedCheck_674_ == 0 {
                    v_unused_675_ = leanh::lean_ctor_get(v_snd_609_, 1);
                    leanh::lean_dec(v_unused_675_);
            ...
            2 => {
                v_fst_620_ = leanh::lean_ctor_get(v_snd_610_, 0);
                v_fvarSet_621_ = leanh::lean_ctor_get(v_snd_611_, 1);
                v___x_622_ = 1usize;
                ...
                if v___x_626_ == 0 {
                    ...
                    if v_isShared_619_ == 0 {
                        leanh::lean_ctor_set(v___x_618_, 0, v___x_628_);
                        v___x_630_ = v___x_618_;
                        state = 3;
                        continue;
                    } else {
                        v_reuseFailAlloc_635_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                        leanh::lean_ctor_set(v_reuseFailAlloc_635_, 0, v___x_628_);
                        leanh::lean_ctor_set(v_reuseFailAlloc_635_, 1, v_snd_610_);
                        v___x_630_ = v_reuseFailAlloc_635_;
                        state = 3;
                        continue;
                    }
                } else {
                    leanh::lean_inc(v_fst_620_);
                    leanh::lean_inc(v_snd_611_);
                    leanh::lean_dec(v___x_625_);
                    v_isSharedCheck_671_ = (!leanh::lean_is_exclusive(v_snd_610_)) as u8;
                    if v_isSharedCheck_671_ == 0 {
                        v_unused_672_ = leanh::lean_ctor_get(v_snd_610_, 1);
                        leanh::lean_dec(v_unused_672_);
                        v_unused_673_ = leanh::lean_ctor_get(v_snd_610_, 0);
                        leanh::lean_dec(v_unused_673_);
                        v___x_637_ = v_snd_610_;
                        v_isShared_638_ = v_isSharedCheck_671_;
                        state = 5;
                        continue;
                    } else {
                        leanh::lean_dec(v_snd_610_);
            ...
            3 => {
                if v_isShared_615_ == 0 {
                    leanh::lean_ctor_set(v___x_614_, 1, v___x_630_);
                    leanh::lean_ctor_set(v___x_614_, 0, v___x_627_);
                    v___x_632_ = v___x_614_;
                    state = 4;
                    continue;
                } else {
                    v_reuseFailAlloc_634_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_634_, 0, v___x_627_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_634_, 1, v___x_630_);
            ...
            5 => {
                ...
                if leanh::lean_obj_tag(v___x_639_) == 0 {
                    v_a_640_ = leanh::lean_ctor_get(v___x_639_, 0);
                    leanh::lean_inc(v_a_640_);
                    leanh::lean_dec_ref_known(v___x_639_, 1);
                    ...
                    if leanh::lean_obj_tag(v___x_642_) == 0 {
                        ...
                        if v_isShared_638_ == 0 {
                            leanh::lean_ctor_set(v___x_637_, 1, v___x_643_);
                            leanh::lean_ctor_set(v___x_637_, 0, v___x_644_);
                            v___x_646_ = v___x_637_;
                            state = 6;
                            continue;
                        } else {
                            v_reuseFailAlloc_654_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                            leanh::lean_ctor_set(v_reuseFailAlloc_654_, 0, v___x_644_);
                            leanh::lean_ctor_set(v_reuseFailAlloc_654_, 1, v___x_643_);
                        ...
                        leanh::lean_dec(v_fst_620_);
                        leanh::lean_del_object(v___x_618_);
                        leanh::lean_dec(v_fst_616_);
                        leanh::lean_del_object(v___x_614_);
                        leanh::lean_dec(v_fst_612_);
                        v_a_655_ = leanh::lean_ctor_get(v___x_642_, 0);
                        v_isSharedCheck_662_ = (!leanh::lean_is_exclusive(v___x_642_)) as u8;
                    ...
                    leanh::lean_del_object(v___x_614_);
                    leanh::lean_dec(v_fst_612_);
                    leanh::lean_dec(v_snd_611_);
                    v_a_663_ = leanh::lean_ctor_get(v___x_639_, 0);
                    v_isSharedCheck_670_ = (!leanh::lean_is_exclusive(v___x_639_)) as u8;
            ...
            6 => {
                if v_isShared_619_ == 0 {
                    leanh::lean_ctor_set(v___x_618_, 1, v___x_646_);
                    v___x_648_ = v___x_618_;
                    state = 7;
                    continue;
                } else {
                    v_reuseFailAlloc_653_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_653_, 0, v_fst_616_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_653_, 1, v___x_646_);
            ...
            7 => {
                if v_isShared_615_ == 0 {
                    leanh::lean_ctor_set(v___x_614_, 1, v___x_648_);
                    v___x_650_ = v___x_614_;
                    state = 8;
                    continue;
                } else {
                    v_reuseFailAlloc_652_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_652_, 0, v_fst_612_);
                    leanh::lean_ctor_set(v_reuseFailAlloc_652_, 1, v___x_648_);
            ...
            11 => {
                if v_isShared_666_ == 0 {
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_669_, 0, v_a_663_);
...
pub unsafe fn l___private_Init_Data_Array_Basic_0__Array_foldrMUnsafe_fold___at___00Lean_Meta_removeUnused_spec__1___boxed(
    mut v_as_679_: *mut leanh::LeanObject,
    mut v_i_680_: *mut leanh::LeanObject,
    mut v_stop_681_: *mut leanh::LeanObject,
    ...
    v_i_boxed_688_ = leanh::lean_unbox_usize(v_i_680_);
    leanh::lean_dec(v_i_680_);
    v_stop_boxed_689_ = leanh::lean_unbox_usize(v_stop_681_);
    leanh::lean_dec(v_stop_681_);
    ...
    leanh::lean_dec_ref(v_as_679_);
    return v_res_690_;
}
pub unsafe fn l_Lean_Meta_removeUnused(
    mut v_vars_693_: *mut leanh::LeanObject,
    mut v_used_694_: *mut leanh::LeanObject,
    ...
    let mut v_fst_701_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fst_702_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_lctx_708_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_localInstances_709_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    let mut v_snd_721_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_snd_722_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fst_723_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_fst_724_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                v_lctx_708_ = leanh::lean_ctor_get(v_a_695_, 2);
                v_localInstances_709_ = leanh::lean_ctor_get(v_a_695_, 3);
                ...
                if v___x_713_ == 0 {
                    leanh::lean_dec_ref(v_used_694_);
                    leanh::lean_inc_ref(v_localInstances_709_);
                    leanh::lean_inc_ref(v_lctx_708_);
                    ...
                    v___x_714_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v___x_714_, 0, v___x_711_);
                    leanh::lean_ctor_set(v___x_714_, 1, v_used_694_);
                    leanh::lean_inc_ref(v_localInstances_709_);
                    v___x_715_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v___x_715_, 0, v_localInstances_709_);
                    leanh::lean_ctor_set(v___x_715_, 1, v___x_714_);
                    leanh::lean_inc_ref(v_lctx_708_);
                    v___x_716_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                    leanh::lean_ctor_set(v___x_716_, 0, v_lctx_708_);
                    ...
                    if leanh::lean_obj_tag(v___x_719_) == 0 {
                        ...
                        v_snd_721_ = leanh::lean_ctor_get(v_a_720_, 1);
                        leanh::lean_inc(v_snd_721_);
                        v_snd_722_ = leanh::lean_ctor_get(v_snd_721_, 1);
                        leanh::lean_inc(v_snd_722_);
                        v_fst_723_ = leanh::lean_ctor_get(v_a_720_, 0);
                        leanh::lean_inc(v_fst_723_);
                        leanh::lean_dec(v_a_720_);
                        v_fst_724_ = leanh::lean_ctor_get(v_snd_721_, 0);
                        leanh::lean_inc(v_fst_724_);
                        leanh::lean_dec(v_snd_721_);
                        v_fst_725_ = leanh::lean_ctor_get(v_snd_722_, 0);
                        leanh::lean_inc(v_fst_725_);
                        leanh::lean_dec(v_snd_722_);
                        ...
                        v_a_726_ = leanh::lean_ctor_get(v___x_719_, 0);
                        v_isSharedCheck_733_ = (!leanh::lean_is_exclusive(v___x_719_)) as u8;
            ...
            1 => {
                ...
                leanh::lean_ctor_set(v___x_705_, 0, v_fst_702_);
                leanh::lean_ctor_set(v___x_705_, 1, v___x_704_);
                v___x_706_ = leanh::lean_alloc_ctor(0, 2, (0) as u32);
                leanh::lean_ctor_set(v___x_706_, 0, v_fst_701_);
                leanh::lean_ctor_set(v___x_706_, 1, v___x_705_);
                v___x_707_ = leanh::lean_alloc_ctor(0, 1, (0) as u32);
...
pub unsafe fn l_Lean_Meta_removeUnused___boxed(
    mut v_vars_734_: *mut leanh::LeanObject,
    mut v_used_735_: *mut leanh::LeanObject,
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_contains___at___00Lean_Meta_removeUnused_spec__0___boxed(
    ...
    mut v_t_748_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn meta_initialize_Lean_Meta_CollectFVars(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn initialize_Lean_Meta_CollectFVars(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
