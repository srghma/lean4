...
pub static l_Lean_Meta_MVarRenaming_find_x21___closed__0_value: leanh::LeanStringObject<26> =
...
static mut l_Lean_Meta_MVarRenaming_find_x21___closed__0: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_MVarRenaming_find_x21___closed__0_value)
        as *mut leanh::LeanObject;
pub static l_Lean_Meta_MVarRenaming_find_x21___closed__1_value: leanh::LeanStringObject<12> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_Meta_MVarRenaming_find_x21___closed__1: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_MVarRenaming_find_x21___closed__1_value)
        as *mut leanh::LeanObject;
pub static l_Lean_Meta_MVarRenaming_find_x21___closed__2_value: leanh::LeanStringObject<14> =
    leanh::LeanStringObject {
        m_header: leanh::LeanObject {
            rc: 0,
            cs_size: (0) as u16,
...
static mut l_Lean_Meta_MVarRenaming_find_x21___closed__2: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_Meta_MVarRenaming_find_x21___closed__2_value)
        as *mut leanh::LeanObject;
static mut l_Lean_Meta_MVarRenaming_find_x21___closed__3_once: leanh::LeanOnceCell =
    leanh::LeanOnceCell {
        state: core::sync::atomic::AtomicI32::new(0),
        lock: core::sync::atomic::AtomicI32::new(0),
    };
static mut l_Lean_Meta_MVarRenaming_find_x21___closed__3: *mut leanh::LeanObject =
    core::ptr::null_mut();
pub unsafe fn l_Lean_Meta_MVarRenaming_isEmpty(mut v_s_86_: *mut leanh::LeanObject) -> u8 {
    if leanh::lean_obj_tag(v_s_86_) == 0 {
...
pub unsafe fn l_Lean_Meta_MVarRenaming_isEmpty___boxed(
    mut v_s_89_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_90_: u8 = 0;
    let mut v_r_91_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_90_ = l_Lean_Meta_MVarRenaming_isEmpty(v_s_89_);
    leanh::lean_dec(v_s_89_);
    v_r_91_ = leanh::lean_box((v_res_90_) as usize);
    return v_r_91_;
}
pub unsafe fn l_Std_DTreeMap_Internal_Impl_Const_get_x3f___at___00Lean_Meta_MVarRenaming_find_x3f_spec__0___redArg(
    ...
    mut v_k_93_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_k_94_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_v_95_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_l_96_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_t_92_) == 0 {
                    v_k_94_ = leanh::lean_ctor_get(v_t_92_, 1);
                    v_v_95_ = leanh::lean_ctor_get(v_t_92_, 2);
                    v_l_96_ = leanh::lean_ctor_get(v_t_92_, 3);
                    v_r_97_ = leanh::lean_ctor_get(v_t_92_, 4);
                    v___x_98_ =
                    ...
                    match v___x_98_ {
                        ...
                        1 => {
                            leanh::lean_inc(v_v_95_);
                            v___x_100_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                            leanh::lean_ctor_set(v___x_100_, 0, v_v_95_);
                            return v___x_100_;
                        }
                        _ => {
                            v_t_92_ = v_r_97_;
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_Const_get_x3f___at___00Lean_Meta_MVarRenaming_find_x3f_spec__0___redArg___boxed(
    mut v_t_103_: *mut leanh::LeanObject,
    mut v_k_104_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_k_104_);
    leanh::lean_dec(v_t_103_);
    return v_res_105_;
}
pub unsafe fn l_Lean_Meta_MVarRenaming_find_x3f(
    mut v_s_106_: *mut leanh::LeanObject,
    mut v_mvarId_107_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_Meta_MVarRenaming_find_x3f___boxed(
    mut v_s_109_: *mut leanh::LeanObject,
    mut v_mvarId_110_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_mvarId_110_);
    leanh::lean_dec(v_s_109_);
    return v_res_111_;
}
pub unsafe fn l_Std_DTreeMap_Internal_Impl_Const_get_x3f___at___00Lean_Meta_MVarRenaming_find_x3f_spec__0(
    mut v_00_u03b4_112_: *mut leanh::LeanObject,
    mut v_t_113_: *mut leanh::LeanObject,
    mut v_k_114_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Std_DTreeMap_Internal_Impl_Const_get_x3f___at___00Lean_Meta_MVarRenaming_find_x3f_spec__0___boxed(
    mut v_00_u03b4_116_: *mut leanh::LeanObject,
    mut v_t_117_: *mut leanh::LeanObject,
    mut v_k_118_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_res_119_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_119_ =
...
pub unsafe fn _init_l_Lean_Meta_MVarRenaming_find_x21___closed__3() -> *mut leanh::LeanObject
{
    ...
    v___x_127_ = leanh::lean_unsigned_to_nat(14);
    v___x_128_ = leanh::lean_unsigned_to_nat(22);
...
pub unsafe fn l_Lean_Meta_MVarRenaming_find_x21(
    mut v_s_132_: *mut leanh::LeanObject,
    mut v_mvarId_133_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    if leanh::lean_obj_tag(v___x_134_) == 0 {
        ...
        let mut v_val_137_: *mut leanh::LeanObject = core::ptr::null_mut();
        v_val_137_ = leanh::lean_ctor_get(v___x_134_, 0);
        leanh::lean_inc(v_val_137_);
        leanh::lean_dec_ref_known(v___x_134_, 1);
        return v_val_137_;
    }
}
pub unsafe fn l_Lean_Meta_MVarRenaming_find_x21___boxed(
    mut v_s_138_: *mut leanh::LeanObject,
    mut v_mvarId_139_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec(v_mvarId_139_);
    leanh::lean_dec(v_s_138_);
    return v_res_140_;
}
pub unsafe fn l_Lean_Meta_MVarRenaming_insert(
    mut v_s_141_: *mut leanh::LeanObject,
    mut v_mvarId_142_: *mut leanh::LeanObject,
    mut v_mvarId_x27_143_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_Meta_MVarRenaming_apply___lam__0(
    ...
    mut v_e_146_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    let mut v_mvarId_147_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_148_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v___x_149_: *mut leanh::LeanObject = core::ptr::null_mut();
    let mut v_val_150_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                if leanh::lean_obj_tag(v_e_146_) == 2 {
                    v_mvarId_147_ = leanh::lean_ctor_get(v_e_146_, 0);
                    ...
                    if leanh::lean_obj_tag(v___x_148_) == 0 {
                        v___x_149_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                        leanh::lean_ctor_set(v___x_149_, 0, v_e_146_);
                        return v___x_149_;
                    } else {
                        leanh::lean_dec_ref_known(v_e_146_, 1);
                        v_val_150_ = leanh::lean_ctor_get(v___x_148_, 0);
                        v_isSharedCheck_158_ = (!leanh::lean_is_exclusive(v___x_148_)) as u8;
            ...
            1 => {
                ...
                if v_isShared_153_ == 0 {
                    leanh::lean_ctor_set(v___x_152_, 0, v___x_154_);
                    v___x_156_ = v___x_152_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_157_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_157_, 0, v___x_154_);
...
pub unsafe fn l_Lean_Meta_MVarRenaming_apply___lam__0___boxed(
    mut v_s_160_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_MVarRenaming_apply(
    ...
    if v___x_165_ == 0 {
        ...
        if leanh::lean_obj_tag(v_s_163_) == 0 {
            ...
            leanh::lean_closure_set(v___f_166_, 0, v_s_163_);
            v___x_167_ = lean_replace_expr(v___f_166_, v_e_164_);
            leanh::lean_dec_ref(v___f_166_);
            return v___x_167_;
        } else {
            leanh::lean_inc_ref(v_e_164_);
            return v_e_164_;
