...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__0: *mut leanh::LeanObject =
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__1: *mut leanh::LeanObject =
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__2: *mut leanh::LeanObject =
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__3: *mut leanh::LeanObject =
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__4: *mut leanh::LeanObject =
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__5: *mut leanh::LeanObject =
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__6: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_PersistentHashSet_fold___redArg___closed__6_value)
        as *mut leanh::LeanObject;
pub static l_Lean_PersistentHashSet_fold___redArg___closed__7_value: leanh::LeanCtorObject<
    2,
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__7: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_PersistentHashSet_fold___redArg___closed__7_value)
        as *mut leanh::LeanObject;
pub static l_Lean_PersistentHashSet_fold___redArg___closed__8_value: leanh::LeanCtorObject<
    5,
> = leanh::LeanCtorObject {
    m_header: leanh::LeanObject {
        rc: 0,
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__8: *mut leanh::LeanObject =
    core::ptr::addr_of!(l_Lean_PersistentHashSet_fold___redArg___closed__8_value)
        as *mut leanh::LeanObject;
pub static l_Lean_PersistentHashSet_fold___redArg___closed__9_value: leanh::LeanCtorObject<
    2,
> = leanh::LeanCtorObject {
    m_header: leanh::LeanObject {
        rc: 0,
...
static mut l_Lean_PersistentHashSet_fold___redArg___closed__9: *mut leanh::LeanObject =
...
static mut l_Lean_PersistentHashSet_toList___redArg___closed__0: *mut leanh::LeanObject =
...
pub unsafe fn l_Lean_PersistentHashSet_instInhabited___redArg___boxed(
    ...
    leanh::lean_dec_ref(v_inst_356_);
...
pub unsafe fn l_Lean_PersistentHashSet_instInhabited___boxed(
    ...
    leanh::lean_dec_ref(v_inst_364_);
    leanh::lean_dec_ref(v_inst_363_);
    return v_res_365_;
}
...
pub unsafe fn l_Lean_PersistentHashSet_isEmpty___redArg___boxed(
    ...
    let mut v_r_384_: *mut leanh::LeanObject = core::ptr::null_mut();
    v_res_383_ = l_Lean_PersistentHashSet_isEmpty___redArg(v_s_382_);
    leanh::lean_dec_ref(v_s_382_);
    v_r_384_ = leanh::lean_box((v_res_383_) as usize);
    return v_r_384_;
}
...
pub unsafe fn l_Lean_PersistentHashSet_isEmpty___boxed(
    ...
    leanh::lean_dec_ref(v_s_393_);
    leanh::lean_dec_ref(v_x_392_);
    leanh::lean_dec_ref(v_x_391_);
    v_r_395_ = leanh::lean_box((v_res_394_) as usize);
    return v_r_395_;
}
...
pub unsafe fn l_Lean_PersistentHashSet_erase(
    ...
    mut v_s_417_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashSet_find_x3f___redArg(
    ...
    let mut v_val_426_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_424_) == 0 {
                    v___x_425_ = leanh::lean_box(0);
                    return v___x_425_;
                } else {
                    v_val_426_ = leanh::lean_ctor_get(v___x_424_, 0);
                    v_isSharedCheck_434_ = (!leanh::lean_is_exclusive(v___x_424_)) as u8;
            ...
            1 => {
                v_fst_430_ = leanh::lean_ctor_get(v_val_426_, 0);
                leanh::lean_inc(v_fst_430_);
                leanh::lean_dec(v_val_426_);
                if v_isShared_429_ == 0 {
                    leanh::lean_ctor_set(v___x_428_, 0, v_fst_430_);
                    v___x_432_ = v___x_428_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_433_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_433_, 0, v_fst_430_);
    ...
    loop {
        match state {
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_445_) == 0 {
                    v___x_446_ = leanh::lean_box(0);
                    return v___x_446_;
                } else {
                    v_val_447_ = leanh::lean_ctor_get(v___x_445_, 0);
                    v_isSharedCheck_455_ = (!leanh::lean_is_exclusive(v___x_445_)) as u8;
            ...
            1 => {
                v_fst_451_ = leanh::lean_ctor_get(v_val_447_, 0);
                leanh::lean_inc(v_fst_451_);
                leanh::lean_dec(v_val_447_);
                if v_isShared_450_ == 0 {
                    leanh::lean_ctor_set(v___x_449_, 0, v_fst_451_);
                    v___x_453_ = v___x_449_;
                    state = 2;
                    continue;
                } else {
                    v_reuseFailAlloc_454_ = leanh::lean_alloc_ctor(1, 1, (0) as u32);
                    leanh::lean_ctor_set(v_reuseFailAlloc_454_, 0, v_fst_451_);
...
pub unsafe fn l_Lean_PersistentHashSet_findD___redArg(
    ...
    mut v_a_u2080_466_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v___x_467_ = leanh::lean_apply_1(v_x_463_, v_a_465_);
    v___x_468_ = leanh::lean_unbox_uint64(v___x_467_);
    leanh::lean_dec_ref(v___x_467_);
...
pub unsafe fn l_Lean_PersistentHashSet_findD___redArg___boxed(
    ...
    mut v_a_u2080_475_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_PersistentHashSet_findD(
    ...
    mut v_a_u2080_482_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    v___x_483_ = leanh::lean_apply_1(v_x_479_, v_a_481_);
    v___x_484_ = leanh::lean_unbox_uint64(v___x_483_);
...
pub unsafe fn l_Lean_PersistentHashSet_findD___boxed(
    ...
    mut v_a_u2080_492_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_PersistentHashSet_contains___boxed(
    ...
    v_r_517_ = leanh::lean_box((v_res_516_) as usize);
    return v_r_517_;
}
pub unsafe fn l_Lean_PersistentHashSet_foldM___redArg___lam__0(
    mut v_f_518_: *mut leanh::LeanObject,
    mut v_d_519_: *mut leanh::LeanObject,
    ...
    v___x_522_ = leanh::lean_apply_2(v_f_518_, v_d_519_, v_a_520_);
    return v___x_522_;
}
pub unsafe fn l_Lean_PersistentHashSet_foldM___redArg(
    ...
    mut v_init_525_: *mut leanh::LeanObject,
    ...
    leanh::lean_closure_set(v___f_527_, 0, v_f_524_);
    v___x_528_ =
...
pub unsafe fn l_Lean_PersistentHashSet_foldM(
    ...
    mut v_s_537_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_closure_set(v___f_538_, 0, v_f_535_);
    v___x_539_ =
...
pub unsafe fn l_Lean_PersistentHashSet_foldM___boxed(
    ...
    mut v_init_547_: *mut leanh::LeanObject,
    ...
    leanh::lean_dec_ref(v_x_542_);
    leanh::lean_dec_ref(v_x_541_);
    return v_res_549_;
}
pub unsafe fn l_Lean_PersistentHashSet_fold___redArg(
    mut v_f_569_: *mut leanh::LeanObject,
    mut v_init_570_: *mut leanh::LeanObject,
    ...
    leanh::lean_closure_set(v___f_572_, 0, v_f_569_);
...
pub unsafe fn l_Lean_PersistentHashSet_fold(
    ...
    mut v_00_u03b2_578_: *mut leanh::LeanObject,
    mut v_f_579_: *mut leanh::LeanObject,
    mut v_init_580_: *mut leanh::LeanObject,
    ...
    leanh::lean_closure_set(v___f_582_, 0, v_f_579_);
...
pub unsafe fn l_Lean_PersistentHashSet_fold___boxed(
    ...
    mut v_init_590_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashSet_toList___redArg___lam__0(
    ...
    v_fst_594_ = leanh::lean_ctor_get(v_x_593_, 0);
...
pub unsafe fn l_Lean_PersistentHashSet_toList(
    ...
    mut v_s_606_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_PersistentHashSet_forIn___redArg(
    ...
    leanh::lean_closure_set(v___f_622_, 0, v_f_621_);
    v___x_623_ =
...
pub unsafe fn l_Lean_PersistentHashSet_forIn___redArg___boxed(
    ...
    mut v_init_626_: *mut leanh::LeanObject,
    mut v_f_627_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
    ...
    leanh::lean_dec_ref(v_s_625_);
    return v_res_628_;
}
pub unsafe fn l_Lean_PersistentHashSet_forIn(
    mut v_00_u03b1_629_: *mut leanh::LeanObject,
    mut v_m_630_: *mut leanh::LeanObject,
    mut v_00_u03c3_631_: *mut leanh::LeanObject,
    ...
    mut v_init_636_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_PersistentHashSet_forIn___boxed(
    ...
    mut v_00_u03c3_641_: *mut leanh::LeanObject,
    ...
    mut v_init_646_: *mut leanh::LeanObject,
    mut v_f_647_: *mut leanh::LeanObject,
) -> *mut leanh::LeanObject {
...
pub unsafe fn l_Lean_PersistentHashSet_instForInOfMonad___redArg(
    ...
    leanh::lean_closure_set(v___f_662_, 0, v_inst_661_);
    return v___f_662_;
}
pub unsafe fn l_Lean_PersistentHashSet_instForInOfMonad(
    ...
    leanh::lean_closure_set(v___f_668_, 0, v_inst_667_);
    return v___f_668_;
}
...
pub unsafe fn initialize_Lean_Data_PersistentHashSet(builtin: u8) -> *mut leanh::LeanObject {
    let mut res: *mut leanh::LeanObject = core::ptr::null_mut();
    if _G_initialized {
        return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
    }
