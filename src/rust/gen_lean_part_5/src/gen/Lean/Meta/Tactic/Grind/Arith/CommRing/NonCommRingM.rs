...
static mut l_Lean_PersistentHashMap_insertAux___at___00Lean_PersistentHashMap_insert___at___00Lean_Meta_Grind_Arith_CommRing_setTermNonCommRingId_spec__0_spec__0___redArg___closed__0: *mut leanh::LeanObject = core::ptr::null_mut();
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommRingM_run___redArg(
    mut v_ringId_835_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommRingM_run___redArg___boxed(
    mut v_ringId_849_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommRingM_run(
    ...
    mut v_ringId_864_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommRingM_run___boxed(
    ...
    mut v_ringId_879_: *mut leanh::LeanObject,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_NonCommRingM_getRing(
    ...
    let mut v_ncRings_1023_: *mut leanh::LeanObject = core::ptr::null_mut();
        ...
        match state {
            ...
            1 => {
                ...
                if v_isShared_1105_ == 0 {
                    leanh::lean_ctor_set(v___x_1104_, 6, v___x_1110_);
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_1113_, 6, v___x_1110_);
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_1113_, 9, v_ncSemirings_1096_);
                    leanh::lean_ctor_set(
                        v_reuseFailAlloc_1113_,
                        10,
...
pub unsafe fn l_Lean_Meta_Grind_Arith_CommRing_getTermNonCommRingId_x3f___redArg(
    ...
    let mut v_exprToNCRingId_1247_: *mut leanh::LeanObject = core::ptr::null_mut();
    ...
    loop {
        match state {
            ...
            1 => {
                v_exprToNCRingId_1247_ = leanh::lean_ctor_get(v_a_1243_, 7);
                leanh::lean_inc_ref(v_exprToNCRingId_1247_);
                ...
                leanh::lean_dec_ref(v_exprToNCRingId_1247_);
        ...
        match state {
            ...
            1 => {
                ...
                if v_isShared_1495_ == 0 {
                    leanh::lean_ctor_set(v___x_1494_, 7, v___x_1496_);
                    ...
                    leanh::lean_ctor_set(v_reuseFailAlloc_1499_, 7, v___x_1496_);
            ...
            0 => {
                ...
                if leanh::lean_obj_tag(v___x_1521_) == 0 {
                    ...
                    if leanh::lean_obj_tag(v_a_1522_) == 1 {
                        ...
                        v___f_1540_ = leanh::lean_alloc_closure(l_Lean_Meta_Grind_Arith_CommRing_setTermNonCommRingId___redArg___lam__0___boxed as *mut core::ffi::c_void, 3, 2);
...
pub unsafe fn runtime_initialize_Lean_Meta_Tactic_Grind_Arith_CommRing_NonCommRingM(
    ...
    leanh::lean_mark_persistent(l_Lean_Meta_Grind_Arith_CommRing_instMonadRingNonCommRingM);
    return leanh::lean_io_result_mk_ok(leanh::lean_box(0));
}
