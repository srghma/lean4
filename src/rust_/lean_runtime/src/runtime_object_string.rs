...
mod runtime_object_string_impl {
    ...
    // Thin local wrappers that delegate to the Rust implementations in `super::`
    #[inline(always)]
    unsafe fn lean_alloc_string(size: usize, capacity: usize, len: usize) -> *mut LeanObject {
        super::lean_alloc_string(size, capacity, len)
    }
    #[inline(always)]
    unsafe fn lean_string_cstr(o: *mut LeanObject) -> *const c_char {
        super::lean_string_cstr(o)
    }
    #[inline(always)]
    unsafe fn lean_string_size(o: *mut LeanObject) -> usize {
        super::lean_string_size(o)
    }
    #[inline(always)]
    unsafe fn lean_string_len(o: *mut LeanObject) -> usize {
        super::lean_string_len(o)
    }
    #[inline(always)]
    unsafe fn lean_string_capacity(o: *mut LeanObject) -> usize {
        super::lean_string_capacity(o)
    }
    #[inline(always)]
    unsafe fn lean_string_byte_size(o: *mut LeanObject) -> usize {
        super::lean_string_byte_size(o)
    }
    #[inline(always)]
    unsafe fn lean_is_exclusive(o: *mut LeanObject) -> bool {
        super::lean_is_exclusive(o)
    }
    #[inline(always)]
    unsafe fn lean_is_string(o: *mut LeanObject) -> bool {
        super::lean_is_string(o)
    }
    #[inline(always)]
    unsafe fn lean_dec_ref(o: *mut LeanObject) {
        super::lean_dec_ref(o);
    }
    #[inline(always)]
    ...
    #[inline(always)]
    unsafe fn lean_alloc_sarray(elem_size: c_uint, size: usize, capacity: usize) -> *mut LeanObject {
        super::lean_alloc_sarray(elem_size, size, capacity)
    }
    #[inline(always)]
    unsafe fn lean_sarray_cptr(o: *mut LeanObject) -> *mut u8 {
        super::lean_sarray_cptr(o) as *mut u8
    }
    #[inline(always)]
    unsafe fn lean_sarray_size(o: *mut LeanObject) -> usize {
        super::lean_sarray_size(o)
    }
    #[inline(always)]
    unsafe fn lean_sarray_capacity(o: *mut LeanObject) -> usize {
        super::lean_sarray_capacity(o)
    }
    #[inline(always)]
    unsafe fn lean_sarray_elem_size(o: *mut LeanObject) -> c_uint {
        super::lean_sarray_elem_size(o)
    }
    #[inline(always)]
    unsafe fn lean_sarray_byte_size(o: *mut LeanObject) -> usize {
        super::lean_sarray_byte_size(o)
    }
    #[inline(always)]
    unsafe fn lean_array_size(o: *mut LeanObject) -> usize {
        super::lean_array_size(o)
    }
    #[inline(always)]
    unsafe fn lean_array_cptr(o: *mut LeanObject) -> *mut *mut LeanObject {
        super::lean_array_cptr(o)
    }
    #[inline(always)]
    unsafe fn lean_alloc_array(size: usize, capacity: usize) -> *mut LeanObject {
        super::lean_alloc_array(size, capacity)
    }
    #[inline(always)]
    unsafe fn lean_box(n: usize) -> *mut LeanObject {
        super::lean_box(n)
    }
    #[inline(always)]
    unsafe fn lean_unbox(o: *mut LeanObject) -> usize {
        super::lean_unbox(o)
    }
    #[inline(always)]
    unsafe fn lean_box_float(v: f64) -> *mut LeanObject {
        super::lean_box_float_rust(v)
    }
    #[inline(always)]
    unsafe fn lean_unbox_float(o: *mut LeanObject) -> f64 {
        super::lean_unbox_float_rust(o)
    }
    #[inline(always)]
    unsafe fn lean_is_scalar(o: *mut LeanObject) -> bool {
        super::lean_is_scalar(o)
    }
    #[inline(always)]
    unsafe fn lean_nat_add(a: *mut LeanObject, b: *mut LeanObject) -> *mut LeanObject {
        super::lean_nat_add_rust(a, b)
    }
    #[inline(always)]
    unsafe fn lean_nat_sub(a: *mut LeanObject, b: *mut LeanObject) -> *mut LeanObject {
        super::lean_nat_sub_rust(a, b)
    }
    #[inline(always)]
    unsafe fn lean_usize_to_nat(n: usize) -> *mut LeanObject {
        super::lean_usize_to_nat_rust(n)
    }
    #[inline(always)]
    unsafe fn lean_box_uint32(v: u32) -> *mut LeanObject {
        super::lean_box_uint32_rust(v)
    }
    #[inline(always)]
    unsafe fn lean_unbox_uint32(o: *mut LeanObject) -> u32 {
        super::lean_unbox_uint32_rust(o)
    }
    #[inline(always)]
    unsafe fn lean_alloc_ctor(tag: c_uint, num_objs: c_uint, scalar_sz: c_uint) -> *mut LeanObject {
        super::lean_alloc_ctor(tag, num_objs, scalar_sz)
    }
    #[inline(always)]
    unsafe fn lean_ctor_set(o: *mut LeanObject, i: c_uint, v: *mut LeanObject) {
        super::lean_ctor_set(o, i as usize, v);
    }
    #[inline(always)]
    unsafe fn lean_ctor_get(o: *mut LeanObject, i: c_uint) -> *mut LeanObject {
        super::lean_ctor_get(o, i as usize)
    }
    #[inline(always)]
    unsafe fn lean_char_default_value() -> u32 {
        super::lean_char_default_value_rust()
    }
    #[inline(always)]
    unsafe fn lean_apply_1(f: *mut LeanObject, a: *mut LeanObject) -> *mut LeanObject {
        super::lean_apply_1(f, a)
    }
    #[inline(always)]
    unsafe fn lean_string_hash(s: *mut LeanObject) -> u64 {
        super::lean_string_hash_export(s)
    }
    #[inline(always)]
    unsafe fn lean_utf8_n_strlen(s: *const c_char, sz: usize) -> usize {
        super::lean_utf8_n_strlen(s, sz)
    }

    #[inline(always)]
    unsafe fn validate_utf8(s: *const u8, sz: usize, pos: *mut usize, i: *mut usize) -> bool {
        super::lean_runtime_validate_utf8(s, sz, pos, i)
    }
    #[inline(always)]
    unsafe fn validate_utf8_one(s: *const u8, sz: usize, pos: usize) -> bool {
        let mut p = pos;
        super::lean_runtime_validate_utf8_one(s, sz, &mut p)
    }
    #[inline(always)]
    unsafe fn push_unicode_scalar(dst: *mut c_char, c: u32) -> usize {
        super::lean_runtime_push_unicode_scalar(dst, c) as usize
    }
    ...
    // ─── dealloc shim (small-alloc aware) ────────────────────────────
    extern "C" {
...
// This mirrors runtime/object.cpp:
//   - small nat: unbox directly
//   - big nat: validate that the embedded mpz fits in size_t, then dec ref
#[no_mangle]
pub unsafe extern "C" fn lean_nat_to_size_t(n: *mut LeanObject) -> usize {
    extern "C" {
        fn lean_internal_panic_out_of_memory() -> !;
    ...
    if lean_is_scalar(n) {
        ...
        let mpz = (n as *const u8).add(core::mem::size_of::<LeanObject>()) as *const LeanMpzRepr;
        #[cfg(lean_use_gmp)]
        let sz = {
            let v = &*mpz;
            if v[0]._mp_size < 0 {
