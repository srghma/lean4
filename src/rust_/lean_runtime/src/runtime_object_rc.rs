...
extern "C" {
    ...
    fn lean_dealloc_rc_mangled(ptr: *mut u8, sz: usize);
...
unsafe fn lean_dealloc(o: *mut LeanObject, sz: usize) {
    lean_dealloc_rc_mangled(o as *mut u8, sz);
}
...
unsafe fn dec_for_del(o: *mut LeanObject, todo: &mut *mut LeanObject) {
    ...
    if rc > 1 {
        ...
        let rc_ptr = &raw mut (*o).m_rc as *mut core::sync::atomic::AtomicI32;
