...
extern "C" LEAN_EXPORT object * lean_cxx_expr_abstract_range(object * e, object * n, object * subst) {
    if (!lean_is_scalar(n))
...
extern "C" LEAN_EXPORT object * lean_cxx_expr_abstract(object * e, object * subst) {
    return lean_expr_abstract_core(e, lean_array_size(subst), subst);
}
}
