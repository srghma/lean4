...
def UInt32.ofNat' (n : Nat) (h : n < UInt32.size) : UInt32 :=
  UInt32.ofNatLT n h
/--
...
@[deprecated ofNatLT_lt_of_lt (since := "2025-02-12")]
theorem UInt32.ofNat'_lt_of_lt {n m : Nat} (h1 : n < UInt32.size) (h2 : m < UInt32.size) :
    n < m → UInt32.ofNatLT n h1 < UInt32.ofNat m :=
  UInt32.ofNatLT_lt_of_lt h1 h2
...
@[deprecated UInt32.lt_ofNatLT_of_lt (since := "2025-02-12")]
theorem UInt32.lt_ofNat'_of_lt {n m : Nat} (h1 : n < UInt32.size) (h2 : m < UInt32.size) :
    m < n → UInt32.ofNat m < UInt32.ofNatLT n h1 :=
  UInt32.lt_ofNatLT_of_lt h1 h2
