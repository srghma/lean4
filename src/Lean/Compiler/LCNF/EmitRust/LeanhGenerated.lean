...
-- TODO: use `def isExternC (env : Environment) (fn : Name) : Bool :=` or `getExternNameFor` instead. If none and `getExportNameFor?` gives none too - then it should be imported from leanh.rs
