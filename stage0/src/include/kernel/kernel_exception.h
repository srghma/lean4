...
[[noreturn]] inline void throw_kernel_exception_object(obj_arg ex) {
    object_ref ex_ref(ex);
    unsigned tag = obj_tag(ex_ref.raw());
    if (tag >= 13 && is_scalar(ex_ref.raw())) {
        switch (unbox(ex_ref.raw())) {
        case 13: throw heartbeat_exception();
        case 14: throw memory_exception("Lean.Kernel");
        case 15: throw stack_space_exception("Lean.Kernel");
        case 16: throw interrupted();
        default: throw exception("unexpected kernel exception");
        }
    }
    switch (tag) {
    case 0: throw unknown_constant_exception(environment(cnstr_get(ex_ref.raw(), 0), true), name(cnstr_get(ex_ref.raw(), 1), true));
    case 1: throw already_declared_exception(environment(cnstr_get(ex_ref.raw(), 0), true), name(cnstr_get(ex_ref.raw(), 1), true));
    case 2: throw definition_type_mismatch_exception(environment(cnstr_get(ex_ref.raw(), 0), true), declaration(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true));
    case 3: throw declaration_has_metavars_exception(environment(cnstr_get(ex_ref.raw(), 0), true), name(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true));
    case 4: throw declaration_has_free_vars_exception(environment(cnstr_get(ex_ref.raw(), 0), true), name(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true));
    case 5: throw function_expected_exception(environment(cnstr_get(ex_ref.raw(), 0), true), local_ctx(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true));
    case 6: throw type_expected_exception(environment(cnstr_get(ex_ref.raw(), 0), true), local_ctx(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true));
    case 7: throw def_type_mismatch_exception(environment(cnstr_get(ex_ref.raw(), 0), true), local_ctx(cnstr_get(ex_ref.raw(), 1), true), name(cnstr_get(ex_ref.raw(), 2), true), expr(cnstr_get(ex_ref.raw(), 3), true), expr(cnstr_get(ex_ref.raw(), 4), true));
    case 8: throw expr_type_mismatch_exception(environment(cnstr_get(ex_ref.raw(), 0), true), local_ctx(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true), expr(cnstr_get(ex_ref.raw(), 3), true));
    case 9: throw app_type_mismatch_exception(environment(cnstr_get(ex_ref.raw(), 0), true), local_ctx(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true), expr(cnstr_get(ex_ref.raw(), 3), true), expr(cnstr_get(ex_ref.raw(), 4), true));
    case 10: throw invalid_proj_exception(environment(cnstr_get(ex_ref.raw(), 0), true), local_ctx(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true));
    case 11: throw theorem_type_is_not_prop(environment(cnstr_get(ex_ref.raw(), 0), true), name(cnstr_get(ex_ref.raw(), 1), true), expr(cnstr_get(ex_ref.raw(), 2), true));
    case 12: throw exception(string_ref(cnstr_get(ex_ref.raw(), 0), true).to_std_string());
    default: throw exception("unexpected kernel exception");
    }
}

template<typename T>
T get_or_throw_kernel_exception(obj_arg r) {
    if (cnstr_tag(r) == 1) {
        T result(cnstr_get(r, 0), true);
        dec(r);
        return result;
    }
