...
static mut LIBRARY_CONSTANTS: [LeanName; LIBRARY_CONSTANT_PATHS.len()] =
    [LeanName { obj: ptr::null_mut() }; LIBRARY_CONSTANT_PATHS.len()];
...
library_constant_getter!(get_and_cases_on_name, "_ZN4lean21get_and_cases_on_nameEv", 6);
...
library_constant_getter!(get_array_to_list_name, "_ZN4lean22get_array_to_list_nameEv", 9);
...
library_constant_getter!(get_has_of_nat_of_nat_name, "_ZN4lean26get_has_of_nat_of_nat_nameEv", 13);
library_constant_getter!(get_byte_array_name, "_ZN4lean19get_byte_array_nameEv", 14);
library_constant_getter!(get_byte_array_data_name, "_ZN4lean24get_byte_array_data_nameEv", 15);
...
library_constant_getter!(get_bool_cases_on_name, "_ZN4lean22get_bool_cases_on_nameEv", 19);
...
library_constant_getter!(get_decidable_is_true_name, "_ZN4lean26get_decidable_is_true_nameEv", 24);
library_constant_getter!(get_decidable_is_false_name, "_ZN4lean27get_decidable_is_false_nameEv", 25);
library_constant_getter!(get_decidable_decide_name, "_ZN4lean25get_decidable_decide_nameEv", 26);
...
library_constant_getter!(get_empty_cases_on_name, "_ZN4lean23get_empty_cases_on_nameEv", 29);
...
library_constant_getter!(get_float_array_data_name, "_ZN4lean25get_float_array_data_nameEv", 43);
...
library_constant_getter!(get_false_cases_on_name, "_ZN4lean23get_false_cases_on_nameEv", 46);
...
library_constant_getter!(get_has_zero_zero_name, "_ZN4lean22get_has_zero_zero_nameEv", 50);
...
library_constant_getter!(get_lc_unreachable_name, "_ZN4lean23get_lc_unreachable_nameEv", 63);
...
library_constant_getter!(get_nat_has_zero_name, "_ZN4lean21get_nat_has_zero_nameEv", 69);
...
library_constant_getter!(get_subsingleton_elim_name, "_ZN4lean26get_subsingleton_elim_nameEv", 92);
...
#[cfg_attr(feature = "export-runtime-ffi", export_name = "_ZN4lean20initialize_constantsEv")]
...
#[cfg_attr(feature = "export-runtime-ffi", export_name = "_ZN4lean18finalize_constantsEv")]
